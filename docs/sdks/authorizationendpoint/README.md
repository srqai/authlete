...
* [processForm](#processform) - Process Authorization Request
...
<!-- UsageSnippet language="java" operationID="auth_authorization_api" method="post" path="/api/{serviceId}/auth/authorization" -->
```java
package hello.world;
...
public class Application {
    ...
    public static void main(String[] args) throws BadRequestException, UnauthorizedException, ForbiddenException, InternalServerError, Exception {
        ...
        AuthAuthorizationApiResponse res = sdk.authorizationEndpoint().process()
                .serviceId("<id>")
                .requestBody(AuthAuthorizationApiRequestBody.builder()
...
**[AuthAuthorizationApiResponse](../../models/operations/AuthAuthorizationApiResponse.md)**
...
<!-- UsageSnippet language="java" operationID="auth_authorization_api_form" method="post" path="/api/{serviceId}/auth/authorization" -->
```java
package hello.world;
...
public class Application {
    ...
    public static void main(String[] args) throws BadRequestException, UnauthorizedException, ForbiddenException, InternalServerError, Exception {
        ...
        AuthAuthorizationApiFormResponse res = sdk.authorizationEndpoint().processForm()
                .serviceId("<id>")
                .requestBody(AuthAuthorizationApiFormRequestBody.builder()
                    .clientLocked(true)
                    .build())
                .call();
...
**[AuthAuthorizationApiFormResponse](../../models/operations/AuthAuthorizationApiFormResponse.md)**
...
<!-- UsageSnippet language="java" operationID="post_/api/{serviceId}/auth/authorization/ticket/update" method="post" path="/api/{serviceId}/auth/authorization/ticket/update" -->
```java
package hello.world;
...
public class Application {
    ...
    public static void main(String[] args) throws BadRequestException, UnauthorizedException, ForbiddenException, InternalServerError, Exception {
        ...
        PostApiServiceIdAuthAuthorizationTicketUpdateResponse res = sdk.authorizationEndpoint().updateTicket()
                .serviceId("<id>")
                .requestBody(PostApiServiceIdAuthAuthorizationTicketUpdateRequestBody.builder()
                    .ticket("<value>")
                    .info("<value>")
                    .build())
                .call();
...
**[PostApiServiceIdAuthAuthorizationTicketUpdateResponse](../../models/operations/PostApiServiceIdAuthAuthorizationTicketUpdateResponse.md)**
...
<!-- UsageSnippet language="java" operationID="post_/api/{serviceId}/auth/authorization/ticket/update_form" method="post" path="/api/{serviceId}/auth/authorization/ticket/update" -->
```java
package hello.world;
...
public class Application {
    ...
    public static void main(String[] args) throws BadRequestException, UnauthorizedException, ForbiddenException, InternalServerError, Exception {
        ...
        PostApiServiceIdAuthAuthorizationTicketUpdateFormResponse res = sdk.authorizationEndpoint().updateTicketForm()
                .serviceId("<id>")
                .requestBody(PostApiServiceIdAuthAuthorizationTicketUpdateFormRequestBody.builder()
                    .clientLocked(true)
                    .build())
                .call();
...
**[PostApiServiceIdAuthAuthorizationTicketUpdateFormResponse](../../models/operations/PostApiServiceIdAuthAuthorizationTicketUpdateFormResponse.md)**
