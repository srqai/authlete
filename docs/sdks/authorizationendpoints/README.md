...
<!-- UsageSnippet language="java" operationID="auth_authorization_fail_api" method="post" path="/api/{serviceId}/auth/authorization/fail" -->
```java
package hello.world;
...
<!-- UsageSnippet language="java" operationID="auth_authorization_fail_api_form" method="post" path="/api/{serviceId}/auth/authorization/fail" -->
```java
package hello.world;
...
public class Application {
    ...
    public static void main(String[] args) throws BadRequestException, UnauthorizedException, ForbiddenException, InternalServerError, Exception {
        ...
        AuthAuthorizationFailApiFormResponse res = sdk.authorizationEndpoints().failAuthRequestForm()
                .serviceId("<id>")
                .requestBody(AuthAuthorizationFailApiFormRequestBody.builder()
                    .clientLocked(false)
                    .build())
                .call();
