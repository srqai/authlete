...
<!-- UsageSnippet language="java" operationID="auth_introspection_api" method="post" path="/api/{serviceId}/auth/introspection" -->
```java
package hello.world;
...
<!-- UsageSnippet language="java" operationID="auth_introspection_api_form" method="post" path="/api/{serviceId}/auth/introspection" -->
```java
package hello.world;
...
public class Application {
    ...
    public static void main(String[] args) throws BadRequestException, UnauthorizedException, ForbiddenException, InternalServerError, Exception {
        ...
        AuthIntrospectionApiFormResponse res = sdk.introspectionEndpoint().processForm()
                .serviceId("<id>")
                .requestBody(AuthIntrospectionApiFormRequestBody.builder()
                    .clientLocked(false)
                    .build())
                .call();
