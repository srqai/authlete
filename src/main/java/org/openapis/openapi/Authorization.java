...
import org.openapis.openapi.models.operations.GetApiServiceIdAuthAuthorizationTicketInfoFormRequest;
import org.openapis.openapi.models.operations.GetApiServiceIdAuthAuthorizationTicketInfoFormRequestBuilder;
...
public class Authorization {
    ...
    public AuthAuthorizationIssueApiResponse issue(@Nonnull String serviceId, @Nonnull AuthAuthorizationIssueApiRequestBody requestBody) throws Exception {
        ...
        RequestOperation<AuthAuthorizationIssueApiRequest, AuthAuthorizationIssueApiResponse> operation
              = new AuthAuthorizationIssueApiOperation(sdkConfiguration);
     ...
     * 
     * @param serviceId A service ID.
     * @param 1api1Percent7BserviceIdPercent7D1auth1authorization1issuePostRequestBodyContentApplication1jsonSchema 
     * @return The response from the API call
     * @throws Exception if the API call fails
     */
    public AuthAuthorizationIssueApiFormResponse issueForm(@Nonnull String serviceId, @Nonnull 1api1Percent7BserviceIdPercent7D1auth1authorization1issuePostRequestBodyContentApplication1jsonSchema 1api1Percent7BserviceIdPercent7D1auth1authorization1issuePostRequestBodyContentApplication1jsonSchema) throws Exception {
        AuthAuthorizationIssueApiFormRequest request = new AuthAuthorizationIssueApiFormRequest(serviceId, 1api1Percent7BserviceIdPercent7D1auth1authorization1issuePostRequestBodyContentApplication1jsonSchema);
    ...
    public PushedAuthReqApiResponse processPushedRequest(@Nonnull String serviceId, @Nonnull PushedAuthReqApiRequestBody requestBody) throws Exception {
        ...
        RequestOperation<PushedAuthReqApiRequest, PushedAuthReqApiResponse> operation
              = new PushedAuthReqApiOperation(sdkConfiguration);
        return operation.handleResponse(operation.doRequest(request));
    }
     ...
     * 
     * @param serviceId A service ID.
     * @param 1api1Percent7BserviceIdPercent7D1pushedAuthReqPostRequestBodyContentApplication1jsonSchema 
     * @return The response from the API call
     * @throws Exception if the API call fails
     */
    public PushedAuthReqApiFormResponse processPushedRequestForm(@Nonnull String serviceId, @Nonnull 1api1Percent7BserviceIdPercent7D1pushedAuthReqPostRequestBodyContentApplication1jsonSchema 1api1Percent7BserviceIdPercent7D1pushedAuthReqPostRequestBodyContentApplication1jsonSchema) throws Exception {
        PushedAuthReqApiFormRequest request = new PushedAuthReqApiFormRequest(serviceId, 1api1Percent7BserviceIdPercent7D1pushedAuthReqPostRequestBodyContentApplication1jsonSchema);
     ...
     * @throws Exception if the API call fails
     */
    public GetApiServiceIdAuthAuthorizationTicketInfoResponse getTicketInfo(@Nonnull String serviceId, @Nonnull GetApiServiceIdAuthAuthorizationTicketInfoRequestBody requestBody) throws Exception {
        GetApiServiceIdAuthAuthorizationTicketInfoRequest request = new GetApiServiceIdAuthAuthorizationTicketInfoRequest(serviceId, requestBody);
     ...
     * @return The call builder
     */
    public GetApiServiceIdAuthAuthorizationTicketInfoFormRequestBuilder getTicketInfoForm() {
        return new GetApiServiceIdAuthAuthorizationTicketInfoFormRequestBuilder(sdkConfiguration);
    }
     ...
     * 
     * @param serviceId A service ID
     * @param 1api1Percent7BserviceIdPercent7D1auth1authorization1ticket1infoGetRequestBodyContentApplication1jsonSchema 
     * @return The response from the API call
     * @throws Exception if the API call fails
     */
    public GetApiServiceIdAuthAuthorizationTicketInfoFormResponse getTicketInfoForm(@Nonnull String serviceId, @Nonnull 1api1Percent7BserviceIdPercent7D1auth1authorization1ticket1infoGetRequestBodyContentApplication1jsonSchema 1api1Percent7BserviceIdPercent7D1auth1authorization1ticket1infoGetRequestBodyContentApplication1jsonSchema) throws Exception {
        GetApiServiceIdAuthAuthorizationTicketInfoFormRequest request = new GetApiServiceIdAuthAuthorizationTicketInfoFormRequest(serviceId, 1api1Percent7BserviceIdPercent7D1auth1authorization1ticket1infoGetRequestBodyContentApplication1jsonSchema);
