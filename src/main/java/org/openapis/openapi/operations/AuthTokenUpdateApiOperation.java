...
import org.openapis.openapi.models.operations.AuthTokenUpdateApiResponseBody;
...
public class AuthTokenUpdateApiOperation implements RequestOperation<AuthTokenUpdateApiRequest, AuthTokenUpdateApiResponse> {
    
    /**
     * AUTH_TOKEN_UPDATE_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] AUTH_TOKEN_UPDATE_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public AuthTokenUpdateApiOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        AUTH_TOKEN_UPDATE_API_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(AuthTokenUpdateApiRequest request) throws Exception {
        String url = Utils.generateURL(
                AuthTokenUpdateApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AuthTokenUpdateApiRequest request) throws Exception {
    ...
    @Override
    public AuthTokenUpdateApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        AuthTokenUpdateApiResponse.Builder resBuilder = 
        ...
        AuthTokenUpdateApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                AuthTokenUpdateApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
