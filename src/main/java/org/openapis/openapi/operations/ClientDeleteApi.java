...
public class ClientDeleteApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ClientDeleteApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<ClientDeleteApiRequest, ClientDeleteApiResponse> {
