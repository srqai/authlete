...
import org.openapis.openapi.models.operations.ClientAuthorizationUpdateApiResponseBody;
...
public class ClientAuthorizationUpdateApiOperation implements RequestOperation<ClientAuthorizationUpdateApiRequest, ClientAuthorizationUpdateApiResponse> {
    
    /**
     * CLIENT_AUTHORIZATION_UPDATE_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] CLIENT_AUTHORIZATION_UPDATE_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public ClientAuthorizationUpdateApiOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        CLIENT_AUTHORIZATION_UPDATE_API_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(ClientAuthorizationUpdateApiRequest request) throws Exception {
        String url = Utils.generateURL(
                ClientAuthorizationUpdateApiRequest.class,
                this.baseUrl,
        ...
        return sdkConfiguration.hooks().beforeRequest(
              new BeforeRequestContextImpl(
                  ...
                  this.baseUrl,
                  "client_authorization_update_api",
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ClientAuthorizationUpdateApiRequest request) throws Exception {
    ...
    @Override
    public ClientAuthorizationUpdateApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ClientAuthorizationUpdateApiResponse.Builder resBuilder = 
        ...
        ClientAuthorizationUpdateApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                ClientAuthorizationUpdateApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
