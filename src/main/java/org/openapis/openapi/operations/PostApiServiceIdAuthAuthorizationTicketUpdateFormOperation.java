...
import org.openapis.openapi.models.operations.PostApiServiceIdAuthAuthorizationTicketUpdateFormResponseBody;
...
public class PostApiServiceIdAuthAuthorizationTicketUpdateFormOperation implements RequestOperation<PostApiServiceIdAuthAuthorizationTicketUpdateFormRequest, PostApiServiceIdAuthAuthorizationTicketUpdateFormResponse> {
    
    /**
     * POST_API_SERVICE_ID_AUTH_AUTHORIZATION_TICKET_UPDATE_FORM_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] POST_API_SERVICE_ID_AUTH_AUTHORIZATION_TICKET_UPDATE_FORM_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public PostApiServiceIdAuthAuthorizationTicketUpdateFormOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        POST_API_SERVICE_ID_AUTH_AUTHORIZATION_TICKET_UPDATE_FORM_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(PostApiServiceIdAuthAuthorizationTicketUpdateFormRequest request) throws Exception {
        String url = Utils.generateURL(
                PostApiServiceIdAuthAuthorizationTicketUpdateFormRequest.class,
                this.baseUrl,
        ...
        return sdkConfiguration.hooks().beforeRequest(
              new BeforeRequestContextImpl(
                  ...
                  this.baseUrl,
                  "post_/api/{serviceId}/auth/authorization/ticket/update_form",
    ...
    @Override
    public HttpResponse<InputStream> doRequest(PostApiServiceIdAuthAuthorizationTicketUpdateFormRequest request) throws Exception {
    ...
    @Override
    public PostApiServiceIdAuthAuthorizationTicketUpdateFormResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        PostApiServiceIdAuthAuthorizationTicketUpdateFormResponse.Builder resBuilder = 
        ...
        PostApiServiceIdAuthAuthorizationTicketUpdateFormResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                PostApiServiceIdAuthAuthorizationTicketUpdateFormResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
