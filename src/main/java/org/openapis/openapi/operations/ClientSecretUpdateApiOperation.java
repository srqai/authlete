...
import org.openapis.openapi.models.operations.ClientSecretUpdateApiResponseBody;
...
public class ClientSecretUpdateApiOperation implements RequestOperation<ClientSecretUpdateApiRequest, ClientSecretUpdateApiResponse> {
    
    /**
     * CLIENT_SECRET_UPDATE_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] CLIENT_SECRET_UPDATE_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public ClientSecretUpdateApiOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        CLIENT_SECRET_UPDATE_API_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(ClientSecretUpdateApiRequest request) throws Exception {
        String url = Utils.generateURL(
                ClientSecretUpdateApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ClientSecretUpdateApiRequest request) throws Exception {
    ...
    @Override
    public ClientSecretUpdateApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ClientSecretUpdateApiResponse.Builder resBuilder = 
        ...
        ClientSecretUpdateApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                ClientSecretUpdateApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
