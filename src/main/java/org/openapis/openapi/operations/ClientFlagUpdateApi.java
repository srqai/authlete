...
public class ClientFlagUpdateApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ClientFlagUpdateApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<ClientFlagUpdateApiRequest, ClientFlagUpdateApiResponse> {
