...
public class VciJwksApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(VciJwksApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<VciJwksApiRequest, VciJwksApiResponse> {
