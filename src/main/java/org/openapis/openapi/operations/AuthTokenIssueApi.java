...
public class AuthTokenIssueApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(AuthTokenIssueApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<AuthTokenIssueApiRequest, AuthTokenIssueApiResponse> {
