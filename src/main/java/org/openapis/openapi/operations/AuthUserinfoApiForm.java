...
public class AuthUserinfoApiForm {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(AuthUserinfoApiFormRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<AuthUserinfoApiFormRequest, AuthUserinfoApiFormResponse> {
