...
import org.openapis.openapi.models.operations.AuthTokenFailApiFormResponseBody;
...
public class AuthTokenFailApiFormOperation implements RequestOperation<AuthTokenFailApiFormRequest, AuthTokenFailApiFormResponse> {
    
    /**
     * AUTH_TOKEN_FAIL_API_FORM_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] AUTH_TOKEN_FAIL_API_FORM_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public AuthTokenFailApiFormOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        AUTH_TOKEN_FAIL_API_FORM_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(AuthTokenFailApiFormRequest request) throws Exception {
        String url = Utils.generateURL(
                AuthTokenFailApiFormRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AuthTokenFailApiFormRequest request) throws Exception {
    ...
    @Override
    public AuthTokenFailApiFormResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        AuthTokenFailApiFormResponse.Builder resBuilder = 
        ...
        AuthTokenFailApiFormResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                AuthTokenFailApiFormResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
