...
import org.openapis.openapi.models.operations.AuthUserinfoIssueApiResponseBody;
...
public class AuthUserinfoIssueApiOperation implements RequestOperation<AuthUserinfoIssueApiRequest, AuthUserinfoIssueApiResponse> {
    
    /**
     * AUTH_USERINFO_ISSUE_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] AUTH_USERINFO_ISSUE_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public AuthUserinfoIssueApiOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        AUTH_USERINFO_ISSUE_API_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(AuthUserinfoIssueApiRequest request) throws Exception {
        String url = Utils.generateURL(
                AuthUserinfoIssueApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AuthUserinfoIssueApiRequest request) throws Exception {
    ...
    @Override
    public AuthUserinfoIssueApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        AuthUserinfoIssueApiResponse.Builder resBuilder = 
        ...
        AuthUserinfoIssueApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                AuthUserinfoIssueApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
