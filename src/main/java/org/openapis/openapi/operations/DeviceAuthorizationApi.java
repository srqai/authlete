...
public class DeviceAuthorizationApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(DeviceAuthorizationApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeviceAuthorizationApiRequest, DeviceAuthorizationApiResponse> {
