...
import org.openapis.openapi.models.operations.AuthRevocationApiResponseBody;
...
public class AuthRevocationApiOperation implements RequestOperation<AuthRevocationApiRequest, AuthRevocationApiResponse> {
    
    /**
     * AUTH_REVOCATION_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] AUTH_REVOCATION_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public AuthRevocationApiOperation(
    ...
    public HttpRequest buildRequest(AuthRevocationApiRequest request) throws Exception {
        String url = Utils.generateURL(
                AuthRevocationApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AuthRevocationApiRequest request) throws Exception {
    ...
    @Override
    public AuthRevocationApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        AuthRevocationApiResponse.Builder resBuilder = 
        ...
        AuthRevocationApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                AuthRevocationApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
