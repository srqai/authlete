...
public class VciDeferredIssueApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(VciDeferredIssueApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<VciDeferredIssueApiRequest, VciDeferredIssueApiResponse> {
