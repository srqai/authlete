...
public class VciMetadataApiForm {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(VciMetadataApiFormRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<VciMetadataApiFormRequest, VciMetadataApiFormResponse> {
