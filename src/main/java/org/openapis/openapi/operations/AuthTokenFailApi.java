...
public class AuthTokenFailApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(AuthTokenFailApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<AuthTokenFailApiRequest, AuthTokenFailApiResponse> {
