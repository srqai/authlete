...
import org.openapis.openapi.models.operations.AuthTokenIssueApiFormResponseBody;
...
public class AuthTokenIssueApiFormOperation implements RequestOperation<AuthTokenIssueApiFormRequest, AuthTokenIssueApiFormResponse> {
    
    /**
     * AUTH_TOKEN_ISSUE_API_FORM_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] AUTH_TOKEN_ISSUE_API_FORM_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public AuthTokenIssueApiFormOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        AUTH_TOKEN_ISSUE_API_FORM_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(AuthTokenIssueApiFormRequest request) throws Exception {
        String url = Utils.generateURL(
                AuthTokenIssueApiFormRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AuthTokenIssueApiFormRequest request) throws Exception {
    ...
    @Override
    public AuthTokenIssueApiFormResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        AuthTokenIssueApiFormResponse.Builder resBuilder = 
        ...
        AuthTokenIssueApiFormResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                AuthTokenIssueApiFormResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
