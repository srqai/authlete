...
public class ServiceCreateApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ServiceCreateApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<ServiceCreateApiRequest, ServiceCreateApiResponse> {
