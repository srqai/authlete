...
import org.openapis.openapi.models.operations.AuthAuthorizationApiResponseBody;
...
public class AuthAuthorizationApiOperation implements RequestOperation<AuthAuthorizationApiRequest, AuthAuthorizationApiResponse> {
    
    /**
     * AUTH_AUTHORIZATION_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] AUTH_AUTHORIZATION_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public AuthAuthorizationApiOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        AUTH_AUTHORIZATION_API_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(AuthAuthorizationApiRequest request) throws Exception {
        String url = Utils.generateURL(
                AuthAuthorizationApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AuthAuthorizationApiRequest request) throws Exception {
    ...
    @Override
    public AuthAuthorizationApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        AuthAuthorizationApiResponse.Builder resBuilder = 
        ...
        AuthAuthorizationApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                AuthAuthorizationApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
