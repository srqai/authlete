...
public class VciDeferredParseApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(VciDeferredParseApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<VciDeferredParseApiRequest, VciDeferredParseApiResponse> {
