...
import org.openapis.openapi.models.operations.AuthAuthorizationFailApiResponseBody;
...
public class AuthAuthorizationFailApiOperation implements RequestOperation<AuthAuthorizationFailApiRequest, AuthAuthorizationFailApiResponse> {
    
    /**
     * AUTH_AUTHORIZATION_FAIL_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] AUTH_AUTHORIZATION_FAIL_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public AuthAuthorizationFailApiOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        AUTH_AUTHORIZATION_FAIL_API_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(AuthAuthorizationFailApiRequest request) throws Exception {
        String url = Utils.generateURL(
                AuthAuthorizationFailApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AuthAuthorizationFailApiRequest request) throws Exception {
    ...
    @Override
    public AuthAuthorizationFailApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        AuthAuthorizationFailApiResponse.Builder resBuilder = 
        ...
        AuthAuthorizationFailApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                AuthAuthorizationFailApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
