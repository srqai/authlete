...
import org.openapis.openapi.models.operations.AuthTokenRevokeApiResponseBody;
...
public class AuthTokenRevokeApiOperation implements RequestOperation<AuthTokenRevokeApiRequest, AuthTokenRevokeApiResponse> {
    
    /**
     * AUTH_TOKEN_REVOKE_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] AUTH_TOKEN_REVOKE_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public AuthTokenRevokeApiOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        AUTH_TOKEN_REVOKE_API_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(AuthTokenRevokeApiRequest request) throws Exception {
        String url = Utils.generateURL(
                AuthTokenRevokeApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AuthTokenRevokeApiRequest request) throws Exception {
    ...
    @Override
    public AuthTokenRevokeApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        AuthTokenRevokeApiResponse.Builder resBuilder = 
        ...
        AuthTokenRevokeApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                AuthTokenRevokeApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
