...
import org.openapis.openapi.models.operations.AuthIntrospectionStandardApiResponseBody;
...
public class AuthIntrospectionStandardApiOperation implements RequestOperation<AuthIntrospectionStandardApiRequest, AuthIntrospectionStandardApiResponse> {
    
    /**
     * AUTH_INTROSPECTION_STANDARD_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] AUTH_INTROSPECTION_STANDARD_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public AuthIntrospectionStandardApiOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        AUTH_INTROSPECTION_STANDARD_API_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(AuthIntrospectionStandardApiRequest request) throws Exception {
        String url = Utils.generateURL(
                AuthIntrospectionStandardApiRequest.class,
                this.baseUrl,
        ...
        return sdkConfiguration.hooks().beforeRequest(
              new BeforeRequestContextImpl(
                  ...
                  this.baseUrl,
                  "auth_introspection_standard_api",
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AuthIntrospectionStandardApiRequest request) throws Exception {
    ...
    @Override
    public AuthIntrospectionStandardApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        AuthIntrospectionStandardApiResponse.Builder resBuilder = 
        ...
        AuthIntrospectionStandardApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                AuthIntrospectionStandardApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
