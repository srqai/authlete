...
public class HskCreateApiForm {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(HskCreateApiFormRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<HskCreateApiFormRequest, HskCreateApiFormResponse> {
