...
public class ClientDeleteApiOperation implements RequestOperation<ClientDeleteApiRequest, ClientDeleteApiResponse> {
    
    /**
     * CLIENT_DELETE_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] CLIENT_DELETE_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public ClientDeleteApiOperation(
    ...
    public HttpRequest buildRequest(ClientDeleteApiRequest request) throws Exception {
        String url = Utils.generateURL(
                ClientDeleteApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ClientDeleteApiRequest request) throws Exception {
    ...
    @Override
    public ClientDeleteApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ClientDeleteApiResponse.Builder resBuilder = 
        ...
        ClientDeleteApiResponse res = resBuilder.build();
