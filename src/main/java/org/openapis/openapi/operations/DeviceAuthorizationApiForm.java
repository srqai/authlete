...
public class DeviceAuthorizationApiForm {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(DeviceAuthorizationApiFormRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeviceAuthorizationApiFormRequest, DeviceAuthorizationApiFormResponse> {
