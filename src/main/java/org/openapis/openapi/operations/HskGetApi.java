...
public class HskGetApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(HskGetApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<HskGetApiRequest, HskGetApiResponse> {
