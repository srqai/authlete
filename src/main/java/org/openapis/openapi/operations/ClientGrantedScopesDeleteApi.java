...
public class ClientGrantedScopesDeleteApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ClientGrantedScopesDeleteApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<ClientGrantedScopesDeleteApiRequest, ClientGrantedScopesDeleteApiResponse> {
