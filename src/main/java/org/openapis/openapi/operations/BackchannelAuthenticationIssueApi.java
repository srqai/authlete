...
public class BackchannelAuthenticationIssueApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(BackchannelAuthenticationIssueApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<BackchannelAuthenticationIssueApiRequest, BackchannelAuthenticationIssueApiResponse> {
