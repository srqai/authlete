...
public class ClientAuthorizationDeleteApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ClientAuthorizationDeleteApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<ClientAuthorizationDeleteApiRequest, ClientAuthorizationDeleteApiResponse> {
