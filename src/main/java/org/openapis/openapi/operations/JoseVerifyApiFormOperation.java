...
import org.openapis.openapi.models.operations.JoseVerifyApiFormResponseBody;
...
public class JoseVerifyApiFormOperation implements RequestOperation<JoseVerifyApiFormRequest, JoseVerifyApiFormResponse> {
    
    /**
     * JOSE_VERIFY_API_FORM_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] JOSE_VERIFY_API_FORM_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public JoseVerifyApiFormOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        JOSE_VERIFY_API_FORM_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(JoseVerifyApiFormRequest request) throws Exception {
        String url = Utils.generateURL(
                JoseVerifyApiFormRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(JoseVerifyApiFormRequest request) throws Exception {
    ...
    @Override
    public JoseVerifyApiFormResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        JoseVerifyApiFormResponse.Builder resBuilder = 
        ...
        JoseVerifyApiFormResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                JoseVerifyApiFormResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
