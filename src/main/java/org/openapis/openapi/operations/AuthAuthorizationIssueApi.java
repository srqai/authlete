...
public class AuthAuthorizationIssueApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(AuthAuthorizationIssueApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<AuthAuthorizationIssueApiRequest, AuthAuthorizationIssueApiResponse> {
