...
import org.openapis.openapi.models.operations.PushedAuthReqApiFormResponseBody;
...
public class PushedAuthReqApiFormOperation implements RequestOperation<PushedAuthReqApiFormRequest, PushedAuthReqApiFormResponse> {
    
    /**
     * PUSHED_AUTH_REQ_API_FORM_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] PUSHED_AUTH_REQ_API_FORM_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public PushedAuthReqApiFormOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        PUSHED_AUTH_REQ_API_FORM_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(PushedAuthReqApiFormRequest request) throws Exception {
        String url = Utils.generateURL(
                PushedAuthReqApiFormRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(PushedAuthReqApiFormRequest request) throws Exception {
    ...
    @Override
    public PushedAuthReqApiFormResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        PushedAuthReqApiFormResponse.Builder resBuilder = 
        ...
        PushedAuthReqApiFormResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                PushedAuthReqApiFormResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
