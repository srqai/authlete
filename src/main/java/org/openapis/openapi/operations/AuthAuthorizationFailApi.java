...
public class AuthAuthorizationFailApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(AuthAuthorizationFailApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<AuthAuthorizationFailApiRequest, AuthAuthorizationFailApiResponse> {
