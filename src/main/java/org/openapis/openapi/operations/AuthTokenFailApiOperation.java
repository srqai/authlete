...
import org.openapis.openapi.models.operations.AuthTokenFailApiResponseBody;
...
public class AuthTokenFailApiOperation implements RequestOperation<AuthTokenFailApiRequest, AuthTokenFailApiResponse> {
    
    /**
     * AUTH_TOKEN_FAIL_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] AUTH_TOKEN_FAIL_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public AuthTokenFailApiOperation(
    ...
    public HttpRequest buildRequest(AuthTokenFailApiRequest request) throws Exception {
        String url = Utils.generateURL(
                AuthTokenFailApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AuthTokenFailApiRequest request) throws Exception {
    ...
    @Override
    public AuthTokenFailApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        AuthTokenFailApiResponse.Builder resBuilder = 
        ...
        AuthTokenFailApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                AuthTokenFailApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
