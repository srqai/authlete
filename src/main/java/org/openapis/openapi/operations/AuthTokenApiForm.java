...
public class AuthTokenApiForm {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(AuthTokenApiFormRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<AuthTokenApiFormRequest, AuthTokenApiFormResponse> {
