...
import org.openapis.openapi.models.operations.ClientAuthorizationGetListApiResponseBody;
...
public class ClientAuthorizationGetListApiOperation implements RequestOperation<ClientAuthorizationGetListApiRequest, ClientAuthorizationGetListApiResponse> {
    
    /**
     * CLIENT_AUTHORIZATION_GET_LIST_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] CLIENT_AUTHORIZATION_GET_LIST_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public ClientAuthorizationGetListApiOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        CLIENT_AUTHORIZATION_GET_LIST_API_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(ClientAuthorizationGetListApiRequest request) throws Exception {
        String url = Utils.generateURL(
                ClientAuthorizationGetListApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ClientAuthorizationGetListApiRequest request) throws Exception {
    ...
    @Override
    public ClientAuthorizationGetListApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ClientAuthorizationGetListApiResponse.Builder resBuilder = 
        ...
        ClientAuthorizationGetListApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                ClientAuthorizationGetListApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
