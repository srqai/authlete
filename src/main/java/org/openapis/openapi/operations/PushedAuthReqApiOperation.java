...
import org.openapis.openapi.models.operations.PushedAuthReqApiResponseBody;
...
public class PushedAuthReqApiOperation implements RequestOperation<PushedAuthReqApiRequest, PushedAuthReqApiResponse> {
    
    /**
     * PUSHED_AUTH_REQ_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] PUSHED_AUTH_REQ_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public PushedAuthReqApiOperation(
    ...
    public HttpRequest buildRequest(PushedAuthReqApiRequest request) throws Exception {
        String url = Utils.generateURL(
                PushedAuthReqApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(PushedAuthReqApiRequest request) throws Exception {
    ...
    @Override
    public PushedAuthReqApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        PushedAuthReqApiResponse.Builder resBuilder = 
        ...
        PushedAuthReqApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                PushedAuthReqApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
