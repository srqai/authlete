...
import org.openapis.openapi.models.operations.VciSingleParseApiFormResponseBody;
...
public class VciSingleParseApiFormOperation implements RequestOperation<VciSingleParseApiFormRequest, VciSingleParseApiFormResponse> {
    
    /**
     * VCI_SINGLE_PARSE_API_FORM_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] VCI_SINGLE_PARSE_API_FORM_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public VciSingleParseApiFormOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        VCI_SINGLE_PARSE_API_FORM_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(VciSingleParseApiFormRequest request) throws Exception {
        String url = Utils.generateURL(
                VciSingleParseApiFormRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(VciSingleParseApiFormRequest request) throws Exception {
    ...
    @Override
    public VciSingleParseApiFormResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        VciSingleParseApiFormResponse.Builder resBuilder = 
        ...
        VciSingleParseApiFormResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                VciSingleParseApiFormResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
