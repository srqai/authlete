...
import org.openapis.openapi.models.operations.FederationConfigurationApiResponseBody;
...
public class FederationConfigurationApiOperation implements RequestOperation<FederationConfigurationApiRequest, FederationConfigurationApiResponse> {
    
    /**
     * FEDERATION_CONFIGURATION_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] FEDERATION_CONFIGURATION_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public FederationConfigurationApiOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        FEDERATION_CONFIGURATION_API_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(FederationConfigurationApiRequest request) throws Exception {
        String url = Utils.generateURL(
                FederationConfigurationApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(FederationConfigurationApiRequest request) throws Exception {
    ...
    @Override
    public FederationConfigurationApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        FederationConfigurationApiResponse.Builder resBuilder = 
        ...
        FederationConfigurationApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                FederationConfigurationApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
