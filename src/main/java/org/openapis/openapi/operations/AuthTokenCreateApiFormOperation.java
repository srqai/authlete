...
import org.openapis.openapi.models.operations.AuthTokenCreateApiFormResponseBody;
...
public class AuthTokenCreateApiFormOperation implements RequestOperation<AuthTokenCreateApiFormRequest, AuthTokenCreateApiFormResponse> {
    
    /**
     * AUTH_TOKEN_CREATE_API_FORM_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] AUTH_TOKEN_CREATE_API_FORM_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public AuthTokenCreateApiFormOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        AUTH_TOKEN_CREATE_API_FORM_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(AuthTokenCreateApiFormRequest request) throws Exception {
        String url = Utils.generateURL(
                AuthTokenCreateApiFormRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AuthTokenCreateApiFormRequest request) throws Exception {
    ...
    @Override
    public AuthTokenCreateApiFormResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        AuthTokenCreateApiFormResponse.Builder resBuilder = 
        ...
        AuthTokenCreateApiFormResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                AuthTokenCreateApiFormResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
