...
import org.openapis.openapi.models.operations.AuthAuthorizationIssueApiFormResponseBody;
...
public class AuthAuthorizationIssueApiFormOperation implements RequestOperation<AuthAuthorizationIssueApiFormRequest, AuthAuthorizationIssueApiFormResponse> {
    
    /**
     * AUTH_AUTHORIZATION_ISSUE_API_FORM_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] AUTH_AUTHORIZATION_ISSUE_API_FORM_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public AuthAuthorizationIssueApiFormOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        AUTH_AUTHORIZATION_ISSUE_API_FORM_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(AuthAuthorizationIssueApiFormRequest request) throws Exception {
        String url = Utils.generateURL(
                AuthAuthorizationIssueApiFormRequest.class,
                this.baseUrl,
        ...
        return sdkConfiguration.hooks().beforeRequest(
              new BeforeRequestContextImpl(
                  ...
                  this.baseUrl,
                  "auth_authorization_issue_api_form",
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AuthAuthorizationIssueApiFormRequest request) throws Exception {
    ...
    @Override
    public AuthAuthorizationIssueApiFormResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        AuthAuthorizationIssueApiFormResponse.Builder resBuilder = 
        ...
        AuthAuthorizationIssueApiFormResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                AuthAuthorizationIssueApiFormResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
