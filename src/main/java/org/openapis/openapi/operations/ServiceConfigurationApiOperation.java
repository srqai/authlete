...
public class ServiceConfigurationApiOperation implements RequestOperation<ServiceConfigurationApiRequest, ServiceConfigurationApiResponse> {
    ...
    public ServiceConfigurationApiOperation(@Nonnull SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ServiceConfigurationApiRequest request) throws Exception {
