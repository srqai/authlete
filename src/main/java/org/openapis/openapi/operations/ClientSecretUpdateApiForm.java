...
public class ClientSecretUpdateApiForm {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ClientSecretUpdateApiFormRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<ClientSecretUpdateApiFormRequest, ClientSecretUpdateApiFormResponse> {
