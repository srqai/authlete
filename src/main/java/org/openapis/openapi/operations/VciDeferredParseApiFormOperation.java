...
import org.openapis.openapi.models.operations.VciDeferredParseApiFormResponseBody;
...
public class VciDeferredParseApiFormOperation implements RequestOperation<VciDeferredParseApiFormRequest, VciDeferredParseApiFormResponse> {
    
    /**
     * VCI_DEFERRED_PARSE_API_FORM_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] VCI_DEFERRED_PARSE_API_FORM_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public VciDeferredParseApiFormOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        VCI_DEFERRED_PARSE_API_FORM_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(VciDeferredParseApiFormRequest request) throws Exception {
        String url = Utils.generateURL(
                VciDeferredParseApiFormRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(VciDeferredParseApiFormRequest request) throws Exception {
    ...
    @Override
    public VciDeferredParseApiFormResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        VciDeferredParseApiFormResponse.Builder resBuilder = 
        ...
        VciDeferredParseApiFormResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                VciDeferredParseApiFormResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
