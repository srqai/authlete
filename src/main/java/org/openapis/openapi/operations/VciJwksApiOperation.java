...
import org.openapis.openapi.models.operations.VciJwksApiResponseBody;
...
public class VciJwksApiOperation implements RequestOperation<VciJwksApiRequest, VciJwksApiResponse> {
    
    /**
     * VCI_JWKS_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] VCI_JWKS_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public HttpRequest buildRequest(VciJwksApiRequest request) throws Exception {
        String url = Utils.generateURL(
                VciJwksApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(VciJwksApiRequest request) throws Exception {
    ...
    @Override
    public VciJwksApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        VciJwksApiResponse.Builder resBuilder = 
            VciJwksApiResponse
                .builder()
        ...
        VciJwksApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                VciJwksApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
