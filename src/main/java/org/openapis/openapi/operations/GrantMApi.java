...
public class GrantMApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(GrantMApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<GrantMApiRequest, GrantMApiResponse> {
