...
public class ClientRegistrationUpdateApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ClientRegistrationUpdateApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<ClientRegistrationUpdateApiRequest, ClientRegistrationUpdateApiResponse> {
