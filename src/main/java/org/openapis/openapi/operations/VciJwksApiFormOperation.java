...
import org.openapis.openapi.models.operations.VciJwksApiFormResponseBody;
...
public class VciJwksApiFormOperation implements RequestOperation<VciJwksApiFormRequest, VciJwksApiFormResponse> {
    
    /**
     * VCI_JWKS_API_FORM_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] VCI_JWKS_API_FORM_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public VciJwksApiFormOperation(
    ...
    public HttpRequest buildRequest(VciJwksApiFormRequest request) throws Exception {
        String url = Utils.generateURL(
                VciJwksApiFormRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(VciJwksApiFormRequest request) throws Exception {
    ...
    @Override
    public VciJwksApiFormResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        VciJwksApiFormResponse.Builder resBuilder = 
        ...
        VciJwksApiFormResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                VciJwksApiFormResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
