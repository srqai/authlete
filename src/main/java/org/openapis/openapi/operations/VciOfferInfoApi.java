...
public class VciOfferInfoApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(VciOfferInfoApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<VciOfferInfoApiRequest, VciOfferInfoApiResponse> {
