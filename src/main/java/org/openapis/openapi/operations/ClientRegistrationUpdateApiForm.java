...
public class ClientRegistrationUpdateApiForm {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ClientRegistrationUpdateApiFormRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<ClientRegistrationUpdateApiFormRequest, ClientRegistrationUpdateApiFormResponse> {
