...
public class VciDeferredParseApiForm {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(VciDeferredParseApiFormRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<VciDeferredParseApiFormRequest, VciDeferredParseApiFormResponse> {
