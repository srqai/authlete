...
public class PushedAuthReqApiForm {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(PushedAuthReqApiFormRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<PushedAuthReqApiFormRequest, PushedAuthReqApiFormResponse> {
