...
import org.openapis.openapi.models.operations.ClientSecretUpdateApiFormResponseBody;
...
public class ClientSecretUpdateApiFormOperation implements RequestOperation<ClientSecretUpdateApiFormRequest, ClientSecretUpdateApiFormResponse> {
    
    /**
     * CLIENT_SECRET_UPDATE_API_FORM_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] CLIENT_SECRET_UPDATE_API_FORM_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public ClientSecretUpdateApiFormOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        CLIENT_SECRET_UPDATE_API_FORM_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(ClientSecretUpdateApiFormRequest request) throws Exception {
        String url = Utils.generateURL(
                ClientSecretUpdateApiFormRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ClientSecretUpdateApiFormRequest request) throws Exception {
    ...
    @Override
    public ClientSecretUpdateApiFormResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ClientSecretUpdateApiFormResponse.Builder resBuilder = 
        ...
        ClientSecretUpdateApiFormResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                ClientSecretUpdateApiFormResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
