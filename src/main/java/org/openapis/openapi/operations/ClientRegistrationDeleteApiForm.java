...
public class ClientRegistrationDeleteApiForm {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ClientRegistrationDeleteApiFormRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<ClientRegistrationDeleteApiFormRequest, ClientRegistrationDeleteApiFormResponse> {
