...
public class HskDeleteApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(HskDeleteApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<HskDeleteApiRequest, HskDeleteApiResponse> {
