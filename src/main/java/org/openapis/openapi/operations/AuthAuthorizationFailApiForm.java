...
public class AuthAuthorizationFailApiForm {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(AuthAuthorizationFailApiFormRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<AuthAuthorizationFailApiFormRequest, AuthAuthorizationFailApiFormResponse> {
