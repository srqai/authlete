...
public class AuthAuthorizationApiForm {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(AuthAuthorizationApiFormRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<AuthAuthorizationApiFormRequest, AuthAuthorizationApiFormResponse> {
