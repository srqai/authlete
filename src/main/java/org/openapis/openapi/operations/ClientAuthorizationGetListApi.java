...
public class ClientAuthorizationGetListApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ClientAuthorizationGetListApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<ClientAuthorizationGetListApiRequest, ClientAuthorizationGetListApiResponse> {
