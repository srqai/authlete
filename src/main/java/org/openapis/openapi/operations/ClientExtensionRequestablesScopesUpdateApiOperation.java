...
import org.openapis.openapi.models.operations.ClientExtensionRequestablesScopesUpdateApiResponseBody;
...
public class ClientExtensionRequestablesScopesUpdateApiOperation implements RequestOperation<ClientExtensionRequestablesScopesUpdateApiRequest, ClientExtensionRequestablesScopesUpdateApiResponse> {
    
    /**
     * CLIENT_EXTENSION_REQUESTABLES_SCOPES_UPDATE_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] CLIENT_EXTENSION_REQUESTABLES_SCOPES_UPDATE_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public ClientExtensionRequestablesScopesUpdateApiOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        CLIENT_EXTENSION_REQUESTABLES_SCOPES_UPDATE_API_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(ClientExtensionRequestablesScopesUpdateApiRequest request) throws Exception {
        String url = Utils.generateURL(
                ClientExtensionRequestablesScopesUpdateApiRequest.class,
                this.baseUrl,
        ...
        return sdkConfiguration.hooks().beforeRequest(
              new BeforeRequestContextImpl(
                  ...
                  this.baseUrl,
                  "client_extension_requestables_scopes_update_api",
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ClientExtensionRequestablesScopesUpdateApiRequest request) throws Exception {
    ...
    @Override
    public ClientExtensionRequestablesScopesUpdateApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ClientExtensionRequestablesScopesUpdateApiResponse.Builder resBuilder = 
        ...
        ClientExtensionRequestablesScopesUpdateApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                ClientExtensionRequestablesScopesUpdateApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
