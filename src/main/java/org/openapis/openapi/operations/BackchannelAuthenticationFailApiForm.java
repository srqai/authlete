...
public class BackchannelAuthenticationFailApiForm {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(BackchannelAuthenticationFailApiFormRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<BackchannelAuthenticationFailApiFormRequest, BackchannelAuthenticationFailApiFormResponse> {
