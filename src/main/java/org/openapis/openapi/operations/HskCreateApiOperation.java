...
import org.openapis.openapi.models.operations.HskCreateApiResponseBody;
...
public class HskCreateApiOperation implements RequestOperation<HskCreateApiRequest, HskCreateApiResponse> {
    
    /**
     * HSK_CREATE_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] HSK_CREATE_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public HttpRequest buildRequest(HskCreateApiRequest request) throws Exception {
        String url = Utils.generateURL(
                HskCreateApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(HskCreateApiRequest request) throws Exception {
    ...
    @Override
    public HskCreateApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        HskCreateApiResponse.Builder resBuilder = 
        ...
        HskCreateApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                HskCreateApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
