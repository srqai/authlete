...
public class ClientUpdateApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ClientUpdateApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<ClientUpdateApiRequest, ClientUpdateApiResponse> {
