...
import org.openapis.openapi.models.operations.AuthIntrospectionApiFormResponseBody;
...
public class AuthIntrospectionApiFormOperation implements RequestOperation<AuthIntrospectionApiFormRequest, AuthIntrospectionApiFormResponse> {
    
    /**
     * AUTH_INTROSPECTION_API_FORM_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] AUTH_INTROSPECTION_API_FORM_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public AuthIntrospectionApiFormOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        AUTH_INTROSPECTION_API_FORM_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(AuthIntrospectionApiFormRequest request) throws Exception {
        String url = Utils.generateURL(
                AuthIntrospectionApiFormRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AuthIntrospectionApiFormRequest request) throws Exception {
    ...
    @Override
    public AuthIntrospectionApiFormResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        AuthIntrospectionApiFormResponse.Builder resBuilder = 
        ...
        AuthIntrospectionApiFormResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                AuthIntrospectionApiFormResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
