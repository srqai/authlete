...
import org.openapis.openapi.models.operations.ServiceUpdateApiResponseBody;
...
public class ServiceUpdateApiOperation implements RequestOperation<ServiceUpdateApiRequest, ServiceUpdateApiResponse> {
    
    /**
     * SERVICE_UPDATE_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] SERVICE_UPDATE_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public ServiceUpdateApiOperation(
    ...
    public HttpRequest buildRequest(ServiceUpdateApiRequest request) throws Exception {
        String url = Utils.generateURL(
                ServiceUpdateApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ServiceUpdateApiRequest request) throws Exception {
    ...
    @Override
    public ServiceUpdateApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ServiceUpdateApiResponse.Builder resBuilder = 
        ...
        ServiceUpdateApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                ServiceUpdateApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
