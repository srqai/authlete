...
import org.openapis.openapi.models.operations.AuthUserinfoIssueApiFormResponseBody;
...
public class AuthUserinfoIssueApiFormOperation implements RequestOperation<AuthUserinfoIssueApiFormRequest, AuthUserinfoIssueApiFormResponse> {
    
    /**
     * AUTH_USERINFO_ISSUE_API_FORM_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] AUTH_USERINFO_ISSUE_API_FORM_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public AuthUserinfoIssueApiFormOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        AUTH_USERINFO_ISSUE_API_FORM_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(AuthUserinfoIssueApiFormRequest request) throws Exception {
        String url = Utils.generateURL(
                AuthUserinfoIssueApiFormRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AuthUserinfoIssueApiFormRequest request) throws Exception {
    ...
    @Override
    public AuthUserinfoIssueApiFormResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        AuthUserinfoIssueApiFormResponse.Builder resBuilder = 
        ...
        AuthUserinfoIssueApiFormResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                AuthUserinfoIssueApiFormResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
