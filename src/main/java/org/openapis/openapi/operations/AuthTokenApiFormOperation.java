...
import org.openapis.openapi.models.operations.AuthTokenApiFormResponseBody;
...
public class AuthTokenApiFormOperation implements RequestOperation<AuthTokenApiFormRequest, AuthTokenApiFormResponse> {
    
    /**
     * AUTH_TOKEN_API_FORM_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] AUTH_TOKEN_API_FORM_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public AuthTokenApiFormOperation(
    ...
    public HttpRequest buildRequest(AuthTokenApiFormRequest request) throws Exception {
        String url = Utils.generateURL(
                AuthTokenApiFormRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AuthTokenApiFormRequest request) throws Exception {
    ...
    @Override
    public AuthTokenApiFormResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        AuthTokenApiFormResponse.Builder resBuilder = 
        ...
        AuthTokenApiFormResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                AuthTokenApiFormResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
