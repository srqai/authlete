...
import org.openapis.openapi.models.operations.ClientRegistrationUpdateApiFormResponseBody;
...
public class ClientRegistrationUpdateApiFormOperation implements RequestOperation<ClientRegistrationUpdateApiFormRequest, ClientRegistrationUpdateApiFormResponse> {
    
    /**
     * CLIENT_REGISTRATION_UPDATE_API_FORM_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] CLIENT_REGISTRATION_UPDATE_API_FORM_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public ClientRegistrationUpdateApiFormOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        CLIENT_REGISTRATION_UPDATE_API_FORM_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(ClientRegistrationUpdateApiFormRequest request) throws Exception {
        String url = Utils.generateURL(
                ClientRegistrationUpdateApiFormRequest.class,
                this.baseUrl,
        ...
        return sdkConfiguration.hooks().beforeRequest(
              new BeforeRequestContextImpl(
                  ...
                  this.baseUrl,
                  "client_registration_update_api_form",
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ClientRegistrationUpdateApiFormRequest request) throws Exception {
    ...
    @Override
    public ClientRegistrationUpdateApiFormResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ClientRegistrationUpdateApiFormResponse.Builder resBuilder = 
        ...
        ClientRegistrationUpdateApiFormResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                ClientRegistrationUpdateApiFormResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
