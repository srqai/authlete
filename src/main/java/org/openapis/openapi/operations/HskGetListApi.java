...
public class HskGetListApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(HskGetListApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<HskGetListApiRequest, HskGetListApiResponse> {
