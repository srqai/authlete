...
public class AuthTokenIssueApiForm {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(AuthTokenIssueApiFormRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<AuthTokenIssueApiFormRequest, AuthTokenIssueApiFormResponse> {
