...
public class ClientAuthorizationUpdateApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ClientAuthorizationUpdateApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<ClientAuthorizationUpdateApiRequest, ClientAuthorizationUpdateApiResponse> {
