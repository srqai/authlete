...
import org.openapis.openapi.models.operations.ClientFlagUpdateApiFormResponseBody;
...
public class ClientFlagUpdateApiFormOperation implements RequestOperation<ClientFlagUpdateApiFormRequest, ClientFlagUpdateApiFormResponse> {
    ...
    public ClientFlagUpdateApiFormOperation(@Nonnull SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ClientFlagUpdateApiFormRequest request) throws Exception {
        String url = Utils.generateURL(
                ClientFlagUpdateApiFormRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ClientFlagUpdateApiFormRequest request) throws Exception {
    ...
    @Override
    public ClientFlagUpdateApiFormResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ClientFlagUpdateApiFormResponse.Builder resBuilder = 
        ...
        ClientFlagUpdateApiFormResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                ClientFlagUpdateApiFormResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
