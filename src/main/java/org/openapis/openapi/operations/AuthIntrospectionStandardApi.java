...
public class AuthIntrospectionStandardApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(AuthIntrospectionStandardApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<AuthIntrospectionStandardApiRequest, AuthIntrospectionStandardApiResponse> {
