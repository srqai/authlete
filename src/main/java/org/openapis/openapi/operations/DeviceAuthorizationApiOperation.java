...
import org.openapis.openapi.models.operations.DeviceAuthorizationApiResponseBody;
...
public class DeviceAuthorizationApiOperation implements RequestOperation<DeviceAuthorizationApiRequest, DeviceAuthorizationApiResponse> {
    
    /**
     * DEVICE_AUTHORIZATION_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] DEVICE_AUTHORIZATION_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public DeviceAuthorizationApiOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        DEVICE_AUTHORIZATION_API_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(DeviceAuthorizationApiRequest request) throws Exception {
        String url = Utils.generateURL(
                DeviceAuthorizationApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(DeviceAuthorizationApiRequest request) throws Exception {
    ...
    @Override
    public DeviceAuthorizationApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        DeviceAuthorizationApiResponse.Builder resBuilder = 
        ...
        DeviceAuthorizationApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                DeviceAuthorizationApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
