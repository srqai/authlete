...
import org.openapis.openapi.models.operations.BackchannelAuthenticationIssueApiResponseBody;
...
public class BackchannelAuthenticationIssueApiOperation implements RequestOperation<BackchannelAuthenticationIssueApiRequest, BackchannelAuthenticationIssueApiResponse> {
    
    /**
     * BACKCHANNEL_AUTHENTICATION_ISSUE_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] BACKCHANNEL_AUTHENTICATION_ISSUE_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public BackchannelAuthenticationIssueApiOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        BACKCHANNEL_AUTHENTICATION_ISSUE_API_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(BackchannelAuthenticationIssueApiRequest request) throws Exception {
        String url = Utils.generateURL(
                BackchannelAuthenticationIssueApiRequest.class,
                this.baseUrl,
        ...
        return sdkConfiguration.hooks().beforeRequest(
              new BeforeRequestContextImpl(
                  ...
                  this.baseUrl,
                  "backchannel_authentication_issue_api",
    ...
    @Override
    public HttpResponse<InputStream> doRequest(BackchannelAuthenticationIssueApiRequest request) throws Exception {
    ...
    @Override
    public BackchannelAuthenticationIssueApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        BackchannelAuthenticationIssueApiResponse.Builder resBuilder = 
        ...
        BackchannelAuthenticationIssueApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                BackchannelAuthenticationIssueApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
