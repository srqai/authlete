...
public class AuthAuthorizationIssueApiForm {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(AuthAuthorizationIssueApiFormRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<AuthAuthorizationIssueApiFormRequest, AuthAuthorizationIssueApiFormResponse> {
