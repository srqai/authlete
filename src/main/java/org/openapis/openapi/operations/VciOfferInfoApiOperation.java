...
import org.openapis.openapi.models.operations.VciOfferInfoApiResponseBody;
...
public class VciOfferInfoApiOperation implements RequestOperation<VciOfferInfoApiRequest, VciOfferInfoApiResponse> {
    
    /**
     * VCI_OFFER_INFO_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] VCI_OFFER_INFO_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public VciOfferInfoApiOperation(
    ...
    public HttpRequest buildRequest(VciOfferInfoApiRequest request) throws Exception {
        String url = Utils.generateURL(
                VciOfferInfoApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(VciOfferInfoApiRequest request) throws Exception {
    ...
    @Override
    public VciOfferInfoApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        VciOfferInfoApiResponse.Builder resBuilder = 
        ...
        VciOfferInfoApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                VciOfferInfoApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
