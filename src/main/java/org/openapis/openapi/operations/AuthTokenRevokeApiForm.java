...
public class AuthTokenRevokeApiForm {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(AuthTokenRevokeApiFormRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<AuthTokenRevokeApiFormRequest, AuthTokenRevokeApiFormResponse> {
