...
import org.openapis.openapi.models.operations.VciBatchParseApiFormResponseBody;
...
public class VciBatchParseApiFormOperation implements RequestOperation<VciBatchParseApiFormRequest, VciBatchParseApiFormResponse> {
    
    /**
     * VCI_BATCH_PARSE_API_FORM_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] VCI_BATCH_PARSE_API_FORM_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public VciBatchParseApiFormOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        VCI_BATCH_PARSE_API_FORM_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(VciBatchParseApiFormRequest request) throws Exception {
        String url = Utils.generateURL(
                VciBatchParseApiFormRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(VciBatchParseApiFormRequest request) throws Exception {
    ...
    @Override
    public VciBatchParseApiFormResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        VciBatchParseApiFormResponse.Builder resBuilder = 
        ...
        VciBatchParseApiFormResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                VciBatchParseApiFormResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
