...
import org.openapis.openapi.models.operations.ClientExtensionRequestablesScopesGetApiResponseBody;
...
public class ClientExtensionRequestablesScopesGetApiOperation implements RequestOperation<ClientExtensionRequestablesScopesGetApiRequest, ClientExtensionRequestablesScopesGetApiResponse> {
    
    /**
     * CLIENT_EXTENSION_REQUESTABLES_SCOPES_GET_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] CLIENT_EXTENSION_REQUESTABLES_SCOPES_GET_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public ClientExtensionRequestablesScopesGetApiOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        CLIENT_EXTENSION_REQUESTABLES_SCOPES_GET_API_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(ClientExtensionRequestablesScopesGetApiRequest request) throws Exception {
        String url = Utils.generateURL(
                ClientExtensionRequestablesScopesGetApiRequest.class,
                this.baseUrl,
        ...
        return sdkConfiguration.hooks().beforeRequest(
              new BeforeRequestContextImpl(
                  ...
                  this.baseUrl,
                  "client_extension_requestables_scopes_get_api",
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ClientExtensionRequestablesScopesGetApiRequest request) throws Exception {
    ...
    @Override
    public ClientExtensionRequestablesScopesGetApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ClientExtensionRequestablesScopesGetApiResponse.Builder resBuilder = 
        ...
        ClientExtensionRequestablesScopesGetApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                ClientExtensionRequestablesScopesGetApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
