...
import org.openapis.openapi.models.operations.AuthTokenIssueApiResponseBody;
...
public class AuthTokenIssueApiOperation implements RequestOperation<AuthTokenIssueApiRequest, AuthTokenIssueApiResponse> {
    
    /**
     * AUTH_TOKEN_ISSUE_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] AUTH_TOKEN_ISSUE_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public AuthTokenIssueApiOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        AUTH_TOKEN_ISSUE_API_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(AuthTokenIssueApiRequest request) throws Exception {
        String url = Utils.generateURL(
                AuthTokenIssueApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AuthTokenIssueApiRequest request) throws Exception {
    ...
    @Override
    public AuthTokenIssueApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        AuthTokenIssueApiResponse.Builder resBuilder = 
        ...
        AuthTokenIssueApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                AuthTokenIssueApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
