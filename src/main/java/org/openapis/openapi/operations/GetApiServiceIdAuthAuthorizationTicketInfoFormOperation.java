...
import org.openapis.openapi.models.operations.GetApiServiceIdAuthAuthorizationTicketInfoFormResponseBody;
...
public class GetApiServiceIdAuthAuthorizationTicketInfoFormOperation implements RequestOperation<GetApiServiceIdAuthAuthorizationTicketInfoFormRequest, GetApiServiceIdAuthAuthorizationTicketInfoFormResponse> {
    ...
    public GetApiServiceIdAuthAuthorizationTicketInfoFormOperation(@Nonnull SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetApiServiceIdAuthAuthorizationTicketInfoFormRequest request) throws Exception {
        String url = Utils.generateURL(
                GetApiServiceIdAuthAuthorizationTicketInfoFormRequest.class,
                this.baseUrl,
        ...
        return sdkConfiguration.hooks().beforeRequest(
              new BeforeRequestContextImpl(
                  ...
                  this.baseUrl,
                  "get_/api/{serviceId}/auth/authorization/ticket/info_form",
    ...
    @Override
    public HttpResponse<InputStream> doRequest(GetApiServiceIdAuthAuthorizationTicketInfoFormRequest request) throws Exception {
    ...
    @Override
    public GetApiServiceIdAuthAuthorizationTicketInfoFormResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        GetApiServiceIdAuthAuthorizationTicketInfoFormResponse.Builder resBuilder = 
            GetApiServiceIdAuthAuthorizationTicketInfoFormResponse
                .builder()
                .contentType(contentType)
                .statusCode(response.statusCode())
                .rawResponse(response);

        GetApiServiceIdAuthAuthorizationTicketInfoFormResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                GetApiServiceIdAuthAuthorizationTicketInfoFormResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
