...
public class AuthTokenUpdateApiForm {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(AuthTokenUpdateApiFormRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<AuthTokenUpdateApiFormRequest, AuthTokenUpdateApiFormResponse> {
