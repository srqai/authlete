...
public class BackchannelAuthenticationApiForm {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(BackchannelAuthenticationApiFormRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<BackchannelAuthenticationApiFormRequest, BackchannelAuthenticationApiFormResponse> {
