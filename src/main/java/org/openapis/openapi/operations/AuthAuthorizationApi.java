...
public class AuthAuthorizationApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(AuthAuthorizationApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<AuthAuthorizationApiRequest, AuthAuthorizationApiResponse> {
