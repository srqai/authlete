...
public class VciSingleParseApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(VciSingleParseApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<VciSingleParseApiRequest, VciSingleParseApiResponse> {
