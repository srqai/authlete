...
public class AuthUserinfoIssueApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(AuthUserinfoIssueApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<AuthUserinfoIssueApiRequest, AuthUserinfoIssueApiResponse> {
