...
public class VciBatchIssueApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(VciBatchIssueApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<VciBatchIssueApiRequest, VciBatchIssueApiResponse> {
