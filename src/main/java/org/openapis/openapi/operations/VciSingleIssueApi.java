...
public class VciSingleIssueApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(VciSingleIssueApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<VciSingleIssueApiRequest, VciSingleIssueApiResponse> {
