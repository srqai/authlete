...
import org.openapis.openapi.models.operations.ClientCreateApiResponseBody;
...
public class ClientCreateApiOperation implements RequestOperation<ClientCreateApiRequest, ClientCreateApiResponse> {
    
    /**
     * CLIENT_CREATE_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] CLIENT_CREATE_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public ClientCreateApiOperation(
    ...
    public HttpRequest buildRequest(ClientCreateApiRequest request) throws Exception {
        String url = Utils.generateURL(
                ClientCreateApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ClientCreateApiRequest request) throws Exception {
    ...
    @Override
    public ClientCreateApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ClientCreateApiResponse.Builder resBuilder = 
        ...
        ClientCreateApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                ClientCreateApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
