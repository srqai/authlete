...
import org.openapis.openapi.models.operations.VciOfferCreateApiResponseBody;
...
public class VciOfferCreateApiOperation implements RequestOperation<VciOfferCreateApiRequest, VciOfferCreateApiResponse> {
    
    /**
     * VCI_OFFER_CREATE_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] VCI_OFFER_CREATE_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public VciOfferCreateApiOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        VCI_OFFER_CREATE_API_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(VciOfferCreateApiRequest request) throws Exception {
        String url = Utils.generateURL(
                VciOfferCreateApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(VciOfferCreateApiRequest request) throws Exception {
    ...
    @Override
    public VciOfferCreateApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        VciOfferCreateApiResponse.Builder resBuilder = 
        ...
        VciOfferCreateApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                VciOfferCreateApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
