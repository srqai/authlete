...
public class BackchannelAuthenticationIssueApiForm {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(BackchannelAuthenticationIssueApiFormRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<BackchannelAuthenticationIssueApiFormRequest, BackchannelAuthenticationIssueApiFormResponse> {
