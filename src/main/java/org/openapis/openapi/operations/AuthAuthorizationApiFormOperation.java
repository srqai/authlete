...
import org.openapis.openapi.models.operations.AuthAuthorizationApiFormResponseBody;
...
public class AuthAuthorizationApiFormOperation implements RequestOperation<AuthAuthorizationApiFormRequest, AuthAuthorizationApiFormResponse> {
    
    /**
     * AUTH_AUTHORIZATION_API_FORM_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] AUTH_AUTHORIZATION_API_FORM_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public AuthAuthorizationApiFormOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        AUTH_AUTHORIZATION_API_FORM_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(AuthAuthorizationApiFormRequest request) throws Exception {
        String url = Utils.generateURL(
                AuthAuthorizationApiFormRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AuthAuthorizationApiFormRequest request) throws Exception {
    ...
    @Override
    public AuthAuthorizationApiFormResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        AuthAuthorizationApiFormResponse.Builder resBuilder = 
        ...
        AuthAuthorizationApiFormResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                AuthAuthorizationApiFormResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
