...
import org.openapis.openapi.models.operations.IdtokenReissueApiResponseBody;
...
public class IdtokenReissueApiOperation implements RequestOperation<IdtokenReissueApiRequest, IdtokenReissueApiResponse> {
    
    /**
     * IDTOKEN_REISSUE_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] IDTOKEN_REISSUE_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public IdtokenReissueApiOperation(
    ...
    public HttpRequest buildRequest(IdtokenReissueApiRequest request) throws Exception {
        String url = Utils.generateURL(
                IdtokenReissueApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(IdtokenReissueApiRequest request) throws Exception {
    ...
    @Override
    public IdtokenReissueApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        IdtokenReissueApiResponse.Builder resBuilder = 
        ...
        IdtokenReissueApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                IdtokenReissueApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
