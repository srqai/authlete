...
import org.openapis.openapi.models.operations.VciSingleParseApiResponseBody;
...
public class VciSingleParseApiOperation implements RequestOperation<VciSingleParseApiRequest, VciSingleParseApiResponse> {
    
    /**
     * VCI_SINGLE_PARSE_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] VCI_SINGLE_PARSE_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public VciSingleParseApiOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        VCI_SINGLE_PARSE_API_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(VciSingleParseApiRequest request) throws Exception {
        String url = Utils.generateURL(
                VciSingleParseApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(VciSingleParseApiRequest request) throws Exception {
    ...
    @Override
    public VciSingleParseApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        VciSingleParseApiResponse.Builder resBuilder = 
        ...
        VciSingleParseApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                VciSingleParseApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
