...
import org.openapis.openapi.models.operations.AuthTokenRevokeApiFormResponseBody;
...
public class AuthTokenRevokeApiFormOperation implements RequestOperation<AuthTokenRevokeApiFormRequest, AuthTokenRevokeApiFormResponse> {
    
    /**
     * AUTH_TOKEN_REVOKE_API_FORM_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] AUTH_TOKEN_REVOKE_API_FORM_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public AuthTokenRevokeApiFormOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        AUTH_TOKEN_REVOKE_API_FORM_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(AuthTokenRevokeApiFormRequest request) throws Exception {
        String url = Utils.generateURL(
                AuthTokenRevokeApiFormRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AuthTokenRevokeApiFormRequest request) throws Exception {
    ...
    @Override
    public AuthTokenRevokeApiFormResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        AuthTokenRevokeApiFormResponse.Builder resBuilder = 
        ...
        AuthTokenRevokeApiFormResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                AuthTokenRevokeApiFormResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
