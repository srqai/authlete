...
public class BackchannelAuthenticationApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(BackchannelAuthenticationApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<BackchannelAuthenticationApiRequest, BackchannelAuthenticationApiResponse> {
