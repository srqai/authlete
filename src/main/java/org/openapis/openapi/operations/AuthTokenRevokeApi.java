...
public class AuthTokenRevokeApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(AuthTokenRevokeApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<AuthTokenRevokeApiRequest, AuthTokenRevokeApiResponse> {
