...
public class ClientExtensionRequestablesScopesDeleteApiOperation implements RequestOperation<ClientExtensionRequestablesScopesDeleteApiRequest, ClientExtensionRequestablesScopesDeleteApiResponse> {
    ...
    /**
     * CLIENT_EXTENSION_REQUESTABLES_SCOPES_DELETE_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] CLIENT_EXTENSION_REQUESTABLES_SCOPES_DELETE_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public ClientExtensionRequestablesScopesDeleteApiOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        CLIENT_EXTENSION_REQUESTABLES_SCOPES_DELETE_API_SERVERS[0], 
                        Map.of()));
