...
import org.openapis.openapi.models.operations.ServiceGetApiResponseBody;
...
public class ServiceGetApiOperation implements RequestOperation<ServiceGetApiRequest, ServiceGetApiResponse> {
    
    /**
     * SERVICE_GET_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] SERVICE_GET_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public HttpRequest buildRequest(ServiceGetApiRequest request) throws Exception {
        String url = Utils.generateURL(
                ServiceGetApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ServiceGetApiRequest request) throws Exception {
    ...
    @Override
    public ServiceGetApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ServiceGetApiResponse.Builder resBuilder = 
        ...
        ServiceGetApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                ServiceGetApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
