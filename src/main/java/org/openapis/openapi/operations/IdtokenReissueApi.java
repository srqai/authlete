...
public class IdtokenReissueApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(IdtokenReissueApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<IdtokenReissueApiRequest, IdtokenReissueApiResponse> {
