...
public class VciBatchParseApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(VciBatchParseApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<VciBatchParseApiRequest, VciBatchParseApiResponse> {
