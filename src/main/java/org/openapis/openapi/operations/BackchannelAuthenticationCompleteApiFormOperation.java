...
import org.openapis.openapi.models.operations.BackchannelAuthenticationCompleteApiFormResponseBody;
...
public class BackchannelAuthenticationCompleteApiFormOperation implements RequestOperation<BackchannelAuthenticationCompleteApiFormRequest, BackchannelAuthenticationCompleteApiFormResponse> {
    
    /**
     * BACKCHANNEL_AUTHENTICATION_COMPLETE_API_FORM_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] BACKCHANNEL_AUTHENTICATION_COMPLETE_API_FORM_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public BackchannelAuthenticationCompleteApiFormOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        BACKCHANNEL_AUTHENTICATION_COMPLETE_API_FORM_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(BackchannelAuthenticationCompleteApiFormRequest request) throws Exception {
        String url = Utils.generateURL(
                BackchannelAuthenticationCompleteApiFormRequest.class,
                this.baseUrl,
        ...
        return sdkConfiguration.hooks().beforeRequest(
              new BeforeRequestContextImpl(
                  ...
                  this.baseUrl,
                  "backchannel_authentication_complete_api_form",
    ...
    @Override
    public HttpResponse<InputStream> doRequest(BackchannelAuthenticationCompleteApiFormRequest request) throws Exception {
    ...
    @Override
    public BackchannelAuthenticationCompleteApiFormResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        BackchannelAuthenticationCompleteApiFormResponse.Builder resBuilder = 
        ...
        BackchannelAuthenticationCompleteApiFormResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                BackchannelAuthenticationCompleteApiFormResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
