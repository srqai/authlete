...
public class AuthIntrospectionStandardApiForm {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(AuthIntrospectionStandardApiFormRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<AuthIntrospectionStandardApiFormRequest, AuthIntrospectionStandardApiFormResponse> {
