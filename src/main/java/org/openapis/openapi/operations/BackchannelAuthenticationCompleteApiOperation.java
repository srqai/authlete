...
import org.openapis.openapi.models.operations.BackchannelAuthenticationCompleteApiResponseBody;
...
public class BackchannelAuthenticationCompleteApiOperation implements RequestOperation<BackchannelAuthenticationCompleteApiRequest, BackchannelAuthenticationCompleteApiResponse> {
    
    /**
     * BACKCHANNEL_AUTHENTICATION_COMPLETE_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] BACKCHANNEL_AUTHENTICATION_COMPLETE_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public BackchannelAuthenticationCompleteApiOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        BACKCHANNEL_AUTHENTICATION_COMPLETE_API_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(BackchannelAuthenticationCompleteApiRequest request) throws Exception {
        String url = Utils.generateURL(
                BackchannelAuthenticationCompleteApiRequest.class,
                this.baseUrl,
        ...
        return sdkConfiguration.hooks().beforeRequest(
              new BeforeRequestContextImpl(
                  ...
                  this.baseUrl,
                  "backchannel_authentication_complete_api",
    ...
    @Override
    public HttpResponse<InputStream> doRequest(BackchannelAuthenticationCompleteApiRequest request) throws Exception {
    ...
    @Override
    public BackchannelAuthenticationCompleteApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        BackchannelAuthenticationCompleteApiResponse.Builder resBuilder = 
        ...
        BackchannelAuthenticationCompleteApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                BackchannelAuthenticationCompleteApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
