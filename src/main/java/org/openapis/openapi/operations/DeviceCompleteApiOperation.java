...
import org.openapis.openapi.models.operations.DeviceCompleteApiResponseBody;
...
public class DeviceCompleteApiOperation implements RequestOperation<DeviceCompleteApiRequest, DeviceCompleteApiResponse> {
    
    /**
     * DEVICE_COMPLETE_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] DEVICE_COMPLETE_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public DeviceCompleteApiOperation(
    ...
    public HttpRequest buildRequest(DeviceCompleteApiRequest request) throws Exception {
        String url = Utils.generateURL(
                DeviceCompleteApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(DeviceCompleteApiRequest request) throws Exception {
    ...
    @Override
    public DeviceCompleteApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        DeviceCompleteApiResponse.Builder resBuilder = 
        ...
        DeviceCompleteApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                DeviceCompleteApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
