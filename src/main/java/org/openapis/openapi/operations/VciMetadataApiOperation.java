...
import org.openapis.openapi.models.operations.VciMetadataApiResponseBody;
...
public class VciMetadataApiOperation implements RequestOperation<VciMetadataApiRequest, VciMetadataApiResponse> {
    
    /**
     * VCI_METADATA_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] VCI_METADATA_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public VciMetadataApiOperation(
    ...
    public HttpRequest buildRequest(VciMetadataApiRequest request) throws Exception {
        String url = Utils.generateURL(
                VciMetadataApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(VciMetadataApiRequest request) throws Exception {
    ...
    @Override
    public VciMetadataApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        VciMetadataApiResponse.Builder resBuilder = 
        ...
        VciMetadataApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                VciMetadataApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
