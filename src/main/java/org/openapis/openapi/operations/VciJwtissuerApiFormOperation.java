...
import org.openapis.openapi.models.operations.VciJwtissuerApiFormResponseBody;
...
public class VciJwtissuerApiFormOperation implements RequestOperation<VciJwtissuerApiFormRequest, VciJwtissuerApiFormResponse> {
    
    /**
     * VCI_JWTISSUER_API_FORM_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] VCI_JWTISSUER_API_FORM_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public VciJwtissuerApiFormOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        VCI_JWTISSUER_API_FORM_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(VciJwtissuerApiFormRequest request) throws Exception {
        String url = Utils.generateURL(
                VciJwtissuerApiFormRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(VciJwtissuerApiFormRequest request) throws Exception {
    ...
    @Override
    public VciJwtissuerApiFormResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        VciJwtissuerApiFormResponse.Builder resBuilder = 
        ...
        VciJwtissuerApiFormResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                VciJwtissuerApiFormResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
