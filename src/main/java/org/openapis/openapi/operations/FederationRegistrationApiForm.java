...
public class FederationRegistrationApiForm {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(FederationRegistrationApiFormRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<FederationRegistrationApiFormRequest, FederationRegistrationApiFormResponse> {
