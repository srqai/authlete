...
import org.openapis.openapi.models.operations.BackchannelAuthenticationFailApiFormResponseBody;
...
public class BackchannelAuthenticationFailApiFormOperation implements RequestOperation<BackchannelAuthenticationFailApiFormRequest, BackchannelAuthenticationFailApiFormResponse> {
    
    /**
     * BACKCHANNEL_AUTHENTICATION_FAIL_API_FORM_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] BACKCHANNEL_AUTHENTICATION_FAIL_API_FORM_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public BackchannelAuthenticationFailApiFormOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        BACKCHANNEL_AUTHENTICATION_FAIL_API_FORM_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(BackchannelAuthenticationFailApiFormRequest request) throws Exception {
        String url = Utils.generateURL(
                BackchannelAuthenticationFailApiFormRequest.class,
                this.baseUrl,
        ...
        return sdkConfiguration.hooks().beforeRequest(
              new BeforeRequestContextImpl(
                  ...
                  this.baseUrl,
                  "backchannel_authentication_fail_api_form",
    ...
    @Override
    public HttpResponse<InputStream> doRequest(BackchannelAuthenticationFailApiFormRequest request) throws Exception {
    ...
    @Override
    public BackchannelAuthenticationFailApiFormResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        BackchannelAuthenticationFailApiFormResponse.Builder resBuilder = 
        ...
        BackchannelAuthenticationFailApiFormResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                BackchannelAuthenticationFailApiFormResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
