...
public class ServiceUpdateApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ServiceUpdateApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<ServiceUpdateApiRequest, ServiceUpdateApiResponse> {
