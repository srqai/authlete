...
import org.openapis.openapi.models.operations.VciOfferCreateApiFormResponseBody;
...
public class VciOfferCreateApiFormOperation implements RequestOperation<VciOfferCreateApiFormRequest, VciOfferCreateApiFormResponse> {
    
    /**
     * VCI_OFFER_CREATE_API_FORM_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] VCI_OFFER_CREATE_API_FORM_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public VciOfferCreateApiFormOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        VCI_OFFER_CREATE_API_FORM_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(VciOfferCreateApiFormRequest request) throws Exception {
        String url = Utils.generateURL(
                VciOfferCreateApiFormRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(VciOfferCreateApiFormRequest request) throws Exception {
    ...
    @Override
    public VciOfferCreateApiFormResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        VciOfferCreateApiFormResponse.Builder resBuilder = 
        ...
        VciOfferCreateApiFormResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                VciOfferCreateApiFormResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
