...
public class AuthTokenGetListApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(AuthTokenGetListApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<AuthTokenGetListApiRequest, AuthTokenGetListApiResponse> {
