...
import org.openapis.openapi.models.operations.AuthAuthorizationFailApiFormResponseBody;
...
public class AuthAuthorizationFailApiFormOperation implements RequestOperation<AuthAuthorizationFailApiFormRequest, AuthAuthorizationFailApiFormResponse> {
    
    /**
     * AUTH_AUTHORIZATION_FAIL_API_FORM_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] AUTH_AUTHORIZATION_FAIL_API_FORM_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public AuthAuthorizationFailApiFormOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        AUTH_AUTHORIZATION_FAIL_API_FORM_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(AuthAuthorizationFailApiFormRequest request) throws Exception {
        String url = Utils.generateURL(
                AuthAuthorizationFailApiFormRequest.class,
                this.baseUrl,
        ...
        return sdkConfiguration.hooks().beforeRequest(
              new BeforeRequestContextImpl(
                  ...
                  this.baseUrl,
                  "auth_authorization_fail_api_form",
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AuthAuthorizationFailApiFormRequest request) throws Exception {
    ...
    @Override
    public AuthAuthorizationFailApiFormResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        AuthAuthorizationFailApiFormResponse.Builder resBuilder = 
        ...
        AuthAuthorizationFailApiFormResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                AuthAuthorizationFailApiFormResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
