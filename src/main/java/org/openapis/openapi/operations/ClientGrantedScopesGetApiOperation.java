...
import org.openapis.openapi.models.operations.ClientGrantedScopesGetApiResponseBody;
...
public class ClientGrantedScopesGetApiOperation implements RequestOperation<ClientGrantedScopesGetApiRequest, ClientGrantedScopesGetApiResponse> {
    
    /**
     * CLIENT_GRANTED_SCOPES_GET_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] CLIENT_GRANTED_SCOPES_GET_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public ClientGrantedScopesGetApiOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        CLIENT_GRANTED_SCOPES_GET_API_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(ClientGrantedScopesGetApiRequest request) throws Exception {
        String url = Utils.generateURL(
                ClientGrantedScopesGetApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ClientGrantedScopesGetApiRequest request) throws Exception {
    ...
    @Override
    public ClientGrantedScopesGetApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ClientGrantedScopesGetApiResponse.Builder resBuilder = 
        ...
        ClientGrantedScopesGetApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                ClientGrantedScopesGetApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
