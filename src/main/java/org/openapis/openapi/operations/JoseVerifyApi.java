...
public class JoseVerifyApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(JoseVerifyApiRequest request) throws Exception {
            String url = Utils.generateURL(
                    JoseVerifyApiRequest.class,
                    this.baseUrl,
    ...
    public static class Sync extends Base
            implements RequestOperation<JoseVerifyApiRequest, JoseVerifyApiResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(JoseVerifyApiRequest request) throws Exception {
        ...
        @Override
        public JoseVerifyApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            JoseVerifyApiResponse.Builder resBuilder =
            ...
            JoseVerifyApiResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    JoseVerifyApiResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withObject(out);
