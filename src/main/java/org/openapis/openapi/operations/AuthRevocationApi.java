...
public class AuthRevocationApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(AuthRevocationApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<AuthRevocationApiRequest, AuthRevocationApiResponse> {
