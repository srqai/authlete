...
public class ClientRegistrationApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ClientRegistrationApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<ClientRegistrationApiRequest, ClientRegistrationApiResponse> {
