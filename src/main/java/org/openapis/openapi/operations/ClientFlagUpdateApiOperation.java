...
import org.openapis.openapi.models.operations.ClientFlagUpdateApiResponseBody;
...
public class ClientFlagUpdateApiOperation implements RequestOperation<ClientFlagUpdateApiRequest, ClientFlagUpdateApiResponse> {
    
    /**
     * CLIENT_FLAG_UPDATE_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] CLIENT_FLAG_UPDATE_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public ClientFlagUpdateApiOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        CLIENT_FLAG_UPDATE_API_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(ClientFlagUpdateApiRequest request) throws Exception {
        String url = Utils.generateURL(
                ClientFlagUpdateApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ClientFlagUpdateApiRequest request) throws Exception {
    ...
    @Override
    public ClientFlagUpdateApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ClientFlagUpdateApiResponse.Builder resBuilder = 
        ...
        ClientFlagUpdateApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                ClientFlagUpdateApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
