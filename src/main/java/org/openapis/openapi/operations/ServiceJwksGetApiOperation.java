...
import org.openapis.openapi.models.operations.ServiceJwksGetApiResponseBody;
...
public class ServiceJwksGetApiOperation implements RequestOperation<ServiceJwksGetApiRequest, ServiceJwksGetApiResponse> {
    
    /**
     * SERVICE_JWKS_GET_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] SERVICE_JWKS_GET_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public ServiceJwksGetApiOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        SERVICE_JWKS_GET_API_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(ServiceJwksGetApiRequest request) throws Exception {
        String url = Utils.generateURL(
                ServiceJwksGetApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ServiceJwksGetApiRequest request) throws Exception {
    ...
    @Override
    public ServiceJwksGetApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ServiceJwksGetApiResponse.Builder resBuilder = 
        ...
        ServiceJwksGetApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                ServiceJwksGetApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
