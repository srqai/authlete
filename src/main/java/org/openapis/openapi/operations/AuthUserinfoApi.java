...
public class AuthUserinfoApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(AuthUserinfoApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<AuthUserinfoApiRequest, AuthUserinfoApiResponse> {
