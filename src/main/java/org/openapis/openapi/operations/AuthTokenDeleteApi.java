...
public class AuthTokenDeleteApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(AuthTokenDeleteApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<AuthTokenDeleteApiRequest, AuthTokenDeleteApiResponse> {
