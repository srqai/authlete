...
import org.openapis.openapi.models.operations.ClientRegistrationApiFormResponseBody;
...
public class ClientRegistrationApiFormOperation implements RequestOperation<ClientRegistrationApiFormRequest, ClientRegistrationApiFormResponse> {
    
    /**
     * CLIENT_REGISTRATION_API_FORM_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] CLIENT_REGISTRATION_API_FORM_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public ClientRegistrationApiFormOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        CLIENT_REGISTRATION_API_FORM_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(ClientRegistrationApiFormRequest request) throws Exception {
        String url = Utils.generateURL(
                ClientRegistrationApiFormRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ClientRegistrationApiFormRequest request) throws Exception {
    ...
    @Override
    public ClientRegistrationApiFormResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ClientRegistrationApiFormResponse.Builder resBuilder = 
        ...
        ClientRegistrationApiFormResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                ClientRegistrationApiFormResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
