...
import org.openapis.openapi.models.operations.ClientRegistrationDeleteApiResponseBody;
...
public class ClientRegistrationDeleteApiOperation implements RequestOperation<ClientRegistrationDeleteApiRequest, ClientRegistrationDeleteApiResponse> {
    
    /**
     * CLIENT_REGISTRATION_DELETE_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] CLIENT_REGISTRATION_DELETE_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public ClientRegistrationDeleteApiOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        CLIENT_REGISTRATION_DELETE_API_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(ClientRegistrationDeleteApiRequest request) throws Exception {
        String url = Utils.generateURL(
                ClientRegistrationDeleteApiRequest.class,
                this.baseUrl,
        ...
        return sdkConfiguration.hooks().beforeRequest(
              new BeforeRequestContextImpl(
                  ...
                  this.baseUrl,
                  "client_registration_delete_api",
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ClientRegistrationDeleteApiRequest request) throws Exception {
    ...
    @Override
    public ClientRegistrationDeleteApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ClientRegistrationDeleteApiResponse.Builder resBuilder = 
        ...
        ClientRegistrationDeleteApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                ClientRegistrationDeleteApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
