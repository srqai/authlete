...
public class FederationConfigurationApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(FederationConfigurationApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<FederationConfigurationApiRequest, FederationConfigurationApiResponse> {
