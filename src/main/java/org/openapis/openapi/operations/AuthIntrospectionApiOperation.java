...
import org.openapis.openapi.models.operations.AuthIntrospectionApiResponseBody;
...
public class AuthIntrospectionApiOperation implements RequestOperation<AuthIntrospectionApiRequest, AuthIntrospectionApiResponse> {
    
    /**
     * AUTH_INTROSPECTION_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] AUTH_INTROSPECTION_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public AuthIntrospectionApiOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        AUTH_INTROSPECTION_API_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(AuthIntrospectionApiRequest request) throws Exception {
        String url = Utils.generateURL(
                AuthIntrospectionApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AuthIntrospectionApiRequest request) throws Exception {
    ...
    @Override
    public AuthIntrospectionApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        AuthIntrospectionApiResponse.Builder resBuilder = 
        ...
        AuthIntrospectionApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                AuthIntrospectionApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
