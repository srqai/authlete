...
public class VciMetadataApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(VciMetadataApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<VciMetadataApiRequest, VciMetadataApiResponse> {
