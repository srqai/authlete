...
public class DeviceCompleteApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(DeviceCompleteApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeviceCompleteApiRequest, DeviceCompleteApiResponse> {
