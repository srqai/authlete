...
import org.openapis.openapi.models.operations.ClientGetApiResponseBody;
...
public class ClientGetApiOperation implements RequestOperation<ClientGetApiRequest, ClientGetApiResponse> {
    
    /**
     * CLIENT_GET_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] CLIENT_GET_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public HttpRequest buildRequest(ClientGetApiRequest request) throws Exception {
        String url = Utils.generateURL(
                ClientGetApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ClientGetApiRequest request) throws Exception {
    ...
    @Override
    public ClientGetApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ClientGetApiResponse.Builder resBuilder = 
        ...
        ClientGetApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                ClientGetApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
