...
import org.openapis.openapi.models.operations.HskGetApiResponseBody;
...
public class HskGetApiOperation implements RequestOperation<HskGetApiRequest, HskGetApiResponse> {
    
    /**
     * HSK_GET_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] HSK_GET_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public HttpRequest buildRequest(HskGetApiRequest request) throws Exception {
        String url = Utils.generateURL(
                HskGetApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(HskGetApiRequest request) throws Exception {
    ...
    @Override
    public HskGetApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        HskGetApiResponse.Builder resBuilder = 
            HskGetApiResponse
                .builder()
        ...
        HskGetApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                HskGetApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
