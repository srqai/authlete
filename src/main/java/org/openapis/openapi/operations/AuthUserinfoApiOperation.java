...
import org.openapis.openapi.models.operations.AuthUserinfoApiResponseBody;
...
public class AuthUserinfoApiOperation implements RequestOperation<AuthUserinfoApiRequest, AuthUserinfoApiResponse> {
    
    /**
     * AUTH_USERINFO_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] AUTH_USERINFO_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public AuthUserinfoApiOperation(
    ...
    public HttpRequest buildRequest(AuthUserinfoApiRequest request) throws Exception {
        String url = Utils.generateURL(
                AuthUserinfoApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AuthUserinfoApiRequest request) throws Exception {
    ...
    @Override
    public AuthUserinfoApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        AuthUserinfoApiResponse.Builder resBuilder = 
        ...
        AuthUserinfoApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                AuthUserinfoApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
