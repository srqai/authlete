...
public class AuthTokenCreateApiForm {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(AuthTokenCreateApiFormRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<AuthTokenCreateApiFormRequest, AuthTokenCreateApiFormResponse> {
