...
public class VciJwtissuerApiForm {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(VciJwtissuerApiFormRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<VciJwtissuerApiFormRequest, VciJwtissuerApiFormResponse> {
