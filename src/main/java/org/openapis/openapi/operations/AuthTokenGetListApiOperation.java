...
import org.openapis.openapi.models.operations.AuthTokenGetListApiResponseBody;
...
public class AuthTokenGetListApiOperation implements RequestOperation<AuthTokenGetListApiRequest, AuthTokenGetListApiResponse> {
    
    /**
     * AUTH_TOKEN_GET_LIST_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] AUTH_TOKEN_GET_LIST_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public AuthTokenGetListApiOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        AUTH_TOKEN_GET_LIST_API_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(AuthTokenGetListApiRequest request) throws Exception {
        String url = Utils.generateURL(
                AuthTokenGetListApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AuthTokenGetListApiRequest request) throws Exception {
    ...
    @Override
    public AuthTokenGetListApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        AuthTokenGetListApiResponse.Builder resBuilder = 
        ...
        AuthTokenGetListApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                AuthTokenGetListApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
