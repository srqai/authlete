...
public class VciJwksApiForm {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(VciJwksApiFormRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<VciJwksApiFormRequest, VciJwksApiFormResponse> {
