...
public class ClientGrantedScopesGetApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ClientGrantedScopesGetApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<ClientGrantedScopesGetApiRequest, ClientGrantedScopesGetApiResponse> {
