...
public class ClientExtensionRequestablesScopesGetApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ClientExtensionRequestablesScopesGetApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<ClientExtensionRequestablesScopesGetApiRequest, ClientExtensionRequestablesScopesGetApiResponse> {
