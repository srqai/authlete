...
public class ClientAuthorizationUpdateApiForm {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ClientAuthorizationUpdateApiFormRequest request) throws Exception {
            String url = Utils.generateURL(
                    ClientAuthorizationUpdateApiFormRequest.class,
                    this.baseUrl,
            ...
            return sdkConfiguration.hooks().beforeRequest(
                    new BeforeRequestContextImpl(
                            ...
                            this.baseUrl,
                            "client_authorization_update_api_form",
    ...
    public static class Sync extends Base
            implements RequestOperation<ClientAuthorizationUpdateApiFormRequest, ClientAuthorizationUpdateApiFormResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ClientAuthorizationUpdateApiFormRequest request) throws Exception {
        ...
        @Override
        public ClientAuthorizationUpdateApiFormResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ClientAuthorizationUpdateApiFormResponse.Builder resBuilder =
            ...
            ClientAuthorizationUpdateApiFormResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ClientAuthorizationUpdateApiFormResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withObject(out);
