...
public class AuthIntrospectionApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(AuthIntrospectionApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<AuthIntrospectionApiRequest, AuthIntrospectionApiResponse> {
