...
public class VciOfferInfoApiForm {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(VciOfferInfoApiFormRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<VciOfferInfoApiFormRequest, VciOfferInfoApiFormResponse> {
