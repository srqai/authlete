...
public class VciJwtissuerApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(VciJwtissuerApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<VciJwtissuerApiRequest, VciJwtissuerApiResponse> {
