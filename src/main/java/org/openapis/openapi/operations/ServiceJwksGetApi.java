...
public class ServiceJwksGetApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ServiceJwksGetApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<ServiceJwksGetApiRequest, ServiceJwksGetApiResponse> {
