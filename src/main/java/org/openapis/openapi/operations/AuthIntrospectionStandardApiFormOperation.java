...
import org.openapis.openapi.models.operations.AuthIntrospectionStandardApiFormResponseBody;
...
public class AuthIntrospectionStandardApiFormOperation implements RequestOperation<AuthIntrospectionStandardApiFormRequest, AuthIntrospectionStandardApiFormResponse> {
    
    /**
     * AUTH_INTROSPECTION_STANDARD_API_FORM_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] AUTH_INTROSPECTION_STANDARD_API_FORM_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public AuthIntrospectionStandardApiFormOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        AUTH_INTROSPECTION_STANDARD_API_FORM_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(AuthIntrospectionStandardApiFormRequest request) throws Exception {
        String url = Utils.generateURL(
                AuthIntrospectionStandardApiFormRequest.class,
                this.baseUrl,
        ...
        return sdkConfiguration.hooks().beforeRequest(
              new BeforeRequestContextImpl(
                  ...
                  this.baseUrl,
                  "auth_introspection_standard_api_form",
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AuthIntrospectionStandardApiFormRequest request) throws Exception {
    ...
    @Override
    public AuthIntrospectionStandardApiFormResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        AuthIntrospectionStandardApiFormResponse.Builder resBuilder = 
        ...
        AuthIntrospectionStandardApiFormResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                AuthIntrospectionStandardApiFormResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
