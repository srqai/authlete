...
public class VciSingleParseApiForm {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(VciSingleParseApiFormRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<VciSingleParseApiFormRequest, VciSingleParseApiFormResponse> {
