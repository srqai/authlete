...
public class DeviceVerificationApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(DeviceVerificationApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeviceVerificationApiRequest, DeviceVerificationApiResponse> {
