...
import org.openapis.openapi.models.operations.VciBatchIssueApiResponseBody;
...
public class VciBatchIssueApiOperation implements RequestOperation<VciBatchIssueApiRequest, VciBatchIssueApiResponse> {
    
    /**
     * VCI_BATCH_ISSUE_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] VCI_BATCH_ISSUE_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public VciBatchIssueApiOperation(
    ...
    public HttpRequest buildRequest(VciBatchIssueApiRequest request) throws Exception {
        String url = Utils.generateURL(
                VciBatchIssueApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(VciBatchIssueApiRequest request) throws Exception {
    ...
    @Override
    public VciBatchIssueApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        VciBatchIssueApiResponse.Builder resBuilder = 
        ...
        VciBatchIssueApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                VciBatchIssueApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
