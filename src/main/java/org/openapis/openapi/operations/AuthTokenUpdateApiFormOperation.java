...
import org.openapis.openapi.models.operations.AuthTokenUpdateApiFormResponseBody;
...
public class AuthTokenUpdateApiFormOperation implements RequestOperation<AuthTokenUpdateApiFormRequest, AuthTokenUpdateApiFormResponse> {
    
    /**
     * AUTH_TOKEN_UPDATE_API_FORM_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] AUTH_TOKEN_UPDATE_API_FORM_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public AuthTokenUpdateApiFormOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        AUTH_TOKEN_UPDATE_API_FORM_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(AuthTokenUpdateApiFormRequest request) throws Exception {
        String url = Utils.generateURL(
                AuthTokenUpdateApiFormRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AuthTokenUpdateApiFormRequest request) throws Exception {
    ...
    @Override
    public AuthTokenUpdateApiFormResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        AuthTokenUpdateApiFormResponse.Builder resBuilder = 
        ...
        AuthTokenUpdateApiFormResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                AuthTokenUpdateApiFormResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
