...
import org.openapis.openapi.models.operations.BackchannelAuthenticationIssueApiFormResponseBody;
...
public class BackchannelAuthenticationIssueApiFormOperation implements RequestOperation<BackchannelAuthenticationIssueApiFormRequest, BackchannelAuthenticationIssueApiFormResponse> {
    
    /**
     * BACKCHANNEL_AUTHENTICATION_ISSUE_API_FORM_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] BACKCHANNEL_AUTHENTICATION_ISSUE_API_FORM_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public BackchannelAuthenticationIssueApiFormOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        BACKCHANNEL_AUTHENTICATION_ISSUE_API_FORM_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(BackchannelAuthenticationIssueApiFormRequest request) throws Exception {
        String url = Utils.generateURL(
                BackchannelAuthenticationIssueApiFormRequest.class,
                this.baseUrl,
        ...
        return sdkConfiguration.hooks().beforeRequest(
              new BeforeRequestContextImpl(
                  ...
                  this.baseUrl,
                  "backchannel_authentication_issue_api_form",
    ...
    @Override
    public HttpResponse<InputStream> doRequest(BackchannelAuthenticationIssueApiFormRequest request) throws Exception {
    ...
    @Override
    public BackchannelAuthenticationIssueApiFormResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        BackchannelAuthenticationIssueApiFormResponse.Builder resBuilder = 
        ...
        BackchannelAuthenticationIssueApiFormResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                BackchannelAuthenticationIssueApiFormResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
