...
import org.openapis.openapi.models.operations.FederationRegistrationApiResponseBody;
...
public class FederationRegistrationApiOperation implements RequestOperation<FederationRegistrationApiRequest, FederationRegistrationApiResponse> {
    
    /**
     * FEDERATION_REGISTRATION_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] FEDERATION_REGISTRATION_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public FederationRegistrationApiOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        FEDERATION_REGISTRATION_API_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(FederationRegistrationApiRequest request) throws Exception {
        String url = Utils.generateURL(
                FederationRegistrationApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(FederationRegistrationApiRequest request) throws Exception {
    ...
    @Override
    public FederationRegistrationApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        FederationRegistrationApiResponse.Builder resBuilder = 
        ...
        FederationRegistrationApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                FederationRegistrationApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
