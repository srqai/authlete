...
public class AuthUserinfoIssueApiForm {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(AuthUserinfoIssueApiFormRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<AuthUserinfoIssueApiFormRequest, AuthUserinfoIssueApiFormResponse> {
