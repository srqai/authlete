...
import org.openapis.openapi.models.operations.VciDeferredIssueApiResponseBody;
...
public class VciDeferredIssueApiOperation implements RequestOperation<VciDeferredIssueApiRequest, VciDeferredIssueApiResponse> {
    
    /**
     * VCI_DEFERRED_ISSUE_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] VCI_DEFERRED_ISSUE_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public VciDeferredIssueApiOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        VCI_DEFERRED_ISSUE_API_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(VciDeferredIssueApiRequest request) throws Exception {
        String url = Utils.generateURL(
                VciDeferredIssueApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(VciDeferredIssueApiRequest request) throws Exception {
    ...
    @Override
    public VciDeferredIssueApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        VciDeferredIssueApiResponse.Builder resBuilder = 
        ...
        VciDeferredIssueApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                VciDeferredIssueApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
