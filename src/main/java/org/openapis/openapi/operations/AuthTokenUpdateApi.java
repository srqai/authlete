...
public class AuthTokenUpdateApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(AuthTokenUpdateApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<AuthTokenUpdateApiRequest, AuthTokenUpdateApiResponse> {
