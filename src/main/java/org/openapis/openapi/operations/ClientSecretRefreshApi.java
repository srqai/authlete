...
public class ClientSecretRefreshApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ClientSecretRefreshApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<ClientSecretRefreshApiRequest, ClientSecretRefreshApiResponse> {
