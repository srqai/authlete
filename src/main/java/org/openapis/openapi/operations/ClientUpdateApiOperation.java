...
import org.openapis.openapi.models.operations.ClientUpdateApiResponseBody;
...
public class ClientUpdateApiOperation implements RequestOperation<ClientUpdateApiRequest, ClientUpdateApiResponse> {
    
    /**
     * CLIENT_UPDATE_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] CLIENT_UPDATE_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public ClientUpdateApiOperation(
    ...
    public HttpRequest buildRequest(ClientUpdateApiRequest request) throws Exception {
        String url = Utils.generateURL(
                ClientUpdateApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ClientUpdateApiRequest request) throws Exception {
    ...
    @Override
    public ClientUpdateApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ClientUpdateApiResponse.Builder resBuilder = 
        ...
        ClientUpdateApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                ClientUpdateApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
