...
import org.openapis.openapi.models.operations.ClientSecretRefreshApiResponseBody;
...
public class ClientSecretRefreshApiOperation implements RequestOperation<ClientSecretRefreshApiRequest, ClientSecretRefreshApiResponse> {
    
    /**
     * CLIENT_SECRET_REFRESH_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] CLIENT_SECRET_REFRESH_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public ClientSecretRefreshApiOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        CLIENT_SECRET_REFRESH_API_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(ClientSecretRefreshApiRequest request) throws Exception {
        String url = Utils.generateURL(
                ClientSecretRefreshApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ClientSecretRefreshApiRequest request) throws Exception {
    ...
    @Override
    public ClientSecretRefreshApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ClientSecretRefreshApiResponse.Builder resBuilder = 
        ...
        ClientSecretRefreshApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                ClientSecretRefreshApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
