...
import org.openapis.openapi.models.operations.FederationRegistrationApiFormResponseBody;
...
public class FederationRegistrationApiFormOperation implements RequestOperation<FederationRegistrationApiFormRequest, FederationRegistrationApiFormResponse> {
    
    /**
     * FEDERATION_REGISTRATION_API_FORM_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] FEDERATION_REGISTRATION_API_FORM_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public FederationRegistrationApiFormOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        FEDERATION_REGISTRATION_API_FORM_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(FederationRegistrationApiFormRequest request) throws Exception {
        String url = Utils.generateURL(
                FederationRegistrationApiFormRequest.class,
                this.baseUrl,
        ...
        return sdkConfiguration.hooks().beforeRequest(
              new BeforeRequestContextImpl(
                  ...
                  this.baseUrl,
                  "federation_registration_api_form",
    ...
    @Override
    public HttpResponse<InputStream> doRequest(FederationRegistrationApiFormRequest request) throws Exception {
    ...
    @Override
    public FederationRegistrationApiFormResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        FederationRegistrationApiFormResponse.Builder resBuilder = 
        ...
        FederationRegistrationApiFormResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                FederationRegistrationApiFormResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
