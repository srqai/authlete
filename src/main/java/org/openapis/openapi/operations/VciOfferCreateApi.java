...
public class VciOfferCreateApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(VciOfferCreateApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<VciOfferCreateApiRequest, VciOfferCreateApiResponse> {
