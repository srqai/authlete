...
public class DeviceVerificationApiOperation implements RequestOperation<DeviceVerificationApiRequest, DeviceVerificationApiResponse> {
    ...
    /**
     * DEVICE_VERIFICATION_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] DEVICE_VERIFICATION_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public DeviceVerificationApiOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        DEVICE_VERIFICATION_API_SERVERS[0], 
                        Map.of()));
