...
import org.openapis.openapi.models.operations.AuthUserinfoApiFormResponseBody;
...
public class AuthUserinfoApiFormOperation implements RequestOperation<AuthUserinfoApiFormRequest, AuthUserinfoApiFormResponse> {
    
    /**
     * AUTH_USERINFO_API_FORM_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] AUTH_USERINFO_API_FORM_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public AuthUserinfoApiFormOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        AUTH_USERINFO_API_FORM_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(AuthUserinfoApiFormRequest request) throws Exception {
        String url = Utils.generateURL(
                AuthUserinfoApiFormRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AuthUserinfoApiFormRequest request) throws Exception {
    ...
    @Override
    public AuthUserinfoApiFormResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        AuthUserinfoApiFormResponse.Builder resBuilder = 
        ...
        AuthUserinfoApiFormResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                AuthUserinfoApiFormResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
