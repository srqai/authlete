...
import org.openapis.openapi.models.operations.ClientRegistrationUpdateApiResponseBody;
...
public class ClientRegistrationUpdateApiOperation implements RequestOperation<ClientRegistrationUpdateApiRequest, ClientRegistrationUpdateApiResponse> {
    
    /**
     * CLIENT_REGISTRATION_UPDATE_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] CLIENT_REGISTRATION_UPDATE_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public ClientRegistrationUpdateApiOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        CLIENT_REGISTRATION_UPDATE_API_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(ClientRegistrationUpdateApiRequest request) throws Exception {
        String url = Utils.generateURL(
                ClientRegistrationUpdateApiRequest.class,
                this.baseUrl,
        ...
        return sdkConfiguration.hooks().beforeRequest(
              new BeforeRequestContextImpl(
                  ...
                  this.baseUrl,
                  "client_registration_update_api",
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ClientRegistrationUpdateApiRequest request) throws Exception {
    ...
    @Override
    public ClientRegistrationUpdateApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ClientRegistrationUpdateApiResponse.Builder resBuilder = 
        ...
        ClientRegistrationUpdateApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                ClientRegistrationUpdateApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
