...
import org.openapis.openapi.models.operations.AuthTokenCreateApiResponseBody;
...
public class AuthTokenCreateApiOperation implements RequestOperation<AuthTokenCreateApiRequest, AuthTokenCreateApiResponse> {
    
    /**
     * AUTH_TOKEN_CREATE_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] AUTH_TOKEN_CREATE_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public AuthTokenCreateApiOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        AUTH_TOKEN_CREATE_API_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(AuthTokenCreateApiRequest request) throws Exception {
        String url = Utils.generateURL(
                AuthTokenCreateApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AuthTokenCreateApiRequest request) throws Exception {
    ...
    @Override
    public AuthTokenCreateApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        AuthTokenCreateApiResponse.Builder resBuilder = 
        ...
        AuthTokenCreateApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                AuthTokenCreateApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
