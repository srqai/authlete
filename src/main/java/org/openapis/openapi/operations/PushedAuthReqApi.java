...
public class PushedAuthReqApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(PushedAuthReqApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<PushedAuthReqApiRequest, PushedAuthReqApiResponse> {
