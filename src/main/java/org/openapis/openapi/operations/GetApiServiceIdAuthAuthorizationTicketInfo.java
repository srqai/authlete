...
public class GetApiServiceIdAuthAuthorizationTicketInfo {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(GetApiServiceIdAuthAuthorizationTicketInfoRequest request) throws Exception {
            String url = Utils.generateURL(
                    GetApiServiceIdAuthAuthorizationTicketInfoRequest.class,
                    this.baseUrl,
            ...
            return sdkConfiguration.hooks().beforeRequest(
                    new BeforeRequestContextImpl(
                            ...
                            this.baseUrl,
                            "get_/api/{serviceId}/auth/authorization/ticket/info",
    ...
    public static class Sync extends Base
            implements RequestOperation<GetApiServiceIdAuthAuthorizationTicketInfoRequest, GetApiServiceIdAuthAuthorizationTicketInfoResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetApiServiceIdAuthAuthorizationTicketInfoRequest request) throws Exception {
        ...
        @Override
        public GetApiServiceIdAuthAuthorizationTicketInfoResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetApiServiceIdAuthAuthorizationTicketInfoResponse.Builder resBuilder =
            ...
            GetApiServiceIdAuthAuthorizationTicketInfoResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetApiServiceIdAuthAuthorizationTicketInfoResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withObject(out);
