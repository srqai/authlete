...
public class ServiceDeleteApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ServiceDeleteApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<ServiceDeleteApiRequest, ServiceDeleteApiResponse> {
