...
import org.openapis.openapi.models.operations.ClientRegistrationApiResponseBody;
...
public class ClientRegistrationApiOperation implements RequestOperation<ClientRegistrationApiRequest, ClientRegistrationApiResponse> {
    
    /**
     * CLIENT_REGISTRATION_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] CLIENT_REGISTRATION_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public ClientRegistrationApiOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        CLIENT_REGISTRATION_API_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(ClientRegistrationApiRequest request) throws Exception {
        String url = Utils.generateURL(
                ClientRegistrationApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ClientRegistrationApiRequest request) throws Exception {
    ...
    @Override
    public ClientRegistrationApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ClientRegistrationApiResponse.Builder resBuilder = 
        ...
        ClientRegistrationApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                ClientRegistrationApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
