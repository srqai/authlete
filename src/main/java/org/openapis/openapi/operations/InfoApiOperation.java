...
import org.openapis.openapi.models.operations.InfoApiResponseBody;
...
public class InfoApiOperation implements RequestlessOperation<InfoApiResponse> {
    
    /**
     * INFO_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] INFO_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    @Override
    public InfoApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        InfoApiResponse.Builder resBuilder = 
            InfoApiResponse
                .builder()
        ...
        InfoApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                InfoApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
