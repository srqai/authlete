...
import org.openapis.openapi.models.operations.GrantMApiResponseBody;
...
public class GrantMApiOperation implements RequestOperation<GrantMApiRequest, GrantMApiResponse> {
    
    /**
     * GRANT_M_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] GRANT_M_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public HttpRequest buildRequest(GrantMApiRequest request) throws Exception {
        String url = Utils.generateURL(
                GrantMApiRequest.class,
                this.baseUrl,
                "/api/{serviceId}/gm",
                request, null);
    ...
    @Override
    public HttpResponse<InputStream> doRequest(GrantMApiRequest request) throws Exception {
    ...
    @Override
    public GrantMApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        GrantMApiResponse.Builder resBuilder = 
            GrantMApiResponse
                .builder()
        ...
        GrantMApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                GrantMApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
