...
import org.openapis.openapi.models.operations.ClientGrantedScopesDeleteApiResponseBody;
...
public class ClientGrantedScopesDeleteApiOperation implements RequestOperation<ClientGrantedScopesDeleteApiRequest, ClientGrantedScopesDeleteApiResponse> {
    
    /**
     * CLIENT_GRANTED_SCOPES_DELETE_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] CLIENT_GRANTED_SCOPES_DELETE_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public ClientGrantedScopesDeleteApiOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        CLIENT_GRANTED_SCOPES_DELETE_API_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(ClientGrantedScopesDeleteApiRequest request) throws Exception {
        String url = Utils.generateURL(
                ClientGrantedScopesDeleteApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ClientGrantedScopesDeleteApiRequest request) throws Exception {
    ...
    @Override
    public ClientGrantedScopesDeleteApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ClientGrantedScopesDeleteApiResponse.Builder resBuilder = 
        ...
        ClientGrantedScopesDeleteApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                ClientGrantedScopesDeleteApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
