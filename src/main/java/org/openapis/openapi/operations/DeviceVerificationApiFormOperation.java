...
import org.openapis.openapi.models.operations.DeviceVerificationApiFormResponseBody;
...
public class DeviceVerificationApiFormOperation implements RequestOperation<DeviceVerificationApiFormRequest, DeviceVerificationApiFormResponse> {
    
    /**
     * DEVICE_VERIFICATION_API_FORM_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] DEVICE_VERIFICATION_API_FORM_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public DeviceVerificationApiFormOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        DEVICE_VERIFICATION_API_FORM_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(DeviceVerificationApiFormRequest request) throws Exception {
        String url = Utils.generateURL(
                DeviceVerificationApiFormRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(DeviceVerificationApiFormRequest request) throws Exception {
    ...
    @Override
    public DeviceVerificationApiFormResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        DeviceVerificationApiFormResponse.Builder resBuilder = 
        ...
        DeviceVerificationApiFormResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                DeviceVerificationApiFormResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
