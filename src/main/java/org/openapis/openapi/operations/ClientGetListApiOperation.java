...
import org.openapis.openapi.models.operations.ClientGetListApiResponseBody;
...
public class ClientGetListApiOperation implements RequestOperation<ClientGetListApiRequest, ClientGetListApiResponse> {
    
    /**
     * CLIENT_GET_LIST_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] CLIENT_GET_LIST_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public ClientGetListApiOperation(
    ...
    public HttpRequest buildRequest(ClientGetListApiRequest request) throws Exception {
        String url = Utils.generateURL(
                ClientGetListApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ClientGetListApiRequest request) throws Exception {
    ...
    @Override
    public ClientGetListApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ClientGetListApiResponse.Builder resBuilder = 
        ...
        ClientGetListApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                ClientGetListApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
