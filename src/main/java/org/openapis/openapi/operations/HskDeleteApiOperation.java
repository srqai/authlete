...
import org.openapis.openapi.models.operations.HskDeleteApiResponseBody;
...
public class HskDeleteApiOperation implements RequestOperation<HskDeleteApiRequest, HskDeleteApiResponse> {
    
    /**
     * HSK_DELETE_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] HSK_DELETE_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public HttpRequest buildRequest(HskDeleteApiRequest request) throws Exception {
        String url = Utils.generateURL(
                HskDeleteApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(HskDeleteApiRequest request) throws Exception {
    ...
    @Override
    public HskDeleteApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        HskDeleteApiResponse.Builder resBuilder = 
        ...
        HskDeleteApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "204")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                HskDeleteApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
