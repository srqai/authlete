...
public class ClientGetApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ClientGetApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<ClientGetApiRequest, ClientGetApiResponse> {
