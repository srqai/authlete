...
public class FederationRegistrationApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(FederationRegistrationApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<FederationRegistrationApiRequest, FederationRegistrationApiResponse> {
