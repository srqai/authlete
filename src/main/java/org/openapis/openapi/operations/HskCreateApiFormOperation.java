...
import org.openapis.openapi.models.operations.HskCreateApiFormResponseBody;
...
public class HskCreateApiFormOperation implements RequestOperation<HskCreateApiFormRequest, HskCreateApiFormResponse> {
    
    /**
     * HSK_CREATE_API_FORM_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] HSK_CREATE_API_FORM_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public HskCreateApiFormOperation(
    ...
    public HttpRequest buildRequest(HskCreateApiFormRequest request) throws Exception {
        String url = Utils.generateURL(
                HskCreateApiFormRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(HskCreateApiFormRequest request) throws Exception {
    ...
    @Override
    public HskCreateApiFormResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        HskCreateApiFormResponse.Builder resBuilder = 
        ...
        HskCreateApiFormResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                HskCreateApiFormResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
