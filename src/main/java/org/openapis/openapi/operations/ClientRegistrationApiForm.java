...
public class ClientRegistrationApiForm {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ClientRegistrationApiFormRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<ClientRegistrationApiFormRequest, ClientRegistrationApiFormResponse> {
