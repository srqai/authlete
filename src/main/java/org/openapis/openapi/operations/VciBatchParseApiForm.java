...
public class VciBatchParseApiForm {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(VciBatchParseApiFormRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<VciBatchParseApiFormRequest, VciBatchParseApiFormResponse> {
