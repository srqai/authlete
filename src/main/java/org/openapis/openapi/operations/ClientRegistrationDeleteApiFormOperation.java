...
import org.openapis.openapi.models.operations.ClientRegistrationDeleteApiFormResponseBody;
...
public class ClientRegistrationDeleteApiFormOperation implements RequestOperation<ClientRegistrationDeleteApiFormRequest, ClientRegistrationDeleteApiFormResponse> {
    
    /**
     * CLIENT_REGISTRATION_DELETE_API_FORM_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] CLIENT_REGISTRATION_DELETE_API_FORM_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public ClientRegistrationDeleteApiFormOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        CLIENT_REGISTRATION_DELETE_API_FORM_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(ClientRegistrationDeleteApiFormRequest request) throws Exception {
        String url = Utils.generateURL(
                ClientRegistrationDeleteApiFormRequest.class,
                this.baseUrl,
        ...
        return sdkConfiguration.hooks().beforeRequest(
              new BeforeRequestContextImpl(
                  ...
                  this.baseUrl,
                  "client_registration_delete_api_form",
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ClientRegistrationDeleteApiFormRequest request) throws Exception {
    ...
    @Override
    public ClientRegistrationDeleteApiFormResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ClientRegistrationDeleteApiFormResponse.Builder resBuilder = 
        ...
        ClientRegistrationDeleteApiFormResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                ClientRegistrationDeleteApiFormResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
