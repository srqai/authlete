...
import org.openapis.openapi.models.operations.AuthAuthorizationIssueApiResponseBody;
...
public class AuthAuthorizationIssueApiOperation implements RequestOperation<AuthAuthorizationIssueApiRequest, AuthAuthorizationIssueApiResponse> {
    
    /**
     * AUTH_AUTHORIZATION_ISSUE_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] AUTH_AUTHORIZATION_ISSUE_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public AuthAuthorizationIssueApiOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        AUTH_AUTHORIZATION_ISSUE_API_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(AuthAuthorizationIssueApiRequest request) throws Exception {
        String url = Utils.generateURL(
                AuthAuthorizationIssueApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AuthAuthorizationIssueApiRequest request) throws Exception {
    ...
    @Override
    public AuthAuthorizationIssueApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        AuthAuthorizationIssueApiResponse.Builder resBuilder = 
        ...
        AuthAuthorizationIssueApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                AuthAuthorizationIssueApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
