...
import org.openapis.openapi.models.operations.DeviceCompleteApiFormResponseBody;
...
public class DeviceCompleteApiFormOperation implements RequestOperation<DeviceCompleteApiFormRequest, DeviceCompleteApiFormResponse> {
    
    /**
     * DEVICE_COMPLETE_API_FORM_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] DEVICE_COMPLETE_API_FORM_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public DeviceCompleteApiFormOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        DEVICE_COMPLETE_API_FORM_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(DeviceCompleteApiFormRequest request) throws Exception {
        String url = Utils.generateURL(
                DeviceCompleteApiFormRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(DeviceCompleteApiFormRequest request) throws Exception {
    ...
    @Override
    public DeviceCompleteApiFormResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        DeviceCompleteApiFormResponse.Builder resBuilder = 
        ...
        DeviceCompleteApiFormResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                DeviceCompleteApiFormResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
