...
public class AuthIntrospectionApiForm {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(AuthIntrospectionApiFormRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<AuthIntrospectionApiFormRequest, AuthIntrospectionApiFormResponse> {
