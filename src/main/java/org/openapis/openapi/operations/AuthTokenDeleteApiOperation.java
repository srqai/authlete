...
public class AuthTokenDeleteApiOperation implements RequestOperation<AuthTokenDeleteApiRequest, AuthTokenDeleteApiResponse> {
    
    /**
     * AUTH_TOKEN_DELETE_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] AUTH_TOKEN_DELETE_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public AuthTokenDeleteApiOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        AUTH_TOKEN_DELETE_API_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(AuthTokenDeleteApiRequest request) throws Exception {
        String url = Utils.generateURL(
                AuthTokenDeleteApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AuthTokenDeleteApiRequest request) throws Exception {
    ...
    @Override
    public AuthTokenDeleteApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        AuthTokenDeleteApiResponse.Builder resBuilder = 
        ...
        AuthTokenDeleteApiResponse res = resBuilder.build();
