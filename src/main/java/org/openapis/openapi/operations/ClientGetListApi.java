...
public class ClientGetListApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ClientGetListApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<ClientGetListApiRequest, ClientGetListApiResponse> {
