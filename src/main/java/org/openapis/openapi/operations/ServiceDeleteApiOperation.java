...
public class ServiceDeleteApiOperation implements RequestOperation<ServiceDeleteApiRequest, ServiceDeleteApiResponse> {
    
    /**
     * SERVICE_DELETE_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] SERVICE_DELETE_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public ServiceDeleteApiOperation(
    ...
    public HttpRequest buildRequest(ServiceDeleteApiRequest request) throws Exception {
        String url = Utils.generateURL(
                ServiceDeleteApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ServiceDeleteApiRequest request) throws Exception {
    ...
    @Override
    public ServiceDeleteApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ServiceDeleteApiResponse.Builder resBuilder = 
        ...
        ServiceDeleteApiResponse res = resBuilder.build();
