...
public class JoseVerifyApiForm {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(JoseVerifyApiFormRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<JoseVerifyApiFormRequest, JoseVerifyApiFormResponse> {
