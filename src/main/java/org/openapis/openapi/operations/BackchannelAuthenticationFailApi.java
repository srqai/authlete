...
public class BackchannelAuthenticationFailApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(BackchannelAuthenticationFailApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<BackchannelAuthenticationFailApiRequest, BackchannelAuthenticationFailApiResponse> {
