...
public class ClientSecretUpdateApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ClientSecretUpdateApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<ClientSecretUpdateApiRequest, ClientSecretUpdateApiResponse> {
