...
import org.openapis.openapi.models.operations.VciBatchParseApiResponseBody;
...
public class VciBatchParseApiOperation implements RequestOperation<VciBatchParseApiRequest, VciBatchParseApiResponse> {
    
    /**
     * VCI_BATCH_PARSE_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] VCI_BATCH_PARSE_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public VciBatchParseApiOperation(
    ...
    public HttpRequest buildRequest(VciBatchParseApiRequest request) throws Exception {
        String url = Utils.generateURL(
                VciBatchParseApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(VciBatchParseApiRequest request) throws Exception {
    ...
    @Override
    public VciBatchParseApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        VciBatchParseApiResponse.Builder resBuilder = 
        ...
        VciBatchParseApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                VciBatchParseApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
