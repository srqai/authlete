...
public class ClientAuthorizationDeleteApiOperation implements RequestOperation<ClientAuthorizationDeleteApiRequest, ClientAuthorizationDeleteApiResponse> {
    ...
    public ClientAuthorizationDeleteApiOperation(@Nonnull SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ClientAuthorizationDeleteApiRequest request) throws Exception {
        String url = Utils.generateURL(
                ClientAuthorizationDeleteApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ClientAuthorizationDeleteApiRequest request) throws Exception {
    ...
    @Override
    public ClientAuthorizationDeleteApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        ClientAuthorizationDeleteApiResponse.Builder resBuilder = 
        ...
        ClientAuthorizationDeleteApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                1api1Percent7BserviceIdPercent7D1client1grantedScopes1get1Percent7BclientIdPercent7DGetResponses200ContentApplication1jsonSchema out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.with1api1Percent7BserviceIdPercent7D1client1grantedScopes1get1Percent7BclientIdPercent7DGetResponses200ContentApplication1jsonSchema(out);
                return res;
            } else {
