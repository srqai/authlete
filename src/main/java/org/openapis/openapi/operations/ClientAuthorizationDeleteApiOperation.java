...
import org.openapis.openapi.models.operations.ClientAuthorizationDeleteApiResponseBody;
...
public class ClientAuthorizationDeleteApiOperation implements RequestOperation<ClientAuthorizationDeleteApiRequest, ClientAuthorizationDeleteApiResponse> {
    ...
    /**
     * CLIENT_AUTHORIZATION_DELETE_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] CLIENT_AUTHORIZATION_DELETE_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public ClientAuthorizationDeleteApiOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        CLIENT_AUTHORIZATION_DELETE_API_SERVERS[0], 
                        Map.of()));
    ...
    public ClientAuthorizationDeleteApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        ...
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                ClientAuthorizationDeleteApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
