...
import org.openapis.openapi.models.operations.PostApiServiceIdAuthAuthorizationTicketUpdateResponseBody;
...
public class PostApiServiceIdAuthAuthorizationTicketUpdateOperation implements RequestOperation<PostApiServiceIdAuthAuthorizationTicketUpdateRequest, PostApiServiceIdAuthAuthorizationTicketUpdateResponse> {
    
    /**
     * POST_API_SERVICE_ID_AUTH_AUTHORIZATION_TICKET_UPDATE_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] POST_API_SERVICE_ID_AUTH_AUTHORIZATION_TICKET_UPDATE_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public PostApiServiceIdAuthAuthorizationTicketUpdateOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        POST_API_SERVICE_ID_AUTH_AUTHORIZATION_TICKET_UPDATE_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(PostApiServiceIdAuthAuthorizationTicketUpdateRequest request) throws Exception {
        String url = Utils.generateURL(
                PostApiServiceIdAuthAuthorizationTicketUpdateRequest.class,
                this.baseUrl,
        ...
        return sdkConfiguration.hooks().beforeRequest(
              new BeforeRequestContextImpl(
                  ...
                  this.baseUrl,
                  "post_/api/{serviceId}/auth/authorization/ticket/update",
    ...
    @Override
    public HttpResponse<InputStream> doRequest(PostApiServiceIdAuthAuthorizationTicketUpdateRequest request) throws Exception {
    ...
    @Override
    public PostApiServiceIdAuthAuthorizationTicketUpdateResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        PostApiServiceIdAuthAuthorizationTicketUpdateResponse.Builder resBuilder = 
        ...
        PostApiServiceIdAuthAuthorizationTicketUpdateResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                PostApiServiceIdAuthAuthorizationTicketUpdateResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
