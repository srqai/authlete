...
public class DeviceVerificationApiForm {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(DeviceVerificationApiFormRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeviceVerificationApiFormRequest, DeviceVerificationApiFormResponse> {
