...
import org.openapis.openapi.models.operations.BackchannelAuthenticationFailApiResponseBody;
...
public class BackchannelAuthenticationFailApiOperation implements RequestOperation<BackchannelAuthenticationFailApiRequest, BackchannelAuthenticationFailApiResponse> {
    
    /**
     * BACKCHANNEL_AUTHENTICATION_FAIL_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] BACKCHANNEL_AUTHENTICATION_FAIL_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public BackchannelAuthenticationFailApiOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        BACKCHANNEL_AUTHENTICATION_FAIL_API_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(BackchannelAuthenticationFailApiRequest request) throws Exception {
        String url = Utils.generateURL(
                BackchannelAuthenticationFailApiRequest.class,
                this.baseUrl,
        ...
        return sdkConfiguration.hooks().beforeRequest(
              new BeforeRequestContextImpl(
                  ...
                  this.baseUrl,
                  "backchannel_authentication_fail_api",
    ...
    @Override
    public HttpResponse<InputStream> doRequest(BackchannelAuthenticationFailApiRequest request) throws Exception {
    ...
    @Override
    public BackchannelAuthenticationFailApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        BackchannelAuthenticationFailApiResponse.Builder resBuilder = 
        ...
        BackchannelAuthenticationFailApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                BackchannelAuthenticationFailApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
