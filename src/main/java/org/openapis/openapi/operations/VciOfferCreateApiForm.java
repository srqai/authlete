...
public class VciOfferCreateApiForm {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(VciOfferCreateApiFormRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<VciOfferCreateApiFormRequest, VciOfferCreateApiFormResponse> {
