...
public class ClientRegistrationDeleteApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(ClientRegistrationDeleteApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<ClientRegistrationDeleteApiRequest, ClientRegistrationDeleteApiResponse> {
