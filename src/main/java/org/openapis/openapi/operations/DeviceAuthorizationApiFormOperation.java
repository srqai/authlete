...
import org.openapis.openapi.models.operations.DeviceAuthorizationApiFormResponseBody;
...
public class DeviceAuthorizationApiFormOperation implements RequestOperation<DeviceAuthorizationApiFormRequest, DeviceAuthorizationApiFormResponse> {
    
    /**
     * DEVICE_AUTHORIZATION_API_FORM_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] DEVICE_AUTHORIZATION_API_FORM_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public DeviceAuthorizationApiFormOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        DEVICE_AUTHORIZATION_API_FORM_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(DeviceAuthorizationApiFormRequest request) throws Exception {
        String url = Utils.generateURL(
                DeviceAuthorizationApiFormRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(DeviceAuthorizationApiFormRequest request) throws Exception {
    ...
    @Override
    public DeviceAuthorizationApiFormResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        DeviceAuthorizationApiFormResponse.Builder resBuilder = 
        ...
        DeviceAuthorizationApiFormResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                DeviceAuthorizationApiFormResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
