...
import org.openapis.openapi.models.operations.HskGetListApiResponseBody;
...
public class HskGetListApiOperation implements RequestOperation<HskGetListApiRequest, HskGetListApiResponse> {
    
    /**
     * HSK_GET_LIST_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] HSK_GET_LIST_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public HttpRequest buildRequest(HskGetListApiRequest request) throws Exception {
        String url = Utils.generateURL(
                HskGetListApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(HskGetListApiRequest request) throws Exception {
    ...
    @Override
    public HskGetListApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        HskGetListApiResponse.Builder resBuilder = 
        ...
        HskGetListApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                HskGetListApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
