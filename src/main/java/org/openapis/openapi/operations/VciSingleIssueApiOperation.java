...
import org.openapis.openapi.models.operations.VciSingleIssueApiResponseBody;
...
public class VciSingleIssueApiOperation implements RequestOperation<VciSingleIssueApiRequest, VciSingleIssueApiResponse> {
    
    /**
     * VCI_SINGLE_ISSUE_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] VCI_SINGLE_ISSUE_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public VciSingleIssueApiOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        VCI_SINGLE_ISSUE_API_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(VciSingleIssueApiRequest request) throws Exception {
        String url = Utils.generateURL(
                VciSingleIssueApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(VciSingleIssueApiRequest request) throws Exception {
    ...
    @Override
    public VciSingleIssueApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        VciSingleIssueApiResponse.Builder resBuilder = 
        ...
        VciSingleIssueApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                VciSingleIssueApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
