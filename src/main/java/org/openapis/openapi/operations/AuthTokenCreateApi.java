...
public class AuthTokenCreateApi {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(AuthTokenCreateApiRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<AuthTokenCreateApiRequest, AuthTokenCreateApiResponse> {
