...
import org.openapis.openapi.models.operations.VciOfferInfoApiFormResponseBody;
...
public class VciOfferInfoApiFormOperation implements RequestOperation<VciOfferInfoApiFormRequest, VciOfferInfoApiFormResponse> {
    
    /**
     * VCI_OFFER_INFO_API_FORM_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] VCI_OFFER_INFO_API_FORM_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public VciOfferInfoApiFormOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        VCI_OFFER_INFO_API_FORM_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(VciOfferInfoApiFormRequest request) throws Exception {
        String url = Utils.generateURL(
                VciOfferInfoApiFormRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(VciOfferInfoApiFormRequest request) throws Exception {
    ...
    @Override
    public VciOfferInfoApiFormResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        VciOfferInfoApiFormResponse.Builder resBuilder = 
        ...
        VciOfferInfoApiFormResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                VciOfferInfoApiFormResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
