...
public class AuthRevocationApiForm {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(AuthRevocationApiFormRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<AuthRevocationApiFormRequest, AuthRevocationApiFormResponse> {
