...
import org.openapis.openapi.models.operations.AuthRevocationApiFormResponseBody;
...
public class AuthRevocationApiFormOperation implements RequestOperation<AuthRevocationApiFormRequest, AuthRevocationApiFormResponse> {
    
    /**
     * AUTH_REVOCATION_API_FORM_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] AUTH_REVOCATION_API_FORM_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public AuthRevocationApiFormOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        AUTH_REVOCATION_API_FORM_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(AuthRevocationApiFormRequest request) throws Exception {
        String url = Utils.generateURL(
                AuthRevocationApiFormRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AuthRevocationApiFormRequest request) throws Exception {
    ...
    @Override
    public AuthRevocationApiFormResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        AuthRevocationApiFormResponse.Builder resBuilder = 
        ...
        AuthRevocationApiFormResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                AuthRevocationApiFormResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
