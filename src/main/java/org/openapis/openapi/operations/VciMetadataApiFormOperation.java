...
import org.openapis.openapi.models.operations.VciMetadataApiFormResponseBody;
...
public class VciMetadataApiFormOperation implements RequestOperation<VciMetadataApiFormRequest, VciMetadataApiFormResponse> {
    
    /**
     * VCI_METADATA_API_FORM_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] VCI_METADATA_API_FORM_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public VciMetadataApiFormOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        VCI_METADATA_API_FORM_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(VciMetadataApiFormRequest request) throws Exception {
        String url = Utils.generateURL(
                VciMetadataApiFormRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(VciMetadataApiFormRequest request) throws Exception {
    ...
    @Override
    public VciMetadataApiFormResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        VciMetadataApiFormResponse.Builder resBuilder = 
        ...
        VciMetadataApiFormResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                VciMetadataApiFormResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
