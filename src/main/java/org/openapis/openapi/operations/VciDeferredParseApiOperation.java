...
import org.openapis.openapi.models.operations.VciDeferredParseApiResponseBody;
...
public class VciDeferredParseApiOperation implements RequestOperation<VciDeferredParseApiRequest, VciDeferredParseApiResponse> {
    
    /**
     * VCI_DEFERRED_PARSE_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] VCI_DEFERRED_PARSE_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public VciDeferredParseApiOperation(
        ...
        this.baseUrl = Optional.ofNullable(serverURL)
                ...
                .orElse(Utils.templateUrl(
                        VCI_DEFERRED_PARSE_API_SERVERS[0], 
                        Map.of()));
    ...
    public HttpRequest buildRequest(VciDeferredParseApiRequest request) throws Exception {
        String url = Utils.generateURL(
                VciDeferredParseApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(VciDeferredParseApiRequest request) throws Exception {
    ...
    @Override
    public VciDeferredParseApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        VciDeferredParseApiResponse.Builder resBuilder = 
        ...
        VciDeferredParseApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                VciDeferredParseApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
