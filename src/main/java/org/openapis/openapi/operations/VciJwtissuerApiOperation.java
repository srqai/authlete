...
import org.openapis.openapi.models.operations.VciJwtissuerApiResponseBody;
...
public class VciJwtissuerApiOperation implements RequestOperation<VciJwtissuerApiRequest, VciJwtissuerApiResponse> {
    
    /**
     * VCI_JWTISSUER_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] VCI_JWTISSUER_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public VciJwtissuerApiOperation(
    ...
    public HttpRequest buildRequest(VciJwtissuerApiRequest request) throws Exception {
        String url = Utils.generateURL(
                VciJwtissuerApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(VciJwtissuerApiRequest request) throws Exception {
    ...
    @Override
    public VciJwtissuerApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        VciJwtissuerApiResponse.Builder resBuilder = 
        ...
        VciJwtissuerApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                VciJwtissuerApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
