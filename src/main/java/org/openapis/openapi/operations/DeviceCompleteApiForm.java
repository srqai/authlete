...
public class DeviceCompleteApiForm {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(DeviceCompleteApiFormRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeviceCompleteApiFormRequest, DeviceCompleteApiFormResponse> {
