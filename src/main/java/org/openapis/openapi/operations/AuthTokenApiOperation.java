...
import org.openapis.openapi.models.operations.AuthTokenApiResponseBody;
...
public class AuthTokenApiOperation implements RequestOperation<AuthTokenApiRequest, AuthTokenApiResponse> {
    
    /**
     * AUTH_TOKEN_API_SERVERS contains the list of server urls available to the SDK.
     */
    public static final String[] AUTH_TOKEN_API_SERVERS = {
        /**
         * 🇺🇸 US Cluster
         */
    ...
    public HttpRequest buildRequest(AuthTokenApiRequest request) throws Exception {
        String url = Utils.generateURL(
                AuthTokenApiRequest.class,
                this.baseUrl,
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AuthTokenApiRequest request) throws Exception {
    ...
    @Override
    public AuthTokenApiResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        String contentType = response
            .headers()
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        AuthTokenApiResponse.Builder resBuilder = 
        ...
        AuthTokenApiResponse res = resBuilder.build();
        
        if (Utils.statusCodeMatches(response.statusCode(), "200")) {
            if (Utils.contentTypeMatches(contentType, "application/json")) {
                AuthTokenApiResponseBody out = Utils.mapper().readValue(
                    response.body(),
                    new TypeReference<>() {
                    });
                res.withObject(out);
