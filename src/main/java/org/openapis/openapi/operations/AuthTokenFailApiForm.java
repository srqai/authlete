...
public class AuthTokenFailApiForm {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(AuthTokenFailApiFormRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<AuthTokenFailApiFormRequest, AuthTokenFailApiFormResponse> {
