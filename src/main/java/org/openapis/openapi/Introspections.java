...
public class Introspections {
     ...
     * 
     * @param serviceId A service ID.
     * @param 1api1Percent7BserviceIdPercent7D1auth1introspection1standardPostRequestBodyContentApplication1jsonSchema 
     * @return The response from the API call
     * @throws Exception if the API call fails
     */
    public AuthIntrospectionStandardApiFormResponse processForm(@Nonnull String serviceId, @Nonnull 1api1Percent7BserviceIdPercent7D1auth1introspection1standardPostRequestBodyContentApplication1jsonSchema 1api1Percent7BserviceIdPercent7D1auth1introspection1standardPostRequestBodyContentApplication1jsonSchema) throws Exception {
        AuthIntrospectionStandardApiFormRequest request = new AuthIntrospectionStandardApiFormRequest(serviceId, 1api1Percent7BserviceIdPercent7D1auth1introspection1standardPostRequestBodyContentApplication1jsonSchema);
