...
public class AuthorizationEndpoints {
     ...
     * 
     * @param serviceId A service ID.
     * @param 1api1Percent7BserviceIdPercent7D1auth1authorization1failPostRequestBodyContentApplication1jsonSchema 
     * @return The response from the API call
     * @throws Exception if the API call fails
     */
    public AuthAuthorizationFailApiFormResponse failAuthRequestForm(@Nonnull String serviceId, @Nonnull 1api1Percent7BserviceIdPercent7D1auth1authorization1failPostRequestBodyContentApplication1jsonSchema 1api1Percent7BserviceIdPercent7D1auth1authorization1failPostRequestBodyContentApplication1jsonSchema) throws Exception {
        AuthAuthorizationFailApiFormRequest request = new AuthAuthorizationFailApiFormRequest(serviceId, 1api1Percent7BserviceIdPercent7D1auth1authorization1failPostRequestBodyContentApplication1jsonSchema);
