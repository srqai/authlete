...
public class AuthorizationEndpoint {
    ...
    public AuthAuthorizationApiResponse process(@Nonnull String serviceId, @Nonnull AuthAuthorizationApiRequestBody requestBody) throws Exception {
        ...
        RequestOperation<AuthAuthorizationApiRequest, AuthAuthorizationApiResponse> operation
              = new AuthAuthorizationApiOperation(sdkConfiguration);
     ...
     * 
     * @param serviceId A service ID.
     * @param 1api1Percent7BserviceIdPercent7D1auth1authorizationPostRequestBodyContentApplication1jsonSchema 
     * @return The response from the API call
     * @throws Exception if the API call fails
     */
    public AuthAuthorizationApiFormResponse processForm(@Nonnull String serviceId, @Nonnull 1api1Percent7BserviceIdPercent7D1auth1authorizationPostRequestBodyContentApplication1jsonSchema 1api1Percent7BserviceIdPercent7D1auth1authorizationPostRequestBodyContentApplication1jsonSchema) throws Exception {
        AuthAuthorizationApiFormRequest request = new AuthAuthorizationApiFormRequest(serviceId, 1api1Percent7BserviceIdPercent7D1auth1authorizationPostRequestBodyContentApplication1jsonSchema);
        RequestOperation<AuthAuthorizationApiFormRequest, AuthAuthorizationApiFormResponse> operation
              = new AuthAuthorizationApiFormOperation(sdkConfiguration);
        return operation.handleResponse(operation.doRequest(request));
    }
     ...
     * 
     * @param serviceId A service ID
     * @param 1api1Percent7BserviceIdPercent7D1auth1authorization1ticket1updatePostRequestBodyContentApplication1jsonSchema 
     * @return The response from the API call
     * @throws Exception if the API call fails
     */
    public PostApiServiceIdAuthAuthorizationTicketUpdateFormResponse updateTicketForm(@Nonnull String serviceId, @Nonnull 1api1Percent7BserviceIdPercent7D1auth1authorization1ticket1updatePostRequestBodyContentApplication1jsonSchema 1api1Percent7BserviceIdPercent7D1auth1authorization1ticket1updatePostRequestBodyContentApplication1jsonSchema) throws Exception {
        PostApiServiceIdAuthAuthorizationTicketUpdateFormRequest request = new PostApiServiceIdAuthAuthorizationTicketUpdateFormRequest(serviceId, 1api1Percent7BserviceIdPercent7D1auth1authorization1ticket1updatePostRequestBodyContentApplication1jsonSchema);
