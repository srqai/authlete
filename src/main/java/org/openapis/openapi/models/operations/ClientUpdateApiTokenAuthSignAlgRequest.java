 ...
 */
public enum ClientUpdateApiTokenAuthSignAlgRequest {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientUpdateApiTokenAuthSignAlgRequest(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientUpdateApiTokenAuthSignAlgRequest> fromValue(String value) {
        for (ClientUpdateApiTokenAuthSignAlgRequest o: ClientUpdateApiTokenAuthSignAlgRequest.values()) {
