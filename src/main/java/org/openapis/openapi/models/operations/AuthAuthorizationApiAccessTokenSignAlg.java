 ...
 */
public enum AuthAuthorizationApiAccessTokenSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    AuthAuthorizationApiAccessTokenSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<AuthAuthorizationApiAccessTokenSignAlg> fromValue(String value) {
        for (AuthAuthorizationApiAccessTokenSignAlg o: AuthAuthorizationApiAccessTokenSignAlg.values()) {
