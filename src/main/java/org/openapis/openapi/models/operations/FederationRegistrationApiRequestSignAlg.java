 ...
 */
public enum FederationRegistrationApiRequestSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    FederationRegistrationApiRequestSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<FederationRegistrationApiRequestSignAlg> fromValue(String value) {
        for (FederationRegistrationApiRequestSignAlg o: FederationRegistrationApiRequestSignAlg.values()) {
