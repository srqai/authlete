 ...
 */
public enum ClientRegistrationDeleteApiFormRequestEncryptionEnc {
    ...
    ClientRegistrationDeleteApiFormRequestEncryptionEnc(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationDeleteApiFormRequestEncryptionEnc> fromValue(String value) {
        for (ClientRegistrationDeleteApiFormRequestEncryptionEnc o: ClientRegistrationDeleteApiFormRequestEncryptionEnc.values()) {
