...
public class AuthAuthorizationApiCredentialIssuerMetadata {
    /**
    ...
    @JsonCreator
    public AuthAuthorizationApiCredentialIssuerMetadata(
     ...
     * The identifier of a credential request.
     */
    public AuthAuthorizationApiCredentialIssuerMetadata withCredentialIssuer(@Nullable String credentialIssuer) {
        this.credentialIssuer = credentialIssuer;
        return this;
    }
     ...
     * relies on for authorization.
     */
    public AuthAuthorizationApiCredentialIssuerMetadata withAuthorizationServer(@Nullable String authorizationServer) {
        this.authorizationServer = authorizationServer;
        return this;
    }
     ...
     * The URL of the credential endpoint of the credential issuer.
     */
    public AuthAuthorizationApiCredentialIssuerMetadata withCredentialEndpoint(@Nullable Boolean credentialEndpoint) {
        this.credentialEndpoint = credentialEndpoint;
        return this;
    }
     ...
     * The URL of the batch credential endpoint of the credential issuer.
     */
    public AuthAuthorizationApiCredentialIssuerMetadata withBatchCredentialEndpoint(@Nullable Long batchCredentialEndpoint) {
        this.batchCredentialEndpoint = batchCredentialEndpoint;
        return this;
    }
     ...
     * The URL of the deferred credential endpoint of the credential issuer.
     */
    public AuthAuthorizationApiCredentialIssuerMetadata withDeferredCredentialEndpoint(@Nullable String deferredCredentialEndpoint) {
        this.deferredCredentialEndpoint = deferredCredentialEndpoint;
        return this;
    }
     ...
     * A JSON array describing supported credentials.
     */
    public AuthAuthorizationApiCredentialIssuerMetadata withCredentialsSupported(@Nullable Boolean credentialsSupported) {
        this.credentialsSupported = credentialsSupported;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AuthAuthorizationApiCredentialIssuerMetadata other = (AuthAuthorizationApiCredentialIssuerMetadata) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AuthAuthorizationApiCredentialIssuerMetadata.class,
    ...
    public final static class Builder {
        ...
        public AuthAuthorizationApiCredentialIssuerMetadata build() {
            return new AuthAuthorizationApiCredentialIssuerMetadata(
                credentialIssuer, authorizationServer, credentialEndpoint,
                batchCredentialEndpoint, deferredCredentialEndpoint, credentialsSupported);
        }
