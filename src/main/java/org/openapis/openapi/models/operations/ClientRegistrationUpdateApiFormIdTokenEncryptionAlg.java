 ...
 */
public enum ClientRegistrationUpdateApiFormIdTokenEncryptionAlg {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientRegistrationUpdateApiFormIdTokenEncryptionAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationUpdateApiFormIdTokenEncryptionAlg> fromValue(String value) {
        for (ClientRegistrationUpdateApiFormIdTokenEncryptionAlg o: ClientRegistrationUpdateApiFormIdTokenEncryptionAlg.values()) {
