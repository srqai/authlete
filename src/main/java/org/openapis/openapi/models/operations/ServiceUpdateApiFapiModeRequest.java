...
public enum ServiceUpdateApiFapiModeRequest {
    ...
    ServiceUpdateApiFapiModeRequest(String value) {
        this.value = value;
    }
    ...
    public static Optional<ServiceUpdateApiFapiModeRequest> fromValue(String value) {
        for (ServiceUpdateApiFapiModeRequest o: ServiceUpdateApiFapiModeRequest.values()) {
