 ...
 */
public enum ClientRegistrationApiAuthorizationSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientRegistrationApiAuthorizationSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationApiAuthorizationSignAlg> fromValue(String value) {
        for (ClientRegistrationApiAuthorizationSignAlg o: ClientRegistrationApiAuthorizationSignAlg.values()) {
