 ...
 */
public enum ClientUpdateApiRequestEncryptionAlgResponse {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientUpdateApiRequestEncryptionAlgResponse(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientUpdateApiRequestEncryptionAlgResponse> fromValue(String value) {
        for (ClientUpdateApiRequestEncryptionAlgResponse o: ClientUpdateApiRequestEncryptionAlgResponse.values()) {
