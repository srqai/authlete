 ...
 */
public enum ClientRegistrationDeleteApiIdTokenEncryptionAlg {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientRegistrationDeleteApiIdTokenEncryptionAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationDeleteApiIdTokenEncryptionAlg> fromValue(String value) {
        for (ClientRegistrationDeleteApiIdTokenEncryptionAlg o: ClientRegistrationDeleteApiIdTokenEncryptionAlg.values()) {
