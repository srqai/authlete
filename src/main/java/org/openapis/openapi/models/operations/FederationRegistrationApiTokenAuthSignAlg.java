 ...
 */
public enum FederationRegistrationApiTokenAuthSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    FederationRegistrationApiTokenAuthSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<FederationRegistrationApiTokenAuthSignAlg> fromValue(String value) {
        for (FederationRegistrationApiTokenAuthSignAlg o: FederationRegistrationApiTokenAuthSignAlg.values()) {
