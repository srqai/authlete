 ...
 */
public enum ServiceCreateApiSupportedDisplayResponse {
    PAGE("PAGE"),
    POPUP("POPUP"),
    TOUCH("TOUCH"),
    WAP("WAP");
    ...
    ServiceCreateApiSupportedDisplayResponse(String value) {
        this.value = value;
    }
    ...
    public static Optional<ServiceCreateApiSupportedDisplayResponse> fromValue(String value) {
        for (ServiceCreateApiSupportedDisplayResponse o: ServiceCreateApiSupportedDisplayResponse.values()) {
