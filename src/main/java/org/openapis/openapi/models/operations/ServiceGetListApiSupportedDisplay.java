 ...
 */
public enum ServiceGetListApiSupportedDisplay {
    PAGE("PAGE"),
    POPUP("POPUP"),
    TOUCH("TOUCH"),
    WAP("WAP");
    ...
    ServiceGetListApiSupportedDisplay(String value) {
        this.value = value;
    }
    ...
    public static Optional<ServiceGetListApiSupportedDisplay> fromValue(String value) {
        for (ServiceGetListApiSupportedDisplay o: ServiceGetListApiSupportedDisplay.values()) {
