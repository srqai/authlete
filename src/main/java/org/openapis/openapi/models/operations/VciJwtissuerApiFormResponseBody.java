...
public class VciJwtissuerApiFormResponseBody {
    /**
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("action")
    private VciJwtissuerApiFormAction action;
     ...
     * a response from Authlete's `/vci/jwtissuer` API.
     */
    public Optional<VciJwtissuerApiFormAction> action() {
     ...
     * The code which represents the result of the API call.
     */
    public VciJwtissuerApiFormResponseBody withResultCode(@Nullable String resultCode) {
        this.resultCode = resultCode;
        return this;
    }
     ...
     * A short message which explains the result of the API call.
     */
    public VciJwtissuerApiFormResponseBody withResultMessage(@Nullable String resultMessage) {
        this.resultMessage = resultMessage;
        return this;
    }
     ...
     * a response from Authlete's `/vci/jwtissuer` API.
     */
    public VciJwtissuerApiFormResponseBody withAction(@Nullable VciJwtissuerApiFormAction action) {
        this.action = action;
        return this;
    }
     ...
     * metadata endpoint should use when it constructs a response.
     */
    public VciJwtissuerApiFormResponseBody withResponseContent(@Nullable String responseContent) {
        this.responseContent = responseContent;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        VciJwtissuerApiFormResponseBody other = (VciJwtissuerApiFormResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(VciJwtissuerApiFormResponseBody.class,
    ...
    public final static class Builder {
         ...
         * a response from Authlete's `/vci/jwtissuer` API.
         */
        public Builder action(@Nullable VciJwtissuerApiFormAction action) {
            this.action = action;
            return this;
        }
        ...
        public VciJwtissuerApiFormResponseBody build() {
            return new VciJwtissuerApiFormResponseBody(
                resultCode, resultMessage, action,
                responseContent);
        }
