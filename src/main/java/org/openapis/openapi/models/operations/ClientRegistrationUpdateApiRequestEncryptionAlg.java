 ...
 */
public enum ClientRegistrationUpdateApiRequestEncryptionAlg {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientRegistrationUpdateApiRequestEncryptionAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationUpdateApiRequestEncryptionAlg> fromValue(String value) {
        for (ClientRegistrationUpdateApiRequestEncryptionAlg o: ClientRegistrationUpdateApiRequestEncryptionAlg.values()) {
