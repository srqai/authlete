 ...
 */
public enum ClientRegistrationApiFormUserInfoSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientRegistrationApiFormUserInfoSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationApiFormUserInfoSignAlg> fromValue(String value) {
        for (ClientRegistrationApiFormUserInfoSignAlg o: ClientRegistrationApiFormUserInfoSignAlg.values()) {
