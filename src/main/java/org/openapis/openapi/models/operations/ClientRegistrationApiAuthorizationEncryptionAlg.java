 ...
 */
public enum ClientRegistrationApiAuthorizationEncryptionAlg {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientRegistrationApiAuthorizationEncryptionAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationApiAuthorizationEncryptionAlg> fromValue(String value) {
        for (ClientRegistrationApiAuthorizationEncryptionAlg o: ClientRegistrationApiAuthorizationEncryptionAlg.values()) {
