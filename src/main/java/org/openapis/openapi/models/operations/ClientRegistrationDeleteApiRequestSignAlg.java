 ...
 */
public enum ClientRegistrationDeleteApiRequestSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientRegistrationDeleteApiRequestSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationDeleteApiRequestSignAlg> fromValue(String value) {
        for (ClientRegistrationDeleteApiRequestSignAlg o: ClientRegistrationDeleteApiRequestSignAlg.values()) {
