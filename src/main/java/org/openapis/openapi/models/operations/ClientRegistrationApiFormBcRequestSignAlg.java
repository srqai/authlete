 ...
 */
public enum ClientRegistrationApiFormBcRequestSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientRegistrationApiFormBcRequestSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationApiFormBcRequestSignAlg> fromValue(String value) {
        for (ClientRegistrationApiFormBcRequestSignAlg o: ClientRegistrationApiFormBcRequestSignAlg.values()) {
