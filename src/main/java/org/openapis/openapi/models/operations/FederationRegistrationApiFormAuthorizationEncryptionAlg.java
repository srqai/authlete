 ...
 */
public enum FederationRegistrationApiFormAuthorizationEncryptionAlg {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    FederationRegistrationApiFormAuthorizationEncryptionAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<FederationRegistrationApiFormAuthorizationEncryptionAlg> fromValue(String value) {
        for (FederationRegistrationApiFormAuthorizationEncryptionAlg o: FederationRegistrationApiFormAuthorizationEncryptionAlg.values()) {
