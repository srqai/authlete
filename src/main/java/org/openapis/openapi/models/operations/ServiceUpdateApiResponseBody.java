...
public class ServiceUpdateApiResponseBody {
    /**
    ...
    private List<ServiceUpdateApiMetadatumResponse> metadata;
    ...
    private List<ServiceUpdateApiSupportedGrantTypeResponse> supportedGrantTypes;
    ...
    private List<ServiceUpdateApiSupportedResponseTypeResponse> supportedResponseTypes;
    ...
    private List<ServiceUpdateApiSupportedServiceProfileResponse> supportedServiceProfiles;
    ...
    private List<ServiceUpdateApiSupportedDisplayResponse> supportedDisplays;
    ...
    private List<ServiceUpdateApiSupportedTokenAuthMethodResponse> supportedTokenAuthMethods;
    ...
    private List<ServiceUpdateApiSupportedRevocationAuthMethodResponse> supportedRevocationAuthMethods;
    ...
    private List<ServiceUpdateApiSupportedIntrospectionAuthMethodResponse> supportedIntrospectionAuthMethods;
    ...
    private List<ServiceUpdateApiMtlsEndpointAliasResponse> mtlsEndpointAliases;
    ...
    private ServiceUpdateApiAccessTokenSignAlgResponse accessTokenSignAlg;
    ...
    private List<ServiceUpdateApiSupportedScopeResponse> supportedScopes;
    ...
    private List<ServiceUpdateApiSupportedClaimTypeResponse> supportedClaimTypes;
    ...
    private List<ServiceUpdateApiSupportedBackchannelTokenDeliveryModeResponse> supportedBackchannelTokenDeliveryModes;
    ...
    private ServiceUpdateApiUserCodeCharsetResponse userCodeCharset;
    ...
    private ServiceUpdateApiVerifiedClaimsValidationSchemaSetResponse verifiedClaimsValidationSchemaSet;
    ...
    private List<ServiceUpdateApiAttributeResponse> attributes;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("hsks")
    private List<ServiceUpdateApiHskResponse> hsks;
    ...
    private List<ServiceUpdateApiSupportedAttachmentResponse> supportedAttachments;
    ...
    private List<ServiceUpdateApiSupportedClientRegistrationTypeResponse> supportedClientRegistrationTypes;
    ...
    private List<ServiceUpdateApiTrustAnchorResponse> trustAnchors;
    ...
    private List<ServiceUpdateApiSupportedPromptValueResponse> supportedPromptValues;
    ...
    private List<ServiceUpdateApiFapiModeResponse> fapiModes;
    ...
    private ServiceUpdateApiCredentialIssuerMetadataResponse credentialIssuerMetadata;
    ...
    @JsonCreator
    public ServiceUpdateApiResponseBody(
            ...
            @JsonProperty("metadata") @Nullable List<ServiceUpdateApiMetadatumResponse> metadata,
            ...
            @JsonProperty("supportedGrantTypes") @Nullable List<ServiceUpdateApiSupportedGrantTypeResponse> supportedGrantTypes,
            @JsonProperty("supportedResponseTypes") @Nullable List<ServiceUpdateApiSupportedResponseTypeResponse> supportedResponseTypes,
            @JsonProperty("supportedAuthorizationDetailsTypes") @Nullable List<String> supportedAuthorizationDetailsTypes,
            @JsonProperty("supportedServiceProfiles") @Nullable List<ServiceUpdateApiSupportedServiceProfileResponse> supportedServiceProfiles,
            ...
            @JsonProperty("supportedDisplays") @Nullable List<ServiceUpdateApiSupportedDisplayResponse> supportedDisplays,
            ...
            @JsonProperty("supportedTokenAuthMethods") @Nullable List<ServiceUpdateApiSupportedTokenAuthMethodResponse> supportedTokenAuthMethods,
            ...
            @JsonProperty("supportedRevocationAuthMethods") @Nullable List<ServiceUpdateApiSupportedRevocationAuthMethodResponse> supportedRevocationAuthMethods,
            ...
            @JsonProperty("supportedIntrospectionAuthMethods") @Nullable List<ServiceUpdateApiSupportedIntrospectionAuthMethodResponse> supportedIntrospectionAuthMethods,
            ...
            @JsonProperty("mtlsEndpointAliases") @Nullable List<ServiceUpdateApiMtlsEndpointAliasResponse> mtlsEndpointAliases,
            ...
            @JsonProperty("accessTokenSignAlg") @Nullable ServiceUpdateApiAccessTokenSignAlgResponse accessTokenSignAlg,
            ...
            @JsonProperty("supportedScopes") @Nullable List<ServiceUpdateApiSupportedScopeResponse> supportedScopes,
            ...
            @JsonProperty("supportedClaimTypes") @Nullable List<ServiceUpdateApiSupportedClaimTypeResponse> supportedClaimTypes,
            ...
            @JsonProperty("supportedBackchannelTokenDeliveryModes") @Nullable List<ServiceUpdateApiSupportedBackchannelTokenDeliveryModeResponse> supportedBackchannelTokenDeliveryModes,
            ...
            @JsonProperty("userCodeCharset") @Nullable ServiceUpdateApiUserCodeCharsetResponse userCodeCharset,
            ...
            @JsonProperty("verifiedClaimsValidationSchemaSet") @Nullable ServiceUpdateApiVerifiedClaimsValidationSchemaSetResponse verifiedClaimsValidationSchemaSet,
            @JsonProperty("attributes") @Nullable List<ServiceUpdateApiAttributeResponse> attributes,
            ...
            @JsonProperty("hsks") @Nullable List<ServiceUpdateApiHskResponse> hsks,
            ...
            @JsonProperty("supportedAttachments") @Nullable List<ServiceUpdateApiSupportedAttachmentResponse> supportedAttachments,
            ...
            @JsonProperty("supportedClientRegistrationTypes") @Nullable List<ServiceUpdateApiSupportedClientRegistrationTypeResponse> supportedClientRegistrationTypes,
            ...
            @JsonProperty("trustAnchors") @Nullable List<ServiceUpdateApiTrustAnchorResponse> trustAnchors,
            ...
            @JsonProperty("supportedPromptValues") @Nullable List<ServiceUpdateApiSupportedPromptValueResponse> supportedPromptValues,
            ...
            @JsonProperty("fapiModes") @Nullable List<ServiceUpdateApiFapiModeResponse> fapiModes,
            @JsonProperty("credentialDuration") @Nullable Long credentialDuration,
            @JsonProperty("credentialIssuerMetadata") @Nullable ServiceUpdateApiCredentialIssuerMetadataResponse credentialIssuerMetadata,
     ...
     *   | `clientCount` | The number of client applications which belong to this service.  |
     */
    public Optional<List<ServiceUpdateApiMetadatumResponse>> metadata() {
     ...
     * [OpenID Provider Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public Optional<List<ServiceUpdateApiSupportedGrantTypeResponse>> supportedGrantTypes() {
     ...
     * [OpenID Provider Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public Optional<List<ServiceUpdateApiSupportedResponseTypeResponse>> supportedResponseTypes() {
     ...
     * The profiles that this service supports.
     */
    public Optional<List<ServiceUpdateApiSupportedServiceProfileResponse>> supportedServiceProfiles() {
     ...
     * <p>The value of this property is used as `display_values_supported` property in the Provider Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public Optional<List<ServiceUpdateApiSupportedDisplayResponse>> supportedDisplays() {
     ...
     * [OpenID Provider Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public Optional<List<ServiceUpdateApiSupportedTokenAuthMethodResponse>> supportedTokenAuthMethods() {
     ...
     * Client authentication methods supported at the revocation endpoint.
     */
    public Optional<List<ServiceUpdateApiSupportedRevocationAuthMethodResponse>> supportedRevocationAuthMethods() {
     ...
     * Client authentication methods supported at the introspection endpoint.
     */
    public Optional<List<ServiceUpdateApiSupportedIntrospectionAuthMethodResponse>> supportedIntrospectionAuthMethods() {
     ...
     * ```
     */
    public Optional<List<ServiceUpdateApiMtlsEndpointAliasResponse>> mtlsEndpointAliases() {
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public Optional<ServiceUpdateApiAccessTokenSignAlgResponse> accessTokenSignAlg() {
     ...
     * <p>The value of this property is used as `scopes_supported` property in the [OpenID Provider Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public Optional<List<ServiceUpdateApiSupportedScopeResponse>> supportedScopes() {
     ...
     * Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public Optional<List<ServiceUpdateApiSupportedClaimTypeResponse>> supportedClaimTypes() {
     ...
     * Backchannel Authentication)](https://openid.net/specs/openid-client-initiated-backchannel-authentication-core-1_0.html).
     */
    public Optional<List<ServiceUpdateApiSupportedBackchannelTokenDeliveryModeResponse>> supportedBackchannelTokenDeliveryModes() {
     ...
     * The character set for end-user verification codes (`user_code`) for Device Flow.
     */
    public Optional<ServiceUpdateApiUserCodeCharsetResponse> userCodeCharset() {
     ...
     * OIDC4IDA / verifiedClaimsValidationSchemaSet
     */
    public Optional<ServiceUpdateApiVerifiedClaimsValidationSchemaSetResponse> verifiedClaimsValidationSchemaSet() {
     ...
     * The attributes of this service.
     */
    public Optional<List<ServiceUpdateApiAttributeResponse>> attributes() {
     ...
     * only by `/api/hsk/*` APIs.
     */
    public Optional<List<ServiceUpdateApiHskResponse>> hsks() {
     ...
     * implementer's draft of OpenID Connect for Identity Assurance 1.0.
     */
    public Optional<List<ServiceUpdateApiSupportedAttachmentResponse>> supportedAttachments() {
    ...
    public Optional<List<ServiceUpdateApiSupportedClientRegistrationTypeResponse>> supportedClientRegistrationTypes() {
     ...
     * that OpenID Connect Federation 1.0 does not work.
     */
    public Optional<List<ServiceUpdateApiTrustAnchorResponse>> trustAnchors() {
     ...
     * The supported `prompt` values.
     */
    public Optional<List<ServiceUpdateApiSupportedPromptValueResponse>> supportedPromptValues() {
     ...
     * Advanced" if the FAPI feature is enabled in Authlete and the FAPI profile is supported by this service.
     */
    public Optional<List<ServiceUpdateApiFapiModeResponse>> fapiModes() {
    ...
    public Optional<ServiceUpdateApiCredentialIssuerMetadataResponse> credentialIssuerMetadata() {
     ...
     * The sequential number of the service. The value of this property is assigned by Authlete.
     */
    public ServiceUpdateApiResponseBody withNumber(@Nullable Integer number) {
        this.number = number;
        return this;
    }
     ...
     * The name of this service.
     */
    public ServiceUpdateApiResponseBody withServiceName(@Nullable String serviceName) {
        this.serviceName = serviceName;
        return this;
    }
     ...
     * and `issuer` property in the [OpenID Provider Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public ServiceUpdateApiResponseBody withIssuer(@Nullable String issuer) {
        this.issuer = issuer;
        return this;
    }
     ...
     * The description about the service.
     */
    public ServiceUpdateApiResponseBody withDescription(@Nullable String description) {
        this.description = description;
        return this;
    }
     ...
     * The service ID used in Authlete API calls. The value of this property is assigned by Authlete.
     */
    public ServiceUpdateApiResponseBody withApiKey(@Nullable Long apiKey) {
        this.apiKey = apiKey;
        return this;
    }
     ...
     * Deprecated. Always `true`.
     */
    public ServiceUpdateApiResponseBody withClientIdAliasEnabled(@Nullable Boolean clientIdAliasEnabled) {
        this.clientIdAliasEnabled = clientIdAliasEnabled;
        return this;
    }
     ...
     *   | `clientCount` | The number of client applications which belong to this service.  |
     */
    public ServiceUpdateApiResponseBody withMetadata(@Nullable List<ServiceUpdateApiMetadatumResponse> metadata) {
        this.metadata = metadata;
        return this;
    }
     ...
     * UNIX epoch (`1970-01-01`).
     */
    public ServiceUpdateApiResponseBody withCreatedAt(@Nullable Long createdAt) {
        this.createdAt = createdAt;
        return this;
    }
     ...
     * the UNIX epoch (1970-01-01).
     */
    public ServiceUpdateApiResponseBody withModifiedAt(@Nullable Long modifiedAt) {
        this.modifiedAt = modifiedAt;
        return this;
    }
     ...
     * a `POST` request to this endpoint.
     */
    public ServiceUpdateApiResponseBody withAuthenticationCallbackEndpoint(@Nullable String authenticationCallbackEndpoint) {
        this.authenticationCallbackEndpoint = authenticationCallbackEndpoint;
        return this;
    }
     ...
     * making a request to the authentication callback endpoint.
     */
    public ServiceUpdateApiResponseBody withAuthenticationCallbackApiKey(@Nullable String authenticationCallbackApiKey) {
        this.authenticationCallbackApiKey = authenticationCallbackApiKey;
        return this;
    }
     ...
     * API secret for `basic` authentication at the authentication callback endpoint.
     */
    public ServiceUpdateApiResponseBody withAuthenticationCallbackApiSecret(@Nullable String authenticationCallbackApiSecret) {
        this.authenticationCallbackApiSecret = authenticationCallbackApiSecret;
        return this;
    }
     ...
     * property in the [OpenID Provider Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public ServiceUpdateApiResponseBody withSupportedAcrs(@Nullable List<String> supportedAcrs) {
        this.supportedAcrs = supportedAcrs;
        return this;
    }
     ...
     * [OpenID Provider Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public ServiceUpdateApiResponseBody withSupportedGrantTypes(@Nullable List<ServiceUpdateApiSupportedGrantTypeResponse> supportedGrantTypes) {
        this.supportedGrantTypes = supportedGrantTypes;
        return this;
    }
     ...
     * [OpenID Provider Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public ServiceUpdateApiResponseBody withSupportedResponseTypes(@Nullable List<ServiceUpdateApiSupportedResponseTypeResponse> supportedResponseTypes) {
        this.supportedResponseTypes = supportedResponseTypes;
        return this;
    }
     ...
     * Rich Authorization Requests" (RAR) for details.
     */
    public ServiceUpdateApiResponseBody withSupportedAuthorizationDetailsTypes(@Nullable List<String> supportedAuthorizationDetailsTypes) {
        this.supportedAuthorizationDetailsTypes = supportedAuthorizationDetailsTypes;
        return this;
    }
     ...
     * The profiles that this service supports.
     */
    public ServiceUpdateApiResponseBody withSupportedServiceProfiles(@Nullable List<ServiceUpdateApiSupportedServiceProfileResponse> supportedServiceProfiles) {
        this.supportedServiceProfiles = supportedServiceProfiles;
        return this;
    }
     ...
     * <p>If `true`, Authlete does not embed the `error_description` response parameter in error responses.
     */
    public ServiceUpdateApiResponseBody withErrorDescriptionOmitted(@Nullable Boolean errorDescriptionOmitted) {
        this.errorDescriptionOmitted = errorDescriptionOmitted;
        return this;
    }
     ...
     * `error_uri` response parameter in error responses.
     */
    public ServiceUpdateApiResponseBody withErrorUriOmitted(@Nullable Boolean errorUriOmitted) {
        this.errorUriOmitted = errorUriOmitted;
        return this;
    }
     ...
     * Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public ServiceUpdateApiResponseBody withAuthorizationEndpoint(@Nullable String authorizationEndpoint) {
        this.authorizationEndpoint = authorizationEndpoint;
        return this;
    }
     ...
     * <p>The path of the endpoint is `/api/auth/authorization/direct/service-api-key`.
     */
    public ServiceUpdateApiResponseBody withDirectAuthorizationEndpointEnabled(@Nullable Boolean directAuthorizationEndpointEnabled) {
        this.directAuthorizationEndpointEnabled = directAuthorizationEndpointEnabled;
        return this;
    }
     ...
     * <p>The value of this property is used as `ui_locales_supported` property in the [OpenID Provider Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public ServiceUpdateApiResponseBody withSupportedUiLocales(@Nullable List<String> supportedUiLocales) {
        this.supportedUiLocales = supportedUiLocales;
        return this;
    }
     ...
     * <p>The value of this property is used as `display_values_supported` property in the Provider Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public ServiceUpdateApiResponseBody withSupportedDisplays(@Nullable List<ServiceUpdateApiSupportedDisplayResponse> supportedDisplays) {
        this.supportedDisplays = supportedDisplays;
        return this;
    }
     ...
     * <p>See [RFC 7636](https://tools.ietf.org/html/rfc7636) (Proof Key for Code Exchange by OAuth Public Clients) for details about `code_challenge` request parameter.
     */
    public ServiceUpdateApiResponseBody withPkceRequired(@Nullable Boolean pkceRequired) {
        this.pkceRequired = pkceRequired;
        return this;
    }
     ...
     * Neither omission of the `code_challenge_method` request parameter nor use of plain (`code_challenge_method=plain`) is allowed.
     */
    public ServiceUpdateApiResponseBody withPkceS256Required(@Nullable Boolean pkceS256Required) {
        this.pkceS256Required = pkceS256Required;
        return this;
    }
     ...
     * value of the `exp` claim of the JWT.
     */
    public ServiceUpdateApiResponseBody withAuthorizationResponseDuration(@Nullable Long authorizationResponseDuration) {
        this.authorizationResponseDuration = authorizationResponseDuration;
        return this;
    }
     ...
     * [OpenID Provider Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public ServiceUpdateApiResponseBody withTokenEndpoint(@Nullable String tokenEndpoint) {
        this.tokenEndpoint = tokenEndpoint;
        return this;
    }
     ...
     * is `/api/auth/token/direct/service-api-key`.
     */
    public ServiceUpdateApiResponseBody withDirectTokenEndpointEnabled(@Nullable Boolean directTokenEndpointEnabled) {
        this.directTokenEndpointEnabled = directTokenEndpointEnabled;
        return this;
    }
     ...
     * [OpenID Provider Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public ServiceUpdateApiResponseBody withSupportedTokenAuthMethods(@Nullable List<ServiceUpdateApiSupportedTokenAuthMethodResponse> supportedTokenAuthMethods) {
        this.supportedTokenAuthMethods = supportedTokenAuthMethods;
        return this;
    }
     ...
     * <p>This flag should not be set unless you have special reasons.
     */
    public ServiceUpdateApiResponseBody withMissingClientIdAllowed(@Nullable Boolean missingClientIdAllowed) {
        this.missingClientIdAllowed = missingClientIdAllowed;
        return this;
    }
     ...
     * <p>A URL that starts with `https://`. For example, `https://example.com/auth/revocation`.
     */
    public ServiceUpdateApiResponseBody withRevocationEndpoint(@Nullable String revocationEndpoint) {
        this.revocationEndpoint = revocationEndpoint;
        return this;
    }
     ...
     * The flag to indicate whether the direct revocation endpoint is enabled or not. The URL of the endpoint is `/api/auth/revocation/direct/service-api-key`.
     */
    public ServiceUpdateApiResponseBody withDirectRevocationEndpointEnabled(@Nullable Boolean directRevocationEndpointEnabled) {
        this.directRevocationEndpointEnabled = directRevocationEndpointEnabled;
        return this;
    }
     ...
     * Client authentication methods supported at the revocation endpoint.
     */
    public ServiceUpdateApiResponseBody withSupportedRevocationAuthMethods(@Nullable List<ServiceUpdateApiSupportedRevocationAuthMethodResponse> supportedRevocationAuthMethods) {
        this.supportedRevocationAuthMethods = supportedRevocationAuthMethods;
        return this;
    }
     ...
     * The URI of the introspection endpoint.
     */
    public ServiceUpdateApiResponseBody withIntrospectionEndpoint(@Nullable String introspectionEndpoint) {
        this.introspectionEndpoint = introspectionEndpoint;
        return this;
    }
     ...
     * The flag to indicate whether the direct userinfo endpoint is enabled or not. The path of the endpoint is `/api/auth/userinfo/direct/{serviceApiKey}`.
     */
    public ServiceUpdateApiResponseBody withDirectIntrospectionEndpointEnabled(@Nullable Boolean directIntrospectionEndpointEnabled) {
        this.directIntrospectionEndpointEnabled = directIntrospectionEndpointEnabled;
        return this;
    }
     ...
     * Client authentication methods supported at the introspection endpoint.
     */
    public ServiceUpdateApiResponseBody withSupportedIntrospectionAuthMethods(@Nullable List<ServiceUpdateApiSupportedIntrospectionAuthMethodResponse> supportedIntrospectionAuthMethods) {
        this.supportedIntrospectionAuthMethods = supportedIntrospectionAuthMethods;
        return this;
    }
     ...
     * <p>This property corresponds to the `pushed_authorization_request_endpoint` metadata defined in "[5. Authorization Server Metadata](https://tools.ietf.org/html/draft-lodderstedt-oauth-par#section-5)" of OAuth 2.0 Pushed Authorization Requests.
     */
    public ServiceUpdateApiResponseBody withPushedAuthReqEndpoint(@Nullable String pushedAuthReqEndpoint) {
        this.pushedAuthReqEndpoint = pushedAuthReqEndpoint;
        return this;
    }
     ...
     * of the `expires_in` parameter in responses from the pushed authorization request endpoint.
     */
    public ServiceUpdateApiResponseBody withPushedAuthReqDuration(@Nullable Long pushedAuthReqDuration) {
        this.pushedAuthReqDuration = pushedAuthReqDuration;
        return this;
    }
     ...
     * in [OAuth 2.0 Pushed Authorization Requests](https://tools.ietf.org/html/draft-lodderstedt-oauth-par).
     */
    public ServiceUpdateApiResponseBody withParRequired(@Nullable Boolean parRequired) {
        this.parRequired = parRequired;
        return this;
    }
     ...
     * conform to the JAR specification are rejected.
     */
    public ServiceUpdateApiResponseBody withRequestObjectRequired(@Nullable Boolean requestObjectRequired) {
        this.requestObjectRequired = requestObjectRequired;
        return this;
    }
     ...
     * requests which don't conform to the JAR specification are rejected.
     */
    public ServiceUpdateApiResponseBody withTraditionalRequestObjectProcessingApplied(@Nullable Boolean traditionalRequestObjectProcessingApplied) {
        this.traditionalRequestObjectProcessingApplied = traditionalRequestObjectProcessingApplied;
        return this;
    }
     ...
     * The flag to indicate whether this service validates certificate chains during PKI-based client mutual TLS authentication.
     */
    public ServiceUpdateApiResponseBody withMutualTlsValidatePkiCertChain(@Nullable Boolean mutualTlsValidatePkiCertChain) {
        this.mutualTlsValidatePkiCertChain = mutualTlsValidatePkiCertChain;
        return this;
    }
     ...
     * The list of root certificates trusted by this service for PKI-based client mutual TLS authentication.
     */
    public ServiceUpdateApiResponseBody withTrustedRootCertificates(@Nullable List<String> trustedRootCertificates) {
        this.trustedRootCertificates = trustedRootCertificates;
        return this;
    }
     ...
     * ```
     */
    public ServiceUpdateApiResponseBody withMtlsEndpointAliases(@Nullable List<ServiceUpdateApiMtlsEndpointAliasResponse> mtlsEndpointAliases) {
        this.mtlsEndpointAliases = mtlsEndpointAliases;
        return this;
    }
     ...
     * <p>See [RFC 6749 (OAuth 2.0), 7.1. Access Token Types](https://tools.ietf.org/html/rfc6749#section-7.1) for details.
     */
    public ServiceUpdateApiResponseBody withAccessTokenType(@Nullable String accessTokenType) {
        this.accessTokenType = accessTokenType;
        return this;
    }
     ...
     * The flag to indicate whether this service supports issuing TLS client certificate bound access tokens.
     */
    public ServiceUpdateApiResponseBody withTlsClientCertificateBoundAccessTokens(@Nullable Boolean tlsClientCertificateBoundAccessTokens) {
        this.tlsClientCertificateBoundAccessTokens = tlsClientCertificateBoundAccessTokens;
        return this;
    }
     ...
     * in access token responses. `expires_in` is defined [RFC 6749, 5.1. Successful Response](https://tools.ietf.org/html/rfc6749#section-5.1).
     */
    public ServiceUpdateApiResponseBody withAccessTokenDuration(@Nullable Long accessTokenDuration) {
        this.accessTokenDuration = accessTokenDuration;
        return this;
    }
     ...
     * <p>Note that, however, attempts by [Client Credentials Flow](https://tools.ietf.org/html/rfc6749#section-4.4) do not invalidate existing access tokens because access tokens issued by Client Credentials Flow are not associated with any end-user's subject. Also note that an attempt by [Refresh Token Flow](https://tools.ietf.org/html/rfc6749#section-6) invalidates the coupled access token only and this invalidation is always performed regardless of whether the value of this setting item is `true` or `false`.
     */
    public ServiceUpdateApiResponseBody withSingleAccessTokenPerSubject(@Nullable Boolean singleAccessTokenPerSubject) {
        this.singleAccessTokenPerSubject = singleAccessTokenPerSubject;
        return this;
    }
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public ServiceUpdateApiResponseBody withAccessTokenSignAlg(@Nullable ServiceUpdateApiAccessTokenSignAlgResponse accessTokenSignAlg) {
        this.accessTokenSignAlg = accessTokenSignAlg;
        return this;
    }
     ...
     * to be specified so that Authlete Server can pick up one JWK from among the JWK candidates.
     */
    public ServiceUpdateApiResponseBody withAccessTokenSignatureKeyId(@Nullable String accessTokenSignatureKeyId) {
        this.accessTokenSignatureKeyId = accessTokenSignatureKeyId;
        return this;
    }
     ...
     * The duration of refresh tokens in seconds. The related specifications have no requirements on refresh token duration, but Authlete sets expiration for refresh tokens.
     */
    public ServiceUpdateApiResponseBody withRefreshTokenDuration(@Nullable Long refreshTokenDuration) {
        this.refreshTokenDuration = refreshTokenDuration;
        return this;
    }
     ...
     * the newly issued refresh token.
     */
    public ServiceUpdateApiResponseBody withRefreshTokenDurationKept(@Nullable Boolean refreshTokenDurationKept) {
        this.refreshTokenDurationKept = refreshTokenDurationKept;
        return this;
    }
     ...
     * `refreshTokenDurationReset` property is not referenced.
     */
    public ServiceUpdateApiResponseBody withRefreshTokenDurationReset(@Nullable Boolean refreshTokenDurationReset) {
        this.refreshTokenDurationReset = refreshTokenDurationReset;
        return this;
    }
     ...
     * <p>See [RFC 6749 6. Refreshing an Access Token](https://tools.ietf.org/html/rfc6749#section-6), as to how to get a new access token using a refresh token.
     */
    public ServiceUpdateApiResponseBody withRefreshTokenKept(@Nullable Boolean refreshTokenKept) {
        this.refreshTokenKept = refreshTokenKept;
        return this;
    }
     ...
     * <p>The value of this property is used as `scopes_supported` property in the [OpenID Provider Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public ServiceUpdateApiResponseBody withSupportedScopes(@Nullable List<ServiceUpdateApiSupportedScopeResponse> supportedScopes) {
        this.supportedScopes = supportedScopes;
        return this;
    }
     ...
     * and want to strictly conform to the requirement above, this flag has to be `true`.
     */
    public ServiceUpdateApiResponseBody withScopeRequired(@Nullable Boolean scopeRequired) {
        this.scopeRequired = scopeRequired;
        return this;
    }
     ...
     * in seconds. This value is used to calculate the value of `exp` claim in an ID token.'
     */
    public ServiceUpdateApiResponseBody withIdTokenDuration(@Nullable Long idTokenDuration) {
        this.idTokenDuration = idTokenDuration;
        return this;
    }
     ...
     * <p>The clock skew is taken into consideration when time-related claims in a JWT (e.g. `exp`, `iat`, `nbf`) are verified.
     */
    public ServiceUpdateApiResponseBody withAllowableClockSkew(@Nullable Integer allowableClockSkew) {
        this.allowableClockSkew = allowableClockSkew;
        return this;
    }
     ...
     * Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public ServiceUpdateApiResponseBody withSupportedClaimTypes(@Nullable List<ServiceUpdateApiSupportedClaimTypeResponse> supportedClaimTypes) {
        this.supportedClaimTypes = supportedClaimTypes;
        return this;
    }
     ...
     * [OpenID Provider Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public ServiceUpdateApiResponseBody withSupportedClaimLocales(@Nullable List<String> supportedClaimLocales) {
        this.supportedClaimLocales = supportedClaimLocales;
        return this;
    }
     ...
     * Claims](https://openid.net/specs/openid-connect-core-1_0.html#AdditionalClaims).
     */
    public ServiceUpdateApiResponseBody withSupportedClaims(@Nullable List<String> supportedClaims) {
        this.supportedClaims = supportedClaims;
        return this;
    }
     ...
     * case for the response_type value id_token), the resulting Claims are returned in the ID Token.
     */
    public ServiceUpdateApiResponseBody withClaimShortcutRestrictive(@Nullable Boolean claimShortcutRestrictive) {
        this.claimShortcutRestrictive = claimShortcutRestrictive;
        return this;
    }
     ...
     * <p>The value of this property is used as `jwks_uri` property in the [OpenID Provider Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public ServiceUpdateApiResponseBody withJwksUri(@Nullable String jwksUri) {
        this.jwksUri = jwksUri;
        return this;
    }
     ...
     * is `/api/service/jwks/get/direct/service-api-key`. '
     */
    public ServiceUpdateApiResponseBody withDirectJwksEndpointEnabled(@Nullable Boolean directJwksEndpointEnabled) {
        this.directJwksEndpointEnabled = directJwksEndpointEnabled;
        return this;
    }
     ...
     * Encryption](https://openid.net/specs/openid-connect-core-1_0.html#SigEnc) for details.
     */
    public ServiceUpdateApiResponseBody withJwks(@Nullable String jwks) {
        this.jwks = jwks;
        return this;
    }
     ...
     * this mechanism is needed.
     */
    public ServiceUpdateApiResponseBody withIdTokenSignatureKeyId(@Nullable String idTokenSignatureKeyId) {
        this.idTokenSignatureKeyId = idTokenSignatureKeyId;
        return this;
    }
     ...
     * this mechanism is needed.
     */
    public ServiceUpdateApiResponseBody withUserInfoSignatureKeyId(@Nullable String userInfoSignatureKeyId) {
        this.userInfoSignatureKeyId = userInfoSignatureKeyId;
        return this;
    }
     ...
     * the key ID.
     */
    public ServiceUpdateApiResponseBody withAuthorizationSignatureKeyId(@Nullable String authorizationSignatureKeyId) {
        this.authorizationSignatureKeyId = authorizationSignatureKeyId;
        return this;
    }
     ...
     * <p>The value of this property is used as `userinfo_endpoint` property in the [OpenID Provider Metadata](http://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public ServiceUpdateApiResponseBody withUserInfoEndpoint(@Nullable String userInfoEndpoint) {
        this.userInfoEndpoint = userInfoEndpoint;
        return this;
    }
     ...
     * of the endpoint is `/api/auth/userinfo/direct/service-api-key`.
     */
    public ServiceUpdateApiResponseBody withDirectUserInfoEndpointEnabled(@Nullable Boolean directUserInfoEndpointEnabled) {
        this.directUserInfoEndpointEnabled = directUserInfoEndpointEnabled;
        return this;
    }
     ...
     * is supported.
     */
    public ServiceUpdateApiResponseBody withDynamicRegistrationSupported(@Nullable Boolean dynamicRegistrationSupported) {
        this.dynamicRegistrationSupported = dynamicRegistrationSupported;
        return this;
    }
     ...
     * <p>The value of this property is used as `registration_endpoint` property in the [OpenID Provider Metadata](http://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public ServiceUpdateApiResponseBody withRegistrationEndpoint(@Nullable String registrationEndpoint) {
        this.registrationEndpoint = registrationEndpoint;
        return this;
    }
     ...
     * be used as the URI base instead.
     */
    public ServiceUpdateApiResponseBody withRegistrationManagementEndpoint(@Nullable String registrationManagementEndpoint) {
        this.registrationManagementEndpoint = registrationManagementEndpoint;
        return this;
    }
     ...
     * <p>The value of this property is used as `op_policy_uri` property in the [OpenID Provider Metadata](http://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public ServiceUpdateApiResponseBody withPolicyUri(@Nullable String policyUri) {
        this.policyUri = policyUri;
        return this;
    }
     ...
     * <p>The value of this property is used as `op_tos_uri` property in the [OpenID Provider Metadata](http://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public ServiceUpdateApiResponseBody withTosUri(@Nullable String tosUri) {
        this.tosUri = tosUri;
        return this;
    }
     ...
     * <p>The value of this property is used as `service_documentation` property in the [OpenID Provider Metadata](http://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public ServiceUpdateApiResponseBody withServiceDocumentation(@Nullable String serviceDocumentation) {
        this.serviceDocumentation = serviceDocumentation;
        return this;
    }
     ...
     * (Client Initiated Backchannel Authentication)](https://openid.net/specs/openid-client-initiated-backchannel-authentication-core-1_0.html).
     */
    public ServiceUpdateApiResponseBody withBackchannelAuthenticationEndpoint(@Nullable String backchannelAuthenticationEndpoint) {
        this.backchannelAuthenticationEndpoint = backchannelAuthenticationEndpoint;
        return this;
    }
     ...
     * Backchannel Authentication)](https://openid.net/specs/openid-client-initiated-backchannel-authentication-core-1_0.html).
     */
    public ServiceUpdateApiResponseBody withSupportedBackchannelTokenDeliveryModes(@Nullable List<ServiceUpdateApiSupportedBackchannelTokenDeliveryModeResponse> supportedBackchannelTokenDeliveryModes) {
        this.supportedBackchannelTokenDeliveryModes = supportedBackchannelTokenDeliveryModes;
        return this;
    }
     ...
     * the backchannel authentication endpoint.
     */
    public ServiceUpdateApiResponseBody withBackchannelAuthReqIdDuration(@Nullable Integer backchannelAuthReqIdDuration) {
        this.backchannelAuthReqIdDuration = backchannelAuthReqIdDuration;
        return this;
    }
     ...
     * authentication endpoint.
     */
    public ServiceUpdateApiResponseBody withBackchannelPollingInterval(@Nullable Integer backchannelPollingInterval) {
        this.backchannelPollingInterval = backchannelPollingInterval;
        return this;
    }
     ...
     * metadata.
     */
    public ServiceUpdateApiResponseBody withBackchannelUserCodeParameterSupported(@Nullable Boolean backchannelUserCodeParameterSupported) {
        this.backchannelUserCodeParameterSupported = backchannelUserCodeParameterSupported;
        return this;
    }
     ...
     * that ensures each backchannel authentication request has unique context.
     */
    public ServiceUpdateApiResponseBody withBackchannelBindingMessageRequiredInFapi(@Nullable Boolean backchannelBindingMessageRequiredInFapi) {
        this.backchannelBindingMessageRequiredInFapi = backchannelBindingMessageRequiredInFapi;
        return this;
    }
     ...
     * <p>Device authorization endpoint is defined in the specification of OAuth 2.0 Device Authorization Grant.
     */
    public ServiceUpdateApiResponseBody withDeviceAuthorizationEndpoint(@Nullable String deviceAuthorizationEndpoint) {
        this.deviceAuthorizationEndpoint = deviceAuthorizationEndpoint;
        return this;
    }
     ...
     * parameter in responses from the device authorization endpoint.
     */
    public ServiceUpdateApiResponseBody withDeviceVerificationUri(@Nullable String deviceVerificationUri) {
        this.deviceVerificationUri = deviceVerificationUri;
        return this;
    }
     ...
     * responses.
     */
    public ServiceUpdateApiResponseBody withDeviceVerificationUriComplete(@Nullable String deviceVerificationUriComplete) {
        this.deviceVerificationUriComplete = deviceVerificationUriComplete;
        return this;
    }
     ...
     * from the device authorization endpoint.
     */
    public ServiceUpdateApiResponseBody withDeviceFlowCodeDuration(@Nullable Integer deviceFlowCodeDuration) {
        this.deviceFlowCodeDuration = deviceFlowCodeDuration;
        return this;
    }
     ...
     * the device authorization endpoint.
     */
    public ServiceUpdateApiResponseBody withDeviceFlowPollingInterval(@Nullable Integer deviceFlowPollingInterval) {
        this.deviceFlowPollingInterval = deviceFlowPollingInterval;
        return this;
    }
     ...
     * The character set for end-user verification codes (`user_code`) for Device Flow.
     */
    public ServiceUpdateApiResponseBody withUserCodeCharset(@Nullable ServiceUpdateApiUserCodeCharsetResponse userCodeCharset) {
        this.userCodeCharset = userCodeCharset;
        return this;
    }
     ...
     * The length of end-user verification codes (`user_code`) for Device Flow.
     */
    public ServiceUpdateApiResponseBody withUserCodeLength(@Nullable Integer userCodeLength) {
        this.userCodeLength = userCodeLength;
        return this;
    }
     ...
     * [metadata](https://openid.net/specs/openid-connect-4-identity-assurance-1_0.html#rfc.section.7).
     */
    public ServiceUpdateApiResponseBody withSupportedTrustFrameworks(@Nullable List<String> supportedTrustFrameworks) {
        this.supportedTrustFrameworks = supportedTrustFrameworks;
        return this;
    }
     ...
     * Evidence supported by this service. This corresponds to the `evidence_supported` [metadata](https://openid.net/specs/openid-connect-4-identity-assurance-1_0.html#rfc.section.7).
     */
    public ServiceUpdateApiResponseBody withSupportedEvidence(@Nullable List<String> supportedEvidence) {
        this.supportedEvidence = supportedEvidence;
        return this;
    }
     ...
     * [metadata](https://openid.net/specs/openid-connect-4-identity-assurance-1_0.html#rfc.section.7).
     */
    public ServiceUpdateApiResponseBody withSupportedIdentityDocuments(@Nullable List<String> supportedIdentityDocuments) {
        this.supportedIdentityDocuments = supportedIdentityDocuments;
        return this;
    }
     ...
     * [metadata](https://openid.net/specs/openid-connect-4-identity-assurance-1_0.html#rfc.section.7).
     */
    public ServiceUpdateApiResponseBody withSupportedVerificationMethods(@Nullable List<String> supportedVerificationMethods) {
        this.supportedVerificationMethods = supportedVerificationMethods;
        return this;
    }
     ...
     * [metadata](https://openid.net/specs/openid-connect-4-identity-assurance-1_0.html#rfc.section.7).
     */
    public ServiceUpdateApiResponseBody withSupportedVerifiedClaims(@Nullable List<String> supportedVerifiedClaims) {
        this.supportedVerifiedClaims = supportedVerifiedClaims;
        return this;
    }
     ...
     * OIDC4IDA / verifiedClaimsValidationSchemaSet
     */
    public ServiceUpdateApiResponseBody withVerifiedClaimsValidationSchemaSet(@Nullable ServiceUpdateApiVerifiedClaimsValidationSchemaSetResponse verifiedClaimsValidationSchemaSet) {
        this.verifiedClaimsValidationSchemaSet = verifiedClaimsValidationSchemaSet;
        return this;
    }
     ...
     * The attributes of this service.
     */
    public ServiceUpdateApiResponseBody withAttributes(@Nullable List<ServiceUpdateApiAttributeResponse> attributes) {
        this.attributes = attributes;
        return this;
    }
     ...
     * from ID2 to Final smooth without breaking live systems.
     */
    public ServiceUpdateApiResponseBody withNbfOptional(@Nullable Boolean nbfOptional) {
        this.nbfOptional = nbfOptional;
        return this;
    }
     ...
     * reasons for it.
     */
    public ServiceUpdateApiResponseBody withIssSuppressed(@Nullable Boolean issSuppressed) {
        this.issSuppressed = issSuppressed;
        return this;
    }
     ...
     * metadata values can be referenced by `customMetadata`.
     */
    public ServiceUpdateApiResponseBody withSupportedCustomClientMetadata(@Nullable List<String> supportedCustomClientMetadata) {
        this.supportedCustomClientMetadata = supportedCustomClientMetadata;
        return this;
    }
     ...
     * will have the same expiration date.
     */
    public ServiceUpdateApiResponseBody withTokenExpirationLinked(@Nullable Boolean tokenExpirationLinked) {
        this.tokenExpirationLinked = tokenExpirationLinked;
        return this;
    }
     ...
     * flag of the client is `true`.
     */
    public ServiceUpdateApiResponseBody withFrontChannelRequestObjectEncryptionRequired(@Nullable Boolean frontChannelRequestObjectEncryptionRequired) {
        this.frontChannelRequestObjectEncryptionRequired = frontChannelRequestObjectEncryptionRequired;
        return this;
    }
     ...
     * flag of the client is `true`.
     */
    public ServiceUpdateApiResponseBody withRequestObjectEncryptionAlgMatchRequired(@Nullable Boolean requestObjectEncryptionAlgMatchRequired) {
        this.requestObjectEncryptionAlgMatchRequired = requestObjectEncryptionAlgMatchRequired;
        return this;
    }
     ...
     * flag is `true`.
     */
    public ServiceUpdateApiResponseBody withRequestObjectEncryptionEncMatchRequired(@Nullable Boolean requestObjectEncryptionEncMatchRequired) {
        this.requestObjectEncryptionEncMatchRequired = requestObjectEncryptionEncMatchRequired;
        return this;
    }
     ...
     * server you are using does not support HSM.
     */
    public ServiceUpdateApiResponseBody withHsmEnabled(@Nullable Boolean hsmEnabled) {
        this.hsmEnabled = hsmEnabled;
        return this;
    }
     ...
     * only by `/api/hsk/*` APIs.
     */
    public ServiceUpdateApiResponseBody withHsks(@Nullable List<ServiceUpdateApiHskResponse> hsks) {
        this.hsks = hsks;
        return this;
    }
     ...
     * The URL of the grant management endpoint.
     */
    public ServiceUpdateApiResponseBody withGrantManagementEndpoint(@Nullable String grantManagementEndpoint) {
        this.grantManagementEndpoint = grantManagementEndpoint;
        return this;
    }
     ...
     * security reasons.
     */
    public ServiceUpdateApiResponseBody withGrantManagementActionRequired(@Nullable Boolean grantManagementActionRequired) {
        this.grantManagementActionRequired = grantManagementActionRequired;
        return this;
    }
     ...
     * 3. Turn on this `unauthorizedOnClientConfigSupported` flag.
     */
    public ServiceUpdateApiResponseBody withUnauthorizedOnClientConfigSupported(@Nullable Boolean unauthorizedOnClientConfigSupported) {
        this.unauthorizedOnClientConfigSupported = unauthorizedOnClientConfigSupported;
        return this;
    }
     ...
     * <p>This property affects behaviors of `/api/client/registration` and other family APIs.
     */
    public ServiceUpdateApiResponseBody withDcrScopeUsedAsRequestable(@Nullable Boolean dcrScopeUsedAsRequestable) {
        this.dcrScopeUsedAsRequestable = dcrScopeUsedAsRequestable;
        return this;
    }
     ...
     * Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public ServiceUpdateApiResponseBody withEndSessionEndpoint(@Nullable String endSessionEndpoint) {
        this.endSessionEndpoint = endSessionEndpoint;
        return this;
    }
     ...
     * component to be variable in other cases (e.g. in the case of the `"https"` scheme), too.
     */
    public ServiceUpdateApiResponseBody withLoopbackRedirectionUriVariable(@Nullable Boolean loopbackRedirectionUriVariable) {
        this.loopbackRedirectionUriVariable = loopbackRedirectionUriVariable;
        return this;
    }
     ...
     * identifier of this service and raises an error if they are different.
     */
    public ServiceUpdateApiResponseBody withRequestObjectAudienceChecked(@Nullable Boolean requestObjectAudienceChecked) {
        this.requestObjectAudienceChecked = requestObjectAudienceChecked;
        return this;
    }
     ...
     * responses.
     */
    public ServiceUpdateApiResponseBody withAccessTokenForExternalAttachmentEmbedded(@Nullable Boolean accessTokenForExternalAttachmentEmbedded) {
        this.accessTokenForExternalAttachmentEmbedded = accessTokenForExternalAttachmentEmbedded;
        return this;
    }
     ...
     * defined in OpenID Connect Federation 1.0.
     */
    public ServiceUpdateApiResponseBody withAuthorityHints(@Nullable List<String> authorityHints) {
        this.authorityHints = authorityHints;
        return this;
    }
     ...
     * flag indicating whether this service supports OpenID Connect Federation 1
     */
    public ServiceUpdateApiResponseBody withFederationEnabled(@Nullable Boolean federationEnabled) {
        this.federationEnabled = federationEnabled;
        return this;
    }
     ...
     * `signed_jwks_uri`.
     */
    public ServiceUpdateApiResponseBody withFederationJwks(@Nullable String federationJwks) {
        this.federationJwks = federationJwks;
        return this;
    }
     ...
     * the signed JWK Set.
     */
    public ServiceUpdateApiResponseBody withFederationSignatureKeyId(@Nullable String federationSignatureKeyId) {
        this.federationSignatureKeyId = federationSignatureKeyId;
        return this;
    }
     ...
     * The duration of the entity configuration in seconds.
     */
    public ServiceUpdateApiResponseBody withFederationConfigurationDuration(@Nullable Long federationConfigurationDuration) {
        this.federationConfigurationDuration = federationConfigurationDuration;
        return this;
    }
     ...
     * defined in OpenID Connect Federation 1.0.
     */
    public ServiceUpdateApiResponseBody withFederationRegistrationEndpoint(@Nullable String federationRegistrationEndpoint) {
        this.federationRegistrationEndpoint = federationRegistrationEndpoint;
        return this;
    }
     ...
     * server metadata that is defined in OpenID Connect Federation 1.0.
     */
    public ServiceUpdateApiResponseBody withOrganizationName(@Nullable String organizationName) {
        this.organizationName = organizationName;
        return this;
    }
     ...
     * server metadata.
     */
    public ServiceUpdateApiResponseBody withPredefinedTransformedClaims(@Nullable String predefinedTransformedClaims) {
        this.predefinedTransformedClaims = predefinedTransformedClaims;
        return this;
    }
     ...
     * period.
     */
    public ServiceUpdateApiResponseBody withRefreshTokenIdempotent(@Nullable Boolean refreshTokenIdempotent) {
        this.refreshTokenIdempotent = refreshTokenIdempotent;
        return this;
    }
     ...
     * server metadata defined in OpenID Connect Federation 1.0.
     */
    public ServiceUpdateApiResponseBody withSignedJwksUri(@Nullable String signedJwksUri) {
        this.signedJwksUri = signedJwksUri;
        return this;
    }
     ...
     * implementer's draft of OpenID Connect for Identity Assurance 1.0.
     */
    public ServiceUpdateApiResponseBody withSupportedAttachments(@Nullable List<ServiceUpdateApiSupportedAttachmentResponse> supportedAttachments) {
        this.supportedAttachments = supportedAttachments;
        return this;
    }
     ...
     * Assurance 1.0.
     */
    public ServiceUpdateApiResponseBody withSupportedDigestAlgorithms(@Nullable List<String> supportedDigestAlgorithms) {
        this.supportedDigestAlgorithms = supportedDigestAlgorithms;
        return this;
    }
     ...
     * to the `documents_supported` server metadata.
     */
    public ServiceUpdateApiResponseBody withSupportedDocuments(@Nullable List<String> supportedDocuments) {
        this.supportedDocuments = supportedDocuments;
        return this;
    }
     ...
     * `documents_methods_supported`.
     */
    public ServiceUpdateApiResponseBody withSupportedDocumentsMethods(@Nullable List<String> supportedDocumentsMethods) {
        this.supportedDocumentsMethods = supportedDocumentsMethods;
        return this;
    }
     ...
     * [OpenID Connect for Identity Assurance 1.0](https://openid.net/specs/openid-connect-4-identity-assurance-1_0.html)
     */
    public ServiceUpdateApiResponseBody withSupportedDocumentsValidationMethods(@Nullable List<String> supportedDocumentsValidationMethods) {
        this.supportedDocumentsValidationMethods = supportedDocumentsValidationMethods;
        return this;
    }
     ...
     * [OpenID Connect for Identity Assurance 1.0](https://openid.net/specs/openid-connect-4-identity-assurance-1_0.html)
     */
    public ServiceUpdateApiResponseBody withSupportedDocumentsVerificationMethods(@Nullable List<String> supportedDocumentsVerificationMethods) {
        this.supportedDocumentsVerificationMethods = supportedDocumentsVerificationMethods;
        return this;
    }
     ...
     * [OpenID Connect for Identity Assurance 1.0](https://openid.net/specs/openid-connect-4-identity-assurance-1_0.html)
     */
    public ServiceUpdateApiResponseBody withSupportedElectronicRecords(@Nullable List<String> supportedElectronicRecords) {
        this.supportedElectronicRecords = supportedElectronicRecords;
        return this;
    }


    public ServiceUpdateApiResponseBody withSupportedClientRegistrationTypes(@Nullable List<ServiceUpdateApiSupportedClientRegistrationTypeResponse> supportedClientRegistrationTypes) {
        this.supportedClientRegistrationTypes = supportedClientRegistrationTypes;
        return this;
    }
     ...
     * making token exchange requests.
     */
    public ServiceUpdateApiResponseBody withTokenExchangeByIdentifiableClientsOnly(@Nullable Boolean tokenExchangeByIdentifiableClientsOnly) {
        this.tokenExchangeByIdentifiableClientsOnly = tokenExchangeByIdentifiableClientsOnly;
        return this;
    }
     ...
     * token exchange requests.
     */
    public ServiceUpdateApiResponseBody withTokenExchangeByConfidentialClientsOnly(@Nullable Boolean tokenExchangeByConfidentialClientsOnly) {
        this.tokenExchangeByConfidentialClientsOnly = tokenExchangeByConfidentialClientsOnly;
        return this;
    }
     ...
     * permission from making token exchange requests.
     */
    public ServiceUpdateApiResponseBody withTokenExchangeByPermittedClientsOnly(@Nullable Boolean tokenExchangeByPermittedClientsOnly) {
        this.tokenExchangeByPermittedClientsOnly = tokenExchangeByPermittedClientsOnly;
        return this;
    }
     ...
     * use encrypted JWTs as input tokens.
     */
    public ServiceUpdateApiResponseBody withTokenExchangeEncryptedJwtRejected(@Nullable Boolean tokenExchangeEncryptedJwtRejected) {
        this.tokenExchangeEncryptedJwtRejected = tokenExchangeEncryptedJwtRejected;
        return this;
    }
     ...
     * use unsigned JWTs as input tokens.
     */
    public ServiceUpdateApiResponseBody withTokenExchangeUnsignedJwtRejected(@Nullable Boolean tokenExchangeUnsignedJwtRejected) {
        this.tokenExchangeUnsignedJwtRejected = tokenExchangeUnsignedJwtRejected;
        return this;
    }
     ...
     * using the grant type "urn:ietf:params:oauth:grant-type:jwt-bearer".
     */
    public ServiceUpdateApiResponseBody withJwtGrantByIdentifiableClientsOnly(@Nullable Boolean jwtGrantByIdentifiableClientsOnly) {
        this.jwtGrantByIdentifiableClientsOnly = jwtGrantByIdentifiableClientsOnly;
        return this;
    }
     ...
     * "urn:ietf:params:oauth:grant-type:jwt-bearer".
     */
    public ServiceUpdateApiResponseBody withJwtGrantEncryptedJwtRejected(@Nullable Boolean jwtGrantEncryptedJwtRejected) {
        this.jwtGrantEncryptedJwtRejected = jwtGrantEncryptedJwtRejected;
        return this;
    }
     ...
     * "urn:ietf:params:oauth:grant-type:jwt-bearer".
     */
    public ServiceUpdateApiResponseBody withJwtGrantUnsignedJwtRejected(@Nullable Boolean jwtGrantUnsignedJwtRejected) {
        this.jwtGrantUnsignedJwtRejected = jwtGrantUnsignedJwtRejected;
        return this;
    }
     ...
     * requests whose "software_id" has already been used previously.
     */
    public ServiceUpdateApiResponseBody withDcrDuplicateSoftwareIdBlocked(@Nullable Boolean dcrDuplicateSoftwareIdBlocked) {
        this.dcrDuplicateSoftwareIdBlocked = dcrDuplicateSoftwareIdBlocked;
        return this;
    }
     ...
     * that OpenID Connect Federation 1.0 does not work.
     */
    public ServiceUpdateApiResponseBody withTrustAnchors(@Nullable List<ServiceUpdateApiTrustAnchorResponse> trustAnchors) {
        this.trustAnchors = trustAnchors;
        return this;
    }
     ...
     * is used.
     */
    public ServiceUpdateApiResponseBody withOpenidDroppedOnRefreshWithoutOfflineAccess(@Nullable Boolean openidDroppedOnRefreshWithoutOfflineAccess) {
        this.openidDroppedOnRefreshWithoutOfflineAccess = openidDroppedOnRefreshWithoutOfflineAccess;
        return this;
    }
     ...
     * Assurance 1.0.
     */
    public ServiceUpdateApiResponseBody withSupportedDocumentsCheckMethods(@Nullable List<String> supportedDocumentsCheckMethods) {
        this.supportedDocumentsCheckMethods = supportedDocumentsCheckMethods;
        return this;
    }
     ...
     * The flag indicating whether this service signs responses from the resource server.
     */
    public ServiceUpdateApiResponseBody withRsResponseSigned(@Nullable Boolean rsResponseSigned) {
        this.rsResponseSigned = rsResponseSigned;
        return this;
    }
     ...
     * The duration of `c_nonce`.
     */
    public ServiceUpdateApiResponseBody withCnonceDuration(@Nullable Long cnonceDuration) {
        this.cnonceDuration = cnonceDuration;
        return this;
    }
     ...
     * whenever they are presented.
     */
    public ServiceUpdateApiResponseBody withDpopNonceRequired(@Nullable Boolean dpopNonceRequired) {
        this.dpopNonceRequired = dpopNonceRequired;
        return this;
    }
     ...
     * for this service is enabled or not.
     */
    public ServiceUpdateApiResponseBody withVerifiableCredentialsEnabled(@Nullable Boolean verifiableCredentialsEnabled) {
        this.verifiableCredentialsEnabled = verifiableCredentialsEnabled;
        return this;
    }
     ...
     * exposed.
     */
    public ServiceUpdateApiResponseBody withCredentialJwksUri(@Nullable String credentialJwksUri) {
        this.credentialJwksUri = credentialJwksUri;
        return this;
    }
     ...
     * The default duration of credential offers in seconds.
     */
    public ServiceUpdateApiResponseBody withCredentialOfferDuration(@Nullable Long credentialOfferDuration) {
        this.credentialOfferDuration = credentialOfferDuration;
        return this;
    }
     ...
     * The duration of nonce values for DPoP proof JWTs in seconds.
     */
    public ServiceUpdateApiResponseBody withDpopNonceDuration(@Nullable Long dpopNonceDuration) {
        this.dpopNonceDuration = dpopNonceDuration;
        return this;
    }
     ...
     * code grant flow by unidentifiable clients are allowed.
     */
    public ServiceUpdateApiResponseBody withPreAuthorizedGrantAnonymousAccessSupported(@Nullable Boolean preAuthorizedGrantAnonymousAccessSupported) {
        this.preAuthorizedGrantAnonymousAccessSupported = preAuthorizedGrantAnonymousAccessSupported;
        return this;
    }
     ...
     * result of a credential request or a batch credential request.
     */
    public ServiceUpdateApiResponseBody withCredentialTransactionDuration(@Nullable Long credentialTransactionDuration) {
        this.credentialTransactionDuration = credentialTransactionDuration;
        return this;
    }
     ...
     * The key ID of the key for signing introspection responses.
     */
    public ServiceUpdateApiResponseBody withIntrospectionSignatureKeyId(@Nullable String introspectionSignatureKeyId) {
        this.introspectionSignatureKeyId = introspectionSignatureKeyId;
        return this;
    }
     ...
     * The key ID of the key for signing introspection responses.
     */
    public ServiceUpdateApiResponseBody withResourceSignatureKeyId(@Nullable String resourceSignatureKeyId) {
        this.resourceSignatureKeyId = resourceSignatureKeyId;
        return this;
    }
     ...
     * The default length of user PINs.
     */
    public ServiceUpdateApiResponseBody withUserPinLength(@Nullable Integer userPinLength) {
        this.userPinLength = userPinLength;
        return this;
    }
     ...
     * The supported `prompt` values.
     */
    public ServiceUpdateApiResponseBody withSupportedPromptValues(@Nullable List<ServiceUpdateApiSupportedPromptValueResponse> supportedPromptValues) {
        this.supportedPromptValues = supportedPromptValues;
        return this;
    }
     ...
     * reissuance in the refresh token flow.
     */
    public ServiceUpdateApiResponseBody withIdTokenReissuable(@Nullable Boolean idTokenReissuable) {
        this.idTokenReissuable = idTokenReissuable;
        return this;
    }
     ...
     * verifiable credentials.
     */
    public ServiceUpdateApiResponseBody withCredentialJwks(@Nullable String credentialJwks) {
        this.credentialJwks = credentialJwks;
        return this;
    }
     ...
     * Advanced" if the FAPI feature is enabled in Authlete and the FAPI profile is supported by this service.
     */
    public ServiceUpdateApiResponseBody withFapiModes(@Nullable List<ServiceUpdateApiFapiModeResponse> fapiModes) {
        this.fapiModes = fapiModes;
        return this;
    }
     ...
     * The default duration of verifiable credentials in seconds.
     */
    public ServiceUpdateApiResponseBody withCredentialDuration(@Nullable Long credentialDuration) {
        this.credentialDuration = credentialDuration;
        return this;
    }


    public ServiceUpdateApiResponseBody withCredentialIssuerMetadata(@Nullable ServiceUpdateApiCredentialIssuerMetadataResponse credentialIssuerMetadata) {
        this.credentialIssuerMetadata = credentialIssuerMetadata;
        return this;
    }
     ...
     * The type of the `aud` claim in ID tokens.
     */
    public ServiceUpdateApiResponseBody withIdTokenAudType(@Nullable String idTokenAudType) {
        this.idTokenAudType = idTokenAudType;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ServiceUpdateApiResponseBody other = (ServiceUpdateApiResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ServiceUpdateApiResponseBody.class,
                "number", number,
    ...
    public final static class Builder {
         ...
         *   | `clientCount` | The number of client applications which belong to this service.  |
         */
        public Builder metadata(@Nullable List<ServiceUpdateApiMetadatumResponse> metadata) {
            this.metadata = metadata;
            return this;
        }
         ...
         * [OpenID Provider Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
         */
        public Builder supportedGrantTypes(@Nullable List<ServiceUpdateApiSupportedGrantTypeResponse> supportedGrantTypes) {
            this.supportedGrantTypes = supportedGrantTypes;
            return this;
        }
         ...
         * [OpenID Provider Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
         */
        public Builder supportedResponseTypes(@Nullable List<ServiceUpdateApiSupportedResponseTypeResponse> supportedResponseTypes) {
            this.supportedResponseTypes = supportedResponseTypes;
            return this;
        }
         ...
         * The profiles that this service supports.
         */
        public Builder supportedServiceProfiles(@Nullable List<ServiceUpdateApiSupportedServiceProfileResponse> supportedServiceProfiles) {
            this.supportedServiceProfiles = supportedServiceProfiles;
            return this;
        }
         ...
         * <p>The value of this property is used as `display_values_supported` property in the Provider Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
         */
        public Builder supportedDisplays(@Nullable List<ServiceUpdateApiSupportedDisplayResponse> supportedDisplays) {
            this.supportedDisplays = supportedDisplays;
            return this;
        }
         ...
         * [OpenID Provider Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
         */
        public Builder supportedTokenAuthMethods(@Nullable List<ServiceUpdateApiSupportedTokenAuthMethodResponse> supportedTokenAuthMethods) {
            this.supportedTokenAuthMethods = supportedTokenAuthMethods;
            return this;
        }
         ...
         * Client authentication methods supported at the revocation endpoint.
         */
        public Builder supportedRevocationAuthMethods(@Nullable List<ServiceUpdateApiSupportedRevocationAuthMethodResponse> supportedRevocationAuthMethods) {
            this.supportedRevocationAuthMethods = supportedRevocationAuthMethods;
            return this;
        }
         ...
         * Client authentication methods supported at the introspection endpoint.
         */
        public Builder supportedIntrospectionAuthMethods(@Nullable List<ServiceUpdateApiSupportedIntrospectionAuthMethodResponse> supportedIntrospectionAuthMethods) {
            this.supportedIntrospectionAuthMethods = supportedIntrospectionAuthMethods;
            return this;
        }
         ...
         * ```
         */
        public Builder mtlsEndpointAliases(@Nullable List<ServiceUpdateApiMtlsEndpointAliasResponse> mtlsEndpointAliases) {
            this.mtlsEndpointAliases = mtlsEndpointAliases;
            return this;
        }
         ...
         *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
         */
        public Builder accessTokenSignAlg(@Nullable ServiceUpdateApiAccessTokenSignAlgResponse accessTokenSignAlg) {
            this.accessTokenSignAlg = accessTokenSignAlg;
            return this;
        }
         ...
         * <p>The value of this property is used as `scopes_supported` property in the [OpenID Provider Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
         */
        public Builder supportedScopes(@Nullable List<ServiceUpdateApiSupportedScopeResponse> supportedScopes) {
            this.supportedScopes = supportedScopes;
            return this;
        }
         ...
         * Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
         */
        public Builder supportedClaimTypes(@Nullable List<ServiceUpdateApiSupportedClaimTypeResponse> supportedClaimTypes) {
            this.supportedClaimTypes = supportedClaimTypes;
            return this;
        }
         ...
         * Backchannel Authentication)](https://openid.net/specs/openid-client-initiated-backchannel-authentication-core-1_0.html).
         */
        public Builder supportedBackchannelTokenDeliveryModes(@Nullable List<ServiceUpdateApiSupportedBackchannelTokenDeliveryModeResponse> supportedBackchannelTokenDeliveryModes) {
            this.supportedBackchannelTokenDeliveryModes = supportedBackchannelTokenDeliveryModes;
            return this;
        }
         ...
         * The character set for end-user verification codes (`user_code`) for Device Flow.
         */
        public Builder userCodeCharset(@Nullable ServiceUpdateApiUserCodeCharsetResponse userCodeCharset) {
            this.userCodeCharset = userCodeCharset;
            return this;
        }
         ...
         * OIDC4IDA / verifiedClaimsValidationSchemaSet
         */
        public Builder verifiedClaimsValidationSchemaSet(@Nullable ServiceUpdateApiVerifiedClaimsValidationSchemaSetResponse verifiedClaimsValidationSchemaSet) {
            this.verifiedClaimsValidationSchemaSet = verifiedClaimsValidationSchemaSet;
            return this;
        }
         ...
         * The attributes of this service.
         */
        public Builder attributes(@Nullable List<ServiceUpdateApiAttributeResponse> attributes) {
            this.attributes = attributes;
            return this;
        }
         ...
         * only by `/api/hsk/*` APIs.
         */
        public Builder hsks(@Nullable List<ServiceUpdateApiHskResponse> hsks) {
            this.hsks = hsks;
            return this;
        }
         ...
         * implementer's draft of OpenID Connect for Identity Assurance 1.0.
         */
        public Builder supportedAttachments(@Nullable List<ServiceUpdateApiSupportedAttachmentResponse> supportedAttachments) {
            this.supportedAttachments = supportedAttachments;
            return this;
        }
        ...
        public Builder supportedClientRegistrationTypes(@Nullable List<ServiceUpdateApiSupportedClientRegistrationTypeResponse> supportedClientRegistrationTypes) {
            this.supportedClientRegistrationTypes = supportedClientRegistrationTypes;
            return this;
        }
         ...
         * that OpenID Connect Federation 1.0 does not work.
         */
        public Builder trustAnchors(@Nullable List<ServiceUpdateApiTrustAnchorResponse> trustAnchors) {
            this.trustAnchors = trustAnchors;
            return this;
        }
         ...
         * The supported `prompt` values.
         */
        public Builder supportedPromptValues(@Nullable List<ServiceUpdateApiSupportedPromptValueResponse> supportedPromptValues) {
            this.supportedPromptValues = supportedPromptValues;
            return this;
        }
         ...
         * Advanced" if the FAPI feature is enabled in Authlete and the FAPI profile is supported by this service.
         */
        public Builder fapiModes(@Nullable List<ServiceUpdateApiFapiModeResponse> fapiModes) {
            this.fapiModes = fapiModes;
            return this;
        }
        ...
        public Builder credentialIssuerMetadata(@Nullable ServiceUpdateApiCredentialIssuerMetadataResponse credentialIssuerMetadata) {
            this.credentialIssuerMetadata = credentialIssuerMetadata;
            return this;
        }
        ...
        public ServiceUpdateApiResponseBody build() {
            return new ServiceUpdateApiResponseBody(
                number, serviceName, issuer,
                description, apiKey, clientIdAliasEnabled,
                metadata, createdAt, modifiedAt,
                authenticationCallbackEndpoint, authenticationCallbackApiKey, authenticationCallbackApiSecret,
