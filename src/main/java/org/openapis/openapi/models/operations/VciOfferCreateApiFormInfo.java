...
public class VciOfferCreateApiFormInfo {
    /**
    ...
    private List<VciOfferCreateApiFormProperty> properties;
    ...
    @JsonCreator
    public VciOfferCreateApiFormInfo(
            ...
            @JsonProperty("properties") @Nullable List<VciOfferCreateApiFormProperty> properties,
     ...
     * Extra properties to associate with the credential offer.
     */
    public Optional<List<VciOfferCreateApiFormProperty>> properties() {
     ...
     * The identifier of the credential offer.
     */
    public VciOfferCreateApiFormInfo withIdentifier(@Nullable String identifier) {
        this.identifier = identifier;
        return this;
    }
     ...
     * The credential offer in the JSON format.
     */
    public VciOfferCreateApiFormInfo withCredentialOffer(@Nullable String credentialOffer) {
        this.credentialOffer = credentialOffer;
        return this;
    }
     ...
     * The identifier of the credential issuer.
     */
    public VciOfferCreateApiFormInfo withCredentialIssuer(@Nullable String credentialIssuer) {
        this.credentialIssuer = credentialIssuer;
        return this;
    }
     ...
     * The value of the `credentials` object in the JSON format.
     */
    public VciOfferCreateApiFormInfo withCredentials(@Nullable String credentials) {
        this.credentials = credentials;
        return this;
    }
     ...
     * included in the `grants` object.
     */
    public VciOfferCreateApiFormInfo withAuthorizationCodeGrantIncluded(@Nullable Boolean authorizationCodeGrantIncluded) {
        this.authorizationCodeGrantIncluded = authorizationCodeGrantIncluded;
        return this;
    }
     ...
     * object.
     */
    public VciOfferCreateApiFormInfo withIssuerStateIncluded(@Nullable Boolean issuerStateIncluded) {
        this.issuerStateIncluded = issuerStateIncluded;
        return this;
    }
     ...
     * `authorization_code` object in the `grants` object.
     */
    public VciOfferCreateApiFormInfo withIssuerState(@Nullable String issuerState) {
        this.issuerState = issuerState;
        return this;
    }
     ...
     * included in the `grants` object.
     */
    public VciOfferCreateApiFormInfo withPreAuthorizedCodeGrantIncluded(@Nullable Boolean preAuthorizedCodeGrantIncluded) {
        this.preAuthorizedCodeGrantIncluded = preAuthorizedCodeGrantIncluded;
        return this;
    }
     ...
     * the `grants` object.
     */
    public VciOfferCreateApiFormInfo withPreAuthorizedCode(@Nullable String preAuthorizedCode) {
        this.preAuthorizedCode = preAuthorizedCode;
        return this;
    }
     ...
     * the `grants` object.
     */
    public VciOfferCreateApiFormInfo withUserPinRequired(@Nullable Boolean userPinRequired) {
        this.userPinRequired = userPinRequired;
        return this;
    }
     ...
     * The value of the user PIN associated with the credential offer.
     */
    public VciOfferCreateApiFormInfo withUserPin(@Nullable String userPin) {
        this.userPin = userPin;
        return this;
    }
     ...
     * The subject associated with the credential offer.
     */
    public VciOfferCreateApiFormInfo withSubject(@Nullable String subject) {
        this.subject = subject;
        return this;
    }
     ...
     * The time at which the credential offer will expire.
     */
    public VciOfferCreateApiFormInfo withExpiresAt(@Nullable Long expiresAt) {
        this.expiresAt = expiresAt;
        return this;
    }
     ...
     * The general-purpose arbitrary string.
     */
    public VciOfferCreateApiFormInfo withContext(@Nullable String context) {
        this.context = context;
        return this;
    }
     ...
     * Extra properties to associate with the credential offer.
     */
    public VciOfferCreateApiFormInfo withProperties(@Nullable List<VciOfferCreateApiFormProperty> properties) {
        this.properties = properties;
        return this;
    }
     ...
     * access token.
     */
    public VciOfferCreateApiFormInfo withJwtAtClaims(@Nullable String jwtAtClaims) {
        this.jwtAtClaims = jwtAtClaims;
        return this;
    }
     ...
     * the course of issuing the credential offer.
     */
    public VciOfferCreateApiFormInfo withAuthTime(@Nullable Long authTime) {
        this.authTime = authTime;
        return this;
    }
     ...
     * performed during the course of issuing the credential offer.
     */
    public VciOfferCreateApiFormInfo withAcr(@Nullable String acr) {
        this.acr = acr;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        VciOfferCreateApiFormInfo other = (VciOfferCreateApiFormInfo) o;
        return 
    ...
    public String toString() {
        return Utils.toString(VciOfferCreateApiFormInfo.class,
    ...
    public final static class Builder {
         ...
         * Extra properties to associate with the credential offer.
         */
        public Builder properties(@Nullable List<VciOfferCreateApiFormProperty> properties) {
            this.properties = properties;
            return this;
        }
        ...
        public VciOfferCreateApiFormInfo build() {
            return new VciOfferCreateApiFormInfo(
                identifier, credentialOffer, credentialIssuer,
                credentials, authorizationCodeGrantIncluded, issuerStateIncluded,
                issuerState, preAuthorizedCodeGrantIncluded, preAuthorizedCode,
                userPinRequired, userPin, subject,
