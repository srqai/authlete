...
public class VciOfferInfoApiInfo {
    /**
    ...
    private List<VciOfferInfoApiProperty> properties;
    ...
    public VciOfferInfoApiInfo(
            ...
            @JsonProperty("properties") @Nullable List<VciOfferInfoApiProperty> properties,
     ...
     * Extra properties to associate with the credential offer.
     */
    public Optional<List<VciOfferInfoApiProperty>> properties() {
     ...
     * The identifier of the credential offer.
     */
    public VciOfferInfoApiInfo withIdentifier(@Nullable String identifier) {
        this.identifier = identifier;
        return this;
    }
     ...
     * The credential offer in the JSON format.
     */
    public VciOfferInfoApiInfo withCredentialOffer(@Nullable String credentialOffer) {
        this.credentialOffer = credentialOffer;
        return this;
    }
     ...
     * The identifier of the credential issuer.
     */
    public VciOfferInfoApiInfo withCredentialIssuer(@Nullable String credentialIssuer) {
        this.credentialIssuer = credentialIssuer;
        return this;
    }
     ...
     * The value of the `credentials` object in the JSON format.
     */
    public VciOfferInfoApiInfo withCredentials(@Nullable String credentials) {
        this.credentials = credentials;
        return this;
    }
     ...
     * included in the `grants` object.
     */
    public VciOfferInfoApiInfo withAuthorizationCodeGrantIncluded(@Nullable Boolean authorizationCodeGrantIncluded) {
        this.authorizationCodeGrantIncluded = authorizationCodeGrantIncluded;
        return this;
    }
     ...
     * object.
     */
    public VciOfferInfoApiInfo withIssuerStateIncluded(@Nullable Boolean issuerStateIncluded) {
        this.issuerStateIncluded = issuerStateIncluded;
        return this;
    }
     ...
     * `authorization_code` object in the `grants` object.
     */
    public VciOfferInfoApiInfo withIssuerState(@Nullable String issuerState) {
        this.issuerState = issuerState;
        return this;
    }
     ...
     * included in the `grants` object.
     */
    public VciOfferInfoApiInfo withPreAuthorizedCodeGrantIncluded(@Nullable Boolean preAuthorizedCodeGrantIncluded) {
        this.preAuthorizedCodeGrantIncluded = preAuthorizedCodeGrantIncluded;
        return this;
    }
     ...
     * the `grants` object.
     */
    public VciOfferInfoApiInfo withPreAuthorizedCode(@Nullable String preAuthorizedCode) {
        this.preAuthorizedCode = preAuthorizedCode;
        return this;
    }
     ...
     * the `grants` object.
     */
    public VciOfferInfoApiInfo withUserPinRequired(@Nullable Boolean userPinRequired) {
        this.userPinRequired = userPinRequired;
        return this;
    }
     ...
     * The value of the user PIN associated with the credential offer.
     */
    public VciOfferInfoApiInfo withUserPin(@Nullable String userPin) {
        this.userPin = userPin;
        return this;
    }
     ...
     * The subject associated with the credential offer.
     */
    public VciOfferInfoApiInfo withSubject(@Nullable String subject) {
        this.subject = subject;
        return this;
    }
     ...
     * The time at which the credential offer will expire.
     */
    public VciOfferInfoApiInfo withExpiresAt(@Nullable Long expiresAt) {
        this.expiresAt = expiresAt;
        return this;
    }
     ...
     * The general-purpose arbitrary string.
     */
    public VciOfferInfoApiInfo withContext(@Nullable String context) {
        this.context = context;
        return this;
    }
     ...
     * Extra properties to associate with the credential offer.
     */
    public VciOfferInfoApiInfo withProperties(@Nullable List<VciOfferInfoApiProperty> properties) {
        this.properties = properties;
        return this;
    }
     ...
     * access token.
     */
    public VciOfferInfoApiInfo withJwtAtClaims(@Nullable String jwtAtClaims) {
        this.jwtAtClaims = jwtAtClaims;
        return this;
    }
     ...
     * the course of issuing the credential offer.
     */
    public VciOfferInfoApiInfo withAuthTime(@Nullable Long authTime) {
        this.authTime = authTime;
        return this;
    }
     ...
     * performed during the course of issuing the credential offer.
     */
    public VciOfferInfoApiInfo withAcr(@Nullable String acr) {
        this.acr = acr;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        VciOfferInfoApiInfo other = (VciOfferInfoApiInfo) o;
        return 
    ...
    public String toString() {
        return Utils.toString(VciOfferInfoApiInfo.class,
    ...
    public final static class Builder {
         ...
         * Extra properties to associate with the credential offer.
         */
        public Builder properties(@Nullable List<VciOfferInfoApiProperty> properties) {
            this.properties = properties;
            return this;
        }
        ...
        public VciOfferInfoApiInfo build() {
            return new VciOfferInfoApiInfo(
                identifier, credentialOffer, credentialIssuer,
                credentials, authorizationCodeGrantIncluded, issuerStateIncluded,
                issuerState, preAuthorizedCodeGrantIncluded, preAuthorizedCode,
                userPinRequired, userPin, subject,
