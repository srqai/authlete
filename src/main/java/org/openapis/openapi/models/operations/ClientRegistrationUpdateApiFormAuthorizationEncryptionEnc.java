 ...
 */
public enum ClientRegistrationUpdateApiFormAuthorizationEncryptionEnc {
    ...
    ClientRegistrationUpdateApiFormAuthorizationEncryptionEnc(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationUpdateApiFormAuthorizationEncryptionEnc> fromValue(String value) {
        for (ClientRegistrationUpdateApiFormAuthorizationEncryptionEnc o: ClientRegistrationUpdateApiFormAuthorizationEncryptionEnc.values()) {
