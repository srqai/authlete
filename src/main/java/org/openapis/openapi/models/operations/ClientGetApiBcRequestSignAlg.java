 ...
 */
public enum ClientGetApiBcRequestSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientGetApiBcRequestSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientGetApiBcRequestSignAlg> fromValue(String value) {
        for (ClientGetApiBcRequestSignAlg o: ClientGetApiBcRequestSignAlg.values()) {
