 ...
 */
public enum ClientCreateApiAuthorizationEncryptionAlgRequest {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientCreateApiAuthorizationEncryptionAlgRequest(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientCreateApiAuthorizationEncryptionAlgRequest> fromValue(String value) {
        for (ClientCreateApiAuthorizationEncryptionAlgRequest o: ClientCreateApiAuthorizationEncryptionAlgRequest.values()) {
