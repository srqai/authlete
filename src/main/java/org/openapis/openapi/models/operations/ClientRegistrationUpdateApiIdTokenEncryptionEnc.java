 ...
 */
public enum ClientRegistrationUpdateApiIdTokenEncryptionEnc {
    ...
    ClientRegistrationUpdateApiIdTokenEncryptionEnc(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationUpdateApiIdTokenEncryptionEnc> fromValue(String value) {
        for (ClientRegistrationUpdateApiIdTokenEncryptionEnc o: ClientRegistrationUpdateApiIdTokenEncryptionEnc.values()) {
