 ...
 */
public enum ClientCreateApiRequestEncryptionEncResponse {
    ...
    ClientCreateApiRequestEncryptionEncResponse(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientCreateApiRequestEncryptionEncResponse> fromValue(String value) {
        for (ClientCreateApiRequestEncryptionEncResponse o: ClientCreateApiRequestEncryptionEncResponse.values()) {
