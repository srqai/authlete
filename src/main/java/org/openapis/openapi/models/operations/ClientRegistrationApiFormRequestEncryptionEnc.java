 ...
 */
public enum ClientRegistrationApiFormRequestEncryptionEnc {
    ...
    ClientRegistrationApiFormRequestEncryptionEnc(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationApiFormRequestEncryptionEnc> fromValue(String value) {
        for (ClientRegistrationApiFormRequestEncryptionEnc o: ClientRegistrationApiFormRequestEncryptionEnc.values()) {
