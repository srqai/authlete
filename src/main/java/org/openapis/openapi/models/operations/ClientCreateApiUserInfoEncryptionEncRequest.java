 ...
 */
public enum ClientCreateApiUserInfoEncryptionEncRequest {
    ...
    ClientCreateApiUserInfoEncryptionEncRequest(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientCreateApiUserInfoEncryptionEncRequest> fromValue(String value) {
        for (ClientCreateApiUserInfoEncryptionEncRequest o: ClientCreateApiUserInfoEncryptionEncRequest.values()) {
