 ...
 */
public enum ServiceCreateApiSupportedDisplayRequest {
    PAGE("PAGE"),
    POPUP("POPUP"),
    TOUCH("TOUCH"),
    WAP("WAP");
    ...
    ServiceCreateApiSupportedDisplayRequest(String value) {
        this.value = value;
    }
    ...
    public static Optional<ServiceCreateApiSupportedDisplayRequest> fromValue(String value) {
        for (ServiceCreateApiSupportedDisplayRequest o: ServiceCreateApiSupportedDisplayRequest.values()) {
