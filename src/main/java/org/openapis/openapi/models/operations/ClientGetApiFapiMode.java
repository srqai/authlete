...
public enum ClientGetApiFapiMode {
    ...
    ClientGetApiFapiMode(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientGetApiFapiMode> fromValue(String value) {
        for (ClientGetApiFapiMode o: ClientGetApiFapiMode.values()) {
