 ...
 */
public enum ClientCreateApiUserInfoSignAlgRequest {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientCreateApiUserInfoSignAlgRequest(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientCreateApiUserInfoSignAlgRequest> fromValue(String value) {
        for (ClientCreateApiUserInfoSignAlgRequest o: ClientCreateApiUserInfoSignAlgRequest.values()) {
