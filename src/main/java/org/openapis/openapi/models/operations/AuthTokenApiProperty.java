...
public class AuthTokenApiProperty {
    /**
     * The key part.
     */
     ...
     * The key part.
     */
    public AuthTokenApiProperty withKey(@Nullable String key) {
        this.key = key;
        return this;
    }
     ...
     * The value part.
     */
    public AuthTokenApiProperty withValue(@Nullable String value) {
        this.value = value;
        return this;
    }
     ...
     * If `true`, this property is hidden from client applications. Otherwise, this property is visible to client applications.
     */
    public AuthTokenApiProperty withHidden(@Nullable Boolean hidden) {
        this.hidden = hidden;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AuthTokenApiProperty other = (AuthTokenApiProperty) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AuthTokenApiProperty.class,
                "key", key,
                "value", value,
                "hidden", hidden);
    }
    ...
    public final static class Builder {
        ...
        public AuthTokenApiProperty build() {
            return new AuthTokenApiProperty(
                key, value, hidden);
        }
