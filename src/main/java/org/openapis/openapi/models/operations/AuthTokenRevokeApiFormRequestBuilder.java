...
public class AuthTokenRevokeApiFormRequestBuilder {
    ...
    public AuthTokenRevokeApiFormRequestBuilder(SDKConfiguration sdkConfiguration) {
        ...
        this.pojoBuilder = AuthTokenRevokeApiFormRequest.builder();
    }

    public AuthTokenRevokeApiFormRequestBuilder serviceId(@Nonnull String serviceId) {
    ...
    private AuthTokenRevokeApiFormRequest _buildRequest() {
