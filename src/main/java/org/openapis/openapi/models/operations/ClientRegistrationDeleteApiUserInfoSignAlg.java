 ...
 */
public enum ClientRegistrationDeleteApiUserInfoSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientRegistrationDeleteApiUserInfoSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationDeleteApiUserInfoSignAlg> fromValue(String value) {
        for (ClientRegistrationDeleteApiUserInfoSignAlg o: ClientRegistrationDeleteApiUserInfoSignAlg.values()) {
