 ...
 */
public enum ClientRegistrationUpdateApiFormRequestEncryptionAlg {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientRegistrationUpdateApiFormRequestEncryptionAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationUpdateApiFormRequestEncryptionAlg> fromValue(String value) {
        for (ClientRegistrationUpdateApiFormRequestEncryptionAlg o: ClientRegistrationUpdateApiFormRequestEncryptionAlg.values()) {
