...
public class VciDeferredParseApiFormResponseBody {
    /**
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("action")
    private VciDeferredParseApiFormAction action;
     ...
     * The next action that the deferred credential endpoint should take.
     */
    public Optional<VciDeferredParseApiFormAction> action() {
     ...
     * The code which represents the result of the API call.
     */
    public VciDeferredParseApiFormResponseBody withResultCode(@Nullable String resultCode) {
        this.resultCode = resultCode;
        return this;
    }
     ...
     * A short message which explains the result of the API call.
     */
    public VciDeferredParseApiFormResponseBody withResultMessage(@Nullable String resultMessage) {
        this.resultMessage = resultMessage;
        return this;
    }
     ...
     * The next action that the deferred credential endpoint should take.
     */
    public VciDeferredParseApiFormResponseBody withAction(@Nullable VciDeferredParseApiFormAction action) {
        this.action = action;
        return this;
    }
     ...
     * The content of the response to the request sender.
     */
    public VciDeferredParseApiFormResponseBody withResponseContent(@Nullable String responseContent) {
        this.responseContent = responseContent;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        VciDeferredParseApiFormResponseBody other = (VciDeferredParseApiFormResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(VciDeferredParseApiFormResponseBody.class,
    ...
    public final static class Builder {
         ...
         * The next action that the deferred credential endpoint should take.
         */
        public Builder action(@Nullable VciDeferredParseApiFormAction action) {
            this.action = action;
            return this;
        }
        ...
        public VciDeferredParseApiFormResponseBody build() {
            return new VciDeferredParseApiFormResponseBody(
                resultCode, resultMessage, action,
                responseContent, info);
        }
