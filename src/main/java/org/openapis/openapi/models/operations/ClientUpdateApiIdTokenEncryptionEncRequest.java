 ...
 */
public enum ClientUpdateApiIdTokenEncryptionEncRequest {
    ...
    ClientUpdateApiIdTokenEncryptionEncRequest(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientUpdateApiIdTokenEncryptionEncRequest> fromValue(String value) {
        for (ClientUpdateApiIdTokenEncryptionEncRequest o: ClientUpdateApiIdTokenEncryptionEncRequest.values()) {
