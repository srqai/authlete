 ...
 */
public enum ClientUpdateApiAuthorizationEncryptionAlgResponse {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientUpdateApiAuthorizationEncryptionAlgResponse(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientUpdateApiAuthorizationEncryptionAlgResponse> fromValue(String value) {
        for (ClientUpdateApiAuthorizationEncryptionAlgResponse o: ClientUpdateApiAuthorizationEncryptionAlgResponse.values()) {
