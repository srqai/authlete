...
public class AuthAuthorizationApiCredentialOfferInfo {
    /**
    ...
    private List<AuthAuthorizationApiProperty> properties;
    ...
    @JsonCreator
    public AuthAuthorizationApiCredentialOfferInfo(
            ...
            @JsonProperty("properties") @Nullable List<AuthAuthorizationApiProperty> properties,
     ...
     * Extra properties to associate with the credential offer.
     */
    public Optional<List<AuthAuthorizationApiProperty>> properties() {
     ...
     * The identifier of the credential offer.
     */
    public AuthAuthorizationApiCredentialOfferInfo withIdentifier(@Nullable String identifier) {
        this.identifier = identifier;
        return this;
    }
     ...
     * The credential offer in the JSON format.
     */
    public AuthAuthorizationApiCredentialOfferInfo withCredentialOffer(@Nullable String credentialOffer) {
        this.credentialOffer = credentialOffer;
        return this;
    }
     ...
     * The identifier of the credential issuer.
     */
    public AuthAuthorizationApiCredentialOfferInfo withCredentialIssuer(@Nullable String credentialIssuer) {
        this.credentialIssuer = credentialIssuer;
        return this;
    }
     ...
     * The value of the `credentials` object in the JSON format.
     */
    public AuthAuthorizationApiCredentialOfferInfo withCredentials(@Nullable String credentials) {
        this.credentials = credentials;
        return this;
    }
     ...
     * included in the `grants` object.
     */
    public AuthAuthorizationApiCredentialOfferInfo withAuthorizationCodeGrantIncluded(@Nullable Boolean authorizationCodeGrantIncluded) {
        this.authorizationCodeGrantIncluded = authorizationCodeGrantIncluded;
        return this;
    }
     ...
     * object.
     */
    public AuthAuthorizationApiCredentialOfferInfo withIssuerStateIncluded(@Nullable Boolean issuerStateIncluded) {
        this.issuerStateIncluded = issuerStateIncluded;
        return this;
    }
     ...
     * `authorization_code` object in the `grants` object.
     */
    public AuthAuthorizationApiCredentialOfferInfo withIssuerState(@Nullable String issuerState) {
        this.issuerState = issuerState;
        return this;
    }
     ...
     * included in the `grants` object.
     */
    public AuthAuthorizationApiCredentialOfferInfo withPreAuthorizedCodeGrantIncluded(@Nullable Boolean preAuthorizedCodeGrantIncluded) {
        this.preAuthorizedCodeGrantIncluded = preAuthorizedCodeGrantIncluded;
        return this;
    }
     ...
     * the `grants` object.
     */
    public AuthAuthorizationApiCredentialOfferInfo withPreAuthorizedCode(@Nullable String preAuthorizedCode) {
        this.preAuthorizedCode = preAuthorizedCode;
        return this;
    }
     ...
     * the `grants` object.
     */
    public AuthAuthorizationApiCredentialOfferInfo withUserPinRequired(@Nullable Boolean userPinRequired) {
        this.userPinRequired = userPinRequired;
        return this;
    }
     ...
     * The value of the user PIN associated with the credential offer.
     */
    public AuthAuthorizationApiCredentialOfferInfo withUserPin(@Nullable String userPin) {
        this.userPin = userPin;
        return this;
    }
     ...
     * The subject associated with the credential offer.
     */
    public AuthAuthorizationApiCredentialOfferInfo withSubject(@Nullable String subject) {
        this.subject = subject;
        return this;
    }
     ...
     * The time at which the credential offer will expire.
     */
    public AuthAuthorizationApiCredentialOfferInfo withExpiresAt(@Nullable Long expiresAt) {
        this.expiresAt = expiresAt;
        return this;
    }
     ...
     * The general-purpose arbitrary string.
     */
    public AuthAuthorizationApiCredentialOfferInfo withContext(@Nullable String context) {
        this.context = context;
        return this;
    }
     ...
     * Extra properties to associate with the credential offer.
     */
    public AuthAuthorizationApiCredentialOfferInfo withProperties(@Nullable List<AuthAuthorizationApiProperty> properties) {
        this.properties = properties;
        return this;
    }
     ...
     * access token.
     */
    public AuthAuthorizationApiCredentialOfferInfo withJwtAtClaims(@Nullable String jwtAtClaims) {
        this.jwtAtClaims = jwtAtClaims;
        return this;
    }
     ...
     * the course of issuing the credential offer.
     */
    public AuthAuthorizationApiCredentialOfferInfo withAuthTime(@Nullable Long authTime) {
        this.authTime = authTime;
        return this;
    }
     ...
     * performed during the course of issuing the credential offer.
     */
    public AuthAuthorizationApiCredentialOfferInfo withAcr(@Nullable String acr) {
        this.acr = acr;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AuthAuthorizationApiCredentialOfferInfo other = (AuthAuthorizationApiCredentialOfferInfo) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AuthAuthorizationApiCredentialOfferInfo.class,
    ...
    public final static class Builder {
         ...
         * Extra properties to associate with the credential offer.
         */
        public Builder properties(@Nullable List<AuthAuthorizationApiProperty> properties) {
            this.properties = properties;
            return this;
        }
        ...
        public AuthAuthorizationApiCredentialOfferInfo build() {
            return new AuthAuthorizationApiCredentialOfferInfo(
                identifier, credentialOffer, credentialIssuer,
                credentials, authorizationCodeGrantIncluded, issuerStateIncluded,
                issuerState, preAuthorizedCodeGrantIncluded, preAuthorizedCode,
                userPinRequired, userPin, subject,
