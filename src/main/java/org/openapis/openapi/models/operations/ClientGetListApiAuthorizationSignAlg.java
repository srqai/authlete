 ...
 */
public enum ClientGetListApiAuthorizationSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientGetListApiAuthorizationSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientGetListApiAuthorizationSignAlg> fromValue(String value) {
        for (ClientGetListApiAuthorizationSignAlg o: ClientGetListApiAuthorizationSignAlg.values()) {
