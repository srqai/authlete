 ...
 */
public enum ClientRegistrationApiFormRequestSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientRegistrationApiFormRequestSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationApiFormRequestSignAlg> fromValue(String value) {
        for (ClientRegistrationApiFormRequestSignAlg o: ClientRegistrationApiFormRequestSignAlg.values()) {
