 ...
 */
public enum ClientUpdateApiIdTokenEncryptionEncResponse {
    ...
    ClientUpdateApiIdTokenEncryptionEncResponse(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientUpdateApiIdTokenEncryptionEncResponse> fromValue(String value) {
        for (ClientUpdateApiIdTokenEncryptionEncResponse o: ClientUpdateApiIdTokenEncryptionEncResponse.values()) {
