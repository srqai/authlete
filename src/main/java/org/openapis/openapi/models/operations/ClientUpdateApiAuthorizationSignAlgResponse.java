 ...
 */
public enum ClientUpdateApiAuthorizationSignAlgResponse {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientUpdateApiAuthorizationSignAlgResponse(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientUpdateApiAuthorizationSignAlgResponse> fromValue(String value) {
        for (ClientUpdateApiAuthorizationSignAlgResponse o: ClientUpdateApiAuthorizationSignAlgResponse.values()) {
