 ...
 */
public enum FederationRegistrationApiRequestEncryptionAlg {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    FederationRegistrationApiRequestEncryptionAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<FederationRegistrationApiRequestEncryptionAlg> fromValue(String value) {
        for (FederationRegistrationApiRequestEncryptionAlg o: FederationRegistrationApiRequestEncryptionAlg.values()) {
