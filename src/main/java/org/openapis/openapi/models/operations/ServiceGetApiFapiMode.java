...
public enum ServiceGetApiFapiMode {
    ...
    ServiceGetApiFapiMode(String value) {
        this.value = value;
    }
    ...
    public static Optional<ServiceGetApiFapiMode> fromValue(String value) {
        for (ServiceGetApiFapiMode o: ServiceGetApiFapiMode.values()) {
