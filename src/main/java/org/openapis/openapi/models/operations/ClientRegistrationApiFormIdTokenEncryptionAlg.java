 ...
 */
public enum ClientRegistrationApiFormIdTokenEncryptionAlg {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientRegistrationApiFormIdTokenEncryptionAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationApiFormIdTokenEncryptionAlg> fromValue(String value) {
        for (ClientRegistrationApiFormIdTokenEncryptionAlg o: ClientRegistrationApiFormIdTokenEncryptionAlg.values()) {
