 ...
 */
public enum ServiceGetApiAccessTokenSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ServiceGetApiAccessTokenSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ServiceGetApiAccessTokenSignAlg> fromValue(String value) {
        for (ServiceGetApiAccessTokenSignAlg o: ServiceGetApiAccessTokenSignAlg.values()) {
