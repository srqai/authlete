 ...
 */
public enum ClientRegistrationUpdateApiFormUserInfoSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientRegistrationUpdateApiFormUserInfoSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationUpdateApiFormUserInfoSignAlg> fromValue(String value) {
        for (ClientRegistrationUpdateApiFormUserInfoSignAlg o: ClientRegistrationUpdateApiFormUserInfoSignAlg.values()) {
