 ...
 */
public enum ClientGetApiAuthorizationSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientGetApiAuthorizationSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientGetApiAuthorizationSignAlg> fromValue(String value) {
        for (ClientGetApiAuthorizationSignAlg o: ClientGetApiAuthorizationSignAlg.values()) {
