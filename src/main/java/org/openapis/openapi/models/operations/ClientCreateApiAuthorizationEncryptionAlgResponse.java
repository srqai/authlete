 ...
 */
public enum ClientCreateApiAuthorizationEncryptionAlgResponse {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientCreateApiAuthorizationEncryptionAlgResponse(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientCreateApiAuthorizationEncryptionAlgResponse> fromValue(String value) {
        for (ClientCreateApiAuthorizationEncryptionAlgResponse o: ClientCreateApiAuthorizationEncryptionAlgResponse.values()) {
