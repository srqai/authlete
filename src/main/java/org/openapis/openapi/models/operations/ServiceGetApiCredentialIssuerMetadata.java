...
public class ServiceGetApiCredentialIssuerMetadata {
    /**
    ...
    @JsonCreator
    public ServiceGetApiCredentialIssuerMetadata(
     ...
     * The identifier of a credential request.
     */
    public ServiceGetApiCredentialIssuerMetadata withCredentialIssuer(@Nullable String credentialIssuer) {
        this.credentialIssuer = credentialIssuer;
        return this;
    }
     ...
     * relies on for authorization.
     */
    public ServiceGetApiCredentialIssuerMetadata withAuthorizationServer(@Nullable String authorizationServer) {
        this.authorizationServer = authorizationServer;
        return this;
    }
     ...
     * The URL of the credential endpoint of the credential issuer.
     */
    public ServiceGetApiCredentialIssuerMetadata withCredentialEndpoint(@Nullable Boolean credentialEndpoint) {
        this.credentialEndpoint = credentialEndpoint;
        return this;
    }
     ...
     * The URL of the batch credential endpoint of the credential issuer.
     */
    public ServiceGetApiCredentialIssuerMetadata withBatchCredentialEndpoint(@Nullable Long batchCredentialEndpoint) {
        this.batchCredentialEndpoint = batchCredentialEndpoint;
        return this;
    }
     ...
     * The URL of the deferred credential endpoint of the credential issuer.
     */
    public ServiceGetApiCredentialIssuerMetadata withDeferredCredentialEndpoint(@Nullable String deferredCredentialEndpoint) {
        this.deferredCredentialEndpoint = deferredCredentialEndpoint;
        return this;
    }
     ...
     * A JSON array describing supported credentials.
     */
    public ServiceGetApiCredentialIssuerMetadata withCredentialsSupported(@Nullable Boolean credentialsSupported) {
        this.credentialsSupported = credentialsSupported;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ServiceGetApiCredentialIssuerMetadata other = (ServiceGetApiCredentialIssuerMetadata) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ServiceGetApiCredentialIssuerMetadata.class,
    ...
    public final static class Builder {
        ...
        public ServiceGetApiCredentialIssuerMetadata build() {
            return new ServiceGetApiCredentialIssuerMetadata(
                credentialIssuer, authorizationServer, credentialEndpoint,
                batchCredentialEndpoint, deferredCredentialEndpoint, credentialsSupported);
        }
