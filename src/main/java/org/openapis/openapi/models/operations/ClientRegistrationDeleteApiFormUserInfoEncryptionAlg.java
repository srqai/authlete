 ...
 */
public enum ClientRegistrationDeleteApiFormUserInfoEncryptionAlg {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientRegistrationDeleteApiFormUserInfoEncryptionAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationDeleteApiFormUserInfoEncryptionAlg> fromValue(String value) {
        for (ClientRegistrationDeleteApiFormUserInfoEncryptionAlg o: ClientRegistrationDeleteApiFormUserInfoEncryptionAlg.values()) {
