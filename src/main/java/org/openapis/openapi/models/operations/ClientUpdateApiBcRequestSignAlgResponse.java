 ...
 */
public enum ClientUpdateApiBcRequestSignAlgResponse {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientUpdateApiBcRequestSignAlgResponse(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientUpdateApiBcRequestSignAlgResponse> fromValue(String value) {
        for (ClientUpdateApiBcRequestSignAlgResponse o: ClientUpdateApiBcRequestSignAlgResponse.values()) {
