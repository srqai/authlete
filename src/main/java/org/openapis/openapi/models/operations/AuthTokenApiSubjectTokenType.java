 ...
 */
public enum AuthTokenApiSubjectTokenType {
    ...
    AuthTokenApiSubjectTokenType(String value) {
        this.value = value;
    }
    ...
    public static Optional<AuthTokenApiSubjectTokenType> fromValue(String value) {
        for (AuthTokenApiSubjectTokenType o: AuthTokenApiSubjectTokenType.values()) {
