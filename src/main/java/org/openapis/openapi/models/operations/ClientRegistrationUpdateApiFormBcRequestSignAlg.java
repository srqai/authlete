 ...
 */
public enum ClientRegistrationUpdateApiFormBcRequestSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientRegistrationUpdateApiFormBcRequestSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationUpdateApiFormBcRequestSignAlg> fromValue(String value) {
        for (ClientRegistrationUpdateApiFormBcRequestSignAlg o: ClientRegistrationUpdateApiFormBcRequestSignAlg.values()) {
