...
public class AuthAuthorizationIssueApiFormResponseBody {
    /**
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("action")
    private AuthAuthorizationIssueApiFormAction action;
    ...
    @JsonCreator
    public AuthAuthorizationIssueApiFormResponseBody(
            @JsonProperty("resultCode") @Nullable String resultCode,
            @JsonProperty("resultMessage") @Nullable String resultMessage,
            @JsonProperty("action") @Nullable AuthAuthorizationIssueApiFormAction action,
     ...
     * The next action that the authorization server implementation should take.
     */
    public Optional<AuthAuthorizationIssueApiFormAction> action() {
     ...
     * The code which represents the result of the API call.
     */
    public AuthAuthorizationIssueApiFormResponseBody withResultCode(@Nullable String resultCode) {
        this.resultCode = resultCode;
        return this;
    }
     ...
     * A short message which explains the result of the API call.
     */
    public AuthAuthorizationIssueApiFormResponseBody withResultMessage(@Nullable String resultMessage) {
        this.resultMessage = resultMessage;
        return this;
    }
     ...
     * The next action that the authorization server implementation should take.
     */
    public AuthAuthorizationIssueApiFormResponseBody withAction(@Nullable AuthAuthorizationIssueApiFormAction action) {
        this.action = action;
        return this;
    }
     ...
     * Its format varies depending on the value of `action` parameter.
     */
    public AuthAuthorizationIssueApiFormResponseBody withResponseContent(@Nullable String responseContent) {
        this.responseContent = responseContent;
        return this;
    }
     ...
     * when `response_type` contains token.
     */
    public AuthAuthorizationIssueApiFormResponseBody withAccessToken(@Nullable String accessToken) {
        this.accessToken = accessToken;
        return this;
    }
     ...
     * since the Unix epoch (1970-01-01).
     */
    public AuthAuthorizationIssueApiFormResponseBody withAccessTokenExpiresAt(@Nullable Long accessTokenExpiresAt) {
        this.accessTokenExpiresAt = accessTokenExpiresAt;
        return this;
    }
     ...
     * The duration of the newly issued access token in seconds.
     */
    public AuthAuthorizationIssueApiFormResponseBody withAccessTokenDuration(@Nullable Long accessTokenDuration) {
        this.accessTokenDuration = accessTokenDuration;
        return this;
    }
     ...
     * when `response_type` contains `id_token`.
     */
    public AuthAuthorizationIssueApiFormResponseBody withIdToken(@Nullable String idToken) {
        this.idToken = idToken;
        return this;
    }
     ...
     * when `response_type` contains code.
     */
    public AuthAuthorizationIssueApiFormResponseBody withAuthorizationCode(@Nullable String authorizationCode) {
        this.authorizationCode = authorizationCode;
        return this;
    }
     ...
     * this property is always set to `null`.
     */
    public AuthAuthorizationIssueApiFormResponseBody withJwtAccessToken(@Nullable String jwtAccessToken) {
        this.jwtAccessToken = jwtAccessToken;
        return this;
    }
     ...
     * The information about the ticket.
     */
    public AuthAuthorizationIssueApiFormResponseBody withTicketInfo(@Nullable String ticketInfo) {
        this.ticketInfo = ticketInfo;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AuthAuthorizationIssueApiFormResponseBody other = (AuthAuthorizationIssueApiFormResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AuthAuthorizationIssueApiFormResponseBody.class,
    ...
    public final static class Builder {
         ...
         * The next action that the authorization server implementation should take.
         */
        public Builder action(@Nullable AuthAuthorizationIssueApiFormAction action) {
            this.action = action;
            return this;
        }
        ...
        public AuthAuthorizationIssueApiFormResponseBody build() {
            return new AuthAuthorizationIssueApiFormResponseBody(
                resultCode, resultMessage, action,
                responseContent, accessToken, accessTokenExpiresAt,
                accessTokenDuration, idToken, authorizationCode,
                jwtAccessToken, ticketInfo);
