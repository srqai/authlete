 ...
 */
public enum FederationRegistrationApiFormRequestSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    FederationRegistrationApiFormRequestSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<FederationRegistrationApiFormRequestSignAlg> fromValue(String value) {
        for (FederationRegistrationApiFormRequestSignAlg o: FederationRegistrationApiFormRequestSignAlg.values()) {
