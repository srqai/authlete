...
public class AuthUserinfoApiProperty {
    /**
     * The key part.
     */
    ...
    @JsonCreator
    public AuthUserinfoApiProperty(
     ...
     * The key part.
     */
    public AuthUserinfoApiProperty withKey(@Nullable String key) {
        this.key = key;
        return this;
    }
     ...
     * The value part.
     */
    public AuthUserinfoApiProperty withValue(@Nullable String value) {
        this.value = value;
        return this;
    }
     ...
     * If `true`, this property is hidden from client applications. Otherwise, this property is visible to client applications.
     */
    public AuthUserinfoApiProperty withHidden(@Nullable Boolean hidden) {
        this.hidden = hidden;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AuthUserinfoApiProperty other = (AuthUserinfoApiProperty) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AuthUserinfoApiProperty.class,
                "key", key,
                "value", value,
                "hidden", hidden);
    }
    ...
    public final static class Builder {
        ...
        public AuthUserinfoApiProperty build() {
            return new AuthUserinfoApiProperty(
                key, value, hidden);
        }
