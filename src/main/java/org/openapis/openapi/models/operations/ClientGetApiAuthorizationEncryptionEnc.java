 ...
 */
public enum ClientGetApiAuthorizationEncryptionEnc {
    ...
    ClientGetApiAuthorizationEncryptionEnc(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientGetApiAuthorizationEncryptionEnc> fromValue(String value) {
        for (ClientGetApiAuthorizationEncryptionEnc o: ClientGetApiAuthorizationEncryptionEnc.values()) {
