...
public class FederationRegistrationApiFormExtension {
    /**
    ...
    @JsonCreator
    public FederationRegistrationApiFormExtension(
     ...
     * that the set is the set of scopes that the client application is allowed to request.
     */
    public FederationRegistrationApiFormExtension withRequestableScopes(@Nullable List<String> requestableScopes) {
        this.requestableScopes = requestableScopes;
        return this;
    }
     ...
     * application can request any scope which is supported by the authorization server.
     */
    public FederationRegistrationApiFormExtension withRequestableScopesEnabled(@Nullable Boolean requestableScopesEnabled) {
        this.requestableScopesEnabled = requestableScopesEnabled;
        return this;
    }
     ...
     * too. Authlete chooses the minimum value among the candidates.
     */
    public FederationRegistrationApiFormExtension withAccessTokenDuration(@Nullable Long accessTokenDuration) {
        this.accessTokenDuration = accessTokenDuration;
        return this;
    }
     ...
     * too. Authlete chooses the minimum value among the candidates.
     */
    public FederationRegistrationApiFormExtension withRefreshTokenDuration(@Nullable Long refreshTokenDuration) {
        this.refreshTokenDuration = refreshTokenDuration;
        return this;
    }
     ...
     * too. Authlete chooses the minimum value among the candidates.
     */
    public FederationRegistrationApiFormExtension withIdTokenDuration(@Nullable Long idTokenDuration) {
        this.idTokenDuration = idTokenDuration;
        return this;
    }
     ...
     * permission to make token exchange requests ([RFC 8693][https://www.rfc-editor.org/rfc/rfc8693.html])
     */
    public FederationRegistrationApiFormExtension withTokenExchangePermitted(@Nullable Boolean tokenExchangePermitted) {
        this.tokenExchangePermitted = tokenExchangePermitted;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        FederationRegistrationApiFormExtension other = (FederationRegistrationApiFormExtension) o;
        return 
    ...
    public String toString() {
        return Utils.toString(FederationRegistrationApiFormExtension.class,
    ...
    public final static class Builder {
        ...
        public FederationRegistrationApiFormExtension build() {
            return new FederationRegistrationApiFormExtension(
                requestableScopes, requestableScopesEnabled, accessTokenDuration,
                refreshTokenDuration, idTokenDuration, tokenExchangePermitted);
        }
