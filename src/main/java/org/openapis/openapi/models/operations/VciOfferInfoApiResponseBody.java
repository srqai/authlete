...
public class VciOfferInfoApiResponseBody {
    /**
     ...
     * The result of the `/vci/offer/info` API call.
     */
    public Optional<VciOfferInfoApiAction> action() {
     ...
     * The code which represents the result of the API call.
     */
    public VciOfferInfoApiResponseBody withResultCode(@Nullable String resultCode) {
        this.resultCode = resultCode;
        return this;
    }
     ...
     * A short message which explains the result of the API call.
     */
    public VciOfferInfoApiResponseBody withResultMessage(@Nullable String resultMessage) {
        this.resultMessage = resultMessage;
        return this;
    }
     ...
     * The result of the `/vci/offer/info` API call.
     */
    public VciOfferInfoApiResponseBody withAction(@Nullable VciOfferInfoApiAction action) {
        this.action = action;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        VciOfferInfoApiResponseBody other = (VciOfferInfoApiResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(VciOfferInfoApiResponseBody.class,
    ...
    public final static class Builder {
         ...
         * The result of the `/vci/offer/info` API call.
         */
        public Builder action(@Nullable VciOfferInfoApiAction action) {
            this.action = action;
            return this;
        }
        ...
        public VciOfferInfoApiResponseBody build() {
            return new VciOfferInfoApiResponseBody(
                resultCode, resultMessage, action,
                info);
        }
