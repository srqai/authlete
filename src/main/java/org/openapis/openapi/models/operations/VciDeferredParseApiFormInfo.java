 ...
 * 
 * <p>Information about the credential request bound to the transaction ID.
 */
public class VciDeferredParseApiFormInfo {
    /**
    ...
    @JsonCreator
    public VciDeferredParseApiFormInfo(
     ...
     * The identifier of the credential offer.
     */
    public VciDeferredParseApiFormInfo withIdentifier(@Nullable String identifier) {
        this.identifier = identifier;
        return this;
    }
     ...
     * The value of the format parameter in the credential request.
     */
    public VciDeferredParseApiFormInfo withFormat(@Nullable String format) {
        this.format = format;
        return this;
    }
     ...
     * The binding key specified by the proof in the credential request.
     */
    public VciDeferredParseApiFormInfo withBindingKey(@Nullable String bindingKey) {
        this.bindingKey = bindingKey;
        return this;
    }
     ...
     * The details about the credential request.
     */
    public VciDeferredParseApiFormInfo withDetails(@Nullable String details) {
        this.details = details;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        VciDeferredParseApiFormInfo other = (VciDeferredParseApiFormInfo) o;
        return 
    ...
    public String toString() {
        return Utils.toString(VciDeferredParseApiFormInfo.class,
    ...
    public final static class Builder {
        ...
        public VciDeferredParseApiFormInfo build() {
            return new VciDeferredParseApiFormInfo(
                identifier, format, bindingKey,
                details);
        }
