 ...
 */
public enum ClientRegistrationApiBcRequestSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientRegistrationApiBcRequestSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationApiBcRequestSignAlg> fromValue(String value) {
        for (ClientRegistrationApiBcRequestSignAlg o: ClientRegistrationApiBcRequestSignAlg.values()) {
