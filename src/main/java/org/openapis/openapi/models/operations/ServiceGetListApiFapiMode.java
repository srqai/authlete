...
public enum ServiceGetListApiFapiMode {
    ...
    ServiceGetListApiFapiMode(String value) {
        this.value = value;
    }
    ...
    public static Optional<ServiceGetListApiFapiMode> fromValue(String value) {
        for (ServiceGetListApiFapiMode o: ServiceGetListApiFapiMode.values()) {
