...
public enum AuthAuthorizationApiFapiMode {
    ...
    AuthAuthorizationApiFapiMode(String value) {
        this.value = value;
    }
    ...
    public static Optional<AuthAuthorizationApiFapiMode> fromValue(String value) {
        for (AuthAuthorizationApiFapiMode o: AuthAuthorizationApiFapiMode.values()) {
