 ...
 */
public enum ClientRegistrationApiFormTokenAuthSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientRegistrationApiFormTokenAuthSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationApiFormTokenAuthSignAlg> fromValue(String value) {
        for (ClientRegistrationApiFormTokenAuthSignAlg o: ClientRegistrationApiFormTokenAuthSignAlg.values()) {
