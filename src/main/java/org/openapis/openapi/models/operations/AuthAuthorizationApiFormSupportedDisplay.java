 ...
 */
public enum AuthAuthorizationApiFormSupportedDisplay {
    PAGE("PAGE"),
    POPUP("POPUP"),
    TOUCH("TOUCH"),
    WAP("WAP");
    ...
    AuthAuthorizationApiFormSupportedDisplay(String value) {
        this.value = value;
    }
    ...
    public static Optional<AuthAuthorizationApiFormSupportedDisplay> fromValue(String value) {
        for (AuthAuthorizationApiFormSupportedDisplay o: AuthAuthorizationApiFormSupportedDisplay.values()) {
