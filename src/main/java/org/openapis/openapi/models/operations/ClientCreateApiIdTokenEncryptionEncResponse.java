 ...
 */
public enum ClientCreateApiIdTokenEncryptionEncResponse {
    ...
    ClientCreateApiIdTokenEncryptionEncResponse(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientCreateApiIdTokenEncryptionEncResponse> fromValue(String value) {
        for (ClientCreateApiIdTokenEncryptionEncResponse o: ClientCreateApiIdTokenEncryptionEncResponse.values()) {
