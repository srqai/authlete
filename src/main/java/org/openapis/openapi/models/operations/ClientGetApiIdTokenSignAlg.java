 ...
 */
public enum ClientGetApiIdTokenSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientGetApiIdTokenSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientGetApiIdTokenSignAlg> fromValue(String value) {
        for (ClientGetApiIdTokenSignAlg o: ClientGetApiIdTokenSignAlg.values()) {
