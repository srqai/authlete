 ...
 */
public enum ClientUpdateApiIdTokenSignAlgResponse {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientUpdateApiIdTokenSignAlgResponse(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientUpdateApiIdTokenSignAlgResponse> fromValue(String value) {
        for (ClientUpdateApiIdTokenSignAlgResponse o: ClientUpdateApiIdTokenSignAlgResponse.values()) {
