...
public class ClientCreateApiResponseBody {
    /**
    ...
    private List<ClientCreateApiClientNameResponse> clientNames;
    ...
    private List<ClientCreateApiDescriptionResponse> descriptions;
    ...
    private ClientCreateApiClientTypeResponse clientType;
    ...
    private ClientCreateApiApplicationTypeResponse applicationType;
    ...
    private List<ClientCreateApiLogoUrisResponse> logoUris;
    ...
    private List<ClientCreateApiGrantTypeResponse> grantTypes;
    ...
    private List<ClientCreateApiResponseTypeResponse> responseTypes;
    ...
    private ClientCreateApiAuthorizationSignAlgResponse authorizationSignAlg;
    ...
    private ClientCreateApiAuthorizationEncryptionAlgResponse authorizationEncryptionAlg;
    ...
    private ClientCreateApiAuthorizationEncryptionEncResponse authorizationEncryptionEnc;
    ...
    private ClientCreateApiTokenAuthMethodResponse tokenAuthMethod;
    ...
    private ClientCreateApiTokenAuthSignAlgResponse tokenAuthSignAlg;
    ...
    private ClientCreateApiRequestSignAlgResponse requestSignAlg;
    ...
    private ClientCreateApiRequestEncryptionAlgResponse requestEncryptionAlg;
    ...
    private ClientCreateApiRequestEncryptionEncResponse requestEncryptionEnc;
    ...
    private ClientCreateApiIdTokenSignAlgResponse idTokenSignAlg;
    ...
    private ClientCreateApiIdTokenEncryptionAlgResponse idTokenEncryptionAlg;
    ...
    private ClientCreateApiIdTokenEncryptionEncResponse idTokenEncryptionEnc;
    ...
    private ClientCreateApiSubjectTypeResponse subjectType;
    ...
    private ClientCreateApiUserInfoSignAlgResponse userInfoSignAlg;
    ...
    private ClientCreateApiUserInfoEncryptionAlgResponse userInfoEncryptionAlg;
    ...
    private ClientCreateApiUserInfoEncryptionEncResponse userInfoEncryptionEnc;
    ...
    private List<ClientCreateApiTosUrisResponse> tosUris;
    ...
    private List<ClientCreateApiPolicyUrisResponse> policyUris;
    ...
    private List<ClientCreateApiClientUrisResponse> clientUris;
    ...
    private ClientCreateApiBcRequestSignAlgResponse bcRequestSignAlg;
    ...
    private List<ClientCreateApiAttributeResponse> attributes;


    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("extension")
    private ClientCreateApiExtensionResponse extension;
    ...
    private List<ClientCreateApiClientRegistrationTypeResponse> clientRegistrationTypes;
    ...
    private List<ClientCreateApiFapiModeResponse> fapiModes;
    ...
    private List<ClientCreateApiResponseModeResponse> responseModes;
    ...
    @JsonCreator
    public ClientCreateApiResponseBody(
            ...
            @JsonProperty("clientNames") @Nullable List<ClientCreateApiClientNameResponse> clientNames,
            @JsonProperty("description") @Nullable String description,
            @JsonProperty("descriptions") @Nullable List<ClientCreateApiDescriptionResponse> descriptions,
            ...
            @JsonProperty("clientType") @Nullable ClientCreateApiClientTypeResponse clientType,
            @JsonProperty("applicationType") @Nullable ClientCreateApiApplicationTypeResponse applicationType,
            @JsonProperty("logoUri") @Nullable String logoUri,
            @JsonProperty("logoUris") @Nullable List<ClientCreateApiLogoUrisResponse> logoUris,
            ...
            @JsonProperty("grantTypes") @Nullable List<ClientCreateApiGrantTypeResponse> grantTypes,
            @JsonProperty("responseTypes") @Nullable List<ClientCreateApiResponseTypeResponse> responseTypes,
            @JsonProperty("redirectUris") @Nullable List<String> redirectUris,
            @JsonProperty("authorizationSignAlg") @Nullable ClientCreateApiAuthorizationSignAlgResponse authorizationSignAlg,
            @JsonProperty("authorizationEncryptionAlg") @Nullable ClientCreateApiAuthorizationEncryptionAlgResponse authorizationEncryptionAlg,
            @JsonProperty("authorizationEncryptionEnc") @Nullable ClientCreateApiAuthorizationEncryptionEncResponse authorizationEncryptionEnc,
            @JsonProperty("tokenAuthMethod") @Nullable ClientCreateApiTokenAuthMethodResponse tokenAuthMethod,
            @JsonProperty("tokenAuthSignAlg") @Nullable ClientCreateApiTokenAuthSignAlgResponse tokenAuthSignAlg,
            ...
            @JsonProperty("requestSignAlg") @Nullable ClientCreateApiRequestSignAlgResponse requestSignAlg,
            @JsonProperty("requestEncryptionAlg") @Nullable ClientCreateApiRequestEncryptionAlgResponse requestEncryptionAlg,
            @JsonProperty("requestEncryptionEnc") @Nullable ClientCreateApiRequestEncryptionEncResponse requestEncryptionEnc,
            ...
            @JsonProperty("idTokenSignAlg") @Nullable ClientCreateApiIdTokenSignAlgResponse idTokenSignAlg,
            @JsonProperty("idTokenEncryptionAlg") @Nullable ClientCreateApiIdTokenEncryptionAlgResponse idTokenEncryptionAlg,
            @JsonProperty("idTokenEncryptionEnc") @Nullable ClientCreateApiIdTokenEncryptionEncResponse idTokenEncryptionEnc,
            @JsonProperty("authTimeRequired") @Nullable Boolean authTimeRequired,
            @JsonProperty("subjectType") @Nullable ClientCreateApiSubjectTypeResponse subjectType,
            ...
            @JsonProperty("userInfoSignAlg") @Nullable ClientCreateApiUserInfoSignAlgResponse userInfoSignAlg,
            @JsonProperty("userInfoEncryptionAlg") @Nullable ClientCreateApiUserInfoEncryptionAlgResponse userInfoEncryptionAlg,
            @JsonProperty("userInfoEncryptionEnc") @Nullable ClientCreateApiUserInfoEncryptionEncResponse userInfoEncryptionEnc,
            @JsonProperty("loginUri") @Nullable String loginUri,
            @JsonProperty("tosUri") @Nullable String tosUri,
            @JsonProperty("tosUris") @Nullable List<ClientCreateApiTosUrisResponse> tosUris,
            @JsonProperty("policyUri") @Nullable String policyUri,
            @JsonProperty("policyUris") @Nullable List<ClientCreateApiPolicyUrisResponse> policyUris,
            @JsonProperty("clientUri") @Nullable String clientUri,
            @JsonProperty("clientUris") @Nullable List<ClientCreateApiClientUrisResponse> clientUris,
            ...
            @JsonProperty("bcRequestSignAlg") @Nullable ClientCreateApiBcRequestSignAlgResponse bcRequestSignAlg,
            @JsonProperty("bcUserCodeRequired") @Nullable Boolean bcUserCodeRequired,
            @JsonProperty("attributes") @Nullable List<ClientCreateApiAttributeResponse> attributes,
            @JsonProperty("extension") @Nullable ClientCreateApiExtensionResponse extension,
            ...
            @JsonProperty("clientRegistrationTypes") @Nullable List<ClientCreateApiClientRegistrationTypeResponse> clientRegistrationTypes,
            ...
            @JsonProperty("fapiModes") @Nullable List<ClientCreateApiFapiModeResponse> fapiModes,
            @JsonProperty("responseModes") @Nullable List<ClientCreateApiResponseModeResponse> responseModes,
     ...
     * languages, this property can be used to register the names.
     */
    public Optional<List<ClientCreateApiClientNameResponse>> clientNames() {
     ...
     * descriptions for different languages, this property can be used to register the descriptions.
     */
    public Optional<List<ClientCreateApiDescriptionResponse>> descriptions() {
     ...
     * for details.
     */
    public Optional<ClientCreateApiClientTypeResponse> clientType() {
     ...
     * See the description about `redirectUris` property for more details.
     */
    public Optional<ClientCreateApiApplicationTypeResponse> applicationType() {
     ...
     * different languages, this property can be used to register URLs of the images.
     */
    public Optional<List<ClientCreateApiLogoUrisResponse>> logoUris() {
     ...
     * 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public Optional<List<ClientCreateApiGrantTypeResponse>> grantTypes() {
     ...
     * 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public Optional<List<ClientCreateApiResponseTypeResponse>> responseTypes() {
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public Optional<ClientCreateApiAuthorizationSignAlgResponse> authorizationSignAlg() {
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public Optional<ClientCreateApiAuthorizationEncryptionAlgResponse> authorizationEncryptionAlg() {
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public Optional<ClientCreateApiAuthorizationEncryptionEncResponse> authorizationEncryptionEnc() {
     ...
     * Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public Optional<ClientCreateApiTokenAuthMethodResponse> tokenAuthMethod() {
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public Optional<ClientCreateApiTokenAuthSignAlgResponse> tokenAuthSignAlg() {
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public Optional<ClientCreateApiRequestSignAlgResponse> requestSignAlg() {
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public Optional<ClientCreateApiRequestEncryptionAlgResponse> requestEncryptionAlg() {
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public Optional<ClientCreateApiRequestEncryptionEncResponse> requestEncryptionEnc() {
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public Optional<ClientCreateApiIdTokenSignAlgResponse> idTokenSignAlg() {
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public Optional<ClientCreateApiIdTokenEncryptionAlgResponse> idTokenEncryptionAlg() {
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public Optional<ClientCreateApiIdTokenEncryptionEncResponse> idTokenEncryptionEnc() {
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public Optional<ClientCreateApiSubjectTypeResponse> subjectType() {
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public Optional<ClientCreateApiUserInfoSignAlgResponse> userInfoSignAlg() {
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public Optional<ClientCreateApiUserInfoEncryptionAlgResponse> userInfoEncryptionAlg() {
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public Optional<ClientCreateApiUserInfoEncryptionEncResponse> userInfoEncryptionEnc() {
     ...
     * this property can be used to register the URLs.
     */
    public Optional<List<ClientCreateApiTosUrisResponse>> tosUris() {
     ...
     * If the client application has different policy pages for different languages, this property can be used to register the URLs.
     */
    public Optional<List<ClientCreateApiPolicyUrisResponse>> policyUris() {
     ...
     * be used to register the URLs.
     */
    public Optional<List<ClientCreateApiClientUrisResponse>> clientUris() {
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public Optional<ClientCreateApiBcRequestSignAlgResponse> bcRequestSignAlg() {
     ...
     * The attributes of this client.
     */
    public Optional<List<ClientCreateApiAttributeResponse>> attributes() {
        return Optional.ofNullable(this.attributes);
    }

    public Optional<ClientCreateApiExtensionResponse> extension() {
     ...
     * The client registration types that the client has declared it may use.
     */
    public Optional<List<ClientCreateApiClientRegistrationTypeResponse>> clientRegistrationTypes() {
     ...
     * the service, and the FAPI modes for the service are set to `null`.
     */
    public Optional<List<ClientCreateApiFapiModeResponse>> fapiModes() {
     ...
     * The response modes that this client may use.
     */
    public Optional<List<ClientCreateApiResponseModeResponse>> responseModes() {
     ...
     * The sequential number of the client. The value of this property is assigned by Authlete.
     */
    public ClientCreateApiResponseBody withNumber(@Nullable Integer number) {
        this.number = number;
        return this;
    }
     ...
     * assigned by Authlete.
     */
    public ClientCreateApiResponseBody withServiceNumber(@Nullable Integer serviceNumber) {
        this.serviceNumber = serviceNumber;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientCreateApiResponseBody withClientName(@Nullable String clientName) {
        this.clientName = clientName;
        return this;
    }
     ...
     * languages, this property can be used to register the names.
     */
    public ClientCreateApiResponseBody withClientNames(@Nullable List<ClientCreateApiClientNameResponse> clientNames) {
        this.clientNames = clientNames;
        return this;
    }
     ...
     * The description about the client application.
     */
    public ClientCreateApiResponseBody withDescription(@Nullable String description) {
        this.description = description;
        return this;
    }
     ...
     * descriptions for different languages, this property can be used to register the descriptions.
     */
    public ClientCreateApiResponseBody withDescriptions(@Nullable List<ClientCreateApiDescriptionResponse> descriptions) {
        this.descriptions = descriptions;
        return this;
    }
     ...
     * The client identifier used in Authlete API calls. The value of this property is assigned by Authlete.
     */
    public ClientCreateApiResponseBody withClientId(@Nullable Long clientId) {
        this.clientId = clientId;
        return this;
    }
     ...
     * authorization server as described in Section 2.3 when making requests to the token endpoint.
     */
    public ClientCreateApiResponseBody withClientSecret(@Nullable String clientSecret) {
        this.clientSecret = clientSecret;
        return this;
    }
     ...
     * default, this is a string version of the `clientId` property.
     */
    public ClientCreateApiResponseBody withClientIdAlias(@Nullable String clientIdAlias) {
        this.clientIdAlias = clientIdAlias;
        return this;
    }
     ...
     * Deprecated. Always set to `true`.
     */
    public ClientCreateApiResponseBody withClientIdAliasEnabled(@Nullable Boolean clientIdAliasEnabled) {
        this.clientIdAliasEnabled = clientIdAliasEnabled;
        return this;
    }
     ...
     * for details.
     */
    public ClientCreateApiResponseBody withClientType(@Nullable ClientCreateApiClientTypeResponse clientType) {
        this.clientType = clientType;
        return this;
    }
     ...
     * See the description about `redirectUris` property for more details.
     */
    public ClientCreateApiResponseBody withApplicationType(@Nullable ClientCreateApiApplicationTypeResponse applicationType) {
        this.applicationType = applicationType;
        return this;
    }
     ...
     * Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientCreateApiResponseBody withLogoUri(@Nullable String logoUri) {
        this.logoUri = logoUri;
        return this;
    }
     ...
     * different languages, this property can be used to register URLs of the images.
     */
    public ClientCreateApiResponseBody withLogoUris(@Nullable List<ClientCreateApiLogoUrisResponse> logoUris) {
        this.logoUris = logoUris;
        return this;
    }
     ...
     * Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientCreateApiResponseBody withContacts(@Nullable List<String> contacts) {
        this.contacts = contacts;
        return this;
    }
     ...
     * The flag to indicate whether this client use TLS client certificate bound access tokens.
     */
    public ClientCreateApiResponseBody withTlsClientCertificateBoundAccessTokens(@Nullable Boolean tlsClientCertificateBoundAccessTokens) {
        this.tlsClientCertificateBoundAccessTokens = tlsClientCertificateBoundAccessTokens;
        return this;
    }
     ...
     * For more details, see [RFC 7591](https://datatracker.ietf.org/doc/html/rfc7591).
     */
    public ClientCreateApiResponseBody withDynamicallyRegistered(@Nullable Boolean dynamicallyRegistered) {
        this.dynamicallyRegistered = dynamicallyRegistered;
        return this;
    }
     ...
     * of [RFC 7591](https://datatracker.ietf.org/doc/html/rfc7591).
     */
    public ClientCreateApiResponseBody withSoftwareId(@Nullable String softwareId) {
        this.softwareId = softwareId;
        return this;
    }
     ...
     * of [RFC 7591](https://datatracker.ietf.org/doc/html/rfc7591).
     */
    public ClientCreateApiResponseBody withSoftwareVersion(@Nullable String softwareVersion) {
        this.softwareVersion = softwareVersion;
        return this;
    }
     ...
     * The hash of the registration access token for this client.
     */
    public ClientCreateApiResponseBody withRegistrationAccessTokenHash(@Nullable String registrationAccessTokenHash) {
        this.registrationAccessTokenHash = registrationAccessTokenHash;
        return this;
    }
     ...
     * The time at which this client was created. The value is represented as milliseconds since the UNIX epoch (1970-01-01).
     */
    public ClientCreateApiResponseBody withCreatedAt(@Nullable Long createdAt) {
        this.createdAt = createdAt;
        return this;
    }
     ...
     * The time at which this client was last modified. The value is represented as milliseconds since the UNIX epoch (1970-01-01).
     */
    public ClientCreateApiResponseBody withModifiedAt(@Nullable Long modifiedAt) {
        this.modifiedAt = modifiedAt;
        return this;
    }
     ...
     * 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientCreateApiResponseBody withGrantTypes(@Nullable List<ClientCreateApiGrantTypeResponse> grantTypes) {
        this.grantTypes = grantTypes;
        return this;
    }
     ...
     * 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientCreateApiResponseBody withResponseTypes(@Nullable List<ClientCreateApiResponseTypeResponse> responseTypes) {
        this.responseTypes = responseTypes;
        return this;
    }
     ...
     * details), but OpenID Connect requires exact match.
     */
    public ClientCreateApiResponseBody withRedirectUris(@Nullable List<String> redirectUris) {
        this.redirectUris = redirectUris;
        return this;
    }
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public ClientCreateApiResponseBody withAuthorizationSignAlg(@Nullable ClientCreateApiAuthorizationSignAlgResponse authorizationSignAlg) {
        this.authorizationSignAlg = authorizationSignAlg;
        return this;
    }
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public ClientCreateApiResponseBody withAuthorizationEncryptionAlg(@Nullable ClientCreateApiAuthorizationEncryptionAlgResponse authorizationEncryptionAlg) {
        this.authorizationEncryptionAlg = authorizationEncryptionAlg;
        return this;
    }
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public ClientCreateApiResponseBody withAuthorizationEncryptionEnc(@Nullable ClientCreateApiAuthorizationEncryptionEncResponse authorizationEncryptionEnc) {
        this.authorizationEncryptionEnc = authorizationEncryptionEnc;
        return this;
    }
     ...
     * Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientCreateApiResponseBody withTokenAuthMethod(@Nullable ClientCreateApiTokenAuthMethodResponse tokenAuthMethod) {
        this.tokenAuthMethod = tokenAuthMethod;
        return this;
    }
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public ClientCreateApiResponseBody withTokenAuthSignAlg(@Nullable ClientCreateApiTokenAuthSignAlgResponse tokenAuthSignAlg) {
        this.tokenAuthSignAlg = tokenAuthSignAlg;
        return this;
    }
     ...
     * The key ID of a JWK containing a self-signed certificate of this client.
     */
    public ClientCreateApiResponseBody withSelfSignedCertificateKeyId(@Nullable String selfSignedCertificateKeyId) {
        this.selfSignedCertificateKeyId = selfSignedCertificateKeyId;
        return this;
    }
     ...
     * Registration" for details.
     */
    public ClientCreateApiResponseBody withTlsClientAuthSubjectDn(@Nullable String tlsClientAuthSubjectDn) {
        this.tlsClientAuthSubjectDn = tlsClientAuthSubjectDn;
        return this;
    }
     ...
     * Registration" for details.
     */
    public ClientCreateApiResponseBody withTlsClientAuthSanDns(@Nullable String tlsClientAuthSanDns) {
        this.tlsClientAuthSanDns = tlsClientAuthSanDns;
        return this;
    }
     ...
     * Registration" for details.
     */
    public ClientCreateApiResponseBody withTlsClientAuthSanUri(@Nullable String tlsClientAuthSanUri) {
        this.tlsClientAuthSanUri = tlsClientAuthSanUri;
        return this;
    }
     ...
     * Registration" for details.
     */
    public ClientCreateApiResponseBody withTlsClientAuthSanIp(@Nullable String tlsClientAuthSanIp) {
        this.tlsClientAuthSanIp = tlsClientAuthSanIp;
        return this;
    }
     ...
     * Registration" for details.
     */
    public ClientCreateApiResponseBody withTlsClientAuthSanEmail(@Nullable String tlsClientAuthSanEmail) {
        this.tlsClientAuthSanEmail = tlsClientAuthSanEmail;
        return this;
    }
     ...
     * in "OAuth 2.0 Pushed Authorization Requests".
     */
    public ClientCreateApiResponseBody withParRequired(@Nullable Boolean parRequired) {
        this.parRequired = parRequired;
        return this;
    }
     ...
     * client metadata of this client is `true`. The metadata is defined in "JAR (JWT Secured Authorization Request)".
     */
    public ClientCreateApiResponseBody withRequestObjectRequired(@Nullable Boolean requestObjectRequired) {
        this.requestObjectRequired = requestObjectRequired;
        return this;
    }
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public ClientCreateApiResponseBody withRequestSignAlg(@Nullable ClientCreateApiRequestSignAlgResponse requestSignAlg) {
        this.requestSignAlg = requestSignAlg;
        return this;
    }
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public ClientCreateApiResponseBody withRequestEncryptionAlg(@Nullable ClientCreateApiRequestEncryptionAlgResponse requestEncryptionAlg) {
        this.requestEncryptionAlg = requestEncryptionAlg;
        return this;
    }
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public ClientCreateApiResponseBody withRequestEncryptionEnc(@Nullable ClientCreateApiRequestEncryptionEncResponse requestEncryptionEnc) {
        this.requestEncryptionEnc = requestEncryptionEnc;
        return this;
    }
     ...
     * See [OpenID Connect Core 1.0, 6.2. Passing a Request Object by Reference](https://openid.net/specs/openid-connect-core-1_0.html#RequestUriParameter) for details.
     */
    public ClientCreateApiResponseBody withRequestUris(@Nullable List<String> requestUris) {
        this.requestUris = requestUris;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientCreateApiResponseBody withDefaultMaxAge(@Nullable Integer defaultMaxAge) {
        this.defaultMaxAge = defaultMaxAge;
        return this;
    }
     ...
     * in claims request parameter.
     */
    public ClientCreateApiResponseBody withDefaultAcrs(@Nullable List<String> defaultAcrs) {
        this.defaultAcrs = defaultAcrs;
        return this;
    }
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public ClientCreateApiResponseBody withIdTokenSignAlg(@Nullable ClientCreateApiIdTokenSignAlgResponse idTokenSignAlg) {
        this.idTokenSignAlg = idTokenSignAlg;
        return this;
    }
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public ClientCreateApiResponseBody withIdTokenEncryptionAlg(@Nullable ClientCreateApiIdTokenEncryptionAlgResponse idTokenEncryptionAlg) {
        this.idTokenEncryptionAlg = idTokenEncryptionAlg;
        return this;
    }
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public ClientCreateApiResponseBody withIdTokenEncryptionEnc(@Nullable ClientCreateApiIdTokenEncryptionEncResponse idTokenEncryptionEnc) {
        this.idTokenEncryptionEnc = idTokenEncryptionEnc;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientCreateApiResponseBody withAuthTimeRequired(@Nullable Boolean authTimeRequired) {
        this.authTimeRequired = authTimeRequired;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientCreateApiResponseBody withSubjectType(@Nullable ClientCreateApiSubjectTypeResponse subjectType) {
        this.subjectType = subjectType;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata)
     */
    public ClientCreateApiResponseBody withSectorIdentifierUri(@Nullable String sectorIdentifierUri) {
        this.sectorIdentifierUri = sectorIdentifierUri;
        return this;
    }
     ...
     * are also registered, the value of this property is `null`.
     */
    public ClientCreateApiResponseBody withDerivedSectorIdentifier(@Nullable String derivedSectorIdentifier) {
        this.derivedSectorIdentifier = derivedSectorIdentifier;
        return this;
    }
     ...
     * Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientCreateApiResponseBody withJwksUri(@Nullable String jwksUri) {
        this.jwksUri = jwksUri;
        return this;
    }
     ...
     * Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientCreateApiResponseBody withJwks(@Nullable String jwks) {
        this.jwks = jwks;
        return this;
    }
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public ClientCreateApiResponseBody withUserInfoSignAlg(@Nullable ClientCreateApiUserInfoSignAlgResponse userInfoSignAlg) {
        this.userInfoSignAlg = userInfoSignAlg;
        return this;
    }
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public ClientCreateApiResponseBody withUserInfoEncryptionAlg(@Nullable ClientCreateApiUserInfoEncryptionAlgResponse userInfoEncryptionAlg) {
        this.userInfoEncryptionAlg = userInfoEncryptionAlg;
        return this;
    }
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public ClientCreateApiResponseBody withUserInfoEncryptionEnc(@Nullable ClientCreateApiUserInfoEncryptionEncResponse userInfoEncryptionEnc) {
        this.userInfoEncryptionEnc = userInfoEncryptionEnc;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientCreateApiResponseBody withLoginUri(@Nullable String loginUri) {
        this.loginUri = loginUri;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientCreateApiResponseBody withTosUri(@Nullable String tosUri) {
        this.tosUri = tosUri;
        return this;
    }
     ...
     * this property can be used to register the URLs.
     */
    public ClientCreateApiResponseBody withTosUris(@Nullable List<ClientCreateApiTosUrisResponse> tosUris) {
        this.tosUris = tosUris;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientCreateApiResponseBody withPolicyUri(@Nullable String policyUri) {
        this.policyUri = policyUri;
        return this;
    }
     ...
     * If the client application has different policy pages for different languages, this property can be used to register the URLs.
     */
    public ClientCreateApiResponseBody withPolicyUris(@Nullable List<ClientCreateApiPolicyUrisResponse> policyUris) {
        this.policyUris = policyUris;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientCreateApiResponseBody withClientUri(@Nullable String clientUri) {
        this.clientUri = clientUri;
        return this;
    }
     ...
     * be used to register the URLs.
     */
    public ClientCreateApiResponseBody withClientUris(@Nullable List<ClientCreateApiClientUrisResponse> clientUris) {
        this.clientUris = clientUris;
        return this;
    }
     ...
     * Backchannel Authentication)".
     */
    public ClientCreateApiResponseBody withBcDeliveryMode(@Nullable String bcDeliveryMode) {
        this.bcDeliveryMode = bcDeliveryMode;
        return this;
    }
     ...
     * Backchannel Authentication)".
     */
    public ClientCreateApiResponseBody withBcNotificationEndpoint(@Nullable String bcNotificationEndpoint) {
        this.bcNotificationEndpoint = bcNotificationEndpoint;
        return this;
    }
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public ClientCreateApiResponseBody withBcRequestSignAlg(@Nullable ClientCreateApiBcRequestSignAlgResponse bcRequestSignAlg) {
        this.bcRequestSignAlg = bcRequestSignAlg;
        return this;
    }
     ...
     * <p>This property corresponds to the `backchannel_user_code_parameter` metadata.
     */
    public ClientCreateApiResponseBody withBcUserCodeRequired(@Nullable Boolean bcUserCodeRequired) {
        this.bcUserCodeRequired = bcUserCodeRequired;
        return this;
    }
     ...
     * The attributes of this client.
     */
    public ClientCreateApiResponseBody withAttributes(@Nullable List<ClientCreateApiAttributeResponse> attributes) {
        this.attributes = attributes;
        return this;
    }


    public ClientCreateApiResponseBody withExtension(@Nullable ClientCreateApiExtensionResponse extension) {
        this.extension = extension;
        return this;
    }
     ...
     * to align with the change made by the 5th draft of the RAR specification.
     */
    public ClientCreateApiResponseBody withAuthorizationDetailsTypes(@Nullable List<String> authorizationDetailsTypes) {
        this.authorizationDetailsTypes = authorizationDetailsTypes;
        return this;
    }
     ...
     * custom client metadata values can be referenced by this property.
     */
    public ClientCreateApiResponseBody withCustomMetadata(@Nullable String customMetadata) {
        this.customMetadata = customMetadata;
        return this;
    }
     ...
     * flag of the service is `true`.
     */
    public ClientCreateApiResponseBody withFrontChannelRequestObjectEncryptionRequired(@Nullable Boolean frontChannelRequestObjectEncryptionRequired) {
        this.frontChannelRequestObjectEncryptionRequired = frontChannelRequestObjectEncryptionRequired;
        return this;
    }
     ...
     * flag of the service is `true`.
     */
    public ClientCreateApiResponseBody withRequestObjectEncryptionAlgMatchRequired(@Nullable Boolean requestObjectEncryptionAlgMatchRequired) {
        this.requestObjectEncryptionAlgMatchRequired = requestObjectEncryptionAlgMatchRequired;
        return this;
    }
     ...
     * flag of the service is `true`.
     */
    public ClientCreateApiResponseBody withRequestObjectEncryptionEncMatchRequired(@Nullable Boolean requestObjectEncryptionEncMatchRequired) {
        this.requestObjectEncryptionEncMatchRequired = requestObjectEncryptionEncMatchRequired;
        return this;
    }
     ...
     * [OpenID Connect for Identity Assurance 1.0](https://openid.net/specs/openid-connect-4-identity-assurance-1_0.html).
     */
    public ClientCreateApiResponseBody withDigestAlgorithm(@Nullable String digestAlgorithm) {
        this.digestAlgorithm = digestAlgorithm;
        return this;
    }
     ...
     * <p>Even if `Disabled` is selected here, single access token per subject is effective if `singleAccessTokenPerSubject` of the `Service` this client belongs to is Enabled.
     */
    public ClientCreateApiResponseBody withSingleAccessTokenPerSubject(@Nullable Boolean singleAccessTokenPerSubject) {
        this.singleAccessTokenPerSubject = singleAccessTokenPerSubject;
        return this;
    }
     ...
     * <p>See [RFC 7636](https://tools.ietf.org/html/rfc7636) (Proof Key for Code Exchange by OAuth Public Clients) for details about `code_challenge` request parameter.
     */
    public ClientCreateApiResponseBody withPkceRequired(@Nullable Boolean pkceRequired) {
        this.pkceRequired = pkceRequired;
        return this;
    }
     ...
     * Neither omission of the `code_challenge_method` request parameter nor use of plain (`code_challenge_method=plain`) is allowed.
     */
    public ClientCreateApiResponseBody withPkceS256Required(@Nullable Boolean pkceS256Required) {
        this.pkceS256Required = pkceS256Required;
        return this;
    }
     ...
     * If the DPoP is required for this client
     */
    public ClientCreateApiResponseBody withDpopRequired(@Nullable Boolean dpopRequired) {
        this.dpopRequired = dpopRequired;
        return this;
    }
     ...
     * "automatic" client registration of OIDC Federation.
     */
    public ClientCreateApiResponseBody withAutomaticallyRegistered(@Nullable Boolean automaticallyRegistered) {
        this.automaticallyRegistered = automaticallyRegistered;
        return this;
    }
     ...
     * "explicit" client registration of OIDC Federation.
     */
    public ClientCreateApiResponseBody withExplicitlyRegistered(@Nullable Boolean explicitlyRegistered) {
        this.explicitlyRegistered = explicitlyRegistered;
        return this;
    }
     ...
     * The flag indicating whether this service signs responses from the resource server.
     */
    public ClientCreateApiResponseBody withRsRequestSigned(@Nullable Boolean rsRequestSigned) {
        this.rsRequestSigned = rsRequestSigned;
        return this;
    }
     ...
     * The key ID of a JWK containing the public key used by this client to sign requests to the resource server.
     */
    public ClientCreateApiResponseBody withRsSignedRequestKeyId(@Nullable String rsSignedRequestKeyId) {
        this.rsSignedRequestKeyId = rsSignedRequestKeyId;
        return this;
    }
     ...
     * The client registration types that the client has declared it may use.
     */
    public ClientCreateApiResponseBody withClientRegistrationTypes(@Nullable List<ClientCreateApiClientRegistrationTypeResponse> clientRegistrationTypes) {
        this.clientRegistrationTypes = clientRegistrationTypes;
        return this;
    }
     ...
     * to the organization_name client metadata that is defined in OpenID Connect Federation 1.0.
     */
    public ClientCreateApiResponseBody withOrganizationName(@Nullable String organizationName) {
        this.organizationName = organizationName;
        return this;
    }
     ...
     * corresponds to the `signed_jwks_uri` client metadata defined in OpenID Connect Federation 1.0.
     */
    public ClientCreateApiResponseBody withSignedJwksUri(@Nullable String signedJwksUri) {
        this.signedJwksUri = signedJwksUri;
        return this;
    }
     ...
     * the entity ID of this client.
     */
    public ClientCreateApiResponseBody withEntityId(@Nullable String entityId) {
        this.entityId = entityId;
        return this;
    }
     ...
     * the mechanism defined in OpenID Connect Federation 1.0
     */
    public ClientCreateApiResponseBody withTrustAnchorId(@Nullable String trustAnchorId) {
        this.trustAnchorId = trustAnchorId;
        return this;
    }
     ...
     * OpenID Connect Federation 1.0
     */
    public ClientCreateApiResponseBody withTrustChain(@Nullable List<String> trustChain) {
        this.trustChain = trustChain;
        return this;
    }
     ...
     * defined in OpenID Connect Federation 1.0. The value is represented as milliseconds elapsed since the Unix epoch (1970-01-01).
     */
    public ClientCreateApiResponseBody withTrustChainExpiresAt(@Nullable Long trustChainExpiresAt) {
        this.trustChainExpiresAt = trustChainExpiresAt;
        return this;
    }
     ...
     * the time at which the trust chain was updated by the mechanism defined in OpenID Connect Federation 1.0
     */
    public ClientCreateApiResponseBody withTrustChainUpdatedAt(@Nullable Long trustChainUpdatedAt) {
        this.trustChainUpdatedAt = trustChainUpdatedAt;
        return this;
    }
     ...
     * The flag which indicates whether this client is locked.
     */
    public ClientCreateApiResponseBody withLocked(@Nullable Boolean locked) {
        this.locked = locked;
        return this;
    }
     ...
     * (wallet) receives a credential offer from the credential issuer.
     */
    public ClientCreateApiResponseBody withCredentialOfferEndpoint(@Nullable String credentialOfferEndpoint) {
        this.credentialOfferEndpoint = credentialOfferEndpoint;
        return this;
    }
     ...
     * the service, and the FAPI modes for the service are set to `null`.
     */
    public ClientCreateApiResponseBody withFapiModes(@Nullable List<ClientCreateApiFapiModeResponse> fapiModes) {
        this.fapiModes = fapiModes;
        return this;
    }
     ...
     * The response modes that this client may use.
     */
    public ClientCreateApiResponseBody withResponseModes(@Nullable List<ClientCreateApiResponseModeResponse> responseModes) {
        this.responseModes = responseModes;
        return this;
    }
     ...
     * True if credential responses to this client must be always encrypted.
     */
    public ClientCreateApiResponseBody withCredentialResponseEncryptionRequired(@Nullable Boolean credentialResponseEncryptionRequired) {
        this.credentialResponseEncryptionRequired = credentialResponseEncryptionRequired;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClientCreateApiResponseBody other = (ClientCreateApiResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ClientCreateApiResponseBody.class,
                "number", number,
    ...
    public final static class Builder {
         ...
         * languages, this property can be used to register the names.
         */
        public Builder clientNames(@Nullable List<ClientCreateApiClientNameResponse> clientNames) {
            this.clientNames = clientNames;
            return this;
        }
         ...
         * descriptions for different languages, this property can be used to register the descriptions.
         */
        public Builder descriptions(@Nullable List<ClientCreateApiDescriptionResponse> descriptions) {
            this.descriptions = descriptions;
            return this;
        }
         ...
         * for details.
         */
        public Builder clientType(@Nullable ClientCreateApiClientTypeResponse clientType) {
            this.clientType = clientType;
            return this;
        }
         ...
         * See the description about `redirectUris` property for more details.
         */
        public Builder applicationType(@Nullable ClientCreateApiApplicationTypeResponse applicationType) {
            this.applicationType = applicationType;
            return this;
        }
         ...
         * different languages, this property can be used to register URLs of the images.
         */
        public Builder logoUris(@Nullable List<ClientCreateApiLogoUrisResponse> logoUris) {
            this.logoUris = logoUris;
            return this;
        }
         ...
         * 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
         */
        public Builder grantTypes(@Nullable List<ClientCreateApiGrantTypeResponse> grantTypes) {
            this.grantTypes = grantTypes;
            return this;
        }
         ...
         * 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
         */
        public Builder responseTypes(@Nullable List<ClientCreateApiResponseTypeResponse> responseTypes) {
            this.responseTypes = responseTypes;
            return this;
        }
         ...
         *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
         */
        public Builder authorizationSignAlg(@Nullable ClientCreateApiAuthorizationSignAlgResponse authorizationSignAlg) {
            this.authorizationSignAlg = authorizationSignAlg;
            return this;
        }
         ...
         * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
         */
        public Builder authorizationEncryptionAlg(@Nullable ClientCreateApiAuthorizationEncryptionAlgResponse authorizationEncryptionAlg) {
            this.authorizationEncryptionAlg = authorizationEncryptionAlg;
            return this;
        }
         ...
         *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
         */
        public Builder authorizationEncryptionEnc(@Nullable ClientCreateApiAuthorizationEncryptionEncResponse authorizationEncryptionEnc) {
            this.authorizationEncryptionEnc = authorizationEncryptionEnc;
            return this;
        }
         ...
         * Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
         */
        public Builder tokenAuthMethod(@Nullable ClientCreateApiTokenAuthMethodResponse tokenAuthMethod) {
            this.tokenAuthMethod = tokenAuthMethod;
            return this;
        }
         ...
         *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
         */
        public Builder tokenAuthSignAlg(@Nullable ClientCreateApiTokenAuthSignAlgResponse tokenAuthSignAlg) {
            this.tokenAuthSignAlg = tokenAuthSignAlg;
            return this;
        }
         ...
         *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
         */
        public Builder requestSignAlg(@Nullable ClientCreateApiRequestSignAlgResponse requestSignAlg) {
            this.requestSignAlg = requestSignAlg;
            return this;
        }
         ...
         * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
         */
        public Builder requestEncryptionAlg(@Nullable ClientCreateApiRequestEncryptionAlgResponse requestEncryptionAlg) {
            this.requestEncryptionAlg = requestEncryptionAlg;
            return this;
        }
         ...
         *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
         */
        public Builder requestEncryptionEnc(@Nullable ClientCreateApiRequestEncryptionEncResponse requestEncryptionEnc) {
            this.requestEncryptionEnc = requestEncryptionEnc;
            return this;
        }
         ...
         *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
         */
        public Builder idTokenSignAlg(@Nullable ClientCreateApiIdTokenSignAlgResponse idTokenSignAlg) {
            this.idTokenSignAlg = idTokenSignAlg;
            return this;
        }
         ...
         * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
         */
        public Builder idTokenEncryptionAlg(@Nullable ClientCreateApiIdTokenEncryptionAlgResponse idTokenEncryptionAlg) {
            this.idTokenEncryptionAlg = idTokenEncryptionAlg;
            return this;
        }
         ...
         *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
         */
        public Builder idTokenEncryptionEnc(@Nullable ClientCreateApiIdTokenEncryptionEncResponse idTokenEncryptionEnc) {
            this.idTokenEncryptionEnc = idTokenEncryptionEnc;
            return this;
        }
         ...
         * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
         */
        public Builder subjectType(@Nullable ClientCreateApiSubjectTypeResponse subjectType) {
            this.subjectType = subjectType;
            return this;
        }
         ...
         *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
         */
        public Builder userInfoSignAlg(@Nullable ClientCreateApiUserInfoSignAlgResponse userInfoSignAlg) {
            this.userInfoSignAlg = userInfoSignAlg;
            return this;
        }
         ...
         * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
         */
        public Builder userInfoEncryptionAlg(@Nullable ClientCreateApiUserInfoEncryptionAlgResponse userInfoEncryptionAlg) {
            this.userInfoEncryptionAlg = userInfoEncryptionAlg;
            return this;
        }
         ...
         *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
         */
        public Builder userInfoEncryptionEnc(@Nullable ClientCreateApiUserInfoEncryptionEncResponse userInfoEncryptionEnc) {
            this.userInfoEncryptionEnc = userInfoEncryptionEnc;
            return this;
        }
         ...
         * this property can be used to register the URLs.
         */
        public Builder tosUris(@Nullable List<ClientCreateApiTosUrisResponse> tosUris) {
            this.tosUris = tosUris;
            return this;
        }
         ...
         * If the client application has different policy pages for different languages, this property can be used to register the URLs.
         */
        public Builder policyUris(@Nullable List<ClientCreateApiPolicyUrisResponse> policyUris) {
            this.policyUris = policyUris;
            return this;
        }
         ...
         * be used to register the URLs.
         */
        public Builder clientUris(@Nullable List<ClientCreateApiClientUrisResponse> clientUris) {
            this.clientUris = clientUris;
            return this;
        }
         ...
         *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
         */
        public Builder bcRequestSignAlg(@Nullable ClientCreateApiBcRequestSignAlgResponse bcRequestSignAlg) {
            this.bcRequestSignAlg = bcRequestSignAlg;
            return this;
        }
         ...
         * The attributes of this client.
         */
        public Builder attributes(@Nullable List<ClientCreateApiAttributeResponse> attributes) {
            this.attributes = attributes;
            return this;
        }

        public Builder extension(@Nullable ClientCreateApiExtensionResponse extension) {
            this.extension = extension;
            return this;
        }
         ...
         * The client registration types that the client has declared it may use.
         */
        public Builder clientRegistrationTypes(@Nullable List<ClientCreateApiClientRegistrationTypeResponse> clientRegistrationTypes) {
            this.clientRegistrationTypes = clientRegistrationTypes;
            return this;
        }
         ...
         * the service, and the FAPI modes for the service are set to `null`.
         */
        public Builder fapiModes(@Nullable List<ClientCreateApiFapiModeResponse> fapiModes) {
            this.fapiModes = fapiModes;
            return this;
        }
         ...
         * The response modes that this client may use.
         */
        public Builder responseModes(@Nullable List<ClientCreateApiResponseModeResponse> responseModes) {
            this.responseModes = responseModes;
            return this;
        }
        ...
        public ClientCreateApiResponseBody build() {
            return new ClientCreateApiResponseBody(
                number, serviceNumber, clientName,
                clientNames, description, descriptions,
                clientId, clientSecret, clientIdAlias,
                clientIdAliasEnabled, clientType, applicationType,
