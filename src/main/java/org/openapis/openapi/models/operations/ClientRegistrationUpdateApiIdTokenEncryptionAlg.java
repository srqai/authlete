 ...
 */
public enum ClientRegistrationUpdateApiIdTokenEncryptionAlg {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientRegistrationUpdateApiIdTokenEncryptionAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationUpdateApiIdTokenEncryptionAlg> fromValue(String value) {
        for (ClientRegistrationUpdateApiIdTokenEncryptionAlg o: ClientRegistrationUpdateApiIdTokenEncryptionAlg.values()) {
