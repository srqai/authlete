 ...
 */
public enum ClientRegistrationDeleteApiFormRequestSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientRegistrationDeleteApiFormRequestSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationDeleteApiFormRequestSignAlg> fromValue(String value) {
        for (ClientRegistrationDeleteApiFormRequestSignAlg o: ClientRegistrationDeleteApiFormRequestSignAlg.values()) {
