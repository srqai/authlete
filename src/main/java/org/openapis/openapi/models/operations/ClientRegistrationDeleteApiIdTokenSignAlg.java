 ...
 */
public enum ClientRegistrationDeleteApiIdTokenSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientRegistrationDeleteApiIdTokenSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationDeleteApiIdTokenSignAlg> fromValue(String value) {
        for (ClientRegistrationDeleteApiIdTokenSignAlg o: ClientRegistrationDeleteApiIdTokenSignAlg.values()) {
