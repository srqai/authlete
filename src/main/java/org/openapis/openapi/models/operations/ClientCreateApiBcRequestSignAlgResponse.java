 ...
 */
public enum ClientCreateApiBcRequestSignAlgResponse {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientCreateApiBcRequestSignAlgResponse(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientCreateApiBcRequestSignAlgResponse> fromValue(String value) {
        for (ClientCreateApiBcRequestSignAlgResponse o: ClientCreateApiBcRequestSignAlgResponse.values()) {
