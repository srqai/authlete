 ...
 */
public enum ClientRegistrationApiFormRequestEncryptionAlg {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientRegistrationApiFormRequestEncryptionAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationApiFormRequestEncryptionAlg> fromValue(String value) {
        for (ClientRegistrationApiFormRequestEncryptionAlg o: ClientRegistrationApiFormRequestEncryptionAlg.values()) {
