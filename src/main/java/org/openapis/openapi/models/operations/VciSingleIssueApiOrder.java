...
public class VciSingleIssueApiOrder {
    /**
     ...
     * The identifier of a credential request.
     */
    public VciSingleIssueApiOrder withRequestIdentifier(@Nullable String requestIdentifier) {
        this.requestIdentifier = requestIdentifier;
        return this;
    }
     ...
     * The additional payload that will be added into a credential to be issued.
     */
    public VciSingleIssueApiOrder withCredentialPayload(@Nullable String credentialPayload) {
        this.credentialPayload = credentialPayload;
        return this;
    }
     ...
     * The flag indicating whether to defer credential issuance.
     */
    public VciSingleIssueApiOrder withIssuanceDeferred(@Nullable Boolean issuanceDeferred) {
        this.issuanceDeferred = issuanceDeferred;
        return this;
    }
     ...
     * The duration of a credential to be issued.
     */
    public VciSingleIssueApiOrder withCredentialDuration(@Nullable Long credentialDuration) {
        this.credentialDuration = credentialDuration;
        return this;
    }
     ...
     * to be issued.
     */
    public VciSingleIssueApiOrder withSigningKeyId(@Nullable String signingKeyId) {
        this.signingKeyId = signingKeyId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        VciSingleIssueApiOrder other = (VciSingleIssueApiOrder) o;
        return 
    ...
    public String toString() {
        return Utils.toString(VciSingleIssueApiOrder.class,
    ...
    public final static class Builder {
        ...
        public VciSingleIssueApiOrder build() {
            return new VciSingleIssueApiOrder(
                requestIdentifier, credentialPayload, issuanceDeferred,
                credentialDuration, signingKeyId);
        }
