 ...
 */
public enum FederationRegistrationApiFormUserInfoEncryptionAlg {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    FederationRegistrationApiFormUserInfoEncryptionAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<FederationRegistrationApiFormUserInfoEncryptionAlg> fromValue(String value) {
        for (FederationRegistrationApiFormUserInfoEncryptionAlg o: FederationRegistrationApiFormUserInfoEncryptionAlg.values()) {
