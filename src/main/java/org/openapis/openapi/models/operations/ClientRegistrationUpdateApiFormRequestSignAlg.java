 ...
 */
public enum ClientRegistrationUpdateApiFormRequestSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientRegistrationUpdateApiFormRequestSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationUpdateApiFormRequestSignAlg> fromValue(String value) {
        for (ClientRegistrationUpdateApiFormRequestSignAlg o: ClientRegistrationUpdateApiFormRequestSignAlg.values()) {
