 ...
 */
public enum ClientUpdateApiRequestEncryptionEncRequest {
    ...
    ClientUpdateApiRequestEncryptionEncRequest(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientUpdateApiRequestEncryptionEncRequest> fromValue(String value) {
        for (ClientUpdateApiRequestEncryptionEncRequest o: ClientUpdateApiRequestEncryptionEncRequest.values()) {
