 ...
 */
public enum ClientCreateApiAuthorizationSignAlgResponse {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientCreateApiAuthorizationSignAlgResponse(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientCreateApiAuthorizationSignAlgResponse> fromValue(String value) {
        for (ClientCreateApiAuthorizationSignAlgResponse o: ClientCreateApiAuthorizationSignAlgResponse.values()) {
