 ...
 */
public enum ClientRegistrationUpdateApiIdTokenSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientRegistrationUpdateApiIdTokenSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationUpdateApiIdTokenSignAlg> fromValue(String value) {
        for (ClientRegistrationUpdateApiIdTokenSignAlg o: ClientRegistrationUpdateApiIdTokenSignAlg.values()) {
