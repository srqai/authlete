...
public class VciBatchParseApiInfo {
    /**
     ...
     * The identifier of the credential offer.
     */
    public VciBatchParseApiInfo withIdentifier(@Nullable String identifier) {
        this.identifier = identifier;
        return this;
    }
     ...
     * The value of the format parameter in the credential request.
     */
    public VciBatchParseApiInfo withFormat(@Nullable String format) {
        this.format = format;
        return this;
    }
     ...
     * The binding key specified by the proof in the credential request.
     */
    public VciBatchParseApiInfo withBindingKey(@Nullable String bindingKey) {
        this.bindingKey = bindingKey;
        return this;
    }
     ...
     * The details about the credential request.
     */
    public VciBatchParseApiInfo withDetails(@Nullable String details) {
        this.details = details;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        VciBatchParseApiInfo other = (VciBatchParseApiInfo) o;
        return 
    ...
    public String toString() {
        return Utils.toString(VciBatchParseApiInfo.class,
    ...
    public final static class Builder {
        ...
        public VciBatchParseApiInfo build() {
            return new VciBatchParseApiInfo(
                identifier, format, bindingKey,
                details);
        }
