 ...
 */
public enum ClientRegistrationApiUserInfoEncryptionAlg {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientRegistrationApiUserInfoEncryptionAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationApiUserInfoEncryptionAlg> fromValue(String value) {
        for (ClientRegistrationApiUserInfoEncryptionAlg o: ClientRegistrationApiUserInfoEncryptionAlg.values()) {
