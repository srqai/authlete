...
public class VciDeferredIssueApiOrder {
    /**
    ...
    @JsonCreator
    public VciDeferredIssueApiOrder(
     ...
     * The identifier of a credential request.
     */
    public VciDeferredIssueApiOrder withRequestIdentifier(@Nullable String requestIdentifier) {
        this.requestIdentifier = requestIdentifier;
        return this;
    }
     ...
     * The additional payload that will be added into a credential to be issued.
     */
    public VciDeferredIssueApiOrder withCredentialPayload(@Nullable String credentialPayload) {
        this.credentialPayload = credentialPayload;
        return this;
    }
     ...
     * The flag indicating whether to defer credential issuance.
     */
    public VciDeferredIssueApiOrder withIssuanceDeferred(@Nullable Boolean issuanceDeferred) {
        this.issuanceDeferred = issuanceDeferred;
        return this;
    }
     ...
     * The duration of a credential to be issued.
     */
    public VciDeferredIssueApiOrder withCredentialDuration(@Nullable Long credentialDuration) {
        this.credentialDuration = credentialDuration;
        return this;
    }
     ...
     * to be issued.
     */
    public VciDeferredIssueApiOrder withSigningKeyId(@Nullable String signingKeyId) {
        this.signingKeyId = signingKeyId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        VciDeferredIssueApiOrder other = (VciDeferredIssueApiOrder) o;
        return 
    ...
    public String toString() {
        return Utils.toString(VciDeferredIssueApiOrder.class,
    ...
    public final static class Builder {
        ...
        public VciDeferredIssueApiOrder build() {
            return new VciDeferredIssueApiOrder(
                requestIdentifier, credentialPayload, issuanceDeferred,
                credentialDuration, signingKeyId);
        }
