 ...
 */
public enum ClientUpdateApiUserInfoSignAlgRequest {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientUpdateApiUserInfoSignAlgRequest(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientUpdateApiUserInfoSignAlgRequest> fromValue(String value) {
        for (ClientUpdateApiUserInfoSignAlgRequest o: ClientUpdateApiUserInfoSignAlgRequest.values()) {
