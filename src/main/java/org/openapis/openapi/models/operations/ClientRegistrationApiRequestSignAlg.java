 ...
 */
public enum ClientRegistrationApiRequestSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientRegistrationApiRequestSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationApiRequestSignAlg> fromValue(String value) {
        for (ClientRegistrationApiRequestSignAlg o: ClientRegistrationApiRequestSignAlg.values()) {
