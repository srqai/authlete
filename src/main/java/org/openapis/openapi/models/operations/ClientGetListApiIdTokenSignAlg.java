 ...
 */
public enum ClientGetListApiIdTokenSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientGetListApiIdTokenSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientGetListApiIdTokenSignAlg> fromValue(String value) {
        for (ClientGetListApiIdTokenSignAlg o: ClientGetListApiIdTokenSignAlg.values()) {
