 ...
 */
public enum ClientUpdateApiAuthorizationSignAlgRequest {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientUpdateApiAuthorizationSignAlgRequest(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientUpdateApiAuthorizationSignAlgRequest> fromValue(String value) {
        for (ClientUpdateApiAuthorizationSignAlgRequest o: ClientUpdateApiAuthorizationSignAlgRequest.values()) {
