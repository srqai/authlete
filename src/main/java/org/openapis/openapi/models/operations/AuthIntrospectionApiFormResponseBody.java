...
public class AuthIntrospectionApiFormResponseBody {
    /**
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("action")
    private AuthIntrospectionApiFormAction action;
    ...
    @JsonCreator
    public AuthIntrospectionApiFormResponseBody(
            @JsonProperty("resultCode") @Nullable String resultCode,
            @JsonProperty("resultMessage") @Nullable String resultMessage,
            @JsonProperty("action") @Nullable AuthIntrospectionApiFormAction action,
     ...
     * The next action that the authorization server implementation should take.
     */
    public Optional<AuthIntrospectionApiFormAction> action() {
     ...
     * The code which represents the result of the API call.
     */
    public AuthIntrospectionApiFormResponseBody withResultCode(@Nullable String resultCode) {
        this.resultCode = resultCode;
        return this;
    }
     ...
     * A short message which explains the result of the API call.
     */
    public AuthIntrospectionApiFormResponseBody withResultMessage(@Nullable String resultMessage) {
        this.resultMessage = resultMessage;
        return this;
    }
     ...
     * The next action that the authorization server implementation should take.
     */
    public AuthIntrospectionApiFormResponseBody withAction(@Nullable AuthIntrospectionApiFormAction action) {
        this.action = action;
        return this;
    }
     ...
     * The content that the authorization server implementation can use as the value of `WWW-Authenticate` header on errors.
     */
    public AuthIntrospectionApiFormResponseBody withResponseContent(@Nullable String responseContent) {
        this.responseContent = responseContent;
        return this;
    }
     ...
     * The client ID.
     */
    public AuthIntrospectionApiFormResponseBody withClientId(@Nullable Long clientId) {
        this.clientId = clientId;
        return this;
    }
     ...
     * Also, if the token request was invalid and it failed to identify a client, this parameter is `null`.
     */
    public AuthIntrospectionApiFormResponseBody withClientIdAlias(@Nullable String clientIdAlias) {
        this.clientIdAlias = clientIdAlias;
        return this;
    }
     ...
     * `true` if the client ID alias was used when the token request was made.
     */
    public AuthIntrospectionApiFormResponseBody withClientIdAliasUsed(@Nullable Boolean clientIdAliasUsed) {
        this.clientIdAliasUsed = clientIdAliasUsed;
        return this;
    }
     ...
     * The value is represented in milliseconds since the Unix epoch (1970-01-01).
     */
    public AuthIntrospectionApiFormResponseBody withExpiresAt(@Nullable Long expiresAt) {
        this.expiresAt = expiresAt;
        return this;
    }
     ...
     * The value of this property is `null` if the access token was issued using the flow of [Client Credentials Grant](tools.ietf.org/html/rfc6749#section-4.4).
     */
    public AuthIntrospectionApiFormResponseBody withSubject(@Nullable String subject) {
        this.subject = subject;
        return this;
    }
     ...
     * The scopes covered by the access token.
     */
    public AuthIntrospectionApiFormResponseBody withScopes(@Nullable List<String> scopes) {
        this.scopes = scopes;
        return this;
    }
     ...
     * `true` if the access token exists.
     */
    public AuthIntrospectionApiFormResponseBody withExistent(@Nullable Boolean existent) {
        this.existent = existent;
        return this;
    }
     ...
     * true` if the access token is usable (= exists and has not expired).
     */
    public AuthIntrospectionApiFormResponseBody withUsable(@Nullable Boolean usable) {
        this.usable = usable;
        return this;
    }
     ...
     * `true` if the access token exists.
     */
    public AuthIntrospectionApiFormResponseBody withSufficient(@Nullable Boolean sufficient) {
        this.sufficient = sufficient;
        return this;
    }
     ...
     * token has no associated refresh token.
     */
    public AuthIntrospectionApiFormResponseBody withRefreshable(@Nullable Boolean refreshable) {
        this.refreshable = refreshable;
        return this;
    }
     ...
     * The client certificate thumbprint used to validate the access token.
     */
    public AuthIntrospectionApiFormResponseBody withCertificateThumbprint(@Nullable String certificateThumbprint) {
        this.certificateThumbprint = certificateThumbprint;
        return this;
    }
     ...
     * <p>See "Resource Indicators for OAuth 2.0" for details.
     */
    public AuthIntrospectionApiFormResponseBody withResources(@Nullable List<String> resources) {
        this.resources = resources;
        return this;
    }
     ...
     * <p>See "Resource Indicators for OAuth 2.0" for details.
     */
    public AuthIntrospectionApiFormResponseBody withAccessTokenResources(@Nullable List<String> accessTokenResources) {
        this.accessTokenResources = accessTokenResources;
        return this;
    }
     ...
     * , which is supported by Authlete 2.3 and newer versions.
     */
    public AuthIntrospectionApiFormResponseBody withGrantId(@Nullable String grantId) {
        this.grantId = grantId;
        return this;
    }
     ...
     * attachment.
     */
    public AuthIntrospectionApiFormResponseBody withForExternalAttachment(@Nullable Boolean forExternalAttachment) {
        this.forExternalAttachment = forExternalAttachment;
        return this;
    }
     ...
     * to know.
     */
    public AuthIntrospectionApiFormResponseBody withConsentedClaims(@Nullable List<String> consentedClaims) {
        this.consentedClaims = consentedClaims;
        return this;
    }
     ...
     * during the course of issuing the access token.
     */
    public AuthIntrospectionApiFormResponseBody withAcr(@Nullable String acr) {
        this.acr = acr;
        return this;
    }
     ...
     * The time when the user authentication was performed during the course of issuing the access token.
     */
    public AuthIntrospectionApiFormResponseBody withAuthTime(@Nullable Long authTime) {
        this.authTime = authTime;
        return this;
    }
     ...
     * The entity ID of the client.
     */
    public AuthIntrospectionApiFormResponseBody withClientEntityId(@Nullable String clientEntityId) {
        this.clientEntityId = clientEntityId;
        return this;
    }
     ...
     * Flag which indicates whether the entity ID of the client was used when the request for the access token was made.
     */
    public AuthIntrospectionApiFormResponseBody withClientEntityIdUsed(@Nullable Boolean clientEntityIdUsed) {
        this.clientEntityIdUsed = clientEntityIdUsed;
        return this;
    }
     ...
     * The flag indicating whether the token is for credential issuance.
     */
    public AuthIntrospectionApiFormResponseBody withForCredentialIssuance(@Nullable Boolean forCredentialIssuance) {
        this.forCredentialIssuance = forCredentialIssuance;
        return this;
    }
     ...
     * The c_nonce
     */
    public AuthIntrospectionApiFormResponseBody withCnonce(@Nullable String cnonce) {
        this.cnonce = cnonce;
        return this;
    }
     ...
     * The time at which the `c_nonce` expires.
     */
    public AuthIntrospectionApiFormResponseBody withCnonceExpiresAt(@Nullable Long cnonceExpiresAt) {
        this.cnonceExpiresAt = cnonceExpiresAt;
        return this;
    }
     ...
     * The credentials that can be obtained by presenting the access token.
     */
    public AuthIntrospectionApiFormResponseBody withIssuableCredentials(@Nullable String issuableCredentials) {
        this.issuableCredentials = issuableCredentials;
        return this;
    }
     ...
     * as the value of the `DPoP-Nonce` HTTP header.
     */
    public AuthIntrospectionApiFormResponseBody withDpopNonce(@Nullable String dpopNonce) {
        this.dpopNonce = dpopNonce;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AuthIntrospectionApiFormResponseBody other = (AuthIntrospectionApiFormResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AuthIntrospectionApiFormResponseBody.class,
    ...
    public final static class Builder {
         ...
         * The next action that the authorization server implementation should take.
         */
        public Builder action(@Nullable AuthIntrospectionApiFormAction action) {
            this.action = action;
            return this;
        }
        ...
        public AuthIntrospectionApiFormResponseBody build() {
            return new AuthIntrospectionApiFormResponseBody(
                resultCode, resultMessage, action,
                responseContent, clientId, clientIdAlias,
                clientIdAliasUsed, expiresAt, subject,
                scopes, existent, usable,
