 ...
 */
public enum ClientCreateApiIdTokenEncryptionAlgResponse {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientCreateApiIdTokenEncryptionAlgResponse(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientCreateApiIdTokenEncryptionAlgResponse> fromValue(String value) {
        for (ClientCreateApiIdTokenEncryptionAlgResponse o: ClientCreateApiIdTokenEncryptionAlgResponse.values()) {
