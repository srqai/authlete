 ...
 */
public enum ClientGetListApiUserInfoEncryptionAlg {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientGetListApiUserInfoEncryptionAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientGetListApiUserInfoEncryptionAlg> fromValue(String value) {
        for (ClientGetListApiUserInfoEncryptionAlg o: ClientGetListApiUserInfoEncryptionAlg.values()) {
