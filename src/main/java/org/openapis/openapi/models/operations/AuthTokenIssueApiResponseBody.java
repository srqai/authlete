...
public class AuthTokenIssueApiResponseBody {
    /**
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("action")
    private AuthTokenIssueApiAction action;
     ...
     * The next action that the authorization server implementation should take.
     */
    public Optional<AuthTokenIssueApiAction> action() {
     ...
     * The code which represents the result of the API call.
     */
    public AuthTokenIssueApiResponseBody withResultCode(@Nullable String resultCode) {
        this.resultCode = resultCode;
        return this;
    }
     ...
     * A short message which explains the result of the API call.
     */
    public AuthTokenIssueApiResponseBody withResultMessage(@Nullable String resultMessage) {
        this.resultMessage = resultMessage;
        return this;
    }
     ...
     * The next action that the authorization server implementation should take.
     */
    public AuthTokenIssueApiResponseBody withAction(@Nullable AuthTokenIssueApiAction action) {
        this.action = action;
        return this;
    }
     ...
     * Its format is JSON.
     */
    public AuthTokenIssueApiResponseBody withResponseContent(@Nullable String responseContent) {
        this.responseContent = responseContent;
        return this;
    }
     ...
     * The newly issued access token. This parameter is a non-null value only when the value of `action` parameter is `OK`.
     */
    public AuthTokenIssueApiResponseBody withAccessToken(@Nullable String accessToken) {
        this.accessToken = accessToken;
        return this;
    }
     ...
     * The value is represented in milliseconds since the Unix epoch (1970-01-01).
     */
    public AuthTokenIssueApiResponseBody withAccessTokenExpiresAt(@Nullable Long accessTokenExpiresAt) {
        this.accessTokenExpiresAt = accessTokenExpiresAt;
        return this;
    }
     ...
     * The duration of the newly issued access token in seconds.
     */
    public AuthTokenIssueApiResponseBody withAccessTokenDuration(@Nullable Long accessTokenDuration) {
        this.accessTokenDuration = accessTokenDuration;
        return this;
    }
     ...
     * is invalidated. On the contrary, if `refreshTokenKept` is set to `true`, the refresh token itself is not refreshed.
     */
    public AuthTokenIssueApiResponseBody withRefreshToken(@Nullable String refreshToken) {
        this.refreshToken = refreshToken;
        return this;
    }
     ...
     * The value is represented in milliseconds since the Unix epoch (1970-01-01).
     */
    public AuthTokenIssueApiResponseBody withRefreshTokenExpiresAt(@Nullable Long refreshTokenExpiresAt) {
        this.refreshTokenExpiresAt = refreshTokenExpiresAt;
        return this;
    }
     ...
     * The duration of the newly issued refresh token in seconds.
     */
    public AuthTokenIssueApiResponseBody withRefreshTokenDuration(@Nullable Long refreshTokenDuration) {
        this.refreshTokenDuration = refreshTokenDuration;
        return this;
    }
     ...
     * The client ID.
     */
    public AuthTokenIssueApiResponseBody withClientId(@Nullable Long clientId) {
        this.clientId = clientId;
        return this;
    }
     ...
     * The client ID alias. If the client did not have an alias, this parameter is `null`.
     */
    public AuthTokenIssueApiResponseBody withClientIdAlias(@Nullable String clientIdAlias) {
        this.clientIdAlias = clientIdAlias;
        return this;
    }
     ...
     * `true` if the client ID alias was used when the token request was made.
     */
    public AuthTokenIssueApiResponseBody withClientIdAliasUsed(@Nullable Boolean clientIdAliasUsed) {
        this.clientIdAliasUsed = clientIdAliasUsed;
        return this;
    }
     ...
     * the access token is not associated with any specific end-user.
     */
    public AuthTokenIssueApiResponseBody withSubject(@Nullable String subject) {
        this.subject = subject;
        return this;
    }
     ...
     * The scopes covered by the access token.
     */
    public AuthTokenIssueApiResponseBody withScopes(@Nullable List<String> scopes) {
        this.scopes = scopes;
        return this;
    }
     ...
     * original random-string one.
     */
    public AuthTokenIssueApiResponseBody withJwtAccessToken(@Nullable String jwtAccessToken) {
        this.jwtAccessToken = jwtAccessToken;
        return this;
    }
     ...
     * The target resources of the access token being issued. See "Resource Indicators for OAuth 2.0" for details.
     */
    public AuthTokenIssueApiResponseBody withAccessTokenResources(@Nullable List<String> accessTokenResources) {
        this.accessTokenResources = accessTokenResources;
        return this;
    }
     ...
     * The entity ID of the client.
     */
    public AuthTokenIssueApiResponseBody withClientEntityId(@Nullable String clientEntityId) {
        this.clientEntityId = clientEntityId;
        return this;
    }
     ...
     * Flag which indicates whether the entity ID of the client was used when the request for the access token was made.
     */
    public AuthTokenIssueApiResponseBody withClientEntityIdUsed(@Nullable Boolean clientEntityIdUsed) {
        this.clientEntityIdUsed = clientEntityIdUsed;
        return this;
    }
     ...
     * The scopes associated with the refresh token. May be null.
     */
    public AuthTokenIssueApiResponseBody withRefreshTokenScopes(@Nullable List<String> refreshTokenScopes) {
        this.refreshTokenScopes = refreshTokenScopes;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AuthTokenIssueApiResponseBody other = (AuthTokenIssueApiResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AuthTokenIssueApiResponseBody.class,
    ...
    public final static class Builder {
         ...
         * The next action that the authorization server implementation should take.
         */
        public Builder action(@Nullable AuthTokenIssueApiAction action) {
            this.action = action;
            return this;
        }
        ...
        public AuthTokenIssueApiResponseBody build() {
            return new AuthTokenIssueApiResponseBody(
                resultCode, resultMessage, action,
                responseContent, accessToken, accessTokenExpiresAt,
                accessTokenDuration, refreshToken, refreshTokenExpiresAt,
                refreshTokenDuration, clientId, clientIdAlias,
