 ...
 */
public enum ServiceCreateApiAccessTokenSignAlgResponse {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ServiceCreateApiAccessTokenSignAlgResponse(String value) {
        this.value = value;
    }
    ...
    public static Optional<ServiceCreateApiAccessTokenSignAlgResponse> fromValue(String value) {
        for (ServiceCreateApiAccessTokenSignAlgResponse o: ServiceCreateApiAccessTokenSignAlgResponse.values()) {
