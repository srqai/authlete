 ...
 */
public enum FederationRegistrationApiUserInfoSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    FederationRegistrationApiUserInfoSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<FederationRegistrationApiUserInfoSignAlg> fromValue(String value) {
        for (FederationRegistrationApiUserInfoSignAlg o: FederationRegistrationApiUserInfoSignAlg.values()) {
