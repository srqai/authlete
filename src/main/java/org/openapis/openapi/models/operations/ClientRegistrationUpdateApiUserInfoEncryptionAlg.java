 ...
 */
public enum ClientRegistrationUpdateApiUserInfoEncryptionAlg {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientRegistrationUpdateApiUserInfoEncryptionAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationUpdateApiUserInfoEncryptionAlg> fromValue(String value) {
        for (ClientRegistrationUpdateApiUserInfoEncryptionAlg o: ClientRegistrationUpdateApiUserInfoEncryptionAlg.values()) {
