...
public enum ClientRegistrationUpdateApiFormFapiMode {
    ...
    ClientRegistrationUpdateApiFormFapiMode(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationUpdateApiFormFapiMode> fromValue(String value) {
        for (ClientRegistrationUpdateApiFormFapiMode o: ClientRegistrationUpdateApiFormFapiMode.values()) {
