 ...
 */
public enum ClientRegistrationApiRequestEncryptionAlg {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientRegistrationApiRequestEncryptionAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationApiRequestEncryptionAlg> fromValue(String value) {
        for (ClientRegistrationApiRequestEncryptionAlg o: ClientRegistrationApiRequestEncryptionAlg.values()) {
