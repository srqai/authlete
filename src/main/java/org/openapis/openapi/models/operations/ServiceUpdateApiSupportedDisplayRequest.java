 ...
 */
public enum ServiceUpdateApiSupportedDisplayRequest {
    PAGE("PAGE"),
    POPUP("POPUP"),
    TOUCH("TOUCH"),
    WAP("WAP");
    ...
    ServiceUpdateApiSupportedDisplayRequest(String value) {
        this.value = value;
    }
    ...
    public static Optional<ServiceUpdateApiSupportedDisplayRequest> fromValue(String value) {
        for (ServiceUpdateApiSupportedDisplayRequest o: ServiceUpdateApiSupportedDisplayRequest.values()) {
