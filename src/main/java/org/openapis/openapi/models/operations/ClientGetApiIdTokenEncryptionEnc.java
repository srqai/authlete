 ...
 */
public enum ClientGetApiIdTokenEncryptionEnc {
    ...
    ClientGetApiIdTokenEncryptionEnc(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientGetApiIdTokenEncryptionEnc> fromValue(String value) {
        for (ClientGetApiIdTokenEncryptionEnc o: ClientGetApiIdTokenEncryptionEnc.values()) {
