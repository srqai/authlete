 ...
 */
public enum ClientRegistrationUpdateApiTokenAuthSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientRegistrationUpdateApiTokenAuthSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationUpdateApiTokenAuthSignAlg> fromValue(String value) {
        for (ClientRegistrationUpdateApiTokenAuthSignAlg o: ClientRegistrationUpdateApiTokenAuthSignAlg.values()) {
