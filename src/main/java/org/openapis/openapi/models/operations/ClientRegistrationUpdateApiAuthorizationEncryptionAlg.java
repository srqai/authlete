 ...
 */
public enum ClientRegistrationUpdateApiAuthorizationEncryptionAlg {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientRegistrationUpdateApiAuthorizationEncryptionAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationUpdateApiAuthorizationEncryptionAlg> fromValue(String value) {
        for (ClientRegistrationUpdateApiAuthorizationEncryptionAlg o: ClientRegistrationUpdateApiAuthorizationEncryptionAlg.values()) {
