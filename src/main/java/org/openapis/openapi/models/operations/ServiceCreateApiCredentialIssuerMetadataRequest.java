...
public class ServiceCreateApiCredentialIssuerMetadataRequest {
    /**
    ...
    @JsonCreator
    public ServiceCreateApiCredentialIssuerMetadataRequest(
     ...
     * The identifier of a credential request.
     */
    public ServiceCreateApiCredentialIssuerMetadataRequest withCredentialIssuer(@Nullable String credentialIssuer) {
        this.credentialIssuer = credentialIssuer;
        return this;
    }
     ...
     * relies on for authorization.
     */
    public ServiceCreateApiCredentialIssuerMetadataRequest withAuthorizationServer(@Nullable String authorizationServer) {
        this.authorizationServer = authorizationServer;
        return this;
    }
     ...
     * The URL of the credential endpoint of the credential issuer.
     */
    public ServiceCreateApiCredentialIssuerMetadataRequest withCredentialEndpoint(@Nullable Boolean credentialEndpoint) {
        this.credentialEndpoint = credentialEndpoint;
        return this;
    }
     ...
     * The URL of the batch credential endpoint of the credential issuer.
     */
    public ServiceCreateApiCredentialIssuerMetadataRequest withBatchCredentialEndpoint(@Nullable Long batchCredentialEndpoint) {
        this.batchCredentialEndpoint = batchCredentialEndpoint;
        return this;
    }
     ...
     * The URL of the deferred credential endpoint of the credential issuer.
     */
    public ServiceCreateApiCredentialIssuerMetadataRequest withDeferredCredentialEndpoint(@Nullable String deferredCredentialEndpoint) {
        this.deferredCredentialEndpoint = deferredCredentialEndpoint;
        return this;
    }
     ...
     * A JSON array describing supported credentials.
     */
    public ServiceCreateApiCredentialIssuerMetadataRequest withCredentialsSupported(@Nullable Boolean credentialsSupported) {
        this.credentialsSupported = credentialsSupported;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ServiceCreateApiCredentialIssuerMetadataRequest other = (ServiceCreateApiCredentialIssuerMetadataRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ServiceCreateApiCredentialIssuerMetadataRequest.class,
    ...
    public final static class Builder {
        ...
        public ServiceCreateApiCredentialIssuerMetadataRequest build() {
            return new ServiceCreateApiCredentialIssuerMetadataRequest(
                credentialIssuer, authorizationServer, credentialEndpoint,
                batchCredentialEndpoint, deferredCredentialEndpoint, credentialsSupported);
        }
