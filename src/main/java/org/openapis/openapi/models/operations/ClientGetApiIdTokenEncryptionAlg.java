 ...
 */
public enum ClientGetApiIdTokenEncryptionAlg {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientGetApiIdTokenEncryptionAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientGetApiIdTokenEncryptionAlg> fromValue(String value) {
        for (ClientGetApiIdTokenEncryptionAlg o: ClientGetApiIdTokenEncryptionAlg.values()) {
