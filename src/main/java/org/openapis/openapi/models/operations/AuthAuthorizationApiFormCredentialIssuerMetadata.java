...
public class AuthAuthorizationApiFormCredentialIssuerMetadata {
    /**
    ...
    @JsonCreator
    public AuthAuthorizationApiFormCredentialIssuerMetadata(
     ...
     * The identifier of a credential request.
     */
    public AuthAuthorizationApiFormCredentialIssuerMetadata withCredentialIssuer(@Nullable String credentialIssuer) {
        this.credentialIssuer = credentialIssuer;
        return this;
    }
     ...
     * relies on for authorization.
     */
    public AuthAuthorizationApiFormCredentialIssuerMetadata withAuthorizationServer(@Nullable String authorizationServer) {
        this.authorizationServer = authorizationServer;
        return this;
    }
     ...
     * The URL of the credential endpoint of the credential issuer.
     */
    public AuthAuthorizationApiFormCredentialIssuerMetadata withCredentialEndpoint(@Nullable Boolean credentialEndpoint) {
        this.credentialEndpoint = credentialEndpoint;
        return this;
    }
     ...
     * The URL of the batch credential endpoint of the credential issuer.
     */
    public AuthAuthorizationApiFormCredentialIssuerMetadata withBatchCredentialEndpoint(@Nullable Long batchCredentialEndpoint) {
        this.batchCredentialEndpoint = batchCredentialEndpoint;
        return this;
    }
     ...
     * The URL of the deferred credential endpoint of the credential issuer.
     */
    public AuthAuthorizationApiFormCredentialIssuerMetadata withDeferredCredentialEndpoint(@Nullable String deferredCredentialEndpoint) {
        this.deferredCredentialEndpoint = deferredCredentialEndpoint;
        return this;
    }
     ...
     * A JSON array describing supported credentials.
     */
    public AuthAuthorizationApiFormCredentialIssuerMetadata withCredentialsSupported(@Nullable Boolean credentialsSupported) {
        this.credentialsSupported = credentialsSupported;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AuthAuthorizationApiFormCredentialIssuerMetadata other = (AuthAuthorizationApiFormCredentialIssuerMetadata) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AuthAuthorizationApiFormCredentialIssuerMetadata.class,
    ...
    public final static class Builder {
        ...
        public AuthAuthorizationApiFormCredentialIssuerMetadata build() {
            return new AuthAuthorizationApiFormCredentialIssuerMetadata(
                credentialIssuer, authorizationServer, credentialEndpoint,
                batchCredentialEndpoint, deferredCredentialEndpoint, credentialsSupported);
        }
