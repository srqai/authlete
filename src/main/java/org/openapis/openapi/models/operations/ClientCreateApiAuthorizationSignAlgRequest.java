 ...
 */
public enum ClientCreateApiAuthorizationSignAlgRequest {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientCreateApiAuthorizationSignAlgRequest(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientCreateApiAuthorizationSignAlgRequest> fromValue(String value) {
        for (ClientCreateApiAuthorizationSignAlgRequest o: ClientCreateApiAuthorizationSignAlgRequest.values()) {
