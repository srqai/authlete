 ...
 */
public enum ClientCreateApiUserInfoSignAlgResponse {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientCreateApiUserInfoSignAlgResponse(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientCreateApiUserInfoSignAlgResponse> fromValue(String value) {
        for (ClientCreateApiUserInfoSignAlgResponse o: ClientCreateApiUserInfoSignAlgResponse.values()) {
