...
public class AuthRevocationApiResponseBody {
    /**
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("action")
    private AuthRevocationApiAction action;
     ...
     * The next action that the authorization server implementation should take.
     */
    public Optional<AuthRevocationApiAction> action() {
     ...
     * The code which represents the result of the API call.
     */
    public AuthRevocationApiResponseBody withResultCode(@Nullable String resultCode) {
        this.resultCode = resultCode;
        return this;
    }
     ...
     * A short message which explains the result of the API call.
     */
    public AuthRevocationApiResponseBody withResultMessage(@Nullable String resultMessage) {
        this.resultMessage = resultMessage;
        return this;
    }
     ...
     * The next action that the authorization server implementation should take.
     */
    public AuthRevocationApiResponseBody withAction(@Nullable AuthRevocationApiAction action) {
        this.action = action;
        return this;
    }
     ...
     * Its format varies depending on the value of `action` parameter.
     */
    public AuthRevocationApiResponseBody withResponseContent(@Nullable String responseContent) {
        this.responseContent = responseContent;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AuthRevocationApiResponseBody other = (AuthRevocationApiResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AuthRevocationApiResponseBody.class,
    ...
    public final static class Builder {
         ...
         * The next action that the authorization server implementation should take.
         */
        public Builder action(@Nullable AuthRevocationApiAction action) {
            this.action = action;
            return this;
        }
        ...
        public AuthRevocationApiResponseBody build() {
            return new AuthRevocationApiResponseBody(
                resultCode, resultMessage, action,
                responseContent);
        }
