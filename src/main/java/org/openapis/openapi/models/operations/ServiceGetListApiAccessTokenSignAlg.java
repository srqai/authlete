 ...
 */
public enum ServiceGetListApiAccessTokenSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ServiceGetListApiAccessTokenSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ServiceGetListApiAccessTokenSignAlg> fromValue(String value) {
        for (ServiceGetListApiAccessTokenSignAlg o: ServiceGetListApiAccessTokenSignAlg.values()) {
