 ...
 */
public enum ClientRegistrationApiIdTokenEncryptionEnc {
    ...
    ClientRegistrationApiIdTokenEncryptionEnc(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationApiIdTokenEncryptionEnc> fromValue(String value) {
        for (ClientRegistrationApiIdTokenEncryptionEnc o: ClientRegistrationApiIdTokenEncryptionEnc.values()) {
