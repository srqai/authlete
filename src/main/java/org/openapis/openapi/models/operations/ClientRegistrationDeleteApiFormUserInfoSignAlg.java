 ...
 */
public enum ClientRegistrationDeleteApiFormUserInfoSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientRegistrationDeleteApiFormUserInfoSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationDeleteApiFormUserInfoSignAlg> fromValue(String value) {
        for (ClientRegistrationDeleteApiFormUserInfoSignAlg o: ClientRegistrationDeleteApiFormUserInfoSignAlg.values()) {
