 ...
 */
public enum ClientRegistrationDeleteApiFormAuthorizationEncryptionAlg {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientRegistrationDeleteApiFormAuthorizationEncryptionAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationDeleteApiFormAuthorizationEncryptionAlg> fromValue(String value) {
        for (ClientRegistrationDeleteApiFormAuthorizationEncryptionAlg o: ClientRegistrationDeleteApiFormAuthorizationEncryptionAlg.values()) {
