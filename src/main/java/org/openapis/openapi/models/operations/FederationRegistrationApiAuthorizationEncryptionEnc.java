 ...
 */
public enum FederationRegistrationApiAuthorizationEncryptionEnc {
    ...
    FederationRegistrationApiAuthorizationEncryptionEnc(String value) {
        this.value = value;
    }
    ...
    public static Optional<FederationRegistrationApiAuthorizationEncryptionEnc> fromValue(String value) {
        for (FederationRegistrationApiAuthorizationEncryptionEnc o: FederationRegistrationApiAuthorizationEncryptionEnc.values()) {
