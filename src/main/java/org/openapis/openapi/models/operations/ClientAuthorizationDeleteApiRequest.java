...
public class ClientAuthorizationDeleteApiRequest {
     ...
     * A service ID.
     */
    public ClientAuthorizationDeleteApiRequest withServiceId(@Nonnull String serviceId) {
     ...
     * A client ID.
     */
    public ClientAuthorizationDeleteApiRequest withClientId(@Nonnull String clientId) {
