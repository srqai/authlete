...
public class ServiceUpdateApiCredentialIssuerMetadataRequest {
    /**
    ...
    @JsonCreator
    public ServiceUpdateApiCredentialIssuerMetadataRequest(
     ...
     * The identifier of a credential request.
     */
    public ServiceUpdateApiCredentialIssuerMetadataRequest withCredentialIssuer(@Nullable String credentialIssuer) {
        this.credentialIssuer = credentialIssuer;
        return this;
    }
     ...
     * relies on for authorization.
     */
    public ServiceUpdateApiCredentialIssuerMetadataRequest withAuthorizationServer(@Nullable String authorizationServer) {
        this.authorizationServer = authorizationServer;
        return this;
    }
     ...
     * The URL of the credential endpoint of the credential issuer.
     */
    public ServiceUpdateApiCredentialIssuerMetadataRequest withCredentialEndpoint(@Nullable Boolean credentialEndpoint) {
        this.credentialEndpoint = credentialEndpoint;
        return this;
    }
     ...
     * The URL of the batch credential endpoint of the credential issuer.
     */
    public ServiceUpdateApiCredentialIssuerMetadataRequest withBatchCredentialEndpoint(@Nullable Long batchCredentialEndpoint) {
        this.batchCredentialEndpoint = batchCredentialEndpoint;
        return this;
    }
     ...
     * The URL of the deferred credential endpoint of the credential issuer.
     */
    public ServiceUpdateApiCredentialIssuerMetadataRequest withDeferredCredentialEndpoint(@Nullable String deferredCredentialEndpoint) {
        this.deferredCredentialEndpoint = deferredCredentialEndpoint;
        return this;
    }
     ...
     * A JSON array describing supported credentials.
     */
    public ServiceUpdateApiCredentialIssuerMetadataRequest withCredentialsSupported(@Nullable Boolean credentialsSupported) {
        this.credentialsSupported = credentialsSupported;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ServiceUpdateApiCredentialIssuerMetadataRequest other = (ServiceUpdateApiCredentialIssuerMetadataRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ServiceUpdateApiCredentialIssuerMetadataRequest.class,
    ...
    public final static class Builder {
        ...
        public ServiceUpdateApiCredentialIssuerMetadataRequest build() {
            return new ServiceUpdateApiCredentialIssuerMetadataRequest(
                credentialIssuer, authorizationServer, credentialEndpoint,
                batchCredentialEndpoint, deferredCredentialEndpoint, credentialsSupported);
        }
