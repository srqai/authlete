 ...
 */
public enum ClientRegistrationApiFormUserInfoEncryptionEnc {
    ...
    ClientRegistrationApiFormUserInfoEncryptionEnc(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationApiFormUserInfoEncryptionEnc> fromValue(String value) {
        for (ClientRegistrationApiFormUserInfoEncryptionEnc o: ClientRegistrationApiFormUserInfoEncryptionEnc.values()) {
