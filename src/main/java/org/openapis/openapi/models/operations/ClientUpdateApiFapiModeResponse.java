...
public enum ClientUpdateApiFapiModeResponse {
    ...
    ClientUpdateApiFapiModeResponse(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientUpdateApiFapiModeResponse> fromValue(String value) {
        for (ClientUpdateApiFapiModeResponse o: ClientUpdateApiFapiModeResponse.values()) {
