 ...
 */
public enum ClientCreateApiRequestEncryptionAlgResponse {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientCreateApiRequestEncryptionAlgResponse(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientCreateApiRequestEncryptionAlgResponse> fromValue(String value) {
        for (ClientCreateApiRequestEncryptionAlgResponse o: ClientCreateApiRequestEncryptionAlgResponse.values()) {
