 ...
 */
public class VciDeferredParseApiInfo {
    /**
    ...
    @JsonCreator
    public VciDeferredParseApiInfo(
     ...
     * The identifier of the credential offer.
     */
    public VciDeferredParseApiInfo withIdentifier(@Nullable String identifier) {
        this.identifier = identifier;
        return this;
    }
     ...
     * The value of the format parameter in the credential request.
     */
    public VciDeferredParseApiInfo withFormat(@Nullable String format) {
        this.format = format;
        return this;
    }
     ...
     * The binding key specified by the proof in the credential request.
     */
    public VciDeferredParseApiInfo withBindingKey(@Nullable String bindingKey) {
        this.bindingKey = bindingKey;
        return this;
    }
     ...
     * The details about the credential request.
     */
    public VciDeferredParseApiInfo withDetails(@Nullable String details) {
        this.details = details;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        VciDeferredParseApiInfo other = (VciDeferredParseApiInfo) o;
        return 
    ...
    public String toString() {
        return Utils.toString(VciDeferredParseApiInfo.class,
    ...
    public final static class Builder {
        ...
        public VciDeferredParseApiInfo build() {
            return new VciDeferredParseApiInfo(
                identifier, format, bindingKey,
                details);
        }
