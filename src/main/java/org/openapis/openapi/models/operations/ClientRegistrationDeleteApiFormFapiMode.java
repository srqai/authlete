...
public enum ClientRegistrationDeleteApiFormFapiMode {
    ...
    ClientRegistrationDeleteApiFormFapiMode(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationDeleteApiFormFapiMode> fromValue(String value) {
        for (ClientRegistrationDeleteApiFormFapiMode o: ClientRegistrationDeleteApiFormFapiMode.values()) {
