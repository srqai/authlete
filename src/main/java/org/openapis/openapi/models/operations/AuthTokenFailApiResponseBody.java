...
public class AuthTokenFailApiResponseBody {
    /**
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("action")
    private AuthTokenFailApiAction action;
     ...
     * The next action that the authorization server implementation should take.
     */
    public Optional<AuthTokenFailApiAction> action() {
     ...
     * The code which represents the result of the API call.
     */
    public AuthTokenFailApiResponseBody withResultCode(@Nullable String resultCode) {
        this.resultCode = resultCode;
        return this;
    }
     ...
     * A short message which explains the result of the API call.
     */
    public AuthTokenFailApiResponseBody withResultMessage(@Nullable String resultMessage) {
        this.resultMessage = resultMessage;
        return this;
    }
     ...
     * The next action that the authorization server implementation should take.
     */
    public AuthTokenFailApiResponseBody withAction(@Nullable AuthTokenFailApiAction action) {
        this.action = action;
        return this;
    }
     ...
     * Its format varies depending on the value of `action` parameter. See description for details.
     */
    public AuthTokenFailApiResponseBody withResponseContent(@Nullable String responseContent) {
        this.responseContent = responseContent;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AuthTokenFailApiResponseBody other = (AuthTokenFailApiResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AuthTokenFailApiResponseBody.class,
    ...
    public final static class Builder {
         ...
         * The next action that the authorization server implementation should take.
         */
        public Builder action(@Nullable AuthTokenFailApiAction action) {
            this.action = action;
            return this;
        }
        ...
        public AuthTokenFailApiResponseBody build() {
            return new AuthTokenFailApiResponseBody(
                resultCode, resultMessage, action,
                responseContent);
        }
