 ...
 */
public enum ClientUpdateApiIdTokenEncryptionAlgRequest {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientUpdateApiIdTokenEncryptionAlgRequest(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientUpdateApiIdTokenEncryptionAlgRequest> fromValue(String value) {
        for (ClientUpdateApiIdTokenEncryptionAlgRequest o: ClientUpdateApiIdTokenEncryptionAlgRequest.values()) {
