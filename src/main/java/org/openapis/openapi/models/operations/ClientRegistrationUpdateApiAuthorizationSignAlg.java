 ...
 */
public enum ClientRegistrationUpdateApiAuthorizationSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientRegistrationUpdateApiAuthorizationSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationUpdateApiAuthorizationSignAlg> fromValue(String value) {
        for (ClientRegistrationUpdateApiAuthorizationSignAlg o: ClientRegistrationUpdateApiAuthorizationSignAlg.values()) {
