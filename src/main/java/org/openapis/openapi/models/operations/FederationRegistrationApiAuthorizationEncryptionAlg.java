 ...
 */
public enum FederationRegistrationApiAuthorizationEncryptionAlg {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    FederationRegistrationApiAuthorizationEncryptionAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<FederationRegistrationApiAuthorizationEncryptionAlg> fromValue(String value) {
        for (FederationRegistrationApiAuthorizationEncryptionAlg o: FederationRegistrationApiAuthorizationEncryptionAlg.values()) {
