 ...
 */
public enum ClientCreateApiIdTokenSignAlgResponse {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientCreateApiIdTokenSignAlgResponse(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientCreateApiIdTokenSignAlgResponse> fromValue(String value) {
        for (ClientCreateApiIdTokenSignAlgResponse o: ClientCreateApiIdTokenSignAlgResponse.values()) {
