...
public class ClientRegistrationDeleteApiClient {
    /**
    ...
    private List<ClientRegistrationDeleteApiClientName> clientNames;
    ...
    private List<ClientRegistrationDeleteApiDescription> descriptions;
    ...
    private ClientRegistrationDeleteApiClientType clientType;
    ...
    private ClientRegistrationDeleteApiApplicationType applicationType;
    ...
    private List<ClientRegistrationDeleteApiLogoUris> logoUris;
    ...
    private List<ClientRegistrationDeleteApiGrantType> grantTypes;
    ...
    private List<ClientRegistrationDeleteApiResponseType> responseTypes;
    ...
    private ClientRegistrationDeleteApiAuthorizationSignAlg authorizationSignAlg;
    ...
    private ClientRegistrationDeleteApiAuthorizationEncryptionAlg authorizationEncryptionAlg;
    ...
    private ClientRegistrationDeleteApiAuthorizationEncryptionEnc authorizationEncryptionEnc;
    ...
    private ClientRegistrationDeleteApiTokenAuthMethod tokenAuthMethod;
    ...
    private ClientRegistrationDeleteApiTokenAuthSignAlg tokenAuthSignAlg;
    ...
    private ClientRegistrationDeleteApiRequestSignAlg requestSignAlg;
    ...
    private ClientRegistrationDeleteApiRequestEncryptionAlg requestEncryptionAlg;
    ...
    private ClientRegistrationDeleteApiRequestEncryptionEnc requestEncryptionEnc;
    ...
    private ClientRegistrationDeleteApiIdTokenSignAlg idTokenSignAlg;
    ...
    private ClientRegistrationDeleteApiIdTokenEncryptionAlg idTokenEncryptionAlg;
    ...
    private ClientRegistrationDeleteApiIdTokenEncryptionEnc idTokenEncryptionEnc;
    ...
    private ClientRegistrationDeleteApiSubjectType subjectType;
    ...
    private ClientRegistrationDeleteApiUserInfoSignAlg userInfoSignAlg;
    ...
    private ClientRegistrationDeleteApiUserInfoEncryptionAlg userInfoEncryptionAlg;
    ...
    private ClientRegistrationDeleteApiUserInfoEncryptionEnc userInfoEncryptionEnc;
    ...
    private List<ClientRegistrationDeleteApiTosUris> tosUris;
    ...
    private List<ClientRegistrationDeleteApiPolicyUris> policyUris;
    ...
    private List<ClientRegistrationDeleteApiClientUris> clientUris;
    ...
    private ClientRegistrationDeleteApiBcRequestSignAlg bcRequestSignAlg;
    ...
    private List<ClientRegistrationDeleteApiAttribute> attributes;


    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("extension")
    private ClientRegistrationDeleteApiExtension extension;
    ...
    private List<ClientRegistrationDeleteApiClientRegistrationType> clientRegistrationTypes;
    ...
    private List<ClientRegistrationDeleteApiFapiMode> fapiModes;
    ...
    private List<ClientRegistrationDeleteApiResponseMode> responseModes;
    ...
    @JsonCreator
    public ClientRegistrationDeleteApiClient(
            ...
            @JsonProperty("clientNames") @Nullable List<ClientRegistrationDeleteApiClientName> clientNames,
            @JsonProperty("description") @Nullable String description,
            @JsonProperty("descriptions") @Nullable List<ClientRegistrationDeleteApiDescription> descriptions,
            ...
            @JsonProperty("clientType") @Nullable ClientRegistrationDeleteApiClientType clientType,
            @JsonProperty("applicationType") @Nullable ClientRegistrationDeleteApiApplicationType applicationType,
            @JsonProperty("logoUri") @Nullable String logoUri,
            @JsonProperty("logoUris") @Nullable List<ClientRegistrationDeleteApiLogoUris> logoUris,
            ...
            @JsonProperty("grantTypes") @Nullable List<ClientRegistrationDeleteApiGrantType> grantTypes,
            @JsonProperty("responseTypes") @Nullable List<ClientRegistrationDeleteApiResponseType> responseTypes,
            @JsonProperty("redirectUris") @Nullable List<String> redirectUris,
            @JsonProperty("authorizationSignAlg") @Nullable ClientRegistrationDeleteApiAuthorizationSignAlg authorizationSignAlg,
            @JsonProperty("authorizationEncryptionAlg") @Nullable ClientRegistrationDeleteApiAuthorizationEncryptionAlg authorizationEncryptionAlg,
            @JsonProperty("authorizationEncryptionEnc") @Nullable ClientRegistrationDeleteApiAuthorizationEncryptionEnc authorizationEncryptionEnc,
            @JsonProperty("tokenAuthMethod") @Nullable ClientRegistrationDeleteApiTokenAuthMethod tokenAuthMethod,
            @JsonProperty("tokenAuthSignAlg") @Nullable ClientRegistrationDeleteApiTokenAuthSignAlg tokenAuthSignAlg,
            ...
            @JsonProperty("requestSignAlg") @Nullable ClientRegistrationDeleteApiRequestSignAlg requestSignAlg,
            @JsonProperty("requestEncryptionAlg") @Nullable ClientRegistrationDeleteApiRequestEncryptionAlg requestEncryptionAlg,
            @JsonProperty("requestEncryptionEnc") @Nullable ClientRegistrationDeleteApiRequestEncryptionEnc requestEncryptionEnc,
            ...
            @JsonProperty("idTokenSignAlg") @Nullable ClientRegistrationDeleteApiIdTokenSignAlg idTokenSignAlg,
            @JsonProperty("idTokenEncryptionAlg") @Nullable ClientRegistrationDeleteApiIdTokenEncryptionAlg idTokenEncryptionAlg,
            @JsonProperty("idTokenEncryptionEnc") @Nullable ClientRegistrationDeleteApiIdTokenEncryptionEnc idTokenEncryptionEnc,
            @JsonProperty("authTimeRequired") @Nullable Boolean authTimeRequired,
            @JsonProperty("subjectType") @Nullable ClientRegistrationDeleteApiSubjectType subjectType,
            ...
            @JsonProperty("userInfoSignAlg") @Nullable ClientRegistrationDeleteApiUserInfoSignAlg userInfoSignAlg,
            @JsonProperty("userInfoEncryptionAlg") @Nullable ClientRegistrationDeleteApiUserInfoEncryptionAlg userInfoEncryptionAlg,
            @JsonProperty("userInfoEncryptionEnc") @Nullable ClientRegistrationDeleteApiUserInfoEncryptionEnc userInfoEncryptionEnc,
            @JsonProperty("loginUri") @Nullable String loginUri,
            @JsonProperty("tosUri") @Nullable String tosUri,
            @JsonProperty("tosUris") @Nullable List<ClientRegistrationDeleteApiTosUris> tosUris,
            @JsonProperty("policyUri") @Nullable String policyUri,
            @JsonProperty("policyUris") @Nullable List<ClientRegistrationDeleteApiPolicyUris> policyUris,
            @JsonProperty("clientUri") @Nullable String clientUri,
            @JsonProperty("clientUris") @Nullable List<ClientRegistrationDeleteApiClientUris> clientUris,
            ...
            @JsonProperty("bcRequestSignAlg") @Nullable ClientRegistrationDeleteApiBcRequestSignAlg bcRequestSignAlg,
            @JsonProperty("bcUserCodeRequired") @Nullable Boolean bcUserCodeRequired,
            @JsonProperty("attributes") @Nullable List<ClientRegistrationDeleteApiAttribute> attributes,
            @JsonProperty("extension") @Nullable ClientRegistrationDeleteApiExtension extension,
            ...
            @JsonProperty("clientRegistrationTypes") @Nullable List<ClientRegistrationDeleteApiClientRegistrationType> clientRegistrationTypes,
            ...
            @JsonProperty("fapiModes") @Nullable List<ClientRegistrationDeleteApiFapiMode> fapiModes,
            @JsonProperty("responseModes") @Nullable List<ClientRegistrationDeleteApiResponseMode> responseModes,
     ...
     * languages, this property can be used to register the names.
     */
    public Optional<List<ClientRegistrationDeleteApiClientName>> clientNames() {
     ...
     * descriptions for different languages, this property can be used to register the descriptions.
     */
    public Optional<List<ClientRegistrationDeleteApiDescription>> descriptions() {
     ...
     * for details.
     */
    public Optional<ClientRegistrationDeleteApiClientType> clientType() {
     ...
     * See the description about `redirectUris` property for more details.
     */
    public Optional<ClientRegistrationDeleteApiApplicationType> applicationType() {
     ...
     * different languages, this property can be used to register URLs of the images.
     */
    public Optional<List<ClientRegistrationDeleteApiLogoUris>> logoUris() {
     ...
     * 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public Optional<List<ClientRegistrationDeleteApiGrantType>> grantTypes() {
     ...
     * 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public Optional<List<ClientRegistrationDeleteApiResponseType>> responseTypes() {
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public Optional<ClientRegistrationDeleteApiAuthorizationSignAlg> authorizationSignAlg() {
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public Optional<ClientRegistrationDeleteApiAuthorizationEncryptionAlg> authorizationEncryptionAlg() {
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public Optional<ClientRegistrationDeleteApiAuthorizationEncryptionEnc> authorizationEncryptionEnc() {
     ...
     * Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public Optional<ClientRegistrationDeleteApiTokenAuthMethod> tokenAuthMethod() {
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public Optional<ClientRegistrationDeleteApiTokenAuthSignAlg> tokenAuthSignAlg() {
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public Optional<ClientRegistrationDeleteApiRequestSignAlg> requestSignAlg() {
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public Optional<ClientRegistrationDeleteApiRequestEncryptionAlg> requestEncryptionAlg() {
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public Optional<ClientRegistrationDeleteApiRequestEncryptionEnc> requestEncryptionEnc() {
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public Optional<ClientRegistrationDeleteApiIdTokenSignAlg> idTokenSignAlg() {
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public Optional<ClientRegistrationDeleteApiIdTokenEncryptionAlg> idTokenEncryptionAlg() {
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public Optional<ClientRegistrationDeleteApiIdTokenEncryptionEnc> idTokenEncryptionEnc() {
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public Optional<ClientRegistrationDeleteApiSubjectType> subjectType() {
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public Optional<ClientRegistrationDeleteApiUserInfoSignAlg> userInfoSignAlg() {
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public Optional<ClientRegistrationDeleteApiUserInfoEncryptionAlg> userInfoEncryptionAlg() {
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public Optional<ClientRegistrationDeleteApiUserInfoEncryptionEnc> userInfoEncryptionEnc() {
     ...
     * this property can be used to register the URLs.
     */
    public Optional<List<ClientRegistrationDeleteApiTosUris>> tosUris() {
     ...
     * If the client application has different policy pages for different languages, this property can be used to register the URLs.
     */
    public Optional<List<ClientRegistrationDeleteApiPolicyUris>> policyUris() {
     ...
     * be used to register the URLs.
     */
    public Optional<List<ClientRegistrationDeleteApiClientUris>> clientUris() {
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public Optional<ClientRegistrationDeleteApiBcRequestSignAlg> bcRequestSignAlg() {
     ...
     * The attributes of this client.
     */
    public Optional<List<ClientRegistrationDeleteApiAttribute>> attributes() {
        return Optional.ofNullable(this.attributes);
    }

    public Optional<ClientRegistrationDeleteApiExtension> extension() {
     ...
     * The client registration types that the client has declared it may use.
     */
    public Optional<List<ClientRegistrationDeleteApiClientRegistrationType>> clientRegistrationTypes() {
     ...
     * the service, and the FAPI modes for the service are set to `null`.
     */
    public Optional<List<ClientRegistrationDeleteApiFapiMode>> fapiModes() {
     ...
     * The response modes that this client may use.
     */
    public Optional<List<ClientRegistrationDeleteApiResponseMode>> responseModes() {
     ...
     * The sequential number of the client. The value of this property is assigned by Authlete.
     */
    public ClientRegistrationDeleteApiClient withNumber(@Nullable Integer number) {
        this.number = number;
        return this;
    }
     ...
     * assigned by Authlete.
     */
    public ClientRegistrationDeleteApiClient withServiceNumber(@Nullable Integer serviceNumber) {
        this.serviceNumber = serviceNumber;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientRegistrationDeleteApiClient withClientName(@Nullable String clientName) {
        this.clientName = clientName;
        return this;
    }
     ...
     * languages, this property can be used to register the names.
     */
    public ClientRegistrationDeleteApiClient withClientNames(@Nullable List<ClientRegistrationDeleteApiClientName> clientNames) {
        this.clientNames = clientNames;
        return this;
    }
     ...
     * The description about the client application.
     */
    public ClientRegistrationDeleteApiClient withDescription(@Nullable String description) {
        this.description = description;
        return this;
    }
     ...
     * descriptions for different languages, this property can be used to register the descriptions.
     */
    public ClientRegistrationDeleteApiClient withDescriptions(@Nullable List<ClientRegistrationDeleteApiDescription> descriptions) {
        this.descriptions = descriptions;
        return this;
    }
     ...
     * The client identifier used in Authlete API calls. The value of this property is assigned by Authlete.
     */
    public ClientRegistrationDeleteApiClient withClientId(@Nullable Long clientId) {
        this.clientId = clientId;
        return this;
    }
     ...
     * authorization server as described in Section 2.3 when making requests to the token endpoint.
     */
    public ClientRegistrationDeleteApiClient withClientSecret(@Nullable String clientSecret) {
        this.clientSecret = clientSecret;
        return this;
    }
     ...
     * default, this is a string version of the `clientId` property.
     */
    public ClientRegistrationDeleteApiClient withClientIdAlias(@Nullable String clientIdAlias) {
        this.clientIdAlias = clientIdAlias;
        return this;
    }
     ...
     * Deprecated. Always set to `true`.
     */
    public ClientRegistrationDeleteApiClient withClientIdAliasEnabled(@Nullable Boolean clientIdAliasEnabled) {
        this.clientIdAliasEnabled = clientIdAliasEnabled;
        return this;
    }
     ...
     * for details.
     */
    public ClientRegistrationDeleteApiClient withClientType(@Nullable ClientRegistrationDeleteApiClientType clientType) {
        this.clientType = clientType;
        return this;
    }
     ...
     * See the description about `redirectUris` property for more details.
     */
    public ClientRegistrationDeleteApiClient withApplicationType(@Nullable ClientRegistrationDeleteApiApplicationType applicationType) {
        this.applicationType = applicationType;
        return this;
    }
     ...
     * Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientRegistrationDeleteApiClient withLogoUri(@Nullable String logoUri) {
        this.logoUri = logoUri;
        return this;
    }
     ...
     * different languages, this property can be used to register URLs of the images.
     */
    public ClientRegistrationDeleteApiClient withLogoUris(@Nullable List<ClientRegistrationDeleteApiLogoUris> logoUris) {
        this.logoUris = logoUris;
        return this;
    }
     ...
     * Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientRegistrationDeleteApiClient withContacts(@Nullable List<String> contacts) {
        this.contacts = contacts;
        return this;
    }
     ...
     * The flag to indicate whether this client use TLS client certificate bound access tokens.
     */
    public ClientRegistrationDeleteApiClient withTlsClientCertificateBoundAccessTokens(@Nullable Boolean tlsClientCertificateBoundAccessTokens) {
        this.tlsClientCertificateBoundAccessTokens = tlsClientCertificateBoundAccessTokens;
        return this;
    }
     ...
     * For more details, see [RFC 7591](https://datatracker.ietf.org/doc/html/rfc7591).
     */
    public ClientRegistrationDeleteApiClient withDynamicallyRegistered(@Nullable Boolean dynamicallyRegistered) {
        this.dynamicallyRegistered = dynamicallyRegistered;
        return this;
    }
     ...
     * of [RFC 7591](https://datatracker.ietf.org/doc/html/rfc7591).
     */
    public ClientRegistrationDeleteApiClient withSoftwareId(@Nullable String softwareId) {
        this.softwareId = softwareId;
        return this;
    }
     ...
     * of [RFC 7591](https://datatracker.ietf.org/doc/html/rfc7591).
     */
    public ClientRegistrationDeleteApiClient withSoftwareVersion(@Nullable String softwareVersion) {
        this.softwareVersion = softwareVersion;
        return this;
    }
     ...
     * The hash of the registration access token for this client.
     */
    public ClientRegistrationDeleteApiClient withRegistrationAccessTokenHash(@Nullable String registrationAccessTokenHash) {
        this.registrationAccessTokenHash = registrationAccessTokenHash;
        return this;
    }
     ...
     * The time at which this client was created. The value is represented as milliseconds since the UNIX epoch (1970-01-01).
     */
    public ClientRegistrationDeleteApiClient withCreatedAt(@Nullable Long createdAt) {
        this.createdAt = createdAt;
        return this;
    }
     ...
     * The time at which this client was last modified. The value is represented as milliseconds since the UNIX epoch (1970-01-01).
     */
    public ClientRegistrationDeleteApiClient withModifiedAt(@Nullable Long modifiedAt) {
        this.modifiedAt = modifiedAt;
        return this;
    }
     ...
     * 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientRegistrationDeleteApiClient withGrantTypes(@Nullable List<ClientRegistrationDeleteApiGrantType> grantTypes) {
        this.grantTypes = grantTypes;
        return this;
    }
     ...
     * 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientRegistrationDeleteApiClient withResponseTypes(@Nullable List<ClientRegistrationDeleteApiResponseType> responseTypes) {
        this.responseTypes = responseTypes;
        return this;
    }
     ...
     * details), but OpenID Connect requires exact match.
     */
    public ClientRegistrationDeleteApiClient withRedirectUris(@Nullable List<String> redirectUris) {
        this.redirectUris = redirectUris;
        return this;
    }
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public ClientRegistrationDeleteApiClient withAuthorizationSignAlg(@Nullable ClientRegistrationDeleteApiAuthorizationSignAlg authorizationSignAlg) {
        this.authorizationSignAlg = authorizationSignAlg;
        return this;
    }
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public ClientRegistrationDeleteApiClient withAuthorizationEncryptionAlg(@Nullable ClientRegistrationDeleteApiAuthorizationEncryptionAlg authorizationEncryptionAlg) {
        this.authorizationEncryptionAlg = authorizationEncryptionAlg;
        return this;
    }
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public ClientRegistrationDeleteApiClient withAuthorizationEncryptionEnc(@Nullable ClientRegistrationDeleteApiAuthorizationEncryptionEnc authorizationEncryptionEnc) {
        this.authorizationEncryptionEnc = authorizationEncryptionEnc;
        return this;
    }
     ...
     * Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientRegistrationDeleteApiClient withTokenAuthMethod(@Nullable ClientRegistrationDeleteApiTokenAuthMethod tokenAuthMethod) {
        this.tokenAuthMethod = tokenAuthMethod;
        return this;
    }
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public ClientRegistrationDeleteApiClient withTokenAuthSignAlg(@Nullable ClientRegistrationDeleteApiTokenAuthSignAlg tokenAuthSignAlg) {
        this.tokenAuthSignAlg = tokenAuthSignAlg;
        return this;
    }
     ...
     * The key ID of a JWK containing a self-signed certificate of this client.
     */
    public ClientRegistrationDeleteApiClient withSelfSignedCertificateKeyId(@Nullable String selfSignedCertificateKeyId) {
        this.selfSignedCertificateKeyId = selfSignedCertificateKeyId;
        return this;
    }
     ...
     * Registration" for details.
     */
    public ClientRegistrationDeleteApiClient withTlsClientAuthSubjectDn(@Nullable String tlsClientAuthSubjectDn) {
        this.tlsClientAuthSubjectDn = tlsClientAuthSubjectDn;
        return this;
    }
     ...
     * Registration" for details.
     */
    public ClientRegistrationDeleteApiClient withTlsClientAuthSanDns(@Nullable String tlsClientAuthSanDns) {
        this.tlsClientAuthSanDns = tlsClientAuthSanDns;
        return this;
    }
     ...
     * Registration" for details.
     */
    public ClientRegistrationDeleteApiClient withTlsClientAuthSanUri(@Nullable String tlsClientAuthSanUri) {
        this.tlsClientAuthSanUri = tlsClientAuthSanUri;
        return this;
    }
     ...
     * Registration" for details.
     */
    public ClientRegistrationDeleteApiClient withTlsClientAuthSanIp(@Nullable String tlsClientAuthSanIp) {
        this.tlsClientAuthSanIp = tlsClientAuthSanIp;
        return this;
    }
     ...
     * Registration" for details.
     */
    public ClientRegistrationDeleteApiClient withTlsClientAuthSanEmail(@Nullable String tlsClientAuthSanEmail) {
        this.tlsClientAuthSanEmail = tlsClientAuthSanEmail;
        return this;
    }
     ...
     * in "OAuth 2.0 Pushed Authorization Requests".
     */
    public ClientRegistrationDeleteApiClient withParRequired(@Nullable Boolean parRequired) {
        this.parRequired = parRequired;
        return this;
    }
     ...
     * client metadata of this client is `true`. The metadata is defined in "JAR (JWT Secured Authorization Request)".
     */
    public ClientRegistrationDeleteApiClient withRequestObjectRequired(@Nullable Boolean requestObjectRequired) {
        this.requestObjectRequired = requestObjectRequired;
        return this;
    }
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public ClientRegistrationDeleteApiClient withRequestSignAlg(@Nullable ClientRegistrationDeleteApiRequestSignAlg requestSignAlg) {
        this.requestSignAlg = requestSignAlg;
        return this;
    }
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public ClientRegistrationDeleteApiClient withRequestEncryptionAlg(@Nullable ClientRegistrationDeleteApiRequestEncryptionAlg requestEncryptionAlg) {
        this.requestEncryptionAlg = requestEncryptionAlg;
        return this;
    }
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public ClientRegistrationDeleteApiClient withRequestEncryptionEnc(@Nullable ClientRegistrationDeleteApiRequestEncryptionEnc requestEncryptionEnc) {
        this.requestEncryptionEnc = requestEncryptionEnc;
        return this;
    }
     ...
     * See [OpenID Connect Core 1.0, 6.2. Passing a Request Object by Reference](https://openid.net/specs/openid-connect-core-1_0.html#RequestUriParameter) for details.
     */
    public ClientRegistrationDeleteApiClient withRequestUris(@Nullable List<String> requestUris) {
        this.requestUris = requestUris;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientRegistrationDeleteApiClient withDefaultMaxAge(@Nullable Integer defaultMaxAge) {
        this.defaultMaxAge = defaultMaxAge;
        return this;
    }
     ...
     * in claims request parameter.
     */
    public ClientRegistrationDeleteApiClient withDefaultAcrs(@Nullable List<String> defaultAcrs) {
        this.defaultAcrs = defaultAcrs;
        return this;
    }
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public ClientRegistrationDeleteApiClient withIdTokenSignAlg(@Nullable ClientRegistrationDeleteApiIdTokenSignAlg idTokenSignAlg) {
        this.idTokenSignAlg = idTokenSignAlg;
        return this;
    }
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public ClientRegistrationDeleteApiClient withIdTokenEncryptionAlg(@Nullable ClientRegistrationDeleteApiIdTokenEncryptionAlg idTokenEncryptionAlg) {
        this.idTokenEncryptionAlg = idTokenEncryptionAlg;
        return this;
    }
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public ClientRegistrationDeleteApiClient withIdTokenEncryptionEnc(@Nullable ClientRegistrationDeleteApiIdTokenEncryptionEnc idTokenEncryptionEnc) {
        this.idTokenEncryptionEnc = idTokenEncryptionEnc;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientRegistrationDeleteApiClient withAuthTimeRequired(@Nullable Boolean authTimeRequired) {
        this.authTimeRequired = authTimeRequired;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientRegistrationDeleteApiClient withSubjectType(@Nullable ClientRegistrationDeleteApiSubjectType subjectType) {
        this.subjectType = subjectType;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata)
     */
    public ClientRegistrationDeleteApiClient withSectorIdentifierUri(@Nullable String sectorIdentifierUri) {
        this.sectorIdentifierUri = sectorIdentifierUri;
        return this;
    }
     ...
     * are also registered, the value of this property is `null`.
     */
    public ClientRegistrationDeleteApiClient withDerivedSectorIdentifier(@Nullable String derivedSectorIdentifier) {
        this.derivedSectorIdentifier = derivedSectorIdentifier;
        return this;
    }
     ...
     * Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientRegistrationDeleteApiClient withJwksUri(@Nullable String jwksUri) {
        this.jwksUri = jwksUri;
        return this;
    }
     ...
     * Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientRegistrationDeleteApiClient withJwks(@Nullable String jwks) {
        this.jwks = jwks;
        return this;
    }
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public ClientRegistrationDeleteApiClient withUserInfoSignAlg(@Nullable ClientRegistrationDeleteApiUserInfoSignAlg userInfoSignAlg) {
        this.userInfoSignAlg = userInfoSignAlg;
        return this;
    }
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public ClientRegistrationDeleteApiClient withUserInfoEncryptionAlg(@Nullable ClientRegistrationDeleteApiUserInfoEncryptionAlg userInfoEncryptionAlg) {
        this.userInfoEncryptionAlg = userInfoEncryptionAlg;
        return this;
    }
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public ClientRegistrationDeleteApiClient withUserInfoEncryptionEnc(@Nullable ClientRegistrationDeleteApiUserInfoEncryptionEnc userInfoEncryptionEnc) {
        this.userInfoEncryptionEnc = userInfoEncryptionEnc;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientRegistrationDeleteApiClient withLoginUri(@Nullable String loginUri) {
        this.loginUri = loginUri;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientRegistrationDeleteApiClient withTosUri(@Nullable String tosUri) {
        this.tosUri = tosUri;
        return this;
    }
     ...
     * this property can be used to register the URLs.
     */
    public ClientRegistrationDeleteApiClient withTosUris(@Nullable List<ClientRegistrationDeleteApiTosUris> tosUris) {
        this.tosUris = tosUris;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientRegistrationDeleteApiClient withPolicyUri(@Nullable String policyUri) {
        this.policyUri = policyUri;
        return this;
    }
     ...
     * If the client application has different policy pages for different languages, this property can be used to register the URLs.
     */
    public ClientRegistrationDeleteApiClient withPolicyUris(@Nullable List<ClientRegistrationDeleteApiPolicyUris> policyUris) {
        this.policyUris = policyUris;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientRegistrationDeleteApiClient withClientUri(@Nullable String clientUri) {
        this.clientUri = clientUri;
        return this;
    }
     ...
     * be used to register the URLs.
     */
    public ClientRegistrationDeleteApiClient withClientUris(@Nullable List<ClientRegistrationDeleteApiClientUris> clientUris) {
        this.clientUris = clientUris;
        return this;
    }
     ...
     * Backchannel Authentication)".
     */
    public ClientRegistrationDeleteApiClient withBcDeliveryMode(@Nullable String bcDeliveryMode) {
        this.bcDeliveryMode = bcDeliveryMode;
        return this;
    }
     ...
     * Backchannel Authentication)".
     */
    public ClientRegistrationDeleteApiClient withBcNotificationEndpoint(@Nullable String bcNotificationEndpoint) {
        this.bcNotificationEndpoint = bcNotificationEndpoint;
        return this;
    }
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public ClientRegistrationDeleteApiClient withBcRequestSignAlg(@Nullable ClientRegistrationDeleteApiBcRequestSignAlg bcRequestSignAlg) {
        this.bcRequestSignAlg = bcRequestSignAlg;
        return this;
    }
     ...
     * <p>This property corresponds to the `backchannel_user_code_parameter` metadata.
     */
    public ClientRegistrationDeleteApiClient withBcUserCodeRequired(@Nullable Boolean bcUserCodeRequired) {
        this.bcUserCodeRequired = bcUserCodeRequired;
        return this;
    }
     ...
     * The attributes of this client.
     */
    public ClientRegistrationDeleteApiClient withAttributes(@Nullable List<ClientRegistrationDeleteApiAttribute> attributes) {
        this.attributes = attributes;
        return this;
    }


    public ClientRegistrationDeleteApiClient withExtension(@Nullable ClientRegistrationDeleteApiExtension extension) {
        this.extension = extension;
        return this;
    }
     ...
     * to align with the change made by the 5th draft of the RAR specification.
     */
    public ClientRegistrationDeleteApiClient withAuthorizationDetailsTypes(@Nullable List<String> authorizationDetailsTypes) {
        this.authorizationDetailsTypes = authorizationDetailsTypes;
        return this;
    }
     ...
     * custom client metadata values can be referenced by this property.
     */
    public ClientRegistrationDeleteApiClient withCustomMetadata(@Nullable String customMetadata) {
        this.customMetadata = customMetadata;
        return this;
    }
     ...
     * flag of the service is `true`.
     */
    public ClientRegistrationDeleteApiClient withFrontChannelRequestObjectEncryptionRequired(@Nullable Boolean frontChannelRequestObjectEncryptionRequired) {
        this.frontChannelRequestObjectEncryptionRequired = frontChannelRequestObjectEncryptionRequired;
        return this;
    }
     ...
     * flag of the service is `true`.
     */
    public ClientRegistrationDeleteApiClient withRequestObjectEncryptionAlgMatchRequired(@Nullable Boolean requestObjectEncryptionAlgMatchRequired) {
        this.requestObjectEncryptionAlgMatchRequired = requestObjectEncryptionAlgMatchRequired;
        return this;
    }
     ...
     * flag of the service is `true`.
     */
    public ClientRegistrationDeleteApiClient withRequestObjectEncryptionEncMatchRequired(@Nullable Boolean requestObjectEncryptionEncMatchRequired) {
        this.requestObjectEncryptionEncMatchRequired = requestObjectEncryptionEncMatchRequired;
        return this;
    }
     ...
     * [OpenID Connect for Identity Assurance 1.0](https://openid.net/specs/openid-connect-4-identity-assurance-1_0.html).
     */
    public ClientRegistrationDeleteApiClient withDigestAlgorithm(@Nullable String digestAlgorithm) {
        this.digestAlgorithm = digestAlgorithm;
        return this;
    }
     ...
     * <p>Even if `Disabled` is selected here, single access token per subject is effective if `singleAccessTokenPerSubject` of the `Service` this client belongs to is Enabled.
     */
    public ClientRegistrationDeleteApiClient withSingleAccessTokenPerSubject(@Nullable Boolean singleAccessTokenPerSubject) {
        this.singleAccessTokenPerSubject = singleAccessTokenPerSubject;
        return this;
    }
     ...
     * <p>See [RFC 7636](https://tools.ietf.org/html/rfc7636) (Proof Key for Code Exchange by OAuth Public Clients) for details about `code_challenge` request parameter.
     */
    public ClientRegistrationDeleteApiClient withPkceRequired(@Nullable Boolean pkceRequired) {
        this.pkceRequired = pkceRequired;
        return this;
    }
     ...
     * Neither omission of the `code_challenge_method` request parameter nor use of plain (`code_challenge_method=plain`) is allowed.
     */
    public ClientRegistrationDeleteApiClient withPkceS256Required(@Nullable Boolean pkceS256Required) {
        this.pkceS256Required = pkceS256Required;
        return this;
    }
     ...
     * If the DPoP is required for this client
     */
    public ClientRegistrationDeleteApiClient withDpopRequired(@Nullable Boolean dpopRequired) {
        this.dpopRequired = dpopRequired;
        return this;
    }
     ...
     * "automatic" client registration of OIDC Federation.
     */
    public ClientRegistrationDeleteApiClient withAutomaticallyRegistered(@Nullable Boolean automaticallyRegistered) {
        this.automaticallyRegistered = automaticallyRegistered;
        return this;
    }
     ...
     * "explicit" client registration of OIDC Federation.
     */
    public ClientRegistrationDeleteApiClient withExplicitlyRegistered(@Nullable Boolean explicitlyRegistered) {
        this.explicitlyRegistered = explicitlyRegistered;
        return this;
    }
     ...
     * The flag indicating whether this service signs responses from the resource server.
     */
    public ClientRegistrationDeleteApiClient withRsRequestSigned(@Nullable Boolean rsRequestSigned) {
        this.rsRequestSigned = rsRequestSigned;
        return this;
    }
     ...
     * The key ID of a JWK containing the public key used by this client to sign requests to the resource server.
     */
    public ClientRegistrationDeleteApiClient withRsSignedRequestKeyId(@Nullable String rsSignedRequestKeyId) {
        this.rsSignedRequestKeyId = rsSignedRequestKeyId;
        return this;
    }
     ...
     * The client registration types that the client has declared it may use.
     */
    public ClientRegistrationDeleteApiClient withClientRegistrationTypes(@Nullable List<ClientRegistrationDeleteApiClientRegistrationType> clientRegistrationTypes) {
        this.clientRegistrationTypes = clientRegistrationTypes;
        return this;
    }
     ...
     * to the organization_name client metadata that is defined in OpenID Connect Federation 1.0.
     */
    public ClientRegistrationDeleteApiClient withOrganizationName(@Nullable String organizationName) {
        this.organizationName = organizationName;
        return this;
    }
     ...
     * corresponds to the `signed_jwks_uri` client metadata defined in OpenID Connect Federation 1.0.
     */
    public ClientRegistrationDeleteApiClient withSignedJwksUri(@Nullable String signedJwksUri) {
        this.signedJwksUri = signedJwksUri;
        return this;
    }
     ...
     * the entity ID of this client.
     */
    public ClientRegistrationDeleteApiClient withEntityId(@Nullable String entityId) {
        this.entityId = entityId;
        return this;
    }
     ...
     * the mechanism defined in OpenID Connect Federation 1.0
     */
    public ClientRegistrationDeleteApiClient withTrustAnchorId(@Nullable String trustAnchorId) {
        this.trustAnchorId = trustAnchorId;
        return this;
    }
     ...
     * OpenID Connect Federation 1.0
     */
    public ClientRegistrationDeleteApiClient withTrustChain(@Nullable List<String> trustChain) {
        this.trustChain = trustChain;
        return this;
    }
     ...
     * defined in OpenID Connect Federation 1.0. The value is represented as milliseconds elapsed since the Unix epoch (1970-01-01).
     */
    public ClientRegistrationDeleteApiClient withTrustChainExpiresAt(@Nullable Long trustChainExpiresAt) {
        this.trustChainExpiresAt = trustChainExpiresAt;
        return this;
    }
     ...
     * the time at which the trust chain was updated by the mechanism defined in OpenID Connect Federation 1.0
     */
    public ClientRegistrationDeleteApiClient withTrustChainUpdatedAt(@Nullable Long trustChainUpdatedAt) {
        this.trustChainUpdatedAt = trustChainUpdatedAt;
        return this;
    }
     ...
     * The flag which indicates whether this client is locked.
     */
    public ClientRegistrationDeleteApiClient withLocked(@Nullable Boolean locked) {
        this.locked = locked;
        return this;
    }
     ...
     * (wallet) receives a credential offer from the credential issuer.
     */
    public ClientRegistrationDeleteApiClient withCredentialOfferEndpoint(@Nullable String credentialOfferEndpoint) {
        this.credentialOfferEndpoint = credentialOfferEndpoint;
        return this;
    }
     ...
     * the service, and the FAPI modes for the service are set to `null`.
     */
    public ClientRegistrationDeleteApiClient withFapiModes(@Nullable List<ClientRegistrationDeleteApiFapiMode> fapiModes) {
        this.fapiModes = fapiModes;
        return this;
    }
     ...
     * The response modes that this client may use.
     */
    public ClientRegistrationDeleteApiClient withResponseModes(@Nullable List<ClientRegistrationDeleteApiResponseMode> responseModes) {
        this.responseModes = responseModes;
        return this;
    }
     ...
     * True if credential responses to this client must be always encrypted.
     */
    public ClientRegistrationDeleteApiClient withCredentialResponseEncryptionRequired(@Nullable Boolean credentialResponseEncryptionRequired) {
        this.credentialResponseEncryptionRequired = credentialResponseEncryptionRequired;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClientRegistrationDeleteApiClient other = (ClientRegistrationDeleteApiClient) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ClientRegistrationDeleteApiClient.class,
                "number", number,
    ...
    public final static class Builder {
         ...
         * languages, this property can be used to register the names.
         */
        public Builder clientNames(@Nullable List<ClientRegistrationDeleteApiClientName> clientNames) {
            this.clientNames = clientNames;
            return this;
        }
         ...
         * descriptions for different languages, this property can be used to register the descriptions.
         */
        public Builder descriptions(@Nullable List<ClientRegistrationDeleteApiDescription> descriptions) {
            this.descriptions = descriptions;
            return this;
        }
         ...
         * for details.
         */
        public Builder clientType(@Nullable ClientRegistrationDeleteApiClientType clientType) {
            this.clientType = clientType;
            return this;
        }
         ...
         * See the description about `redirectUris` property for more details.
         */
        public Builder applicationType(@Nullable ClientRegistrationDeleteApiApplicationType applicationType) {
            this.applicationType = applicationType;
            return this;
        }
         ...
         * different languages, this property can be used to register URLs of the images.
         */
        public Builder logoUris(@Nullable List<ClientRegistrationDeleteApiLogoUris> logoUris) {
            this.logoUris = logoUris;
            return this;
        }
         ...
         * 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
         */
        public Builder grantTypes(@Nullable List<ClientRegistrationDeleteApiGrantType> grantTypes) {
            this.grantTypes = grantTypes;
            return this;
        }
         ...
         * 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
         */
        public Builder responseTypes(@Nullable List<ClientRegistrationDeleteApiResponseType> responseTypes) {
            this.responseTypes = responseTypes;
            return this;
        }
         ...
         *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
         */
        public Builder authorizationSignAlg(@Nullable ClientRegistrationDeleteApiAuthorizationSignAlg authorizationSignAlg) {
            this.authorizationSignAlg = authorizationSignAlg;
            return this;
        }
         ...
         * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
         */
        public Builder authorizationEncryptionAlg(@Nullable ClientRegistrationDeleteApiAuthorizationEncryptionAlg authorizationEncryptionAlg) {
            this.authorizationEncryptionAlg = authorizationEncryptionAlg;
            return this;
        }
         ...
         *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
         */
        public Builder authorizationEncryptionEnc(@Nullable ClientRegistrationDeleteApiAuthorizationEncryptionEnc authorizationEncryptionEnc) {
            this.authorizationEncryptionEnc = authorizationEncryptionEnc;
            return this;
        }
         ...
         * Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
         */
        public Builder tokenAuthMethod(@Nullable ClientRegistrationDeleteApiTokenAuthMethod tokenAuthMethod) {
            this.tokenAuthMethod = tokenAuthMethod;
            return this;
        }
         ...
         *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
         */
        public Builder tokenAuthSignAlg(@Nullable ClientRegistrationDeleteApiTokenAuthSignAlg tokenAuthSignAlg) {
            this.tokenAuthSignAlg = tokenAuthSignAlg;
            return this;
        }
         ...
         *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
         */
        public Builder requestSignAlg(@Nullable ClientRegistrationDeleteApiRequestSignAlg requestSignAlg) {
            this.requestSignAlg = requestSignAlg;
            return this;
        }
         ...
         * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
         */
        public Builder requestEncryptionAlg(@Nullable ClientRegistrationDeleteApiRequestEncryptionAlg requestEncryptionAlg) {
            this.requestEncryptionAlg = requestEncryptionAlg;
            return this;
        }
         ...
         *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
         */
        public Builder requestEncryptionEnc(@Nullable ClientRegistrationDeleteApiRequestEncryptionEnc requestEncryptionEnc) {
            this.requestEncryptionEnc = requestEncryptionEnc;
            return this;
        }
         ...
         *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
         */
        public Builder idTokenSignAlg(@Nullable ClientRegistrationDeleteApiIdTokenSignAlg idTokenSignAlg) {
            this.idTokenSignAlg = idTokenSignAlg;
            return this;
        }
         ...
         * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
         */
        public Builder idTokenEncryptionAlg(@Nullable ClientRegistrationDeleteApiIdTokenEncryptionAlg idTokenEncryptionAlg) {
            this.idTokenEncryptionAlg = idTokenEncryptionAlg;
            return this;
        }
         ...
         *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
         */
        public Builder idTokenEncryptionEnc(@Nullable ClientRegistrationDeleteApiIdTokenEncryptionEnc idTokenEncryptionEnc) {
            this.idTokenEncryptionEnc = idTokenEncryptionEnc;
            return this;
        }
         ...
         * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
         */
        public Builder subjectType(@Nullable ClientRegistrationDeleteApiSubjectType subjectType) {
            this.subjectType = subjectType;
            return this;
        }
         ...
         *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
         */
        public Builder userInfoSignAlg(@Nullable ClientRegistrationDeleteApiUserInfoSignAlg userInfoSignAlg) {
            this.userInfoSignAlg = userInfoSignAlg;
            return this;
        }
         ...
         * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
         */
        public Builder userInfoEncryptionAlg(@Nullable ClientRegistrationDeleteApiUserInfoEncryptionAlg userInfoEncryptionAlg) {
            this.userInfoEncryptionAlg = userInfoEncryptionAlg;
            return this;
        }
         ...
         *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
         */
        public Builder userInfoEncryptionEnc(@Nullable ClientRegistrationDeleteApiUserInfoEncryptionEnc userInfoEncryptionEnc) {
            this.userInfoEncryptionEnc = userInfoEncryptionEnc;
            return this;
        }
         ...
         * this property can be used to register the URLs.
         */
        public Builder tosUris(@Nullable List<ClientRegistrationDeleteApiTosUris> tosUris) {
            this.tosUris = tosUris;
            return this;
        }
         ...
         * If the client application has different policy pages for different languages, this property can be used to register the URLs.
         */
        public Builder policyUris(@Nullable List<ClientRegistrationDeleteApiPolicyUris> policyUris) {
            this.policyUris = policyUris;
            return this;
        }
         ...
         * be used to register the URLs.
         */
        public Builder clientUris(@Nullable List<ClientRegistrationDeleteApiClientUris> clientUris) {
            this.clientUris = clientUris;
            return this;
        }
         ...
         *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
         */
        public Builder bcRequestSignAlg(@Nullable ClientRegistrationDeleteApiBcRequestSignAlg bcRequestSignAlg) {
            this.bcRequestSignAlg = bcRequestSignAlg;
            return this;
        }
         ...
         * The attributes of this client.
         */
        public Builder attributes(@Nullable List<ClientRegistrationDeleteApiAttribute> attributes) {
            this.attributes = attributes;
            return this;
        }

        public Builder extension(@Nullable ClientRegistrationDeleteApiExtension extension) {
            this.extension = extension;
            return this;
        }
         ...
         * The client registration types that the client has declared it may use.
         */
        public Builder clientRegistrationTypes(@Nullable List<ClientRegistrationDeleteApiClientRegistrationType> clientRegistrationTypes) {
            this.clientRegistrationTypes = clientRegistrationTypes;
            return this;
        }
         ...
         * the service, and the FAPI modes for the service are set to `null`.
         */
        public Builder fapiModes(@Nullable List<ClientRegistrationDeleteApiFapiMode> fapiModes) {
            this.fapiModes = fapiModes;
            return this;
        }
         ...
         * The response modes that this client may use.
         */
        public Builder responseModes(@Nullable List<ClientRegistrationDeleteApiResponseMode> responseModes) {
            this.responseModes = responseModes;
            return this;
        }
        ...
        public ClientRegistrationDeleteApiClient build() {
            return new ClientRegistrationDeleteApiClient(
                number, serviceNumber, clientName,
                clientNames, description, descriptions,
                clientId, clientSecret, clientIdAlias,
                clientIdAliasEnabled, clientType, applicationType,
