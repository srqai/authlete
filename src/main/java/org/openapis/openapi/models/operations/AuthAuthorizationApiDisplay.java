 ...
 */
public enum AuthAuthorizationApiDisplay {
    PAGE("PAGE"),
    POPUP("POPUP"),
    TOUCH("TOUCH"),
    WAP("WAP");
    ...
    AuthAuthorizationApiDisplay(String value) {
        this.value = value;
    }
    ...
    public static Optional<AuthAuthorizationApiDisplay> fromValue(String value) {
        for (AuthAuthorizationApiDisplay o: AuthAuthorizationApiDisplay.values()) {
