 ...
 */
public enum ClientGetApiUserInfoEncryptionEnc {
    ...
    ClientGetApiUserInfoEncryptionEnc(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientGetApiUserInfoEncryptionEnc> fromValue(String value) {
        for (ClientGetApiUserInfoEncryptionEnc o: ClientGetApiUserInfoEncryptionEnc.values()) {
