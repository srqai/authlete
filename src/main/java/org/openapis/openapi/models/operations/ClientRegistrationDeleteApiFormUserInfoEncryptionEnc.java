 ...
 */
public enum ClientRegistrationDeleteApiFormUserInfoEncryptionEnc {
    ...
    ClientRegistrationDeleteApiFormUserInfoEncryptionEnc(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationDeleteApiFormUserInfoEncryptionEnc> fromValue(String value) {
        for (ClientRegistrationDeleteApiFormUserInfoEncryptionEnc o: ClientRegistrationDeleteApiFormUserInfoEncryptionEnc.values()) {
