 ...
 */
public enum FederationRegistrationApiIdTokenEncryptionEnc {
    ...
    FederationRegistrationApiIdTokenEncryptionEnc(String value) {
        this.value = value;
    }
    ...
    public static Optional<FederationRegistrationApiIdTokenEncryptionEnc> fromValue(String value) {
        for (FederationRegistrationApiIdTokenEncryptionEnc o: FederationRegistrationApiIdTokenEncryptionEnc.values()) {
