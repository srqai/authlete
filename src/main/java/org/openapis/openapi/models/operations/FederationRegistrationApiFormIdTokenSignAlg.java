 ...
 */
public enum FederationRegistrationApiFormIdTokenSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    FederationRegistrationApiFormIdTokenSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<FederationRegistrationApiFormIdTokenSignAlg> fromValue(String value) {
        for (FederationRegistrationApiFormIdTokenSignAlg o: FederationRegistrationApiFormIdTokenSignAlg.values()) {
