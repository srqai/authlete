 ...
 */
public enum ClientRegistrationDeleteApiAuthorizationEncryptionAlg {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientRegistrationDeleteApiAuthorizationEncryptionAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationDeleteApiAuthorizationEncryptionAlg> fromValue(String value) {
        for (ClientRegistrationDeleteApiAuthorizationEncryptionAlg o: ClientRegistrationDeleteApiAuthorizationEncryptionAlg.values()) {
