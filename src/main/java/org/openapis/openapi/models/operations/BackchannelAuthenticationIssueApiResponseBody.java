...
public class BackchannelAuthenticationIssueApiResponseBody {
    /**
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("action")
    private BackchannelAuthenticationIssueApiAction action;
    ...
    @JsonCreator
    public BackchannelAuthenticationIssueApiResponseBody(
            @JsonProperty("resultCode") @Nullable String resultCode,
            @JsonProperty("resultMessage") @Nullable String resultMessage,
            @JsonProperty("action") @Nullable BackchannelAuthenticationIssueApiAction action,
     ...
     * The next action that the authorization server implementation should take.
     */
    public Optional<BackchannelAuthenticationIssueApiAction> action() {
     ...
     * The code which represents the result of the API call.
     */
    public BackchannelAuthenticationIssueApiResponseBody withResultCode(@Nullable String resultCode) {
        this.resultCode = resultCode;
        return this;
    }
     ...
     * A short message which explains the result of the API call.
     */
    public BackchannelAuthenticationIssueApiResponseBody withResultMessage(@Nullable String resultMessage) {
        this.resultMessage = resultMessage;
        return this;
    }
     ...
     * The next action that the authorization server implementation should take.
     */
    public BackchannelAuthenticationIssueApiResponseBody withAction(@Nullable BackchannelAuthenticationIssueApiAction action) {
        this.action = action;
        return this;
    }
     ...
     * application. Its format varies depending on the value of `action` parameter.
     */
    public BackchannelAuthenticationIssueApiResponseBody withResponseContent(@Nullable String responseContent) {
        this.responseContent = responseContent;
        return this;
    }
     ...
     * The newly issued authentication request ID.
     */
    public BackchannelAuthenticationIssueApiResponseBody withAuthReqId(@Nullable String authReqId) {
        this.authReqId = authReqId;
        return this;
    }
     ...
     * The duration of the issued authentication request ID in seconds.
     */
    public BackchannelAuthenticationIssueApiResponseBody withExpiresIn(@Nullable Integer expiresIn) {
        this.expiresIn = expiresIn;
        return this;
    }
     ...
     * requests to the token endpoint.
     */
    public BackchannelAuthenticationIssueApiResponseBody withInterval(@Nullable Integer interval) {
        this.interval = interval;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        BackchannelAuthenticationIssueApiResponseBody other = (BackchannelAuthenticationIssueApiResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(BackchannelAuthenticationIssueApiResponseBody.class,
    ...
    public final static class Builder {
         ...
         * The next action that the authorization server implementation should take.
         */
        public Builder action(@Nullable BackchannelAuthenticationIssueApiAction action) {
            this.action = action;
            return this;
        }
        ...
        public BackchannelAuthenticationIssueApiResponseBody build() {
            return new BackchannelAuthenticationIssueApiResponseBody(
                resultCode, resultMessage, action,
                responseContent, authReqId, expiresIn,
                interval);
        }
