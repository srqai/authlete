 ...
 */
public enum ClientGetListApiUserInfoEncryptionEnc {
    ...
    ClientGetListApiUserInfoEncryptionEnc(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientGetListApiUserInfoEncryptionEnc> fromValue(String value) {
        for (ClientGetListApiUserInfoEncryptionEnc o: ClientGetListApiUserInfoEncryptionEnc.values()) {
