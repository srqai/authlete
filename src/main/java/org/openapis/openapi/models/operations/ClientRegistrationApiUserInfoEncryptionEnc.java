 ...
 */
public enum ClientRegistrationApiUserInfoEncryptionEnc {
    ...
    ClientRegistrationApiUserInfoEncryptionEnc(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationApiUserInfoEncryptionEnc> fromValue(String value) {
        for (ClientRegistrationApiUserInfoEncryptionEnc o: ClientRegistrationApiUserInfoEncryptionEnc.values()) {
