 ...
 */
public enum ClientUpdateApiRequestSignAlgResponse {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientUpdateApiRequestSignAlgResponse(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientUpdateApiRequestSignAlgResponse> fromValue(String value) {
        for (ClientUpdateApiRequestSignAlgResponse o: ClientUpdateApiRequestSignAlgResponse.values()) {
