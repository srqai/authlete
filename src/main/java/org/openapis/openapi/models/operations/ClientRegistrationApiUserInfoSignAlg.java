 ...
 */
public enum ClientRegistrationApiUserInfoSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientRegistrationApiUserInfoSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationApiUserInfoSignAlg> fromValue(String value) {
        for (ClientRegistrationApiUserInfoSignAlg o: ClientRegistrationApiUserInfoSignAlg.values()) {
