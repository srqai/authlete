 ...
 */
public enum ClientUpdateApiRequestEncryptionAlgRequest {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientUpdateApiRequestEncryptionAlgRequest(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientUpdateApiRequestEncryptionAlgRequest> fromValue(String value) {
        for (ClientUpdateApiRequestEncryptionAlgRequest o: ClientUpdateApiRequestEncryptionAlgRequest.values()) {
