 ...
 */
public enum ClientRegistrationDeleteApiIdTokenEncryptionEnc {
    ...
    ClientRegistrationDeleteApiIdTokenEncryptionEnc(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationDeleteApiIdTokenEncryptionEnc> fromValue(String value) {
        for (ClientRegistrationDeleteApiIdTokenEncryptionEnc o: ClientRegistrationDeleteApiIdTokenEncryptionEnc.values()) {
