 ...
 */
public enum ClientRegistrationDeleteApiRequestEncryptionAlg {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientRegistrationDeleteApiRequestEncryptionAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationDeleteApiRequestEncryptionAlg> fromValue(String value) {
        for (ClientRegistrationDeleteApiRequestEncryptionAlg o: ClientRegistrationDeleteApiRequestEncryptionAlg.values()) {
