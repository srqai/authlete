...
public class AuthUserinfoApiFormResponseBody {
    /**
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("action")
    private AuthUserinfoApiFormAction action;
    ...
    private List<AuthUserinfoApiFormProperty> properties;
    ...
    private List<AuthUserinfoApiFormServiceAttribute> serviceAttributes;
    ...
    private List<AuthUserinfoApiFormClientAttribute> clientAttributes;
    ...
    public AuthUserinfoApiFormResponseBody(
            ...
            @JsonProperty("properties") @Nullable List<AuthUserinfoApiFormProperty> properties,
            @JsonProperty("userInfoClaims") @Nullable String userInfoClaims,
            @JsonProperty("serviceAttributes") @Nullable List<AuthUserinfoApiFormServiceAttribute> serviceAttributes,
            @JsonProperty("clientAttributes") @Nullable List<AuthUserinfoApiFormClientAttribute> clientAttributes,
     ...
     * The next action that the authorization server implementation should take.
     */
    public Optional<AuthUserinfoApiFormAction> action() {
     ...
     * The extra properties associated with the access token.
     */
    public Optional<List<AuthUserinfoApiFormProperty>> properties() {
     ...
     * The attributes of this service that the client application belongs to.
     */
    public Optional<List<AuthUserinfoApiFormServiceAttribute>> serviceAttributes() {
     ...
     * The attributes of the client.
     */
    public Optional<List<AuthUserinfoApiFormClientAttribute>> clientAttributes() {
     ...
     * The code which represents the result of the API call.
     */
    public AuthUserinfoApiFormResponseBody withResultCode(@Nullable String resultCode) {
        this.resultCode = resultCode;
        return this;
    }
     ...
     * A short message which explains the result of the API call.
     */
    public AuthUserinfoApiFormResponseBody withResultMessage(@Nullable String resultMessage) {
        this.resultMessage = resultMessage;
        return this;
    }
     ...
     * The next action that the authorization server implementation should take.
     */
    public AuthUserinfoApiFormResponseBody withAction(@Nullable AuthUserinfoApiFormAction action) {
        this.action = action;
        return this;
    }
     ...
     * The list of claims that the client application requests to be embedded in the ID token.
     */
    public AuthUserinfoApiFormResponseBody withClaims(@Nullable List<String> claims) {
        this.claims = claims;
        return this;
    }
     ...
     * The ID of the client application which is associated with the access token.
     */
    public AuthUserinfoApiFormResponseBody withClientId(@Nullable Long clientId) {
        this.clientId = clientId;
        return this;
    }
     ...
     * The client ID alias when the authorization request for the access token was made.
     */
    public AuthUserinfoApiFormResponseBody withClientIdAlias(@Nullable String clientIdAlias) {
        this.clientIdAlias = clientIdAlias;
        return this;
    }
     ...
     * request for the access token was made.
     */
    public AuthUserinfoApiFormResponseBody withClientIdAliasUsed(@Nullable Boolean clientIdAliasUsed) {
        this.clientIdAliasUsed = clientIdAliasUsed;
        return this;
    }
     ...
     * header on errors.
     */
    public AuthUserinfoApiFormResponseBody withResponseContent(@Nullable String responseContent) {
        this.responseContent = responseContent;
        return this;
    }
     ...
     * The scopes covered by the access token.
     */
    public AuthUserinfoApiFormResponseBody withScopes(@Nullable List<String> scopes) {
        this.scopes = scopes;
        return this;
    }
     ...
     * The subject (= resource owner's ID).
     */
    public AuthUserinfoApiFormResponseBody withSubject(@Nullable String subject) {
        this.subject = subject;
        return this;
    }
     ...
     * The access token that came along with the userinfo request.
     */
    public AuthUserinfoApiFormResponseBody withToken(@Nullable String token) {
        this.token = token;
        return this;
    }
     ...
     * The extra properties associated with the access token.
     */
    public AuthUserinfoApiFormResponseBody withProperties(@Nullable List<AuthUserinfoApiFormProperty> properties) {
        this.properties = properties;
        return this;
    }
     ...
     * the value of this property holds the former value.
     */
    public AuthUserinfoApiFormResponseBody withUserInfoClaims(@Nullable String userInfoClaims) {
        this.userInfoClaims = userInfoClaims;
        return this;
    }
     ...
     * The attributes of this service that the client application belongs to.
     */
    public AuthUserinfoApiFormResponseBody withServiceAttributes(@Nullable List<AuthUserinfoApiFormServiceAttribute> serviceAttributes) {
        this.serviceAttributes = serviceAttributes;
        return this;
    }
     ...
     * The attributes of the client.
     */
    public AuthUserinfoApiFormResponseBody withClientAttributes(@Nullable List<AuthUserinfoApiFormClientAttribute> clientAttributes) {
        this.clientAttributes = clientAttributes;
        return this;
    }
     ...
     * to know.
     */
    public AuthUserinfoApiFormResponseBody withConsentedClaims(@Nullable List<String> consentedClaims) {
        this.consentedClaims = consentedClaims;
        return this;
    }
     ...
     * ```
     */
    public AuthUserinfoApiFormResponseBody withRequestedClaimsForTx(@Nullable List<String> requestedClaimsForTx) {
        this.requestedClaimsForTx = requestedClaimsForTx;
        return this;
    }
     ...
     * Names of verified claims that will be referenced when transformed claims are computed.
     */
    public AuthUserinfoApiFormResponseBody withRequestedVerifiedClaimsForTx(@Nullable List<List<String>> requestedVerifiedClaimsForTx) {
        this.requestedVerifiedClaimsForTx = requestedVerifiedClaimsForTx;
        return this;
    }
     ...
     * request object.
     */
    public AuthUserinfoApiFormResponseBody withTransformedClaims(@Nullable String transformedClaims) {
        this.transformedClaims = transformedClaims;
        return this;
    }
     ...
     * The entity ID of the client.
     */
    public AuthUserinfoApiFormResponseBody withClientEntityId(@Nullable String clientEntityId) {
        this.clientEntityId = clientEntityId;
        return this;
    }
     ...
     * Flag which indicates whether the entity ID of the client was used when the request for the access token was made.
     */
    public AuthUserinfoApiFormResponseBody withClientEntityIdUsed(@Nullable Boolean clientEntityIdUsed) {
        this.clientEntityIdUsed = clientEntityIdUsed;
        return this;
    }
     ...
     * as the value of the `DPoP-Nonce` HTTP header.
     */
    public AuthUserinfoApiFormResponseBody withDpopNonce(@Nullable String dpopNonce) {
        this.dpopNonce = dpopNonce;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AuthUserinfoApiFormResponseBody other = (AuthUserinfoApiFormResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AuthUserinfoApiFormResponseBody.class,
    ...
    public final static class Builder {
         ...
         * The next action that the authorization server implementation should take.
         */
        public Builder action(@Nullable AuthUserinfoApiFormAction action) {
            this.action = action;
            return this;
        }
         ...
         * The extra properties associated with the access token.
         */
        public Builder properties(@Nullable List<AuthUserinfoApiFormProperty> properties) {
            this.properties = properties;
            return this;
        }
         ...
         * The attributes of this service that the client application belongs to.
         */
        public Builder serviceAttributes(@Nullable List<AuthUserinfoApiFormServiceAttribute> serviceAttributes) {
            this.serviceAttributes = serviceAttributes;
            return this;
        }
         ...
         * The attributes of the client.
         */
        public Builder clientAttributes(@Nullable List<AuthUserinfoApiFormClientAttribute> clientAttributes) {
            this.clientAttributes = clientAttributes;
            return this;
        }
        ...
        public AuthUserinfoApiFormResponseBody build() {
            return new AuthUserinfoApiFormResponseBody(
                resultCode, resultMessage, action,
                claims, clientId, clientIdAlias,
                clientIdAliasUsed, responseContent, scopes,
                subject, token, properties,
