...
public class AuthTokenCreateApiFormResponseBody {
    /**
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("action")
    private AuthTokenCreateApiFormAction action;
     ...
     * The next action that the authorization server implementation should take.
     */
    public Optional<AuthTokenCreateApiFormAction> action() {
     ...
     * The code which represents the result of the API call.
     */
    public AuthTokenCreateApiFormResponseBody withResultCode(@Nullable String resultCode) {
        this.resultCode = resultCode;
        return this;
    }
     ...
     * A short message which explains the result of the API call.
     */
    public AuthTokenCreateApiFormResponseBody withResultMessage(@Nullable String resultMessage) {
        this.resultMessage = resultMessage;
        return this;
    }
     ...
     * The next action that the authorization server implementation should take.
     */
    public AuthTokenCreateApiFormResponseBody withAction(@Nullable AuthTokenCreateApiFormAction action) {
        this.action = action;
        return this;
    }
     ...
     * The newly issued access token.
     */
    public AuthTokenCreateApiFormResponseBody withAccessToken(@Nullable String accessToken) {
        this.accessToken = accessToken;
        return this;
    }
     ...
     * The ID of the client application associated with the access token.
     */
    public AuthTokenCreateApiFormResponseBody withClientId(@Nullable Long clientId) {
        this.clientId = clientId;
        return this;
    }
     ...
     * The time at which the access token expires.
     */
    public AuthTokenCreateApiFormResponseBody withExpiresAt(@Nullable Long expiresAt) {
        this.expiresAt = expiresAt;
        return this;
    }
     ...
     * The duration of the newly issued access token in seconds.
     */
    public AuthTokenCreateApiFormResponseBody withExpiresIn(@Nullable Long expiresIn) {
        this.expiresIn = expiresIn;
        return this;
    }
     ...
     * The grant type for the newly issued access token.
     */
    public AuthTokenCreateApiFormResponseBody withGrantType(@Nullable String grantType) {
        this.grantType = grantType;
        return this;
    }
     ...
     * The newly issued refresh token.
     */
    public AuthTokenCreateApiFormResponseBody withRefreshToken(@Nullable String refreshToken) {
        this.refreshToken = refreshToken;
        return this;
    }
     ...
     * Scopes which are associated with the access token.
     */
    public AuthTokenCreateApiFormResponseBody withScopes(@Nullable List<String> scopes) {
        this.scopes = scopes;
        return this;
    }
     ...
     * token.
     */
    public AuthTokenCreateApiFormResponseBody withSubject(@Nullable String subject) {
        this.subject = subject;
        return this;
    }
     ...
     * The token type of the access token.
     */
    public AuthTokenCreateApiFormResponseBody withTokenType(@Nullable String tokenType) {
        this.tokenType = tokenType;
        return this;
    }
     ...
     * random-string one.
     */
    public AuthTokenCreateApiFormResponseBody withJwtAccessToken(@Nullable String jwtAccessToken) {
        this.jwtAccessToken = jwtAccessToken;
        return this;
    }
     ...
     * attachment.
     */
    public AuthTokenCreateApiFormResponseBody withForExternalAttachment(@Nullable Boolean forExternalAttachment) {
        this.forExternalAttachment = forExternalAttachment;
        return this;
    }
     ...
     * Set the unique token identifier.
     */
    public AuthTokenCreateApiFormResponseBody withTokenId(@Nullable String tokenId) {
        this.tokenId = tokenId;
        return this;
    }
     ...
     * The scopes associated with the refresh token. May be null.
     */
    public AuthTokenCreateApiFormResponseBody withRefreshTokenScopes(@Nullable List<String> refreshTokenScopes) {
        this.refreshTokenScopes = refreshTokenScopes;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AuthTokenCreateApiFormResponseBody other = (AuthTokenCreateApiFormResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AuthTokenCreateApiFormResponseBody.class,
    ...
    public final static class Builder {
         ...
         * The next action that the authorization server implementation should take.
         */
        public Builder action(@Nullable AuthTokenCreateApiFormAction action) {
            this.action = action;
            return this;
        }
        ...
        public AuthTokenCreateApiFormResponseBody build() {
            return new AuthTokenCreateApiFormResponseBody(
                resultCode, resultMessage, action,
                accessToken, clientId, expiresAt,
                expiresIn, grantType, properties,
                refreshToken, scopes, subject,
