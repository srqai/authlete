...
public class ClientUpdateApiResponseBody {
    /**
    ...
    private List<ClientUpdateApiClientNameResponse> clientNames;
    ...
    private List<ClientUpdateApiDescriptionResponse> descriptions;
    ...
    private ClientUpdateApiClientTypeResponse clientType;
    ...
    private ClientUpdateApiApplicationTypeResponse applicationType;
    ...
    private List<ClientUpdateApiLogoUrisResponse> logoUris;
    ...
    private List<ClientUpdateApiGrantTypeResponse> grantTypes;
    ...
    private List<ClientUpdateApiResponseTypeResponse> responseTypes;
    ...
    private ClientUpdateApiAuthorizationSignAlgResponse authorizationSignAlg;
    ...
    private ClientUpdateApiAuthorizationEncryptionAlgResponse authorizationEncryptionAlg;
    ...
    private ClientUpdateApiAuthorizationEncryptionEncResponse authorizationEncryptionEnc;
    ...
    private ClientUpdateApiTokenAuthMethodResponse tokenAuthMethod;
    ...
    private ClientUpdateApiTokenAuthSignAlgResponse tokenAuthSignAlg;
    ...
    private ClientUpdateApiRequestSignAlgResponse requestSignAlg;
    ...
    private ClientUpdateApiRequestEncryptionAlgResponse requestEncryptionAlg;
    ...
    private ClientUpdateApiRequestEncryptionEncResponse requestEncryptionEnc;
    ...
    private ClientUpdateApiIdTokenSignAlgResponse idTokenSignAlg;
    ...
    private ClientUpdateApiIdTokenEncryptionAlgResponse idTokenEncryptionAlg;
    ...
    private ClientUpdateApiIdTokenEncryptionEncResponse idTokenEncryptionEnc;
    ...
    private ClientUpdateApiSubjectTypeResponse subjectType;
    ...
    private ClientUpdateApiUserInfoSignAlgResponse userInfoSignAlg;
    ...
    private ClientUpdateApiUserInfoEncryptionAlgResponse userInfoEncryptionAlg;
    ...
    private ClientUpdateApiUserInfoEncryptionEncResponse userInfoEncryptionEnc;
    ...
    private List<ClientUpdateApiTosUrisResponse> tosUris;
    ...
    private List<ClientUpdateApiPolicyUrisResponse> policyUris;
    ...
    private List<ClientUpdateApiClientUrisResponse> clientUris;
    ...
    private ClientUpdateApiBcRequestSignAlgResponse bcRequestSignAlg;
    ...
    private List<ClientUpdateApiAttributeResponse> attributes;


    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("extension")
    private ClientUpdateApiExtensionResponse extension;
    ...
    private List<ClientUpdateApiClientRegistrationTypeResponse> clientRegistrationTypes;
    ...
    private List<ClientUpdateApiFapiModeResponse> fapiModes;
    ...
    private List<ClientUpdateApiResponseModeResponse> responseModes;
    ...
    @JsonCreator
    public ClientUpdateApiResponseBody(
            ...
            @JsonProperty("clientNames") @Nullable List<ClientUpdateApiClientNameResponse> clientNames,
            @JsonProperty("description") @Nullable String description,
            @JsonProperty("descriptions") @Nullable List<ClientUpdateApiDescriptionResponse> descriptions,
            ...
            @JsonProperty("clientType") @Nullable ClientUpdateApiClientTypeResponse clientType,
            @JsonProperty("applicationType") @Nullable ClientUpdateApiApplicationTypeResponse applicationType,
            @JsonProperty("logoUri") @Nullable String logoUri,
            @JsonProperty("logoUris") @Nullable List<ClientUpdateApiLogoUrisResponse> logoUris,
            ...
            @JsonProperty("grantTypes") @Nullable List<ClientUpdateApiGrantTypeResponse> grantTypes,
            @JsonProperty("responseTypes") @Nullable List<ClientUpdateApiResponseTypeResponse> responseTypes,
            @JsonProperty("redirectUris") @Nullable List<String> redirectUris,
            @JsonProperty("authorizationSignAlg") @Nullable ClientUpdateApiAuthorizationSignAlgResponse authorizationSignAlg,
            @JsonProperty("authorizationEncryptionAlg") @Nullable ClientUpdateApiAuthorizationEncryptionAlgResponse authorizationEncryptionAlg,
            @JsonProperty("authorizationEncryptionEnc") @Nullable ClientUpdateApiAuthorizationEncryptionEncResponse authorizationEncryptionEnc,
            @JsonProperty("tokenAuthMethod") @Nullable ClientUpdateApiTokenAuthMethodResponse tokenAuthMethod,
            @JsonProperty("tokenAuthSignAlg") @Nullable ClientUpdateApiTokenAuthSignAlgResponse tokenAuthSignAlg,
            ...
            @JsonProperty("requestSignAlg") @Nullable ClientUpdateApiRequestSignAlgResponse requestSignAlg,
            @JsonProperty("requestEncryptionAlg") @Nullable ClientUpdateApiRequestEncryptionAlgResponse requestEncryptionAlg,
            @JsonProperty("requestEncryptionEnc") @Nullable ClientUpdateApiRequestEncryptionEncResponse requestEncryptionEnc,
            ...
            @JsonProperty("idTokenSignAlg") @Nullable ClientUpdateApiIdTokenSignAlgResponse idTokenSignAlg,
            @JsonProperty("idTokenEncryptionAlg") @Nullable ClientUpdateApiIdTokenEncryptionAlgResponse idTokenEncryptionAlg,
            @JsonProperty("idTokenEncryptionEnc") @Nullable ClientUpdateApiIdTokenEncryptionEncResponse idTokenEncryptionEnc,
            @JsonProperty("authTimeRequired") @Nullable Boolean authTimeRequired,
            @JsonProperty("subjectType") @Nullable ClientUpdateApiSubjectTypeResponse subjectType,
            ...
            @JsonProperty("userInfoSignAlg") @Nullable ClientUpdateApiUserInfoSignAlgResponse userInfoSignAlg,
            @JsonProperty("userInfoEncryptionAlg") @Nullable ClientUpdateApiUserInfoEncryptionAlgResponse userInfoEncryptionAlg,
            @JsonProperty("userInfoEncryptionEnc") @Nullable ClientUpdateApiUserInfoEncryptionEncResponse userInfoEncryptionEnc,
            @JsonProperty("loginUri") @Nullable String loginUri,
            @JsonProperty("tosUri") @Nullable String tosUri,
            @JsonProperty("tosUris") @Nullable List<ClientUpdateApiTosUrisResponse> tosUris,
            @JsonProperty("policyUri") @Nullable String policyUri,
            @JsonProperty("policyUris") @Nullable List<ClientUpdateApiPolicyUrisResponse> policyUris,
            @JsonProperty("clientUri") @Nullable String clientUri,
            @JsonProperty("clientUris") @Nullable List<ClientUpdateApiClientUrisResponse> clientUris,
            ...
            @JsonProperty("bcRequestSignAlg") @Nullable ClientUpdateApiBcRequestSignAlgResponse bcRequestSignAlg,
            @JsonProperty("bcUserCodeRequired") @Nullable Boolean bcUserCodeRequired,
            @JsonProperty("attributes") @Nullable List<ClientUpdateApiAttributeResponse> attributes,
            @JsonProperty("extension") @Nullable ClientUpdateApiExtensionResponse extension,
            ...
            @JsonProperty("clientRegistrationTypes") @Nullable List<ClientUpdateApiClientRegistrationTypeResponse> clientRegistrationTypes,
            ...
            @JsonProperty("fapiModes") @Nullable List<ClientUpdateApiFapiModeResponse> fapiModes,
            @JsonProperty("responseModes") @Nullable List<ClientUpdateApiResponseModeResponse> responseModes,
     ...
     * languages, this property can be used to register the names.
     */
    public Optional<List<ClientUpdateApiClientNameResponse>> clientNames() {
     ...
     * descriptions for different languages, this property can be used to register the descriptions.
     */
    public Optional<List<ClientUpdateApiDescriptionResponse>> descriptions() {
     ...
     * for details.
     */
    public Optional<ClientUpdateApiClientTypeResponse> clientType() {
     ...
     * See the description about `redirectUris` property for more details.
     */
    public Optional<ClientUpdateApiApplicationTypeResponse> applicationType() {
     ...
     * different languages, this property can be used to register URLs of the images.
     */
    public Optional<List<ClientUpdateApiLogoUrisResponse>> logoUris() {
     ...
     * 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public Optional<List<ClientUpdateApiGrantTypeResponse>> grantTypes() {
     ...
     * 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public Optional<List<ClientUpdateApiResponseTypeResponse>> responseTypes() {
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public Optional<ClientUpdateApiAuthorizationSignAlgResponse> authorizationSignAlg() {
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public Optional<ClientUpdateApiAuthorizationEncryptionAlgResponse> authorizationEncryptionAlg() {
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public Optional<ClientUpdateApiAuthorizationEncryptionEncResponse> authorizationEncryptionEnc() {
     ...
     * Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public Optional<ClientUpdateApiTokenAuthMethodResponse> tokenAuthMethod() {
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public Optional<ClientUpdateApiTokenAuthSignAlgResponse> tokenAuthSignAlg() {
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public Optional<ClientUpdateApiRequestSignAlgResponse> requestSignAlg() {
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public Optional<ClientUpdateApiRequestEncryptionAlgResponse> requestEncryptionAlg() {
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public Optional<ClientUpdateApiRequestEncryptionEncResponse> requestEncryptionEnc() {
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public Optional<ClientUpdateApiIdTokenSignAlgResponse> idTokenSignAlg() {
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public Optional<ClientUpdateApiIdTokenEncryptionAlgResponse> idTokenEncryptionAlg() {
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public Optional<ClientUpdateApiIdTokenEncryptionEncResponse> idTokenEncryptionEnc() {
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public Optional<ClientUpdateApiSubjectTypeResponse> subjectType() {
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public Optional<ClientUpdateApiUserInfoSignAlgResponse> userInfoSignAlg() {
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public Optional<ClientUpdateApiUserInfoEncryptionAlgResponse> userInfoEncryptionAlg() {
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public Optional<ClientUpdateApiUserInfoEncryptionEncResponse> userInfoEncryptionEnc() {
     ...
     * this property can be used to register the URLs.
     */
    public Optional<List<ClientUpdateApiTosUrisResponse>> tosUris() {
     ...
     * If the client application has different policy pages for different languages, this property can be used to register the URLs.
     */
    public Optional<List<ClientUpdateApiPolicyUrisResponse>> policyUris() {
     ...
     * be used to register the URLs.
     */
    public Optional<List<ClientUpdateApiClientUrisResponse>> clientUris() {
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public Optional<ClientUpdateApiBcRequestSignAlgResponse> bcRequestSignAlg() {
     ...
     * The attributes of this client.
     */
    public Optional<List<ClientUpdateApiAttributeResponse>> attributes() {
        return Optional.ofNullable(this.attributes);
    }

    public Optional<ClientUpdateApiExtensionResponse> extension() {
     ...
     * The client registration types that the client has declared it may use.
     */
    public Optional<List<ClientUpdateApiClientRegistrationTypeResponse>> clientRegistrationTypes() {
     ...
     * the service, and the FAPI modes for the service are set to `null`.
     */
    public Optional<List<ClientUpdateApiFapiModeResponse>> fapiModes() {
     ...
     * The response modes that this client may use.
     */
    public Optional<List<ClientUpdateApiResponseModeResponse>> responseModes() {
     ...
     * The sequential number of the client. The value of this property is assigned by Authlete.
     */
    public ClientUpdateApiResponseBody withNumber(@Nullable Integer number) {
        this.number = number;
        return this;
    }
     ...
     * assigned by Authlete.
     */
    public ClientUpdateApiResponseBody withServiceNumber(@Nullable Integer serviceNumber) {
        this.serviceNumber = serviceNumber;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientUpdateApiResponseBody withClientName(@Nullable String clientName) {
        this.clientName = clientName;
        return this;
    }
     ...
     * languages, this property can be used to register the names.
     */
    public ClientUpdateApiResponseBody withClientNames(@Nullable List<ClientUpdateApiClientNameResponse> clientNames) {
        this.clientNames = clientNames;
        return this;
    }
     ...
     * The description about the client application.
     */
    public ClientUpdateApiResponseBody withDescription(@Nullable String description) {
        this.description = description;
        return this;
    }
     ...
     * descriptions for different languages, this property can be used to register the descriptions.
     */
    public ClientUpdateApiResponseBody withDescriptions(@Nullable List<ClientUpdateApiDescriptionResponse> descriptions) {
        this.descriptions = descriptions;
        return this;
    }
     ...
     * The client identifier used in Authlete API calls. The value of this property is assigned by Authlete.
     */
    public ClientUpdateApiResponseBody withClientId(@Nullable Long clientId) {
        this.clientId = clientId;
        return this;
    }
     ...
     * authorization server as described in Section 2.3 when making requests to the token endpoint.
     */
    public ClientUpdateApiResponseBody withClientSecret(@Nullable String clientSecret) {
        this.clientSecret = clientSecret;
        return this;
    }
     ...
     * default, this is a string version of the `clientId` property.
     */
    public ClientUpdateApiResponseBody withClientIdAlias(@Nullable String clientIdAlias) {
        this.clientIdAlias = clientIdAlias;
        return this;
    }
     ...
     * Deprecated. Always set to `true`.
     */
    public ClientUpdateApiResponseBody withClientIdAliasEnabled(@Nullable Boolean clientIdAliasEnabled) {
        this.clientIdAliasEnabled = clientIdAliasEnabled;
        return this;
    }
     ...
     * for details.
     */
    public ClientUpdateApiResponseBody withClientType(@Nullable ClientUpdateApiClientTypeResponse clientType) {
        this.clientType = clientType;
        return this;
    }
     ...
     * See the description about `redirectUris` property for more details.
     */
    public ClientUpdateApiResponseBody withApplicationType(@Nullable ClientUpdateApiApplicationTypeResponse applicationType) {
        this.applicationType = applicationType;
        return this;
    }
     ...
     * Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientUpdateApiResponseBody withLogoUri(@Nullable String logoUri) {
        this.logoUri = logoUri;
        return this;
    }
     ...
     * different languages, this property can be used to register URLs of the images.
     */
    public ClientUpdateApiResponseBody withLogoUris(@Nullable List<ClientUpdateApiLogoUrisResponse> logoUris) {
        this.logoUris = logoUris;
        return this;
    }
     ...
     * Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientUpdateApiResponseBody withContacts(@Nullable List<String> contacts) {
        this.contacts = contacts;
        return this;
    }
     ...
     * The flag to indicate whether this client use TLS client certificate bound access tokens.
     */
    public ClientUpdateApiResponseBody withTlsClientCertificateBoundAccessTokens(@Nullable Boolean tlsClientCertificateBoundAccessTokens) {
        this.tlsClientCertificateBoundAccessTokens = tlsClientCertificateBoundAccessTokens;
        return this;
    }
     ...
     * For more details, see [RFC 7591](https://datatracker.ietf.org/doc/html/rfc7591).
     */
    public ClientUpdateApiResponseBody withDynamicallyRegistered(@Nullable Boolean dynamicallyRegistered) {
        this.dynamicallyRegistered = dynamicallyRegistered;
        return this;
    }
     ...
     * of [RFC 7591](https://datatracker.ietf.org/doc/html/rfc7591).
     */
    public ClientUpdateApiResponseBody withSoftwareId(@Nullable String softwareId) {
        this.softwareId = softwareId;
        return this;
    }
     ...
     * of [RFC 7591](https://datatracker.ietf.org/doc/html/rfc7591).
     */
    public ClientUpdateApiResponseBody withSoftwareVersion(@Nullable String softwareVersion) {
        this.softwareVersion = softwareVersion;
        return this;
    }
     ...
     * The hash of the registration access token for this client.
     */
    public ClientUpdateApiResponseBody withRegistrationAccessTokenHash(@Nullable String registrationAccessTokenHash) {
        this.registrationAccessTokenHash = registrationAccessTokenHash;
        return this;
    }
     ...
     * The time at which this client was created. The value is represented as milliseconds since the UNIX epoch (1970-01-01).
     */
    public ClientUpdateApiResponseBody withCreatedAt(@Nullable Long createdAt) {
        this.createdAt = createdAt;
        return this;
    }
     ...
     * The time at which this client was last modified. The value is represented as milliseconds since the UNIX epoch (1970-01-01).
     */
    public ClientUpdateApiResponseBody withModifiedAt(@Nullable Long modifiedAt) {
        this.modifiedAt = modifiedAt;
        return this;
    }
     ...
     * 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientUpdateApiResponseBody withGrantTypes(@Nullable List<ClientUpdateApiGrantTypeResponse> grantTypes) {
        this.grantTypes = grantTypes;
        return this;
    }
     ...
     * 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientUpdateApiResponseBody withResponseTypes(@Nullable List<ClientUpdateApiResponseTypeResponse> responseTypes) {
        this.responseTypes = responseTypes;
        return this;
    }
     ...
     * details), but OpenID Connect requires exact match.
     */
    public ClientUpdateApiResponseBody withRedirectUris(@Nullable List<String> redirectUris) {
        this.redirectUris = redirectUris;
        return this;
    }
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public ClientUpdateApiResponseBody withAuthorizationSignAlg(@Nullable ClientUpdateApiAuthorizationSignAlgResponse authorizationSignAlg) {
        this.authorizationSignAlg = authorizationSignAlg;
        return this;
    }
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public ClientUpdateApiResponseBody withAuthorizationEncryptionAlg(@Nullable ClientUpdateApiAuthorizationEncryptionAlgResponse authorizationEncryptionAlg) {
        this.authorizationEncryptionAlg = authorizationEncryptionAlg;
        return this;
    }
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public ClientUpdateApiResponseBody withAuthorizationEncryptionEnc(@Nullable ClientUpdateApiAuthorizationEncryptionEncResponse authorizationEncryptionEnc) {
        this.authorizationEncryptionEnc = authorizationEncryptionEnc;
        return this;
    }
     ...
     * Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientUpdateApiResponseBody withTokenAuthMethod(@Nullable ClientUpdateApiTokenAuthMethodResponse tokenAuthMethod) {
        this.tokenAuthMethod = tokenAuthMethod;
        return this;
    }
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public ClientUpdateApiResponseBody withTokenAuthSignAlg(@Nullable ClientUpdateApiTokenAuthSignAlgResponse tokenAuthSignAlg) {
        this.tokenAuthSignAlg = tokenAuthSignAlg;
        return this;
    }
     ...
     * The key ID of a JWK containing a self-signed certificate of this client.
     */
    public ClientUpdateApiResponseBody withSelfSignedCertificateKeyId(@Nullable String selfSignedCertificateKeyId) {
        this.selfSignedCertificateKeyId = selfSignedCertificateKeyId;
        return this;
    }
     ...
     * Registration" for details.
     */
    public ClientUpdateApiResponseBody withTlsClientAuthSubjectDn(@Nullable String tlsClientAuthSubjectDn) {
        this.tlsClientAuthSubjectDn = tlsClientAuthSubjectDn;
        return this;
    }
     ...
     * Registration" for details.
     */
    public ClientUpdateApiResponseBody withTlsClientAuthSanDns(@Nullable String tlsClientAuthSanDns) {
        this.tlsClientAuthSanDns = tlsClientAuthSanDns;
        return this;
    }
     ...
     * Registration" for details.
     */
    public ClientUpdateApiResponseBody withTlsClientAuthSanUri(@Nullable String tlsClientAuthSanUri) {
        this.tlsClientAuthSanUri = tlsClientAuthSanUri;
        return this;
    }
     ...
     * Registration" for details.
     */
    public ClientUpdateApiResponseBody withTlsClientAuthSanIp(@Nullable String tlsClientAuthSanIp) {
        this.tlsClientAuthSanIp = tlsClientAuthSanIp;
        return this;
    }
     ...
     * Registration" for details.
     */
    public ClientUpdateApiResponseBody withTlsClientAuthSanEmail(@Nullable String tlsClientAuthSanEmail) {
        this.tlsClientAuthSanEmail = tlsClientAuthSanEmail;
        return this;
    }
     ...
     * in "OAuth 2.0 Pushed Authorization Requests".
     */
    public ClientUpdateApiResponseBody withParRequired(@Nullable Boolean parRequired) {
        this.parRequired = parRequired;
        return this;
    }
     ...
     * client metadata of this client is `true`. The metadata is defined in "JAR (JWT Secured Authorization Request)".
     */
    public ClientUpdateApiResponseBody withRequestObjectRequired(@Nullable Boolean requestObjectRequired) {
        this.requestObjectRequired = requestObjectRequired;
        return this;
    }
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public ClientUpdateApiResponseBody withRequestSignAlg(@Nullable ClientUpdateApiRequestSignAlgResponse requestSignAlg) {
        this.requestSignAlg = requestSignAlg;
        return this;
    }
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public ClientUpdateApiResponseBody withRequestEncryptionAlg(@Nullable ClientUpdateApiRequestEncryptionAlgResponse requestEncryptionAlg) {
        this.requestEncryptionAlg = requestEncryptionAlg;
        return this;
    }
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public ClientUpdateApiResponseBody withRequestEncryptionEnc(@Nullable ClientUpdateApiRequestEncryptionEncResponse requestEncryptionEnc) {
        this.requestEncryptionEnc = requestEncryptionEnc;
        return this;
    }
     ...
     * See [OpenID Connect Core 1.0, 6.2. Passing a Request Object by Reference](https://openid.net/specs/openid-connect-core-1_0.html#RequestUriParameter) for details.
     */
    public ClientUpdateApiResponseBody withRequestUris(@Nullable List<String> requestUris) {
        this.requestUris = requestUris;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientUpdateApiResponseBody withDefaultMaxAge(@Nullable Integer defaultMaxAge) {
        this.defaultMaxAge = defaultMaxAge;
        return this;
    }
     ...
     * in claims request parameter.
     */
    public ClientUpdateApiResponseBody withDefaultAcrs(@Nullable List<String> defaultAcrs) {
        this.defaultAcrs = defaultAcrs;
        return this;
    }
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public ClientUpdateApiResponseBody withIdTokenSignAlg(@Nullable ClientUpdateApiIdTokenSignAlgResponse idTokenSignAlg) {
        this.idTokenSignAlg = idTokenSignAlg;
        return this;
    }
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public ClientUpdateApiResponseBody withIdTokenEncryptionAlg(@Nullable ClientUpdateApiIdTokenEncryptionAlgResponse idTokenEncryptionAlg) {
        this.idTokenEncryptionAlg = idTokenEncryptionAlg;
        return this;
    }
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public ClientUpdateApiResponseBody withIdTokenEncryptionEnc(@Nullable ClientUpdateApiIdTokenEncryptionEncResponse idTokenEncryptionEnc) {
        this.idTokenEncryptionEnc = idTokenEncryptionEnc;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientUpdateApiResponseBody withAuthTimeRequired(@Nullable Boolean authTimeRequired) {
        this.authTimeRequired = authTimeRequired;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientUpdateApiResponseBody withSubjectType(@Nullable ClientUpdateApiSubjectTypeResponse subjectType) {
        this.subjectType = subjectType;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata)
     */
    public ClientUpdateApiResponseBody withSectorIdentifierUri(@Nullable String sectorIdentifierUri) {
        this.sectorIdentifierUri = sectorIdentifierUri;
        return this;
    }
     ...
     * are also registered, the value of this property is `null`.
     */
    public ClientUpdateApiResponseBody withDerivedSectorIdentifier(@Nullable String derivedSectorIdentifier) {
        this.derivedSectorIdentifier = derivedSectorIdentifier;
        return this;
    }
     ...
     * Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientUpdateApiResponseBody withJwksUri(@Nullable String jwksUri) {
        this.jwksUri = jwksUri;
        return this;
    }
     ...
     * Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientUpdateApiResponseBody withJwks(@Nullable String jwks) {
        this.jwks = jwks;
        return this;
    }
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public ClientUpdateApiResponseBody withUserInfoSignAlg(@Nullable ClientUpdateApiUserInfoSignAlgResponse userInfoSignAlg) {
        this.userInfoSignAlg = userInfoSignAlg;
        return this;
    }
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public ClientUpdateApiResponseBody withUserInfoEncryptionAlg(@Nullable ClientUpdateApiUserInfoEncryptionAlgResponse userInfoEncryptionAlg) {
        this.userInfoEncryptionAlg = userInfoEncryptionAlg;
        return this;
    }
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public ClientUpdateApiResponseBody withUserInfoEncryptionEnc(@Nullable ClientUpdateApiUserInfoEncryptionEncResponse userInfoEncryptionEnc) {
        this.userInfoEncryptionEnc = userInfoEncryptionEnc;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientUpdateApiResponseBody withLoginUri(@Nullable String loginUri) {
        this.loginUri = loginUri;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientUpdateApiResponseBody withTosUri(@Nullable String tosUri) {
        this.tosUri = tosUri;
        return this;
    }
     ...
     * this property can be used to register the URLs.
     */
    public ClientUpdateApiResponseBody withTosUris(@Nullable List<ClientUpdateApiTosUrisResponse> tosUris) {
        this.tosUris = tosUris;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientUpdateApiResponseBody withPolicyUri(@Nullable String policyUri) {
        this.policyUri = policyUri;
        return this;
    }
     ...
     * If the client application has different policy pages for different languages, this property can be used to register the URLs.
     */
    public ClientUpdateApiResponseBody withPolicyUris(@Nullable List<ClientUpdateApiPolicyUrisResponse> policyUris) {
        this.policyUris = policyUris;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientUpdateApiResponseBody withClientUri(@Nullable String clientUri) {
        this.clientUri = clientUri;
        return this;
    }
     ...
     * be used to register the URLs.
     */
    public ClientUpdateApiResponseBody withClientUris(@Nullable List<ClientUpdateApiClientUrisResponse> clientUris) {
        this.clientUris = clientUris;
        return this;
    }
     ...
     * Backchannel Authentication)".
     */
    public ClientUpdateApiResponseBody withBcDeliveryMode(@Nullable String bcDeliveryMode) {
        this.bcDeliveryMode = bcDeliveryMode;
        return this;
    }
     ...
     * Backchannel Authentication)".
     */
    public ClientUpdateApiResponseBody withBcNotificationEndpoint(@Nullable String bcNotificationEndpoint) {
        this.bcNotificationEndpoint = bcNotificationEndpoint;
        return this;
    }
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public ClientUpdateApiResponseBody withBcRequestSignAlg(@Nullable ClientUpdateApiBcRequestSignAlgResponse bcRequestSignAlg) {
        this.bcRequestSignAlg = bcRequestSignAlg;
        return this;
    }
     ...
     * <p>This property corresponds to the `backchannel_user_code_parameter` metadata.
     */
    public ClientUpdateApiResponseBody withBcUserCodeRequired(@Nullable Boolean bcUserCodeRequired) {
        this.bcUserCodeRequired = bcUserCodeRequired;
        return this;
    }
     ...
     * The attributes of this client.
     */
    public ClientUpdateApiResponseBody withAttributes(@Nullable List<ClientUpdateApiAttributeResponse> attributes) {
        this.attributes = attributes;
        return this;
    }


    public ClientUpdateApiResponseBody withExtension(@Nullable ClientUpdateApiExtensionResponse extension) {
        this.extension = extension;
        return this;
    }
     ...
     * to align with the change made by the 5th draft of the RAR specification.
     */
    public ClientUpdateApiResponseBody withAuthorizationDetailsTypes(@Nullable List<String> authorizationDetailsTypes) {
        this.authorizationDetailsTypes = authorizationDetailsTypes;
        return this;
    }
     ...
     * custom client metadata values can be referenced by this property.
     */
    public ClientUpdateApiResponseBody withCustomMetadata(@Nullable String customMetadata) {
        this.customMetadata = customMetadata;
        return this;
    }
     ...
     * flag of the service is `true`.
     */
    public ClientUpdateApiResponseBody withFrontChannelRequestObjectEncryptionRequired(@Nullable Boolean frontChannelRequestObjectEncryptionRequired) {
        this.frontChannelRequestObjectEncryptionRequired = frontChannelRequestObjectEncryptionRequired;
        return this;
    }
     ...
     * flag of the service is `true`.
     */
    public ClientUpdateApiResponseBody withRequestObjectEncryptionAlgMatchRequired(@Nullable Boolean requestObjectEncryptionAlgMatchRequired) {
        this.requestObjectEncryptionAlgMatchRequired = requestObjectEncryptionAlgMatchRequired;
        return this;
    }
     ...
     * flag of the service is `true`.
     */
    public ClientUpdateApiResponseBody withRequestObjectEncryptionEncMatchRequired(@Nullable Boolean requestObjectEncryptionEncMatchRequired) {
        this.requestObjectEncryptionEncMatchRequired = requestObjectEncryptionEncMatchRequired;
        return this;
    }
     ...
     * [OpenID Connect for Identity Assurance 1.0](https://openid.net/specs/openid-connect-4-identity-assurance-1_0.html).
     */
    public ClientUpdateApiResponseBody withDigestAlgorithm(@Nullable String digestAlgorithm) {
        this.digestAlgorithm = digestAlgorithm;
        return this;
    }
     ...
     * <p>Even if `Disabled` is selected here, single access token per subject is effective if `singleAccessTokenPerSubject` of the `Service` this client belongs to is Enabled.
     */
    public ClientUpdateApiResponseBody withSingleAccessTokenPerSubject(@Nullable Boolean singleAccessTokenPerSubject) {
        this.singleAccessTokenPerSubject = singleAccessTokenPerSubject;
        return this;
    }
     ...
     * <p>See [RFC 7636](https://tools.ietf.org/html/rfc7636) (Proof Key for Code Exchange by OAuth Public Clients) for details about `code_challenge` request parameter.
     */
    public ClientUpdateApiResponseBody withPkceRequired(@Nullable Boolean pkceRequired) {
        this.pkceRequired = pkceRequired;
        return this;
    }
     ...
     * Neither omission of the `code_challenge_method` request parameter nor use of plain (`code_challenge_method=plain`) is allowed.
     */
    public ClientUpdateApiResponseBody withPkceS256Required(@Nullable Boolean pkceS256Required) {
        this.pkceS256Required = pkceS256Required;
        return this;
    }
     ...
     * If the DPoP is required for this client
     */
    public ClientUpdateApiResponseBody withDpopRequired(@Nullable Boolean dpopRequired) {
        this.dpopRequired = dpopRequired;
        return this;
    }
     ...
     * "automatic" client registration of OIDC Federation.
     */
    public ClientUpdateApiResponseBody withAutomaticallyRegistered(@Nullable Boolean automaticallyRegistered) {
        this.automaticallyRegistered = automaticallyRegistered;
        return this;
    }
     ...
     * "explicit" client registration of OIDC Federation.
     */
    public ClientUpdateApiResponseBody withExplicitlyRegistered(@Nullable Boolean explicitlyRegistered) {
        this.explicitlyRegistered = explicitlyRegistered;
        return this;
    }
     ...
     * The flag indicating whether this service signs responses from the resource server.
     */
    public ClientUpdateApiResponseBody withRsRequestSigned(@Nullable Boolean rsRequestSigned) {
        this.rsRequestSigned = rsRequestSigned;
        return this;
    }
     ...
     * The key ID of a JWK containing the public key used by this client to sign requests to the resource server.
     */
    public ClientUpdateApiResponseBody withRsSignedRequestKeyId(@Nullable String rsSignedRequestKeyId) {
        this.rsSignedRequestKeyId = rsSignedRequestKeyId;
        return this;
    }
     ...
     * The client registration types that the client has declared it may use.
     */
    public ClientUpdateApiResponseBody withClientRegistrationTypes(@Nullable List<ClientUpdateApiClientRegistrationTypeResponse> clientRegistrationTypes) {
        this.clientRegistrationTypes = clientRegistrationTypes;
        return this;
    }
     ...
     * to the organization_name client metadata that is defined in OpenID Connect Federation 1.0.
     */
    public ClientUpdateApiResponseBody withOrganizationName(@Nullable String organizationName) {
        this.organizationName = organizationName;
        return this;
    }
     ...
     * corresponds to the `signed_jwks_uri` client metadata defined in OpenID Connect Federation 1.0.
     */
    public ClientUpdateApiResponseBody withSignedJwksUri(@Nullable String signedJwksUri) {
        this.signedJwksUri = signedJwksUri;
        return this;
    }
     ...
     * the entity ID of this client.
     */
    public ClientUpdateApiResponseBody withEntityId(@Nullable String entityId) {
        this.entityId = entityId;
        return this;
    }
     ...
     * the mechanism defined in OpenID Connect Federation 1.0
     */
    public ClientUpdateApiResponseBody withTrustAnchorId(@Nullable String trustAnchorId) {
        this.trustAnchorId = trustAnchorId;
        return this;
    }
     ...
     * OpenID Connect Federation 1.0
     */
    public ClientUpdateApiResponseBody withTrustChain(@Nullable List<String> trustChain) {
        this.trustChain = trustChain;
        return this;
    }
     ...
     * defined in OpenID Connect Federation 1.0. The value is represented as milliseconds elapsed since the Unix epoch (1970-01-01).
     */
    public ClientUpdateApiResponseBody withTrustChainExpiresAt(@Nullable Long trustChainExpiresAt) {
        this.trustChainExpiresAt = trustChainExpiresAt;
        return this;
    }
     ...
     * the time at which the trust chain was updated by the mechanism defined in OpenID Connect Federation 1.0
     */
    public ClientUpdateApiResponseBody withTrustChainUpdatedAt(@Nullable Long trustChainUpdatedAt) {
        this.trustChainUpdatedAt = trustChainUpdatedAt;
        return this;
    }
     ...
     * The flag which indicates whether this client is locked.
     */
    public ClientUpdateApiResponseBody withLocked(@Nullable Boolean locked) {
        this.locked = locked;
        return this;
    }
     ...
     * (wallet) receives a credential offer from the credential issuer.
     */
    public ClientUpdateApiResponseBody withCredentialOfferEndpoint(@Nullable String credentialOfferEndpoint) {
        this.credentialOfferEndpoint = credentialOfferEndpoint;
        return this;
    }
     ...
     * the service, and the FAPI modes for the service are set to `null`.
     */
    public ClientUpdateApiResponseBody withFapiModes(@Nullable List<ClientUpdateApiFapiModeResponse> fapiModes) {
        this.fapiModes = fapiModes;
        return this;
    }
     ...
     * The response modes that this client may use.
     */
    public ClientUpdateApiResponseBody withResponseModes(@Nullable List<ClientUpdateApiResponseModeResponse> responseModes) {
        this.responseModes = responseModes;
        return this;
    }
     ...
     * True if credential responses to this client must be always encrypted.
     */
    public ClientUpdateApiResponseBody withCredentialResponseEncryptionRequired(@Nullable Boolean credentialResponseEncryptionRequired) {
        this.credentialResponseEncryptionRequired = credentialResponseEncryptionRequired;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClientUpdateApiResponseBody other = (ClientUpdateApiResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ClientUpdateApiResponseBody.class,
                "number", number,
    ...
    public final static class Builder {
         ...
         * languages, this property can be used to register the names.
         */
        public Builder clientNames(@Nullable List<ClientUpdateApiClientNameResponse> clientNames) {
            this.clientNames = clientNames;
            return this;
        }
         ...
         * descriptions for different languages, this property can be used to register the descriptions.
         */
        public Builder descriptions(@Nullable List<ClientUpdateApiDescriptionResponse> descriptions) {
            this.descriptions = descriptions;
            return this;
        }
         ...
         * for details.
         */
        public Builder clientType(@Nullable ClientUpdateApiClientTypeResponse clientType) {
            this.clientType = clientType;
            return this;
        }
         ...
         * See the description about `redirectUris` property for more details.
         */
        public Builder applicationType(@Nullable ClientUpdateApiApplicationTypeResponse applicationType) {
            this.applicationType = applicationType;
            return this;
        }
         ...
         * different languages, this property can be used to register URLs of the images.
         */
        public Builder logoUris(@Nullable List<ClientUpdateApiLogoUrisResponse> logoUris) {
            this.logoUris = logoUris;
            return this;
        }
         ...
         * 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
         */
        public Builder grantTypes(@Nullable List<ClientUpdateApiGrantTypeResponse> grantTypes) {
            this.grantTypes = grantTypes;
            return this;
        }
         ...
         * 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
         */
        public Builder responseTypes(@Nullable List<ClientUpdateApiResponseTypeResponse> responseTypes) {
            this.responseTypes = responseTypes;
            return this;
        }
         ...
         *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
         */
        public Builder authorizationSignAlg(@Nullable ClientUpdateApiAuthorizationSignAlgResponse authorizationSignAlg) {
            this.authorizationSignAlg = authorizationSignAlg;
            return this;
        }
         ...
         * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
         */
        public Builder authorizationEncryptionAlg(@Nullable ClientUpdateApiAuthorizationEncryptionAlgResponse authorizationEncryptionAlg) {
            this.authorizationEncryptionAlg = authorizationEncryptionAlg;
            return this;
        }
         ...
         *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
         */
        public Builder authorizationEncryptionEnc(@Nullable ClientUpdateApiAuthorizationEncryptionEncResponse authorizationEncryptionEnc) {
            this.authorizationEncryptionEnc = authorizationEncryptionEnc;
            return this;
        }
         ...
         * Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
         */
        public Builder tokenAuthMethod(@Nullable ClientUpdateApiTokenAuthMethodResponse tokenAuthMethod) {
            this.tokenAuthMethod = tokenAuthMethod;
            return this;
        }
         ...
         *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
         */
        public Builder tokenAuthSignAlg(@Nullable ClientUpdateApiTokenAuthSignAlgResponse tokenAuthSignAlg) {
            this.tokenAuthSignAlg = tokenAuthSignAlg;
            return this;
        }
         ...
         *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
         */
        public Builder requestSignAlg(@Nullable ClientUpdateApiRequestSignAlgResponse requestSignAlg) {
            this.requestSignAlg = requestSignAlg;
            return this;
        }
         ...
         * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
         */
        public Builder requestEncryptionAlg(@Nullable ClientUpdateApiRequestEncryptionAlgResponse requestEncryptionAlg) {
            this.requestEncryptionAlg = requestEncryptionAlg;
            return this;
        }
         ...
         *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
         */
        public Builder requestEncryptionEnc(@Nullable ClientUpdateApiRequestEncryptionEncResponse requestEncryptionEnc) {
            this.requestEncryptionEnc = requestEncryptionEnc;
            return this;
        }
         ...
         *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
         */
        public Builder idTokenSignAlg(@Nullable ClientUpdateApiIdTokenSignAlgResponse idTokenSignAlg) {
            this.idTokenSignAlg = idTokenSignAlg;
            return this;
        }
         ...
         * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
         */
        public Builder idTokenEncryptionAlg(@Nullable ClientUpdateApiIdTokenEncryptionAlgResponse idTokenEncryptionAlg) {
            this.idTokenEncryptionAlg = idTokenEncryptionAlg;
            return this;
        }
         ...
         *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
         */
        public Builder idTokenEncryptionEnc(@Nullable ClientUpdateApiIdTokenEncryptionEncResponse idTokenEncryptionEnc) {
            this.idTokenEncryptionEnc = idTokenEncryptionEnc;
            return this;
        }
         ...
         * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
         */
        public Builder subjectType(@Nullable ClientUpdateApiSubjectTypeResponse subjectType) {
            this.subjectType = subjectType;
            return this;
        }
         ...
         *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
         */
        public Builder userInfoSignAlg(@Nullable ClientUpdateApiUserInfoSignAlgResponse userInfoSignAlg) {
            this.userInfoSignAlg = userInfoSignAlg;
            return this;
        }
         ...
         * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
         */
        public Builder userInfoEncryptionAlg(@Nullable ClientUpdateApiUserInfoEncryptionAlgResponse userInfoEncryptionAlg) {
            this.userInfoEncryptionAlg = userInfoEncryptionAlg;
            return this;
        }
         ...
         *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
         */
        public Builder userInfoEncryptionEnc(@Nullable ClientUpdateApiUserInfoEncryptionEncResponse userInfoEncryptionEnc) {
            this.userInfoEncryptionEnc = userInfoEncryptionEnc;
            return this;
        }
         ...
         * this property can be used to register the URLs.
         */
        public Builder tosUris(@Nullable List<ClientUpdateApiTosUrisResponse> tosUris) {
            this.tosUris = tosUris;
            return this;
        }
         ...
         * If the client application has different policy pages for different languages, this property can be used to register the URLs.
         */
        public Builder policyUris(@Nullable List<ClientUpdateApiPolicyUrisResponse> policyUris) {
            this.policyUris = policyUris;
            return this;
        }
         ...
         * be used to register the URLs.
         */
        public Builder clientUris(@Nullable List<ClientUpdateApiClientUrisResponse> clientUris) {
            this.clientUris = clientUris;
            return this;
        }
         ...
         *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
         */
        public Builder bcRequestSignAlg(@Nullable ClientUpdateApiBcRequestSignAlgResponse bcRequestSignAlg) {
            this.bcRequestSignAlg = bcRequestSignAlg;
            return this;
        }
         ...
         * The attributes of this client.
         */
        public Builder attributes(@Nullable List<ClientUpdateApiAttributeResponse> attributes) {
            this.attributes = attributes;
            return this;
        }

        public Builder extension(@Nullable ClientUpdateApiExtensionResponse extension) {
            this.extension = extension;
            return this;
        }
         ...
         * The client registration types that the client has declared it may use.
         */
        public Builder clientRegistrationTypes(@Nullable List<ClientUpdateApiClientRegistrationTypeResponse> clientRegistrationTypes) {
            this.clientRegistrationTypes = clientRegistrationTypes;
            return this;
        }
         ...
         * the service, and the FAPI modes for the service are set to `null`.
         */
        public Builder fapiModes(@Nullable List<ClientUpdateApiFapiModeResponse> fapiModes) {
            this.fapiModes = fapiModes;
            return this;
        }
         ...
         * The response modes that this client may use.
         */
        public Builder responseModes(@Nullable List<ClientUpdateApiResponseModeResponse> responseModes) {
            this.responseModes = responseModes;
            return this;
        }
        ...
        public ClientUpdateApiResponseBody build() {
            return new ClientUpdateApiResponseBody(
                number, serviceNumber, clientName,
                clientNames, description, descriptions,
                clientId, clientSecret, clientIdAlias,
                clientIdAliasEnabled, clientType, applicationType,
