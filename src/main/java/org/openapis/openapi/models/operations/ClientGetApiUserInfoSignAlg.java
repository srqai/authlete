 ...
 */
public enum ClientGetApiUserInfoSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientGetApiUserInfoSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientGetApiUserInfoSignAlg> fromValue(String value) {
        for (ClientGetApiUserInfoSignAlg o: ClientGetApiUserInfoSignAlg.values()) {
