...
public class ClientCreateApiRequestBody {
    /**
    ...
    private List<ClientCreateApiClientNameRequest> clientNames;
    ...
    private List<ClientCreateApiDescriptionRequest> descriptions;
    ...
    private ClientCreateApiClientTypeRequest clientType;
    ...
    private ClientCreateApiApplicationTypeRequest applicationType;
    ...
    private List<ClientCreateApiLogoUrisRequest> logoUris;
    ...
    private List<ClientCreateApiGrantTypeRequest> grantTypes;
    ...
    private List<ClientCreateApiResponseTypeRequest> responseTypes;
    ...
    private ClientCreateApiAuthorizationSignAlgRequest authorizationSignAlg;
    ...
    private ClientCreateApiAuthorizationEncryptionAlgRequest authorizationEncryptionAlg;
    ...
    private ClientCreateApiAuthorizationEncryptionEncRequest authorizationEncryptionEnc;
    ...
    private ClientCreateApiTokenAuthMethodRequest tokenAuthMethod;
    ...
    private ClientCreateApiTokenAuthSignAlgRequest tokenAuthSignAlg;
    ...
    private ClientCreateApiRequestSignAlgRequest requestSignAlg;
    ...
    private ClientCreateApiRequestEncryptionAlgRequest requestEncryptionAlg;
    ...
    private ClientCreateApiRequestEncryptionEncRequest requestEncryptionEnc;
    ...
    private ClientCreateApiIdTokenSignAlgRequest idTokenSignAlg;
    ...
    private ClientCreateApiIdTokenEncryptionAlgRequest idTokenEncryptionAlg;
    ...
    private ClientCreateApiIdTokenEncryptionEncRequest idTokenEncryptionEnc;
    ...
    private ClientCreateApiSubjectTypeRequest subjectType;
    ...
    private ClientCreateApiUserInfoSignAlgRequest userInfoSignAlg;
    ...
    private ClientCreateApiUserInfoEncryptionAlgRequest userInfoEncryptionAlg;
    ...
    private ClientCreateApiUserInfoEncryptionEncRequest userInfoEncryptionEnc;
    ...
    private List<ClientCreateApiTosUrisRequest> tosUris;
    ...
    private List<ClientCreateApiPolicyUrisRequest> policyUris;
    ...
    private List<ClientCreateApiClientUrisRequest> clientUris;
    ...
    private ClientCreateApiBcRequestSignAlgRequest bcRequestSignAlg;
    ...
    private List<ClientCreateApiAttributeRequest> attributes;


    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("extension")
    private ClientCreateApiExtensionRequest extension;
    ...
    private List<ClientCreateApiClientRegistrationTypeRequest> clientRegistrationTypes;
    ...
    private List<ClientCreateApiFapiModeRequest> fapiModes;
    ...
    private List<ClientCreateApiResponseModeRequest> responseModes;
    ...
    @JsonCreator
    public ClientCreateApiRequestBody(
            @JsonProperty("clientName") @Nullable String clientName,
            @JsonProperty("clientNames") @Nullable List<ClientCreateApiClientNameRequest> clientNames,
            @JsonProperty("description") @Nullable String description,
            @JsonProperty("descriptions") @Nullable List<ClientCreateApiDescriptionRequest> descriptions,
            ...
            @JsonProperty("clientType") @Nullable ClientCreateApiClientTypeRequest clientType,
            @JsonProperty("applicationType") @Nullable ClientCreateApiApplicationTypeRequest applicationType,
            @JsonProperty("logoUri") @Nullable String logoUri,
            @JsonProperty("logoUris") @Nullable List<ClientCreateApiLogoUrisRequest> logoUris,
            ...
            @JsonProperty("grantTypes") @Nullable List<ClientCreateApiGrantTypeRequest> grantTypes,
            @JsonProperty("responseTypes") @Nullable List<ClientCreateApiResponseTypeRequest> responseTypes,
            @JsonProperty("redirectUris") @Nullable List<String> redirectUris,
            @JsonProperty("authorizationSignAlg") @Nullable ClientCreateApiAuthorizationSignAlgRequest authorizationSignAlg,
            @JsonProperty("authorizationEncryptionAlg") @Nullable ClientCreateApiAuthorizationEncryptionAlgRequest authorizationEncryptionAlg,
            @JsonProperty("authorizationEncryptionEnc") @Nullable ClientCreateApiAuthorizationEncryptionEncRequest authorizationEncryptionEnc,
            @JsonProperty("tokenAuthMethod") @Nullable ClientCreateApiTokenAuthMethodRequest tokenAuthMethod,
            @JsonProperty("tokenAuthSignAlg") @Nullable ClientCreateApiTokenAuthSignAlgRequest tokenAuthSignAlg,
            ...
            @JsonProperty("requestSignAlg") @Nullable ClientCreateApiRequestSignAlgRequest requestSignAlg,
            @JsonProperty("requestEncryptionAlg") @Nullable ClientCreateApiRequestEncryptionAlgRequest requestEncryptionAlg,
            @JsonProperty("requestEncryptionEnc") @Nullable ClientCreateApiRequestEncryptionEncRequest requestEncryptionEnc,
            ...
            @JsonProperty("idTokenSignAlg") @Nullable ClientCreateApiIdTokenSignAlgRequest idTokenSignAlg,
            @JsonProperty("idTokenEncryptionAlg") @Nullable ClientCreateApiIdTokenEncryptionAlgRequest idTokenEncryptionAlg,
            @JsonProperty("idTokenEncryptionEnc") @Nullable ClientCreateApiIdTokenEncryptionEncRequest idTokenEncryptionEnc,
            @JsonProperty("authTimeRequired") @Nullable Boolean authTimeRequired,
            @JsonProperty("subjectType") @Nullable ClientCreateApiSubjectTypeRequest subjectType,
            ...
            @JsonProperty("userInfoSignAlg") @Nullable ClientCreateApiUserInfoSignAlgRequest userInfoSignAlg,
            @JsonProperty("userInfoEncryptionAlg") @Nullable ClientCreateApiUserInfoEncryptionAlgRequest userInfoEncryptionAlg,
            @JsonProperty("userInfoEncryptionEnc") @Nullable ClientCreateApiUserInfoEncryptionEncRequest userInfoEncryptionEnc,
            @JsonProperty("loginUri") @Nullable String loginUri,
            @JsonProperty("tosUri") @Nullable String tosUri,
            @JsonProperty("tosUris") @Nullable List<ClientCreateApiTosUrisRequest> tosUris,
            @JsonProperty("policyUri") @Nullable String policyUri,
            @JsonProperty("policyUris") @Nullable List<ClientCreateApiPolicyUrisRequest> policyUris,
            @JsonProperty("clientUri") @Nullable String clientUri,
            @JsonProperty("clientUris") @Nullable List<ClientCreateApiClientUrisRequest> clientUris,
            ...
            @JsonProperty("bcRequestSignAlg") @Nullable ClientCreateApiBcRequestSignAlgRequest bcRequestSignAlg,
            @JsonProperty("bcUserCodeRequired") @Nullable Boolean bcUserCodeRequired,
            @JsonProperty("attributes") @Nullable List<ClientCreateApiAttributeRequest> attributes,
            @JsonProperty("extension") @Nullable ClientCreateApiExtensionRequest extension,
            ...
            @JsonProperty("clientRegistrationTypes") @Nullable List<ClientCreateApiClientRegistrationTypeRequest> clientRegistrationTypes,
            ...
            @JsonProperty("fapiModes") @Nullable List<ClientCreateApiFapiModeRequest> fapiModes,
            @JsonProperty("responseModes") @Nullable List<ClientCreateApiResponseModeRequest> responseModes,
     ...
     * languages, this property can be used to register the names.
     */
    public Optional<List<ClientCreateApiClientNameRequest>> clientNames() {
     ...
     * descriptions for different languages, this property can be used to register the descriptions.
     */
    public Optional<List<ClientCreateApiDescriptionRequest>> descriptions() {
     ...
     * for details.
     */
    public Optional<ClientCreateApiClientTypeRequest> clientType() {
     ...
     * See the description about `redirectUris` property for more details.
     */
    public Optional<ClientCreateApiApplicationTypeRequest> applicationType() {
     ...
     * different languages, this property can be used to register URLs of the images.
     */
    public Optional<List<ClientCreateApiLogoUrisRequest>> logoUris() {
     ...
     * 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public Optional<List<ClientCreateApiGrantTypeRequest>> grantTypes() {
     ...
     * 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public Optional<List<ClientCreateApiResponseTypeRequest>> responseTypes() {
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public Optional<ClientCreateApiAuthorizationSignAlgRequest> authorizationSignAlg() {
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public Optional<ClientCreateApiAuthorizationEncryptionAlgRequest> authorizationEncryptionAlg() {
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public Optional<ClientCreateApiAuthorizationEncryptionEncRequest> authorizationEncryptionEnc() {
     ...
     * Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public Optional<ClientCreateApiTokenAuthMethodRequest> tokenAuthMethod() {
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public Optional<ClientCreateApiTokenAuthSignAlgRequest> tokenAuthSignAlg() {
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public Optional<ClientCreateApiRequestSignAlgRequest> requestSignAlg() {
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public Optional<ClientCreateApiRequestEncryptionAlgRequest> requestEncryptionAlg() {
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public Optional<ClientCreateApiRequestEncryptionEncRequest> requestEncryptionEnc() {
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public Optional<ClientCreateApiIdTokenSignAlgRequest> idTokenSignAlg() {
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public Optional<ClientCreateApiIdTokenEncryptionAlgRequest> idTokenEncryptionAlg() {
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public Optional<ClientCreateApiIdTokenEncryptionEncRequest> idTokenEncryptionEnc() {
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public Optional<ClientCreateApiSubjectTypeRequest> subjectType() {
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public Optional<ClientCreateApiUserInfoSignAlgRequest> userInfoSignAlg() {
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public Optional<ClientCreateApiUserInfoEncryptionAlgRequest> userInfoEncryptionAlg() {
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public Optional<ClientCreateApiUserInfoEncryptionEncRequest> userInfoEncryptionEnc() {
     ...
     * this property can be used to register the URLs.
     */
    public Optional<List<ClientCreateApiTosUrisRequest>> tosUris() {
     ...
     * If the client application has different policy pages for different languages, this property can be used to register the URLs.
     */
    public Optional<List<ClientCreateApiPolicyUrisRequest>> policyUris() {
     ...
     * be used to register the URLs.
     */
    public Optional<List<ClientCreateApiClientUrisRequest>> clientUris() {
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public Optional<ClientCreateApiBcRequestSignAlgRequest> bcRequestSignAlg() {
     ...
     * The attributes of this client.
     */
    public Optional<List<ClientCreateApiAttributeRequest>> attributes() {
        return Optional.ofNullable(this.attributes);
    }

    public Optional<ClientCreateApiExtensionRequest> extension() {
     ...
     * The client registration types that the client has declared it may use.
     */
    public Optional<List<ClientCreateApiClientRegistrationTypeRequest>> clientRegistrationTypes() {
     ...
     * the service, and the FAPI modes for the service are set to `null`.
     */
    public Optional<List<ClientCreateApiFapiModeRequest>> fapiModes() {
     ...
     * The response modes that this client may use.
     */
    public Optional<List<ClientCreateApiResponseModeRequest>> responseModes() {
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientCreateApiRequestBody withClientName(@Nullable String clientName) {
        this.clientName = clientName;
        return this;
    }
     ...
     * languages, this property can be used to register the names.
     */
    public ClientCreateApiRequestBody withClientNames(@Nullable List<ClientCreateApiClientNameRequest> clientNames) {
        this.clientNames = clientNames;
        return this;
    }
     ...
     * The description about the client application.
     */
    public ClientCreateApiRequestBody withDescription(@Nullable String description) {
        this.description = description;
        return this;
    }
     ...
     * descriptions for different languages, this property can be used to register the descriptions.
     */
    public ClientCreateApiRequestBody withDescriptions(@Nullable List<ClientCreateApiDescriptionRequest> descriptions) {
        this.descriptions = descriptions;
        return this;
    }
     ...
     * default, this is a string version of the `clientId` property.
     */
    public ClientCreateApiRequestBody withClientIdAlias(@Nullable String clientIdAlias) {
        this.clientIdAlias = clientIdAlias;
        return this;
    }
     ...
     * Deprecated. Always set to `true`.
     */
    public ClientCreateApiRequestBody withClientIdAliasEnabled(@Nullable Boolean clientIdAliasEnabled) {
        this.clientIdAliasEnabled = clientIdAliasEnabled;
        return this;
    }
     ...
     * for details.
     */
    public ClientCreateApiRequestBody withClientType(@Nullable ClientCreateApiClientTypeRequest clientType) {
        this.clientType = clientType;
        return this;
    }
     ...
     * See the description about `redirectUris` property for more details.
     */
    public ClientCreateApiRequestBody withApplicationType(@Nullable ClientCreateApiApplicationTypeRequest applicationType) {
        this.applicationType = applicationType;
        return this;
    }
     ...
     * Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientCreateApiRequestBody withLogoUri(@Nullable String logoUri) {
        this.logoUri = logoUri;
        return this;
    }
     ...
     * different languages, this property can be used to register URLs of the images.
     */
    public ClientCreateApiRequestBody withLogoUris(@Nullable List<ClientCreateApiLogoUrisRequest> logoUris) {
        this.logoUris = logoUris;
        return this;
    }
     ...
     * Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientCreateApiRequestBody withContacts(@Nullable List<String> contacts) {
        this.contacts = contacts;
        return this;
    }
     ...
     * The flag to indicate whether this client use TLS client certificate bound access tokens.
     */
    public ClientCreateApiRequestBody withTlsClientCertificateBoundAccessTokens(@Nullable Boolean tlsClientCertificateBoundAccessTokens) {
        this.tlsClientCertificateBoundAccessTokens = tlsClientCertificateBoundAccessTokens;
        return this;
    }
     ...
     * of [RFC 7591](https://datatracker.ietf.org/doc/html/rfc7591).
     */
    public ClientCreateApiRequestBody withSoftwareId(@Nullable String softwareId) {
        this.softwareId = softwareId;
        return this;
    }
     ...
     * of [RFC 7591](https://datatracker.ietf.org/doc/html/rfc7591).
     */
    public ClientCreateApiRequestBody withSoftwareVersion(@Nullable String softwareVersion) {
        this.softwareVersion = softwareVersion;
        return this;
    }
     ...
     * The hash of the registration access token for this client.
     */
    public ClientCreateApiRequestBody withRegistrationAccessTokenHash(@Nullable String registrationAccessTokenHash) {
        this.registrationAccessTokenHash = registrationAccessTokenHash;
        return this;
    }
     ...
     * 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientCreateApiRequestBody withGrantTypes(@Nullable List<ClientCreateApiGrantTypeRequest> grantTypes) {
        this.grantTypes = grantTypes;
        return this;
    }
     ...
     * 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientCreateApiRequestBody withResponseTypes(@Nullable List<ClientCreateApiResponseTypeRequest> responseTypes) {
        this.responseTypes = responseTypes;
        return this;
    }
     ...
     * details), but OpenID Connect requires exact match.
     */
    public ClientCreateApiRequestBody withRedirectUris(@Nullable List<String> redirectUris) {
        this.redirectUris = redirectUris;
        return this;
    }
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public ClientCreateApiRequestBody withAuthorizationSignAlg(@Nullable ClientCreateApiAuthorizationSignAlgRequest authorizationSignAlg) {
        this.authorizationSignAlg = authorizationSignAlg;
        return this;
    }
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public ClientCreateApiRequestBody withAuthorizationEncryptionAlg(@Nullable ClientCreateApiAuthorizationEncryptionAlgRequest authorizationEncryptionAlg) {
        this.authorizationEncryptionAlg = authorizationEncryptionAlg;
        return this;
    }
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public ClientCreateApiRequestBody withAuthorizationEncryptionEnc(@Nullable ClientCreateApiAuthorizationEncryptionEncRequest authorizationEncryptionEnc) {
        this.authorizationEncryptionEnc = authorizationEncryptionEnc;
        return this;
    }
     ...
     * Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientCreateApiRequestBody withTokenAuthMethod(@Nullable ClientCreateApiTokenAuthMethodRequest tokenAuthMethod) {
        this.tokenAuthMethod = tokenAuthMethod;
        return this;
    }
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public ClientCreateApiRequestBody withTokenAuthSignAlg(@Nullable ClientCreateApiTokenAuthSignAlgRequest tokenAuthSignAlg) {
        this.tokenAuthSignAlg = tokenAuthSignAlg;
        return this;
    }
     ...
     * The key ID of a JWK containing a self-signed certificate of this client.
     */
    public ClientCreateApiRequestBody withSelfSignedCertificateKeyId(@Nullable String selfSignedCertificateKeyId) {
        this.selfSignedCertificateKeyId = selfSignedCertificateKeyId;
        return this;
    }
     ...
     * Registration" for details.
     */
    public ClientCreateApiRequestBody withTlsClientAuthSubjectDn(@Nullable String tlsClientAuthSubjectDn) {
        this.tlsClientAuthSubjectDn = tlsClientAuthSubjectDn;
        return this;
    }
     ...
     * Registration" for details.
     */
    public ClientCreateApiRequestBody withTlsClientAuthSanDns(@Nullable String tlsClientAuthSanDns) {
        this.tlsClientAuthSanDns = tlsClientAuthSanDns;
        return this;
    }
     ...
     * Registration" for details.
     */
    public ClientCreateApiRequestBody withTlsClientAuthSanUri(@Nullable String tlsClientAuthSanUri) {
        this.tlsClientAuthSanUri = tlsClientAuthSanUri;
        return this;
    }
     ...
     * Registration" for details.
     */
    public ClientCreateApiRequestBody withTlsClientAuthSanIp(@Nullable String tlsClientAuthSanIp) {
        this.tlsClientAuthSanIp = tlsClientAuthSanIp;
        return this;
    }
     ...
     * Registration" for details.
     */
    public ClientCreateApiRequestBody withTlsClientAuthSanEmail(@Nullable String tlsClientAuthSanEmail) {
        this.tlsClientAuthSanEmail = tlsClientAuthSanEmail;
        return this;
    }
     ...
     * in "OAuth 2.0 Pushed Authorization Requests".
     */
    public ClientCreateApiRequestBody withParRequired(@Nullable Boolean parRequired) {
        this.parRequired = parRequired;
        return this;
    }
     ...
     * client metadata of this client is `true`. The metadata is defined in "JAR (JWT Secured Authorization Request)".
     */
    public ClientCreateApiRequestBody withRequestObjectRequired(@Nullable Boolean requestObjectRequired) {
        this.requestObjectRequired = requestObjectRequired;
        return this;
    }
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public ClientCreateApiRequestBody withRequestSignAlg(@Nullable ClientCreateApiRequestSignAlgRequest requestSignAlg) {
        this.requestSignAlg = requestSignAlg;
        return this;
    }
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public ClientCreateApiRequestBody withRequestEncryptionAlg(@Nullable ClientCreateApiRequestEncryptionAlgRequest requestEncryptionAlg) {
        this.requestEncryptionAlg = requestEncryptionAlg;
        return this;
    }
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public ClientCreateApiRequestBody withRequestEncryptionEnc(@Nullable ClientCreateApiRequestEncryptionEncRequest requestEncryptionEnc) {
        this.requestEncryptionEnc = requestEncryptionEnc;
        return this;
    }
     ...
     * See [OpenID Connect Core 1.0, 6.2. Passing a Request Object by Reference](https://openid.net/specs/openid-connect-core-1_0.html#RequestUriParameter) for details.
     */
    public ClientCreateApiRequestBody withRequestUris(@Nullable List<String> requestUris) {
        this.requestUris = requestUris;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientCreateApiRequestBody withDefaultMaxAge(@Nullable Integer defaultMaxAge) {
        this.defaultMaxAge = defaultMaxAge;
        return this;
    }
     ...
     * in claims request parameter.
     */
    public ClientCreateApiRequestBody withDefaultAcrs(@Nullable List<String> defaultAcrs) {
        this.defaultAcrs = defaultAcrs;
        return this;
    }
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public ClientCreateApiRequestBody withIdTokenSignAlg(@Nullable ClientCreateApiIdTokenSignAlgRequest idTokenSignAlg) {
        this.idTokenSignAlg = idTokenSignAlg;
        return this;
    }
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public ClientCreateApiRequestBody withIdTokenEncryptionAlg(@Nullable ClientCreateApiIdTokenEncryptionAlgRequest idTokenEncryptionAlg) {
        this.idTokenEncryptionAlg = idTokenEncryptionAlg;
        return this;
    }
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public ClientCreateApiRequestBody withIdTokenEncryptionEnc(@Nullable ClientCreateApiIdTokenEncryptionEncRequest idTokenEncryptionEnc) {
        this.idTokenEncryptionEnc = idTokenEncryptionEnc;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientCreateApiRequestBody withAuthTimeRequired(@Nullable Boolean authTimeRequired) {
        this.authTimeRequired = authTimeRequired;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientCreateApiRequestBody withSubjectType(@Nullable ClientCreateApiSubjectTypeRequest subjectType) {
        this.subjectType = subjectType;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata)
     */
    public ClientCreateApiRequestBody withSectorIdentifierUri(@Nullable String sectorIdentifierUri) {
        this.sectorIdentifierUri = sectorIdentifierUri;
        return this;
    }
     ...
     * Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientCreateApiRequestBody withJwksUri(@Nullable String jwksUri) {
        this.jwksUri = jwksUri;
        return this;
    }
     ...
     * Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientCreateApiRequestBody withJwks(@Nullable String jwks) {
        this.jwks = jwks;
        return this;
    }
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public ClientCreateApiRequestBody withUserInfoSignAlg(@Nullable ClientCreateApiUserInfoSignAlgRequest userInfoSignAlg) {
        this.userInfoSignAlg = userInfoSignAlg;
        return this;
    }
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public ClientCreateApiRequestBody withUserInfoEncryptionAlg(@Nullable ClientCreateApiUserInfoEncryptionAlgRequest userInfoEncryptionAlg) {
        this.userInfoEncryptionAlg = userInfoEncryptionAlg;
        return this;
    }
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public ClientCreateApiRequestBody withUserInfoEncryptionEnc(@Nullable ClientCreateApiUserInfoEncryptionEncRequest userInfoEncryptionEnc) {
        this.userInfoEncryptionEnc = userInfoEncryptionEnc;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientCreateApiRequestBody withLoginUri(@Nullable String loginUri) {
        this.loginUri = loginUri;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientCreateApiRequestBody withTosUri(@Nullable String tosUri) {
        this.tosUri = tosUri;
        return this;
    }
     ...
     * this property can be used to register the URLs.
     */
    public ClientCreateApiRequestBody withTosUris(@Nullable List<ClientCreateApiTosUrisRequest> tosUris) {
        this.tosUris = tosUris;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientCreateApiRequestBody withPolicyUri(@Nullable String policyUri) {
        this.policyUri = policyUri;
        return this;
    }
     ...
     * If the client application has different policy pages for different languages, this property can be used to register the URLs.
     */
    public ClientCreateApiRequestBody withPolicyUris(@Nullable List<ClientCreateApiPolicyUrisRequest> policyUris) {
        this.policyUris = policyUris;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientCreateApiRequestBody withClientUri(@Nullable String clientUri) {
        this.clientUri = clientUri;
        return this;
    }
     ...
     * be used to register the URLs.
     */
    public ClientCreateApiRequestBody withClientUris(@Nullable List<ClientCreateApiClientUrisRequest> clientUris) {
        this.clientUris = clientUris;
        return this;
    }
     ...
     * Backchannel Authentication)".
     */
    public ClientCreateApiRequestBody withBcDeliveryMode(@Nullable String bcDeliveryMode) {
        this.bcDeliveryMode = bcDeliveryMode;
        return this;
    }
     ...
     * Backchannel Authentication)".
     */
    public ClientCreateApiRequestBody withBcNotificationEndpoint(@Nullable String bcNotificationEndpoint) {
        this.bcNotificationEndpoint = bcNotificationEndpoint;
        return this;
    }
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public ClientCreateApiRequestBody withBcRequestSignAlg(@Nullable ClientCreateApiBcRequestSignAlgRequest bcRequestSignAlg) {
        this.bcRequestSignAlg = bcRequestSignAlg;
        return this;
    }
     ...
     * <p>This property corresponds to the `backchannel_user_code_parameter` metadata.
     */
    public ClientCreateApiRequestBody withBcUserCodeRequired(@Nullable Boolean bcUserCodeRequired) {
        this.bcUserCodeRequired = bcUserCodeRequired;
        return this;
    }
     ...
     * The attributes of this client.
     */
    public ClientCreateApiRequestBody withAttributes(@Nullable List<ClientCreateApiAttributeRequest> attributes) {
        this.attributes = attributes;
        return this;
    }


    public ClientCreateApiRequestBody withExtension(@Nullable ClientCreateApiExtensionRequest extension) {
        this.extension = extension;
        return this;
    }
     ...
     * to align with the change made by the 5th draft of the RAR specification.
     */
    public ClientCreateApiRequestBody withAuthorizationDetailsTypes(@Nullable List<String> authorizationDetailsTypes) {
        this.authorizationDetailsTypes = authorizationDetailsTypes;
        return this;
    }
     ...
     * custom client metadata values can be referenced by this property.
     */
    public ClientCreateApiRequestBody withCustomMetadata(@Nullable String customMetadata) {
        this.customMetadata = customMetadata;
        return this;
    }
     ...
     * flag of the service is `true`.
     */
    public ClientCreateApiRequestBody withFrontChannelRequestObjectEncryptionRequired(@Nullable Boolean frontChannelRequestObjectEncryptionRequired) {
        this.frontChannelRequestObjectEncryptionRequired = frontChannelRequestObjectEncryptionRequired;
        return this;
    }
     ...
     * flag of the service is `true`.
     */
    public ClientCreateApiRequestBody withRequestObjectEncryptionAlgMatchRequired(@Nullable Boolean requestObjectEncryptionAlgMatchRequired) {
        this.requestObjectEncryptionAlgMatchRequired = requestObjectEncryptionAlgMatchRequired;
        return this;
    }
     ...
     * flag of the service is `true`.
     */
    public ClientCreateApiRequestBody withRequestObjectEncryptionEncMatchRequired(@Nullable Boolean requestObjectEncryptionEncMatchRequired) {
        this.requestObjectEncryptionEncMatchRequired = requestObjectEncryptionEncMatchRequired;
        return this;
    }
     ...
     * [OpenID Connect for Identity Assurance 1.0](https://openid.net/specs/openid-connect-4-identity-assurance-1_0.html).
     */
    public ClientCreateApiRequestBody withDigestAlgorithm(@Nullable String digestAlgorithm) {
        this.digestAlgorithm = digestAlgorithm;
        return this;
    }
     ...
     * <p>Even if `Disabled` is selected here, single access token per subject is effective if `singleAccessTokenPerSubject` of the `Service` this client belongs to is Enabled.
     */
    public ClientCreateApiRequestBody withSingleAccessTokenPerSubject(@Nullable Boolean singleAccessTokenPerSubject) {
        this.singleAccessTokenPerSubject = singleAccessTokenPerSubject;
        return this;
    }
     ...
     * <p>See [RFC 7636](https://tools.ietf.org/html/rfc7636) (Proof Key for Code Exchange by OAuth Public Clients) for details about `code_challenge` request parameter.
     */
    public ClientCreateApiRequestBody withPkceRequired(@Nullable Boolean pkceRequired) {
        this.pkceRequired = pkceRequired;
        return this;
    }
     ...
     * Neither omission of the `code_challenge_method` request parameter nor use of plain (`code_challenge_method=plain`) is allowed.
     */
    public ClientCreateApiRequestBody withPkceS256Required(@Nullable Boolean pkceS256Required) {
        this.pkceS256Required = pkceS256Required;
        return this;
    }
     ...
     * If the DPoP is required for this client
     */
    public ClientCreateApiRequestBody withDpopRequired(@Nullable Boolean dpopRequired) {
        this.dpopRequired = dpopRequired;
        return this;
    }
     ...
     * "automatic" client registration of OIDC Federation.
     */
    public ClientCreateApiRequestBody withAutomaticallyRegistered(@Nullable Boolean automaticallyRegistered) {
        this.automaticallyRegistered = automaticallyRegistered;
        return this;
    }
     ...
     * "explicit" client registration of OIDC Federation.
     */
    public ClientCreateApiRequestBody withExplicitlyRegistered(@Nullable Boolean explicitlyRegistered) {
        this.explicitlyRegistered = explicitlyRegistered;
        return this;
    }
     ...
     * The flag indicating whether this service signs responses from the resource server.
     */
    public ClientCreateApiRequestBody withRsRequestSigned(@Nullable Boolean rsRequestSigned) {
        this.rsRequestSigned = rsRequestSigned;
        return this;
    }
     ...
     * The key ID of a JWK containing the public key used by this client to sign requests to the resource server.
     */
    public ClientCreateApiRequestBody withRsSignedRequestKeyId(@Nullable String rsSignedRequestKeyId) {
        this.rsSignedRequestKeyId = rsSignedRequestKeyId;
        return this;
    }
     ...
     * The client registration types that the client has declared it may use.
     */
    public ClientCreateApiRequestBody withClientRegistrationTypes(@Nullable List<ClientCreateApiClientRegistrationTypeRequest> clientRegistrationTypes) {
        this.clientRegistrationTypes = clientRegistrationTypes;
        return this;
    }
     ...
     * to the organization_name client metadata that is defined in OpenID Connect Federation 1.0.
     */
    public ClientCreateApiRequestBody withOrganizationName(@Nullable String organizationName) {
        this.organizationName = organizationName;
        return this;
    }
     ...
     * corresponds to the `signed_jwks_uri` client metadata defined in OpenID Connect Federation 1.0.
     */
    public ClientCreateApiRequestBody withSignedJwksUri(@Nullable String signedJwksUri) {
        this.signedJwksUri = signedJwksUri;
        return this;
    }
     ...
     * the entity ID of this client.
     */
    public ClientCreateApiRequestBody withEntityId(@Nullable String entityId) {
        this.entityId = entityId;
        return this;
    }
     ...
     * the mechanism defined in OpenID Connect Federation 1.0
     */
    public ClientCreateApiRequestBody withTrustAnchorId(@Nullable String trustAnchorId) {
        this.trustAnchorId = trustAnchorId;
        return this;
    }
     ...
     * OpenID Connect Federation 1.0
     */
    public ClientCreateApiRequestBody withTrustChain(@Nullable List<String> trustChain) {
        this.trustChain = trustChain;
        return this;
    }
     ...
     * defined in OpenID Connect Federation 1.0. The value is represented as milliseconds elapsed since the Unix epoch (1970-01-01).
     */
    public ClientCreateApiRequestBody withTrustChainExpiresAt(@Nullable Long trustChainExpiresAt) {
        this.trustChainExpiresAt = trustChainExpiresAt;
        return this;
    }
     ...
     * the time at which the trust chain was updated by the mechanism defined in OpenID Connect Federation 1.0
     */
    public ClientCreateApiRequestBody withTrustChainUpdatedAt(@Nullable Long trustChainUpdatedAt) {
        this.trustChainUpdatedAt = trustChainUpdatedAt;
        return this;
    }
     ...
     * The flag which indicates whether this client is locked.
     */
    public ClientCreateApiRequestBody withLocked(@Nullable Boolean locked) {
        this.locked = locked;
        return this;
    }
     ...
     * (wallet) receives a credential offer from the credential issuer.
     */
    public ClientCreateApiRequestBody withCredentialOfferEndpoint(@Nullable String credentialOfferEndpoint) {
        this.credentialOfferEndpoint = credentialOfferEndpoint;
        return this;
    }
     ...
     * the service, and the FAPI modes for the service are set to `null`.
     */
    public ClientCreateApiRequestBody withFapiModes(@Nullable List<ClientCreateApiFapiModeRequest> fapiModes) {
        this.fapiModes = fapiModes;
        return this;
    }
     ...
     * The response modes that this client may use.
     */
    public ClientCreateApiRequestBody withResponseModes(@Nullable List<ClientCreateApiResponseModeRequest> responseModes) {
        this.responseModes = responseModes;
        return this;
    }
     ...
     * True if credential responses to this client must be always encrypted.
     */
    public ClientCreateApiRequestBody withCredentialResponseEncryptionRequired(@Nullable Boolean credentialResponseEncryptionRequired) {
        this.credentialResponseEncryptionRequired = credentialResponseEncryptionRequired;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClientCreateApiRequestBody other = (ClientCreateApiRequestBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ClientCreateApiRequestBody.class,
    ...
    public final static class Builder {
         ...
         * languages, this property can be used to register the names.
         */
        public Builder clientNames(@Nullable List<ClientCreateApiClientNameRequest> clientNames) {
            this.clientNames = clientNames;
            return this;
        }
         ...
         * descriptions for different languages, this property can be used to register the descriptions.
         */
        public Builder descriptions(@Nullable List<ClientCreateApiDescriptionRequest> descriptions) {
            this.descriptions = descriptions;
            return this;
        }
         ...
         * for details.
         */
        public Builder clientType(@Nullable ClientCreateApiClientTypeRequest clientType) {
            this.clientType = clientType;
            return this;
        }
         ...
         * See the description about `redirectUris` property for more details.
         */
        public Builder applicationType(@Nullable ClientCreateApiApplicationTypeRequest applicationType) {
            this.applicationType = applicationType;
            return this;
        }
         ...
         * different languages, this property can be used to register URLs of the images.
         */
        public Builder logoUris(@Nullable List<ClientCreateApiLogoUrisRequest> logoUris) {
            this.logoUris = logoUris;
            return this;
        }
         ...
         * 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
         */
        public Builder grantTypes(@Nullable List<ClientCreateApiGrantTypeRequest> grantTypes) {
            this.grantTypes = grantTypes;
            return this;
        }
         ...
         * 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
         */
        public Builder responseTypes(@Nullable List<ClientCreateApiResponseTypeRequest> responseTypes) {
            this.responseTypes = responseTypes;
            return this;
        }
         ...
         *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
         */
        public Builder authorizationSignAlg(@Nullable ClientCreateApiAuthorizationSignAlgRequest authorizationSignAlg) {
            this.authorizationSignAlg = authorizationSignAlg;
            return this;
        }
         ...
         * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
         */
        public Builder authorizationEncryptionAlg(@Nullable ClientCreateApiAuthorizationEncryptionAlgRequest authorizationEncryptionAlg) {
            this.authorizationEncryptionAlg = authorizationEncryptionAlg;
            return this;
        }
         ...
         *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
         */
        public Builder authorizationEncryptionEnc(@Nullable ClientCreateApiAuthorizationEncryptionEncRequest authorizationEncryptionEnc) {
            this.authorizationEncryptionEnc = authorizationEncryptionEnc;
            return this;
        }
         ...
         * Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
         */
        public Builder tokenAuthMethod(@Nullable ClientCreateApiTokenAuthMethodRequest tokenAuthMethod) {
            this.tokenAuthMethod = tokenAuthMethod;
            return this;
        }
         ...
         *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
         */
        public Builder tokenAuthSignAlg(@Nullable ClientCreateApiTokenAuthSignAlgRequest tokenAuthSignAlg) {
            this.tokenAuthSignAlg = tokenAuthSignAlg;
            return this;
        }
         ...
         *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
         */
        public Builder requestSignAlg(@Nullable ClientCreateApiRequestSignAlgRequest requestSignAlg) {
            this.requestSignAlg = requestSignAlg;
            return this;
        }
         ...
         * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
         */
        public Builder requestEncryptionAlg(@Nullable ClientCreateApiRequestEncryptionAlgRequest requestEncryptionAlg) {
            this.requestEncryptionAlg = requestEncryptionAlg;
            return this;
        }
         ...
         *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
         */
        public Builder requestEncryptionEnc(@Nullable ClientCreateApiRequestEncryptionEncRequest requestEncryptionEnc) {
            this.requestEncryptionEnc = requestEncryptionEnc;
            return this;
        }
         ...
         *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
         */
        public Builder idTokenSignAlg(@Nullable ClientCreateApiIdTokenSignAlgRequest idTokenSignAlg) {
            this.idTokenSignAlg = idTokenSignAlg;
            return this;
        }
         ...
         * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
         */
        public Builder idTokenEncryptionAlg(@Nullable ClientCreateApiIdTokenEncryptionAlgRequest idTokenEncryptionAlg) {
            this.idTokenEncryptionAlg = idTokenEncryptionAlg;
            return this;
        }
         ...
         *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
         */
        public Builder idTokenEncryptionEnc(@Nullable ClientCreateApiIdTokenEncryptionEncRequest idTokenEncryptionEnc) {
            this.idTokenEncryptionEnc = idTokenEncryptionEnc;
            return this;
        }
         ...
         * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
         */
        public Builder subjectType(@Nullable ClientCreateApiSubjectTypeRequest subjectType) {
            this.subjectType = subjectType;
            return this;
        }
         ...
         *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
         */
        public Builder userInfoSignAlg(@Nullable ClientCreateApiUserInfoSignAlgRequest userInfoSignAlg) {
            this.userInfoSignAlg = userInfoSignAlg;
            return this;
        }
         ...
         * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
         */
        public Builder userInfoEncryptionAlg(@Nullable ClientCreateApiUserInfoEncryptionAlgRequest userInfoEncryptionAlg) {
            this.userInfoEncryptionAlg = userInfoEncryptionAlg;
            return this;
        }
         ...
         *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
         */
        public Builder userInfoEncryptionEnc(@Nullable ClientCreateApiUserInfoEncryptionEncRequest userInfoEncryptionEnc) {
            this.userInfoEncryptionEnc = userInfoEncryptionEnc;
            return this;
        }
         ...
         * this property can be used to register the URLs.
         */
        public Builder tosUris(@Nullable List<ClientCreateApiTosUrisRequest> tosUris) {
            this.tosUris = tosUris;
            return this;
        }
         ...
         * If the client application has different policy pages for different languages, this property can be used to register the URLs.
         */
        public Builder policyUris(@Nullable List<ClientCreateApiPolicyUrisRequest> policyUris) {
            this.policyUris = policyUris;
            return this;
        }
         ...
         * be used to register the URLs.
         */
        public Builder clientUris(@Nullable List<ClientCreateApiClientUrisRequest> clientUris) {
            this.clientUris = clientUris;
            return this;
        }
         ...
         *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
         */
        public Builder bcRequestSignAlg(@Nullable ClientCreateApiBcRequestSignAlgRequest bcRequestSignAlg) {
            this.bcRequestSignAlg = bcRequestSignAlg;
            return this;
        }
         ...
         * The attributes of this client.
         */
        public Builder attributes(@Nullable List<ClientCreateApiAttributeRequest> attributes) {
            this.attributes = attributes;
            return this;
        }

        public Builder extension(@Nullable ClientCreateApiExtensionRequest extension) {
            this.extension = extension;
            return this;
        }
         ...
         * The client registration types that the client has declared it may use.
         */
        public Builder clientRegistrationTypes(@Nullable List<ClientCreateApiClientRegistrationTypeRequest> clientRegistrationTypes) {
            this.clientRegistrationTypes = clientRegistrationTypes;
            return this;
        }
         ...
         * the service, and the FAPI modes for the service are set to `null`.
         */
        public Builder fapiModes(@Nullable List<ClientCreateApiFapiModeRequest> fapiModes) {
            this.fapiModes = fapiModes;
            return this;
        }
         ...
         * The response modes that this client may use.
         */
        public Builder responseModes(@Nullable List<ClientCreateApiResponseModeRequest> responseModes) {
            this.responseModes = responseModes;
            return this;
        }
        ...
        public ClientCreateApiRequestBody build() {
            return new ClientCreateApiRequestBody(
                clientName, clientNames, description,
                descriptions, clientIdAlias, clientIdAliasEnabled,
                clientType, applicationType, logoUri,
                logoUris, contacts, tlsClientCertificateBoundAccessTokens,
