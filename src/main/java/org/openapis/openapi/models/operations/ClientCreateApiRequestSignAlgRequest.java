 ...
 */
public enum ClientCreateApiRequestSignAlgRequest {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientCreateApiRequestSignAlgRequest(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientCreateApiRequestSignAlgRequest> fromValue(String value) {
        for (ClientCreateApiRequestSignAlgRequest o: ClientCreateApiRequestSignAlgRequest.values()) {
