 ...
 */
public enum ClientRegistrationUpdateApiAuthorizationEncryptionEnc {
    ...
    ClientRegistrationUpdateApiAuthorizationEncryptionEnc(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationUpdateApiAuthorizationEncryptionEnc> fromValue(String value) {
        for (ClientRegistrationUpdateApiAuthorizationEncryptionEnc o: ClientRegistrationUpdateApiAuthorizationEncryptionEnc.values()) {
