 ...
 */
public enum ClientUpdateApiUserInfoEncryptionAlgResponse {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientUpdateApiUserInfoEncryptionAlgResponse(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientUpdateApiUserInfoEncryptionAlgResponse> fromValue(String value) {
        for (ClientUpdateApiUserInfoEncryptionAlgResponse o: ClientUpdateApiUserInfoEncryptionAlgResponse.values()) {
