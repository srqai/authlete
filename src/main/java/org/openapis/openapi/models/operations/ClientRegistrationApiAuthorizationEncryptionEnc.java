 ...
 */
public enum ClientRegistrationApiAuthorizationEncryptionEnc {
    ...
    ClientRegistrationApiAuthorizationEncryptionEnc(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationApiAuthorizationEncryptionEnc> fromValue(String value) {
        for (ClientRegistrationApiAuthorizationEncryptionEnc o: ClientRegistrationApiAuthorizationEncryptionEnc.values()) {
