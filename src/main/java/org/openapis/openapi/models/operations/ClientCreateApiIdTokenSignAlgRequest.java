 ...
 */
public enum ClientCreateApiIdTokenSignAlgRequest {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientCreateApiIdTokenSignAlgRequest(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientCreateApiIdTokenSignAlgRequest> fromValue(String value) {
        for (ClientCreateApiIdTokenSignAlgRequest o: ClientCreateApiIdTokenSignAlgRequest.values()) {
