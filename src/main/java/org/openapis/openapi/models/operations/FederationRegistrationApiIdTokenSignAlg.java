 ...
 */
public enum FederationRegistrationApiIdTokenSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    FederationRegistrationApiIdTokenSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<FederationRegistrationApiIdTokenSignAlg> fromValue(String value) {
        for (FederationRegistrationApiIdTokenSignAlg o: FederationRegistrationApiIdTokenSignAlg.values()) {
