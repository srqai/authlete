...
public class JoseVerifyApiFormResponseBody {
    /**
    ...
    @JsonCreator
    public JoseVerifyApiFormResponseBody(
     ...
     * The code which represents the result of the API call.
     */
    public JoseVerifyApiFormResponseBody withResultCode(@Nullable String resultCode) {
        this.resultCode = resultCode;
        return this;
    }
     ...
     * A short message which explains the result of the API call.
     */
    public JoseVerifyApiFormResponseBody withResultMessage(@Nullable String resultMessage) {
        this.resultMessage = resultMessage;
        return this;
    }
     ...
     * The result of the verification on the JOSE object.
     */
    public JoseVerifyApiFormResponseBody withValid(@Nullable Boolean valid) {
        this.valid = valid;
        return this;
    }
     ...
     * The result of the signature verification.
     */
    public JoseVerifyApiFormResponseBody withSignatureValid(@Nullable Boolean signatureValid) {
        this.signatureValid = signatureValid;
        return this;
    }
     ...
     * The list of missing claims.
     */
    public JoseVerifyApiFormResponseBody withMissingClaims(@Nullable List<String> missingClaims) {
        this.missingClaims = missingClaims;
        return this;
    }
     ...
     * The list of invalid claims.
     */
    public JoseVerifyApiFormResponseBody withInvalidClaims(@Nullable List<String> invalidClaims) {
        this.invalidClaims = invalidClaims;
        return this;
    }
     ...
     * The list of error messages.
     */
    public JoseVerifyApiFormResponseBody withErrorDescriptions(@Nullable List<String> errorDescriptions) {
        this.errorDescriptions = errorDescriptions;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        JoseVerifyApiFormResponseBody other = (JoseVerifyApiFormResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(JoseVerifyApiFormResponseBody.class,
    ...
    public final static class Builder {
        ...
        public JoseVerifyApiFormResponseBody build() {
            return new JoseVerifyApiFormResponseBody(
                resultCode, resultMessage, valid,
                signatureValid, missingClaims, invalidClaims,
                errorDescriptions);
        }
