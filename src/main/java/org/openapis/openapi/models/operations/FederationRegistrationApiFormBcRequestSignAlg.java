 ...
 */
public enum FederationRegistrationApiFormBcRequestSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    FederationRegistrationApiFormBcRequestSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<FederationRegistrationApiFormBcRequestSignAlg> fromValue(String value) {
        for (FederationRegistrationApiFormBcRequestSignAlg o: FederationRegistrationApiFormBcRequestSignAlg.values()) {
