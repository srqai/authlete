 ...
 */
public enum ClientUpdateApiAuthorizationEncryptionEncResponse {
    ...
    ClientUpdateApiAuthorizationEncryptionEncResponse(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientUpdateApiAuthorizationEncryptionEncResponse> fromValue(String value) {
        for (ClientUpdateApiAuthorizationEncryptionEncResponse o: ClientUpdateApiAuthorizationEncryptionEncResponse.values()) {
