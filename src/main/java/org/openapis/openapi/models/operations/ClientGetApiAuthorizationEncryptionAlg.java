 ...
 */
public enum ClientGetApiAuthorizationEncryptionAlg {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientGetApiAuthorizationEncryptionAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientGetApiAuthorizationEncryptionAlg> fromValue(String value) {
        for (ClientGetApiAuthorizationEncryptionAlg o: ClientGetApiAuthorizationEncryptionAlg.values()) {
