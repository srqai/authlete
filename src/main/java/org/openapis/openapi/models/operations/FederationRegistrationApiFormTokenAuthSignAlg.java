 ...
 */
public enum FederationRegistrationApiFormTokenAuthSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    FederationRegistrationApiFormTokenAuthSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<FederationRegistrationApiFormTokenAuthSignAlg> fromValue(String value) {
        for (FederationRegistrationApiFormTokenAuthSignAlg o: FederationRegistrationApiFormTokenAuthSignAlg.values()) {
