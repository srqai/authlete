 ...
 */
public enum ClientCreateApiAuthorizationEncryptionEncResponse {
    ...
    ClientCreateApiAuthorizationEncryptionEncResponse(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientCreateApiAuthorizationEncryptionEncResponse> fromValue(String value) {
        for (ClientCreateApiAuthorizationEncryptionEncResponse o: ClientCreateApiAuthorizationEncryptionEncResponse.values()) {
