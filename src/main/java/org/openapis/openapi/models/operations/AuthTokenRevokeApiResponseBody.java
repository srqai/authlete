...
public class AuthTokenRevokeApiResponseBody {
    /**
    ...
    @JsonCreator
    public AuthTokenRevokeApiResponseBody(
     ...
     * The code which represents the result of the API call.
     */
    public AuthTokenRevokeApiResponseBody withResultCode(@Nullable String resultCode) {
        this.resultCode = resultCode;
        return this;
    }
     ...
     * A short message which explains the result of the API call.
     */
    public AuthTokenRevokeApiResponseBody withResultMessage(@Nullable String resultMessage) {
        this.resultMessage = resultMessage;
        return this;
    }
     ...
     * The number of tokens revoked
     */
    public AuthTokenRevokeApiResponseBody withCount(@Nullable Long count) {
        this.count = count;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AuthTokenRevokeApiResponseBody other = (AuthTokenRevokeApiResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AuthTokenRevokeApiResponseBody.class,
    ...
    public final static class Builder {
        ...
        public AuthTokenRevokeApiResponseBody build() {
            return new AuthTokenRevokeApiResponseBody(
                resultCode, resultMessage, count);
        }
