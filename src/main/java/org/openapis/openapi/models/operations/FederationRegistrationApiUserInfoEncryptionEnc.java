 ...
 */
public enum FederationRegistrationApiUserInfoEncryptionEnc {
    ...
    FederationRegistrationApiUserInfoEncryptionEnc(String value) {
        this.value = value;
    }
    ...
    public static Optional<FederationRegistrationApiUserInfoEncryptionEnc> fromValue(String value) {
        for (FederationRegistrationApiUserInfoEncryptionEnc o: FederationRegistrationApiUserInfoEncryptionEnc.values()) {
