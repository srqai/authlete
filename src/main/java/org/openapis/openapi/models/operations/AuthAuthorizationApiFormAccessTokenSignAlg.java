 ...
 */
public enum AuthAuthorizationApiFormAccessTokenSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    AuthAuthorizationApiFormAccessTokenSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<AuthAuthorizationApiFormAccessTokenSignAlg> fromValue(String value) {
        for (AuthAuthorizationApiFormAccessTokenSignAlg o: AuthAuthorizationApiFormAccessTokenSignAlg.values()) {
