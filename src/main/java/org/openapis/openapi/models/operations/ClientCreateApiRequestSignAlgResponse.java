 ...
 */
public enum ClientCreateApiRequestSignAlgResponse {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientCreateApiRequestSignAlgResponse(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientCreateApiRequestSignAlgResponse> fromValue(String value) {
        for (ClientCreateApiRequestSignAlgResponse o: ClientCreateApiRequestSignAlgResponse.values()) {
