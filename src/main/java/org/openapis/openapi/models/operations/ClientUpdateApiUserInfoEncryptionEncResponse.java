 ...
 */
public enum ClientUpdateApiUserInfoEncryptionEncResponse {
    ...
    ClientUpdateApiUserInfoEncryptionEncResponse(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientUpdateApiUserInfoEncryptionEncResponse> fromValue(String value) {
        for (ClientUpdateApiUserInfoEncryptionEncResponse o: ClientUpdateApiUserInfoEncryptionEncResponse.values()) {
