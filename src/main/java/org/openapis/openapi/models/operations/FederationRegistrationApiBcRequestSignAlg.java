 ...
 */
public enum FederationRegistrationApiBcRequestSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    FederationRegistrationApiBcRequestSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<FederationRegistrationApiBcRequestSignAlg> fromValue(String value) {
        for (FederationRegistrationApiBcRequestSignAlg o: FederationRegistrationApiBcRequestSignAlg.values()) {
