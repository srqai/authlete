...
public class AuthTokenUpdateApiFormResponseBody {
    /**
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("action")
    private AuthTokenUpdateApiFormAction action;
    ...
    private List<AuthTokenUpdateApiFormProperty> properties;
    ...
    private AuthTokenUpdateApiFormAuthorizationDetails authorizationDetails;
    ...
    @JsonCreator
    public AuthTokenUpdateApiFormResponseBody(
            @JsonProperty("resultCode") @Nullable String resultCode,
            @JsonProperty("resultMessage") @Nullable String resultMessage,
            @JsonProperty("action") @Nullable AuthTokenUpdateApiFormAction action,
            @JsonProperty("accessToken") @Nullable String accessToken,
            @JsonProperty("accessTokenExpiresAt") @Nullable Long accessTokenExpiresAt,
            @JsonProperty("properties") @Nullable List<AuthTokenUpdateApiFormProperty> properties,
            @JsonProperty("scopes") @Nullable List<String> scopes,
            @JsonProperty("authorizationDetails") @Nullable AuthTokenUpdateApiFormAuthorizationDetails authorizationDetails,
     ...
     * The next action that the authorization server implementation should take.
     */
    public Optional<AuthTokenUpdateApiFormAction> action() {
     ...
     * The extra properties associated with the access token.
     */
    public Optional<List<AuthTokenUpdateApiFormProperty>> properties() {
     ...
     * "OAuth 2.0 Rich Authorization Requests".
     */
    public Optional<AuthTokenUpdateApiFormAuthorizationDetails> authorizationDetails() {
     ...
     * The code which represents the result of the API call.
     */
    public AuthTokenUpdateApiFormResponseBody withResultCode(@Nullable String resultCode) {
        this.resultCode = resultCode;
        return this;
    }
     ...
     * A short message which explains the result of the API call.
     */
    public AuthTokenUpdateApiFormResponseBody withResultMessage(@Nullable String resultMessage) {
        this.resultMessage = resultMessage;
        return this;
    }
     ...
     * The next action that the authorization server implementation should take.
     */
    public AuthTokenUpdateApiFormResponseBody withAction(@Nullable AuthTokenUpdateApiFormAction action) {
        this.action = action;
        return this;
    }
     ...
     * The access token which has been specified by the request.
     */
    public AuthTokenUpdateApiFormResponseBody withAccessToken(@Nullable String accessToken) {
        this.accessToken = accessToken;
        return this;
    }
     ...
     * The date at which the access token will expire.
     */
    public AuthTokenUpdateApiFormResponseBody withAccessTokenExpiresAt(@Nullable Long accessTokenExpiresAt) {
        this.accessTokenExpiresAt = accessTokenExpiresAt;
        return this;
    }
     ...
     * The extra properties associated with the access token.
     */
    public AuthTokenUpdateApiFormResponseBody withProperties(@Nullable List<AuthTokenUpdateApiFormProperty> properties) {
        this.properties = properties;
        return this;
    }
     ...
     * The scopes associated with the access token.
     */
    public AuthTokenUpdateApiFormResponseBody withScopes(@Nullable List<String> scopes) {
        this.scopes = scopes;
        return this;
    }
     ...
     * "OAuth 2.0 Rich Authorization Requests".
     */
    public AuthTokenUpdateApiFormResponseBody withAuthorizationDetails(@Nullable AuthTokenUpdateApiFormAuthorizationDetails authorizationDetails) {
        this.authorizationDetails = authorizationDetails;
        return this;
    }
     ...
     * The token type associated with the access token.
     */
    public AuthTokenUpdateApiFormResponseBody withTokenType(@Nullable String tokenType) {
        this.tokenType = tokenType;
        return this;
    }
     ...
     * attachment.
     */
    public AuthTokenUpdateApiFormResponseBody withForExternalAttachment(@Nullable Boolean forExternalAttachment) {
        this.forExternalAttachment = forExternalAttachment;
        return this;
    }
     ...
     * Set the unique token identifier.
     */
    public AuthTokenUpdateApiFormResponseBody withTokenId(@Nullable String tokenId) {
        this.tokenId = tokenId;
        return this;
    }
     ...
     * The value is represented in milliseconds since the Unix epoch (1970-01-01).
     */
    public AuthTokenUpdateApiFormResponseBody withRefreshTokenExpiresAt(@Nullable Long refreshTokenExpiresAt) {
        this.refreshTokenExpiresAt = refreshTokenExpiresAt;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AuthTokenUpdateApiFormResponseBody other = (AuthTokenUpdateApiFormResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AuthTokenUpdateApiFormResponseBody.class,
    ...
    public final static class Builder {
         ...
         * The next action that the authorization server implementation should take.
         */
        public Builder action(@Nullable AuthTokenUpdateApiFormAction action) {
            this.action = action;
            return this;
        }
         ...
         * The extra properties associated with the access token.
         */
        public Builder properties(@Nullable List<AuthTokenUpdateApiFormProperty> properties) {
            this.properties = properties;
            return this;
        }
         ...
         * "OAuth 2.0 Rich Authorization Requests".
         */
        public Builder authorizationDetails(@Nullable AuthTokenUpdateApiFormAuthorizationDetails authorizationDetails) {
            this.authorizationDetails = authorizationDetails;
            return this;
        }
        ...
        public AuthTokenUpdateApiFormResponseBody build() {
            return new AuthTokenUpdateApiFormResponseBody(
                resultCode, resultMessage, action,
                accessToken, accessTokenExpiresAt, properties,
                scopes, authorizationDetails, tokenType,
                forExternalAttachment, tokenId, refreshTokenExpiresAt);
