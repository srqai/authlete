 ...
 */
public enum AuthTokenApiActorTokenType {
    ...
    AuthTokenApiActorTokenType(String value) {
        this.value = value;
    }
    ...
    public static Optional<AuthTokenApiActorTokenType> fromValue(String value) {
        for (AuthTokenApiActorTokenType o: AuthTokenApiActorTokenType.values()) {
