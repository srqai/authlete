 ...
 */
public enum ClientGetApiUserInfoEncryptionAlg {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientGetApiUserInfoEncryptionAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientGetApiUserInfoEncryptionAlg> fromValue(String value) {
        for (ClientGetApiUserInfoEncryptionAlg o: ClientGetApiUserInfoEncryptionAlg.values()) {
