...
public class FederationRegistrationApiFormResponseBody {
    /**
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("action")
    private FederationRegistrationApiFormAction action;
     ...
     * The next action that the authorization server implementation should take.
     */
    public Optional<FederationRegistrationApiFormAction> action() {
     ...
     * The code which represents the result of the API call.
     */
    public FederationRegistrationApiFormResponseBody withResultCode(@Nullable String resultCode) {
        this.resultCode = resultCode;
        return this;
    }
     ...
     * A short message which explains the result of the API call.
     */
    public FederationRegistrationApiFormResponseBody withResultMessage(@Nullable String resultMessage) {
        this.resultMessage = resultMessage;
        return this;
    }
     ...
     * The next action that the authorization server implementation should take.
     */
    public FederationRegistrationApiFormResponseBody withAction(@Nullable FederationRegistrationApiFormAction action) {
        this.action = action;
        return this;
    }
     ...
     * header on errors.
     */
    public FederationRegistrationApiFormResponseBody withResponseContent(@Nullable String responseContent) {
        this.responseContent = responseContent;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        FederationRegistrationApiFormResponseBody other = (FederationRegistrationApiFormResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(FederationRegistrationApiFormResponseBody.class,
    ...
    public final static class Builder {
         ...
         * The next action that the authorization server implementation should take.
         */
        public Builder action(@Nullable FederationRegistrationApiFormAction action) {
            this.action = action;
            return this;
        }
        ...
        public FederationRegistrationApiFormResponseBody build() {
            return new FederationRegistrationApiFormResponseBody(
                resultCode, resultMessage, action,
                responseContent, client);
        }
