...
public class ClientGetListApiClient {
    /**
    ...
    private List<ClientGetListApiClientName> clientNames;
    ...
    private List<ClientGetListApiDescription> descriptions;
    ...
    private ClientGetListApiClientType clientType;
    ...
    private ClientGetListApiApplicationType applicationType;
    ...
    private List<ClientGetListApiLogoUris> logoUris;
    ...
    private List<ClientGetListApiGrantType> grantTypes;
    ...
    private List<ClientGetListApiResponseType> responseTypes;
    ...
    private ClientGetListApiAuthorizationSignAlg authorizationSignAlg;
    ...
    private ClientGetListApiAuthorizationEncryptionAlg authorizationEncryptionAlg;
    ...
    private ClientGetListApiAuthorizationEncryptionEnc authorizationEncryptionEnc;
    ...
    private ClientGetListApiTokenAuthMethod tokenAuthMethod;
    ...
    private ClientGetListApiTokenAuthSignAlg tokenAuthSignAlg;
    ...
    private ClientGetListApiRequestSignAlg requestSignAlg;
    ...
    private ClientGetListApiRequestEncryptionAlg requestEncryptionAlg;
    ...
    private ClientGetListApiRequestEncryptionEnc requestEncryptionEnc;
    ...
    private ClientGetListApiIdTokenSignAlg idTokenSignAlg;
    ...
    private ClientGetListApiIdTokenEncryptionAlg idTokenEncryptionAlg;
    ...
    private ClientGetListApiIdTokenEncryptionEnc idTokenEncryptionEnc;
    ...
    private ClientGetListApiSubjectType subjectType;
    ...
    private ClientGetListApiUserInfoSignAlg userInfoSignAlg;
    ...
    private ClientGetListApiUserInfoEncryptionAlg userInfoEncryptionAlg;
    ...
    private ClientGetListApiUserInfoEncryptionEnc userInfoEncryptionEnc;
    ...
    private List<ClientGetListApiTosUris> tosUris;
    ...
    private List<ClientGetListApiPolicyUris> policyUris;
    ...
    private List<ClientGetListApiClientUris> clientUris;
    ...
    private ClientGetListApiBcRequestSignAlg bcRequestSignAlg;
    ...
    private List<ClientGetListApiAttribute> attributes;


    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("extension")
    private ClientGetListApiExtension extension;
    ...
    private List<ClientGetListApiClientRegistrationType> clientRegistrationTypes;
    ...
    private List<ClientGetListApiFapiMode> fapiModes;
    ...
    private List<ClientGetListApiResponseMode> responseModes;
    ...
    public ClientGetListApiClient(
            ...
            @JsonProperty("clientNames") @Nullable List<ClientGetListApiClientName> clientNames,
            @JsonProperty("description") @Nullable String description,
            @JsonProperty("descriptions") @Nullable List<ClientGetListApiDescription> descriptions,
            ...
            @JsonProperty("clientType") @Nullable ClientGetListApiClientType clientType,
            @JsonProperty("applicationType") @Nullable ClientGetListApiApplicationType applicationType,
            @JsonProperty("logoUri") @Nullable String logoUri,
            @JsonProperty("logoUris") @Nullable List<ClientGetListApiLogoUris> logoUris,
            ...
            @JsonProperty("grantTypes") @Nullable List<ClientGetListApiGrantType> grantTypes,
            @JsonProperty("responseTypes") @Nullable List<ClientGetListApiResponseType> responseTypes,
            @JsonProperty("redirectUris") @Nullable List<String> redirectUris,
            @JsonProperty("authorizationSignAlg") @Nullable ClientGetListApiAuthorizationSignAlg authorizationSignAlg,
            @JsonProperty("authorizationEncryptionAlg") @Nullable ClientGetListApiAuthorizationEncryptionAlg authorizationEncryptionAlg,
            @JsonProperty("authorizationEncryptionEnc") @Nullable ClientGetListApiAuthorizationEncryptionEnc authorizationEncryptionEnc,
            @JsonProperty("tokenAuthMethod") @Nullable ClientGetListApiTokenAuthMethod tokenAuthMethod,
            @JsonProperty("tokenAuthSignAlg") @Nullable ClientGetListApiTokenAuthSignAlg tokenAuthSignAlg,
            ...
            @JsonProperty("requestSignAlg") @Nullable ClientGetListApiRequestSignAlg requestSignAlg,
            @JsonProperty("requestEncryptionAlg") @Nullable ClientGetListApiRequestEncryptionAlg requestEncryptionAlg,
            @JsonProperty("requestEncryptionEnc") @Nullable ClientGetListApiRequestEncryptionEnc requestEncryptionEnc,
            ...
            @JsonProperty("idTokenSignAlg") @Nullable ClientGetListApiIdTokenSignAlg idTokenSignAlg,
            @JsonProperty("idTokenEncryptionAlg") @Nullable ClientGetListApiIdTokenEncryptionAlg idTokenEncryptionAlg,
            @JsonProperty("idTokenEncryptionEnc") @Nullable ClientGetListApiIdTokenEncryptionEnc idTokenEncryptionEnc,
            @JsonProperty("authTimeRequired") @Nullable Boolean authTimeRequired,
            @JsonProperty("subjectType") @Nullable ClientGetListApiSubjectType subjectType,
            ...
            @JsonProperty("userInfoSignAlg") @Nullable ClientGetListApiUserInfoSignAlg userInfoSignAlg,
            @JsonProperty("userInfoEncryptionAlg") @Nullable ClientGetListApiUserInfoEncryptionAlg userInfoEncryptionAlg,
            @JsonProperty("userInfoEncryptionEnc") @Nullable ClientGetListApiUserInfoEncryptionEnc userInfoEncryptionEnc,
            @JsonProperty("loginUri") @Nullable String loginUri,
            @JsonProperty("tosUri") @Nullable String tosUri,
            @JsonProperty("tosUris") @Nullable List<ClientGetListApiTosUris> tosUris,
            @JsonProperty("policyUri") @Nullable String policyUri,
            @JsonProperty("policyUris") @Nullable List<ClientGetListApiPolicyUris> policyUris,
            @JsonProperty("clientUri") @Nullable String clientUri,
            @JsonProperty("clientUris") @Nullable List<ClientGetListApiClientUris> clientUris,
            ...
            @JsonProperty("bcRequestSignAlg") @Nullable ClientGetListApiBcRequestSignAlg bcRequestSignAlg,
            @JsonProperty("bcUserCodeRequired") @Nullable Boolean bcUserCodeRequired,
            @JsonProperty("attributes") @Nullable List<ClientGetListApiAttribute> attributes,
            @JsonProperty("extension") @Nullable ClientGetListApiExtension extension,
            ...
            @JsonProperty("clientRegistrationTypes") @Nullable List<ClientGetListApiClientRegistrationType> clientRegistrationTypes,
            ...
            @JsonProperty("fapiModes") @Nullable List<ClientGetListApiFapiMode> fapiModes,
            @JsonProperty("responseModes") @Nullable List<ClientGetListApiResponseMode> responseModes,
     ...
     * languages, this property can be used to register the names.
     */
    public Optional<List<ClientGetListApiClientName>> clientNames() {
     ...
     * descriptions for different languages, this property can be used to register the descriptions.
     */
    public Optional<List<ClientGetListApiDescription>> descriptions() {
     ...
     * for details.
     */
    public Optional<ClientGetListApiClientType> clientType() {
     ...
     * See the description about `redirectUris` property for more details.
     */
    public Optional<ClientGetListApiApplicationType> applicationType() {
     ...
     * different languages, this property can be used to register URLs of the images.
     */
    public Optional<List<ClientGetListApiLogoUris>> logoUris() {
     ...
     * 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public Optional<List<ClientGetListApiGrantType>> grantTypes() {
     ...
     * 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public Optional<List<ClientGetListApiResponseType>> responseTypes() {
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public Optional<ClientGetListApiAuthorizationSignAlg> authorizationSignAlg() {
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public Optional<ClientGetListApiAuthorizationEncryptionAlg> authorizationEncryptionAlg() {
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public Optional<ClientGetListApiAuthorizationEncryptionEnc> authorizationEncryptionEnc() {
     ...
     * Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public Optional<ClientGetListApiTokenAuthMethod> tokenAuthMethod() {
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public Optional<ClientGetListApiTokenAuthSignAlg> tokenAuthSignAlg() {
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public Optional<ClientGetListApiRequestSignAlg> requestSignAlg() {
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public Optional<ClientGetListApiRequestEncryptionAlg> requestEncryptionAlg() {
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public Optional<ClientGetListApiRequestEncryptionEnc> requestEncryptionEnc() {
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public Optional<ClientGetListApiIdTokenSignAlg> idTokenSignAlg() {
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public Optional<ClientGetListApiIdTokenEncryptionAlg> idTokenEncryptionAlg() {
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public Optional<ClientGetListApiIdTokenEncryptionEnc> idTokenEncryptionEnc() {
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public Optional<ClientGetListApiSubjectType> subjectType() {
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public Optional<ClientGetListApiUserInfoSignAlg> userInfoSignAlg() {
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public Optional<ClientGetListApiUserInfoEncryptionAlg> userInfoEncryptionAlg() {
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public Optional<ClientGetListApiUserInfoEncryptionEnc> userInfoEncryptionEnc() {
     ...
     * this property can be used to register the URLs.
     */
    public Optional<List<ClientGetListApiTosUris>> tosUris() {
     ...
     * If the client application has different policy pages for different languages, this property can be used to register the URLs.
     */
    public Optional<List<ClientGetListApiPolicyUris>> policyUris() {
     ...
     * be used to register the URLs.
     */
    public Optional<List<ClientGetListApiClientUris>> clientUris() {
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public Optional<ClientGetListApiBcRequestSignAlg> bcRequestSignAlg() {
     ...
     * The attributes of this client.
     */
    public Optional<List<ClientGetListApiAttribute>> attributes() {
        return Optional.ofNullable(this.attributes);
    }

    public Optional<ClientGetListApiExtension> extension() {
     ...
     * The client registration types that the client has declared it may use.
     */
    public Optional<List<ClientGetListApiClientRegistrationType>> clientRegistrationTypes() {
     ...
     * the service, and the FAPI modes for the service are set to `null`.
     */
    public Optional<List<ClientGetListApiFapiMode>> fapiModes() {
     ...
     * The response modes that this client may use.
     */
    public Optional<List<ClientGetListApiResponseMode>> responseModes() {
     ...
     * The sequential number of the client. The value of this property is assigned by Authlete.
     */
    public ClientGetListApiClient withNumber(@Nullable Integer number) {
        this.number = number;
        return this;
    }
     ...
     * assigned by Authlete.
     */
    public ClientGetListApiClient withServiceNumber(@Nullable Integer serviceNumber) {
        this.serviceNumber = serviceNumber;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientGetListApiClient withClientName(@Nullable String clientName) {
        this.clientName = clientName;
        return this;
    }
     ...
     * languages, this property can be used to register the names.
     */
    public ClientGetListApiClient withClientNames(@Nullable List<ClientGetListApiClientName> clientNames) {
        this.clientNames = clientNames;
        return this;
    }
     ...
     * The description about the client application.
     */
    public ClientGetListApiClient withDescription(@Nullable String description) {
        this.description = description;
        return this;
    }
     ...
     * descriptions for different languages, this property can be used to register the descriptions.
     */
    public ClientGetListApiClient withDescriptions(@Nullable List<ClientGetListApiDescription> descriptions) {
        this.descriptions = descriptions;
        return this;
    }
     ...
     * The client identifier used in Authlete API calls. The value of this property is assigned by Authlete.
     */
    public ClientGetListApiClient withClientId(@Nullable Long clientId) {
        this.clientId = clientId;
        return this;
    }
     ...
     * authorization server as described in Section 2.3 when making requests to the token endpoint.
     */
    public ClientGetListApiClient withClientSecret(@Nullable String clientSecret) {
        this.clientSecret = clientSecret;
        return this;
    }
     ...
     * default, this is a string version of the `clientId` property.
     */
    public ClientGetListApiClient withClientIdAlias(@Nullable String clientIdAlias) {
        this.clientIdAlias = clientIdAlias;
        return this;
    }
     ...
     * Deprecated. Always set to `true`.
     */
    public ClientGetListApiClient withClientIdAliasEnabled(@Nullable Boolean clientIdAliasEnabled) {
        this.clientIdAliasEnabled = clientIdAliasEnabled;
        return this;
    }
     ...
     * for details.
     */
    public ClientGetListApiClient withClientType(@Nullable ClientGetListApiClientType clientType) {
        this.clientType = clientType;
        return this;
    }
     ...
     * See the description about `redirectUris` property for more details.
     */
    public ClientGetListApiClient withApplicationType(@Nullable ClientGetListApiApplicationType applicationType) {
        this.applicationType = applicationType;
        return this;
    }
     ...
     * Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientGetListApiClient withLogoUri(@Nullable String logoUri) {
        this.logoUri = logoUri;
        return this;
    }
     ...
     * different languages, this property can be used to register URLs of the images.
     */
    public ClientGetListApiClient withLogoUris(@Nullable List<ClientGetListApiLogoUris> logoUris) {
        this.logoUris = logoUris;
        return this;
    }
     ...
     * Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientGetListApiClient withContacts(@Nullable List<String> contacts) {
        this.contacts = contacts;
        return this;
    }
     ...
     * The flag to indicate whether this client use TLS client certificate bound access tokens.
     */
    public ClientGetListApiClient withTlsClientCertificateBoundAccessTokens(@Nullable Boolean tlsClientCertificateBoundAccessTokens) {
        this.tlsClientCertificateBoundAccessTokens = tlsClientCertificateBoundAccessTokens;
        return this;
    }
     ...
     * For more details, see [RFC 7591](https://datatracker.ietf.org/doc/html/rfc7591).
     */
    public ClientGetListApiClient withDynamicallyRegistered(@Nullable Boolean dynamicallyRegistered) {
        this.dynamicallyRegistered = dynamicallyRegistered;
        return this;
    }
     ...
     * of [RFC 7591](https://datatracker.ietf.org/doc/html/rfc7591).
     */
    public ClientGetListApiClient withSoftwareId(@Nullable String softwareId) {
        this.softwareId = softwareId;
        return this;
    }
     ...
     * of [RFC 7591](https://datatracker.ietf.org/doc/html/rfc7591).
     */
    public ClientGetListApiClient withSoftwareVersion(@Nullable String softwareVersion) {
        this.softwareVersion = softwareVersion;
        return this;
    }
     ...
     * The hash of the registration access token for this client.
     */
    public ClientGetListApiClient withRegistrationAccessTokenHash(@Nullable String registrationAccessTokenHash) {
        this.registrationAccessTokenHash = registrationAccessTokenHash;
        return this;
    }
     ...
     * The time at which this client was created. The value is represented as milliseconds since the UNIX epoch (1970-01-01).
     */
    public ClientGetListApiClient withCreatedAt(@Nullable Long createdAt) {
        this.createdAt = createdAt;
        return this;
    }
     ...
     * The time at which this client was last modified. The value is represented as milliseconds since the UNIX epoch (1970-01-01).
     */
    public ClientGetListApiClient withModifiedAt(@Nullable Long modifiedAt) {
        this.modifiedAt = modifiedAt;
        return this;
    }
     ...
     * 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientGetListApiClient withGrantTypes(@Nullable List<ClientGetListApiGrantType> grantTypes) {
        this.grantTypes = grantTypes;
        return this;
    }
     ...
     * 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientGetListApiClient withResponseTypes(@Nullable List<ClientGetListApiResponseType> responseTypes) {
        this.responseTypes = responseTypes;
        return this;
    }
     ...
     * details), but OpenID Connect requires exact match.
     */
    public ClientGetListApiClient withRedirectUris(@Nullable List<String> redirectUris) {
        this.redirectUris = redirectUris;
        return this;
    }
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public ClientGetListApiClient withAuthorizationSignAlg(@Nullable ClientGetListApiAuthorizationSignAlg authorizationSignAlg) {
        this.authorizationSignAlg = authorizationSignAlg;
        return this;
    }
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public ClientGetListApiClient withAuthorizationEncryptionAlg(@Nullable ClientGetListApiAuthorizationEncryptionAlg authorizationEncryptionAlg) {
        this.authorizationEncryptionAlg = authorizationEncryptionAlg;
        return this;
    }
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public ClientGetListApiClient withAuthorizationEncryptionEnc(@Nullable ClientGetListApiAuthorizationEncryptionEnc authorizationEncryptionEnc) {
        this.authorizationEncryptionEnc = authorizationEncryptionEnc;
        return this;
    }
     ...
     * Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientGetListApiClient withTokenAuthMethod(@Nullable ClientGetListApiTokenAuthMethod tokenAuthMethod) {
        this.tokenAuthMethod = tokenAuthMethod;
        return this;
    }
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public ClientGetListApiClient withTokenAuthSignAlg(@Nullable ClientGetListApiTokenAuthSignAlg tokenAuthSignAlg) {
        this.tokenAuthSignAlg = tokenAuthSignAlg;
        return this;
    }
     ...
     * The key ID of a JWK containing a self-signed certificate of this client.
     */
    public ClientGetListApiClient withSelfSignedCertificateKeyId(@Nullable String selfSignedCertificateKeyId) {
        this.selfSignedCertificateKeyId = selfSignedCertificateKeyId;
        return this;
    }
     ...
     * Registration" for details.
     */
    public ClientGetListApiClient withTlsClientAuthSubjectDn(@Nullable String tlsClientAuthSubjectDn) {
        this.tlsClientAuthSubjectDn = tlsClientAuthSubjectDn;
        return this;
    }
     ...
     * Registration" for details.
     */
    public ClientGetListApiClient withTlsClientAuthSanDns(@Nullable String tlsClientAuthSanDns) {
        this.tlsClientAuthSanDns = tlsClientAuthSanDns;
        return this;
    }
     ...
     * Registration" for details.
     */
    public ClientGetListApiClient withTlsClientAuthSanUri(@Nullable String tlsClientAuthSanUri) {
        this.tlsClientAuthSanUri = tlsClientAuthSanUri;
        return this;
    }
     ...
     * Registration" for details.
     */
    public ClientGetListApiClient withTlsClientAuthSanIp(@Nullable String tlsClientAuthSanIp) {
        this.tlsClientAuthSanIp = tlsClientAuthSanIp;
        return this;
    }
     ...
     * Registration" for details.
     */
    public ClientGetListApiClient withTlsClientAuthSanEmail(@Nullable String tlsClientAuthSanEmail) {
        this.tlsClientAuthSanEmail = tlsClientAuthSanEmail;
        return this;
    }
     ...
     * in "OAuth 2.0 Pushed Authorization Requests".
     */
    public ClientGetListApiClient withParRequired(@Nullable Boolean parRequired) {
        this.parRequired = parRequired;
        return this;
    }
     ...
     * client metadata of this client is `true`. The metadata is defined in "JAR (JWT Secured Authorization Request)".
     */
    public ClientGetListApiClient withRequestObjectRequired(@Nullable Boolean requestObjectRequired) {
        this.requestObjectRequired = requestObjectRequired;
        return this;
    }
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public ClientGetListApiClient withRequestSignAlg(@Nullable ClientGetListApiRequestSignAlg requestSignAlg) {
        this.requestSignAlg = requestSignAlg;
        return this;
    }
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public ClientGetListApiClient withRequestEncryptionAlg(@Nullable ClientGetListApiRequestEncryptionAlg requestEncryptionAlg) {
        this.requestEncryptionAlg = requestEncryptionAlg;
        return this;
    }
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public ClientGetListApiClient withRequestEncryptionEnc(@Nullable ClientGetListApiRequestEncryptionEnc requestEncryptionEnc) {
        this.requestEncryptionEnc = requestEncryptionEnc;
        return this;
    }
     ...
     * See [OpenID Connect Core 1.0, 6.2. Passing a Request Object by Reference](https://openid.net/specs/openid-connect-core-1_0.html#RequestUriParameter) for details.
     */
    public ClientGetListApiClient withRequestUris(@Nullable List<String> requestUris) {
        this.requestUris = requestUris;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientGetListApiClient withDefaultMaxAge(@Nullable Integer defaultMaxAge) {
        this.defaultMaxAge = defaultMaxAge;
        return this;
    }
     ...
     * in claims request parameter.
     */
    public ClientGetListApiClient withDefaultAcrs(@Nullable List<String> defaultAcrs) {
        this.defaultAcrs = defaultAcrs;
        return this;
    }
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public ClientGetListApiClient withIdTokenSignAlg(@Nullable ClientGetListApiIdTokenSignAlg idTokenSignAlg) {
        this.idTokenSignAlg = idTokenSignAlg;
        return this;
    }
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public ClientGetListApiClient withIdTokenEncryptionAlg(@Nullable ClientGetListApiIdTokenEncryptionAlg idTokenEncryptionAlg) {
        this.idTokenEncryptionAlg = idTokenEncryptionAlg;
        return this;
    }
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public ClientGetListApiClient withIdTokenEncryptionEnc(@Nullable ClientGetListApiIdTokenEncryptionEnc idTokenEncryptionEnc) {
        this.idTokenEncryptionEnc = idTokenEncryptionEnc;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientGetListApiClient withAuthTimeRequired(@Nullable Boolean authTimeRequired) {
        this.authTimeRequired = authTimeRequired;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientGetListApiClient withSubjectType(@Nullable ClientGetListApiSubjectType subjectType) {
        this.subjectType = subjectType;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata)
     */
    public ClientGetListApiClient withSectorIdentifierUri(@Nullable String sectorIdentifierUri) {
        this.sectorIdentifierUri = sectorIdentifierUri;
        return this;
    }
     ...
     * are also registered, the value of this property is `null`.
     */
    public ClientGetListApiClient withDerivedSectorIdentifier(@Nullable String derivedSectorIdentifier) {
        this.derivedSectorIdentifier = derivedSectorIdentifier;
        return this;
    }
     ...
     * Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientGetListApiClient withJwksUri(@Nullable String jwksUri) {
        this.jwksUri = jwksUri;
        return this;
    }
     ...
     * Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientGetListApiClient withJwks(@Nullable String jwks) {
        this.jwks = jwks;
        return this;
    }
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public ClientGetListApiClient withUserInfoSignAlg(@Nullable ClientGetListApiUserInfoSignAlg userInfoSignAlg) {
        this.userInfoSignAlg = userInfoSignAlg;
        return this;
    }
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public ClientGetListApiClient withUserInfoEncryptionAlg(@Nullable ClientGetListApiUserInfoEncryptionAlg userInfoEncryptionAlg) {
        this.userInfoEncryptionAlg = userInfoEncryptionAlg;
        return this;
    }
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public ClientGetListApiClient withUserInfoEncryptionEnc(@Nullable ClientGetListApiUserInfoEncryptionEnc userInfoEncryptionEnc) {
        this.userInfoEncryptionEnc = userInfoEncryptionEnc;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientGetListApiClient withLoginUri(@Nullable String loginUri) {
        this.loginUri = loginUri;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientGetListApiClient withTosUri(@Nullable String tosUri) {
        this.tosUri = tosUri;
        return this;
    }
     ...
     * this property can be used to register the URLs.
     */
    public ClientGetListApiClient withTosUris(@Nullable List<ClientGetListApiTosUris> tosUris) {
        this.tosUris = tosUris;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientGetListApiClient withPolicyUri(@Nullable String policyUri) {
        this.policyUri = policyUri;
        return this;
    }
     ...
     * If the client application has different policy pages for different languages, this property can be used to register the URLs.
     */
    public ClientGetListApiClient withPolicyUris(@Nullable List<ClientGetListApiPolicyUris> policyUris) {
        this.policyUris = policyUris;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientGetListApiClient withClientUri(@Nullable String clientUri) {
        this.clientUri = clientUri;
        return this;
    }
     ...
     * be used to register the URLs.
     */
    public ClientGetListApiClient withClientUris(@Nullable List<ClientGetListApiClientUris> clientUris) {
        this.clientUris = clientUris;
        return this;
    }
     ...
     * Backchannel Authentication)".
     */
    public ClientGetListApiClient withBcDeliveryMode(@Nullable String bcDeliveryMode) {
        this.bcDeliveryMode = bcDeliveryMode;
        return this;
    }
     ...
     * Backchannel Authentication)".
     */
    public ClientGetListApiClient withBcNotificationEndpoint(@Nullable String bcNotificationEndpoint) {
        this.bcNotificationEndpoint = bcNotificationEndpoint;
        return this;
    }
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public ClientGetListApiClient withBcRequestSignAlg(@Nullable ClientGetListApiBcRequestSignAlg bcRequestSignAlg) {
        this.bcRequestSignAlg = bcRequestSignAlg;
        return this;
    }
     ...
     * <p>This property corresponds to the `backchannel_user_code_parameter` metadata.
     */
    public ClientGetListApiClient withBcUserCodeRequired(@Nullable Boolean bcUserCodeRequired) {
        this.bcUserCodeRequired = bcUserCodeRequired;
        return this;
    }
     ...
     * The attributes of this client.
     */
    public ClientGetListApiClient withAttributes(@Nullable List<ClientGetListApiAttribute> attributes) {
        this.attributes = attributes;
        return this;
    }


    public ClientGetListApiClient withExtension(@Nullable ClientGetListApiExtension extension) {
        this.extension = extension;
        return this;
    }
     ...
     * to align with the change made by the 5th draft of the RAR specification.
     */
    public ClientGetListApiClient withAuthorizationDetailsTypes(@Nullable List<String> authorizationDetailsTypes) {
        this.authorizationDetailsTypes = authorizationDetailsTypes;
        return this;
    }
     ...
     * custom client metadata values can be referenced by this property.
     */
    public ClientGetListApiClient withCustomMetadata(@Nullable String customMetadata) {
        this.customMetadata = customMetadata;
        return this;
    }
     ...
     * flag of the service is `true`.
     */
    public ClientGetListApiClient withFrontChannelRequestObjectEncryptionRequired(@Nullable Boolean frontChannelRequestObjectEncryptionRequired) {
        this.frontChannelRequestObjectEncryptionRequired = frontChannelRequestObjectEncryptionRequired;
        return this;
    }
     ...
     * flag of the service is `true`.
     */
    public ClientGetListApiClient withRequestObjectEncryptionAlgMatchRequired(@Nullable Boolean requestObjectEncryptionAlgMatchRequired) {
        this.requestObjectEncryptionAlgMatchRequired = requestObjectEncryptionAlgMatchRequired;
        return this;
    }
     ...
     * flag of the service is `true`.
     */
    public ClientGetListApiClient withRequestObjectEncryptionEncMatchRequired(@Nullable Boolean requestObjectEncryptionEncMatchRequired) {
        this.requestObjectEncryptionEncMatchRequired = requestObjectEncryptionEncMatchRequired;
        return this;
    }
     ...
     * [OpenID Connect for Identity Assurance 1.0](https://openid.net/specs/openid-connect-4-identity-assurance-1_0.html).
     */
    public ClientGetListApiClient withDigestAlgorithm(@Nullable String digestAlgorithm) {
        this.digestAlgorithm = digestAlgorithm;
        return this;
    }
     ...
     * <p>Even if `Disabled` is selected here, single access token per subject is effective if `singleAccessTokenPerSubject` of the `Service` this client belongs to is Enabled.
     */
    public ClientGetListApiClient withSingleAccessTokenPerSubject(@Nullable Boolean singleAccessTokenPerSubject) {
        this.singleAccessTokenPerSubject = singleAccessTokenPerSubject;
        return this;
    }
     ...
     * <p>See [RFC 7636](https://tools.ietf.org/html/rfc7636) (Proof Key for Code Exchange by OAuth Public Clients) for details about `code_challenge` request parameter.
     */
    public ClientGetListApiClient withPkceRequired(@Nullable Boolean pkceRequired) {
        this.pkceRequired = pkceRequired;
        return this;
    }
     ...
     * Neither omission of the `code_challenge_method` request parameter nor use of plain (`code_challenge_method=plain`) is allowed.
     */
    public ClientGetListApiClient withPkceS256Required(@Nullable Boolean pkceS256Required) {
        this.pkceS256Required = pkceS256Required;
        return this;
    }
     ...
     * If the DPoP is required for this client
     */
    public ClientGetListApiClient withDpopRequired(@Nullable Boolean dpopRequired) {
        this.dpopRequired = dpopRequired;
        return this;
    }
     ...
     * "automatic" client registration of OIDC Federation.
     */
    public ClientGetListApiClient withAutomaticallyRegistered(@Nullable Boolean automaticallyRegistered) {
        this.automaticallyRegistered = automaticallyRegistered;
        return this;
    }
     ...
     * "explicit" client registration of OIDC Federation.
     */
    public ClientGetListApiClient withExplicitlyRegistered(@Nullable Boolean explicitlyRegistered) {
        this.explicitlyRegistered = explicitlyRegistered;
        return this;
    }
     ...
     * The flag indicating whether this service signs responses from the resource server.
     */
    public ClientGetListApiClient withRsRequestSigned(@Nullable Boolean rsRequestSigned) {
        this.rsRequestSigned = rsRequestSigned;
        return this;
    }
     ...
     * The key ID of a JWK containing the public key used by this client to sign requests to the resource server.
     */
    public ClientGetListApiClient withRsSignedRequestKeyId(@Nullable String rsSignedRequestKeyId) {
        this.rsSignedRequestKeyId = rsSignedRequestKeyId;
        return this;
    }
     ...
     * The client registration types that the client has declared it may use.
     */
    public ClientGetListApiClient withClientRegistrationTypes(@Nullable List<ClientGetListApiClientRegistrationType> clientRegistrationTypes) {
        this.clientRegistrationTypes = clientRegistrationTypes;
        return this;
    }
     ...
     * to the organization_name client metadata that is defined in OpenID Connect Federation 1.0.
     */
    public ClientGetListApiClient withOrganizationName(@Nullable String organizationName) {
        this.organizationName = organizationName;
        return this;
    }
     ...
     * corresponds to the `signed_jwks_uri` client metadata defined in OpenID Connect Federation 1.0.
     */
    public ClientGetListApiClient withSignedJwksUri(@Nullable String signedJwksUri) {
        this.signedJwksUri = signedJwksUri;
        return this;
    }
     ...
     * the entity ID of this client.
     */
    public ClientGetListApiClient withEntityId(@Nullable String entityId) {
        this.entityId = entityId;
        return this;
    }
     ...
     * the mechanism defined in OpenID Connect Federation 1.0
     */
    public ClientGetListApiClient withTrustAnchorId(@Nullable String trustAnchorId) {
        this.trustAnchorId = trustAnchorId;
        return this;
    }
     ...
     * OpenID Connect Federation 1.0
     */
    public ClientGetListApiClient withTrustChain(@Nullable List<String> trustChain) {
        this.trustChain = trustChain;
        return this;
    }
     ...
     * defined in OpenID Connect Federation 1.0. The value is represented as milliseconds elapsed since the Unix epoch (1970-01-01).
     */
    public ClientGetListApiClient withTrustChainExpiresAt(@Nullable Long trustChainExpiresAt) {
        this.trustChainExpiresAt = trustChainExpiresAt;
        return this;
    }
     ...
     * the time at which the trust chain was updated by the mechanism defined in OpenID Connect Federation 1.0
     */
    public ClientGetListApiClient withTrustChainUpdatedAt(@Nullable Long trustChainUpdatedAt) {
        this.trustChainUpdatedAt = trustChainUpdatedAt;
        return this;
    }
     ...
     * The flag which indicates whether this client is locked.
     */
    public ClientGetListApiClient withLocked(@Nullable Boolean locked) {
        this.locked = locked;
        return this;
    }
     ...
     * (wallet) receives a credential offer from the credential issuer.
     */
    public ClientGetListApiClient withCredentialOfferEndpoint(@Nullable String credentialOfferEndpoint) {
        this.credentialOfferEndpoint = credentialOfferEndpoint;
        return this;
    }
     ...
     * the service, and the FAPI modes for the service are set to `null`.
     */
    public ClientGetListApiClient withFapiModes(@Nullable List<ClientGetListApiFapiMode> fapiModes) {
        this.fapiModes = fapiModes;
        return this;
    }
     ...
     * The response modes that this client may use.
     */
    public ClientGetListApiClient withResponseModes(@Nullable List<ClientGetListApiResponseMode> responseModes) {
        this.responseModes = responseModes;
        return this;
    }
     ...
     * True if credential responses to this client must be always encrypted.
     */
    public ClientGetListApiClient withCredentialResponseEncryptionRequired(@Nullable Boolean credentialResponseEncryptionRequired) {
        this.credentialResponseEncryptionRequired = credentialResponseEncryptionRequired;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClientGetListApiClient other = (ClientGetListApiClient) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ClientGetListApiClient.class,
                "number", number,
    ...
    public final static class Builder {
         ...
         * languages, this property can be used to register the names.
         */
        public Builder clientNames(@Nullable List<ClientGetListApiClientName> clientNames) {
            this.clientNames = clientNames;
            return this;
        }
         ...
         * descriptions for different languages, this property can be used to register the descriptions.
         */
        public Builder descriptions(@Nullable List<ClientGetListApiDescription> descriptions) {
            this.descriptions = descriptions;
            return this;
        }
         ...
         * for details.
         */
        public Builder clientType(@Nullable ClientGetListApiClientType clientType) {
            this.clientType = clientType;
            return this;
        }
         ...
         * See the description about `redirectUris` property for more details.
         */
        public Builder applicationType(@Nullable ClientGetListApiApplicationType applicationType) {
            this.applicationType = applicationType;
            return this;
        }
         ...
         * different languages, this property can be used to register URLs of the images.
         */
        public Builder logoUris(@Nullable List<ClientGetListApiLogoUris> logoUris) {
            this.logoUris = logoUris;
            return this;
        }
         ...
         * 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
         */
        public Builder grantTypes(@Nullable List<ClientGetListApiGrantType> grantTypes) {
            this.grantTypes = grantTypes;
            return this;
        }
         ...
         * 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
         */
        public Builder responseTypes(@Nullable List<ClientGetListApiResponseType> responseTypes) {
            this.responseTypes = responseTypes;
            return this;
        }
         ...
         *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
         */
        public Builder authorizationSignAlg(@Nullable ClientGetListApiAuthorizationSignAlg authorizationSignAlg) {
            this.authorizationSignAlg = authorizationSignAlg;
            return this;
        }
         ...
         * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
         */
        public Builder authorizationEncryptionAlg(@Nullable ClientGetListApiAuthorizationEncryptionAlg authorizationEncryptionAlg) {
            this.authorizationEncryptionAlg = authorizationEncryptionAlg;
            return this;
        }
         ...
         *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
         */
        public Builder authorizationEncryptionEnc(@Nullable ClientGetListApiAuthorizationEncryptionEnc authorizationEncryptionEnc) {
            this.authorizationEncryptionEnc = authorizationEncryptionEnc;
            return this;
        }
         ...
         * Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
         */
        public Builder tokenAuthMethod(@Nullable ClientGetListApiTokenAuthMethod tokenAuthMethod) {
            this.tokenAuthMethod = tokenAuthMethod;
            return this;
        }
         ...
         *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
         */
        public Builder tokenAuthSignAlg(@Nullable ClientGetListApiTokenAuthSignAlg tokenAuthSignAlg) {
            this.tokenAuthSignAlg = tokenAuthSignAlg;
            return this;
        }
         ...
         *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
         */
        public Builder requestSignAlg(@Nullable ClientGetListApiRequestSignAlg requestSignAlg) {
            this.requestSignAlg = requestSignAlg;
            return this;
        }
         ...
         * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
         */
        public Builder requestEncryptionAlg(@Nullable ClientGetListApiRequestEncryptionAlg requestEncryptionAlg) {
            this.requestEncryptionAlg = requestEncryptionAlg;
            return this;
        }
         ...
         *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
         */
        public Builder requestEncryptionEnc(@Nullable ClientGetListApiRequestEncryptionEnc requestEncryptionEnc) {
            this.requestEncryptionEnc = requestEncryptionEnc;
            return this;
        }
         ...
         *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
         */
        public Builder idTokenSignAlg(@Nullable ClientGetListApiIdTokenSignAlg idTokenSignAlg) {
            this.idTokenSignAlg = idTokenSignAlg;
            return this;
        }
         ...
         * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
         */
        public Builder idTokenEncryptionAlg(@Nullable ClientGetListApiIdTokenEncryptionAlg idTokenEncryptionAlg) {
            this.idTokenEncryptionAlg = idTokenEncryptionAlg;
            return this;
        }
         ...
         *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
         */
        public Builder idTokenEncryptionEnc(@Nullable ClientGetListApiIdTokenEncryptionEnc idTokenEncryptionEnc) {
            this.idTokenEncryptionEnc = idTokenEncryptionEnc;
            return this;
        }
         ...
         * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
         */
        public Builder subjectType(@Nullable ClientGetListApiSubjectType subjectType) {
            this.subjectType = subjectType;
            return this;
        }
         ...
         *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
         */
        public Builder userInfoSignAlg(@Nullable ClientGetListApiUserInfoSignAlg userInfoSignAlg) {
            this.userInfoSignAlg = userInfoSignAlg;
            return this;
        }
         ...
         * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
         */
        public Builder userInfoEncryptionAlg(@Nullable ClientGetListApiUserInfoEncryptionAlg userInfoEncryptionAlg) {
            this.userInfoEncryptionAlg = userInfoEncryptionAlg;
            return this;
        }
         ...
         *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
         */
        public Builder userInfoEncryptionEnc(@Nullable ClientGetListApiUserInfoEncryptionEnc userInfoEncryptionEnc) {
            this.userInfoEncryptionEnc = userInfoEncryptionEnc;
            return this;
        }
         ...
         * this property can be used to register the URLs.
         */
        public Builder tosUris(@Nullable List<ClientGetListApiTosUris> tosUris) {
            this.tosUris = tosUris;
            return this;
        }
         ...
         * If the client application has different policy pages for different languages, this property can be used to register the URLs.
         */
        public Builder policyUris(@Nullable List<ClientGetListApiPolicyUris> policyUris) {
            this.policyUris = policyUris;
            return this;
        }
         ...
         * be used to register the URLs.
         */
        public Builder clientUris(@Nullable List<ClientGetListApiClientUris> clientUris) {
            this.clientUris = clientUris;
            return this;
        }
         ...
         *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
         */
        public Builder bcRequestSignAlg(@Nullable ClientGetListApiBcRequestSignAlg bcRequestSignAlg) {
            this.bcRequestSignAlg = bcRequestSignAlg;
            return this;
        }
         ...
         * The attributes of this client.
         */
        public Builder attributes(@Nullable List<ClientGetListApiAttribute> attributes) {
            this.attributes = attributes;
            return this;
        }

        public Builder extension(@Nullable ClientGetListApiExtension extension) {
            this.extension = extension;
            return this;
        }
         ...
         * The client registration types that the client has declared it may use.
         */
        public Builder clientRegistrationTypes(@Nullable List<ClientGetListApiClientRegistrationType> clientRegistrationTypes) {
            this.clientRegistrationTypes = clientRegistrationTypes;
            return this;
        }
         ...
         * the service, and the FAPI modes for the service are set to `null`.
         */
        public Builder fapiModes(@Nullable List<ClientGetListApiFapiMode> fapiModes) {
            this.fapiModes = fapiModes;
            return this;
        }
         ...
         * The response modes that this client may use.
         */
        public Builder responseModes(@Nullable List<ClientGetListApiResponseMode> responseModes) {
            this.responseModes = responseModes;
            return this;
        }
        ...
        public ClientGetListApiClient build() {
            return new ClientGetListApiClient(
                number, serviceNumber, clientName,
                clientNames, description, descriptions,
                clientId, clientSecret, clientIdAlias,
                clientIdAliasEnabled, clientType, applicationType,
