 ...
 */
public enum AuthAuthorizationApiFormDisplay {
    PAGE("PAGE"),
    POPUP("POPUP"),
    TOUCH("TOUCH"),
    WAP("WAP");
    ...
    AuthAuthorizationApiFormDisplay(String value) {
        this.value = value;
    }
    ...
    public static Optional<AuthAuthorizationApiFormDisplay> fromValue(String value) {
        for (AuthAuthorizationApiFormDisplay o: AuthAuthorizationApiFormDisplay.values()) {
