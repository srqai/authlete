...
public class DeviceCompleteApiRequestBody {
    /**
     * A user code.
     */
     ...
     */
    @JsonProperty("result")
    private DeviceCompleteApiResult result;
    ...
    @JsonCreator
    public DeviceCompleteApiRequestBody(
            @JsonProperty("userCode") @Nonnull String userCode,
            @JsonProperty("result") @Nonnull DeviceCompleteApiResult result,
    ...
    public DeviceCompleteApiRequestBody(
            ...
            @Nonnull DeviceCompleteApiResult result,
     ...
     * described in the description.
     */
    public DeviceCompleteApiResult result() {
        return this.result;
    }
     ...
     * A user code.
     */
    public DeviceCompleteApiRequestBody withUserCode(@Nonnull String userCode) {
     ...
     * described in the description.
     */
    public DeviceCompleteApiRequestBody withResult(@Nonnull DeviceCompleteApiResult result) {
     ...
     * The subject (= unique identifier) of the end-user.
     */
    public DeviceCompleteApiRequestBody withSubject(@Nonnull String subject) {
     ...
     * The value of the sub claim that should be used in the ID token.
     */
    public DeviceCompleteApiRequestBody withSub(@Nullable String sub) {
        this.sub = sub;
        return this;
    }
     ...
     * The time at which the end-user was authenticated. Its value is the number of seconds from `1970-01-01`.
     */
    public DeviceCompleteApiRequestBody withAuthTime(@Nullable Long authTime) {
        this.authTime = authTime;
        return this;
    }
     ...
     * The reference of the authentication context class which the end-user authentication satisfied.
     */
    public DeviceCompleteApiRequestBody withAcr(@Nullable String acr) {
        this.acr = acr;
        return this;
    }
     ...
     * Additional claims which will be embedded in the ID token.
     */
    public DeviceCompleteApiRequestBody withClaims(@Nullable String claims) {
        this.claims = claims;
        return this;
    }
     ...
     * When nothing is specified for this parameter, replacement is not performed.
     */
    public DeviceCompleteApiRequestBody withScopes(@Nullable List<String> scopes) {
        this.scopes = scopes;
        return this;
    }
     ...
     * the set `%x20-21 / %x23-5B / %x5D-7E`.
     */
    public DeviceCompleteApiRequestBody withErrorDescription(@Nullable String errorDescription) {
        this.errorDescription = errorDescription;
        return this;
    }
     ...
     * property in the response to the client.
     */
    public DeviceCompleteApiRequestBody withErrorUri(@Nullable String errorUri) {
        this.errorUri = errorUri;
        return this;
    }
     ...
     * JSON that represents additional JWS header parameters for ID tokens.
     */
    public DeviceCompleteApiRequestBody withIdtHeaderParams(@Nullable String idtHeaderParams) {
        this.idtHeaderParams = idtHeaderParams;
        return this;
    }
     ...
     * to know.
     */
    public DeviceCompleteApiRequestBody withConsentedClaims(@Nullable List<String> consentedClaims) {
        this.consentedClaims = consentedClaims;
        return this;
    }
     ...
     * Additional claims that are added to the payload part of the JWT access token.
     */
    public DeviceCompleteApiRequestBody withJwtAtClaims(@Nullable String jwtAtClaims) {
        this.jwtAtClaims = jwtAtClaims;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DeviceCompleteApiRequestBody other = (DeviceCompleteApiRequestBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DeviceCompleteApiRequestBody.class,
                "userCode", userCode,
                "result", result,
                "subject", subject,
                "sub", sub,
    ...
    public final static class Builder {
         ...
         * described in the description.
         */
        public Builder result(@Nonnull DeviceCompleteApiResult result) {
            this.result = Utils.checkNotNull(result, "result");
            return this;
        }
        ...
        public DeviceCompleteApiRequestBody build() {
            return new DeviceCompleteApiRequestBody(
                userCode, result, subject,
                sub, authTime, acr,
                claims, properties, scopes,
                errorDescription, errorUri, idtHeaderParams,
