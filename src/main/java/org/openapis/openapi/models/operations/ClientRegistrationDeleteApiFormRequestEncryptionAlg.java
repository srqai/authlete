 ...
 */
public enum ClientRegistrationDeleteApiFormRequestEncryptionAlg {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientRegistrationDeleteApiFormRequestEncryptionAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationDeleteApiFormRequestEncryptionAlg> fromValue(String value) {
        for (ClientRegistrationDeleteApiFormRequestEncryptionAlg o: ClientRegistrationDeleteApiFormRequestEncryptionAlg.values()) {
