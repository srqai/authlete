...
public class ServiceCreateApiResponseBody {
    /**
    ...
    private List<ServiceCreateApiMetadatumResponse> metadata;
    ...
    private List<ServiceCreateApiSupportedGrantTypeResponse> supportedGrantTypes;
    ...
    private List<ServiceCreateApiSupportedResponseTypeResponse> supportedResponseTypes;
    ...
    private List<ServiceCreateApiSupportedServiceProfileResponse> supportedServiceProfiles;
    ...
    private List<ServiceCreateApiSupportedDisplayResponse> supportedDisplays;
    ...
    private List<ServiceCreateApiSupportedTokenAuthMethodResponse> supportedTokenAuthMethods;
    ...
    private List<ServiceCreateApiSupportedRevocationAuthMethodResponse> supportedRevocationAuthMethods;
    ...
    private List<ServiceCreateApiSupportedIntrospectionAuthMethodResponse> supportedIntrospectionAuthMethods;
    ...
    private List<ServiceCreateApiMtlsEndpointAliasResponse> mtlsEndpointAliases;
    ...
    private ServiceCreateApiAccessTokenSignAlgResponse accessTokenSignAlg;
    ...
    private List<ServiceCreateApiSupportedScopeResponse> supportedScopes;
    ...
    private List<ServiceCreateApiSupportedClaimTypeResponse> supportedClaimTypes;
    ...
    private List<ServiceCreateApiSupportedBackchannelTokenDeliveryModeResponse> supportedBackchannelTokenDeliveryModes;
    ...
    private ServiceCreateApiUserCodeCharsetResponse userCodeCharset;
    ...
    private ServiceCreateApiVerifiedClaimsValidationSchemaSetResponse verifiedClaimsValidationSchemaSet;
    ...
    private List<ServiceCreateApiAttributeResponse> attributes;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("hsks")
    private List<ServiceCreateApiHskResponse> hsks;
    ...
    private List<ServiceCreateApiSupportedAttachmentResponse> supportedAttachments;
    ...
    private List<ServiceCreateApiSupportedClientRegistrationTypeResponse> supportedClientRegistrationTypes;
    ...
    private List<ServiceCreateApiTrustAnchorResponse> trustAnchors;
    ...
    private List<ServiceCreateApiSupportedPromptValueResponse> supportedPromptValues;
    ...
    private List<ServiceCreateApiFapiModeResponse> fapiModes;
    ...
    private ServiceCreateApiCredentialIssuerMetadataResponse credentialIssuerMetadata;
    ...
    @JsonCreator
    public ServiceCreateApiResponseBody(
            ...
            @JsonProperty("metadata") @Nullable List<ServiceCreateApiMetadatumResponse> metadata,
            ...
            @JsonProperty("supportedGrantTypes") @Nullable List<ServiceCreateApiSupportedGrantTypeResponse> supportedGrantTypes,
            @JsonProperty("supportedResponseTypes") @Nullable List<ServiceCreateApiSupportedResponseTypeResponse> supportedResponseTypes,
            @JsonProperty("supportedAuthorizationDetailsTypes") @Nullable List<String> supportedAuthorizationDetailsTypes,
            @JsonProperty("supportedServiceProfiles") @Nullable List<ServiceCreateApiSupportedServiceProfileResponse> supportedServiceProfiles,
            ...
            @JsonProperty("supportedDisplays") @Nullable List<ServiceCreateApiSupportedDisplayResponse> supportedDisplays,
            ...
            @JsonProperty("supportedTokenAuthMethods") @Nullable List<ServiceCreateApiSupportedTokenAuthMethodResponse> supportedTokenAuthMethods,
            ...
            @JsonProperty("supportedRevocationAuthMethods") @Nullable List<ServiceCreateApiSupportedRevocationAuthMethodResponse> supportedRevocationAuthMethods,
            ...
            @JsonProperty("supportedIntrospectionAuthMethods") @Nullable List<ServiceCreateApiSupportedIntrospectionAuthMethodResponse> supportedIntrospectionAuthMethods,
            ...
            @JsonProperty("mtlsEndpointAliases") @Nullable List<ServiceCreateApiMtlsEndpointAliasResponse> mtlsEndpointAliases,
            ...
            @JsonProperty("accessTokenSignAlg") @Nullable ServiceCreateApiAccessTokenSignAlgResponse accessTokenSignAlg,
            ...
            @JsonProperty("supportedScopes") @Nullable List<ServiceCreateApiSupportedScopeResponse> supportedScopes,
            ...
            @JsonProperty("supportedClaimTypes") @Nullable List<ServiceCreateApiSupportedClaimTypeResponse> supportedClaimTypes,
            ...
            @JsonProperty("supportedBackchannelTokenDeliveryModes") @Nullable List<ServiceCreateApiSupportedBackchannelTokenDeliveryModeResponse> supportedBackchannelTokenDeliveryModes,
            ...
            @JsonProperty("userCodeCharset") @Nullable ServiceCreateApiUserCodeCharsetResponse userCodeCharset,
            ...
            @JsonProperty("verifiedClaimsValidationSchemaSet") @Nullable ServiceCreateApiVerifiedClaimsValidationSchemaSetResponse verifiedClaimsValidationSchemaSet,
            @JsonProperty("attributes") @Nullable List<ServiceCreateApiAttributeResponse> attributes,
            ...
            @JsonProperty("hsks") @Nullable List<ServiceCreateApiHskResponse> hsks,
            ...
            @JsonProperty("supportedAttachments") @Nullable List<ServiceCreateApiSupportedAttachmentResponse> supportedAttachments,
            ...
            @JsonProperty("supportedClientRegistrationTypes") @Nullable List<ServiceCreateApiSupportedClientRegistrationTypeResponse> supportedClientRegistrationTypes,
            ...
            @JsonProperty("trustAnchors") @Nullable List<ServiceCreateApiTrustAnchorResponse> trustAnchors,
            ...
            @JsonProperty("supportedPromptValues") @Nullable List<ServiceCreateApiSupportedPromptValueResponse> supportedPromptValues,
            ...
            @JsonProperty("fapiModes") @Nullable List<ServiceCreateApiFapiModeResponse> fapiModes,
            @JsonProperty("credentialDuration") @Nullable Long credentialDuration,
            @JsonProperty("credentialIssuerMetadata") @Nullable ServiceCreateApiCredentialIssuerMetadataResponse credentialIssuerMetadata,
     ...
     *   | `clientCount` | The number of client applications which belong to this service.  |
     */
    public Optional<List<ServiceCreateApiMetadatumResponse>> metadata() {
     ...
     * [OpenID Provider Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public Optional<List<ServiceCreateApiSupportedGrantTypeResponse>> supportedGrantTypes() {
     ...
     * [OpenID Provider Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public Optional<List<ServiceCreateApiSupportedResponseTypeResponse>> supportedResponseTypes() {
     ...
     * The profiles that this service supports.
     */
    public Optional<List<ServiceCreateApiSupportedServiceProfileResponse>> supportedServiceProfiles() {
     ...
     * <p>The value of this property is used as `display_values_supported` property in the Provider Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public Optional<List<ServiceCreateApiSupportedDisplayResponse>> supportedDisplays() {
     ...
     * [OpenID Provider Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public Optional<List<ServiceCreateApiSupportedTokenAuthMethodResponse>> supportedTokenAuthMethods() {
     ...
     * Client authentication methods supported at the revocation endpoint.
     */
    public Optional<List<ServiceCreateApiSupportedRevocationAuthMethodResponse>> supportedRevocationAuthMethods() {
     ...
     * Client authentication methods supported at the introspection endpoint.
     */
    public Optional<List<ServiceCreateApiSupportedIntrospectionAuthMethodResponse>> supportedIntrospectionAuthMethods() {
     ...
     * ```
     */
    public Optional<List<ServiceCreateApiMtlsEndpointAliasResponse>> mtlsEndpointAliases() {
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public Optional<ServiceCreateApiAccessTokenSignAlgResponse> accessTokenSignAlg() {
     ...
     * <p>The value of this property is used as `scopes_supported` property in the [OpenID Provider Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public Optional<List<ServiceCreateApiSupportedScopeResponse>> supportedScopes() {
     ...
     * Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public Optional<List<ServiceCreateApiSupportedClaimTypeResponse>> supportedClaimTypes() {
     ...
     * Backchannel Authentication)](https://openid.net/specs/openid-client-initiated-backchannel-authentication-core-1_0.html).
     */
    public Optional<List<ServiceCreateApiSupportedBackchannelTokenDeliveryModeResponse>> supportedBackchannelTokenDeliveryModes() {
     ...
     * The character set for end-user verification codes (`user_code`) for Device Flow.
     */
    public Optional<ServiceCreateApiUserCodeCharsetResponse> userCodeCharset() {
     ...
     * OIDC4IDA / verifiedClaimsValidationSchemaSet
     */
    public Optional<ServiceCreateApiVerifiedClaimsValidationSchemaSetResponse> verifiedClaimsValidationSchemaSet() {
     ...
     * The attributes of this service.
     */
    public Optional<List<ServiceCreateApiAttributeResponse>> attributes() {
     ...
     * only by `/api/hsk/*` APIs.
     */
    public Optional<List<ServiceCreateApiHskResponse>> hsks() {
     ...
     * implementer's draft of OpenID Connect for Identity Assurance 1.0.
     */
    public Optional<List<ServiceCreateApiSupportedAttachmentResponse>> supportedAttachments() {
    ...
    public Optional<List<ServiceCreateApiSupportedClientRegistrationTypeResponse>> supportedClientRegistrationTypes() {
     ...
     * that OpenID Connect Federation 1.0 does not work.
     */
    public Optional<List<ServiceCreateApiTrustAnchorResponse>> trustAnchors() {
     ...
     * The supported `prompt` values.
     */
    public Optional<List<ServiceCreateApiSupportedPromptValueResponse>> supportedPromptValues() {
     ...
     * Advanced" if the FAPI feature is enabled in Authlete and the FAPI profile is supported by this service.
     */
    public Optional<List<ServiceCreateApiFapiModeResponse>> fapiModes() {
    ...
    public Optional<ServiceCreateApiCredentialIssuerMetadataResponse> credentialIssuerMetadata() {
     ...
     * The sequential number of the service. The value of this property is assigned by Authlete.
     */
    public ServiceCreateApiResponseBody withNumber(@Nullable Integer number) {
        this.number = number;
        return this;
    }
     ...
     * The name of this service.
     */
    public ServiceCreateApiResponseBody withServiceName(@Nullable String serviceName) {
        this.serviceName = serviceName;
        return this;
    }
     ...
     * and `issuer` property in the [OpenID Provider Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public ServiceCreateApiResponseBody withIssuer(@Nullable String issuer) {
        this.issuer = issuer;
        return this;
    }
     ...
     * The description about the service.
     */
    public ServiceCreateApiResponseBody withDescription(@Nullable String description) {
        this.description = description;
        return this;
    }
     ...
     * The service ID used in Authlete API calls. The value of this property is assigned by Authlete.
     */
    public ServiceCreateApiResponseBody withApiKey(@Nullable Long apiKey) {
        this.apiKey = apiKey;
        return this;
    }
     ...
     * Deprecated. Always `true`.
     */
    public ServiceCreateApiResponseBody withClientIdAliasEnabled(@Nullable Boolean clientIdAliasEnabled) {
        this.clientIdAliasEnabled = clientIdAliasEnabled;
        return this;
    }
     ...
     *   | `clientCount` | The number of client applications which belong to this service.  |
     */
    public ServiceCreateApiResponseBody withMetadata(@Nullable List<ServiceCreateApiMetadatumResponse> metadata) {
        this.metadata = metadata;
        return this;
    }
     ...
     * UNIX epoch (`1970-01-01`).
     */
    public ServiceCreateApiResponseBody withCreatedAt(@Nullable Long createdAt) {
        this.createdAt = createdAt;
        return this;
    }
     ...
     * the UNIX epoch (1970-01-01).
     */
    public ServiceCreateApiResponseBody withModifiedAt(@Nullable Long modifiedAt) {
        this.modifiedAt = modifiedAt;
        return this;
    }
     ...
     * a `POST` request to this endpoint.
     */
    public ServiceCreateApiResponseBody withAuthenticationCallbackEndpoint(@Nullable String authenticationCallbackEndpoint) {
        this.authenticationCallbackEndpoint = authenticationCallbackEndpoint;
        return this;
    }
     ...
     * making a request to the authentication callback endpoint.
     */
    public ServiceCreateApiResponseBody withAuthenticationCallbackApiKey(@Nullable String authenticationCallbackApiKey) {
        this.authenticationCallbackApiKey = authenticationCallbackApiKey;
        return this;
    }
     ...
     * API secret for `basic` authentication at the authentication callback endpoint.
     */
    public ServiceCreateApiResponseBody withAuthenticationCallbackApiSecret(@Nullable String authenticationCallbackApiSecret) {
        this.authenticationCallbackApiSecret = authenticationCallbackApiSecret;
        return this;
    }
     ...
     * property in the [OpenID Provider Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public ServiceCreateApiResponseBody withSupportedAcrs(@Nullable List<String> supportedAcrs) {
        this.supportedAcrs = supportedAcrs;
        return this;
    }
     ...
     * [OpenID Provider Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public ServiceCreateApiResponseBody withSupportedGrantTypes(@Nullable List<ServiceCreateApiSupportedGrantTypeResponse> supportedGrantTypes) {
        this.supportedGrantTypes = supportedGrantTypes;
        return this;
    }
     ...
     * [OpenID Provider Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public ServiceCreateApiResponseBody withSupportedResponseTypes(@Nullable List<ServiceCreateApiSupportedResponseTypeResponse> supportedResponseTypes) {
        this.supportedResponseTypes = supportedResponseTypes;
        return this;
    }
     ...
     * Rich Authorization Requests" (RAR) for details.
     */
    public ServiceCreateApiResponseBody withSupportedAuthorizationDetailsTypes(@Nullable List<String> supportedAuthorizationDetailsTypes) {
        this.supportedAuthorizationDetailsTypes = supportedAuthorizationDetailsTypes;
        return this;
    }
     ...
     * The profiles that this service supports.
     */
    public ServiceCreateApiResponseBody withSupportedServiceProfiles(@Nullable List<ServiceCreateApiSupportedServiceProfileResponse> supportedServiceProfiles) {
        this.supportedServiceProfiles = supportedServiceProfiles;
        return this;
    }
     ...
     * <p>If `true`, Authlete does not embed the `error_description` response parameter in error responses.
     */
    public ServiceCreateApiResponseBody withErrorDescriptionOmitted(@Nullable Boolean errorDescriptionOmitted) {
        this.errorDescriptionOmitted = errorDescriptionOmitted;
        return this;
    }
     ...
     * `error_uri` response parameter in error responses.
     */
    public ServiceCreateApiResponseBody withErrorUriOmitted(@Nullable Boolean errorUriOmitted) {
        this.errorUriOmitted = errorUriOmitted;
        return this;
    }
     ...
     * Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public ServiceCreateApiResponseBody withAuthorizationEndpoint(@Nullable String authorizationEndpoint) {
        this.authorizationEndpoint = authorizationEndpoint;
        return this;
    }
     ...
     * <p>The path of the endpoint is `/api/auth/authorization/direct/service-api-key`.
     */
    public ServiceCreateApiResponseBody withDirectAuthorizationEndpointEnabled(@Nullable Boolean directAuthorizationEndpointEnabled) {
        this.directAuthorizationEndpointEnabled = directAuthorizationEndpointEnabled;
        return this;
    }
     ...
     * <p>The value of this property is used as `ui_locales_supported` property in the [OpenID Provider Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public ServiceCreateApiResponseBody withSupportedUiLocales(@Nullable List<String> supportedUiLocales) {
        this.supportedUiLocales = supportedUiLocales;
        return this;
    }
     ...
     * <p>The value of this property is used as `display_values_supported` property in the Provider Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public ServiceCreateApiResponseBody withSupportedDisplays(@Nullable List<ServiceCreateApiSupportedDisplayResponse> supportedDisplays) {
        this.supportedDisplays = supportedDisplays;
        return this;
    }
     ...
     * <p>See [RFC 7636](https://tools.ietf.org/html/rfc7636) (Proof Key for Code Exchange by OAuth Public Clients) for details about `code_challenge` request parameter.
     */
    public ServiceCreateApiResponseBody withPkceRequired(@Nullable Boolean pkceRequired) {
        this.pkceRequired = pkceRequired;
        return this;
    }
     ...
     * Neither omission of the `code_challenge_method` request parameter nor use of plain (`code_challenge_method=plain`) is allowed.
     */
    public ServiceCreateApiResponseBody withPkceS256Required(@Nullable Boolean pkceS256Required) {
        this.pkceS256Required = pkceS256Required;
        return this;
    }
     ...
     * value of the `exp` claim of the JWT.
     */
    public ServiceCreateApiResponseBody withAuthorizationResponseDuration(@Nullable Long authorizationResponseDuration) {
        this.authorizationResponseDuration = authorizationResponseDuration;
        return this;
    }
     ...
     * [OpenID Provider Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public ServiceCreateApiResponseBody withTokenEndpoint(@Nullable String tokenEndpoint) {
        this.tokenEndpoint = tokenEndpoint;
        return this;
    }
     ...
     * is `/api/auth/token/direct/service-api-key`.
     */
    public ServiceCreateApiResponseBody withDirectTokenEndpointEnabled(@Nullable Boolean directTokenEndpointEnabled) {
        this.directTokenEndpointEnabled = directTokenEndpointEnabled;
        return this;
    }
     ...
     * [OpenID Provider Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public ServiceCreateApiResponseBody withSupportedTokenAuthMethods(@Nullable List<ServiceCreateApiSupportedTokenAuthMethodResponse> supportedTokenAuthMethods) {
        this.supportedTokenAuthMethods = supportedTokenAuthMethods;
        return this;
    }
     ...
     * <p>This flag should not be set unless you have special reasons.
     */
    public ServiceCreateApiResponseBody withMissingClientIdAllowed(@Nullable Boolean missingClientIdAllowed) {
        this.missingClientIdAllowed = missingClientIdAllowed;
        return this;
    }
     ...
     * <p>A URL that starts with `https://`. For example, `https://example.com/auth/revocation`.
     */
    public ServiceCreateApiResponseBody withRevocationEndpoint(@Nullable String revocationEndpoint) {
        this.revocationEndpoint = revocationEndpoint;
        return this;
    }
     ...
     * The flag to indicate whether the direct revocation endpoint is enabled or not. The URL of the endpoint is `/api/auth/revocation/direct/service-api-key`.
     */
    public ServiceCreateApiResponseBody withDirectRevocationEndpointEnabled(@Nullable Boolean directRevocationEndpointEnabled) {
        this.directRevocationEndpointEnabled = directRevocationEndpointEnabled;
        return this;
    }
     ...
     * Client authentication methods supported at the revocation endpoint.
     */
    public ServiceCreateApiResponseBody withSupportedRevocationAuthMethods(@Nullable List<ServiceCreateApiSupportedRevocationAuthMethodResponse> supportedRevocationAuthMethods) {
        this.supportedRevocationAuthMethods = supportedRevocationAuthMethods;
        return this;
    }
     ...
     * The URI of the introspection endpoint.
     */
    public ServiceCreateApiResponseBody withIntrospectionEndpoint(@Nullable String introspectionEndpoint) {
        this.introspectionEndpoint = introspectionEndpoint;
        return this;
    }
     ...
     * The flag to indicate whether the direct userinfo endpoint is enabled or not. The path of the endpoint is `/api/auth/userinfo/direct/{serviceApiKey}`.
     */
    public ServiceCreateApiResponseBody withDirectIntrospectionEndpointEnabled(@Nullable Boolean directIntrospectionEndpointEnabled) {
        this.directIntrospectionEndpointEnabled = directIntrospectionEndpointEnabled;
        return this;
    }
     ...
     * Client authentication methods supported at the introspection endpoint.
     */
    public ServiceCreateApiResponseBody withSupportedIntrospectionAuthMethods(@Nullable List<ServiceCreateApiSupportedIntrospectionAuthMethodResponse> supportedIntrospectionAuthMethods) {
        this.supportedIntrospectionAuthMethods = supportedIntrospectionAuthMethods;
        return this;
    }
     ...
     * <p>This property corresponds to the `pushed_authorization_request_endpoint` metadata defined in "[5. Authorization Server Metadata](https://tools.ietf.org/html/draft-lodderstedt-oauth-par#section-5)" of OAuth 2.0 Pushed Authorization Requests.
     */
    public ServiceCreateApiResponseBody withPushedAuthReqEndpoint(@Nullable String pushedAuthReqEndpoint) {
        this.pushedAuthReqEndpoint = pushedAuthReqEndpoint;
        return this;
    }
     ...
     * of the `expires_in` parameter in responses from the pushed authorization request endpoint.
     */
    public ServiceCreateApiResponseBody withPushedAuthReqDuration(@Nullable Long pushedAuthReqDuration) {
        this.pushedAuthReqDuration = pushedAuthReqDuration;
        return this;
    }
     ...
     * in [OAuth 2.0 Pushed Authorization Requests](https://tools.ietf.org/html/draft-lodderstedt-oauth-par).
     */
    public ServiceCreateApiResponseBody withParRequired(@Nullable Boolean parRequired) {
        this.parRequired = parRequired;
        return this;
    }
     ...
     * conform to the JAR specification are rejected.
     */
    public ServiceCreateApiResponseBody withRequestObjectRequired(@Nullable Boolean requestObjectRequired) {
        this.requestObjectRequired = requestObjectRequired;
        return this;
    }
     ...
     * requests which don't conform to the JAR specification are rejected.
     */
    public ServiceCreateApiResponseBody withTraditionalRequestObjectProcessingApplied(@Nullable Boolean traditionalRequestObjectProcessingApplied) {
        this.traditionalRequestObjectProcessingApplied = traditionalRequestObjectProcessingApplied;
        return this;
    }
     ...
     * The flag to indicate whether this service validates certificate chains during PKI-based client mutual TLS authentication.
     */
    public ServiceCreateApiResponseBody withMutualTlsValidatePkiCertChain(@Nullable Boolean mutualTlsValidatePkiCertChain) {
        this.mutualTlsValidatePkiCertChain = mutualTlsValidatePkiCertChain;
        return this;
    }
     ...
     * The list of root certificates trusted by this service for PKI-based client mutual TLS authentication.
     */
    public ServiceCreateApiResponseBody withTrustedRootCertificates(@Nullable List<String> trustedRootCertificates) {
        this.trustedRootCertificates = trustedRootCertificates;
        return this;
    }
     ...
     * ```
     */
    public ServiceCreateApiResponseBody withMtlsEndpointAliases(@Nullable List<ServiceCreateApiMtlsEndpointAliasResponse> mtlsEndpointAliases) {
        this.mtlsEndpointAliases = mtlsEndpointAliases;
        return this;
    }
     ...
     * <p>See [RFC 6749 (OAuth 2.0), 7.1. Access Token Types](https://tools.ietf.org/html/rfc6749#section-7.1) for details.
     */
    public ServiceCreateApiResponseBody withAccessTokenType(@Nullable String accessTokenType) {
        this.accessTokenType = accessTokenType;
        return this;
    }
     ...
     * The flag to indicate whether this service supports issuing TLS client certificate bound access tokens.
     */
    public ServiceCreateApiResponseBody withTlsClientCertificateBoundAccessTokens(@Nullable Boolean tlsClientCertificateBoundAccessTokens) {
        this.tlsClientCertificateBoundAccessTokens = tlsClientCertificateBoundAccessTokens;
        return this;
    }
     ...
     * in access token responses. `expires_in` is defined [RFC 6749, 5.1. Successful Response](https://tools.ietf.org/html/rfc6749#section-5.1).
     */
    public ServiceCreateApiResponseBody withAccessTokenDuration(@Nullable Long accessTokenDuration) {
        this.accessTokenDuration = accessTokenDuration;
        return this;
    }
     ...
     * <p>Note that, however, attempts by [Client Credentials Flow](https://tools.ietf.org/html/rfc6749#section-4.4) do not invalidate existing access tokens because access tokens issued by Client Credentials Flow are not associated with any end-user's subject. Also note that an attempt by [Refresh Token Flow](https://tools.ietf.org/html/rfc6749#section-6) invalidates the coupled access token only and this invalidation is always performed regardless of whether the value of this setting item is `true` or `false`.
     */
    public ServiceCreateApiResponseBody withSingleAccessTokenPerSubject(@Nullable Boolean singleAccessTokenPerSubject) {
        this.singleAccessTokenPerSubject = singleAccessTokenPerSubject;
        return this;
    }
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public ServiceCreateApiResponseBody withAccessTokenSignAlg(@Nullable ServiceCreateApiAccessTokenSignAlgResponse accessTokenSignAlg) {
        this.accessTokenSignAlg = accessTokenSignAlg;
        return this;
    }
     ...
     * to be specified so that Authlete Server can pick up one JWK from among the JWK candidates.
     */
    public ServiceCreateApiResponseBody withAccessTokenSignatureKeyId(@Nullable String accessTokenSignatureKeyId) {
        this.accessTokenSignatureKeyId = accessTokenSignatureKeyId;
        return this;
    }
     ...
     * The duration of refresh tokens in seconds. The related specifications have no requirements on refresh token duration, but Authlete sets expiration for refresh tokens.
     */
    public ServiceCreateApiResponseBody withRefreshTokenDuration(@Nullable Long refreshTokenDuration) {
        this.refreshTokenDuration = refreshTokenDuration;
        return this;
    }
     ...
     * the newly issued refresh token.
     */
    public ServiceCreateApiResponseBody withRefreshTokenDurationKept(@Nullable Boolean refreshTokenDurationKept) {
        this.refreshTokenDurationKept = refreshTokenDurationKept;
        return this;
    }
     ...
     * `refreshTokenDurationReset` property is not referenced.
     */
    public ServiceCreateApiResponseBody withRefreshTokenDurationReset(@Nullable Boolean refreshTokenDurationReset) {
        this.refreshTokenDurationReset = refreshTokenDurationReset;
        return this;
    }
     ...
     * <p>See [RFC 6749 6. Refreshing an Access Token](https://tools.ietf.org/html/rfc6749#section-6), as to how to get a new access token using a refresh token.
     */
    public ServiceCreateApiResponseBody withRefreshTokenKept(@Nullable Boolean refreshTokenKept) {
        this.refreshTokenKept = refreshTokenKept;
        return this;
    }
     ...
     * <p>The value of this property is used as `scopes_supported` property in the [OpenID Provider Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public ServiceCreateApiResponseBody withSupportedScopes(@Nullable List<ServiceCreateApiSupportedScopeResponse> supportedScopes) {
        this.supportedScopes = supportedScopes;
        return this;
    }
     ...
     * and want to strictly conform to the requirement above, this flag has to be `true`.
     */
    public ServiceCreateApiResponseBody withScopeRequired(@Nullable Boolean scopeRequired) {
        this.scopeRequired = scopeRequired;
        return this;
    }
     ...
     * in seconds. This value is used to calculate the value of `exp` claim in an ID token.'
     */
    public ServiceCreateApiResponseBody withIdTokenDuration(@Nullable Long idTokenDuration) {
        this.idTokenDuration = idTokenDuration;
        return this;
    }
     ...
     * <p>The clock skew is taken into consideration when time-related claims in a JWT (e.g. `exp`, `iat`, `nbf`) are verified.
     */
    public ServiceCreateApiResponseBody withAllowableClockSkew(@Nullable Integer allowableClockSkew) {
        this.allowableClockSkew = allowableClockSkew;
        return this;
    }
     ...
     * Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public ServiceCreateApiResponseBody withSupportedClaimTypes(@Nullable List<ServiceCreateApiSupportedClaimTypeResponse> supportedClaimTypes) {
        this.supportedClaimTypes = supportedClaimTypes;
        return this;
    }
     ...
     * [OpenID Provider Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public ServiceCreateApiResponseBody withSupportedClaimLocales(@Nullable List<String> supportedClaimLocales) {
        this.supportedClaimLocales = supportedClaimLocales;
        return this;
    }
     ...
     * Claims](https://openid.net/specs/openid-connect-core-1_0.html#AdditionalClaims).
     */
    public ServiceCreateApiResponseBody withSupportedClaims(@Nullable List<String> supportedClaims) {
        this.supportedClaims = supportedClaims;
        return this;
    }
     ...
     * case for the response_type value id_token), the resulting Claims are returned in the ID Token.
     */
    public ServiceCreateApiResponseBody withClaimShortcutRestrictive(@Nullable Boolean claimShortcutRestrictive) {
        this.claimShortcutRestrictive = claimShortcutRestrictive;
        return this;
    }
     ...
     * <p>The value of this property is used as `jwks_uri` property in the [OpenID Provider Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public ServiceCreateApiResponseBody withJwksUri(@Nullable String jwksUri) {
        this.jwksUri = jwksUri;
        return this;
    }
     ...
     * is `/api/service/jwks/get/direct/service-api-key`. '
     */
    public ServiceCreateApiResponseBody withDirectJwksEndpointEnabled(@Nullable Boolean directJwksEndpointEnabled) {
        this.directJwksEndpointEnabled = directJwksEndpointEnabled;
        return this;
    }
     ...
     * Encryption](https://openid.net/specs/openid-connect-core-1_0.html#SigEnc) for details.
     */
    public ServiceCreateApiResponseBody withJwks(@Nullable String jwks) {
        this.jwks = jwks;
        return this;
    }
     ...
     * this mechanism is needed.
     */
    public ServiceCreateApiResponseBody withIdTokenSignatureKeyId(@Nullable String idTokenSignatureKeyId) {
        this.idTokenSignatureKeyId = idTokenSignatureKeyId;
        return this;
    }
     ...
     * this mechanism is needed.
     */
    public ServiceCreateApiResponseBody withUserInfoSignatureKeyId(@Nullable String userInfoSignatureKeyId) {
        this.userInfoSignatureKeyId = userInfoSignatureKeyId;
        return this;
    }
     ...
     * the key ID.
     */
    public ServiceCreateApiResponseBody withAuthorizationSignatureKeyId(@Nullable String authorizationSignatureKeyId) {
        this.authorizationSignatureKeyId = authorizationSignatureKeyId;
        return this;
    }
     ...
     * <p>The value of this property is used as `userinfo_endpoint` property in the [OpenID Provider Metadata](http://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public ServiceCreateApiResponseBody withUserInfoEndpoint(@Nullable String userInfoEndpoint) {
        this.userInfoEndpoint = userInfoEndpoint;
        return this;
    }
     ...
     * of the endpoint is `/api/auth/userinfo/direct/service-api-key`.
     */
    public ServiceCreateApiResponseBody withDirectUserInfoEndpointEnabled(@Nullable Boolean directUserInfoEndpointEnabled) {
        this.directUserInfoEndpointEnabled = directUserInfoEndpointEnabled;
        return this;
    }
     ...
     * is supported.
     */
    public ServiceCreateApiResponseBody withDynamicRegistrationSupported(@Nullable Boolean dynamicRegistrationSupported) {
        this.dynamicRegistrationSupported = dynamicRegistrationSupported;
        return this;
    }
     ...
     * <p>The value of this property is used as `registration_endpoint` property in the [OpenID Provider Metadata](http://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public ServiceCreateApiResponseBody withRegistrationEndpoint(@Nullable String registrationEndpoint) {
        this.registrationEndpoint = registrationEndpoint;
        return this;
    }
     ...
     * be used as the URI base instead.
     */
    public ServiceCreateApiResponseBody withRegistrationManagementEndpoint(@Nullable String registrationManagementEndpoint) {
        this.registrationManagementEndpoint = registrationManagementEndpoint;
        return this;
    }
     ...
     * <p>The value of this property is used as `op_policy_uri` property in the [OpenID Provider Metadata](http://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public ServiceCreateApiResponseBody withPolicyUri(@Nullable String policyUri) {
        this.policyUri = policyUri;
        return this;
    }
     ...
     * <p>The value of this property is used as `op_tos_uri` property in the [OpenID Provider Metadata](http://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public ServiceCreateApiResponseBody withTosUri(@Nullable String tosUri) {
        this.tosUri = tosUri;
        return this;
    }
     ...
     * <p>The value of this property is used as `service_documentation` property in the [OpenID Provider Metadata](http://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public ServiceCreateApiResponseBody withServiceDocumentation(@Nullable String serviceDocumentation) {
        this.serviceDocumentation = serviceDocumentation;
        return this;
    }
     ...
     * (Client Initiated Backchannel Authentication)](https://openid.net/specs/openid-client-initiated-backchannel-authentication-core-1_0.html).
     */
    public ServiceCreateApiResponseBody withBackchannelAuthenticationEndpoint(@Nullable String backchannelAuthenticationEndpoint) {
        this.backchannelAuthenticationEndpoint = backchannelAuthenticationEndpoint;
        return this;
    }
     ...
     * Backchannel Authentication)](https://openid.net/specs/openid-client-initiated-backchannel-authentication-core-1_0.html).
     */
    public ServiceCreateApiResponseBody withSupportedBackchannelTokenDeliveryModes(@Nullable List<ServiceCreateApiSupportedBackchannelTokenDeliveryModeResponse> supportedBackchannelTokenDeliveryModes) {
        this.supportedBackchannelTokenDeliveryModes = supportedBackchannelTokenDeliveryModes;
        return this;
    }
     ...
     * the backchannel authentication endpoint.
     */
    public ServiceCreateApiResponseBody withBackchannelAuthReqIdDuration(@Nullable Integer backchannelAuthReqIdDuration) {
        this.backchannelAuthReqIdDuration = backchannelAuthReqIdDuration;
        return this;
    }
     ...
     * authentication endpoint.
     */
    public ServiceCreateApiResponseBody withBackchannelPollingInterval(@Nullable Integer backchannelPollingInterval) {
        this.backchannelPollingInterval = backchannelPollingInterval;
        return this;
    }
     ...
     * metadata.
     */
    public ServiceCreateApiResponseBody withBackchannelUserCodeParameterSupported(@Nullable Boolean backchannelUserCodeParameterSupported) {
        this.backchannelUserCodeParameterSupported = backchannelUserCodeParameterSupported;
        return this;
    }
     ...
     * that ensures each backchannel authentication request has unique context.
     */
    public ServiceCreateApiResponseBody withBackchannelBindingMessageRequiredInFapi(@Nullable Boolean backchannelBindingMessageRequiredInFapi) {
        this.backchannelBindingMessageRequiredInFapi = backchannelBindingMessageRequiredInFapi;
        return this;
    }
     ...
     * <p>Device authorization endpoint is defined in the specification of OAuth 2.0 Device Authorization Grant.
     */
    public ServiceCreateApiResponseBody withDeviceAuthorizationEndpoint(@Nullable String deviceAuthorizationEndpoint) {
        this.deviceAuthorizationEndpoint = deviceAuthorizationEndpoint;
        return this;
    }
     ...
     * parameter in responses from the device authorization endpoint.
     */
    public ServiceCreateApiResponseBody withDeviceVerificationUri(@Nullable String deviceVerificationUri) {
        this.deviceVerificationUri = deviceVerificationUri;
        return this;
    }
     ...
     * responses.
     */
    public ServiceCreateApiResponseBody withDeviceVerificationUriComplete(@Nullable String deviceVerificationUriComplete) {
        this.deviceVerificationUriComplete = deviceVerificationUriComplete;
        return this;
    }
     ...
     * from the device authorization endpoint.
     */
    public ServiceCreateApiResponseBody withDeviceFlowCodeDuration(@Nullable Integer deviceFlowCodeDuration) {
        this.deviceFlowCodeDuration = deviceFlowCodeDuration;
        return this;
    }
     ...
     * the device authorization endpoint.
     */
    public ServiceCreateApiResponseBody withDeviceFlowPollingInterval(@Nullable Integer deviceFlowPollingInterval) {
        this.deviceFlowPollingInterval = deviceFlowPollingInterval;
        return this;
    }
     ...
     * The character set for end-user verification codes (`user_code`) for Device Flow.
     */
    public ServiceCreateApiResponseBody withUserCodeCharset(@Nullable ServiceCreateApiUserCodeCharsetResponse userCodeCharset) {
        this.userCodeCharset = userCodeCharset;
        return this;
    }
     ...
     * The length of end-user verification codes (`user_code`) for Device Flow.
     */
    public ServiceCreateApiResponseBody withUserCodeLength(@Nullable Integer userCodeLength) {
        this.userCodeLength = userCodeLength;
        return this;
    }
     ...
     * [metadata](https://openid.net/specs/openid-connect-4-identity-assurance-1_0.html#rfc.section.7).
     */
    public ServiceCreateApiResponseBody withSupportedTrustFrameworks(@Nullable List<String> supportedTrustFrameworks) {
        this.supportedTrustFrameworks = supportedTrustFrameworks;
        return this;
    }
     ...
     * Evidence supported by this service. This corresponds to the `evidence_supported` [metadata](https://openid.net/specs/openid-connect-4-identity-assurance-1_0.html#rfc.section.7).
     */
    public ServiceCreateApiResponseBody withSupportedEvidence(@Nullable List<String> supportedEvidence) {
        this.supportedEvidence = supportedEvidence;
        return this;
    }
     ...
     * [metadata](https://openid.net/specs/openid-connect-4-identity-assurance-1_0.html#rfc.section.7).
     */
    public ServiceCreateApiResponseBody withSupportedIdentityDocuments(@Nullable List<String> supportedIdentityDocuments) {
        this.supportedIdentityDocuments = supportedIdentityDocuments;
        return this;
    }
     ...
     * [metadata](https://openid.net/specs/openid-connect-4-identity-assurance-1_0.html#rfc.section.7).
     */
    public ServiceCreateApiResponseBody withSupportedVerificationMethods(@Nullable List<String> supportedVerificationMethods) {
        this.supportedVerificationMethods = supportedVerificationMethods;
        return this;
    }
     ...
     * [metadata](https://openid.net/specs/openid-connect-4-identity-assurance-1_0.html#rfc.section.7).
     */
    public ServiceCreateApiResponseBody withSupportedVerifiedClaims(@Nullable List<String> supportedVerifiedClaims) {
        this.supportedVerifiedClaims = supportedVerifiedClaims;
        return this;
    }
     ...
     * OIDC4IDA / verifiedClaimsValidationSchemaSet
     */
    public ServiceCreateApiResponseBody withVerifiedClaimsValidationSchemaSet(@Nullable ServiceCreateApiVerifiedClaimsValidationSchemaSetResponse verifiedClaimsValidationSchemaSet) {
        this.verifiedClaimsValidationSchemaSet = verifiedClaimsValidationSchemaSet;
        return this;
    }
     ...
     * The attributes of this service.
     */
    public ServiceCreateApiResponseBody withAttributes(@Nullable List<ServiceCreateApiAttributeResponse> attributes) {
        this.attributes = attributes;
        return this;
    }
     ...
     * from ID2 to Final smooth without breaking live systems.
     */
    public ServiceCreateApiResponseBody withNbfOptional(@Nullable Boolean nbfOptional) {
        this.nbfOptional = nbfOptional;
        return this;
    }
     ...
     * reasons for it.
     */
    public ServiceCreateApiResponseBody withIssSuppressed(@Nullable Boolean issSuppressed) {
        this.issSuppressed = issSuppressed;
        return this;
    }
     ...
     * metadata values can be referenced by `customMetadata`.
     */
    public ServiceCreateApiResponseBody withSupportedCustomClientMetadata(@Nullable List<String> supportedCustomClientMetadata) {
        this.supportedCustomClientMetadata = supportedCustomClientMetadata;
        return this;
    }
     ...
     * will have the same expiration date.
     */
    public ServiceCreateApiResponseBody withTokenExpirationLinked(@Nullable Boolean tokenExpirationLinked) {
        this.tokenExpirationLinked = tokenExpirationLinked;
        return this;
    }
     ...
     * flag of the client is `true`.
     */
    public ServiceCreateApiResponseBody withFrontChannelRequestObjectEncryptionRequired(@Nullable Boolean frontChannelRequestObjectEncryptionRequired) {
        this.frontChannelRequestObjectEncryptionRequired = frontChannelRequestObjectEncryptionRequired;
        return this;
    }
     ...
     * flag of the client is `true`.
     */
    public ServiceCreateApiResponseBody withRequestObjectEncryptionAlgMatchRequired(@Nullable Boolean requestObjectEncryptionAlgMatchRequired) {
        this.requestObjectEncryptionAlgMatchRequired = requestObjectEncryptionAlgMatchRequired;
        return this;
    }
     ...
     * flag is `true`.
     */
    public ServiceCreateApiResponseBody withRequestObjectEncryptionEncMatchRequired(@Nullable Boolean requestObjectEncryptionEncMatchRequired) {
        this.requestObjectEncryptionEncMatchRequired = requestObjectEncryptionEncMatchRequired;
        return this;
    }
     ...
     * server you are using does not support HSM.
     */
    public ServiceCreateApiResponseBody withHsmEnabled(@Nullable Boolean hsmEnabled) {
        this.hsmEnabled = hsmEnabled;
        return this;
    }
     ...
     * only by `/api/hsk/*` APIs.
     */
    public ServiceCreateApiResponseBody withHsks(@Nullable List<ServiceCreateApiHskResponse> hsks) {
        this.hsks = hsks;
        return this;
    }
     ...
     * The URL of the grant management endpoint.
     */
    public ServiceCreateApiResponseBody withGrantManagementEndpoint(@Nullable String grantManagementEndpoint) {
        this.grantManagementEndpoint = grantManagementEndpoint;
        return this;
    }
     ...
     * security reasons.
     */
    public ServiceCreateApiResponseBody withGrantManagementActionRequired(@Nullable Boolean grantManagementActionRequired) {
        this.grantManagementActionRequired = grantManagementActionRequired;
        return this;
    }
     ...
     * 3. Turn on this `unauthorizedOnClientConfigSupported` flag.
     */
    public ServiceCreateApiResponseBody withUnauthorizedOnClientConfigSupported(@Nullable Boolean unauthorizedOnClientConfigSupported) {
        this.unauthorizedOnClientConfigSupported = unauthorizedOnClientConfigSupported;
        return this;
    }
     ...
     * <p>This property affects behaviors of `/api/client/registration` and other family APIs.
     */
    public ServiceCreateApiResponseBody withDcrScopeUsedAsRequestable(@Nullable Boolean dcrScopeUsedAsRequestable) {
        this.dcrScopeUsedAsRequestable = dcrScopeUsedAsRequestable;
        return this;
    }
     ...
     * Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
     */
    public ServiceCreateApiResponseBody withEndSessionEndpoint(@Nullable String endSessionEndpoint) {
        this.endSessionEndpoint = endSessionEndpoint;
        return this;
    }
     ...
     * component to be variable in other cases (e.g. in the case of the `"https"` scheme), too.
     */
    public ServiceCreateApiResponseBody withLoopbackRedirectionUriVariable(@Nullable Boolean loopbackRedirectionUriVariable) {
        this.loopbackRedirectionUriVariable = loopbackRedirectionUriVariable;
        return this;
    }
     ...
     * identifier of this service and raises an error if they are different.
     */
    public ServiceCreateApiResponseBody withRequestObjectAudienceChecked(@Nullable Boolean requestObjectAudienceChecked) {
        this.requestObjectAudienceChecked = requestObjectAudienceChecked;
        return this;
    }
     ...
     * responses.
     */
    public ServiceCreateApiResponseBody withAccessTokenForExternalAttachmentEmbedded(@Nullable Boolean accessTokenForExternalAttachmentEmbedded) {
        this.accessTokenForExternalAttachmentEmbedded = accessTokenForExternalAttachmentEmbedded;
        return this;
    }
     ...
     * defined in OpenID Connect Federation 1.0.
     */
    public ServiceCreateApiResponseBody withAuthorityHints(@Nullable List<String> authorityHints) {
        this.authorityHints = authorityHints;
        return this;
    }
     ...
     * flag indicating whether this service supports OpenID Connect Federation 1
     */
    public ServiceCreateApiResponseBody withFederationEnabled(@Nullable Boolean federationEnabled) {
        this.federationEnabled = federationEnabled;
        return this;
    }
     ...
     * `signed_jwks_uri`.
     */
    public ServiceCreateApiResponseBody withFederationJwks(@Nullable String federationJwks) {
        this.federationJwks = federationJwks;
        return this;
    }
     ...
     * the signed JWK Set.
     */
    public ServiceCreateApiResponseBody withFederationSignatureKeyId(@Nullable String federationSignatureKeyId) {
        this.federationSignatureKeyId = federationSignatureKeyId;
        return this;
    }
     ...
     * The duration of the entity configuration in seconds.
     */
    public ServiceCreateApiResponseBody withFederationConfigurationDuration(@Nullable Long federationConfigurationDuration) {
        this.federationConfigurationDuration = federationConfigurationDuration;
        return this;
    }
     ...
     * defined in OpenID Connect Federation 1.0.
     */
    public ServiceCreateApiResponseBody withFederationRegistrationEndpoint(@Nullable String federationRegistrationEndpoint) {
        this.federationRegistrationEndpoint = federationRegistrationEndpoint;
        return this;
    }
     ...
     * server metadata that is defined in OpenID Connect Federation 1.0.
     */
    public ServiceCreateApiResponseBody withOrganizationName(@Nullable String organizationName) {
        this.organizationName = organizationName;
        return this;
    }
     ...
     * server metadata.
     */
    public ServiceCreateApiResponseBody withPredefinedTransformedClaims(@Nullable String predefinedTransformedClaims) {
        this.predefinedTransformedClaims = predefinedTransformedClaims;
        return this;
    }
     ...
     * period.
     */
    public ServiceCreateApiResponseBody withRefreshTokenIdempotent(@Nullable Boolean refreshTokenIdempotent) {
        this.refreshTokenIdempotent = refreshTokenIdempotent;
        return this;
    }
     ...
     * server metadata defined in OpenID Connect Federation 1.0.
     */
    public ServiceCreateApiResponseBody withSignedJwksUri(@Nullable String signedJwksUri) {
        this.signedJwksUri = signedJwksUri;
        return this;
    }
     ...
     * implementer's draft of OpenID Connect for Identity Assurance 1.0.
     */
    public ServiceCreateApiResponseBody withSupportedAttachments(@Nullable List<ServiceCreateApiSupportedAttachmentResponse> supportedAttachments) {
        this.supportedAttachments = supportedAttachments;
        return this;
    }
     ...
     * Assurance 1.0.
     */
    public ServiceCreateApiResponseBody withSupportedDigestAlgorithms(@Nullable List<String> supportedDigestAlgorithms) {
        this.supportedDigestAlgorithms = supportedDigestAlgorithms;
        return this;
    }
     ...
     * to the `documents_supported` server metadata.
     */
    public ServiceCreateApiResponseBody withSupportedDocuments(@Nullable List<String> supportedDocuments) {
        this.supportedDocuments = supportedDocuments;
        return this;
    }
     ...
     * `documents_methods_supported`.
     */
    public ServiceCreateApiResponseBody withSupportedDocumentsMethods(@Nullable List<String> supportedDocumentsMethods) {
        this.supportedDocumentsMethods = supportedDocumentsMethods;
        return this;
    }
     ...
     * [OpenID Connect for Identity Assurance 1.0](https://openid.net/specs/openid-connect-4-identity-assurance-1_0.html)
     */
    public ServiceCreateApiResponseBody withSupportedDocumentsValidationMethods(@Nullable List<String> supportedDocumentsValidationMethods) {
        this.supportedDocumentsValidationMethods = supportedDocumentsValidationMethods;
        return this;
    }
     ...
     * [OpenID Connect for Identity Assurance 1.0](https://openid.net/specs/openid-connect-4-identity-assurance-1_0.html)
     */
    public ServiceCreateApiResponseBody withSupportedDocumentsVerificationMethods(@Nullable List<String> supportedDocumentsVerificationMethods) {
        this.supportedDocumentsVerificationMethods = supportedDocumentsVerificationMethods;
        return this;
    }
     ...
     * [OpenID Connect for Identity Assurance 1.0](https://openid.net/specs/openid-connect-4-identity-assurance-1_0.html)
     */
    public ServiceCreateApiResponseBody withSupportedElectronicRecords(@Nullable List<String> supportedElectronicRecords) {
        this.supportedElectronicRecords = supportedElectronicRecords;
        return this;
    }


    public ServiceCreateApiResponseBody withSupportedClientRegistrationTypes(@Nullable List<ServiceCreateApiSupportedClientRegistrationTypeResponse> supportedClientRegistrationTypes) {
        this.supportedClientRegistrationTypes = supportedClientRegistrationTypes;
        return this;
    }
     ...
     * making token exchange requests.
     */
    public ServiceCreateApiResponseBody withTokenExchangeByIdentifiableClientsOnly(@Nullable Boolean tokenExchangeByIdentifiableClientsOnly) {
        this.tokenExchangeByIdentifiableClientsOnly = tokenExchangeByIdentifiableClientsOnly;
        return this;
    }
     ...
     * token exchange requests.
     */
    public ServiceCreateApiResponseBody withTokenExchangeByConfidentialClientsOnly(@Nullable Boolean tokenExchangeByConfidentialClientsOnly) {
        this.tokenExchangeByConfidentialClientsOnly = tokenExchangeByConfidentialClientsOnly;
        return this;
    }
     ...
     * permission from making token exchange requests.
     */
    public ServiceCreateApiResponseBody withTokenExchangeByPermittedClientsOnly(@Nullable Boolean tokenExchangeByPermittedClientsOnly) {
        this.tokenExchangeByPermittedClientsOnly = tokenExchangeByPermittedClientsOnly;
        return this;
    }
     ...
     * use encrypted JWTs as input tokens.
     */
    public ServiceCreateApiResponseBody withTokenExchangeEncryptedJwtRejected(@Nullable Boolean tokenExchangeEncryptedJwtRejected) {
        this.tokenExchangeEncryptedJwtRejected = tokenExchangeEncryptedJwtRejected;
        return this;
    }
     ...
     * use unsigned JWTs as input tokens.
     */
    public ServiceCreateApiResponseBody withTokenExchangeUnsignedJwtRejected(@Nullable Boolean tokenExchangeUnsignedJwtRejected) {
        this.tokenExchangeUnsignedJwtRejected = tokenExchangeUnsignedJwtRejected;
        return this;
    }
     ...
     * using the grant type "urn:ietf:params:oauth:grant-type:jwt-bearer".
     */
    public ServiceCreateApiResponseBody withJwtGrantByIdentifiableClientsOnly(@Nullable Boolean jwtGrantByIdentifiableClientsOnly) {
        this.jwtGrantByIdentifiableClientsOnly = jwtGrantByIdentifiableClientsOnly;
        return this;
    }
     ...
     * "urn:ietf:params:oauth:grant-type:jwt-bearer".
     */
    public ServiceCreateApiResponseBody withJwtGrantEncryptedJwtRejected(@Nullable Boolean jwtGrantEncryptedJwtRejected) {
        this.jwtGrantEncryptedJwtRejected = jwtGrantEncryptedJwtRejected;
        return this;
    }
     ...
     * "urn:ietf:params:oauth:grant-type:jwt-bearer".
     */
    public ServiceCreateApiResponseBody withJwtGrantUnsignedJwtRejected(@Nullable Boolean jwtGrantUnsignedJwtRejected) {
        this.jwtGrantUnsignedJwtRejected = jwtGrantUnsignedJwtRejected;
        return this;
    }
     ...
     * requests whose "software_id" has already been used previously.
     */
    public ServiceCreateApiResponseBody withDcrDuplicateSoftwareIdBlocked(@Nullable Boolean dcrDuplicateSoftwareIdBlocked) {
        this.dcrDuplicateSoftwareIdBlocked = dcrDuplicateSoftwareIdBlocked;
        return this;
    }
     ...
     * that OpenID Connect Federation 1.0 does not work.
     */
    public ServiceCreateApiResponseBody withTrustAnchors(@Nullable List<ServiceCreateApiTrustAnchorResponse> trustAnchors) {
        this.trustAnchors = trustAnchors;
        return this;
    }
     ...
     * is used.
     */
    public ServiceCreateApiResponseBody withOpenidDroppedOnRefreshWithoutOfflineAccess(@Nullable Boolean openidDroppedOnRefreshWithoutOfflineAccess) {
        this.openidDroppedOnRefreshWithoutOfflineAccess = openidDroppedOnRefreshWithoutOfflineAccess;
        return this;
    }
     ...
     * Assurance 1.0.
     */
    public ServiceCreateApiResponseBody withSupportedDocumentsCheckMethods(@Nullable List<String> supportedDocumentsCheckMethods) {
        this.supportedDocumentsCheckMethods = supportedDocumentsCheckMethods;
        return this;
    }
     ...
     * The flag indicating whether this service signs responses from the resource server.
     */
    public ServiceCreateApiResponseBody withRsResponseSigned(@Nullable Boolean rsResponseSigned) {
        this.rsResponseSigned = rsResponseSigned;
        return this;
    }
     ...
     * The duration of `c_nonce`.
     */
    public ServiceCreateApiResponseBody withCnonceDuration(@Nullable Long cnonceDuration) {
        this.cnonceDuration = cnonceDuration;
        return this;
    }
     ...
     * whenever they are presented.
     */
    public ServiceCreateApiResponseBody withDpopNonceRequired(@Nullable Boolean dpopNonceRequired) {
        this.dpopNonceRequired = dpopNonceRequired;
        return this;
    }
     ...
     * for this service is enabled or not.
     */
    public ServiceCreateApiResponseBody withVerifiableCredentialsEnabled(@Nullable Boolean verifiableCredentialsEnabled) {
        this.verifiableCredentialsEnabled = verifiableCredentialsEnabled;
        return this;
    }
     ...
     * exposed.
     */
    public ServiceCreateApiResponseBody withCredentialJwksUri(@Nullable String credentialJwksUri) {
        this.credentialJwksUri = credentialJwksUri;
        return this;
    }
     ...
     * The default duration of credential offers in seconds.
     */
    public ServiceCreateApiResponseBody withCredentialOfferDuration(@Nullable Long credentialOfferDuration) {
        this.credentialOfferDuration = credentialOfferDuration;
        return this;
    }
     ...
     * The duration of nonce values for DPoP proof JWTs in seconds.
     */
    public ServiceCreateApiResponseBody withDpopNonceDuration(@Nullable Long dpopNonceDuration) {
        this.dpopNonceDuration = dpopNonceDuration;
        return this;
    }
     ...
     * code grant flow by unidentifiable clients are allowed.
     */
    public ServiceCreateApiResponseBody withPreAuthorizedGrantAnonymousAccessSupported(@Nullable Boolean preAuthorizedGrantAnonymousAccessSupported) {
        this.preAuthorizedGrantAnonymousAccessSupported = preAuthorizedGrantAnonymousAccessSupported;
        return this;
    }
     ...
     * result of a credential request or a batch credential request.
     */
    public ServiceCreateApiResponseBody withCredentialTransactionDuration(@Nullable Long credentialTransactionDuration) {
        this.credentialTransactionDuration = credentialTransactionDuration;
        return this;
    }
     ...
     * The key ID of the key for signing introspection responses.
     */
    public ServiceCreateApiResponseBody withIntrospectionSignatureKeyId(@Nullable String introspectionSignatureKeyId) {
        this.introspectionSignatureKeyId = introspectionSignatureKeyId;
        return this;
    }
     ...
     * The key ID of the key for signing introspection responses.
     */
    public ServiceCreateApiResponseBody withResourceSignatureKeyId(@Nullable String resourceSignatureKeyId) {
        this.resourceSignatureKeyId = resourceSignatureKeyId;
        return this;
    }
     ...
     * The default length of user PINs.
     */
    public ServiceCreateApiResponseBody withUserPinLength(@Nullable Integer userPinLength) {
        this.userPinLength = userPinLength;
        return this;
    }
     ...
     * The supported `prompt` values.
     */
    public ServiceCreateApiResponseBody withSupportedPromptValues(@Nullable List<ServiceCreateApiSupportedPromptValueResponse> supportedPromptValues) {
        this.supportedPromptValues = supportedPromptValues;
        return this;
    }
     ...
     * reissuance in the refresh token flow.
     */
    public ServiceCreateApiResponseBody withIdTokenReissuable(@Nullable Boolean idTokenReissuable) {
        this.idTokenReissuable = idTokenReissuable;
        return this;
    }
     ...
     * verifiable credentials.
     */
    public ServiceCreateApiResponseBody withCredentialJwks(@Nullable String credentialJwks) {
        this.credentialJwks = credentialJwks;
        return this;
    }
     ...
     * Advanced" if the FAPI feature is enabled in Authlete and the FAPI profile is supported by this service.
     */
    public ServiceCreateApiResponseBody withFapiModes(@Nullable List<ServiceCreateApiFapiModeResponse> fapiModes) {
        this.fapiModes = fapiModes;
        return this;
    }
     ...
     * The default duration of verifiable credentials in seconds.
     */
    public ServiceCreateApiResponseBody withCredentialDuration(@Nullable Long credentialDuration) {
        this.credentialDuration = credentialDuration;
        return this;
    }


    public ServiceCreateApiResponseBody withCredentialIssuerMetadata(@Nullable ServiceCreateApiCredentialIssuerMetadataResponse credentialIssuerMetadata) {
        this.credentialIssuerMetadata = credentialIssuerMetadata;
        return this;
    }
     ...
     * The type of the `aud` claim in ID tokens.
     */
    public ServiceCreateApiResponseBody withIdTokenAudType(@Nullable String idTokenAudType) {
        this.idTokenAudType = idTokenAudType;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ServiceCreateApiResponseBody other = (ServiceCreateApiResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ServiceCreateApiResponseBody.class,
                "number", number,
    ...
    public final static class Builder {
         ...
         *   | `clientCount` | The number of client applications which belong to this service.  |
         */
        public Builder metadata(@Nullable List<ServiceCreateApiMetadatumResponse> metadata) {
            this.metadata = metadata;
            return this;
        }
         ...
         * [OpenID Provider Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
         */
        public Builder supportedGrantTypes(@Nullable List<ServiceCreateApiSupportedGrantTypeResponse> supportedGrantTypes) {
            this.supportedGrantTypes = supportedGrantTypes;
            return this;
        }
         ...
         * [OpenID Provider Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
         */
        public Builder supportedResponseTypes(@Nullable List<ServiceCreateApiSupportedResponseTypeResponse> supportedResponseTypes) {
            this.supportedResponseTypes = supportedResponseTypes;
            return this;
        }
         ...
         * The profiles that this service supports.
         */
        public Builder supportedServiceProfiles(@Nullable List<ServiceCreateApiSupportedServiceProfileResponse> supportedServiceProfiles) {
            this.supportedServiceProfiles = supportedServiceProfiles;
            return this;
        }
         ...
         * <p>The value of this property is used as `display_values_supported` property in the Provider Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
         */
        public Builder supportedDisplays(@Nullable List<ServiceCreateApiSupportedDisplayResponse> supportedDisplays) {
            this.supportedDisplays = supportedDisplays;
            return this;
        }
         ...
         * [OpenID Provider Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
         */
        public Builder supportedTokenAuthMethods(@Nullable List<ServiceCreateApiSupportedTokenAuthMethodResponse> supportedTokenAuthMethods) {
            this.supportedTokenAuthMethods = supportedTokenAuthMethods;
            return this;
        }
         ...
         * Client authentication methods supported at the revocation endpoint.
         */
        public Builder supportedRevocationAuthMethods(@Nullable List<ServiceCreateApiSupportedRevocationAuthMethodResponse> supportedRevocationAuthMethods) {
            this.supportedRevocationAuthMethods = supportedRevocationAuthMethods;
            return this;
        }
         ...
         * Client authentication methods supported at the introspection endpoint.
         */
        public Builder supportedIntrospectionAuthMethods(@Nullable List<ServiceCreateApiSupportedIntrospectionAuthMethodResponse> supportedIntrospectionAuthMethods) {
            this.supportedIntrospectionAuthMethods = supportedIntrospectionAuthMethods;
            return this;
        }
         ...
         * ```
         */
        public Builder mtlsEndpointAliases(@Nullable List<ServiceCreateApiMtlsEndpointAliasResponse> mtlsEndpointAliases) {
            this.mtlsEndpointAliases = mtlsEndpointAliases;
            return this;
        }
         ...
         *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
         */
        public Builder accessTokenSignAlg(@Nullable ServiceCreateApiAccessTokenSignAlgResponse accessTokenSignAlg) {
            this.accessTokenSignAlg = accessTokenSignAlg;
            return this;
        }
         ...
         * <p>The value of this property is used as `scopes_supported` property in the [OpenID Provider Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
         */
        public Builder supportedScopes(@Nullable List<ServiceCreateApiSupportedScopeResponse> supportedScopes) {
            this.supportedScopes = supportedScopes;
            return this;
        }
         ...
         * Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata).
         */
        public Builder supportedClaimTypes(@Nullable List<ServiceCreateApiSupportedClaimTypeResponse> supportedClaimTypes) {
            this.supportedClaimTypes = supportedClaimTypes;
            return this;
        }
         ...
         * Backchannel Authentication)](https://openid.net/specs/openid-client-initiated-backchannel-authentication-core-1_0.html).
         */
        public Builder supportedBackchannelTokenDeliveryModes(@Nullable List<ServiceCreateApiSupportedBackchannelTokenDeliveryModeResponse> supportedBackchannelTokenDeliveryModes) {
            this.supportedBackchannelTokenDeliveryModes = supportedBackchannelTokenDeliveryModes;
            return this;
        }
         ...
         * The character set for end-user verification codes (`user_code`) for Device Flow.
         */
        public Builder userCodeCharset(@Nullable ServiceCreateApiUserCodeCharsetResponse userCodeCharset) {
            this.userCodeCharset = userCodeCharset;
            return this;
        }
         ...
         * OIDC4IDA / verifiedClaimsValidationSchemaSet
         */
        public Builder verifiedClaimsValidationSchemaSet(@Nullable ServiceCreateApiVerifiedClaimsValidationSchemaSetResponse verifiedClaimsValidationSchemaSet) {
            this.verifiedClaimsValidationSchemaSet = verifiedClaimsValidationSchemaSet;
            return this;
        }
         ...
         * The attributes of this service.
         */
        public Builder attributes(@Nullable List<ServiceCreateApiAttributeResponse> attributes) {
            this.attributes = attributes;
            return this;
        }
         ...
         * only by `/api/hsk/*` APIs.
         */
        public Builder hsks(@Nullable List<ServiceCreateApiHskResponse> hsks) {
            this.hsks = hsks;
            return this;
        }
         ...
         * implementer's draft of OpenID Connect for Identity Assurance 1.0.
         */
        public Builder supportedAttachments(@Nullable List<ServiceCreateApiSupportedAttachmentResponse> supportedAttachments) {
            this.supportedAttachments = supportedAttachments;
            return this;
        }
        ...
        public Builder supportedClientRegistrationTypes(@Nullable List<ServiceCreateApiSupportedClientRegistrationTypeResponse> supportedClientRegistrationTypes) {
            this.supportedClientRegistrationTypes = supportedClientRegistrationTypes;
            return this;
        }
         ...
         * that OpenID Connect Federation 1.0 does not work.
         */
        public Builder trustAnchors(@Nullable List<ServiceCreateApiTrustAnchorResponse> trustAnchors) {
            this.trustAnchors = trustAnchors;
            return this;
        }
         ...
         * The supported `prompt` values.
         */
        public Builder supportedPromptValues(@Nullable List<ServiceCreateApiSupportedPromptValueResponse> supportedPromptValues) {
            this.supportedPromptValues = supportedPromptValues;
            return this;
        }
         ...
         * Advanced" if the FAPI feature is enabled in Authlete and the FAPI profile is supported by this service.
         */
        public Builder fapiModes(@Nullable List<ServiceCreateApiFapiModeResponse> fapiModes) {
            this.fapiModes = fapiModes;
            return this;
        }
        ...
        public Builder credentialIssuerMetadata(@Nullable ServiceCreateApiCredentialIssuerMetadataResponse credentialIssuerMetadata) {
            this.credentialIssuerMetadata = credentialIssuerMetadata;
            return this;
        }
        ...
        public ServiceCreateApiResponseBody build() {
            return new ServiceCreateApiResponseBody(
                number, serviceName, issuer,
                description, apiKey, clientIdAliasEnabled,
                metadata, createdAt, modifiedAt,
                authenticationCallbackEndpoint, authenticationCallbackApiKey, authenticationCallbackApiSecret,
