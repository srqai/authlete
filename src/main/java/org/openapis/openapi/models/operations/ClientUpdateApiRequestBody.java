...
public class ClientUpdateApiRequestBody {
    /**
    ...
    private List<ClientUpdateApiClientNameRequest> clientNames;
    ...
    private List<ClientUpdateApiDescriptionRequest> descriptions;
    ...
    private ClientUpdateApiClientTypeRequest clientType;
    ...
    private ClientUpdateApiApplicationTypeRequest applicationType;
    ...
    private List<ClientUpdateApiLogoUrisRequest> logoUris;
    ...
    private List<ClientUpdateApiGrantTypeRequest> grantTypes;
    ...
    private List<ClientUpdateApiResponseTypeRequest> responseTypes;
    ...
    private ClientUpdateApiAuthorizationSignAlgRequest authorizationSignAlg;
    ...
    private ClientUpdateApiAuthorizationEncryptionAlgRequest authorizationEncryptionAlg;
    ...
    private ClientUpdateApiAuthorizationEncryptionEncRequest authorizationEncryptionEnc;
    ...
    private ClientUpdateApiTokenAuthMethodRequest tokenAuthMethod;
    ...
    private ClientUpdateApiTokenAuthSignAlgRequest tokenAuthSignAlg;
    ...
    private ClientUpdateApiRequestSignAlgRequest requestSignAlg;
    ...
    private ClientUpdateApiRequestEncryptionAlgRequest requestEncryptionAlg;
    ...
    private ClientUpdateApiRequestEncryptionEncRequest requestEncryptionEnc;
    ...
    private ClientUpdateApiIdTokenSignAlgRequest idTokenSignAlg;
    ...
    private ClientUpdateApiIdTokenEncryptionAlgRequest idTokenEncryptionAlg;
    ...
    private ClientUpdateApiIdTokenEncryptionEncRequest idTokenEncryptionEnc;
    ...
    private ClientUpdateApiSubjectTypeRequest subjectType;
    ...
    private ClientUpdateApiUserInfoSignAlgRequest userInfoSignAlg;
    ...
    private ClientUpdateApiUserInfoEncryptionAlgRequest userInfoEncryptionAlg;
    ...
    private ClientUpdateApiUserInfoEncryptionEncRequest userInfoEncryptionEnc;
    ...
    private List<ClientUpdateApiTosUrisRequest> tosUris;
    ...
    private List<ClientUpdateApiPolicyUrisRequest> policyUris;
    ...
    private List<ClientUpdateApiClientUrisRequest> clientUris;
    ...
    private ClientUpdateApiBcRequestSignAlgRequest bcRequestSignAlg;
    ...
    private List<ClientUpdateApiAttributeRequest> attributes;


    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("extension")
    private ClientUpdateApiExtensionRequest extension;
    ...
    private List<ClientUpdateApiClientRegistrationTypeRequest> clientRegistrationTypes;
    ...
    private List<ClientUpdateApiFapiModeRequest> fapiModes;
    ...
    private List<ClientUpdateApiResponseModeRequest> responseModes;
    ...
    @JsonCreator
    public ClientUpdateApiRequestBody(
            @JsonProperty("clientName") @Nullable String clientName,
            @JsonProperty("clientNames") @Nullable List<ClientUpdateApiClientNameRequest> clientNames,
            @JsonProperty("description") @Nullable String description,
            @JsonProperty("descriptions") @Nullable List<ClientUpdateApiDescriptionRequest> descriptions,
            ...
            @JsonProperty("clientType") @Nullable ClientUpdateApiClientTypeRequest clientType,
            @JsonProperty("applicationType") @Nullable ClientUpdateApiApplicationTypeRequest applicationType,
            @JsonProperty("logoUri") @Nullable String logoUri,
            @JsonProperty("logoUris") @Nullable List<ClientUpdateApiLogoUrisRequest> logoUris,
            ...
            @JsonProperty("grantTypes") @Nullable List<ClientUpdateApiGrantTypeRequest> grantTypes,
            @JsonProperty("responseTypes") @Nullable List<ClientUpdateApiResponseTypeRequest> responseTypes,
            @JsonProperty("redirectUris") @Nullable List<String> redirectUris,
            @JsonProperty("authorizationSignAlg") @Nullable ClientUpdateApiAuthorizationSignAlgRequest authorizationSignAlg,
            @JsonProperty("authorizationEncryptionAlg") @Nullable ClientUpdateApiAuthorizationEncryptionAlgRequest authorizationEncryptionAlg,
            @JsonProperty("authorizationEncryptionEnc") @Nullable ClientUpdateApiAuthorizationEncryptionEncRequest authorizationEncryptionEnc,
            @JsonProperty("tokenAuthMethod") @Nullable ClientUpdateApiTokenAuthMethodRequest tokenAuthMethod,
            @JsonProperty("tokenAuthSignAlg") @Nullable ClientUpdateApiTokenAuthSignAlgRequest tokenAuthSignAlg,
            ...
            @JsonProperty("requestSignAlg") @Nullable ClientUpdateApiRequestSignAlgRequest requestSignAlg,
            @JsonProperty("requestEncryptionAlg") @Nullable ClientUpdateApiRequestEncryptionAlgRequest requestEncryptionAlg,
            @JsonProperty("requestEncryptionEnc") @Nullable ClientUpdateApiRequestEncryptionEncRequest requestEncryptionEnc,
            ...
            @JsonProperty("idTokenSignAlg") @Nullable ClientUpdateApiIdTokenSignAlgRequest idTokenSignAlg,
            @JsonProperty("idTokenEncryptionAlg") @Nullable ClientUpdateApiIdTokenEncryptionAlgRequest idTokenEncryptionAlg,
            @JsonProperty("idTokenEncryptionEnc") @Nullable ClientUpdateApiIdTokenEncryptionEncRequest idTokenEncryptionEnc,
            @JsonProperty("authTimeRequired") @Nullable Boolean authTimeRequired,
            @JsonProperty("subjectType") @Nullable ClientUpdateApiSubjectTypeRequest subjectType,
            ...
            @JsonProperty("userInfoSignAlg") @Nullable ClientUpdateApiUserInfoSignAlgRequest userInfoSignAlg,
            @JsonProperty("userInfoEncryptionAlg") @Nullable ClientUpdateApiUserInfoEncryptionAlgRequest userInfoEncryptionAlg,
            @JsonProperty("userInfoEncryptionEnc") @Nullable ClientUpdateApiUserInfoEncryptionEncRequest userInfoEncryptionEnc,
            @JsonProperty("loginUri") @Nullable String loginUri,
            @JsonProperty("tosUri") @Nullable String tosUri,
            @JsonProperty("tosUris") @Nullable List<ClientUpdateApiTosUrisRequest> tosUris,
            @JsonProperty("policyUri") @Nullable String policyUri,
            @JsonProperty("policyUris") @Nullable List<ClientUpdateApiPolicyUrisRequest> policyUris,
            @JsonProperty("clientUri") @Nullable String clientUri,
            @JsonProperty("clientUris") @Nullable List<ClientUpdateApiClientUrisRequest> clientUris,
            ...
            @JsonProperty("bcRequestSignAlg") @Nullable ClientUpdateApiBcRequestSignAlgRequest bcRequestSignAlg,
            @JsonProperty("bcUserCodeRequired") @Nullable Boolean bcUserCodeRequired,
            @JsonProperty("attributes") @Nullable List<ClientUpdateApiAttributeRequest> attributes,
            @JsonProperty("extension") @Nullable ClientUpdateApiExtensionRequest extension,
            ...
            @JsonProperty("clientRegistrationTypes") @Nullable List<ClientUpdateApiClientRegistrationTypeRequest> clientRegistrationTypes,
            ...
            @JsonProperty("fapiModes") @Nullable List<ClientUpdateApiFapiModeRequest> fapiModes,
            @JsonProperty("responseModes") @Nullable List<ClientUpdateApiResponseModeRequest> responseModes,
     ...
     * languages, this property can be used to register the names.
     */
    public Optional<List<ClientUpdateApiClientNameRequest>> clientNames() {
     ...
     * descriptions for different languages, this property can be used to register the descriptions.
     */
    public Optional<List<ClientUpdateApiDescriptionRequest>> descriptions() {
     ...
     * for details.
     */
    public Optional<ClientUpdateApiClientTypeRequest> clientType() {
     ...
     * See the description about `redirectUris` property for more details.
     */
    public Optional<ClientUpdateApiApplicationTypeRequest> applicationType() {
     ...
     * different languages, this property can be used to register URLs of the images.
     */
    public Optional<List<ClientUpdateApiLogoUrisRequest>> logoUris() {
     ...
     * 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public Optional<List<ClientUpdateApiGrantTypeRequest>> grantTypes() {
     ...
     * 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public Optional<List<ClientUpdateApiResponseTypeRequest>> responseTypes() {
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public Optional<ClientUpdateApiAuthorizationSignAlgRequest> authorizationSignAlg() {
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public Optional<ClientUpdateApiAuthorizationEncryptionAlgRequest> authorizationEncryptionAlg() {
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public Optional<ClientUpdateApiAuthorizationEncryptionEncRequest> authorizationEncryptionEnc() {
     ...
     * Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public Optional<ClientUpdateApiTokenAuthMethodRequest> tokenAuthMethod() {
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public Optional<ClientUpdateApiTokenAuthSignAlgRequest> tokenAuthSignAlg() {
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public Optional<ClientUpdateApiRequestSignAlgRequest> requestSignAlg() {
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public Optional<ClientUpdateApiRequestEncryptionAlgRequest> requestEncryptionAlg() {
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public Optional<ClientUpdateApiRequestEncryptionEncRequest> requestEncryptionEnc() {
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public Optional<ClientUpdateApiIdTokenSignAlgRequest> idTokenSignAlg() {
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public Optional<ClientUpdateApiIdTokenEncryptionAlgRequest> idTokenEncryptionAlg() {
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public Optional<ClientUpdateApiIdTokenEncryptionEncRequest> idTokenEncryptionEnc() {
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public Optional<ClientUpdateApiSubjectTypeRequest> subjectType() {
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public Optional<ClientUpdateApiUserInfoSignAlgRequest> userInfoSignAlg() {
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public Optional<ClientUpdateApiUserInfoEncryptionAlgRequest> userInfoEncryptionAlg() {
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public Optional<ClientUpdateApiUserInfoEncryptionEncRequest> userInfoEncryptionEnc() {
     ...
     * this property can be used to register the URLs.
     */
    public Optional<List<ClientUpdateApiTosUrisRequest>> tosUris() {
     ...
     * If the client application has different policy pages for different languages, this property can be used to register the URLs.
     */
    public Optional<List<ClientUpdateApiPolicyUrisRequest>> policyUris() {
     ...
     * be used to register the URLs.
     */
    public Optional<List<ClientUpdateApiClientUrisRequest>> clientUris() {
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public Optional<ClientUpdateApiBcRequestSignAlgRequest> bcRequestSignAlg() {
     ...
     * The attributes of this client.
     */
    public Optional<List<ClientUpdateApiAttributeRequest>> attributes() {
        return Optional.ofNullable(this.attributes);
    }

    public Optional<ClientUpdateApiExtensionRequest> extension() {
     ...
     * The client registration types that the client has declared it may use.
     */
    public Optional<List<ClientUpdateApiClientRegistrationTypeRequest>> clientRegistrationTypes() {
     ...
     * the service, and the FAPI modes for the service are set to `null`.
     */
    public Optional<List<ClientUpdateApiFapiModeRequest>> fapiModes() {
     ...
     * The response modes that this client may use.
     */
    public Optional<List<ClientUpdateApiResponseModeRequest>> responseModes() {
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientUpdateApiRequestBody withClientName(@Nullable String clientName) {
        this.clientName = clientName;
        return this;
    }
     ...
     * languages, this property can be used to register the names.
     */
    public ClientUpdateApiRequestBody withClientNames(@Nullable List<ClientUpdateApiClientNameRequest> clientNames) {
        this.clientNames = clientNames;
        return this;
    }
     ...
     * The description about the client application.
     */
    public ClientUpdateApiRequestBody withDescription(@Nullable String description) {
        this.description = description;
        return this;
    }
     ...
     * descriptions for different languages, this property can be used to register the descriptions.
     */
    public ClientUpdateApiRequestBody withDescriptions(@Nullable List<ClientUpdateApiDescriptionRequest> descriptions) {
        this.descriptions = descriptions;
        return this;
    }
     ...
     * default, this is a string version of the `clientId` property.
     */
    public ClientUpdateApiRequestBody withClientIdAlias(@Nullable String clientIdAlias) {
        this.clientIdAlias = clientIdAlias;
        return this;
    }
     ...
     * Deprecated. Always set to `true`.
     */
    public ClientUpdateApiRequestBody withClientIdAliasEnabled(@Nullable Boolean clientIdAliasEnabled) {
        this.clientIdAliasEnabled = clientIdAliasEnabled;
        return this;
    }
     ...
     * for details.
     */
    public ClientUpdateApiRequestBody withClientType(@Nullable ClientUpdateApiClientTypeRequest clientType) {
        this.clientType = clientType;
        return this;
    }
     ...
     * See the description about `redirectUris` property for more details.
     */
    public ClientUpdateApiRequestBody withApplicationType(@Nullable ClientUpdateApiApplicationTypeRequest applicationType) {
        this.applicationType = applicationType;
        return this;
    }
     ...
     * Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientUpdateApiRequestBody withLogoUri(@Nullable String logoUri) {
        this.logoUri = logoUri;
        return this;
    }
     ...
     * different languages, this property can be used to register URLs of the images.
     */
    public ClientUpdateApiRequestBody withLogoUris(@Nullable List<ClientUpdateApiLogoUrisRequest> logoUris) {
        this.logoUris = logoUris;
        return this;
    }
     ...
     * Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientUpdateApiRequestBody withContacts(@Nullable List<String> contacts) {
        this.contacts = contacts;
        return this;
    }
     ...
     * The flag to indicate whether this client use TLS client certificate bound access tokens.
     */
    public ClientUpdateApiRequestBody withTlsClientCertificateBoundAccessTokens(@Nullable Boolean tlsClientCertificateBoundAccessTokens) {
        this.tlsClientCertificateBoundAccessTokens = tlsClientCertificateBoundAccessTokens;
        return this;
    }
     ...
     * of [RFC 7591](https://datatracker.ietf.org/doc/html/rfc7591).
     */
    public ClientUpdateApiRequestBody withSoftwareId(@Nullable String softwareId) {
        this.softwareId = softwareId;
        return this;
    }
     ...
     * of [RFC 7591](https://datatracker.ietf.org/doc/html/rfc7591).
     */
    public ClientUpdateApiRequestBody withSoftwareVersion(@Nullable String softwareVersion) {
        this.softwareVersion = softwareVersion;
        return this;
    }
     ...
     * The hash of the registration access token for this client.
     */
    public ClientUpdateApiRequestBody withRegistrationAccessTokenHash(@Nullable String registrationAccessTokenHash) {
        this.registrationAccessTokenHash = registrationAccessTokenHash;
        return this;
    }
     ...
     * 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientUpdateApiRequestBody withGrantTypes(@Nullable List<ClientUpdateApiGrantTypeRequest> grantTypes) {
        this.grantTypes = grantTypes;
        return this;
    }
     ...
     * 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientUpdateApiRequestBody withResponseTypes(@Nullable List<ClientUpdateApiResponseTypeRequest> responseTypes) {
        this.responseTypes = responseTypes;
        return this;
    }
     ...
     * details), but OpenID Connect requires exact match.
     */
    public ClientUpdateApiRequestBody withRedirectUris(@Nullable List<String> redirectUris) {
        this.redirectUris = redirectUris;
        return this;
    }
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public ClientUpdateApiRequestBody withAuthorizationSignAlg(@Nullable ClientUpdateApiAuthorizationSignAlgRequest authorizationSignAlg) {
        this.authorizationSignAlg = authorizationSignAlg;
        return this;
    }
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public ClientUpdateApiRequestBody withAuthorizationEncryptionAlg(@Nullable ClientUpdateApiAuthorizationEncryptionAlgRequest authorizationEncryptionAlg) {
        this.authorizationEncryptionAlg = authorizationEncryptionAlg;
        return this;
    }
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public ClientUpdateApiRequestBody withAuthorizationEncryptionEnc(@Nullable ClientUpdateApiAuthorizationEncryptionEncRequest authorizationEncryptionEnc) {
        this.authorizationEncryptionEnc = authorizationEncryptionEnc;
        return this;
    }
     ...
     * Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientUpdateApiRequestBody withTokenAuthMethod(@Nullable ClientUpdateApiTokenAuthMethodRequest tokenAuthMethod) {
        this.tokenAuthMethod = tokenAuthMethod;
        return this;
    }
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public ClientUpdateApiRequestBody withTokenAuthSignAlg(@Nullable ClientUpdateApiTokenAuthSignAlgRequest tokenAuthSignAlg) {
        this.tokenAuthSignAlg = tokenAuthSignAlg;
        return this;
    }
     ...
     * The key ID of a JWK containing a self-signed certificate of this client.
     */
    public ClientUpdateApiRequestBody withSelfSignedCertificateKeyId(@Nullable String selfSignedCertificateKeyId) {
        this.selfSignedCertificateKeyId = selfSignedCertificateKeyId;
        return this;
    }
     ...
     * Registration" for details.
     */
    public ClientUpdateApiRequestBody withTlsClientAuthSubjectDn(@Nullable String tlsClientAuthSubjectDn) {
        this.tlsClientAuthSubjectDn = tlsClientAuthSubjectDn;
        return this;
    }
     ...
     * Registration" for details.
     */
    public ClientUpdateApiRequestBody withTlsClientAuthSanDns(@Nullable String tlsClientAuthSanDns) {
        this.tlsClientAuthSanDns = tlsClientAuthSanDns;
        return this;
    }
     ...
     * Registration" for details.
     */
    public ClientUpdateApiRequestBody withTlsClientAuthSanUri(@Nullable String tlsClientAuthSanUri) {
        this.tlsClientAuthSanUri = tlsClientAuthSanUri;
        return this;
    }
     ...
     * Registration" for details.
     */
    public ClientUpdateApiRequestBody withTlsClientAuthSanIp(@Nullable String tlsClientAuthSanIp) {
        this.tlsClientAuthSanIp = tlsClientAuthSanIp;
        return this;
    }
     ...
     * Registration" for details.
     */
    public ClientUpdateApiRequestBody withTlsClientAuthSanEmail(@Nullable String tlsClientAuthSanEmail) {
        this.tlsClientAuthSanEmail = tlsClientAuthSanEmail;
        return this;
    }
     ...
     * in "OAuth 2.0 Pushed Authorization Requests".
     */
    public ClientUpdateApiRequestBody withParRequired(@Nullable Boolean parRequired) {
        this.parRequired = parRequired;
        return this;
    }
     ...
     * client metadata of this client is `true`. The metadata is defined in "JAR (JWT Secured Authorization Request)".
     */
    public ClientUpdateApiRequestBody withRequestObjectRequired(@Nullable Boolean requestObjectRequired) {
        this.requestObjectRequired = requestObjectRequired;
        return this;
    }
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public ClientUpdateApiRequestBody withRequestSignAlg(@Nullable ClientUpdateApiRequestSignAlgRequest requestSignAlg) {
        this.requestSignAlg = requestSignAlg;
        return this;
    }
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public ClientUpdateApiRequestBody withRequestEncryptionAlg(@Nullable ClientUpdateApiRequestEncryptionAlgRequest requestEncryptionAlg) {
        this.requestEncryptionAlg = requestEncryptionAlg;
        return this;
    }
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public ClientUpdateApiRequestBody withRequestEncryptionEnc(@Nullable ClientUpdateApiRequestEncryptionEncRequest requestEncryptionEnc) {
        this.requestEncryptionEnc = requestEncryptionEnc;
        return this;
    }
     ...
     * See [OpenID Connect Core 1.0, 6.2. Passing a Request Object by Reference](https://openid.net/specs/openid-connect-core-1_0.html#RequestUriParameter) for details.
     */
    public ClientUpdateApiRequestBody withRequestUris(@Nullable List<String> requestUris) {
        this.requestUris = requestUris;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientUpdateApiRequestBody withDefaultMaxAge(@Nullable Integer defaultMaxAge) {
        this.defaultMaxAge = defaultMaxAge;
        return this;
    }
     ...
     * in claims request parameter.
     */
    public ClientUpdateApiRequestBody withDefaultAcrs(@Nullable List<String> defaultAcrs) {
        this.defaultAcrs = defaultAcrs;
        return this;
    }
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public ClientUpdateApiRequestBody withIdTokenSignAlg(@Nullable ClientUpdateApiIdTokenSignAlgRequest idTokenSignAlg) {
        this.idTokenSignAlg = idTokenSignAlg;
        return this;
    }
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public ClientUpdateApiRequestBody withIdTokenEncryptionAlg(@Nullable ClientUpdateApiIdTokenEncryptionAlgRequest idTokenEncryptionAlg) {
        this.idTokenEncryptionAlg = idTokenEncryptionAlg;
        return this;
    }
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public ClientUpdateApiRequestBody withIdTokenEncryptionEnc(@Nullable ClientUpdateApiIdTokenEncryptionEncRequest idTokenEncryptionEnc) {
        this.idTokenEncryptionEnc = idTokenEncryptionEnc;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientUpdateApiRequestBody withAuthTimeRequired(@Nullable Boolean authTimeRequired) {
        this.authTimeRequired = authTimeRequired;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientUpdateApiRequestBody withSubjectType(@Nullable ClientUpdateApiSubjectTypeRequest subjectType) {
        this.subjectType = subjectType;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata)
     */
    public ClientUpdateApiRequestBody withSectorIdentifierUri(@Nullable String sectorIdentifierUri) {
        this.sectorIdentifierUri = sectorIdentifierUri;
        return this;
    }
     ...
     * Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientUpdateApiRequestBody withJwksUri(@Nullable String jwksUri) {
        this.jwksUri = jwksUri;
        return this;
    }
     ...
     * Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientUpdateApiRequestBody withJwks(@Nullable String jwks) {
        this.jwks = jwks;
        return this;
    }
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public ClientUpdateApiRequestBody withUserInfoSignAlg(@Nullable ClientUpdateApiUserInfoSignAlgRequest userInfoSignAlg) {
        this.userInfoSignAlg = userInfoSignAlg;
        return this;
    }
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public ClientUpdateApiRequestBody withUserInfoEncryptionAlg(@Nullable ClientUpdateApiUserInfoEncryptionAlgRequest userInfoEncryptionAlg) {
        this.userInfoEncryptionAlg = userInfoEncryptionAlg;
        return this;
    }
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public ClientUpdateApiRequestBody withUserInfoEncryptionEnc(@Nullable ClientUpdateApiUserInfoEncryptionEncRequest userInfoEncryptionEnc) {
        this.userInfoEncryptionEnc = userInfoEncryptionEnc;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientUpdateApiRequestBody withLoginUri(@Nullable String loginUri) {
        this.loginUri = loginUri;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientUpdateApiRequestBody withTosUri(@Nullable String tosUri) {
        this.tosUri = tosUri;
        return this;
    }
     ...
     * this property can be used to register the URLs.
     */
    public ClientUpdateApiRequestBody withTosUris(@Nullable List<ClientUpdateApiTosUrisRequest> tosUris) {
        this.tosUris = tosUris;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientUpdateApiRequestBody withPolicyUri(@Nullable String policyUri) {
        this.policyUri = policyUri;
        return this;
    }
     ...
     * If the client application has different policy pages for different languages, this property can be used to register the URLs.
     */
    public ClientUpdateApiRequestBody withPolicyUris(@Nullable List<ClientUpdateApiPolicyUrisRequest> policyUris) {
        this.policyUris = policyUris;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientUpdateApiRequestBody withClientUri(@Nullable String clientUri) {
        this.clientUri = clientUri;
        return this;
    }
     ...
     * be used to register the URLs.
     */
    public ClientUpdateApiRequestBody withClientUris(@Nullable List<ClientUpdateApiClientUrisRequest> clientUris) {
        this.clientUris = clientUris;
        return this;
    }
     ...
     * Backchannel Authentication)".
     */
    public ClientUpdateApiRequestBody withBcDeliveryMode(@Nullable String bcDeliveryMode) {
        this.bcDeliveryMode = bcDeliveryMode;
        return this;
    }
     ...
     * Backchannel Authentication)".
     */
    public ClientUpdateApiRequestBody withBcNotificationEndpoint(@Nullable String bcNotificationEndpoint) {
        this.bcNotificationEndpoint = bcNotificationEndpoint;
        return this;
    }
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public ClientUpdateApiRequestBody withBcRequestSignAlg(@Nullable ClientUpdateApiBcRequestSignAlgRequest bcRequestSignAlg) {
        this.bcRequestSignAlg = bcRequestSignAlg;
        return this;
    }
     ...
     * <p>This property corresponds to the `backchannel_user_code_parameter` metadata.
     */
    public ClientUpdateApiRequestBody withBcUserCodeRequired(@Nullable Boolean bcUserCodeRequired) {
        this.bcUserCodeRequired = bcUserCodeRequired;
        return this;
    }
     ...
     * The attributes of this client.
     */
    public ClientUpdateApiRequestBody withAttributes(@Nullable List<ClientUpdateApiAttributeRequest> attributes) {
        this.attributes = attributes;
        return this;
    }


    public ClientUpdateApiRequestBody withExtension(@Nullable ClientUpdateApiExtensionRequest extension) {
        this.extension = extension;
        return this;
    }
     ...
     * to align with the change made by the 5th draft of the RAR specification.
     */
    public ClientUpdateApiRequestBody withAuthorizationDetailsTypes(@Nullable List<String> authorizationDetailsTypes) {
        this.authorizationDetailsTypes = authorizationDetailsTypes;
        return this;
    }
     ...
     * custom client metadata values can be referenced by this property.
     */
    public ClientUpdateApiRequestBody withCustomMetadata(@Nullable String customMetadata) {
        this.customMetadata = customMetadata;
        return this;
    }
     ...
     * flag of the service is `true`.
     */
    public ClientUpdateApiRequestBody withFrontChannelRequestObjectEncryptionRequired(@Nullable Boolean frontChannelRequestObjectEncryptionRequired) {
        this.frontChannelRequestObjectEncryptionRequired = frontChannelRequestObjectEncryptionRequired;
        return this;
    }
     ...
     * flag of the service is `true`.
     */
    public ClientUpdateApiRequestBody withRequestObjectEncryptionAlgMatchRequired(@Nullable Boolean requestObjectEncryptionAlgMatchRequired) {
        this.requestObjectEncryptionAlgMatchRequired = requestObjectEncryptionAlgMatchRequired;
        return this;
    }
     ...
     * flag of the service is `true`.
     */
    public ClientUpdateApiRequestBody withRequestObjectEncryptionEncMatchRequired(@Nullable Boolean requestObjectEncryptionEncMatchRequired) {
        this.requestObjectEncryptionEncMatchRequired = requestObjectEncryptionEncMatchRequired;
        return this;
    }
     ...
     * [OpenID Connect for Identity Assurance 1.0](https://openid.net/specs/openid-connect-4-identity-assurance-1_0.html).
     */
    public ClientUpdateApiRequestBody withDigestAlgorithm(@Nullable String digestAlgorithm) {
        this.digestAlgorithm = digestAlgorithm;
        return this;
    }
     ...
     * <p>Even if `Disabled` is selected here, single access token per subject is effective if `singleAccessTokenPerSubject` of the `Service` this client belongs to is Enabled.
     */
    public ClientUpdateApiRequestBody withSingleAccessTokenPerSubject(@Nullable Boolean singleAccessTokenPerSubject) {
        this.singleAccessTokenPerSubject = singleAccessTokenPerSubject;
        return this;
    }
     ...
     * <p>See [RFC 7636](https://tools.ietf.org/html/rfc7636) (Proof Key for Code Exchange by OAuth Public Clients) for details about `code_challenge` request parameter.
     */
    public ClientUpdateApiRequestBody withPkceRequired(@Nullable Boolean pkceRequired) {
        this.pkceRequired = pkceRequired;
        return this;
    }
     ...
     * Neither omission of the `code_challenge_method` request parameter nor use of plain (`code_challenge_method=plain`) is allowed.
     */
    public ClientUpdateApiRequestBody withPkceS256Required(@Nullable Boolean pkceS256Required) {
        this.pkceS256Required = pkceS256Required;
        return this;
    }
     ...
     * If the DPoP is required for this client
     */
    public ClientUpdateApiRequestBody withDpopRequired(@Nullable Boolean dpopRequired) {
        this.dpopRequired = dpopRequired;
        return this;
    }
     ...
     * "automatic" client registration of OIDC Federation.
     */
    public ClientUpdateApiRequestBody withAutomaticallyRegistered(@Nullable Boolean automaticallyRegistered) {
        this.automaticallyRegistered = automaticallyRegistered;
        return this;
    }
     ...
     * "explicit" client registration of OIDC Federation.
     */
    public ClientUpdateApiRequestBody withExplicitlyRegistered(@Nullable Boolean explicitlyRegistered) {
        this.explicitlyRegistered = explicitlyRegistered;
        return this;
    }
     ...
     * The flag indicating whether this service signs responses from the resource server.
     */
    public ClientUpdateApiRequestBody withRsRequestSigned(@Nullable Boolean rsRequestSigned) {
        this.rsRequestSigned = rsRequestSigned;
        return this;
    }
     ...
     * The key ID of a JWK containing the public key used by this client to sign requests to the resource server.
     */
    public ClientUpdateApiRequestBody withRsSignedRequestKeyId(@Nullable String rsSignedRequestKeyId) {
        this.rsSignedRequestKeyId = rsSignedRequestKeyId;
        return this;
    }
     ...
     * The client registration types that the client has declared it may use.
     */
    public ClientUpdateApiRequestBody withClientRegistrationTypes(@Nullable List<ClientUpdateApiClientRegistrationTypeRequest> clientRegistrationTypes) {
        this.clientRegistrationTypes = clientRegistrationTypes;
        return this;
    }
     ...
     * to the organization_name client metadata that is defined in OpenID Connect Federation 1.0.
     */
    public ClientUpdateApiRequestBody withOrganizationName(@Nullable String organizationName) {
        this.organizationName = organizationName;
        return this;
    }
     ...
     * corresponds to the `signed_jwks_uri` client metadata defined in OpenID Connect Federation 1.0.
     */
    public ClientUpdateApiRequestBody withSignedJwksUri(@Nullable String signedJwksUri) {
        this.signedJwksUri = signedJwksUri;
        return this;
    }
     ...
     * the entity ID of this client.
     */
    public ClientUpdateApiRequestBody withEntityId(@Nullable String entityId) {
        this.entityId = entityId;
        return this;
    }
     ...
     * the mechanism defined in OpenID Connect Federation 1.0
     */
    public ClientUpdateApiRequestBody withTrustAnchorId(@Nullable String trustAnchorId) {
        this.trustAnchorId = trustAnchorId;
        return this;
    }
     ...
     * OpenID Connect Federation 1.0
     */
    public ClientUpdateApiRequestBody withTrustChain(@Nullable List<String> trustChain) {
        this.trustChain = trustChain;
        return this;
    }
     ...
     * defined in OpenID Connect Federation 1.0. The value is represented as milliseconds elapsed since the Unix epoch (1970-01-01).
     */
    public ClientUpdateApiRequestBody withTrustChainExpiresAt(@Nullable Long trustChainExpiresAt) {
        this.trustChainExpiresAt = trustChainExpiresAt;
        return this;
    }
     ...
     * the time at which the trust chain was updated by the mechanism defined in OpenID Connect Federation 1.0
     */
    public ClientUpdateApiRequestBody withTrustChainUpdatedAt(@Nullable Long trustChainUpdatedAt) {
        this.trustChainUpdatedAt = trustChainUpdatedAt;
        return this;
    }
     ...
     * The flag which indicates whether this client is locked.
     */
    public ClientUpdateApiRequestBody withLocked(@Nullable Boolean locked) {
        this.locked = locked;
        return this;
    }
     ...
     * (wallet) receives a credential offer from the credential issuer.
     */
    public ClientUpdateApiRequestBody withCredentialOfferEndpoint(@Nullable String credentialOfferEndpoint) {
        this.credentialOfferEndpoint = credentialOfferEndpoint;
        return this;
    }
     ...
     * the service, and the FAPI modes for the service are set to `null`.
     */
    public ClientUpdateApiRequestBody withFapiModes(@Nullable List<ClientUpdateApiFapiModeRequest> fapiModes) {
        this.fapiModes = fapiModes;
        return this;
    }
     ...
     * The response modes that this client may use.
     */
    public ClientUpdateApiRequestBody withResponseModes(@Nullable List<ClientUpdateApiResponseModeRequest> responseModes) {
        this.responseModes = responseModes;
        return this;
    }
     ...
     * True if credential responses to this client must be always encrypted.
     */
    public ClientUpdateApiRequestBody withCredentialResponseEncryptionRequired(@Nullable Boolean credentialResponseEncryptionRequired) {
        this.credentialResponseEncryptionRequired = credentialResponseEncryptionRequired;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClientUpdateApiRequestBody other = (ClientUpdateApiRequestBody) o;
        return 
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            clientName, clientNames, description,
            descriptions, clientIdAlias, clientIdAliasEnabled,
            clientType, applicationType, logoUri,
            logoUris, contacts, tlsClientCertificateBoundAccessTokens,
            softwareId, softwareVersion, registrationAccessTokenHash,
            grantTypes, responseTypes, redirectUris,
            authorizationSignAlg, authorizationEncryptionAlg, authorizationEncryptionEnc,
            tokenAuthMethod, tokenAuthSignAlg, selfSignedCertificateKeyId,
            tlsClientAuthSubjectDn, tlsClientAuthSanDns, tlsClientAuthSanUri,
            tlsClientAuthSanIp, tlsClientAuthSanEmail, parRequired,
            requestObjectRequired, requestSignAlg, requestEncryptionAlg,
            requestEncryptionEnc, requestUris, defaultMaxAge,
            defaultAcrs, idTokenSignAlg, idTokenEncryptionAlg,
            idTokenEncryptionEnc, authTimeRequired, subjectType,
            sectorIdentifierUri, jwksUri, jwks,
            userInfoSignAlg, userInfoEncryptionAlg, userInfoEncryptionEnc,
            loginUri, tosUri, tosUris,
            policyUri, policyUris, clientUri,
            clientUris, bcDeliveryMode, bcNotificationEndpoint,
            bcRequestSignAlg, bcUserCodeRequired, attributes,
            extension, authorizationDetailsTypes, customMetadata,
            frontChannelRequestObjectEncryptionRequired, requestObjectEncryptionAlgMatchRequired, requestObjectEncryptionEncMatchRequired,
            digestAlgorithm, singleAccessTokenPerSubject, pkceRequired,
            pkceS256Required, dpopRequired, automaticallyRegistered,
            explicitlyRegistered, rsRequestSigned, rsSignedRequestKeyId,
            clientRegistrationTypes, organizationName, signedJwksUri,
            entityId, trustAnchorId, trustChain,
            trustChainExpiresAt, trustChainUpdatedAt, locked,
            credentialOfferEndpoint, fapiModes, responseModes,
            credentialResponseEncryptionRequired);
    }
    
    @Override
    public String toString() {
        return Utils.toString(ClientUpdateApiRequestBody.class,
    ...
    public final static class Builder {
         ...
         * languages, this property can be used to register the names.
         */
        public Builder clientNames(@Nullable List<ClientUpdateApiClientNameRequest> clientNames) {
            this.clientNames = clientNames;
            return this;
        }
         ...
         * descriptions for different languages, this property can be used to register the descriptions.
         */
        public Builder descriptions(@Nullable List<ClientUpdateApiDescriptionRequest> descriptions) {
            this.descriptions = descriptions;
            return this;
        }
         ...
         * for details.
         */
        public Builder clientType(@Nullable ClientUpdateApiClientTypeRequest clientType) {
            this.clientType = clientType;
            return this;
        }
         ...
         * See the description about `redirectUris` property for more details.
         */
        public Builder applicationType(@Nullable ClientUpdateApiApplicationTypeRequest applicationType) {
            this.applicationType = applicationType;
            return this;
        }
         ...
         * different languages, this property can be used to register URLs of the images.
         */
        public Builder logoUris(@Nullable List<ClientUpdateApiLogoUrisRequest> logoUris) {
            this.logoUris = logoUris;
            return this;
        }
         ...
         * 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
         */
        public Builder grantTypes(@Nullable List<ClientUpdateApiGrantTypeRequest> grantTypes) {
            this.grantTypes = grantTypes;
            return this;
        }
         ...
         * 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
         */
        public Builder responseTypes(@Nullable List<ClientUpdateApiResponseTypeRequest> responseTypes) {
            this.responseTypes = responseTypes;
            return this;
        }
         ...
         *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
         */
        public Builder authorizationSignAlg(@Nullable ClientUpdateApiAuthorizationSignAlgRequest authorizationSignAlg) {
            this.authorizationSignAlg = authorizationSignAlg;
            return this;
        }
         ...
         * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
         */
        public Builder authorizationEncryptionAlg(@Nullable ClientUpdateApiAuthorizationEncryptionAlgRequest authorizationEncryptionAlg) {
            this.authorizationEncryptionAlg = authorizationEncryptionAlg;
            return this;
        }
         ...
         *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
         */
        public Builder authorizationEncryptionEnc(@Nullable ClientUpdateApiAuthorizationEncryptionEncRequest authorizationEncryptionEnc) {
            this.authorizationEncryptionEnc = authorizationEncryptionEnc;
            return this;
        }
         ...
         * Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
         */
        public Builder tokenAuthMethod(@Nullable ClientUpdateApiTokenAuthMethodRequest tokenAuthMethod) {
            this.tokenAuthMethod = tokenAuthMethod;
            return this;
        }
         ...
         *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
         */
        public Builder tokenAuthSignAlg(@Nullable ClientUpdateApiTokenAuthSignAlgRequest tokenAuthSignAlg) {
            this.tokenAuthSignAlg = tokenAuthSignAlg;
            return this;
        }
         ...
         *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
         */
        public Builder requestSignAlg(@Nullable ClientUpdateApiRequestSignAlgRequest requestSignAlg) {
            this.requestSignAlg = requestSignAlg;
            return this;
        }
         ...
         * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
         */
        public Builder requestEncryptionAlg(@Nullable ClientUpdateApiRequestEncryptionAlgRequest requestEncryptionAlg) {
            this.requestEncryptionAlg = requestEncryptionAlg;
            return this;
        }
         ...
         *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
         */
        public Builder requestEncryptionEnc(@Nullable ClientUpdateApiRequestEncryptionEncRequest requestEncryptionEnc) {
            this.requestEncryptionEnc = requestEncryptionEnc;
            return this;
        }
         ...
         *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
         */
        public Builder idTokenSignAlg(@Nullable ClientUpdateApiIdTokenSignAlgRequest idTokenSignAlg) {
            this.idTokenSignAlg = idTokenSignAlg;
            return this;
        }
         ...
         * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
         */
        public Builder idTokenEncryptionAlg(@Nullable ClientUpdateApiIdTokenEncryptionAlgRequest idTokenEncryptionAlg) {
            this.idTokenEncryptionAlg = idTokenEncryptionAlg;
            return this;
        }
         ...
         *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
         */
        public Builder idTokenEncryptionEnc(@Nullable ClientUpdateApiIdTokenEncryptionEncRequest idTokenEncryptionEnc) {
            this.idTokenEncryptionEnc = idTokenEncryptionEnc;
            return this;
        }
         ...
         * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
         */
        public Builder subjectType(@Nullable ClientUpdateApiSubjectTypeRequest subjectType) {
            this.subjectType = subjectType;
            return this;
        }
         ...
         *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
         */
        public Builder userInfoSignAlg(@Nullable ClientUpdateApiUserInfoSignAlgRequest userInfoSignAlg) {
            this.userInfoSignAlg = userInfoSignAlg;
            return this;
        }
         ...
         * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
         */
        public Builder userInfoEncryptionAlg(@Nullable ClientUpdateApiUserInfoEncryptionAlgRequest userInfoEncryptionAlg) {
            this.userInfoEncryptionAlg = userInfoEncryptionAlg;
            return this;
        }
         ...
         *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
         */
        public Builder userInfoEncryptionEnc(@Nullable ClientUpdateApiUserInfoEncryptionEncRequest userInfoEncryptionEnc) {
            this.userInfoEncryptionEnc = userInfoEncryptionEnc;
            return this;
        }
         ...
         * this property can be used to register the URLs.
         */
        public Builder tosUris(@Nullable List<ClientUpdateApiTosUrisRequest> tosUris) {
            this.tosUris = tosUris;
            return this;
        }
         ...
         * If the client application has different policy pages for different languages, this property can be used to register the URLs.
         */
        public Builder policyUris(@Nullable List<ClientUpdateApiPolicyUrisRequest> policyUris) {
            this.policyUris = policyUris;
            return this;
        }
         ...
         * be used to register the URLs.
         */
        public Builder clientUris(@Nullable List<ClientUpdateApiClientUrisRequest> clientUris) {
            this.clientUris = clientUris;
            return this;
        }
         ...
         *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
         */
        public Builder bcRequestSignAlg(@Nullable ClientUpdateApiBcRequestSignAlgRequest bcRequestSignAlg) {
            this.bcRequestSignAlg = bcRequestSignAlg;
            return this;
        }
         ...
         * The attributes of this client.
         */
        public Builder attributes(@Nullable List<ClientUpdateApiAttributeRequest> attributes) {
            this.attributes = attributes;
            return this;
        }

        public Builder extension(@Nullable ClientUpdateApiExtensionRequest extension) {
            this.extension = extension;
            return this;
        }
         ...
         * The client registration types that the client has declared it may use.
         */
        public Builder clientRegistrationTypes(@Nullable List<ClientUpdateApiClientRegistrationTypeRequest> clientRegistrationTypes) {
            this.clientRegistrationTypes = clientRegistrationTypes;
            return this;
        }
         ...
         * the service, and the FAPI modes for the service are set to `null`.
         */
        public Builder fapiModes(@Nullable List<ClientUpdateApiFapiModeRequest> fapiModes) {
            this.fapiModes = fapiModes;
            return this;
        }
         ...
         * The response modes that this client may use.
         */
        public Builder responseModes(@Nullable List<ClientUpdateApiResponseModeRequest> responseModes) {
            this.responseModes = responseModes;
            return this;
        }
        ...
        public ClientUpdateApiRequestBody build() {
            return new ClientUpdateApiRequestBody(
                clientName, clientNames, description,
                descriptions, clientIdAlias, clientIdAliasEnabled,
                clientType, applicationType, logoUri,
                logoUris, contacts, tlsClientCertificateBoundAccessTokens,
