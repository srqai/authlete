 ...
 */
public enum FederationRegistrationApiRequestEncryptionEnc {
    ...
    FederationRegistrationApiRequestEncryptionEnc(String value) {
        this.value = value;
    }
    ...
    public static Optional<FederationRegistrationApiRequestEncryptionEnc> fromValue(String value) {
        for (FederationRegistrationApiRequestEncryptionEnc o: FederationRegistrationApiRequestEncryptionEnc.values()) {
