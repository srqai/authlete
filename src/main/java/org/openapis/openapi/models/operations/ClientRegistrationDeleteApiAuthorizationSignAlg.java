 ...
 */
public enum ClientRegistrationDeleteApiAuthorizationSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientRegistrationDeleteApiAuthorizationSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationDeleteApiAuthorizationSignAlg> fromValue(String value) {
        for (ClientRegistrationDeleteApiAuthorizationSignAlg o: ClientRegistrationDeleteApiAuthorizationSignAlg.values()) {
