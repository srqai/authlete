 ...
 */
public enum ClientRegistrationDeleteApiFormIdTokenEncryptionAlg {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientRegistrationDeleteApiFormIdTokenEncryptionAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationDeleteApiFormIdTokenEncryptionAlg> fromValue(String value) {
        for (ClientRegistrationDeleteApiFormIdTokenEncryptionAlg o: ClientRegistrationDeleteApiFormIdTokenEncryptionAlg.values()) {
