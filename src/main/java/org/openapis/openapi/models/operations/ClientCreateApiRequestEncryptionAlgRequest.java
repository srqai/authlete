 ...
 */
public enum ClientCreateApiRequestEncryptionAlgRequest {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientCreateApiRequestEncryptionAlgRequest(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientCreateApiRequestEncryptionAlgRequest> fromValue(String value) {
        for (ClientCreateApiRequestEncryptionAlgRequest o: ClientCreateApiRequestEncryptionAlgRequest.values()) {
