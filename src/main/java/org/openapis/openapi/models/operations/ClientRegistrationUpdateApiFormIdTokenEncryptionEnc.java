 ...
 */
public enum ClientRegistrationUpdateApiFormIdTokenEncryptionEnc {
    ...
    ClientRegistrationUpdateApiFormIdTokenEncryptionEnc(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationUpdateApiFormIdTokenEncryptionEnc> fromValue(String value) {
        for (ClientRegistrationUpdateApiFormIdTokenEncryptionEnc o: ClientRegistrationUpdateApiFormIdTokenEncryptionEnc.values()) {
