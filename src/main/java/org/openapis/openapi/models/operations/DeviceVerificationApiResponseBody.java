...
public class DeviceVerificationApiResponseBody {
    /**
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("action")
    private DeviceVerificationApiAction action;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("scopes")
    private List<DeviceVerificationApiScope> scopes;
    ...
    private DeviceVerificationApiAuthorizationDetails authorizationDetails;
    ...
    private List<DeviceVerificationApiServiceAttribute> serviceAttributes;
    ...
    private List<DeviceVerificationApiClientAttribute> clientAttributes;
    ...
    private List<DeviceVerificationApiDynamicScope> dynamicScopes;
    ...
    private DeviceVerificationApiGmAction gmAction;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("grant")
    private DeviceVerificationApiGrant grant;
    ...
    public DeviceVerificationApiResponseBody(
            ...
            @JsonProperty("scopes") @Nullable List<DeviceVerificationApiScope> scopes,
            ...
            @JsonProperty("authorizationDetails") @Nullable DeviceVerificationApiAuthorizationDetails authorizationDetails,
            @JsonProperty("serviceAttributes") @Nullable List<DeviceVerificationApiServiceAttribute> serviceAttributes,
            @JsonProperty("clientAttributes") @Nullable List<DeviceVerificationApiClientAttribute> clientAttributes,
            @JsonProperty("dynamicScopes") @Nullable List<DeviceVerificationApiDynamicScope> dynamicScopes,
            @JsonProperty("expiresAt") @Nullable Long expiresAt,
            @JsonProperty("gmAction") @Nullable DeviceVerificationApiGmAction gmAction,
            @JsonProperty("grantId") @Nullable String grantId,
            @JsonProperty("grant") @Nullable DeviceVerificationApiGrant grant,
     ...
     * The next action that the authorization server implementation should take.
     */
    public Optional<DeviceVerificationApiAction> action() {
     ...
     * are registered.
     */
    public Optional<List<DeviceVerificationApiScope>> scopes() {
     ...
     * "OAuth 2.0 Rich Authorization Requests".
     */
    public Optional<DeviceVerificationApiAuthorizationDetails> authorizationDetails() {
     ...
     * The attributes of this service that the client application belongs to.
     */
    public Optional<List<DeviceVerificationApiServiceAttribute>> serviceAttributes() {
     ...
     * The attributes of the client.
     */
    public Optional<List<DeviceVerificationApiClientAttribute>> clientAttributes() {
     ...
     * The dynamic scopes which the client application requested by the scope request parameter.
     */
    public Optional<List<DeviceVerificationApiDynamicScope>> dynamicScopes() {
     ...
     * [Grant Management for OAuth 2.0](https://openid.net/specs/fapi-grant-management.html).
     */
    public Optional<DeviceVerificationApiGmAction> gmAction() {
    ...
    public Optional<DeviceVerificationApiGrant> grant() {
     ...
     * The code which represents the result of the API call.
     */
    public DeviceVerificationApiResponseBody withResultCode(@Nullable String resultCode) {
        this.resultCode = resultCode;
        return this;
    }
     ...
     * A short message which explains the result of the API call.
     */
    public DeviceVerificationApiResponseBody withResultMessage(@Nullable String resultMessage) {
        this.resultMessage = resultMessage;
        return this;
    }
     ...
     * The next action that the authorization server implementation should take.
     */
    public DeviceVerificationApiResponseBody withAction(@Nullable DeviceVerificationApiAction action) {
        this.action = action;
        return this;
    }
     ...
     * The client ID of the client application to which the user code has been issued.
     */
    public DeviceVerificationApiResponseBody withClientId(@Nullable Long clientId) {
        this.clientId = clientId;
        return this;
    }
     ...
     * The client ID alias of the client application to which the user code has been issued.
     */
    public DeviceVerificationApiResponseBody withClientIdAlias(@Nullable String clientIdAlias) {
        this.clientIdAlias = clientIdAlias;
        return this;
    }
     ...
     * request is the client ID alias. `false` if the value is the original numeric client ID.
     */
    public DeviceVerificationApiResponseBody withClientIdAliasUsed(@Nullable Boolean clientIdAliasUsed) {
        this.clientIdAliasUsed = clientIdAliasUsed;
        return this;
    }
     ...
     * The name of the client application to which the user code has been issued.
     */
    public DeviceVerificationApiResponseBody withClientName(@Nullable String clientName) {
        this.clientName = clientName;
        return this;
    }
     ...
     * are registered.
     */
    public DeviceVerificationApiResponseBody withScopes(@Nullable List<DeviceVerificationApiScope> scopes) {
        this.scopes = scopes;
        return this;
    }
     ...
     * of scopes which is used when the `scope` request parameter is omitted).
     */
    public DeviceVerificationApiResponseBody withClaimNames(@Nullable List<String> claimNames) {
        this.claimNames = claimNames;
        return this;
    }
     ...
     * The list of ACR values requested by the device authorization request.
     */
    public DeviceVerificationApiResponseBody withAcrs(@Nullable List<String> acrs) {
        this.acrs = acrs;
        return this;
    }
     ...
     * set. See "Resource Indicators for OAuth 2.0" for details.
     */
    public DeviceVerificationApiResponseBody withResources(@Nullable List<String> resources) {
        this.resources = resources;
        return this;
    }
     ...
     * "OAuth 2.0 Rich Authorization Requests".
     */
    public DeviceVerificationApiResponseBody withAuthorizationDetails(@Nullable DeviceVerificationApiAuthorizationDetails authorizationDetails) {
        this.authorizationDetails = authorizationDetails;
        return this;
    }
     ...
     * The attributes of this service that the client application belongs to.
     */
    public DeviceVerificationApiResponseBody withServiceAttributes(@Nullable List<DeviceVerificationApiServiceAttribute> serviceAttributes) {
        this.serviceAttributes = serviceAttributes;
        return this;
    }
     ...
     * The attributes of the client.
     */
    public DeviceVerificationApiResponseBody withClientAttributes(@Nullable List<DeviceVerificationApiClientAttribute> clientAttributes) {
        this.clientAttributes = clientAttributes;
        return this;
    }
     ...
     * The dynamic scopes which the client application requested by the scope request parameter.
     */
    public DeviceVerificationApiResponseBody withDynamicScopes(@Nullable List<DeviceVerificationApiDynamicScope> dynamicScopes) {
        this.dynamicScopes = dynamicScopes;
        return this;
    }
     ...
     * Get the date in milliseconds since the Unix epoch (1970-01-01) at which the user code will expire.
     */
    public DeviceVerificationApiResponseBody withExpiresAt(@Nullable Long expiresAt) {
        this.expiresAt = expiresAt;
        return this;
    }
     ...
     * [Grant Management for OAuth 2.0](https://openid.net/specs/fapi-grant-management.html).
     */
    public DeviceVerificationApiResponseBody withGmAction(@Nullable DeviceVerificationApiGmAction gmAction) {
        this.gmAction = gmAction;
        return this;
    }
     ...
     * , which is supported by Authlete 2.3 and newer versions.
     */
    public DeviceVerificationApiResponseBody withGrantId(@Nullable String grantId) {
        this.grantId = grantId;
        return this;
    }


    public DeviceVerificationApiResponseBody withGrant(@Nullable DeviceVerificationApiGrant grant) {
        this.grant = grant;
        return this;
    }
     ...
     * user of the grant.
     */
    public DeviceVerificationApiResponseBody withGrantSubject(@Nullable String grantSubject) {
        this.grantSubject = grantSubject;
        return this;
    }
     ...
     * The entity ID of the client.
     */
    public DeviceVerificationApiResponseBody withClientEntityId(@Nullable String clientEntityId) {
        this.clientEntityId = clientEntityId;
        return this;
    }
     ...
     * Flag which indicates whether the entity ID of the client was used when the request for the access token was made.
     */
    public DeviceVerificationApiResponseBody withClientEntityIdUsed(@Nullable Boolean clientEntityIdUsed) {
        this.clientEntityIdUsed = clientEntityIdUsed;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DeviceVerificationApiResponseBody other = (DeviceVerificationApiResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DeviceVerificationApiResponseBody.class,
    ...
    public final static class Builder {
         ...
         * The next action that the authorization server implementation should take.
         */
        public Builder action(@Nullable DeviceVerificationApiAction action) {
            this.action = action;
            return this;
        }
         ...
         * are registered.
         */
        public Builder scopes(@Nullable List<DeviceVerificationApiScope> scopes) {
            this.scopes = scopes;
            return this;
        }
         ...
         * "OAuth 2.0 Rich Authorization Requests".
         */
        public Builder authorizationDetails(@Nullable DeviceVerificationApiAuthorizationDetails authorizationDetails) {
            this.authorizationDetails = authorizationDetails;
            return this;
        }
         ...
         * The attributes of this service that the client application belongs to.
         */
        public Builder serviceAttributes(@Nullable List<DeviceVerificationApiServiceAttribute> serviceAttributes) {
            this.serviceAttributes = serviceAttributes;
            return this;
        }
         ...
         * The attributes of the client.
         */
        public Builder clientAttributes(@Nullable List<DeviceVerificationApiClientAttribute> clientAttributes) {
            this.clientAttributes = clientAttributes;
            return this;
        }
         ...
         * The dynamic scopes which the client application requested by the scope request parameter.
         */
        public Builder dynamicScopes(@Nullable List<DeviceVerificationApiDynamicScope> dynamicScopes) {
            this.dynamicScopes = dynamicScopes;
            return this;
        }
         ...
         * [Grant Management for OAuth 2.0](https://openid.net/specs/fapi-grant-management.html).
         */
        public Builder gmAction(@Nullable DeviceVerificationApiGmAction gmAction) {
            this.gmAction = gmAction;
            return this;
        }
        ...
        public Builder grant(@Nullable DeviceVerificationApiGrant grant) {
            this.grant = grant;
            return this;
        }
        ...
        public DeviceVerificationApiResponseBody build() {
            return new DeviceVerificationApiResponseBody(
                resultCode, resultMessage, action,
                clientId, clientIdAlias, clientIdAliasUsed,
                clientName, scopes, claimNames,
                acrs, resources, authorizationDetails,
