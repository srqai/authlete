 ...
 */
public enum AuthAuthorizationApiSupportedDisplay {
    PAGE("PAGE"),
    POPUP("POPUP"),
    TOUCH("TOUCH"),
    WAP("WAP");
    ...
    AuthAuthorizationApiSupportedDisplay(String value) {
        this.value = value;
    }
    ...
    public static Optional<AuthAuthorizationApiSupportedDisplay> fromValue(String value) {
        for (AuthAuthorizationApiSupportedDisplay o: AuthAuthorizationApiSupportedDisplay.values()) {
