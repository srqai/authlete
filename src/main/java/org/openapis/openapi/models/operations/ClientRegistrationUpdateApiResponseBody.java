...
public class ClientRegistrationUpdateApiResponseBody {
    /**
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("action")
    private ClientRegistrationUpdateApiAction action;
     ...
     * The next action that the authorization server implementation should take.
     */
    public Optional<ClientRegistrationUpdateApiAction> action() {
     ...
     * The code which represents the result of the API call.
     */
    public ClientRegistrationUpdateApiResponseBody withResultCode(@Nullable String resultCode) {
        this.resultCode = resultCode;
        return this;
    }
     ...
     * A short message which explains the result of the API call.
     */
    public ClientRegistrationUpdateApiResponseBody withResultMessage(@Nullable String resultMessage) {
        this.resultMessage = resultMessage;
        return this;
    }
     ...
     * The next action that the authorization server implementation should take.
     */
    public ClientRegistrationUpdateApiResponseBody withAction(@Nullable ClientRegistrationUpdateApiAction action) {
        this.action = action;
        return this;
    }
     ...
     * Its format varies depending on the value of `action` parameter.
     */
    public ClientRegistrationUpdateApiResponseBody withResponseContent(@Nullable String responseContent) {
        this.responseContent = responseContent;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClientRegistrationUpdateApiResponseBody other = (ClientRegistrationUpdateApiResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ClientRegistrationUpdateApiResponseBody.class,
    ...
    public final static class Builder {
         ...
         * The next action that the authorization server implementation should take.
         */
        public Builder action(@Nullable ClientRegistrationUpdateApiAction action) {
            this.action = action;
            return this;
        }
        ...
        public ClientRegistrationUpdateApiResponseBody build() {
            return new ClientRegistrationUpdateApiResponseBody(
                resultCode, resultMessage, action,
                responseContent, client);
        }
