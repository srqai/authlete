 ...
 */
public enum ClientGetListApiAuthorizationEncryptionAlg {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientGetListApiAuthorizationEncryptionAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientGetListApiAuthorizationEncryptionAlg> fromValue(String value) {
        for (ClientGetListApiAuthorizationEncryptionAlg o: ClientGetListApiAuthorizationEncryptionAlg.values()) {
