 ...
 */
public enum ClientCreateApiUserInfoEncryptionAlgRequest {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientCreateApiUserInfoEncryptionAlgRequest(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientCreateApiUserInfoEncryptionAlgRequest> fromValue(String value) {
        for (ClientCreateApiUserInfoEncryptionAlgRequest o: ClientCreateApiUserInfoEncryptionAlgRequest.values()) {
