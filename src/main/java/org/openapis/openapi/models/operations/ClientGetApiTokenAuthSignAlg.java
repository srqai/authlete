 ...
 */
public enum ClientGetApiTokenAuthSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientGetApiTokenAuthSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientGetApiTokenAuthSignAlg> fromValue(String value) {
        for (ClientGetApiTokenAuthSignAlg o: ClientGetApiTokenAuthSignAlg.values()) {
