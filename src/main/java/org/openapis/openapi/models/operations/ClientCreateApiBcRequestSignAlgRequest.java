 ...
 */
public enum ClientCreateApiBcRequestSignAlgRequest {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientCreateApiBcRequestSignAlgRequest(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientCreateApiBcRequestSignAlgRequest> fromValue(String value) {
        for (ClientCreateApiBcRequestSignAlgRequest o: ClientCreateApiBcRequestSignAlgRequest.values()) {
