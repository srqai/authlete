 ...
 */
public enum ClientRegistrationApiFormAuthorizationEncryptionAlg {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientRegistrationApiFormAuthorizationEncryptionAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationApiFormAuthorizationEncryptionAlg> fromValue(String value) {
        for (ClientRegistrationApiFormAuthorizationEncryptionAlg o: ClientRegistrationApiFormAuthorizationEncryptionAlg.values()) {
