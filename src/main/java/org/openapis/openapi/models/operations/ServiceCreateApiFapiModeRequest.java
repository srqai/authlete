...
public enum ServiceCreateApiFapiModeRequest {
    ...
    ServiceCreateApiFapiModeRequest(String value) {
        this.value = value;
    }
    ...
    public static Optional<ServiceCreateApiFapiModeRequest> fromValue(String value) {
        for (ServiceCreateApiFapiModeRequest o: ServiceCreateApiFapiModeRequest.values()) {
