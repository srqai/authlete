...
public enum AuthAuthorizationApiFormFapiMode {
    ...
    AuthAuthorizationApiFormFapiMode(String value) {
        this.value = value;
    }
    ...
    public static Optional<AuthAuthorizationApiFormFapiMode> fromValue(String value) {
        for (AuthAuthorizationApiFormFapiMode o: AuthAuthorizationApiFormFapiMode.values()) {
