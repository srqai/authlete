 ...
 */
public enum ClientRegistrationUpdateApiFormAuthorizationSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientRegistrationUpdateApiFormAuthorizationSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationUpdateApiFormAuthorizationSignAlg> fromValue(String value) {
        for (ClientRegistrationUpdateApiFormAuthorizationSignAlg o: ClientRegistrationUpdateApiFormAuthorizationSignAlg.values()) {
