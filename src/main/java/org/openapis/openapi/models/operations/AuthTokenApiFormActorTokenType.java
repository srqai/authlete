 ...
 */
public enum AuthTokenApiFormActorTokenType {
    ...
    AuthTokenApiFormActorTokenType(String value) {
        this.value = value;
    }
    ...
    public static Optional<AuthTokenApiFormActorTokenType> fromValue(String value) {
        for (AuthTokenApiFormActorTokenType o: AuthTokenApiFormActorTokenType.values()) {
