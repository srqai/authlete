 ...
 */
public enum ClientCreateApiRequestEncryptionEncRequest {
    ...
    ClientCreateApiRequestEncryptionEncRequest(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientCreateApiRequestEncryptionEncRequest> fromValue(String value) {
        for (ClientCreateApiRequestEncryptionEncRequest o: ClientCreateApiRequestEncryptionEncRequest.values()) {
