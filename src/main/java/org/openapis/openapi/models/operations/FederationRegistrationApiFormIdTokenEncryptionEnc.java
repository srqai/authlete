 ...
 */
public enum FederationRegistrationApiFormIdTokenEncryptionEnc {
    ...
    FederationRegistrationApiFormIdTokenEncryptionEnc(String value) {
        this.value = value;
    }
    ...
    public static Optional<FederationRegistrationApiFormIdTokenEncryptionEnc> fromValue(String value) {
        for (FederationRegistrationApiFormIdTokenEncryptionEnc o: FederationRegistrationApiFormIdTokenEncryptionEnc.values()) {
