...
public class VciOfferInfoApiFormInfo {
    /**
    ...
    private List<VciOfferInfoApiFormProperty> properties;
    ...
    @JsonCreator
    public VciOfferInfoApiFormInfo(
            ...
            @JsonProperty("properties") @Nullable List<VciOfferInfoApiFormProperty> properties,
     ...
     * Extra properties to associate with the credential offer.
     */
    public Optional<List<VciOfferInfoApiFormProperty>> properties() {
     ...
     * The identifier of the credential offer.
     */
    public VciOfferInfoApiFormInfo withIdentifier(@Nullable String identifier) {
        this.identifier = identifier;
        return this;
    }
     ...
     * The credential offer in the JSON format.
     */
    public VciOfferInfoApiFormInfo withCredentialOffer(@Nullable String credentialOffer) {
        this.credentialOffer = credentialOffer;
        return this;
    }
     ...
     * The identifier of the credential issuer.
     */
    public VciOfferInfoApiFormInfo withCredentialIssuer(@Nullable String credentialIssuer) {
        this.credentialIssuer = credentialIssuer;
        return this;
    }
     ...
     * The value of the `credentials` object in the JSON format.
     */
    public VciOfferInfoApiFormInfo withCredentials(@Nullable String credentials) {
        this.credentials = credentials;
        return this;
    }
     ...
     * included in the `grants` object.
     */
    public VciOfferInfoApiFormInfo withAuthorizationCodeGrantIncluded(@Nullable Boolean authorizationCodeGrantIncluded) {
        this.authorizationCodeGrantIncluded = authorizationCodeGrantIncluded;
        return this;
    }
     ...
     * object.
     */
    public VciOfferInfoApiFormInfo withIssuerStateIncluded(@Nullable Boolean issuerStateIncluded) {
        this.issuerStateIncluded = issuerStateIncluded;
        return this;
    }
     ...
     * `authorization_code` object in the `grants` object.
     */
    public VciOfferInfoApiFormInfo withIssuerState(@Nullable String issuerState) {
        this.issuerState = issuerState;
        return this;
    }
     ...
     * included in the `grants` object.
     */
    public VciOfferInfoApiFormInfo withPreAuthorizedCodeGrantIncluded(@Nullable Boolean preAuthorizedCodeGrantIncluded) {
        this.preAuthorizedCodeGrantIncluded = preAuthorizedCodeGrantIncluded;
        return this;
    }
     ...
     * the `grants` object.
     */
    public VciOfferInfoApiFormInfo withPreAuthorizedCode(@Nullable String preAuthorizedCode) {
        this.preAuthorizedCode = preAuthorizedCode;
        return this;
    }
     ...
     * the `grants` object.
     */
    public VciOfferInfoApiFormInfo withUserPinRequired(@Nullable Boolean userPinRequired) {
        this.userPinRequired = userPinRequired;
        return this;
    }
     ...
     * The value of the user PIN associated with the credential offer.
     */
    public VciOfferInfoApiFormInfo withUserPin(@Nullable String userPin) {
        this.userPin = userPin;
        return this;
    }
     ...
     * The subject associated with the credential offer.
     */
    public VciOfferInfoApiFormInfo withSubject(@Nullable String subject) {
        this.subject = subject;
        return this;
    }
     ...
     * The time at which the credential offer will expire.
     */
    public VciOfferInfoApiFormInfo withExpiresAt(@Nullable Long expiresAt) {
        this.expiresAt = expiresAt;
        return this;
    }
     ...
     * The general-purpose arbitrary string.
     */
    public VciOfferInfoApiFormInfo withContext(@Nullable String context) {
        this.context = context;
        return this;
    }
     ...
     * Extra properties to associate with the credential offer.
     */
    public VciOfferInfoApiFormInfo withProperties(@Nullable List<VciOfferInfoApiFormProperty> properties) {
        this.properties = properties;
        return this;
    }
     ...
     * access token.
     */
    public VciOfferInfoApiFormInfo withJwtAtClaims(@Nullable String jwtAtClaims) {
        this.jwtAtClaims = jwtAtClaims;
        return this;
    }
     ...
     * the course of issuing the credential offer.
     */
    public VciOfferInfoApiFormInfo withAuthTime(@Nullable Long authTime) {
        this.authTime = authTime;
        return this;
    }
     ...
     * performed during the course of issuing the credential offer.
     */
    public VciOfferInfoApiFormInfo withAcr(@Nullable String acr) {
        this.acr = acr;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        VciOfferInfoApiFormInfo other = (VciOfferInfoApiFormInfo) o;
        return 
    ...
    public String toString() {
        return Utils.toString(VciOfferInfoApiFormInfo.class,
    ...
    public final static class Builder {
         ...
         * Extra properties to associate with the credential offer.
         */
        public Builder properties(@Nullable List<VciOfferInfoApiFormProperty> properties) {
            this.properties = properties;
            return this;
        }
        ...
        public VciOfferInfoApiFormInfo build() {
            return new VciOfferInfoApiFormInfo(
                identifier, credentialOffer, credentialIssuer,
                credentials, authorizationCodeGrantIncluded, issuerStateIncluded,
                issuerState, preAuthorizedCodeGrantIncluded, preAuthorizedCode,
                userPinRequired, userPin, subject,
