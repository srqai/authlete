 ...
 */
public enum FederationRegistrationApiFormUserInfoEncryptionEnc {
    ...
    FederationRegistrationApiFormUserInfoEncryptionEnc(String value) {
        this.value = value;
    }
    ...
    public static Optional<FederationRegistrationApiFormUserInfoEncryptionEnc> fromValue(String value) {
        for (FederationRegistrationApiFormUserInfoEncryptionEnc o: FederationRegistrationApiFormUserInfoEncryptionEnc.values()) {
