...
public class VciDeferredIssueApiResponseBody {
    /**
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("action")
    private VciDeferredIssueApiAction action;
     ...
     * endpoint should take.
     */
    public Optional<VciDeferredIssueApiAction> action() {
     ...
     * The code which represents the result of the API call.
     */
    public VciDeferredIssueApiResponseBody withResultCode(@Nullable String resultCode) {
        this.resultCode = resultCode;
        return this;
    }
     ...
     * A short message which explains the result of the API call.
     */
    public VciDeferredIssueApiResponseBody withResultMessage(@Nullable String resultMessage) {
        this.resultMessage = resultMessage;
        return this;
    }
     ...
     * endpoint should take.
     */
    public VciDeferredIssueApiResponseBody withAction(@Nullable VciDeferredIssueApiAction action) {
        this.action = action;
        return this;
    }
     ...
     * credential endpoint should return.
     */
    public VciDeferredIssueApiResponseBody withResponseContent(@Nullable String responseContent) {
        this.responseContent = responseContent;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        VciDeferredIssueApiResponseBody other = (VciDeferredIssueApiResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(VciDeferredIssueApiResponseBody.class,
    ...
    public final static class Builder {
         ...
         * endpoint should take.
         */
        public Builder action(@Nullable VciDeferredIssueApiAction action) {
            this.action = action;
            return this;
        }
        ...
        public VciDeferredIssueApiResponseBody build() {
            return new VciDeferredIssueApiResponseBody(
                resultCode, resultMessage, action,
                responseContent);
        }
