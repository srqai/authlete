...
public class AuthAuthorizationApiFormCredentialOfferInfo {
    /**
    ...
    private List<AuthAuthorizationApiFormProperty> properties;
    ...
    @JsonCreator
    public AuthAuthorizationApiFormCredentialOfferInfo(
            ...
            @JsonProperty("properties") @Nullable List<AuthAuthorizationApiFormProperty> properties,
     ...
     * Extra properties to associate with the credential offer.
     */
    public Optional<List<AuthAuthorizationApiFormProperty>> properties() {
     ...
     * The identifier of the credential offer.
     */
    public AuthAuthorizationApiFormCredentialOfferInfo withIdentifier(@Nullable String identifier) {
        this.identifier = identifier;
        return this;
    }
     ...
     * The credential offer in the JSON format.
     */
    public AuthAuthorizationApiFormCredentialOfferInfo withCredentialOffer(@Nullable String credentialOffer) {
        this.credentialOffer = credentialOffer;
        return this;
    }
     ...
     * The identifier of the credential issuer.
     */
    public AuthAuthorizationApiFormCredentialOfferInfo withCredentialIssuer(@Nullable String credentialIssuer) {
        this.credentialIssuer = credentialIssuer;
        return this;
    }
     ...
     * The value of the `credentials` object in the JSON format.
     */
    public AuthAuthorizationApiFormCredentialOfferInfo withCredentials(@Nullable String credentials) {
        this.credentials = credentials;
        return this;
    }
     ...
     * included in the `grants` object.
     */
    public AuthAuthorizationApiFormCredentialOfferInfo withAuthorizationCodeGrantIncluded(@Nullable Boolean authorizationCodeGrantIncluded) {
        this.authorizationCodeGrantIncluded = authorizationCodeGrantIncluded;
        return this;
    }
     ...
     * object.
     */
    public AuthAuthorizationApiFormCredentialOfferInfo withIssuerStateIncluded(@Nullable Boolean issuerStateIncluded) {
        this.issuerStateIncluded = issuerStateIncluded;
        return this;
    }
     ...
     * `authorization_code` object in the `grants` object.
     */
    public AuthAuthorizationApiFormCredentialOfferInfo withIssuerState(@Nullable String issuerState) {
        this.issuerState = issuerState;
        return this;
    }
     ...
     * included in the `grants` object.
     */
    public AuthAuthorizationApiFormCredentialOfferInfo withPreAuthorizedCodeGrantIncluded(@Nullable Boolean preAuthorizedCodeGrantIncluded) {
        this.preAuthorizedCodeGrantIncluded = preAuthorizedCodeGrantIncluded;
        return this;
    }
     ...
     * the `grants` object.
     */
    public AuthAuthorizationApiFormCredentialOfferInfo withPreAuthorizedCode(@Nullable String preAuthorizedCode) {
        this.preAuthorizedCode = preAuthorizedCode;
        return this;
    }
     ...
     * the `grants` object.
     */
    public AuthAuthorizationApiFormCredentialOfferInfo withUserPinRequired(@Nullable Boolean userPinRequired) {
        this.userPinRequired = userPinRequired;
        return this;
    }
     ...
     * The value of the user PIN associated with the credential offer.
     */
    public AuthAuthorizationApiFormCredentialOfferInfo withUserPin(@Nullable String userPin) {
        this.userPin = userPin;
        return this;
    }
     ...
     * The subject associated with the credential offer.
     */
    public AuthAuthorizationApiFormCredentialOfferInfo withSubject(@Nullable String subject) {
        this.subject = subject;
        return this;
    }
     ...
     * The time at which the credential offer will expire.
     */
    public AuthAuthorizationApiFormCredentialOfferInfo withExpiresAt(@Nullable Long expiresAt) {
        this.expiresAt = expiresAt;
        return this;
    }
     ...
     * The general-purpose arbitrary string.
     */
    public AuthAuthorizationApiFormCredentialOfferInfo withContext(@Nullable String context) {
        this.context = context;
        return this;
    }
     ...
     * Extra properties to associate with the credential offer.
     */
    public AuthAuthorizationApiFormCredentialOfferInfo withProperties(@Nullable List<AuthAuthorizationApiFormProperty> properties) {
        this.properties = properties;
        return this;
    }
     ...
     * access token.
     */
    public AuthAuthorizationApiFormCredentialOfferInfo withJwtAtClaims(@Nullable String jwtAtClaims) {
        this.jwtAtClaims = jwtAtClaims;
        return this;
    }
     ...
     * the course of issuing the credential offer.
     */
    public AuthAuthorizationApiFormCredentialOfferInfo withAuthTime(@Nullable Long authTime) {
        this.authTime = authTime;
        return this;
    }
     ...
     * performed during the course of issuing the credential offer.
     */
    public AuthAuthorizationApiFormCredentialOfferInfo withAcr(@Nullable String acr) {
        this.acr = acr;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AuthAuthorizationApiFormCredentialOfferInfo other = (AuthAuthorizationApiFormCredentialOfferInfo) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AuthAuthorizationApiFormCredentialOfferInfo.class,
    ...
    public final static class Builder {
         ...
         * Extra properties to associate with the credential offer.
         */
        public Builder properties(@Nullable List<AuthAuthorizationApiFormProperty> properties) {
            this.properties = properties;
            return this;
        }
        ...
        public AuthAuthorizationApiFormCredentialOfferInfo build() {
            return new AuthAuthorizationApiFormCredentialOfferInfo(
                identifier, credentialOffer, credentialIssuer,
                credentials, authorizationCodeGrantIncluded, issuerStateIncluded,
                issuerState, preAuthorizedCodeGrantIncluded, preAuthorizedCode,
                userPinRequired, userPin, subject,
