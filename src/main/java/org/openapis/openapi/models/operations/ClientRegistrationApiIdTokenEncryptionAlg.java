 ...
 */
public enum ClientRegistrationApiIdTokenEncryptionAlg {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientRegistrationApiIdTokenEncryptionAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationApiIdTokenEncryptionAlg> fromValue(String value) {
        for (ClientRegistrationApiIdTokenEncryptionAlg o: ClientRegistrationApiIdTokenEncryptionAlg.values()) {
