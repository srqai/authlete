...
public enum ServiceUpdateApiFapiModeResponse {
    ...
    ServiceUpdateApiFapiModeResponse(String value) {
        this.value = value;
    }
    ...
    public static Optional<ServiceUpdateApiFapiModeResponse> fromValue(String value) {
        for (ServiceUpdateApiFapiModeResponse o: ServiceUpdateApiFapiModeResponse.values()) {
