 ...
 */
public enum ClientGetListApiRequestSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientGetListApiRequestSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientGetListApiRequestSignAlg> fromValue(String value) {
        for (ClientGetListApiRequestSignAlg o: ClientGetListApiRequestSignAlg.values()) {
