 ...
 */
public enum FederationRegistrationApiFormUserInfoSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    FederationRegistrationApiFormUserInfoSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<FederationRegistrationApiFormUserInfoSignAlg> fromValue(String value) {
        for (FederationRegistrationApiFormUserInfoSignAlg o: FederationRegistrationApiFormUserInfoSignAlg.values()) {
