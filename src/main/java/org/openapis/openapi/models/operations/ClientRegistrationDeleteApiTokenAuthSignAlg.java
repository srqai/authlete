 ...
 */
public enum ClientRegistrationDeleteApiTokenAuthSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientRegistrationDeleteApiTokenAuthSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationDeleteApiTokenAuthSignAlg> fromValue(String value) {
        for (ClientRegistrationDeleteApiTokenAuthSignAlg o: ClientRegistrationDeleteApiTokenAuthSignAlg.values()) {
