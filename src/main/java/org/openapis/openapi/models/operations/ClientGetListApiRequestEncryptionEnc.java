 ...
 */
public enum ClientGetListApiRequestEncryptionEnc {
    ...
    ClientGetListApiRequestEncryptionEnc(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientGetListApiRequestEncryptionEnc> fromValue(String value) {
        for (ClientGetListApiRequestEncryptionEnc o: ClientGetListApiRequestEncryptionEnc.values()) {
