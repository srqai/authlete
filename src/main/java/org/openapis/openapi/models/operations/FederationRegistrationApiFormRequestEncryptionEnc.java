 ...
 */
public enum FederationRegistrationApiFormRequestEncryptionEnc {
    ...
    FederationRegistrationApiFormRequestEncryptionEnc(String value) {
        this.value = value;
    }
    ...
    public static Optional<FederationRegistrationApiFormRequestEncryptionEnc> fromValue(String value) {
        for (FederationRegistrationApiFormRequestEncryptionEnc o: FederationRegistrationApiFormRequestEncryptionEnc.values()) {
