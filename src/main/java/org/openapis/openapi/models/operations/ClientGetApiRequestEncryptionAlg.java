 ...
 */
public enum ClientGetApiRequestEncryptionAlg {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientGetApiRequestEncryptionAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientGetApiRequestEncryptionAlg> fromValue(String value) {
        for (ClientGetApiRequestEncryptionAlg o: ClientGetApiRequestEncryptionAlg.values()) {
