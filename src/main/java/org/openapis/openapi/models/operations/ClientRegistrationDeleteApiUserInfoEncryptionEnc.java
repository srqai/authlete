 ...
 */
public enum ClientRegistrationDeleteApiUserInfoEncryptionEnc {
    ...
    ClientRegistrationDeleteApiUserInfoEncryptionEnc(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationDeleteApiUserInfoEncryptionEnc> fromValue(String value) {
        for (ClientRegistrationDeleteApiUserInfoEncryptionEnc o: ClientRegistrationDeleteApiUserInfoEncryptionEnc.values()) {
