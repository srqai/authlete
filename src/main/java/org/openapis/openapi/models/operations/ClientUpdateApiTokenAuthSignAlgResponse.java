 ...
 */
public enum ClientUpdateApiTokenAuthSignAlgResponse {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientUpdateApiTokenAuthSignAlgResponse(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientUpdateApiTokenAuthSignAlgResponse> fromValue(String value) {
        for (ClientUpdateApiTokenAuthSignAlgResponse o: ClientUpdateApiTokenAuthSignAlgResponse.values()) {
