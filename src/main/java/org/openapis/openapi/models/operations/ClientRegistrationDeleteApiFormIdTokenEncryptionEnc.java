 ...
 */
public enum ClientRegistrationDeleteApiFormIdTokenEncryptionEnc {
    ...
    ClientRegistrationDeleteApiFormIdTokenEncryptionEnc(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationDeleteApiFormIdTokenEncryptionEnc> fromValue(String value) {
        for (ClientRegistrationDeleteApiFormIdTokenEncryptionEnc o: ClientRegistrationDeleteApiFormIdTokenEncryptionEnc.values()) {
