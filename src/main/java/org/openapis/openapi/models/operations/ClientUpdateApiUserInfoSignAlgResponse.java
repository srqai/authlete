 ...
 */
public enum ClientUpdateApiUserInfoSignAlgResponse {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientUpdateApiUserInfoSignAlgResponse(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientUpdateApiUserInfoSignAlgResponse> fromValue(String value) {
        for (ClientUpdateApiUserInfoSignAlgResponse o: ClientUpdateApiUserInfoSignAlgResponse.values()) {
