...
public enum ServiceCreateApiFapiModeResponse {
    ...
    ServiceCreateApiFapiModeResponse(String value) {
        this.value = value;
    }
    ...
    public static Optional<ServiceCreateApiFapiModeResponse> fromValue(String value) {
        for (ServiceCreateApiFapiModeResponse o: ServiceCreateApiFapiModeResponse.values()) {
