 ...
 */
public enum ClientUpdateApiBcRequestSignAlgRequest {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientUpdateApiBcRequestSignAlgRequest(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientUpdateApiBcRequestSignAlgRequest> fromValue(String value) {
        for (ClientUpdateApiBcRequestSignAlgRequest o: ClientUpdateApiBcRequestSignAlgRequest.values()) {
