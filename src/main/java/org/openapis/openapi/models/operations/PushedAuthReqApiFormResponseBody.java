...
public class PushedAuthReqApiFormResponseBody {
    /**
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("action")
    private PushedAuthReqApiFormAction action;
    ...
    private PushedAuthReqApiFormClientAuthMethod clientAuthMethod;
     ...
     * The next action that the authorization server implementation should take. Any other value other than "CREATED" should be handled as unsuccessful result.
     */
    public Optional<PushedAuthReqApiFormAction> action() {
     ...
     * Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public Optional<PushedAuthReqApiFormClientAuthMethod> clientAuthMethod() {
     ...
     * The code which represents the result of the API call.
     */
    public PushedAuthReqApiFormResponseBody withResultCode(@Nullable String resultCode) {
        this.resultCode = resultCode;
        return this;
    }
     ...
     * A short message which explains the result of the API call.
     */
    public PushedAuthReqApiFormResponseBody withResultMessage(@Nullable String resultMessage) {
        this.resultMessage = resultMessage;
        return this;
    }
     ...
     * The next action that the authorization server implementation should take. Any other value other than "CREATED" should be handled as unsuccessful result.
     */
    public PushedAuthReqApiFormResponseBody withAction(@Nullable PushedAuthReqApiFormAction action) {
        this.action = action;
        return this;
    }
     ...
     * The request_uri created to the client to be used as request_uri on the authorize call.
     */
    public PushedAuthReqApiFormResponseBody withRequestUri(@Nullable String requestUri) {
        this.requestUri = requestUri;
        return this;
    }
     ...
     * application.
     */
    public PushedAuthReqApiFormResponseBody withResponseContent(@Nullable String responseContent) {
        this.responseContent = responseContent;
        return this;
    }
     ...
     * Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public PushedAuthReqApiFormResponseBody withClientAuthMethod(@Nullable PushedAuthReqApiFormClientAuthMethod clientAuthMethod) {
        this.clientAuthMethod = clientAuthMethod;
        return this;
    }
     ...
     * as the value of the `DPoP-Nonce` HTTP header.
     */
    public PushedAuthReqApiFormResponseBody withDpopNonce(@Nullable String dpopNonce) {
        this.dpopNonce = dpopNonce;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PushedAuthReqApiFormResponseBody other = (PushedAuthReqApiFormResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PushedAuthReqApiFormResponseBody.class,
    ...
    public final static class Builder {
         ...
         * The next action that the authorization server implementation should take. Any other value other than "CREATED" should be handled as unsuccessful result.
         */
        public Builder action(@Nullable PushedAuthReqApiFormAction action) {
            this.action = action;
            return this;
        }
         ...
         * Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
         */
        public Builder clientAuthMethod(@Nullable PushedAuthReqApiFormClientAuthMethod clientAuthMethod) {
            this.clientAuthMethod = clientAuthMethod;
            return this;
        }
        ...
        public PushedAuthReqApiFormResponseBody build() {
            return new PushedAuthReqApiFormResponseBody(
                resultCode, resultMessage, action,
                requestUri, responseContent, clientAuthMethod,
                dpopNonce);
        }
