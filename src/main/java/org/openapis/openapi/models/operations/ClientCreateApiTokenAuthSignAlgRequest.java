 ...
 */
public enum ClientCreateApiTokenAuthSignAlgRequest {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientCreateApiTokenAuthSignAlgRequest(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientCreateApiTokenAuthSignAlgRequest> fromValue(String value) {
        for (ClientCreateApiTokenAuthSignAlgRequest o: ClientCreateApiTokenAuthSignAlgRequest.values()) {
