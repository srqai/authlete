 ...
 */
public enum AuthTokenApiFormSubjectTokenType {
    ...
    AuthTokenApiFormSubjectTokenType(String value) {
        this.value = value;
    }
    ...
    public static Optional<AuthTokenApiFormSubjectTokenType> fromValue(String value) {
        for (AuthTokenApiFormSubjectTokenType o: AuthTokenApiFormSubjectTokenType.values()) {
