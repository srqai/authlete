 ...
 */
public enum ClientRegistrationApiFormAuthorizationEncryptionEnc {
    ...
    ClientRegistrationApiFormAuthorizationEncryptionEnc(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationApiFormAuthorizationEncryptionEnc> fromValue(String value) {
        for (ClientRegistrationApiFormAuthorizationEncryptionEnc o: ClientRegistrationApiFormAuthorizationEncryptionEnc.values()) {
