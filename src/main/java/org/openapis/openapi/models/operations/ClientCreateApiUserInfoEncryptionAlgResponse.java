 ...
 */
public enum ClientCreateApiUserInfoEncryptionAlgResponse {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientCreateApiUserInfoEncryptionAlgResponse(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientCreateApiUserInfoEncryptionAlgResponse> fromValue(String value) {
        for (ClientCreateApiUserInfoEncryptionAlgResponse o: ClientCreateApiUserInfoEncryptionAlgResponse.values()) {
