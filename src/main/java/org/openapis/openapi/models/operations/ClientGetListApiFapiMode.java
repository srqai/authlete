...
public enum ClientGetListApiFapiMode {
    ...
    ClientGetListApiFapiMode(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientGetListApiFapiMode> fromValue(String value) {
        for (ClientGetListApiFapiMode o: ClientGetListApiFapiMode.values()) {
