 ...
 */
public enum ClientRegistrationDeleteApiFormTokenAuthSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientRegistrationDeleteApiFormTokenAuthSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationDeleteApiFormTokenAuthSignAlg> fromValue(String value) {
        for (ClientRegistrationDeleteApiFormTokenAuthSignAlg o: ClientRegistrationDeleteApiFormTokenAuthSignAlg.values()) {
