 ...
 */
public enum ServiceUpdateApiAccessTokenSignAlgRequest {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ServiceUpdateApiAccessTokenSignAlgRequest(String value) {
        this.value = value;
    }
    ...
    public static Optional<ServiceUpdateApiAccessTokenSignAlgRequest> fromValue(String value) {
        for (ServiceUpdateApiAccessTokenSignAlgRequest o: ServiceUpdateApiAccessTokenSignAlgRequest.values()) {
