 ...
 */
public enum ClientRegistrationDeleteApiFormIdTokenSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientRegistrationDeleteApiFormIdTokenSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationDeleteApiFormIdTokenSignAlg> fromValue(String value) {
        for (ClientRegistrationDeleteApiFormIdTokenSignAlg o: ClientRegistrationDeleteApiFormIdTokenSignAlg.values()) {
