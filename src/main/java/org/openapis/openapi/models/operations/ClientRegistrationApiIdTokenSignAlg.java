 ...
 */
public enum ClientRegistrationApiIdTokenSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientRegistrationApiIdTokenSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationApiIdTokenSignAlg> fromValue(String value) {
        for (ClientRegistrationApiIdTokenSignAlg o: ClientRegistrationApiIdTokenSignAlg.values()) {
