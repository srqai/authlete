 ...
 */
public enum ClientRegistrationDeleteApiUserInfoEncryptionAlg {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientRegistrationDeleteApiUserInfoEncryptionAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationDeleteApiUserInfoEncryptionAlg> fromValue(String value) {
        for (ClientRegistrationDeleteApiUserInfoEncryptionAlg o: ClientRegistrationDeleteApiUserInfoEncryptionAlg.values()) {
