 ...
 */
public enum ClientRegistrationUpdateApiUserInfoSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientRegistrationUpdateApiUserInfoSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationUpdateApiUserInfoSignAlg> fromValue(String value) {
        for (ClientRegistrationUpdateApiUserInfoSignAlg o: ClientRegistrationUpdateApiUserInfoSignAlg.values()) {
