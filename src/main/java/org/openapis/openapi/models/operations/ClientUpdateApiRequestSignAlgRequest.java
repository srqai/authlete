 ...
 */
public enum ClientUpdateApiRequestSignAlgRequest {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientUpdateApiRequestSignAlgRequest(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientUpdateApiRequestSignAlgRequest> fromValue(String value) {
        for (ClientUpdateApiRequestSignAlgRequest o: ClientUpdateApiRequestSignAlgRequest.values()) {
