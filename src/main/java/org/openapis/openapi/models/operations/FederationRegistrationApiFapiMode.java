...
public enum FederationRegistrationApiFapiMode {
    ...
    FederationRegistrationApiFapiMode(String value) {
        this.value = value;
    }
    ...
    public static Optional<FederationRegistrationApiFapiMode> fromValue(String value) {
        for (FederationRegistrationApiFapiMode o: FederationRegistrationApiFapiMode.values()) {
