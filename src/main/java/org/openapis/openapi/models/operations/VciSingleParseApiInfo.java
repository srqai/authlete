...
public class VciSingleParseApiInfo {
    /**
     ...
     * The identifier of the credential offer.
     */
    public VciSingleParseApiInfo withIdentifier(@Nullable String identifier) {
        this.identifier = identifier;
        return this;
    }
     ...
     * The value of the format parameter in the credential request.
     */
    public VciSingleParseApiInfo withFormat(@Nullable String format) {
        this.format = format;
        return this;
    }
     ...
     * The binding key specified by the proof in the credential request.
     */
    public VciSingleParseApiInfo withBindingKey(@Nullable String bindingKey) {
        this.bindingKey = bindingKey;
        return this;
    }
     ...
     * The details about the credential request.
     */
    public VciSingleParseApiInfo withDetails(@Nullable String details) {
        this.details = details;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        VciSingleParseApiInfo other = (VciSingleParseApiInfo) o;
        return 
    ...
    public String toString() {
        return Utils.toString(VciSingleParseApiInfo.class,
    ...
    public final static class Builder {
        ...
        public VciSingleParseApiInfo build() {
            return new VciSingleParseApiInfo(
                identifier, format, bindingKey,
                details);
        }
