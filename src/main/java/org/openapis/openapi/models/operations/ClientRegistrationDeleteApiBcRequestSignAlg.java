 ...
 */
public enum ClientRegistrationDeleteApiBcRequestSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientRegistrationDeleteApiBcRequestSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationDeleteApiBcRequestSignAlg> fromValue(String value) {
        for (ClientRegistrationDeleteApiBcRequestSignAlg o: ClientRegistrationDeleteApiBcRequestSignAlg.values()) {
