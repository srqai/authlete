 ...
 */
public enum ClientRegistrationDeleteApiFormAuthorizationEncryptionEnc {
    ...
    ClientRegistrationDeleteApiFormAuthorizationEncryptionEnc(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationDeleteApiFormAuthorizationEncryptionEnc> fromValue(String value) {
        for (ClientRegistrationDeleteApiFormAuthorizationEncryptionEnc o: ClientRegistrationDeleteApiFormAuthorizationEncryptionEnc.values()) {
