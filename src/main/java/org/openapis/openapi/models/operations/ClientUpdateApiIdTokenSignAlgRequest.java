 ...
 */
public enum ClientUpdateApiIdTokenSignAlgRequest {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientUpdateApiIdTokenSignAlgRequest(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientUpdateApiIdTokenSignAlgRequest> fromValue(String value) {
        for (ClientUpdateApiIdTokenSignAlgRequest o: ClientUpdateApiIdTokenSignAlgRequest.values()) {
