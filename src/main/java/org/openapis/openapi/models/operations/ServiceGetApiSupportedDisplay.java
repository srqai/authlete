 ...
 */
public enum ServiceGetApiSupportedDisplay {
    PAGE("PAGE"),
    POPUP("POPUP"),
    TOUCH("TOUCH"),
    WAP("WAP");
    ...
    ServiceGetApiSupportedDisplay(String value) {
        this.value = value;
    }
    ...
    public static Optional<ServiceGetApiSupportedDisplay> fromValue(String value) {
        for (ServiceGetApiSupportedDisplay o: ServiceGetApiSupportedDisplay.values()) {
