 ...
 */
public enum FederationRegistrationApiIdTokenEncryptionAlg {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    FederationRegistrationApiIdTokenEncryptionAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<FederationRegistrationApiIdTokenEncryptionAlg> fromValue(String value) {
        for (FederationRegistrationApiIdTokenEncryptionAlg o: FederationRegistrationApiIdTokenEncryptionAlg.values()) {
