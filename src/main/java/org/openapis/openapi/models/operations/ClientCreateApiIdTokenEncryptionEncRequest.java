 ...
 */
public enum ClientCreateApiIdTokenEncryptionEncRequest {
    ...
    ClientCreateApiIdTokenEncryptionEncRequest(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientCreateApiIdTokenEncryptionEncRequest> fromValue(String value) {
        for (ClientCreateApiIdTokenEncryptionEncRequest o: ClientCreateApiIdTokenEncryptionEncRequest.values()) {
