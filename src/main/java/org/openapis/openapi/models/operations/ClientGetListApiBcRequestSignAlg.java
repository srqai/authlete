 ...
 */
public enum ClientGetListApiBcRequestSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientGetListApiBcRequestSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientGetListApiBcRequestSignAlg> fromValue(String value) {
        for (ClientGetListApiBcRequestSignAlg o: ClientGetListApiBcRequestSignAlg.values()) {
