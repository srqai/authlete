 ...
 */
public enum ClientUpdateApiRequestEncryptionEncResponse {
    ...
    ClientUpdateApiRequestEncryptionEncResponse(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientUpdateApiRequestEncryptionEncResponse> fromValue(String value) {
        for (ClientUpdateApiRequestEncryptionEncResponse o: ClientUpdateApiRequestEncryptionEncResponse.values()) {
