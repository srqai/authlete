 ...
 */
public enum ClientRegistrationUpdateApiFormUserInfoEncryptionAlg {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientRegistrationUpdateApiFormUserInfoEncryptionAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationUpdateApiFormUserInfoEncryptionAlg> fromValue(String value) {
        for (ClientRegistrationUpdateApiFormUserInfoEncryptionAlg o: ClientRegistrationUpdateApiFormUserInfoEncryptionAlg.values()) {
