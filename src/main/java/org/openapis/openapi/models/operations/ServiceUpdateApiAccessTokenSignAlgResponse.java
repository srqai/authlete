 ...
 */
public enum ServiceUpdateApiAccessTokenSignAlgResponse {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ServiceUpdateApiAccessTokenSignAlgResponse(String value) {
        this.value = value;
    }
    ...
    public static Optional<ServiceUpdateApiAccessTokenSignAlgResponse> fromValue(String value) {
        for (ServiceUpdateApiAccessTokenSignAlgResponse o: ServiceUpdateApiAccessTokenSignAlgResponse.values()) {
