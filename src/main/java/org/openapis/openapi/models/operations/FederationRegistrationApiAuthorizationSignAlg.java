 ...
 */
public enum FederationRegistrationApiAuthorizationSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    FederationRegistrationApiAuthorizationSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<FederationRegistrationApiAuthorizationSignAlg> fromValue(String value) {
        for (FederationRegistrationApiAuthorizationSignAlg o: FederationRegistrationApiAuthorizationSignAlg.values()) {
