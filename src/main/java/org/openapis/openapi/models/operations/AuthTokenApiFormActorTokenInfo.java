...
public class AuthTokenApiFormActorTokenInfo {
    /**
     * The client id.
     */
    ...
    private List<AuthTokenApiFormActorTokenInfoProperty> properties;
    ...
    private AuthTokenApiFormActorTokenInfoAuthorizationDetails authorizationDetails;
    ...
    @JsonCreator
    public AuthTokenApiFormActorTokenInfo(
            ...
            @JsonProperty("properties") @Nullable List<AuthTokenApiFormActorTokenInfoProperty> properties,
            @JsonProperty("resources") @Nullable List<String> resources,
            @JsonProperty("authorizationDetails") @Nullable AuthTokenApiFormActorTokenInfoAuthorizationDetails authorizationDetails,
     ...
     * Extra properties associated with the token
     */
    public Optional<List<AuthTokenApiFormActorTokenInfoProperty>> properties() {
    ...
    public Optional<AuthTokenApiFormActorTokenInfoAuthorizationDetails> authorizationDetails() {
     ...
     * The client id.
     */
    public AuthTokenApiFormActorTokenInfo withClientId(@Nullable Long clientId) {
        this.clientId = clientId;
        return this;
    }
     ...
     * The alias of the client.
     */
    public AuthTokenApiFormActorTokenInfo withClientIdAlias(@Nullable String clientIdAlias) {
        this.clientIdAlias = clientIdAlias;
        return this;
    }
     ...
     * Flag specifying if the alias was used to identify the client
     */
    public AuthTokenApiFormActorTokenInfo withClientIdAliasUsed(@Nullable Boolean clientIdAliasUsed) {
        this.clientIdAliasUsed = clientIdAliasUsed;
        return this;
    }
     ...
     * the resource owner unique id
     */
    public AuthTokenApiFormActorTokenInfo withSubject(@Nullable String subject) {
        this.subject = subject;
        return this;
    }
     ...
     * The scopes granted on the token
     */
    public AuthTokenApiFormActorTokenInfo withScopes(@Nullable List<String> scopes) {
        this.scopes = scopes;
        return this;
    }
     ...
     * time which the token expires.
     */
    public AuthTokenApiFormActorTokenInfo withExpiresAt(@Nullable Long expiresAt) {
        this.expiresAt = expiresAt;
        return this;
    }
     ...
     * Extra properties associated with the token
     */
    public AuthTokenApiFormActorTokenInfo withProperties(@Nullable List<AuthTokenApiFormActorTokenInfoProperty> properties) {
        this.properties = properties;
        return this;
    }
     ...
     * The array of the resources of the token.
     */
    public AuthTokenApiFormActorTokenInfo withResources(@Nullable List<String> resources) {
        this.resources = resources;
        return this;
    }


    public AuthTokenApiFormActorTokenInfo withAuthorizationDetails(@Nullable AuthTokenApiFormActorTokenInfoAuthorizationDetails authorizationDetails) {
        this.authorizationDetails = authorizationDetails;
        return this;
    }
     ...
     * The entity ID of the client.
     */
    public AuthTokenApiFormActorTokenInfo withClientEntityId(@Nullable String clientEntityId) {
        this.clientEntityId = clientEntityId;
        return this;
    }
     ...
     * Flag which indicates whether the entity ID of the client was used when the request for the access token was made.
     */
    public AuthTokenApiFormActorTokenInfo withClientEntityIdUsed(@Nullable Boolean clientEntityIdUsed) {
        this.clientEntityIdUsed = clientEntityIdUsed;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AuthTokenApiFormActorTokenInfo other = (AuthTokenApiFormActorTokenInfo) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AuthTokenApiFormActorTokenInfo.class,
                "clientId", clientId,
    ...
    public final static class Builder {
         ...
         * Extra properties associated with the token
         */
        public Builder properties(@Nullable List<AuthTokenApiFormActorTokenInfoProperty> properties) {
            this.properties = properties;
            return this;
        }
        ...
        public Builder authorizationDetails(@Nullable AuthTokenApiFormActorTokenInfoAuthorizationDetails authorizationDetails) {
            this.authorizationDetails = authorizationDetails;
            return this;
        }
        ...
        public AuthTokenApiFormActorTokenInfo build() {
            return new AuthTokenApiFormActorTokenInfo(
                clientId, clientIdAlias, clientIdAliasUsed,
                subject, scopes, expiresAt,
                properties, resources, authorizationDetails,
                clientEntityId, clientEntityIdUsed);
