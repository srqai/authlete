 ...
 */
public enum ClientRegistrationUpdateApiFormRequestEncryptionEnc {
    ...
    ClientRegistrationUpdateApiFormRequestEncryptionEnc(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationUpdateApiFormRequestEncryptionEnc> fromValue(String value) {
        for (ClientRegistrationUpdateApiFormRequestEncryptionEnc o: ClientRegistrationUpdateApiFormRequestEncryptionEnc.values()) {
