 ...
 */
public enum ClientRegistrationUpdateApiFormUserInfoEncryptionEnc {
    ...
    ClientRegistrationUpdateApiFormUserInfoEncryptionEnc(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationUpdateApiFormUserInfoEncryptionEnc> fromValue(String value) {
        for (ClientRegistrationUpdateApiFormUserInfoEncryptionEnc o: ClientRegistrationUpdateApiFormUserInfoEncryptionEnc.values()) {
