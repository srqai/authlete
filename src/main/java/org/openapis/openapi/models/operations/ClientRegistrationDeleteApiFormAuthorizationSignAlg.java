 ...
 */
public enum ClientRegistrationDeleteApiFormAuthorizationSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientRegistrationDeleteApiFormAuthorizationSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationDeleteApiFormAuthorizationSignAlg> fromValue(String value) {
        for (ClientRegistrationDeleteApiFormAuthorizationSignAlg o: ClientRegistrationDeleteApiFormAuthorizationSignAlg.values()) {
