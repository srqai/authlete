 ...
 */
public enum ClientUpdateApiAuthorizationEncryptionAlgRequest {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientUpdateApiAuthorizationEncryptionAlgRequest(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientUpdateApiAuthorizationEncryptionAlgRequest> fromValue(String value) {
        for (ClientUpdateApiAuthorizationEncryptionAlgRequest o: ClientUpdateApiAuthorizationEncryptionAlgRequest.values()) {
