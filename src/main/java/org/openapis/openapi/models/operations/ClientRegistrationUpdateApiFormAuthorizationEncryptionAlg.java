 ...
 */
public enum ClientRegistrationUpdateApiFormAuthorizationEncryptionAlg {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientRegistrationUpdateApiFormAuthorizationEncryptionAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationUpdateApiFormAuthorizationEncryptionAlg> fromValue(String value) {
        for (ClientRegistrationUpdateApiFormAuthorizationEncryptionAlg o: ClientRegistrationUpdateApiFormAuthorizationEncryptionAlg.values()) {
