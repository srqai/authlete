 ...
 */
public enum ClientRegistrationApiFormIdTokenEncryptionEnc {
    ...
    ClientRegistrationApiFormIdTokenEncryptionEnc(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationApiFormIdTokenEncryptionEnc> fromValue(String value) {
        for (ClientRegistrationApiFormIdTokenEncryptionEnc o: ClientRegistrationApiFormIdTokenEncryptionEnc.values()) {
