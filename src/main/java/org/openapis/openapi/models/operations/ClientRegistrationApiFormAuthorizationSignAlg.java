 ...
 */
public enum ClientRegistrationApiFormAuthorizationSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientRegistrationApiFormAuthorizationSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationApiFormAuthorizationSignAlg> fromValue(String value) {
        for (ClientRegistrationApiFormAuthorizationSignAlg o: ClientRegistrationApiFormAuthorizationSignAlg.values()) {
