...
public class BackchannelAuthenticationCompleteApiResponseBody {
    /**
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("action")
    private BackchannelAuthenticationCompleteApiAction action;
    ...
    @JsonCreator
    public BackchannelAuthenticationCompleteApiResponseBody(
            @JsonProperty("resultCode") @Nullable String resultCode,
            @JsonProperty("resultMessage") @Nullable String resultMessage,
            @JsonProperty("action") @Nullable BackchannelAuthenticationCompleteApiAction action,
     ...
     * The next action that the authorization server implementation should take.
     */
    public Optional<BackchannelAuthenticationCompleteApiAction> action() {
     ...
     * The code which represents the result of the API call.
     */
    public BackchannelAuthenticationCompleteApiResponseBody withResultCode(@Nullable String resultCode) {
        this.resultCode = resultCode;
        return this;
    }
     ...
     * A short message which explains the result of the API call.
     */
    public BackchannelAuthenticationCompleteApiResponseBody withResultMessage(@Nullable String resultMessage) {
        this.resultMessage = resultMessage;
        return this;
    }
     ...
     * The next action that the authorization server implementation should take.
     */
    public BackchannelAuthenticationCompleteApiResponseBody withAction(@Nullable BackchannelAuthenticationCompleteApiAction action) {
        this.action = action;
        return this;
    }
     ...
     * application. Its format varies depending on the value of `action` parameter.
     */
    public BackchannelAuthenticationCompleteApiResponseBody withResponseContent(@Nullable String responseContent) {
        this.responseContent = responseContent;
        return this;
    }
     ...
     * request.
     */
    public BackchannelAuthenticationCompleteApiResponseBody withClientId(@Nullable Long clientId) {
        this.clientId = clientId;
        return this;
    }
     ...
     * request.
     */
    public BackchannelAuthenticationCompleteApiResponseBody withClientIdAlias(@Nullable String clientIdAlias) {
        this.clientIdAlias = clientIdAlias;
        return this;
    }
     ...
     * numeric client ID.
     */
    public BackchannelAuthenticationCompleteApiResponseBody withClientIdAliasUsed(@Nullable Boolean clientIdAliasUsed) {
        this.clientIdAliasUsed = clientIdAliasUsed;
        return this;
    }
     ...
     * The name of the client application which has made the backchannel authentication request.
     */
    public BackchannelAuthenticationCompleteApiResponseBody withClientName(@Nullable String clientName) {
        this.clientName = clientName;
        return this;
    }
     ...
     * to the `client_notification_endpoint` metadata of the client application.
     */
    public BackchannelAuthenticationCompleteApiResponseBody withClientNotificationEndpoint(@Nullable String clientNotificationEndpoint) {
        this.clientNotificationEndpoint = clientNotificationEndpoint;
        return this;
    }
     ...
     * parameter included in the backchannel authentication request.
     */
    public BackchannelAuthenticationCompleteApiResponseBody withClientNotificationToken(@Nullable String clientNotificationToken) {
        this.clientNotificationToken = clientNotificationToken;
        return this;
    }
     ...
     * The newly issued authentication request ID.
     */
    public BackchannelAuthenticationCompleteApiResponseBody withAuthReqId(@Nullable String authReqId) {
        this.authReqId = authReqId;
        return this;
    }
     ...
     * The issued access token.
     */
    public BackchannelAuthenticationCompleteApiResponseBody withAccessToken(@Nullable String accessToken) {
        this.accessToken = accessToken;
        return this;
    }
     ...
     * The issued refresh token.
     */
    public BackchannelAuthenticationCompleteApiResponseBody withRefreshToken(@Nullable String refreshToken) {
        this.refreshToken = refreshToken;
        return this;
    }
     ...
     * The issued ID token.
     */
    public BackchannelAuthenticationCompleteApiResponseBody withIdToken(@Nullable String idToken) {
        this.idToken = idToken;
        return this;
    }
     ...
     * The duration of the access token in seconds.
     */
    public BackchannelAuthenticationCompleteApiResponseBody withAccessTokenDuration(@Nullable Long accessTokenDuration) {
        this.accessTokenDuration = accessTokenDuration;
        return this;
    }
     ...
     * The duration of the refresh token in seconds.
     */
    public BackchannelAuthenticationCompleteApiResponseBody withRefreshTokenDuration(@Nullable Long refreshTokenDuration) {
        this.refreshTokenDuration = refreshTokenDuration;
        return this;
    }
     ...
     * The duration of the ID token in seconds.
     */
    public BackchannelAuthenticationCompleteApiResponseBody withIdTokenDuration(@Nullable Long idTokenDuration) {
        this.idTokenDuration = idTokenDuration;
        return this;
    }
     ...
     * The issued access token in JWT format.
     */
    public BackchannelAuthenticationCompleteApiResponseBody withJwtAccessToken(@Nullable String jwtAccessToken) {
        this.jwtAccessToken = jwtAccessToken;
        return this;
    }
     ...
     * set. See "Resource Indicators for OAuth 2.0" for details.
     */
    public BackchannelAuthenticationCompleteApiResponseBody withResources(@Nullable List<String> resources) {
        this.resources = resources;
        return this;
    }
     ...
     * , which is supported by Authlete 2.3 and newer versions.
     */
    public BackchannelAuthenticationCompleteApiResponseBody withGrantId(@Nullable String grantId) {
        this.grantId = grantId;
        return this;
    }
     ...
     * The entity ID of the client.
     */
    public BackchannelAuthenticationCompleteApiResponseBody withClientEntityId(@Nullable String clientEntityId) {
        this.clientEntityId = clientEntityId;
        return this;
    }
     ...
     * Flag which indicates whether the entity ID of the client was used when the request for the access token was made.
     */
    public BackchannelAuthenticationCompleteApiResponseBody withClientEntityIdUsed(@Nullable Boolean clientEntityIdUsed) {
        this.clientEntityIdUsed = clientEntityIdUsed;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        BackchannelAuthenticationCompleteApiResponseBody other = (BackchannelAuthenticationCompleteApiResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(BackchannelAuthenticationCompleteApiResponseBody.class,
    ...
    public final static class Builder {
         ...
         * The next action that the authorization server implementation should take.
         */
        public Builder action(@Nullable BackchannelAuthenticationCompleteApiAction action) {
            this.action = action;
            return this;
        }
        ...
        public BackchannelAuthenticationCompleteApiResponseBody build() {
            return new BackchannelAuthenticationCompleteApiResponseBody(
                resultCode, resultMessage, action,
                responseContent, clientId, clientIdAlias,
                clientIdAliasUsed, clientName, deliveryMode,
                clientNotificationEndpoint, clientNotificationToken, authReqId,
