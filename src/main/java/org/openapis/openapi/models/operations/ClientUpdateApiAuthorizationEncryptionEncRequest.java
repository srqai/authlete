 ...
 */
public enum ClientUpdateApiAuthorizationEncryptionEncRequest {
    ...
    ClientUpdateApiAuthorizationEncryptionEncRequest(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientUpdateApiAuthorizationEncryptionEncRequest> fromValue(String value) {
        for (ClientUpdateApiAuthorizationEncryptionEncRequest o: ClientUpdateApiAuthorizationEncryptionEncRequest.values()) {
