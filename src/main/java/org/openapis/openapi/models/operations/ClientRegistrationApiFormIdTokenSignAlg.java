 ...
 */
public enum ClientRegistrationApiFormIdTokenSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientRegistrationApiFormIdTokenSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationApiFormIdTokenSignAlg> fromValue(String value) {
        for (ClientRegistrationApiFormIdTokenSignAlg o: ClientRegistrationApiFormIdTokenSignAlg.values()) {
