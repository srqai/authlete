 ...
 */
public enum ClientCreateApiUserInfoEncryptionEncResponse {
    ...
    ClientCreateApiUserInfoEncryptionEncResponse(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientCreateApiUserInfoEncryptionEncResponse> fromValue(String value) {
        for (ClientCreateApiUserInfoEncryptionEncResponse o: ClientCreateApiUserInfoEncryptionEncResponse.values()) {
