...
public enum ClientCreateApiFapiModeRequest {
    ...
    ClientCreateApiFapiModeRequest(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientCreateApiFapiModeRequest> fromValue(String value) {
        for (ClientCreateApiFapiModeRequest o: ClientCreateApiFapiModeRequest.values()) {
