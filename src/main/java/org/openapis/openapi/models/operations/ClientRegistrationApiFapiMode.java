...
public enum ClientRegistrationApiFapiMode {
    ...
    ClientRegistrationApiFapiMode(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationApiFapiMode> fromValue(String value) {
        for (ClientRegistrationApiFapiMode o: ClientRegistrationApiFapiMode.values()) {
