 ...
 */
public enum AuthTokenApiRequestedTokenType {
    ...
    AuthTokenApiRequestedTokenType(String value) {
        this.value = value;
    }
    ...
    public static Optional<AuthTokenApiRequestedTokenType> fromValue(String value) {
        for (AuthTokenApiRequestedTokenType o: AuthTokenApiRequestedTokenType.values()) {
