 ...
 */
public enum ClientGetListApiIdTokenEncryptionAlg {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientGetListApiIdTokenEncryptionAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientGetListApiIdTokenEncryptionAlg> fromValue(String value) {
        for (ClientGetListApiIdTokenEncryptionAlg o: ClientGetListApiIdTokenEncryptionAlg.values()) {
