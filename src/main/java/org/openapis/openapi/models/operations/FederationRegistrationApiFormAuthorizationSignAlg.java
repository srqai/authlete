 ...
 */
public enum FederationRegistrationApiFormAuthorizationSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    FederationRegistrationApiFormAuthorizationSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<FederationRegistrationApiFormAuthorizationSignAlg> fromValue(String value) {
        for (FederationRegistrationApiFormAuthorizationSignAlg o: FederationRegistrationApiFormAuthorizationSignAlg.values()) {
