 ...
 */
public enum ClientRegistrationDeleteApiFormBcRequestSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientRegistrationDeleteApiFormBcRequestSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationDeleteApiFormBcRequestSignAlg> fromValue(String value) {
        for (ClientRegistrationDeleteApiFormBcRequestSignAlg o: ClientRegistrationDeleteApiFormBcRequestSignAlg.values()) {
