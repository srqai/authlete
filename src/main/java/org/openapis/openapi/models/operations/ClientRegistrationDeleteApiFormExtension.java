...
public class ClientRegistrationDeleteApiFormExtension {
    /**
    ...
    @JsonCreator
    public ClientRegistrationDeleteApiFormExtension(
     ...
     * that the set is the set of scopes that the client application is allowed to request.
     */
    public ClientRegistrationDeleteApiFormExtension withRequestableScopes(@Nullable List<String> requestableScopes) {
        this.requestableScopes = requestableScopes;
        return this;
    }
     ...
     * application can request any scope which is supported by the authorization server.
     */
    public ClientRegistrationDeleteApiFormExtension withRequestableScopesEnabled(@Nullable Boolean requestableScopesEnabled) {
        this.requestableScopesEnabled = requestableScopesEnabled;
        return this;
    }
     ...
     * too. Authlete chooses the minimum value among the candidates.
     */
    public ClientRegistrationDeleteApiFormExtension withAccessTokenDuration(@Nullable Long accessTokenDuration) {
        this.accessTokenDuration = accessTokenDuration;
        return this;
    }
     ...
     * too. Authlete chooses the minimum value among the candidates.
     */
    public ClientRegistrationDeleteApiFormExtension withRefreshTokenDuration(@Nullable Long refreshTokenDuration) {
        this.refreshTokenDuration = refreshTokenDuration;
        return this;
    }
     ...
     * too. Authlete chooses the minimum value among the candidates.
     */
    public ClientRegistrationDeleteApiFormExtension withIdTokenDuration(@Nullable Long idTokenDuration) {
        this.idTokenDuration = idTokenDuration;
        return this;
    }
     ...
     * permission to make token exchange requests ([RFC 8693][https://www.rfc-editor.org/rfc/rfc8693.html])
     */
    public ClientRegistrationDeleteApiFormExtension withTokenExchangePermitted(@Nullable Boolean tokenExchangePermitted) {
        this.tokenExchangePermitted = tokenExchangePermitted;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClientRegistrationDeleteApiFormExtension other = (ClientRegistrationDeleteApiFormExtension) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ClientRegistrationDeleteApiFormExtension.class,
    ...
    public final static class Builder {
        ...
        public ClientRegistrationDeleteApiFormExtension build() {
            return new ClientRegistrationDeleteApiFormExtension(
                requestableScopes, requestableScopesEnabled, accessTokenDuration,
                refreshTokenDuration, idTokenDuration, tokenExchangePermitted);
        }
