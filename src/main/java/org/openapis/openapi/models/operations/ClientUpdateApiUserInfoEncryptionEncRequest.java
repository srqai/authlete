 ...
 */
public enum ClientUpdateApiUserInfoEncryptionEncRequest {
    ...
    ClientUpdateApiUserInfoEncryptionEncRequest(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientUpdateApiUserInfoEncryptionEncRequest> fromValue(String value) {
        for (ClientUpdateApiUserInfoEncryptionEncRequest o: ClientUpdateApiUserInfoEncryptionEncRequest.values()) {
