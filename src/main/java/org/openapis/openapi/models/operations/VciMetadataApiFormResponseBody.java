...
public class VciMetadataApiFormResponseBody {
    /**
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("action")
    private VciMetadataApiFormAction action;
     ...
     * `/vci/metadata` API.
     */
    public Optional<VciMetadataApiFormAction> action() {
     ...
     * The code which represents the result of the API call.
     */
    public VciMetadataApiFormResponseBody withResultCode(@Nullable String resultCode) {
        this.resultCode = resultCode;
        return this;
    }
     ...
     * A short message which explains the result of the API call.
     */
    public VciMetadataApiFormResponseBody withResultMessage(@Nullable String resultMessage) {
        this.resultMessage = resultMessage;
        return this;
    }
     ...
     * `/vci/metadata` API.
     */
    public VciMetadataApiFormResponseBody withAction(@Nullable VciMetadataApiFormAction action) {
        this.action = action;
        return this;
    }
     ...
     * metadata endpoint should use when it constructs a response.
     */
    public VciMetadataApiFormResponseBody withResponseContent(@Nullable String responseContent) {
        this.responseContent = responseContent;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        VciMetadataApiFormResponseBody other = (VciMetadataApiFormResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(VciMetadataApiFormResponseBody.class,
    ...
    public final static class Builder {
         ...
         * `/vci/metadata` API.
         */
        public Builder action(@Nullable VciMetadataApiFormAction action) {
            this.action = action;
            return this;
        }
        ...
        public VciMetadataApiFormResponseBody build() {
            return new VciMetadataApiFormResponseBody(
                resultCode, resultMessage, action,
                responseContent);
        }
