 ...
 */
public enum ClientRegistrationUpdateApiBcRequestSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientRegistrationUpdateApiBcRequestSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationUpdateApiBcRequestSignAlg> fromValue(String value) {
        for (ClientRegistrationUpdateApiBcRequestSignAlg o: ClientRegistrationUpdateApiBcRequestSignAlg.values()) {
