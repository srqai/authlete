 ...
 */
public enum ClientGetListApiUserInfoSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientGetListApiUserInfoSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientGetListApiUserInfoSignAlg> fromValue(String value) {
        for (ClientGetListApiUserInfoSignAlg o: ClientGetListApiUserInfoSignAlg.values()) {
