 ...
 */
public enum ClientGetListApiRequestEncryptionAlg {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientGetListApiRequestEncryptionAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientGetListApiRequestEncryptionAlg> fromValue(String value) {
        for (ClientGetListApiRequestEncryptionAlg o: ClientGetListApiRequestEncryptionAlg.values()) {
