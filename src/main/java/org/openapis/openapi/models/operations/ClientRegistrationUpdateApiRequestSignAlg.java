 ...
 */
public enum ClientRegistrationUpdateApiRequestSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientRegistrationUpdateApiRequestSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationUpdateApiRequestSignAlg> fromValue(String value) {
        for (ClientRegistrationUpdateApiRequestSignAlg o: ClientRegistrationUpdateApiRequestSignAlg.values()) {
