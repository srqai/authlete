...
public class HskDeleteApiHsk {
     ...
     * The key type (EC or RSA)
     */
    public HskDeleteApiHsk withKty(@Nullable String kty) {
        this.kty = kty;
        return this;
    }
     ...
     * When the key use is "enc" (encryption), the private key on the HSM is used to decrypt encrypted data which have been encrypted with the corresponding public key
     */
    public HskDeleteApiHsk withUse(@Nullable String use) {
        this.use = use;
        return this;
    }
     ...
     * Key ID for the key on the HSM.
     */
    public HskDeleteApiHsk withKid(@Nullable String kid) {
        this.kid = kid;
        return this;
    }
     ...
     * The identifier for the HSM that sits behind the Authlete server. For example, "google".
     */
    public HskDeleteApiHsk withHsmName(@Nullable String hsmName) {
        this.hsmName = hsmName;
        return this;
    }
     ...
     * A handle is a base64url-encoded 256-bit random value (43 letters) which is assigned by Authlete on the call of the /api/hsk/create API
     */
    public HskDeleteApiHsk withHandle(@Nullable String handle) {
        this.handle = handle;
        return this;
    }
     ...
     * The public key that corresponds to the key on the HSM.
     */
    public HskDeleteApiHsk withPublicKey(@Nullable String publicKey) {
        this.publicKey = publicKey;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HskDeleteApiHsk other = (HskDeleteApiHsk) o;
        return 
    ...
    public String toString() {
        return Utils.toString(HskDeleteApiHsk.class,
                "kty", kty,
                "use", use,
                "kid", kid,
                "hsmName", hsmName,
    ...
    public final static class Builder {
        ...
        public HskDeleteApiHsk build() {
            return new HskDeleteApiHsk(
                kty, use, kid,
                hsmName, handle, publicKey);
        }
