 ...
 */
public enum ClientGetApiRequestEncryptionEnc {
    ...
    ClientGetApiRequestEncryptionEnc(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientGetApiRequestEncryptionEnc> fromValue(String value) {
        for (ClientGetApiRequestEncryptionEnc o: ClientGetApiRequestEncryptionEnc.values()) {
