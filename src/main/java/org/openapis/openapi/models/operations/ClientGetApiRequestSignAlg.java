 ...
 */
public enum ClientGetApiRequestSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientGetApiRequestSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientGetApiRequestSignAlg> fromValue(String value) {
        for (ClientGetApiRequestSignAlg o: ClientGetApiRequestSignAlg.values()) {
