 ...
 */
public enum FederationRegistrationApiFormAuthorizationEncryptionEnc {
    ...
    FederationRegistrationApiFormAuthorizationEncryptionEnc(String value) {
        this.value = value;
    }
    ...
    public static Optional<FederationRegistrationApiFormAuthorizationEncryptionEnc> fromValue(String value) {
        for (FederationRegistrationApiFormAuthorizationEncryptionEnc o: FederationRegistrationApiFormAuthorizationEncryptionEnc.values()) {
