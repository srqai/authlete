...
public class AuthTokenFailApiFormResponseBody {
    /**
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("action")
    private AuthTokenFailApiFormAction action;
     ...
     * The next action that the authorization server implementation should take.
     */
    public Optional<AuthTokenFailApiFormAction> action() {
     ...
     * The code which represents the result of the API call.
     */
    public AuthTokenFailApiFormResponseBody withResultCode(@Nullable String resultCode) {
        this.resultCode = resultCode;
        return this;
    }
     ...
     * A short message which explains the result of the API call.
     */
    public AuthTokenFailApiFormResponseBody withResultMessage(@Nullable String resultMessage) {
        this.resultMessage = resultMessage;
        return this;
    }
     ...
     * The next action that the authorization server implementation should take.
     */
    public AuthTokenFailApiFormResponseBody withAction(@Nullable AuthTokenFailApiFormAction action) {
        this.action = action;
        return this;
    }
     ...
     * Its format varies depending on the value of `action` parameter. See description for details.
     */
    public AuthTokenFailApiFormResponseBody withResponseContent(@Nullable String responseContent) {
        this.responseContent = responseContent;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AuthTokenFailApiFormResponseBody other = (AuthTokenFailApiFormResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AuthTokenFailApiFormResponseBody.class,
    ...
    public final static class Builder {
         ...
         * The next action that the authorization server implementation should take.
         */
        public Builder action(@Nullable AuthTokenFailApiFormAction action) {
            this.action = action;
            return this;
        }
        ...
        public AuthTokenFailApiFormResponseBody build() {
            return new AuthTokenFailApiFormResponseBody(
                resultCode, resultMessage, action,
                responseContent);
        }
