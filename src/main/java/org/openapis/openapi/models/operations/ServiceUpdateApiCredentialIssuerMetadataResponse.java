...
public class ServiceUpdateApiCredentialIssuerMetadataResponse {
    /**
    ...
    @JsonCreator
    public ServiceUpdateApiCredentialIssuerMetadataResponse(
     ...
     * The identifier of a credential request.
     */
    public ServiceUpdateApiCredentialIssuerMetadataResponse withCredentialIssuer(@Nullable String credentialIssuer) {
        this.credentialIssuer = credentialIssuer;
        return this;
    }
     ...
     * relies on for authorization.
     */
    public ServiceUpdateApiCredentialIssuerMetadataResponse withAuthorizationServer(@Nullable String authorizationServer) {
        this.authorizationServer = authorizationServer;
        return this;
    }
     ...
     * The URL of the credential endpoint of the credential issuer.
     */
    public ServiceUpdateApiCredentialIssuerMetadataResponse withCredentialEndpoint(@Nullable Boolean credentialEndpoint) {
        this.credentialEndpoint = credentialEndpoint;
        return this;
    }
     ...
     * The URL of the batch credential endpoint of the credential issuer.
     */
    public ServiceUpdateApiCredentialIssuerMetadataResponse withBatchCredentialEndpoint(@Nullable Long batchCredentialEndpoint) {
        this.batchCredentialEndpoint = batchCredentialEndpoint;
        return this;
    }
     ...
     * The URL of the deferred credential endpoint of the credential issuer.
     */
    public ServiceUpdateApiCredentialIssuerMetadataResponse withDeferredCredentialEndpoint(@Nullable String deferredCredentialEndpoint) {
        this.deferredCredentialEndpoint = deferredCredentialEndpoint;
        return this;
    }
     ...
     * A JSON array describing supported credentials.
     */
    public ServiceUpdateApiCredentialIssuerMetadataResponse withCredentialsSupported(@Nullable Boolean credentialsSupported) {
        this.credentialsSupported = credentialsSupported;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ServiceUpdateApiCredentialIssuerMetadataResponse other = (ServiceUpdateApiCredentialIssuerMetadataResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ServiceUpdateApiCredentialIssuerMetadataResponse.class,
    ...
    public final static class Builder {
        ...
        public ServiceUpdateApiCredentialIssuerMetadataResponse build() {
            return new ServiceUpdateApiCredentialIssuerMetadataResponse(
                credentialIssuer, authorizationServer, credentialEndpoint,
                batchCredentialEndpoint, deferredCredentialEndpoint, credentialsSupported);
        }
