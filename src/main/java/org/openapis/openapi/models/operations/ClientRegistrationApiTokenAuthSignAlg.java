 ...
 */
public enum ClientRegistrationApiTokenAuthSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientRegistrationApiTokenAuthSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationApiTokenAuthSignAlg> fromValue(String value) {
        for (ClientRegistrationApiTokenAuthSignAlg o: ClientRegistrationApiTokenAuthSignAlg.values()) {
