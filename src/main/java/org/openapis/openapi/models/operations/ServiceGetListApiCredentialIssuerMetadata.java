...
public class ServiceGetListApiCredentialIssuerMetadata {
    /**
    ...
    @JsonCreator
    public ServiceGetListApiCredentialIssuerMetadata(
     ...
     * The identifier of a credential request.
     */
    public ServiceGetListApiCredentialIssuerMetadata withCredentialIssuer(@Nullable String credentialIssuer) {
        this.credentialIssuer = credentialIssuer;
        return this;
    }
     ...
     * relies on for authorization.
     */
    public ServiceGetListApiCredentialIssuerMetadata withAuthorizationServer(@Nullable String authorizationServer) {
        this.authorizationServer = authorizationServer;
        return this;
    }
     ...
     * The URL of the credential endpoint of the credential issuer.
     */
    public ServiceGetListApiCredentialIssuerMetadata withCredentialEndpoint(@Nullable Boolean credentialEndpoint) {
        this.credentialEndpoint = credentialEndpoint;
        return this;
    }
     ...
     * The URL of the batch credential endpoint of the credential issuer.
     */
    public ServiceGetListApiCredentialIssuerMetadata withBatchCredentialEndpoint(@Nullable Long batchCredentialEndpoint) {
        this.batchCredentialEndpoint = batchCredentialEndpoint;
        return this;
    }
     ...
     * The URL of the deferred credential endpoint of the credential issuer.
     */
    public ServiceGetListApiCredentialIssuerMetadata withDeferredCredentialEndpoint(@Nullable String deferredCredentialEndpoint) {
        this.deferredCredentialEndpoint = deferredCredentialEndpoint;
        return this;
    }
     ...
     * A JSON array describing supported credentials.
     */
    public ServiceGetListApiCredentialIssuerMetadata withCredentialsSupported(@Nullable Boolean credentialsSupported) {
        this.credentialsSupported = credentialsSupported;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ServiceGetListApiCredentialIssuerMetadata other = (ServiceGetListApiCredentialIssuerMetadata) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ServiceGetListApiCredentialIssuerMetadata.class,
    ...
    public final static class Builder {
        ...
        public ServiceGetListApiCredentialIssuerMetadata build() {
            return new ServiceGetListApiCredentialIssuerMetadata(
                credentialIssuer, authorizationServer, credentialEndpoint,
                batchCredentialEndpoint, deferredCredentialEndpoint, credentialsSupported);
        }
