 ...
 */
public enum ClientRegistrationDeleteApiRequestEncryptionEnc {
    ...
    ClientRegistrationDeleteApiRequestEncryptionEnc(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationDeleteApiRequestEncryptionEnc> fromValue(String value) {
        for (ClientRegistrationDeleteApiRequestEncryptionEnc o: ClientRegistrationDeleteApiRequestEncryptionEnc.values()) {
