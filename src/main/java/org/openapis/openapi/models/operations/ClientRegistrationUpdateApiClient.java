...
public class ClientRegistrationUpdateApiClient {
    /**
    ...
    private List<ClientRegistrationUpdateApiClientName> clientNames;
    ...
    private List<ClientRegistrationUpdateApiDescription> descriptions;
    ...
    private ClientRegistrationUpdateApiClientType clientType;
    ...
    private ClientRegistrationUpdateApiApplicationType applicationType;
    ...
    private List<ClientRegistrationUpdateApiLogoUris> logoUris;
    ...
    private List<ClientRegistrationUpdateApiGrantType> grantTypes;
    ...
    private List<ClientRegistrationUpdateApiResponseType> responseTypes;
    ...
    private ClientRegistrationUpdateApiAuthorizationSignAlg authorizationSignAlg;
    ...
    private ClientRegistrationUpdateApiAuthorizationEncryptionAlg authorizationEncryptionAlg;
    ...
    private ClientRegistrationUpdateApiAuthorizationEncryptionEnc authorizationEncryptionEnc;
    ...
    private ClientRegistrationUpdateApiTokenAuthMethod tokenAuthMethod;
    ...
    private ClientRegistrationUpdateApiTokenAuthSignAlg tokenAuthSignAlg;
    ...
    private ClientRegistrationUpdateApiRequestSignAlg requestSignAlg;
    ...
    private ClientRegistrationUpdateApiRequestEncryptionAlg requestEncryptionAlg;
    ...
    private ClientRegistrationUpdateApiRequestEncryptionEnc requestEncryptionEnc;
    ...
    private ClientRegistrationUpdateApiIdTokenSignAlg idTokenSignAlg;
    ...
    private ClientRegistrationUpdateApiIdTokenEncryptionAlg idTokenEncryptionAlg;
    ...
    private ClientRegistrationUpdateApiIdTokenEncryptionEnc idTokenEncryptionEnc;
    ...
    private ClientRegistrationUpdateApiSubjectType subjectType;
    ...
    private ClientRegistrationUpdateApiUserInfoSignAlg userInfoSignAlg;
    ...
    private ClientRegistrationUpdateApiUserInfoEncryptionAlg userInfoEncryptionAlg;
    ...
    private ClientRegistrationUpdateApiUserInfoEncryptionEnc userInfoEncryptionEnc;
    ...
    private List<ClientRegistrationUpdateApiTosUris> tosUris;
    ...
    private List<ClientRegistrationUpdateApiPolicyUris> policyUris;
    ...
    private List<ClientRegistrationUpdateApiClientUris> clientUris;
    ...
    private ClientRegistrationUpdateApiBcRequestSignAlg bcRequestSignAlg;
    ...
    private List<ClientRegistrationUpdateApiAttribute> attributes;


    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("extension")
    private ClientRegistrationUpdateApiExtension extension;
    ...
    private List<ClientRegistrationUpdateApiClientRegistrationType> clientRegistrationTypes;
    ...
    private List<ClientRegistrationUpdateApiFapiMode> fapiModes;
    ...
    private List<ClientRegistrationUpdateApiResponseMode> responseModes;
    ...
    @JsonCreator
    public ClientRegistrationUpdateApiClient(
            ...
            @JsonProperty("clientNames") @Nullable List<ClientRegistrationUpdateApiClientName> clientNames,
            @JsonProperty("description") @Nullable String description,
            @JsonProperty("descriptions") @Nullable List<ClientRegistrationUpdateApiDescription> descriptions,
            ...
            @JsonProperty("clientType") @Nullable ClientRegistrationUpdateApiClientType clientType,
            @JsonProperty("applicationType") @Nullable ClientRegistrationUpdateApiApplicationType applicationType,
            @JsonProperty("logoUri") @Nullable String logoUri,
            @JsonProperty("logoUris") @Nullable List<ClientRegistrationUpdateApiLogoUris> logoUris,
            ...
            @JsonProperty("grantTypes") @Nullable List<ClientRegistrationUpdateApiGrantType> grantTypes,
            @JsonProperty("responseTypes") @Nullable List<ClientRegistrationUpdateApiResponseType> responseTypes,
            @JsonProperty("redirectUris") @Nullable List<String> redirectUris,
            @JsonProperty("authorizationSignAlg") @Nullable ClientRegistrationUpdateApiAuthorizationSignAlg authorizationSignAlg,
            @JsonProperty("authorizationEncryptionAlg") @Nullable ClientRegistrationUpdateApiAuthorizationEncryptionAlg authorizationEncryptionAlg,
            @JsonProperty("authorizationEncryptionEnc") @Nullable ClientRegistrationUpdateApiAuthorizationEncryptionEnc authorizationEncryptionEnc,
            @JsonProperty("tokenAuthMethod") @Nullable ClientRegistrationUpdateApiTokenAuthMethod tokenAuthMethod,
            @JsonProperty("tokenAuthSignAlg") @Nullable ClientRegistrationUpdateApiTokenAuthSignAlg tokenAuthSignAlg,
            ...
            @JsonProperty("requestSignAlg") @Nullable ClientRegistrationUpdateApiRequestSignAlg requestSignAlg,
            @JsonProperty("requestEncryptionAlg") @Nullable ClientRegistrationUpdateApiRequestEncryptionAlg requestEncryptionAlg,
            @JsonProperty("requestEncryptionEnc") @Nullable ClientRegistrationUpdateApiRequestEncryptionEnc requestEncryptionEnc,
            ...
            @JsonProperty("idTokenSignAlg") @Nullable ClientRegistrationUpdateApiIdTokenSignAlg idTokenSignAlg,
            @JsonProperty("idTokenEncryptionAlg") @Nullable ClientRegistrationUpdateApiIdTokenEncryptionAlg idTokenEncryptionAlg,
            @JsonProperty("idTokenEncryptionEnc") @Nullable ClientRegistrationUpdateApiIdTokenEncryptionEnc idTokenEncryptionEnc,
            @JsonProperty("authTimeRequired") @Nullable Boolean authTimeRequired,
            @JsonProperty("subjectType") @Nullable ClientRegistrationUpdateApiSubjectType subjectType,
            ...
            @JsonProperty("userInfoSignAlg") @Nullable ClientRegistrationUpdateApiUserInfoSignAlg userInfoSignAlg,
            @JsonProperty("userInfoEncryptionAlg") @Nullable ClientRegistrationUpdateApiUserInfoEncryptionAlg userInfoEncryptionAlg,
            @JsonProperty("userInfoEncryptionEnc") @Nullable ClientRegistrationUpdateApiUserInfoEncryptionEnc userInfoEncryptionEnc,
            @JsonProperty("loginUri") @Nullable String loginUri,
            @JsonProperty("tosUri") @Nullable String tosUri,
            @JsonProperty("tosUris") @Nullable List<ClientRegistrationUpdateApiTosUris> tosUris,
            @JsonProperty("policyUri") @Nullable String policyUri,
            @JsonProperty("policyUris") @Nullable List<ClientRegistrationUpdateApiPolicyUris> policyUris,
            @JsonProperty("clientUri") @Nullable String clientUri,
            @JsonProperty("clientUris") @Nullable List<ClientRegistrationUpdateApiClientUris> clientUris,
            ...
            @JsonProperty("bcRequestSignAlg") @Nullable ClientRegistrationUpdateApiBcRequestSignAlg bcRequestSignAlg,
            @JsonProperty("bcUserCodeRequired") @Nullable Boolean bcUserCodeRequired,
            @JsonProperty("attributes") @Nullable List<ClientRegistrationUpdateApiAttribute> attributes,
            @JsonProperty("extension") @Nullable ClientRegistrationUpdateApiExtension extension,
            ...
            @JsonProperty("clientRegistrationTypes") @Nullable List<ClientRegistrationUpdateApiClientRegistrationType> clientRegistrationTypes,
            ...
            @JsonProperty("fapiModes") @Nullable List<ClientRegistrationUpdateApiFapiMode> fapiModes,
            @JsonProperty("responseModes") @Nullable List<ClientRegistrationUpdateApiResponseMode> responseModes,
     ...
     * languages, this property can be used to register the names.
     */
    public Optional<List<ClientRegistrationUpdateApiClientName>> clientNames() {
     ...
     * descriptions for different languages, this property can be used to register the descriptions.
     */
    public Optional<List<ClientRegistrationUpdateApiDescription>> descriptions() {
     ...
     * for details.
     */
    public Optional<ClientRegistrationUpdateApiClientType> clientType() {
     ...
     * See the description about `redirectUris` property for more details.
     */
    public Optional<ClientRegistrationUpdateApiApplicationType> applicationType() {
     ...
     * different languages, this property can be used to register URLs of the images.
     */
    public Optional<List<ClientRegistrationUpdateApiLogoUris>> logoUris() {
     ...
     * 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public Optional<List<ClientRegistrationUpdateApiGrantType>> grantTypes() {
     ...
     * 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public Optional<List<ClientRegistrationUpdateApiResponseType>> responseTypes() {
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public Optional<ClientRegistrationUpdateApiAuthorizationSignAlg> authorizationSignAlg() {
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public Optional<ClientRegistrationUpdateApiAuthorizationEncryptionAlg> authorizationEncryptionAlg() {
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public Optional<ClientRegistrationUpdateApiAuthorizationEncryptionEnc> authorizationEncryptionEnc() {
     ...
     * Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public Optional<ClientRegistrationUpdateApiTokenAuthMethod> tokenAuthMethod() {
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public Optional<ClientRegistrationUpdateApiTokenAuthSignAlg> tokenAuthSignAlg() {
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public Optional<ClientRegistrationUpdateApiRequestSignAlg> requestSignAlg() {
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public Optional<ClientRegistrationUpdateApiRequestEncryptionAlg> requestEncryptionAlg() {
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public Optional<ClientRegistrationUpdateApiRequestEncryptionEnc> requestEncryptionEnc() {
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public Optional<ClientRegistrationUpdateApiIdTokenSignAlg> idTokenSignAlg() {
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public Optional<ClientRegistrationUpdateApiIdTokenEncryptionAlg> idTokenEncryptionAlg() {
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public Optional<ClientRegistrationUpdateApiIdTokenEncryptionEnc> idTokenEncryptionEnc() {
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public Optional<ClientRegistrationUpdateApiSubjectType> subjectType() {
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public Optional<ClientRegistrationUpdateApiUserInfoSignAlg> userInfoSignAlg() {
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public Optional<ClientRegistrationUpdateApiUserInfoEncryptionAlg> userInfoEncryptionAlg() {
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public Optional<ClientRegistrationUpdateApiUserInfoEncryptionEnc> userInfoEncryptionEnc() {
     ...
     * this property can be used to register the URLs.
     */
    public Optional<List<ClientRegistrationUpdateApiTosUris>> tosUris() {
     ...
     * If the client application has different policy pages for different languages, this property can be used to register the URLs.
     */
    public Optional<List<ClientRegistrationUpdateApiPolicyUris>> policyUris() {
     ...
     * be used to register the URLs.
     */
    public Optional<List<ClientRegistrationUpdateApiClientUris>> clientUris() {
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public Optional<ClientRegistrationUpdateApiBcRequestSignAlg> bcRequestSignAlg() {
     ...
     * The attributes of this client.
     */
    public Optional<List<ClientRegistrationUpdateApiAttribute>> attributes() {
        return Optional.ofNullable(this.attributes);
    }

    public Optional<ClientRegistrationUpdateApiExtension> extension() {
     ...
     * The client registration types that the client has declared it may use.
     */
    public Optional<List<ClientRegistrationUpdateApiClientRegistrationType>> clientRegistrationTypes() {
     ...
     * the service, and the FAPI modes for the service are set to `null`.
     */
    public Optional<List<ClientRegistrationUpdateApiFapiMode>> fapiModes() {
     ...
     * The response modes that this client may use.
     */
    public Optional<List<ClientRegistrationUpdateApiResponseMode>> responseModes() {
     ...
     * The sequential number of the client. The value of this property is assigned by Authlete.
     */
    public ClientRegistrationUpdateApiClient withNumber(@Nullable Integer number) {
        this.number = number;
        return this;
    }
     ...
     * assigned by Authlete.
     */
    public ClientRegistrationUpdateApiClient withServiceNumber(@Nullable Integer serviceNumber) {
        this.serviceNumber = serviceNumber;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientRegistrationUpdateApiClient withClientName(@Nullable String clientName) {
        this.clientName = clientName;
        return this;
    }
     ...
     * languages, this property can be used to register the names.
     */
    public ClientRegistrationUpdateApiClient withClientNames(@Nullable List<ClientRegistrationUpdateApiClientName> clientNames) {
        this.clientNames = clientNames;
        return this;
    }
     ...
     * The description about the client application.
     */
    public ClientRegistrationUpdateApiClient withDescription(@Nullable String description) {
        this.description = description;
        return this;
    }
     ...
     * descriptions for different languages, this property can be used to register the descriptions.
     */
    public ClientRegistrationUpdateApiClient withDescriptions(@Nullable List<ClientRegistrationUpdateApiDescription> descriptions) {
        this.descriptions = descriptions;
        return this;
    }
     ...
     * The client identifier used in Authlete API calls. The value of this property is assigned by Authlete.
     */
    public ClientRegistrationUpdateApiClient withClientId(@Nullable Long clientId) {
        this.clientId = clientId;
        return this;
    }
     ...
     * authorization server as described in Section 2.3 when making requests to the token endpoint.
     */
    public ClientRegistrationUpdateApiClient withClientSecret(@Nullable String clientSecret) {
        this.clientSecret = clientSecret;
        return this;
    }
     ...
     * default, this is a string version of the `clientId` property.
     */
    public ClientRegistrationUpdateApiClient withClientIdAlias(@Nullable String clientIdAlias) {
        this.clientIdAlias = clientIdAlias;
        return this;
    }
     ...
     * Deprecated. Always set to `true`.
     */
    public ClientRegistrationUpdateApiClient withClientIdAliasEnabled(@Nullable Boolean clientIdAliasEnabled) {
        this.clientIdAliasEnabled = clientIdAliasEnabled;
        return this;
    }
     ...
     * for details.
     */
    public ClientRegistrationUpdateApiClient withClientType(@Nullable ClientRegistrationUpdateApiClientType clientType) {
        this.clientType = clientType;
        return this;
    }
     ...
     * See the description about `redirectUris` property for more details.
     */
    public ClientRegistrationUpdateApiClient withApplicationType(@Nullable ClientRegistrationUpdateApiApplicationType applicationType) {
        this.applicationType = applicationType;
        return this;
    }
     ...
     * Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientRegistrationUpdateApiClient withLogoUri(@Nullable String logoUri) {
        this.logoUri = logoUri;
        return this;
    }
     ...
     * different languages, this property can be used to register URLs of the images.
     */
    public ClientRegistrationUpdateApiClient withLogoUris(@Nullable List<ClientRegistrationUpdateApiLogoUris> logoUris) {
        this.logoUris = logoUris;
        return this;
    }
     ...
     * Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientRegistrationUpdateApiClient withContacts(@Nullable List<String> contacts) {
        this.contacts = contacts;
        return this;
    }
     ...
     * The flag to indicate whether this client use TLS client certificate bound access tokens.
     */
    public ClientRegistrationUpdateApiClient withTlsClientCertificateBoundAccessTokens(@Nullable Boolean tlsClientCertificateBoundAccessTokens) {
        this.tlsClientCertificateBoundAccessTokens = tlsClientCertificateBoundAccessTokens;
        return this;
    }
     ...
     * For more details, see [RFC 7591](https://datatracker.ietf.org/doc/html/rfc7591).
     */
    public ClientRegistrationUpdateApiClient withDynamicallyRegistered(@Nullable Boolean dynamicallyRegistered) {
        this.dynamicallyRegistered = dynamicallyRegistered;
        return this;
    }
     ...
     * of [RFC 7591](https://datatracker.ietf.org/doc/html/rfc7591).
     */
    public ClientRegistrationUpdateApiClient withSoftwareId(@Nullable String softwareId) {
        this.softwareId = softwareId;
        return this;
    }
     ...
     * of [RFC 7591](https://datatracker.ietf.org/doc/html/rfc7591).
     */
    public ClientRegistrationUpdateApiClient withSoftwareVersion(@Nullable String softwareVersion) {
        this.softwareVersion = softwareVersion;
        return this;
    }
     ...
     * The hash of the registration access token for this client.
     */
    public ClientRegistrationUpdateApiClient withRegistrationAccessTokenHash(@Nullable String registrationAccessTokenHash) {
        this.registrationAccessTokenHash = registrationAccessTokenHash;
        return this;
    }
     ...
     * The time at which this client was created. The value is represented as milliseconds since the UNIX epoch (1970-01-01).
     */
    public ClientRegistrationUpdateApiClient withCreatedAt(@Nullable Long createdAt) {
        this.createdAt = createdAt;
        return this;
    }
     ...
     * The time at which this client was last modified. The value is represented as milliseconds since the UNIX epoch (1970-01-01).
     */
    public ClientRegistrationUpdateApiClient withModifiedAt(@Nullable Long modifiedAt) {
        this.modifiedAt = modifiedAt;
        return this;
    }
     ...
     * 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientRegistrationUpdateApiClient withGrantTypes(@Nullable List<ClientRegistrationUpdateApiGrantType> grantTypes) {
        this.grantTypes = grantTypes;
        return this;
    }
     ...
     * 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientRegistrationUpdateApiClient withResponseTypes(@Nullable List<ClientRegistrationUpdateApiResponseType> responseTypes) {
        this.responseTypes = responseTypes;
        return this;
    }
     ...
     * details), but OpenID Connect requires exact match.
     */
    public ClientRegistrationUpdateApiClient withRedirectUris(@Nullable List<String> redirectUris) {
        this.redirectUris = redirectUris;
        return this;
    }
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public ClientRegistrationUpdateApiClient withAuthorizationSignAlg(@Nullable ClientRegistrationUpdateApiAuthorizationSignAlg authorizationSignAlg) {
        this.authorizationSignAlg = authorizationSignAlg;
        return this;
    }
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public ClientRegistrationUpdateApiClient withAuthorizationEncryptionAlg(@Nullable ClientRegistrationUpdateApiAuthorizationEncryptionAlg authorizationEncryptionAlg) {
        this.authorizationEncryptionAlg = authorizationEncryptionAlg;
        return this;
    }
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public ClientRegistrationUpdateApiClient withAuthorizationEncryptionEnc(@Nullable ClientRegistrationUpdateApiAuthorizationEncryptionEnc authorizationEncryptionEnc) {
        this.authorizationEncryptionEnc = authorizationEncryptionEnc;
        return this;
    }
     ...
     * Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientRegistrationUpdateApiClient withTokenAuthMethod(@Nullable ClientRegistrationUpdateApiTokenAuthMethod tokenAuthMethod) {
        this.tokenAuthMethod = tokenAuthMethod;
        return this;
    }
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public ClientRegistrationUpdateApiClient withTokenAuthSignAlg(@Nullable ClientRegistrationUpdateApiTokenAuthSignAlg tokenAuthSignAlg) {
        this.tokenAuthSignAlg = tokenAuthSignAlg;
        return this;
    }
     ...
     * The key ID of a JWK containing a self-signed certificate of this client.
     */
    public ClientRegistrationUpdateApiClient withSelfSignedCertificateKeyId(@Nullable String selfSignedCertificateKeyId) {
        this.selfSignedCertificateKeyId = selfSignedCertificateKeyId;
        return this;
    }
     ...
     * Registration" for details.
     */
    public ClientRegistrationUpdateApiClient withTlsClientAuthSubjectDn(@Nullable String tlsClientAuthSubjectDn) {
        this.tlsClientAuthSubjectDn = tlsClientAuthSubjectDn;
        return this;
    }
     ...
     * Registration" for details.
     */
    public ClientRegistrationUpdateApiClient withTlsClientAuthSanDns(@Nullable String tlsClientAuthSanDns) {
        this.tlsClientAuthSanDns = tlsClientAuthSanDns;
        return this;
    }
     ...
     * Registration" for details.
     */
    public ClientRegistrationUpdateApiClient withTlsClientAuthSanUri(@Nullable String tlsClientAuthSanUri) {
        this.tlsClientAuthSanUri = tlsClientAuthSanUri;
        return this;
    }
     ...
     * Registration" for details.
     */
    public ClientRegistrationUpdateApiClient withTlsClientAuthSanIp(@Nullable String tlsClientAuthSanIp) {
        this.tlsClientAuthSanIp = tlsClientAuthSanIp;
        return this;
    }
     ...
     * Registration" for details.
     */
    public ClientRegistrationUpdateApiClient withTlsClientAuthSanEmail(@Nullable String tlsClientAuthSanEmail) {
        this.tlsClientAuthSanEmail = tlsClientAuthSanEmail;
        return this;
    }
     ...
     * in "OAuth 2.0 Pushed Authorization Requests".
     */
    public ClientRegistrationUpdateApiClient withParRequired(@Nullable Boolean parRequired) {
        this.parRequired = parRequired;
        return this;
    }
     ...
     * client metadata of this client is `true`. The metadata is defined in "JAR (JWT Secured Authorization Request)".
     */
    public ClientRegistrationUpdateApiClient withRequestObjectRequired(@Nullable Boolean requestObjectRequired) {
        this.requestObjectRequired = requestObjectRequired;
        return this;
    }
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public ClientRegistrationUpdateApiClient withRequestSignAlg(@Nullable ClientRegistrationUpdateApiRequestSignAlg requestSignAlg) {
        this.requestSignAlg = requestSignAlg;
        return this;
    }
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public ClientRegistrationUpdateApiClient withRequestEncryptionAlg(@Nullable ClientRegistrationUpdateApiRequestEncryptionAlg requestEncryptionAlg) {
        this.requestEncryptionAlg = requestEncryptionAlg;
        return this;
    }
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public ClientRegistrationUpdateApiClient withRequestEncryptionEnc(@Nullable ClientRegistrationUpdateApiRequestEncryptionEnc requestEncryptionEnc) {
        this.requestEncryptionEnc = requestEncryptionEnc;
        return this;
    }
     ...
     * See [OpenID Connect Core 1.0, 6.2. Passing a Request Object by Reference](https://openid.net/specs/openid-connect-core-1_0.html#RequestUriParameter) for details.
     */
    public ClientRegistrationUpdateApiClient withRequestUris(@Nullable List<String> requestUris) {
        this.requestUris = requestUris;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientRegistrationUpdateApiClient withDefaultMaxAge(@Nullable Integer defaultMaxAge) {
        this.defaultMaxAge = defaultMaxAge;
        return this;
    }
     ...
     * in claims request parameter.
     */
    public ClientRegistrationUpdateApiClient withDefaultAcrs(@Nullable List<String> defaultAcrs) {
        this.defaultAcrs = defaultAcrs;
        return this;
    }
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public ClientRegistrationUpdateApiClient withIdTokenSignAlg(@Nullable ClientRegistrationUpdateApiIdTokenSignAlg idTokenSignAlg) {
        this.idTokenSignAlg = idTokenSignAlg;
        return this;
    }
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public ClientRegistrationUpdateApiClient withIdTokenEncryptionAlg(@Nullable ClientRegistrationUpdateApiIdTokenEncryptionAlg idTokenEncryptionAlg) {
        this.idTokenEncryptionAlg = idTokenEncryptionAlg;
        return this;
    }
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public ClientRegistrationUpdateApiClient withIdTokenEncryptionEnc(@Nullable ClientRegistrationUpdateApiIdTokenEncryptionEnc idTokenEncryptionEnc) {
        this.idTokenEncryptionEnc = idTokenEncryptionEnc;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientRegistrationUpdateApiClient withAuthTimeRequired(@Nullable Boolean authTimeRequired) {
        this.authTimeRequired = authTimeRequired;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientRegistrationUpdateApiClient withSubjectType(@Nullable ClientRegistrationUpdateApiSubjectType subjectType) {
        this.subjectType = subjectType;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata)
     */
    public ClientRegistrationUpdateApiClient withSectorIdentifierUri(@Nullable String sectorIdentifierUri) {
        this.sectorIdentifierUri = sectorIdentifierUri;
        return this;
    }
     ...
     * are also registered, the value of this property is `null`.
     */
    public ClientRegistrationUpdateApiClient withDerivedSectorIdentifier(@Nullable String derivedSectorIdentifier) {
        this.derivedSectorIdentifier = derivedSectorIdentifier;
        return this;
    }
     ...
     * Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientRegistrationUpdateApiClient withJwksUri(@Nullable String jwksUri) {
        this.jwksUri = jwksUri;
        return this;
    }
     ...
     * Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientRegistrationUpdateApiClient withJwks(@Nullable String jwks) {
        this.jwks = jwks;
        return this;
    }
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public ClientRegistrationUpdateApiClient withUserInfoSignAlg(@Nullable ClientRegistrationUpdateApiUserInfoSignAlg userInfoSignAlg) {
        this.userInfoSignAlg = userInfoSignAlg;
        return this;
    }
     ...
     * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
     */
    public ClientRegistrationUpdateApiClient withUserInfoEncryptionAlg(@Nullable ClientRegistrationUpdateApiUserInfoEncryptionAlg userInfoEncryptionAlg) {
        this.userInfoEncryptionAlg = userInfoEncryptionAlg;
        return this;
    }
     ...
     *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
     */
    public ClientRegistrationUpdateApiClient withUserInfoEncryptionEnc(@Nullable ClientRegistrationUpdateApiUserInfoEncryptionEnc userInfoEncryptionEnc) {
        this.userInfoEncryptionEnc = userInfoEncryptionEnc;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientRegistrationUpdateApiClient withLoginUri(@Nullable String loginUri) {
        this.loginUri = loginUri;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientRegistrationUpdateApiClient withTosUri(@Nullable String tosUri) {
        this.tosUri = tosUri;
        return this;
    }
     ...
     * this property can be used to register the URLs.
     */
    public ClientRegistrationUpdateApiClient withTosUris(@Nullable List<ClientRegistrationUpdateApiTosUris> tosUris) {
        this.tosUris = tosUris;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientRegistrationUpdateApiClient withPolicyUri(@Nullable String policyUri) {
        this.policyUri = policyUri;
        return this;
    }
     ...
     * If the client application has different policy pages for different languages, this property can be used to register the URLs.
     */
    public ClientRegistrationUpdateApiClient withPolicyUris(@Nullable List<ClientRegistrationUpdateApiPolicyUris> policyUris) {
        this.policyUris = policyUris;
        return this;
    }
     ...
     * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
     */
    public ClientRegistrationUpdateApiClient withClientUri(@Nullable String clientUri) {
        this.clientUri = clientUri;
        return this;
    }
     ...
     * be used to register the URLs.
     */
    public ClientRegistrationUpdateApiClient withClientUris(@Nullable List<ClientRegistrationUpdateApiClientUris> clientUris) {
        this.clientUris = clientUris;
        return this;
    }
     ...
     * Backchannel Authentication)".
     */
    public ClientRegistrationUpdateApiClient withBcDeliveryMode(@Nullable String bcDeliveryMode) {
        this.bcDeliveryMode = bcDeliveryMode;
        return this;
    }
     ...
     * Backchannel Authentication)".
     */
    public ClientRegistrationUpdateApiClient withBcNotificationEndpoint(@Nullable String bcNotificationEndpoint) {
        this.bcNotificationEndpoint = bcNotificationEndpoint;
        return this;
    }
     ...
     *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
     */
    public ClientRegistrationUpdateApiClient withBcRequestSignAlg(@Nullable ClientRegistrationUpdateApiBcRequestSignAlg bcRequestSignAlg) {
        this.bcRequestSignAlg = bcRequestSignAlg;
        return this;
    }
     ...
     * <p>This property corresponds to the `backchannel_user_code_parameter` metadata.
     */
    public ClientRegistrationUpdateApiClient withBcUserCodeRequired(@Nullable Boolean bcUserCodeRequired) {
        this.bcUserCodeRequired = bcUserCodeRequired;
        return this;
    }
     ...
     * The attributes of this client.
     */
    public ClientRegistrationUpdateApiClient withAttributes(@Nullable List<ClientRegistrationUpdateApiAttribute> attributes) {
        this.attributes = attributes;
        return this;
    }


    public ClientRegistrationUpdateApiClient withExtension(@Nullable ClientRegistrationUpdateApiExtension extension) {
        this.extension = extension;
        return this;
    }
     ...
     * to align with the change made by the 5th draft of the RAR specification.
     */
    public ClientRegistrationUpdateApiClient withAuthorizationDetailsTypes(@Nullable List<String> authorizationDetailsTypes) {
        this.authorizationDetailsTypes = authorizationDetailsTypes;
        return this;
    }
     ...
     * custom client metadata values can be referenced by this property.
     */
    public ClientRegistrationUpdateApiClient withCustomMetadata(@Nullable String customMetadata) {
        this.customMetadata = customMetadata;
        return this;
    }
     ...
     * flag of the service is `true`.
     */
    public ClientRegistrationUpdateApiClient withFrontChannelRequestObjectEncryptionRequired(@Nullable Boolean frontChannelRequestObjectEncryptionRequired) {
        this.frontChannelRequestObjectEncryptionRequired = frontChannelRequestObjectEncryptionRequired;
        return this;
    }
     ...
     * flag of the service is `true`.
     */
    public ClientRegistrationUpdateApiClient withRequestObjectEncryptionAlgMatchRequired(@Nullable Boolean requestObjectEncryptionAlgMatchRequired) {
        this.requestObjectEncryptionAlgMatchRequired = requestObjectEncryptionAlgMatchRequired;
        return this;
    }
     ...
     * flag of the service is `true`.
     */
    public ClientRegistrationUpdateApiClient withRequestObjectEncryptionEncMatchRequired(@Nullable Boolean requestObjectEncryptionEncMatchRequired) {
        this.requestObjectEncryptionEncMatchRequired = requestObjectEncryptionEncMatchRequired;
        return this;
    }
     ...
     * [OpenID Connect for Identity Assurance 1.0](https://openid.net/specs/openid-connect-4-identity-assurance-1_0.html).
     */
    public ClientRegistrationUpdateApiClient withDigestAlgorithm(@Nullable String digestAlgorithm) {
        this.digestAlgorithm = digestAlgorithm;
        return this;
    }
     ...
     * <p>Even if `Disabled` is selected here, single access token per subject is effective if `singleAccessTokenPerSubject` of the `Service` this client belongs to is Enabled.
     */
    public ClientRegistrationUpdateApiClient withSingleAccessTokenPerSubject(@Nullable Boolean singleAccessTokenPerSubject) {
        this.singleAccessTokenPerSubject = singleAccessTokenPerSubject;
        return this;
    }
     ...
     * <p>See [RFC 7636](https://tools.ietf.org/html/rfc7636) (Proof Key for Code Exchange by OAuth Public Clients) for details about `code_challenge` request parameter.
     */
    public ClientRegistrationUpdateApiClient withPkceRequired(@Nullable Boolean pkceRequired) {
        this.pkceRequired = pkceRequired;
        return this;
    }
     ...
     * Neither omission of the `code_challenge_method` request parameter nor use of plain (`code_challenge_method=plain`) is allowed.
     */
    public ClientRegistrationUpdateApiClient withPkceS256Required(@Nullable Boolean pkceS256Required) {
        this.pkceS256Required = pkceS256Required;
        return this;
    }
     ...
     * If the DPoP is required for this client
     */
    public ClientRegistrationUpdateApiClient withDpopRequired(@Nullable Boolean dpopRequired) {
        this.dpopRequired = dpopRequired;
        return this;
    }
     ...
     * "automatic" client registration of OIDC Federation.
     */
    public ClientRegistrationUpdateApiClient withAutomaticallyRegistered(@Nullable Boolean automaticallyRegistered) {
        this.automaticallyRegistered = automaticallyRegistered;
        return this;
    }
     ...
     * "explicit" client registration of OIDC Federation.
     */
    public ClientRegistrationUpdateApiClient withExplicitlyRegistered(@Nullable Boolean explicitlyRegistered) {
        this.explicitlyRegistered = explicitlyRegistered;
        return this;
    }
     ...
     * The flag indicating whether this service signs responses from the resource server.
     */
    public ClientRegistrationUpdateApiClient withRsRequestSigned(@Nullable Boolean rsRequestSigned) {
        this.rsRequestSigned = rsRequestSigned;
        return this;
    }
     ...
     * The key ID of a JWK containing the public key used by this client to sign requests to the resource server.
     */
    public ClientRegistrationUpdateApiClient withRsSignedRequestKeyId(@Nullable String rsSignedRequestKeyId) {
        this.rsSignedRequestKeyId = rsSignedRequestKeyId;
        return this;
    }
     ...
     * The client registration types that the client has declared it may use.
     */
    public ClientRegistrationUpdateApiClient withClientRegistrationTypes(@Nullable List<ClientRegistrationUpdateApiClientRegistrationType> clientRegistrationTypes) {
        this.clientRegistrationTypes = clientRegistrationTypes;
        return this;
    }
     ...
     * to the organization_name client metadata that is defined in OpenID Connect Federation 1.0.
     */
    public ClientRegistrationUpdateApiClient withOrganizationName(@Nullable String organizationName) {
        this.organizationName = organizationName;
        return this;
    }
     ...
     * corresponds to the `signed_jwks_uri` client metadata defined in OpenID Connect Federation 1.0.
     */
    public ClientRegistrationUpdateApiClient withSignedJwksUri(@Nullable String signedJwksUri) {
        this.signedJwksUri = signedJwksUri;
        return this;
    }
     ...
     * the entity ID of this client.
     */
    public ClientRegistrationUpdateApiClient withEntityId(@Nullable String entityId) {
        this.entityId = entityId;
        return this;
    }
     ...
     * the mechanism defined in OpenID Connect Federation 1.0
     */
    public ClientRegistrationUpdateApiClient withTrustAnchorId(@Nullable String trustAnchorId) {
        this.trustAnchorId = trustAnchorId;
        return this;
    }
     ...
     * OpenID Connect Federation 1.0
     */
    public ClientRegistrationUpdateApiClient withTrustChain(@Nullable List<String> trustChain) {
        this.trustChain = trustChain;
        return this;
    }
     ...
     * defined in OpenID Connect Federation 1.0. The value is represented as milliseconds elapsed since the Unix epoch (1970-01-01).
     */
    public ClientRegistrationUpdateApiClient withTrustChainExpiresAt(@Nullable Long trustChainExpiresAt) {
        this.trustChainExpiresAt = trustChainExpiresAt;
        return this;
    }
     ...
     * the time at which the trust chain was updated by the mechanism defined in OpenID Connect Federation 1.0
     */
    public ClientRegistrationUpdateApiClient withTrustChainUpdatedAt(@Nullable Long trustChainUpdatedAt) {
        this.trustChainUpdatedAt = trustChainUpdatedAt;
        return this;
    }
     ...
     * The flag which indicates whether this client is locked.
     */
    public ClientRegistrationUpdateApiClient withLocked(@Nullable Boolean locked) {
        this.locked = locked;
        return this;
    }
     ...
     * (wallet) receives a credential offer from the credential issuer.
     */
    public ClientRegistrationUpdateApiClient withCredentialOfferEndpoint(@Nullable String credentialOfferEndpoint) {
        this.credentialOfferEndpoint = credentialOfferEndpoint;
        return this;
    }
     ...
     * the service, and the FAPI modes for the service are set to `null`.
     */
    public ClientRegistrationUpdateApiClient withFapiModes(@Nullable List<ClientRegistrationUpdateApiFapiMode> fapiModes) {
        this.fapiModes = fapiModes;
        return this;
    }
     ...
     * The response modes that this client may use.
     */
    public ClientRegistrationUpdateApiClient withResponseModes(@Nullable List<ClientRegistrationUpdateApiResponseMode> responseModes) {
        this.responseModes = responseModes;
        return this;
    }
     ...
     * True if credential responses to this client must be always encrypted.
     */
    public ClientRegistrationUpdateApiClient withCredentialResponseEncryptionRequired(@Nullable Boolean credentialResponseEncryptionRequired) {
        this.credentialResponseEncryptionRequired = credentialResponseEncryptionRequired;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClientRegistrationUpdateApiClient other = (ClientRegistrationUpdateApiClient) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ClientRegistrationUpdateApiClient.class,
                "number", number,
    ...
    public final static class Builder {
         ...
         * languages, this property can be used to register the names.
         */
        public Builder clientNames(@Nullable List<ClientRegistrationUpdateApiClientName> clientNames) {
            this.clientNames = clientNames;
            return this;
        }
         ...
         * descriptions for different languages, this property can be used to register the descriptions.
         */
        public Builder descriptions(@Nullable List<ClientRegistrationUpdateApiDescription> descriptions) {
            this.descriptions = descriptions;
            return this;
        }
         ...
         * for details.
         */
        public Builder clientType(@Nullable ClientRegistrationUpdateApiClientType clientType) {
            this.clientType = clientType;
            return this;
        }
         ...
         * See the description about `redirectUris` property for more details.
         */
        public Builder applicationType(@Nullable ClientRegistrationUpdateApiApplicationType applicationType) {
            this.applicationType = applicationType;
            return this;
        }
         ...
         * different languages, this property can be used to register URLs of the images.
         */
        public Builder logoUris(@Nullable List<ClientRegistrationUpdateApiLogoUris> logoUris) {
            this.logoUris = logoUris;
            return this;
        }
         ...
         * 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
         */
        public Builder grantTypes(@Nullable List<ClientRegistrationUpdateApiGrantType> grantTypes) {
            this.grantTypes = grantTypes;
            return this;
        }
         ...
         * 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
         */
        public Builder responseTypes(@Nullable List<ClientRegistrationUpdateApiResponseType> responseTypes) {
            this.responseTypes = responseTypes;
            return this;
        }
         ...
         *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
         */
        public Builder authorizationSignAlg(@Nullable ClientRegistrationUpdateApiAuthorizationSignAlg authorizationSignAlg) {
            this.authorizationSignAlg = authorizationSignAlg;
            return this;
        }
         ...
         * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
         */
        public Builder authorizationEncryptionAlg(@Nullable ClientRegistrationUpdateApiAuthorizationEncryptionAlg authorizationEncryptionAlg) {
            this.authorizationEncryptionAlg = authorizationEncryptionAlg;
            return this;
        }
         ...
         *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
         */
        public Builder authorizationEncryptionEnc(@Nullable ClientRegistrationUpdateApiAuthorizationEncryptionEnc authorizationEncryptionEnc) {
            this.authorizationEncryptionEnc = authorizationEncryptionEnc;
            return this;
        }
         ...
         * Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
         */
        public Builder tokenAuthMethod(@Nullable ClientRegistrationUpdateApiTokenAuthMethod tokenAuthMethod) {
            this.tokenAuthMethod = tokenAuthMethod;
            return this;
        }
         ...
         *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
         */
        public Builder tokenAuthSignAlg(@Nullable ClientRegistrationUpdateApiTokenAuthSignAlg tokenAuthSignAlg) {
            this.tokenAuthSignAlg = tokenAuthSignAlg;
            return this;
        }
         ...
         *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
         */
        public Builder requestSignAlg(@Nullable ClientRegistrationUpdateApiRequestSignAlg requestSignAlg) {
            this.requestSignAlg = requestSignAlg;
            return this;
        }
         ...
         * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
         */
        public Builder requestEncryptionAlg(@Nullable ClientRegistrationUpdateApiRequestEncryptionAlg requestEncryptionAlg) {
            this.requestEncryptionAlg = requestEncryptionAlg;
            return this;
        }
         ...
         *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
         */
        public Builder requestEncryptionEnc(@Nullable ClientRegistrationUpdateApiRequestEncryptionEnc requestEncryptionEnc) {
            this.requestEncryptionEnc = requestEncryptionEnc;
            return this;
        }
         ...
         *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
         */
        public Builder idTokenSignAlg(@Nullable ClientRegistrationUpdateApiIdTokenSignAlg idTokenSignAlg) {
            this.idTokenSignAlg = idTokenSignAlg;
            return this;
        }
         ...
         * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
         */
        public Builder idTokenEncryptionAlg(@Nullable ClientRegistrationUpdateApiIdTokenEncryptionAlg idTokenEncryptionAlg) {
            this.idTokenEncryptionAlg = idTokenEncryptionAlg;
            return this;
        }
         ...
         *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
         */
        public Builder idTokenEncryptionEnc(@Nullable ClientRegistrationUpdateApiIdTokenEncryptionEnc idTokenEncryptionEnc) {
            this.idTokenEncryptionEnc = idTokenEncryptionEnc;
            return this;
        }
         ...
         * [OpenID Connect Dynamic Client Registration 1.0, 2. Client Metadata](https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata).
         */
        public Builder subjectType(@Nullable ClientRegistrationUpdateApiSubjectType subjectType) {
            this.subjectType = subjectType;
            return this;
        }
         ...
         *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
         */
        public Builder userInfoSignAlg(@Nullable ClientRegistrationUpdateApiUserInfoSignAlg userInfoSignAlg) {
            this.userInfoSignAlg = userInfoSignAlg;
            return this;
        }
         ...
         * <p>**Please note that some of the algorithms are more secure than others, some are not supported very well cross platforms and some (like RSA1_5) is known to be weak**.
         */
        public Builder userInfoEncryptionAlg(@Nullable ClientRegistrationUpdateApiUserInfoEncryptionAlg userInfoEncryptionAlg) {
            this.userInfoEncryptionAlg = userInfoEncryptionAlg;
            return this;
        }
         ...
         *   - as `idTokenEncryptionEnc` value, it refers to the algorithm used by the server to encrypt id_tokens
         */
        public Builder userInfoEncryptionEnc(@Nullable ClientRegistrationUpdateApiUserInfoEncryptionEnc userInfoEncryptionEnc) {
            this.userInfoEncryptionEnc = userInfoEncryptionEnc;
            return this;
        }
         ...
         * this property can be used to register the URLs.
         */
        public Builder tosUris(@Nullable List<ClientRegistrationUpdateApiTosUris> tosUris) {
            this.tosUris = tosUris;
            return this;
        }
         ...
         * If the client application has different policy pages for different languages, this property can be used to register the URLs.
         */
        public Builder policyUris(@Nullable List<ClientRegistrationUpdateApiPolicyUris> policyUris) {
            this.policyUris = policyUris;
            return this;
        }
         ...
         * be used to register the URLs.
         */
        public Builder clientUris(@Nullable List<ClientRegistrationUpdateApiClientUris> clientUris) {
            this.clientUris = clientUris;
            return this;
        }
         ...
         *   - or as client requestSignAlg value, it specifies which is the expected signature used by [client on a Request Object](https://kb.authlete.com/en/s/oauth-and-openid-connect/a/request-objects).
         */
        public Builder bcRequestSignAlg(@Nullable ClientRegistrationUpdateApiBcRequestSignAlg bcRequestSignAlg) {
            this.bcRequestSignAlg = bcRequestSignAlg;
            return this;
        }
         ...
         * The attributes of this client.
         */
        public Builder attributes(@Nullable List<ClientRegistrationUpdateApiAttribute> attributes) {
            this.attributes = attributes;
            return this;
        }

        public Builder extension(@Nullable ClientRegistrationUpdateApiExtension extension) {
            this.extension = extension;
            return this;
        }
         ...
         * The client registration types that the client has declared it may use.
         */
        public Builder clientRegistrationTypes(@Nullable List<ClientRegistrationUpdateApiClientRegistrationType> clientRegistrationTypes) {
            this.clientRegistrationTypes = clientRegistrationTypes;
            return this;
        }
         ...
         * the service, and the FAPI modes for the service are set to `null`.
         */
        public Builder fapiModes(@Nullable List<ClientRegistrationUpdateApiFapiMode> fapiModes) {
            this.fapiModes = fapiModes;
            return this;
        }
         ...
         * The response modes that this client may use.
         */
        public Builder responseModes(@Nullable List<ClientRegistrationUpdateApiResponseMode> responseModes) {
            this.responseModes = responseModes;
            return this;
        }
        ...
        public ClientRegistrationUpdateApiClient build() {
            return new ClientRegistrationUpdateApiClient(
                number, serviceNumber, clientName,
                clientNames, description, descriptions,
                clientId, clientSecret, clientIdAlias,
                clientIdAliasEnabled, clientType, applicationType,
