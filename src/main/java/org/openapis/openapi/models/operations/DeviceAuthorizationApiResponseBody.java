...
public class DeviceAuthorizationApiResponseBody {
    /**
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("action")
    private DeviceAuthorizationApiAction action;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("scopes")
    private List<DeviceAuthorizationApiScope> scopes;
    ...
    private DeviceAuthorizationApiAuthorizationDetails authorizationDetails;
    ...
    private List<DeviceAuthorizationApiServiceAttribute> serviceAttributes;
    ...
    private List<DeviceAuthorizationApiClientAttribute> clientAttributes;
    ...
    private List<DeviceAuthorizationApiDynamicScope> dynamicScopes;
    ...
    private DeviceAuthorizationApiGmAction gmAction;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("grant")
    private DeviceAuthorizationApiGrant grant;
    ...
    public DeviceAuthorizationApiResponseBody(
            ...
            @JsonProperty("scopes") @Nullable List<DeviceAuthorizationApiScope> scopes,
            ...
            @JsonProperty("authorizationDetails") @Nullable DeviceAuthorizationApiAuthorizationDetails authorizationDetails,
            @JsonProperty("serviceAttributes") @Nullable List<DeviceAuthorizationApiServiceAttribute> serviceAttributes,
            @JsonProperty("clientAttributes") @Nullable List<DeviceAuthorizationApiClientAttribute> clientAttributes,
            @JsonProperty("dynamicScopes") @Nullable List<DeviceAuthorizationApiDynamicScope> dynamicScopes,
            @JsonProperty("gmAction") @Nullable DeviceAuthorizationApiGmAction gmAction,
            @JsonProperty("grantId") @Nullable String grantId,
            @JsonProperty("grant") @Nullable DeviceAuthorizationApiGrant grant,
     ...
     * The next action that the authorization server implementation should take.
     */
    public Optional<DeviceAuthorizationApiAction> action() {
     ...
     * are registered.
     */
    public Optional<List<DeviceAuthorizationApiScope>> scopes() {
     ...
     * "OAuth 2.0 Rich Authorization Requests".
     */
    public Optional<DeviceAuthorizationApiAuthorizationDetails> authorizationDetails() {
     ...
     * The attributes of this service that the client application belongs to.
     */
    public Optional<List<DeviceAuthorizationApiServiceAttribute>> serviceAttributes() {
     ...
     * The attributes of the client.
     */
    public Optional<List<DeviceAuthorizationApiClientAttribute>> clientAttributes() {
     ...
     * The dynamic scopes which the client application requested by the scope request parameter.
     */
    public Optional<List<DeviceAuthorizationApiDynamicScope>> dynamicScopes() {
     ...
     * [Grant Management for OAuth 2.0](https://openid.net/specs/fapi-grant-management.html).
     */
    public Optional<DeviceAuthorizationApiGmAction> gmAction() {
    ...
    public Optional<DeviceAuthorizationApiGrant> grant() {
     ...
     * The code which represents the result of the API call.
     */
    public DeviceAuthorizationApiResponseBody withResultCode(@Nullable String resultCode) {
        this.resultCode = resultCode;
        return this;
    }
     ...
     * A short message which explains the result of the API call.
     */
    public DeviceAuthorizationApiResponseBody withResultMessage(@Nullable String resultMessage) {
        this.resultMessage = resultMessage;
        return this;
    }
     ...
     * The next action that the authorization server implementation should take.
     */
    public DeviceAuthorizationApiResponseBody withAction(@Nullable DeviceAuthorizationApiAction action) {
        this.action = action;
        return this;
    }
     ...
     * application. Its format varies depending on the value of `action` parameter.
     */
    public DeviceAuthorizationApiResponseBody withResponseContent(@Nullable String responseContent) {
        this.responseContent = responseContent;
        return this;
    }
     ...
     * The client ID of the client application that has made the device authorization request.
     */
    public DeviceAuthorizationApiResponseBody withClientId(@Nullable Long clientId) {
        this.clientId = clientId;
        return this;
    }
     ...
     * request.
     */
    public DeviceAuthorizationApiResponseBody withClientIdAlias(@Nullable String clientIdAlias) {
        this.clientIdAlias = clientIdAlias;
        return this;
    }
     ...
     * request is the client ID alias. `false` if the value is the original numeric client ID.
     */
    public DeviceAuthorizationApiResponseBody withClientIdAliasUsed(@Nullable Boolean clientIdAliasUsed) {
        this.clientIdAliasUsed = clientIdAliasUsed;
        return this;
    }
     ...
     * The name of the client application which has made the device authorization request.
     */
    public DeviceAuthorizationApiResponseBody withClientName(@Nullable String clientName) {
        this.clientName = clientName;
        return this;
    }
     ...
     * endpoint.
     */
    public DeviceAuthorizationApiResponseBody withClientAuthMethod(@Nullable String clientAuthMethod) {
        this.clientAuthMethod = clientAuthMethod;
        return this;
    }
     ...
     * are registered.
     */
    public DeviceAuthorizationApiResponseBody withScopes(@Nullable List<DeviceAuthorizationApiScope> scopes) {
        this.scopes = scopes;
        return this;
    }
     ...
     * in OpenID Connect Core 1.0 for details.
     */
    public DeviceAuthorizationApiResponseBody withClaimNames(@Nullable List<String> claimNames) {
        this.claimNames = claimNames;
        return this;
    }
     ...
     * request parameter.
     */
    public DeviceAuthorizationApiResponseBody withAcrs(@Nullable List<String> acrs) {
        this.acrs = acrs;
        return this;
    }
     ...
     * response to the client.
     */
    public DeviceAuthorizationApiResponseBody withDeviceCode(@Nullable String deviceCode) {
        this.deviceCode = deviceCode;
        return this;
    }
     ...
     * response to the client.
     */
    public DeviceAuthorizationApiResponseBody withUserCode(@Nullable String userCode) {
        this.userCode = userCode;
        return this;
    }
     ...
     * the response to the client.
     */
    public DeviceAuthorizationApiResponseBody withVerificationUri(@Nullable String verificationUri) {
        this.verificationUri = verificationUri;
        return this;
    }
     ...
     * to the `verification_uri_complete` property in the response to the client.
     */
    public DeviceAuthorizationApiResponseBody withVerificationUriComplete(@Nullable String verificationUriComplete) {
        this.verificationUriComplete = verificationUriComplete;
        return this;
    }
     ...
     * property in the response to the client.
     */
    public DeviceAuthorizationApiResponseBody withExpiresIn(@Nullable Integer expiresIn) {
        this.expiresIn = expiresIn;
        return this;
    }
     ...
     * to the client.
     */
    public DeviceAuthorizationApiResponseBody withInterval(@Nullable Integer interval) {
        this.interval = interval;
        return this;
    }
     ...
     * The warnings raised during processing the backchannel authentication request.
     */
    public DeviceAuthorizationApiResponseBody withWarnings(@Nullable List<String> warnings) {
        this.warnings = warnings;
        return this;
    }
     ...
     * for OAuth 2.0" for details.
     */
    public DeviceAuthorizationApiResponseBody withResources(@Nullable List<String> resources) {
        this.resources = resources;
        return this;
    }
     ...
     * "OAuth 2.0 Rich Authorization Requests".
     */
    public DeviceAuthorizationApiResponseBody withAuthorizationDetails(@Nullable DeviceAuthorizationApiAuthorizationDetails authorizationDetails) {
        this.authorizationDetails = authorizationDetails;
        return this;
    }
     ...
     * The attributes of this service that the client application belongs to.
     */
    public DeviceAuthorizationApiResponseBody withServiceAttributes(@Nullable List<DeviceAuthorizationApiServiceAttribute> serviceAttributes) {
        this.serviceAttributes = serviceAttributes;
        return this;
    }
     ...
     * The attributes of the client.
     */
    public DeviceAuthorizationApiResponseBody withClientAttributes(@Nullable List<DeviceAuthorizationApiClientAttribute> clientAttributes) {
        this.clientAttributes = clientAttributes;
        return this;
    }
     ...
     * The dynamic scopes which the client application requested by the scope request parameter.
     */
    public DeviceAuthorizationApiResponseBody withDynamicScopes(@Nullable List<DeviceAuthorizationApiDynamicScope> dynamicScopes) {
        this.dynamicScopes = dynamicScopes;
        return this;
    }
     ...
     * [Grant Management for OAuth 2.0](https://openid.net/specs/fapi-grant-management.html).
     */
    public DeviceAuthorizationApiResponseBody withGmAction(@Nullable DeviceAuthorizationApiGmAction gmAction) {
        this.gmAction = gmAction;
        return this;
    }
     ...
     * , which is supported by Authlete 2.3 and newer versions.
     */
    public DeviceAuthorizationApiResponseBody withGrantId(@Nullable String grantId) {
        this.grantId = grantId;
        return this;
    }


    public DeviceAuthorizationApiResponseBody withGrant(@Nullable DeviceAuthorizationApiGrant grant) {
        this.grant = grant;
        return this;
    }
     ...
     * user of the grant.
     */
    public DeviceAuthorizationApiResponseBody withGrantSubject(@Nullable String grantSubject) {
        this.grantSubject = grantSubject;
        return this;
    }
     ...
     * The entity ID of the client.
     */
    public DeviceAuthorizationApiResponseBody withClientEntityId(@Nullable String clientEntityId) {
        this.clientEntityId = clientEntityId;
        return this;
    }
     ...
     * Flag which indicates whether the entity ID of the client was used when the request for the access token was made.
     */
    public DeviceAuthorizationApiResponseBody withClientEntityIdUsed(@Nullable Boolean clientEntityIdUsed) {
        this.clientEntityIdUsed = clientEntityIdUsed;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DeviceAuthorizationApiResponseBody other = (DeviceAuthorizationApiResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DeviceAuthorizationApiResponseBody.class,
    ...
    public final static class Builder {
         ...
         * The next action that the authorization server implementation should take.
         */
        public Builder action(@Nullable DeviceAuthorizationApiAction action) {
            this.action = action;
            return this;
        }
         ...
         * are registered.
         */
        public Builder scopes(@Nullable List<DeviceAuthorizationApiScope> scopes) {
            this.scopes = scopes;
            return this;
        }
         ...
         * "OAuth 2.0 Rich Authorization Requests".
         */
        public Builder authorizationDetails(@Nullable DeviceAuthorizationApiAuthorizationDetails authorizationDetails) {
            this.authorizationDetails = authorizationDetails;
            return this;
        }
         ...
         * The attributes of this service that the client application belongs to.
         */
        public Builder serviceAttributes(@Nullable List<DeviceAuthorizationApiServiceAttribute> serviceAttributes) {
            this.serviceAttributes = serviceAttributes;
            return this;
        }
         ...
         * The attributes of the client.
         */
        public Builder clientAttributes(@Nullable List<DeviceAuthorizationApiClientAttribute> clientAttributes) {
            this.clientAttributes = clientAttributes;
            return this;
        }
         ...
         * The dynamic scopes which the client application requested by the scope request parameter.
         */
        public Builder dynamicScopes(@Nullable List<DeviceAuthorizationApiDynamicScope> dynamicScopes) {
            this.dynamicScopes = dynamicScopes;
            return this;
        }
         ...
         * [Grant Management for OAuth 2.0](https://openid.net/specs/fapi-grant-management.html).
         */
        public Builder gmAction(@Nullable DeviceAuthorizationApiGmAction gmAction) {
            this.gmAction = gmAction;
            return this;
        }
        ...
        public Builder grant(@Nullable DeviceAuthorizationApiGrant grant) {
            this.grant = grant;
            return this;
        }
        ...
        public DeviceAuthorizationApiResponseBody build() {
            return new DeviceAuthorizationApiResponseBody(
                resultCode, resultMessage, action,
                responseContent, clientId, clientIdAlias,
                clientIdAliasUsed, clientName, clientAuthMethod,
                scopes, claimNames, acrs,
