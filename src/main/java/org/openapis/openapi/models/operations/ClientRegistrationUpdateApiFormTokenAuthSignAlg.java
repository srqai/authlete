 ...
 */
public enum ClientRegistrationUpdateApiFormTokenAuthSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientRegistrationUpdateApiFormTokenAuthSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationUpdateApiFormTokenAuthSignAlg> fromValue(String value) {
        for (ClientRegistrationUpdateApiFormTokenAuthSignAlg o: ClientRegistrationUpdateApiFormTokenAuthSignAlg.values()) {
