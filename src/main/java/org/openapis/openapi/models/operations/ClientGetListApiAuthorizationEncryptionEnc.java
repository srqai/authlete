 ...
 */
public enum ClientGetListApiAuthorizationEncryptionEnc {
    ...
    ClientGetListApiAuthorizationEncryptionEnc(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientGetListApiAuthorizationEncryptionEnc> fromValue(String value) {
        for (ClientGetListApiAuthorizationEncryptionEnc o: ClientGetListApiAuthorizationEncryptionEnc.values()) {
