 ...
 */
public enum ClientUpdateApiIdTokenEncryptionAlgResponse {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientUpdateApiIdTokenEncryptionAlgResponse(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientUpdateApiIdTokenEncryptionAlgResponse> fromValue(String value) {
        for (ClientUpdateApiIdTokenEncryptionAlgResponse o: ClientUpdateApiIdTokenEncryptionAlgResponse.values()) {
