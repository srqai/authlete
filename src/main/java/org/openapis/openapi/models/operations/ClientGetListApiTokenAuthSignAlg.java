 ...
 */
public enum ClientGetListApiTokenAuthSignAlg {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ClientGetListApiTokenAuthSignAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientGetListApiTokenAuthSignAlg> fromValue(String value) {
        for (ClientGetListApiTokenAuthSignAlg o: ClientGetListApiTokenAuthSignAlg.values()) {
