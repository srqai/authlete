...
public class VciOfferInfoApiProperty {
    /**
     * The key part.
     */
    ...
    @JsonCreator
    public VciOfferInfoApiProperty(
     ...
     * The key part.
     */
    public VciOfferInfoApiProperty withKey(@Nullable String key) {
        this.key = key;
        return this;
    }
     ...
     * The value part.
     */
    public VciOfferInfoApiProperty withValue(@Nullable String value) {
        this.value = value;
        return this;
    }
     ...
     * If `true`, this property is hidden from client applications. Otherwise, this property is visible to client applications.
     */
    public VciOfferInfoApiProperty withHidden(@Nullable Boolean hidden) {
        this.hidden = hidden;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        VciOfferInfoApiProperty other = (VciOfferInfoApiProperty) o;
        return 
    ...
    public String toString() {
        return Utils.toString(VciOfferInfoApiProperty.class,
                "key", key,
                "value", value,
                "hidden", hidden);
    }
    ...
    public final static class Builder {
        ...
        public VciOfferInfoApiProperty build() {
            return new VciOfferInfoApiProperty(
                key, value, hidden);
        }
