 ...
 */
public enum FederationRegistrationApiUserInfoEncryptionAlg {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    FederationRegistrationApiUserInfoEncryptionAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<FederationRegistrationApiUserInfoEncryptionAlg> fromValue(String value) {
        for (FederationRegistrationApiUserInfoEncryptionAlg o: FederationRegistrationApiUserInfoEncryptionAlg.values()) {
