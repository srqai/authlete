 ...
 */
public enum FederationRegistrationApiFormRequestEncryptionAlg {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    FederationRegistrationApiFormRequestEncryptionAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<FederationRegistrationApiFormRequestEncryptionAlg> fromValue(String value) {
        for (FederationRegistrationApiFormRequestEncryptionAlg o: FederationRegistrationApiFormRequestEncryptionAlg.values()) {
