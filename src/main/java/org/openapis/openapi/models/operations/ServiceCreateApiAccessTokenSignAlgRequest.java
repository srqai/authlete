 ...
 */
public enum ServiceCreateApiAccessTokenSignAlgRequest {
    NONE("NONE"),
    HS256("HS256"),
    HS384("HS384"),
    HS512("HS512"),
    ...
    ServiceCreateApiAccessTokenSignAlgRequest(String value) {
        this.value = value;
    }
    ...
    public static Optional<ServiceCreateApiAccessTokenSignAlgRequest> fromValue(String value) {
        for (ServiceCreateApiAccessTokenSignAlgRequest o: ServiceCreateApiAccessTokenSignAlgRequest.values()) {
