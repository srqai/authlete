 ...
 */
public enum ClientCreateApiAuthorizationEncryptionEncRequest {
    ...
    ClientCreateApiAuthorizationEncryptionEncRequest(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientCreateApiAuthorizationEncryptionEncRequest> fromValue(String value) {
        for (ClientCreateApiAuthorizationEncryptionEncRequest o: ClientCreateApiAuthorizationEncryptionEncRequest.values()) {
