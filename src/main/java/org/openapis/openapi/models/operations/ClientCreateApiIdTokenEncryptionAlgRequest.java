 ...
 */
public enum ClientCreateApiIdTokenEncryptionAlgRequest {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientCreateApiIdTokenEncryptionAlgRequest(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientCreateApiIdTokenEncryptionAlgRequest> fromValue(String value) {
        for (ClientCreateApiIdTokenEncryptionAlgRequest o: ClientCreateApiIdTokenEncryptionAlgRequest.values()) {
