 ...
 */
public enum ClientRegistrationApiFormUserInfoEncryptionAlg {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientRegistrationApiFormUserInfoEncryptionAlg(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationApiFormUserInfoEncryptionAlg> fromValue(String value) {
        for (ClientRegistrationApiFormUserInfoEncryptionAlg o: ClientRegistrationApiFormUserInfoEncryptionAlg.values()) {
