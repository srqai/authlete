 ...
 */
public enum ClientRegistrationUpdateApiRequestEncryptionEnc {
    ...
    ClientRegistrationUpdateApiRequestEncryptionEnc(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationUpdateApiRequestEncryptionEnc> fromValue(String value) {
        for (ClientRegistrationUpdateApiRequestEncryptionEnc o: ClientRegistrationUpdateApiRequestEncryptionEnc.values()) {
