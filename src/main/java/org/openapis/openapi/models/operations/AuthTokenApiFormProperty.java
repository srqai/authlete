...
public class AuthTokenApiFormProperty {
    /**
     * The key part.
     */
    ...
    @JsonCreator
    public AuthTokenApiFormProperty(
     ...
     * The key part.
     */
    public AuthTokenApiFormProperty withKey(@Nullable String key) {
        this.key = key;
        return this;
    }
     ...
     * The value part.
     */
    public AuthTokenApiFormProperty withValue(@Nullable String value) {
        this.value = value;
        return this;
    }
     ...
     * If `true`, this property is hidden from client applications. Otherwise, this property is visible to client applications.
     */
    public AuthTokenApiFormProperty withHidden(@Nullable Boolean hidden) {
        this.hidden = hidden;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AuthTokenApiFormProperty other = (AuthTokenApiFormProperty) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AuthTokenApiFormProperty.class,
                "key", key,
                "value", value,
                "hidden", hidden);
    }
    ...
    public final static class Builder {
        ...
        public AuthTokenApiFormProperty build() {
            return new AuthTokenApiFormProperty(
                key, value, hidden);
        }
