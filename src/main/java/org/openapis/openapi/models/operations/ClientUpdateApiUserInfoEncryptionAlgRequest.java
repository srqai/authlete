 ...
 */
public enum ClientUpdateApiUserInfoEncryptionAlgRequest {
    RSA15("RSA1_5"),
    RSA_OAEP("RSA_OAEP"),
    ...
    ClientUpdateApiUserInfoEncryptionAlgRequest(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientUpdateApiUserInfoEncryptionAlgRequest> fromValue(String value) {
        for (ClientUpdateApiUserInfoEncryptionAlgRequest o: ClientUpdateApiUserInfoEncryptionAlgRequest.values()) {
