 ...
 */
public enum ClientRegistrationDeleteApiAuthorizationEncryptionEnc {
    ...
    ClientRegistrationDeleteApiAuthorizationEncryptionEnc(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationDeleteApiAuthorizationEncryptionEnc> fromValue(String value) {
        for (ClientRegistrationDeleteApiAuthorizationEncryptionEnc o: ClientRegistrationDeleteApiAuthorizationEncryptionEnc.values()) {
