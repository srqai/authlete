...
public class ClientRegistrationUpdateApiFormExtension {
    /**
    ...
    @JsonCreator
    public ClientRegistrationUpdateApiFormExtension(
     ...
     * that the set is the set of scopes that the client application is allowed to request.
     */
    public ClientRegistrationUpdateApiFormExtension withRequestableScopes(@Nullable List<String> requestableScopes) {
        this.requestableScopes = requestableScopes;
        return this;
    }
     ...
     * application can request any scope which is supported by the authorization server.
     */
    public ClientRegistrationUpdateApiFormExtension withRequestableScopesEnabled(@Nullable Boolean requestableScopesEnabled) {
        this.requestableScopesEnabled = requestableScopesEnabled;
        return this;
    }
     ...
     * too. Authlete chooses the minimum value among the candidates.
     */
    public ClientRegistrationUpdateApiFormExtension withAccessTokenDuration(@Nullable Long accessTokenDuration) {
        this.accessTokenDuration = accessTokenDuration;
        return this;
    }
     ...
     * too. Authlete chooses the minimum value among the candidates.
     */
    public ClientRegistrationUpdateApiFormExtension withRefreshTokenDuration(@Nullable Long refreshTokenDuration) {
        this.refreshTokenDuration = refreshTokenDuration;
        return this;
    }
     ...
     * too. Authlete chooses the minimum value among the candidates.
     */
    public ClientRegistrationUpdateApiFormExtension withIdTokenDuration(@Nullable Long idTokenDuration) {
        this.idTokenDuration = idTokenDuration;
        return this;
    }
     ...
     * permission to make token exchange requests ([RFC 8693][https://www.rfc-editor.org/rfc/rfc8693.html])
     */
    public ClientRegistrationUpdateApiFormExtension withTokenExchangePermitted(@Nullable Boolean tokenExchangePermitted) {
        this.tokenExchangePermitted = tokenExchangePermitted;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClientRegistrationUpdateApiFormExtension other = (ClientRegistrationUpdateApiFormExtension) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ClientRegistrationUpdateApiFormExtension.class,
    ...
    public final static class Builder {
        ...
        public ClientRegistrationUpdateApiFormExtension build() {
            return new ClientRegistrationUpdateApiFormExtension(
                requestableScopes, requestableScopesEnabled, accessTokenDuration,
                refreshTokenDuration, idTokenDuration, tokenExchangePermitted);
        }
