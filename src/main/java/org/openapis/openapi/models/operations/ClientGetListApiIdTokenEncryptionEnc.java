 ...
 */
public enum ClientGetListApiIdTokenEncryptionEnc {
    ...
    ClientGetListApiIdTokenEncryptionEnc(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientGetListApiIdTokenEncryptionEnc> fromValue(String value) {
        for (ClientGetListApiIdTokenEncryptionEnc o: ClientGetListApiIdTokenEncryptionEnc.values()) {
