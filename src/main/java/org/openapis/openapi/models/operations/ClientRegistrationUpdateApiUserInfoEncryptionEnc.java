 ...
 */
public enum ClientRegistrationUpdateApiUserInfoEncryptionEnc {
    ...
    ClientRegistrationUpdateApiUserInfoEncryptionEnc(String value) {
        this.value = value;
    }
    ...
    public static Optional<ClientRegistrationUpdateApiUserInfoEncryptionEnc> fromValue(String value) {
        for (ClientRegistrationUpdateApiUserInfoEncryptionEnc o: ClientRegistrationUpdateApiUserInfoEncryptionEnc.values()) {
