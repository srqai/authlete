...
public class 1api1infoGetResponses400Exception extends RuntimeException {
    /**
    ...
    @JsonCreator
    public 1api1infoGetResponses400Exception(
     ...
     * The code which represents the result of the API call.
     */
    public 1api1infoGetResponses400Exception withResultCode(@Nullable String resultCode) {
        this.resultCode = resultCode;
        return this;
    }
     ...
     * A short message which explains the result of the API call.
     */
    public 1api1infoGetResponses400Exception withResultMessage(@Nullable String resultMessage) {
        this.resultMessage = resultMessage;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public 1api1infoGetResponses400Exception withRawResponse(@Nullable HttpResponse<InputStream> rawResponse) {
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        1api1infoGetResponses400Exception other = (1api1infoGetResponses400Exception) o;
        return 
    ...
    public String toString() {
        return Utils.toString(1api1infoGetResponses400Exception.class,
    ...
    public final static class Builder {
        ...
        public 1api1infoGetResponses400Exception build() {
            return new 1api1infoGetResponses400Exception(
                resultCode, resultMessage, rawResponse);
        }
