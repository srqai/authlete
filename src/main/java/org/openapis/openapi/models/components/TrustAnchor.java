...
public class TrustAnchor {
     ...
     * the entity ID of the trust anchor
     */
    public TrustAnchor withEntityId(@Nullable String entityId) {
        this.entityId = entityId;
        return this;
    }
     ...
     * the JWK Set document containing public keys of the trust anchor
     */
    public TrustAnchor withJwks(@Nullable String jwks) {
        this.jwks = jwks;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(TrustAnchor.class,
                "entityId", entityId,
                "jwks", jwks);
    }
