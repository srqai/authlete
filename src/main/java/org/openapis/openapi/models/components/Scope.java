...
public class Scope {
     ...
     * The name of the scope.
     */
    public Scope withName(@Nullable String name) {
        this.name = name;
        return this;
    }
     ...
     * `true` to mark the scope as default. Scopes marked as default are regarded as requested when an authorization request from a client application does not contain scope request parameter.
     */
    public Scope withDefaultEntry(@Nullable Boolean defaultEntry) {
        this.defaultEntry = defaultEntry;
        return this;
    }
     ...
     * The description about the scope.
     */
    public Scope withDescription(@Nullable String description) {
        this.description = description;
        return this;
    }
     ...
     * The descriptions about this scope in multiple languages.
     */
    public Scope withDescriptions(@Nullable List<TaggedValue> descriptions) {
        this.descriptions = descriptions;
        return this;
    }
     ...
     * The attributes of the scope.
     */
    public Scope withAttributes(@Nullable List<Pair> attributes) {
        this.attributes = attributes;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(Scope.class,
                "name", name,
