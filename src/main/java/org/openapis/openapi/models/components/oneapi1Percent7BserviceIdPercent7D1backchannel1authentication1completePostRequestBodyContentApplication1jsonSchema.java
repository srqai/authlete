...
public class 1api1Percent7BserviceIdPercent7D1backchannel1authentication1completePostRequestBodyContentApplication1jsonSchema {
    /**
    ...
    private 1api1Percent7BserviceIdPercent7D1backchannel1authentication1completePostRequestBodyContentApplication1jsonSchemaResult result;
    ...
    @JsonCreator
    public 1api1Percent7BserviceIdPercent7D1backchannel1authentication1completePostRequestBodyContentApplication1jsonSchema(
            @Nonnull String ticket,
            @Nonnull 1api1Percent7BserviceIdPercent7D1backchannel1authentication1completePostRequestBodyContentApplication1jsonSchemaResult result,
     ...
     * described in the description.
     */
    public 1api1Percent7BserviceIdPercent7D1backchannel1authentication1completePostRequestBodyContentApplication1jsonSchemaResult result() {
        return this.result;
    }
     ...
     * The ticket issued by Authlete's `/backchannel/authentication` API.
     */
    public 1api1Percent7BserviceIdPercent7D1backchannel1authentication1completePostRequestBodyContentApplication1jsonSchema withTicket(@Nonnull String ticket) {
     ...
     * described in the description.
     */
    public 1api1Percent7BserviceIdPercent7D1backchannel1authentication1completePostRequestBodyContentApplication1jsonSchema withResult(@Nonnull 1api1Percent7BserviceIdPercent7D1backchannel1authentication1completePostRequestBodyContentApplication1jsonSchemaResult result) {
     ...
     * The subject (= unique identifier) of the end-user.
     */
    public 1api1Percent7BserviceIdPercent7D1backchannel1authentication1completePostRequestBodyContentApplication1jsonSchema withSubject(@Nonnull String subject) {
     ...
     * The value of the sub claim that should be used in the ID token.
     */
    public 1api1Percent7BserviceIdPercent7D1backchannel1authentication1completePostRequestBodyContentApplication1jsonSchema withSub(@Nullable String sub) {
        this.sub = sub;
        return this;
    }
     ...
     * The time at which the end-user was authenticated. Its value is the number of seconds from `1970-01-01`.
     */
    public 1api1Percent7BserviceIdPercent7D1backchannel1authentication1completePostRequestBodyContentApplication1jsonSchema withAuthTime(@Nullable Long authTime) {
        this.authTime = authTime;
        return this;
    }
     ...
     * The reference of the authentication context class which the end-user authentication satisfied.
     */
    public 1api1Percent7BserviceIdPercent7D1backchannel1authentication1completePostRequestBodyContentApplication1jsonSchema withAcr(@Nullable String acr) {
        this.acr = acr;
        return this;
    }
     ...
     * Additional claims which will be embedded in the ID token.
     */
    public 1api1Percent7BserviceIdPercent7D1backchannel1authentication1completePostRequestBodyContentApplication1jsonSchema withClaims(@Nullable String claims) {
        this.claims = claims;
        return this;
    }
     ...
     * The extra properties associated with the access token.
     */
    public 1api1Percent7BserviceIdPercent7D1backchannel1authentication1completePostRequestBodyContentApplication1jsonSchema withProperties(@Nullable List<Property> properties) {
        this.properties = properties;
        return this;
    }
     ...
     * When nothing is specified for this parameter, replacement is not performed.
     */
    public 1api1Percent7BserviceIdPercent7D1backchannel1authentication1completePostRequestBodyContentApplication1jsonSchema withScopes(@Nullable List<String> scopes) {
        this.scopes = scopes;
        return this;
    }
     ...
     * JSON that represents additional JWS header parameters for ID tokens.
     */
    public 1api1Percent7BserviceIdPercent7D1backchannel1authentication1completePostRequestBodyContentApplication1jsonSchema withIdtHeaderParams(@Nullable String idtHeaderParams) {
        this.idtHeaderParams = idtHeaderParams;
        return this;
    }
     ...
     * the set `%x20-21 / %x23-5B / %x5D-7E`.
     */
    public 1api1Percent7BserviceIdPercent7D1backchannel1authentication1completePostRequestBodyContentApplication1jsonSchema withErrorDescription(@Nullable String errorDescription) {
        this.errorDescription = errorDescription;
        return this;
    }
     ...
     * property in the response to the client.
     */
    public 1api1Percent7BserviceIdPercent7D1backchannel1authentication1completePostRequestBodyContentApplication1jsonSchema withErrorUri(@Nullable String errorUri) {
        this.errorUri = errorUri;
        return this;
    }
     ...
     * to know.
     */
    public 1api1Percent7BserviceIdPercent7D1backchannel1authentication1completePostRequestBodyContentApplication1jsonSchema withConsentedClaims(@Nullable List<String> consentedClaims) {
        this.consentedClaims = consentedClaims;
        return this;
    }
     ...
     * Additional claims that are added to the payload part of the JWT access token.
     */
    public 1api1Percent7BserviceIdPercent7D1backchannel1authentication1completePostRequestBodyContentApplication1jsonSchema withJwtAtClaims(@Nullable String jwtAtClaims) {
        this.jwtAtClaims = jwtAtClaims;
        return this;
    }
     ...
     * The representation of an access token that may be issued as a result of the Authlete API call.
     */
    public 1api1Percent7BserviceIdPercent7D1backchannel1authentication1completePostRequestBodyContentApplication1jsonSchema withAccessToken(@Nullable String accessToken) {
        this.accessToken = accessToken;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        1api1Percent7BserviceIdPercent7D1backchannel1authentication1completePostRequestBodyContentApplication1jsonSchema other = (1api1Percent7BserviceIdPercent7D1backchannel1authentication1completePostRequestBodyContentApplication1jsonSchema) o;
        return 
    ...
    public String toString() {
        return Utils.toString(1api1Percent7BserviceIdPercent7D1backchannel1authentication1completePostRequestBodyContentApplication1jsonSchema.class,
                "ticket", ticket,
                "result", result,
                "subject", subject,
                "sub", sub,
    ...
    public final static class Builder {
         ...
         * described in the description.
         */
        public Builder result(@Nonnull 1api1Percent7BserviceIdPercent7D1backchannel1authentication1completePostRequestBodyContentApplication1jsonSchemaResult result) {
            this.result = Utils.checkNotNull(result, "result");
            return this;
        }
        ...
        public 1api1Percent7BserviceIdPercent7D1backchannel1authentication1completePostRequestBodyContentApplication1jsonSchema build() {
            return new 1api1Percent7BserviceIdPercent7D1backchannel1authentication1completePostRequestBodyContentApplication1jsonSchema(
                ticket, result, subject,
                sub, authTime, acr,
                claims, properties, scopes,
                idtHeaderParams, errorDescription, errorUri,
