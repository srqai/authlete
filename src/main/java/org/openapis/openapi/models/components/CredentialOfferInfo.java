...
public class CredentialOfferInfo {
     ...
     * The identifier of the credential offer.
     */
    public CredentialOfferInfo withIdentifier(@Nullable String identifier) {
        this.identifier = identifier;
        return this;
    }
     ...
     * The credential offer in the JSON format.
     */
    public CredentialOfferInfo withCredentialOffer(@Nullable String credentialOffer) {
        this.credentialOffer = credentialOffer;
        return this;
    }
     ...
     * The identifier of the credential issuer.
     */
    public CredentialOfferInfo withCredentialIssuer(@Nullable String credentialIssuer) {
        this.credentialIssuer = credentialIssuer;
        return this;
    }
     ...
     * The value of the `credentials` object in the JSON format.
     */
    public CredentialOfferInfo withCredentials(@Nullable String credentials) {
        this.credentials = credentials;
        return this;
    }
     ...
     * included in the `grants` object.
     */
    public CredentialOfferInfo withAuthorizationCodeGrantIncluded(@Nullable Boolean authorizationCodeGrantIncluded) {
        this.authorizationCodeGrantIncluded = authorizationCodeGrantIncluded;
        return this;
    }
     ...
     * object.
     */
    public CredentialOfferInfo withIssuerStateIncluded(@Nullable Boolean issuerStateIncluded) {
        this.issuerStateIncluded = issuerStateIncluded;
        return this;
    }
     ...
     * `authorization_code` object in the `grants` object.
     */
    public CredentialOfferInfo withIssuerState(@Nullable String issuerState) {
        this.issuerState = issuerState;
        return this;
    }
     ...
     * included in the `grants` object.
     */
    public CredentialOfferInfo withPreAuthorizedCodeGrantIncluded(@Nullable Boolean preAuthorizedCodeGrantIncluded) {
        this.preAuthorizedCodeGrantIncluded = preAuthorizedCodeGrantIncluded;
        return this;
    }
     ...
     * the `grants` object.
     */
    public CredentialOfferInfo withPreAuthorizedCode(@Nullable String preAuthorizedCode) {
        this.preAuthorizedCode = preAuthorizedCode;
        return this;
    }
     ...
     * the `grants` object.
     */
    public CredentialOfferInfo withUserPinRequired(@Nullable Boolean userPinRequired) {
        this.userPinRequired = userPinRequired;
        return this;
    }
     ...
     * The value of the user PIN associated with the credential offer.
     */
    public CredentialOfferInfo withUserPin(@Nullable String userPin) {
        this.userPin = userPin;
        return this;
    }
     ...
     * The subject associated with the credential offer.
     */
    public CredentialOfferInfo withSubject(@Nullable String subject) {
        this.subject = subject;
        return this;
    }
     ...
     * The time at which the credential offer will expire.
     */
    public CredentialOfferInfo withExpiresAt(@Nullable Long expiresAt) {
        this.expiresAt = expiresAt;
        return this;
    }
     ...
     * The general-purpose arbitrary string.
     */
    public CredentialOfferInfo withContext(@Nullable String context) {
        this.context = context;
        return this;
    }
     ...
     * Extra properties to associate with the credential offer.
     */
    public CredentialOfferInfo withProperties(@Nullable List<Property> properties) {
        this.properties = properties;
        return this;
    }
     ...
     * access token.
     */
    public CredentialOfferInfo withJwtAtClaims(@Nullable String jwtAtClaims) {
        this.jwtAtClaims = jwtAtClaims;
        return this;
    }
     ...
     * the course of issuing the credential offer.
     */
    public CredentialOfferInfo withAuthTime(@Nullable Long authTime) {
        this.authTime = authTime;
        return this;
    }
     ...
     * performed during the course of issuing the credential offer.
     */
    public CredentialOfferInfo withAcr(@Nullable String acr) {
        this.acr = acr;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CredentialOfferInfo other = (CredentialOfferInfo) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CredentialOfferInfo.class,
    ...
    public final static class Builder {
        ...
        public CredentialOfferInfo build() {
