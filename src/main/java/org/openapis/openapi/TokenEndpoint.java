...
import org.openapis.openapi.models.operations.AuthTokenApiFormRequest;
import org.openapis.openapi.models.operations.AuthTokenApiFormRequestBuilder;
import org.openapis.openapi.models.operations.AuthTokenApiFormResponse;
import org.openapis.openapi.models.operations.AuthTokenApiRequest;
import org.openapis.openapi.models.operations.AuthTokenApiRequestBody;
import org.openapis.openapi.models.operations.AuthTokenApiRequestBuilder;
import org.openapis.openapi.models.operations.AuthTokenApiResponse;
import org.openapis.openapi.models.operations.AuthTokenIssueApiFormRequest;
import org.openapis.openapi.models.operations.AuthTokenIssueApiFormRequestBuilder;
import org.openapis.openapi.models.operations.AuthTokenIssueApiFormResponse;
import org.openapis.openapi.models.operations.AuthTokenIssueApiRequest;
...
public class TokenEndpoint {
    ...
    TokenEndpoint(SDKConfiguration sdkConfiguration) {
     ...
     * 
     * <p>This API is supposed to be called from with the implementation of the token endpoint of the service.
     ...
     * 
     * <p>In addition, if the token endpoint of the authorization server implementation supports basic authentication
     ...
     * 
     * <p>    // The credentials of the client application extracted from
     ...
     * 
     * <p>    // Process the given parameters.
     *     return process(parameters, clientId, clientSecret);
     * }
     * ```
     * 
     * <p>The response from `/auth/token` API has some parameters. Among them, it is action parameter that
     ...
     * 
     * <p>The following illustrate responses which the service implementation must generate and return to
     ...
     * **PASSWORD**
     * 
     * <p>When the value of `"action"` is `"PASSWORD"`, it means that
     ...
     * 
     * <p>In this case, #getUsername() returns the value of `"username"`
     * request parameter and #getPassword() returns the value of {@code
     ...
     * 
     * <p>1. When the credentials are valid, call Authlete's /auth/token/issue} API to generate an access token for the client
     ...
     * 
     * <p>The HTTP status of the response returned to the client application must be "200 OK" and the content
     * type must be `application/json`.
     * 
     * <p>The value of `responseContent` is a JSON string which contains an access token (and optionally
     ...
     * ```
     * 
     * <p>**TOKEN_EXCHANGE (Authlete 2.3 onwards)**
     * 
     * <p>When the value of `"action"` is `"TOKEN_EXCHANGE"`, it means
     ...
     * 
     * <p>1. Confirm that the value of the `requested_token_type` request parameter
     ...
     * 
     * <p>Furthermore, Authlete performs additional validation on the tokens specified
     ...
     * 
     * <p>**Token Validation Steps**
     * 
     * <p>*Token Type: `urn:ietf:params:oauth:token-type:jwt`*
     * 
     * <p>1. Confirm that the format conforms to the JWT specification [RFC 7519][https://www.rfc-editor.org/rfc/rfc7519.html].
     ...
     * 
     * <p>*Token Type: `urn:ietf:params:oauth:token-type:access_token`*
     * 
     * <p>1. Confirm that the token is an access token that has been issued by
     ...
     * 
     * <p>*Token Type: `urn:ietf:params:oauth:token-type:refresh_token`*
     * 
     * <p>1. Confirm that the token is a refresh token that has been issued by
     ...
     * 
     * <p>*Token Type: `urn:ietf:params:oauth:token-type:id_token`*
     * 
     * <p>1. Confirm that the format conforms to the JWT specification (&lt;a href=
     ...
     * 
     * <p>*Token Type: `urn:ietf:params:oauth:token-type:saml1`*
     * 
     * <p>(Authlete does not perform any validation for this token type.)
     * 
     * <p>*Token Type: `urn:ietf:params:oauth:token-type:saml2`*
     * 
     * <p>(Authlete does not perform any validation for this token type.)
     * 
     * <p>The specification of Token Exchange (&lt;a href=
     ...
     * their own rules.
     * 
     * <p>In the case of Action#TOKEN_EXCHANGE TOKEN_EXCHANGE, the {@link
     * #getResponseContent()} method returns `null`. You have to construct
     * the token response by yourself.
     * 
     * <p>For example, you may generate an access token by calling Authlete's
     ...
     * ```
     * 
     * <p>**JWT_BEARER JWT_BEARER (Authlete 2.3 onwards)**
     * 
     * <p>When the value of `"action"` is `"JWT_BEARER"`, it means that
     ...
     * 
     * <p>1. Confirm that the `assertion` request parameter is given and its value
     *   is not empty.
     ...
     * 
     * <p>3. Check if the JWT is encrypted and if it is encrypted, then (a) reject the
     ...
     * 7. Confirm that the issuer identifier of the service (cf. Service#getIssuer())
     ...
     * 
     * <p>Authlete provides some configuration options for the grant type as listed
     ...
     * ```
     * 
     * <p>  Finally, note again that Authlete does not verify the signature of the JWT
     ...
     */
    public AuthTokenApiRequestBuilder process() {
        return new AuthTokenApiRequestBuilder(sdkConfiguration);
    }
     ...
     */
    public AuthTokenApiResponse process(@Nonnull String serviceId, @Nonnull AuthTokenApiRequestBody requestBody) throws Exception {
        ...
        RequestOperation<AuthTokenApiRequest, AuthTokenApiResponse> operation
              = new AuthTokenApiOperation(sdkConfiguration);
     ...
     * @return The call builder
     */
    public AuthTokenApiFormRequestBuilder processForm() {
        return new AuthTokenApiFormRequestBuilder(sdkConfiguration);
    }
     ...
     * 
     * @param serviceId A service ID.
     * @param 1api1Percent7BserviceIdPercent7D1auth1tokenPostRequestBodyContentApplication1jsonSchema 
     * @return The response from the API call
     * @throws Exception if the API call fails
     */
    public AuthTokenApiFormResponse processForm(@Nonnull String serviceId, @Nonnull 1api1Percent7BserviceIdPercent7D1auth1tokenPostRequestBodyContentApplication1jsonSchema 1api1Percent7BserviceIdPercent7D1auth1tokenPostRequestBodyContentApplication1jsonSchema) throws Exception {
        AuthTokenApiFormRequest request = new AuthTokenApiFormRequest(serviceId, 1api1Percent7BserviceIdPercent7D1auth1tokenPostRequestBodyContentApplication1jsonSchema);
     ...
     * 
     * <p>This API generates a content of a successful token response that the authorization server implementation
     ...
     * 
     * <p>The response from `/auth/token/issue` API has some parameters. Among them, it is `action` parameter
     ...
     * <p>**OK**
     * 
     * <p>When the value of `action` is `OK`, it means that Authlete's `/auth/token/issue` API successfully
     * generated an access token.
     * 
     * <p>The HTTP status of the response returned to the client application must be "200 OK" and the content
     * type must be`application/json`.
     * 
     * <p>The value of `responseContent` is a JSON string which contains an access token, so it can be used
     * as the entity body of the response.
     * 
     * <p>The following illustrates the response which the service implementation must generate and return
     * to the client application.
     ...
     * @return The call builder
     */
    public AuthTokenIssueApiRequestBuilder issue() {
        return new AuthTokenIssueApiRequestBuilder(sdkConfiguration);
    }
     ...
     * @throws Exception if the API call fails
     */
    public AuthTokenIssueApiResponse issue(@Nonnull String serviceId, @Nonnull AuthTokenIssueApiRequestBody requestBody) throws Exception {
        ...
        RequestOperation<AuthTokenIssueApiRequest, AuthTokenIssueApiResponse> operation
              = new AuthTokenIssueApiOperation(sdkConfiguration);
        return operation.handleResponse(operation.doRequest(request));
    }
     ...
     * @return The call builder
     */
    public AuthTokenIssueApiFormRequestBuilder issueForm() {
        return new AuthTokenIssueApiFormRequestBuilder(sdkConfiguration);
    }
     ...
     * 
     * @param serviceId A service ID.
     * @param 1api1Percent7BserviceIdPercent7D1auth1token1issuePostRequestBodyContentApplication1jsonSchema 
     * @return The response from the API call
     * @throws Exception if the API call fails
     */
    public AuthTokenIssueApiFormResponse issueForm(@Nonnull String serviceId, @Nonnull 1api1Percent7BserviceIdPercent7D1auth1token1issuePostRequestBodyContentApplication1jsonSchema 1api1Percent7BserviceIdPercent7D1auth1token1issuePostRequestBodyContentApplication1jsonSchema) throws Exception {
        AuthTokenIssueApiFormRequest request = new AuthTokenIssueApiFormRequest(serviceId, 1api1Percent7BserviceIdPercent7D1auth1token1issuePostRequestBodyContentApplication1jsonSchema);
