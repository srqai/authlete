...
import org.openapis.openapi.models.components.1api1Percent7BserviceIdPercent7D1backchannel1authentication1completePostRequestBodyContentApplication1jsonSchema;
...
import org.openapis.openapi.models.operations.BackchannelAuthenticationApiFormRequestBuilder;
...
import org.openapis.openapi.models.operations.BackchannelAuthenticationApiRequestBuilder;
import org.openapis.openapi.models.operations.BackchannelAuthenticationApiResponse;
import org.openapis.openapi.models.operations.BackchannelAuthenticationCompleteApiFormRequest;
import org.openapis.openapi.models.operations.BackchannelAuthenticationCompleteApiFormRequestBuilder;
import org.openapis.openapi.models.operations.BackchannelAuthenticationCompleteApiFormResponse;
import org.openapis.openapi.models.operations.BackchannelAuthenticationCompleteApiRequest;
import org.openapis.openapi.models.operations.BackchannelAuthenticationCompleteApiRequestBody;
import org.openapis.openapi.models.operations.BackchannelAuthenticationCompleteApiRequestBuilder;
import org.openapis.openapi.models.operations.BackchannelAuthenticationCompleteApiResponse;
import org.openapis.openapi.models.operations.BackchannelAuthenticationFailApiFormRequest;
import org.openapis.openapi.models.operations.BackchannelAuthenticationFailApiFormRequestBuilder;
import org.openapis.openapi.models.operations.BackchannelAuthenticationFailApiFormResponse;
import org.openapis.openapi.models.operations.BackchannelAuthenticationFailApiRequest;
import org.openapis.openapi.models.operations.BackchannelAuthenticationFailApiRequestBody;
import org.openapis.openapi.models.operations.BackchannelAuthenticationFailApiRequestBuilder;
import org.openapis.openapi.models.operations.BackchannelAuthenticationFailApiResponse;
import org.openapis.openapi.models.operations.BackchannelAuthenticationIssueApiFormRequest;
import org.openapis.openapi.models.operations.BackchannelAuthenticationIssueApiFormRequestBuilder;
import org.openapis.openapi.models.operations.BackchannelAuthenticationIssueApiFormResponse;
import org.openapis.openapi.models.operations.BackchannelAuthenticationIssueApiRequest;
...
public class Ciba {
    ...
    Ciba(SDKConfiguration sdkConfiguration) {
     ...
     * 
     * <p>This API parses request parameters of a [backchannel authentication request](https://openid.net/specs/openid-client-initiated-backchannel-authentication-core-1_0.html#auth_request)
     ...
     * 
     * <p>This API is supposed to be called from within the implementation of the [backchannel authentication
     ...
     * 
     * <p>The response from `/backchannel/authentication` API has various parameters. Among them, it is `action`
     ...
     * <p>**UNAUTHORIZED**
     * 
     * <p>When the value of `action` is `UNAUTHORIZED`, it means that client authentication of the backchannel
     ...
     * 
     * <p>When the value of `action` is `USER_IDENTIFICATION`, it means that the backchannel authentication
     * request from the client application is valid. The authorization server implementation has to follow
     * the steps below.
     * 
     * <p>[1] END-USER IDENTIFICATION
     * 
     * <p>The first step is to determine the subject (= unique identifier) of the end-user from whom the
     * client application wants to get authorization.
     * 
     * <p>According to the CIBA specification, a backchannel authentication request contains one (and only
     ...
     * as a hint.&lt;br&gt;
     * 
     * <p>The value of the `hint` parameter is the value of the hint. For example, when the value of the
     * `hintType` parameter is `LOGIN_HINT`, The value of the `hint` parameter is the value of the `login_hint`
     * request parameter.&lt;br&gt;
     * 
     * <p>It is up to the authorization server implementation how to determine the subject of the end-user
     ...
     * 
     * <p>[2] END-USER IDENTIFICATION ERROR
     * 
     * <p>There are some cases where the authorization server implementation encounters an error during
     ...
     * Pragma: no-cache
     * 
     * <p>{ "error":"unknown_user_id" }
     * ```
     * 
     * <p>Authlete provides `/backchannel/authentication/fail` API that builds the response body (JSON)
     ...
     * 
     * <p>Possible error cases that the authorization server implementation itself has to handle are as
     * follows. Other error cases have already been covered by `/backchannel/authentication` API.
     * 
     * <p>- &lt;u&gt;`expired_login_hint_token`&lt;/u&gt;&lt;br&gt;
     ...
     * 
     * <p>  Note that the format of `login_hint_token` is not described in the CIBA Core spec at all and
     ...
     * 
     * <p>  Note that `/backchannel/authentication` API does not return `action=USER_IDENTIFICATION` in
     ...
     * 
     * <p>  Note that `/backchannel/authentication` API does not return `action=USER_IDENTIFICATION` when
     ...
     * 
     * <p>- &lt;u&gt;`invalid_user_code`&lt;/u&gt;&lt;br&gt;
     *   The authorization server implementation detected that the presented user code is invalid.
     * 
     * <p>  Note that the format of user_code is not described in the CIBA Core spec at all and so there
     ...
     * 
     * <p>- &lt;u&gt;`invalid_binding_message`&lt;/u&gt;&lt;br&gt;
     *   The authorization server implementation detected that the presented binding message is invalid.
     * 
     * <p>  Note that the format of binding_message is not described in the CIBA Core spec at all and
     ...
     * 
     * <p>- &lt;u&gt;`invalid_target`&lt;/u&gt;&lt;br&gt;
     *   The authorization server implementation rejects the requested target resources.
     * 
     * <p>  The error code invalid_target is from "Resource Indicators for OAuth 2.0". The specification
     ...
     * 
     * <p>  The authorization server implementation will never have to use the error code `access_denied`
     ...
     * 
     * <p>[3] AUTH_REQ_ID ISSUE
     * 
     * <p>If the authorization server implementation has successfully determined the subject of the end-user,
     * the next action is to return an HTTP response to the client application which contains `auth_req_id`.
     * 
     * <p>Authlete provides `/backchannel/authentication/issue` API which generates a JSON containing `auth_req_id`,
     ...
     * 
     * <p>[4] END-USER AUTHENTICATION AND AUTHORIZATION
     * 
     * <p>After sending a JSON containing `auth_req_id` back to the client application, the service implementation
     ...
     * 
     * <p>How to communicate with an authentication device and achieve end-user authentication and authorization
     ...
     * 
     * <p>  If the scope request parameter contains `address`, `email`, `phone` and/or `profile`, they are
     ...
     * 
     * <p>[5] END-USER AUTHENTICATION AND AUTHORIZATION COMPLETION
     * 
     * <p>After receiving the result of end-user authentication and authorization, the authorization server
     ...
     * 
     * <p>[6] CLIENT NOTIFICATION
     * 
     * <p>When the backchannel token delivery mode is either `ping` or `push`, the authorization server implementation
     ...
     * <p>[7] TOKEN REQUEST
     * 
     * <p>When the backchannel token delivery mode is either `ping` or `poll`, the client application will make
     * a token request to the token endpoint to get an ID token, an access token and optionally a refresh
     * token.
     * 
     * <p>A token request that corresponds to a backchannel authentication request uses `urn:openid:params:grant-type:ciba`
     ...
     */
    public BackchannelAuthenticationApiRequestBuilder process() {
        return new BackchannelAuthenticationApiRequestBuilder(sdkConfiguration);
    }
     ...
     */
    public BackchannelAuthenticationApiResponse process(@Nonnull String serviceId, @Nonnull BackchannelAuthenticationApiRequestBody requestBody) throws Exception {
        ...
        RequestOperation<BackchannelAuthenticationApiRequest, BackchannelAuthenticationApiResponse> operation
              = new BackchannelAuthenticationApiOperation(sdkConfiguration);
     ...
     * @return The call builder
     */
    public BackchannelAuthenticationApiFormRequestBuilder processForm() {
        return new BackchannelAuthenticationApiFormRequestBuilder(sdkConfiguration);
    }
     ...
     * 
     * @param serviceId A service ID.
     * @param 1api1Percent7BserviceIdPercent7D1backchannel1authenticationPostRequestBodyContentApplication1jsonSchema 
     * @return The response from the API call
     * @throws Exception if the API call fails
     */
    public BackchannelAuthenticationApiFormResponse processForm(@Nonnull String serviceId, @Nonnull 1api1Percent7BserviceIdPercent7D1backchannel1authenticationPostRequestBodyContentApplication1jsonSchema 1api1Percent7BserviceIdPercent7D1backchannel1authenticationPostRequestBodyContentApplication1jsonSchema) throws Exception {
        BackchannelAuthenticationApiFormRequest request = new BackchannelAuthenticationApiFormRequest(serviceId, 1api1Percent7BserviceIdPercent7D1backchannel1authenticationPostRequestBodyContentApplication1jsonSchema);
        RequestOperation<BackchannelAuthenticationApiFormRequest, BackchannelAuthenticationApiFormResponse> operation
              = new BackchannelAuthenticationApiFormOperation(sdkConfiguration);
        return operation.handleResponse(operation.doRequest(request));
    }
     ...
     * 
     * <p>This API prepares JSON that contains an `auth_req_id`. The JSON should be used as the response body
     ...
     * 
     * <p>The description of the `/backchannel/authentication` API describes the timing when this API should
     * be called and the meaning of request parameters. See [AUTH_REQ_ID ISSUE] in `USER_IDENTIFICATION`.
     * 
     * <p>The response from `/backchannel/authentication/issue` API has some parameters. Among them, it is
     ...
     * <p>**INVALID_TICKET**
     * 
     * <p>When the value of `action` is `INVALID_TICKET`, it means that the ticket included in the API call
     * was invalid. For example, it does not exist or has expired.
     * 
     * <p>From a viewpoint of the client application, this is an error on the server side. Therefore, the
     ...
     * 
     * <p>You can build an error response in the same way as shown in the description for the case of `INTERNAL_SERVER_ERROR`.
     * 
     * <p>**OK**
     * 
     * <p>When the value of `action` is `OK`, it means that Authlete has succeeded in preparing JSON that
     ...
     * @return The call builder
     */
    public BackchannelAuthenticationIssueApiRequestBuilder issue() {
        return new BackchannelAuthenticationIssueApiRequestBuilder(sdkConfiguration);
    }
     ...
     * @throws Exception if the API call fails
     */
    public BackchannelAuthenticationIssueApiResponse issue(@Nonnull String serviceId, @Nonnull BackchannelAuthenticationIssueApiRequestBody requestBody) throws Exception {
     ...
     * @return The call builder
     */
    public BackchannelAuthenticationIssueApiFormRequestBuilder issueForm() {
        return new BackchannelAuthenticationIssueApiFormRequestBuilder(sdkConfiguration);
    }
     ...
     * 
     * @param serviceId A service ID.
     * @param 1api1Percent7BserviceIdPercent7D1backchannel1authentication1issuePostRequestBodyContentApplication1jsonSchema 
     * @return The response from the API call
     * @throws Exception if the API call fails
     */
    public BackchannelAuthenticationIssueApiFormResponse issueForm(@Nonnull String serviceId, @Nonnull 1api1Percent7BserviceIdPercent7D1backchannel1authentication1issuePostRequestBodyContentApplication1jsonSchema 1api1Percent7BserviceIdPercent7D1backchannel1authentication1issuePostRequestBodyContentApplication1jsonSchema) throws Exception {
        BackchannelAuthenticationIssueApiFormRequest request = new BackchannelAuthenticationIssueApiFormRequest(serviceId, 1api1Percent7BserviceIdPercent7D1backchannel1authentication1issuePostRequestBodyContentApplication1jsonSchema);
     ...
     * 
     * <p>The API prepares JSON that contains an error. The JSON should be used as the response body of the
     ...
     * 
     * <p>The response from `/backchannel/authentication/fails` API has some parameters. Among them, it is
     * `action` parameter that the authorization server implementation should check first because it denotes
     * the next action that the authorization server implementation should take. According to the value
     * of `action`, the authorization server implementation must take the steps described below.
     * 
     * <p>**INTERNAL_SERVER_ERROR**
     * 
     * <p>When the value of `action` is `INTERNAL_SERVER_ERROR`, it means that (1) the `reason` request parameter
     ...
     * <p>**BAD_REQUEST**
     * 
     * <p>When the value of `action` is `BAD_REQUEST`, the authorization server implementation should return a
     * "400 Bad Request" response to the client application.
     * 
     * <p>**FORBIDDEN**
     * 
     * <p>When the value of `action` is `FORBIDDEN`, it means that the `reason` request parameter of the API call
     ...
     * @return The call builder
     */
    public BackchannelAuthenticationFailApiRequestBuilder fail() {
        return new BackchannelAuthenticationFailApiRequestBuilder(sdkConfiguration);
    }
     ...
     * @throws Exception if the API call fails
     */
    public BackchannelAuthenticationFailApiResponse fail(@Nonnull String serviceId, @Nonnull BackchannelAuthenticationFailApiRequestBody requestBody) throws Exception {
     ...
     * @return The call builder
     */
    public BackchannelAuthenticationFailApiFormRequestBuilder failForm() {
        return new BackchannelAuthenticationFailApiFormRequestBuilder(sdkConfiguration);
    }
     ...
     * 
     * @param serviceId A service ID.
     * @param 1api1Percent7BserviceIdPercent7D1backchannel1authentication1failPostRequestBodyContentApplication1jsonSchema 
     * @return The response from the API call
     * @throws Exception if the API call fails
     */
    public BackchannelAuthenticationFailApiFormResponse failForm(@Nonnull String serviceId, @Nonnull 1api1Percent7BserviceIdPercent7D1backchannel1authentication1failPostRequestBodyContentApplication1jsonSchema 1api1Percent7BserviceIdPercent7D1backchannel1authentication1failPostRequestBodyContentApplication1jsonSchema) throws Exception {
        BackchannelAuthenticationFailApiFormRequest request = new BackchannelAuthenticationFailApiFormRequest(serviceId, 1api1Percent7BserviceIdPercent7D1backchannel1authentication1failPostRequestBodyContentApplication1jsonSchema);
     ...
     * &lt;summary&gt;Description&lt;/summary&gt;
     * 
     * <p>After the implementation of the backchannel authentication endpoint returns JSON containing an
     ...
     * 
     * <p>After the authorization server receives the result from the authentication device, or even in the
     ...
     * 
     * <p>When the authorization server received the decision of the end-user from the authentication device
     ...
     * 
     * <p>When the authorization server could not get the result of end-user authentication and authorization
     ...
     * parameter.
     * 
     * <p>The response from `/backchannel/authentication/complete` API has various parameters. Among them,
     ...
     * <p>**SERVER_ERROR**
     * 
     * <p>When the value of `action` is `SERVER_ERROR`, it means either (1) that the request from the authorization
     * server to Authlete was wrong, or (2) that an error occurred on Authlete side.
     * 
     * <p>When the backchannel token delivery mode is `ping` or `push`, `SERVER_ERROR` is used only when
     ...
     * 
     * <p>When the backchannel token delivery mode is `poll`, `SERVER_ERROR` is used regardless of whether
     * it is before or after the record of the ticket is retrieved from the database.
     * 
     * <p>**NO_ACTION**
     * 
     * <p>When the value of `action` is `NO_ACTION`, it means that the authorization server does not have
     * to take any immediate action.
     * 
     * <p>`NO_ACTION` is returned when the backchannel token delivery mode is `poll`. In this case, the client
     * will receive the final result at the token endpoint.
     * 
     * <p>**NOTIFICATION**
     * 
     * <p>When the value of `action` is `NOTIFICATION`, it means that the authorization server must send a
     * notification to the client notification endpoint.
     * 
     * <p>According to the CIBA Core specification, the notification is an HTTP POST request whose request
     ...
     * 
     * <p>When the backchannel token delivery mode is `ping`, the request body of the notification is JSON
     ...
     * 
     * <p>In error cases, in the ping mode, however, the content of a notification is not different from the
     ...
     * in the notification.
     * 
     * <p>In any case, the value of `responseContent` is JSON which can be used as the request body of the
     * notification.
     * 
     * <p>The client notification endpoint that the notification should be sent to the value of the `clientNotificationEndpoint`
     ...
     * @return The call builder
     */
    public BackchannelAuthenticationCompleteApiRequestBuilder completeBackchannelAuth() {
        return new BackchannelAuthenticationCompleteApiRequestBuilder(sdkConfiguration);
    }
     ...
     * @throws Exception if the API call fails
     */
    public BackchannelAuthenticationCompleteApiResponse completeBackchannelAuth(@Nonnull String serviceId, @Nonnull BackchannelAuthenticationCompleteApiRequestBody requestBody) throws Exception {
     ...
     * @return The call builder
     */
    public BackchannelAuthenticationCompleteApiFormRequestBuilder completeBackchannelAuthForm() {
        return new BackchannelAuthenticationCompleteApiFormRequestBuilder(sdkConfiguration);
    }
     ...
     * 
     * @param serviceId A service ID.
     * @param 1api1Percent7BserviceIdPercent7D1backchannel1authentication1completePostRequestBodyContentApplication1jsonSchema 
     * @return The response from the API call
     * @throws Exception if the API call fails
     */
    public BackchannelAuthenticationCompleteApiFormResponse completeBackchannelAuthForm(@Nonnull String serviceId, @Nonnull 1api1Percent7BserviceIdPercent7D1backchannel1authentication1completePostRequestBodyContentApplication1jsonSchema 1api1Percent7BserviceIdPercent7D1backchannel1authentication1completePostRequestBodyContentApplication1jsonSchema) throws Exception {
        BackchannelAuthenticationCompleteApiFormRequest request = new BackchannelAuthenticationCompleteApiFormRequest(serviceId, 1api1Percent7BserviceIdPercent7D1backchannel1authentication1completePostRequestBodyContentApplication1jsonSchema);
        RequestOperation<BackchannelAuthenticationCompleteApiFormRequest, BackchannelAuthenticationCompleteApiFormResponse> operation
              = new BackchannelAuthenticationCompleteApiFormOperation(sdkConfiguration);
        return operation.handleResponse(operation.doRequest(request));
    }
